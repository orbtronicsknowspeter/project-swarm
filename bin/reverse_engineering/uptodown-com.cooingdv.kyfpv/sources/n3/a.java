...
public final class a {
    ...
    public static void a(String str, List list, r3.a aVar) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (!aVar.f8859a.containsKey(str2)) {
                throw new q3.a(l.w("Field not found: '", str2, "'"));
            }
            o3.a aVar2 = (o3.a) aVar.f8859a.get(str2);
            try {
    ...
    public static String b(r3.a aVar, List list) {
        ...
        for (int i = 0; i < list.size(); i++) {
            ...
            if (!aVar.f8859a.containsKey(str)) {
                throw new b(l.w("Field not found: '", str, "'"));
            }
            strConcat = strConcat.concat(((o3.a) aVar.f8859a.get(str)).b());
        }
        return strConcat;
    }
}
