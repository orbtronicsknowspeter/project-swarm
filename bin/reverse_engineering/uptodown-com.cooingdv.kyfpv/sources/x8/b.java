...
public abstract class b {
    ...
    public static final LinkedHashMap b(ArrayList arrayList) {
        ...
        for (g gVar : l.C0(arrayList, new z(15))) {
            if (((g) linkedHashMap.put(gVar.f11560a, gVar)) == null) {
                while (true) {
                    y yVar = gVar.f11560a;
                    y yVarC = yVar.c();
                    if (yVarC != null) {
    ...
    public static final g d(w8.a0 a0Var) throws IOException {
        ...
        a0Var.f();
        w wVar = new w();
        wVar.f7024a = ((long) a0Var.f()) & 4294967295L;
        w wVar2 = new w();
        wVar2.f7024a = ((long) a0Var.f()) & 4294967295L;
        int i12 = a0Var.i() & 65535;
        int i13 = a0Var.i() & 65535;
        int i14 = a0Var.i() & 65535;
        a0Var.skip(8L);
        w wVar3 = new w();
        wVar3.f7024a = ((long) a0Var.f()) & 4294967295L;
        String strJ = a0Var.j(i12);
        if (m.r0(strJ, (char) 0)) {
            com.google.gson.internal.a.n("bad zip: filename contains 0x00");
            return null;
        }
        long j = wVar2.f7024a == 4294967295L ? 8 : 0L;
        if (wVar.f7024a == 4294967295L) {
            j += (long) 8;
        }
        if (wVar3.f7024a == 4294967295L) {
            j += (long) 8;
        }
        u uVar = new u();
        ...
        String str = y.f11005b;
        return new g(q1.a.j("/", false).d(strJ), l7.u.k0(strJ, "/", false), strJ2, wVar.f7024a, wVar2.f7024a, i6, lValueOf, wVar3.f7024a);
    }
    ...
    public static final void e(w8.a0 a0Var, int i, p pVar) throws IOException {
        ...
        while (j != 0) {
            ...
            a0Var.t(jI);
            long j10 = hVar.f10962b;
            pVar.invoke(Integer.valueOf(i6), Long.valueOf(jI));
            long j11 = (hVar.f10962b + jI) - j10;
            if (j11 < 0) {
    ...
    public static final n f(w8.a0 a0Var, n nVar) throws IOException {
        x xVar = new x();
        xVar.f7025a = nVar != null ? nVar.f10985e : null;
        x xVar2 = new x();
        x xVar3 = new x();
        int iF = a0Var.f();
        if (iF != 67324752) {
        ...
        return new n(nVar.f10981a, nVar.f10982b, nVar.f10983c, (Long) xVar3.f7025a, (Long) xVar.f7025a, (Long) xVar2.f7025a);
    }

    public static final int g(d0 d0Var, int i) {
        int i6;
        int[] iArr = d0Var.f10955o;
        int i10 = i + 1;
        int length = d0Var.f10954n.length;
        iArr.getClass();
        int i11 = length - 1;
        int i12 = 0;
        while (true) {
