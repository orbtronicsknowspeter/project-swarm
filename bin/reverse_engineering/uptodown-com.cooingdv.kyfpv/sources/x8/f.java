...
public final class f extends o {
    ...
    public final m f11559b;

    static {
        String str = y.f11005b;
        f11558c = q1.a.j("/", false);
    }

    public f(ClassLoader classLoader) {
        this.f11559b = new m(new o9.a(classLoader, 8));
    }
    ...
    public static String i(y yVar) throws EOFException {
        ...
        y yVar2 = f11558c;
        yVar2.getClass();
        k kVar = yVar2.f11006a;
        yVar.getClass();
        y yVarB = c.b(yVar2, yVar, true);
        k kVar2 = yVarB.f11006a;
        int iA = c.a(yVarB);
        ...
        if (i == iMin && kVar2.f() == kVar.f()) {
            ...
            if (arrayListA2.subList(i, arrayListA2.size()).indexOf(c.f11552e) != -1) {
    ...
    public final n e(y yVar) throws EOFException {
        ...
        String strI = i(yVar);
        for (p6.i iVar : (List) this.f11559b.getValue()) {
            n nVarE = ((o) iVar.f8442a).e(((y) iVar.f8443b).d(strI));
            if (nVarE != null) {
                return nVarE;
            }
        }
    ...
    public final u f(y yVar) throws EOFException, FileNotFoundException {
        ...
        for (p6.i iVar : (List) this.f11559b.getValue()) {
            try {
                return ((o) iVar.f8442a).f(((y) iVar.f8443b).d(strI));
    ...
    public final g0 h(y yVar) throws EOFException, FileNotFoundException {
        ...
        for (p6.i iVar : (List) this.f11559b.getValue()) {
            try {
                return ((o) iVar.f8442a).h(((y) iVar.f8443b).d(strI));
            } catch (FileNotFoundException unused) {
            }
        }
        s1.o.p(yVar, "file not found: ");
