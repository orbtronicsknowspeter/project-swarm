...
public final class s implements e3.b {
    ...
    public final Object get() {
        ...
        switch (this.f1316a) {
            case 0:
                Context context = (Context) this.f1317b.f4812b;
                t6.h hVar = (t6.h) this.f1318l.get();
                context.getClass();
                hVar.getClass();
                f3.h hVar2 = f3.h.f4852a;
                ...
                return null;
            case 1:
                return new d0((Context) this.f1317b.f4812b, (i1) this.f1318l.get());
            default:
                return new f3.d((b) this.f1318l.get(), (t6.h) this.f1317b.f4812b);
        }
    }
