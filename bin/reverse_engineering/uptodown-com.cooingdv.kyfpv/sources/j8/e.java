...
public abstract class e {
    ...
    public static final int[] f6732a = {1, 2, 3, 4};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final int[] f6733b = {5};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final int[] f6734c = {6};

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static boolean f6735d = false;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static n f6736e = null;
    ...
    public static int h() {
        ...
        k kVar = nVar.f7241o;
        boolean z9 = kVar.f7220b;
        if (l.a(kVar.f7219a, "NATIONAL") || (z9 && j())) {
            iB = 16;
    ...
    public static void i(a aVar) {
        ...
        if ((j() && j == 1) || (f().j(69).equals("STATE_AND_NATIONAL") && j == 2 && b(f().j(70)) == h())) {
            ...
            if (vectorK != null && (r22 = aVar.f6720d) != 0) {
                for (b bVar : r22) {
                    int iIntValue = bVar.f6721a.intValue();
                    if (vectorK.contains(iIntValue)) {
                        bVar.f6723c = vectorK.get(iIntValue);
                    }
                }
            }
            Vector vectorK2 = f().k(72);
            if (vectorK2 != null && (r62 = aVar.f6720d) != 0) {
                ...
                while (true) {
                    ...
                    next = it.next();
                    if (((b) next).f6721a.intValue() == q6.j.i0(f6733b)) {
                        break;
                    }
                }
                b bVar2 = (b) next;
                if (bVar2 != null && (r63 = bVar2.f) != 0) {
                    for (c cVar : r63) {
                        ...
                        if (vectorK2.contains(iIntValue2)) {
                            cVar.f6729d = vectorK2.get(iIntValue2);
                        }
                    }
                }
            }
