...
public final class DownloadUpdatesWorker extends DownloadWorker {
    ...
    public DownloadUpdatesWorker(Context context, WorkerParameters workerParameters) {
        ...
        this.f3474e = workerParameters.getInputData().getBoolean("downloadAnyway", false);
    ...
    public final Bundle d(Bundle bundle, j0 j0Var) {
        ...
        r rVar = this.f3478d;
        String str = rVar != null ? rVar.f11356b : null;
        if (str != null) {
    ...
    */
    ...
    public final boolean p() {
        return a5.c.f198b.f8973a.getValue() instanceof v0;
    }

    @Override // com.uptodown.workers.DownloadWorker
    public final boolean q() {
        return a5.c.f198b.f8973a.getValue() instanceof y0;
    }
