        ...
        if (System.currentTimeMillis() - j >= 86400000 && z3.f2928c) {
            ...
            if (!arrayList.isEmpty() && (string = Settings.Secure.getString(context.getContentResolver(), "android_id")) != null) {
                ...
                while (it.hasNext()) {
                    ...
                    jSONObject.put("hourTimestamp", qVar.f11336b);
                    jSONObject.put("batteryLevel", qVar.f11337c);
                    jSONObject.put("isCharging", qVar.f11338d);
                    jSONObject.put("wifiConnected", qVar.f11339e);
                ...
                g2VarK.f11207d = vVar2.i(g2VarK, strConcat);
                if (!g2VarK.b()) {
                    SQLiteDatabase sQLiteDatabase3 = gVarL2.f6674a;
