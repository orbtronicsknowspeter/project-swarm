    ...
    */
    public final void onCreate(android.os.Bundle r5) {
        /*
            ...
            super.onCreate(r5)
            t4.n r5 = r4.y0()
            android.widget.RelativeLayout r5 = r5.f10009a
            r5.getClass()
        ...
        L50:
            ...
            r1.<init>(r4)
            t4.n r2 = r4.y0()
            androidx.viewpager2.widget.ViewPager2 r2 = r2.f10013n
            r2.setAdapter(r1)
            if (r5 <= 0) goto L69
            t4.n r1 = r4.y0()
            androidx.viewpager2.widget.ViewPager2 r1 = r1.f10013n
            r1.setCurrentItem(r5, r0)
        L69:
            t4.n r0 = r4.y0()
            androidx.viewpager2.widget.ViewPager2 r0 = r0.f10013n
            c4.r1 r1 = new c4.r1
            r1.<init>(r4)
            r0.registerOnPageChangeCallback(r1)
            r4.z0(r5)
            t4.n r5 = r4.y0()
            android.widget.TextView r5 = r5.f10012m
            android.graphics.Typeface r0 = f4.c.f4883w
            r5.setTypeface(r0)
            t4.n r5 = r4.y0()
            android.widget.ImageView r5 = r5.f10010b
            c4.n1 r0 = new c4.n1
            r1 = 0
            r0.<init>(r4, r1)
