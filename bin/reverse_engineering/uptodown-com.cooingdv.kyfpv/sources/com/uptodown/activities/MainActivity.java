...
public final class MainActivity extends t2 {
    ...
    public ViewPager2 f3311h0;

    /* JADX INFO: renamed from: i0, reason: collision with root package name */
    public RelativeLayout f3312i0;

    /* JADX INFO: renamed from: j0, reason: collision with root package name */
    public RelativeLayout f3313j0;

    /* JADX INFO: renamed from: k0, reason: collision with root package name */
    public ProgressBar f3314k0;

    /* JADX INFO: renamed from: l0, reason: collision with root package name */
    public TabLayout f3315l0;
    ...
    public FrameLayout f3322t0;

    /* JADX INFO: renamed from: u0, reason: collision with root package name */
    public h0 f3323u0;

    /* JADX INFO: renamed from: v0, reason: collision with root package name */
    public FrameLayout f3324v0;

    /* JADX INFO: renamed from: w0, reason: collision with root package name */
    public ImageView f3325w0;

    /* JADX INFO: renamed from: x0, reason: collision with root package name */
    public ImageView f3326x0;
    ...
    public final Handler f3309f0 = new Handler(Looper.getMainLooper());

    /* JADX INFO: renamed from: q0, reason: collision with root package name */
    public final ArrayList f3319q0 = new ArrayList();

    /* JADX INFO: renamed from: r0, reason: collision with root package name */
    public final ArrayList f3320r0 = new ArrayList();

    /* JADX INFO: renamed from: s0, reason: collision with root package name */
    public long f3321s0 = -1;
    ...
    */
    public static final java.lang.Object J0(com.uptodown.activities.MainActivity r6, v6.c r7) throws java.lang.Throwable {
        ...
        L4b:
            ...
            int r7 = r0.size()
            if (r7 != r3) goto L7a
            x4.k r7 = com.uptodown.UptodownApp.f3294g0
            r1 = 0
            if (r7 != 0) goto L6d
            x4.k r7 = new x4.k
            r7.<init>()
            com.uptodown.UptodownApp.f3294g0 = r7
    ...
    public static final void M0(MainActivity mainActivity, g gVar) {
        ...
        if (mainActivity.W != null && mainActivity.T == 0 && arrayList.size() == 1 && ((e3) arrayList.get(mainActivity.T)).f11142a == 1 && !mainActivity.Z0()) {
            mainActivity.f3308e0 = gVar;
            mainActivity.f3307d0 = gVar;
            mainActivity.O0(mainActivity.d1(gVar), 2);
            String strG = x.g(((e3) arrayList.get(mainActivity.T)).f11142a, "wizard_step_", "_shown");
            ...
            if (i >= 0 && i < arrayList.size()) {
                ...
                if (((e3) arrayList.get(mainActivity.T)).f11142a == 2 && ((e3) arrayList.get(0)).f11142a == 1) {
    ...
    public final void B0() {
        if (this.W != null) {
            ...
            int i = this.T;
            if (size > i && ((e3) arrayList.get(i)).f11142a == 5) {
                Q0();
                u1();
                return;
            }
        }
        f1 f1Var = this.f3318p0;
        if (f1Var != null) {
            f1Var.onResume();
        }
    }
    ...
    public final void G0() {
        ...
        this.f3327y0 = b3Var;
        this.f3309f0.postDelayed(b3Var, 2000L);
    }

    public final void O0(RelativeLayout relativeLayout, int i) {
        e3 e3Var = new e3();
        e3Var.f11142a = i;
        e3Var.f11143b = relativeLayout;
        this.U.add(e3Var);
    }
    ...
    public final void Q0() {
        int i = this.T;
        ArrayList arrayList = this.U;
        String strG = x.g(((e3) arrayList.get(i)).f11142a, "wizard_step_", "_shown");
        SharedPreferences sharedPreferences = getSharedPreferences("SettingsPreferences", 0);
        sharedPreferences.getClass();
        SharedPreferences.Editor editorEdit = sharedPreferences.edit();
        boolean z9 = true;
    ...
    public final void R0(g gVar, boolean z9) {
        ...
        try {
            fragmentTransactionBeginTransaction.replace(R.id.rl_main_scrollable, f0Var);
    ...
    public final void S0(int i) {
        TabLayout tabLayout = this.f3315l0;
        tabLayout.getClass();
        if (i < tabLayout.getTabCount()) {
            TabLayout tabLayout2 = this.f3315l0;
            tabLayout2.getClass();
            if (tabLayout2.getSelectedTabPosition() != i) {
                TabLayout tabLayout3 = this.f3315l0;
                tabLayout3.getClass();
    ...
    public final void T0() {
        ...
        if (jCurrentTimeMillis - this.f3305b0 > 60000) {
            this.f3305b0 = jCurrentTimeMillis;
            LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
            e eVar = m0.f8289a;
            c0.s(lifecycleScope, v7.d.f10885a, null, new g3(this, null, 0), 2);
        }
    }

    public final void U0() {
        h0 h0Var;
        FrameLayout frameLayout = this.f3322t0;
        if (frameLayout == null || frameLayout.getChildCount() == 0 || (h0Var = this.f3323u0) == null) {
            return;
        }
        h0Var.getClass();
        RelativeLayout relativeLayout = h0Var.f9842b;
        relativeLayout.getClass();
    ...
    public final Fragment W0() {
        ...
        ArrayList arrayList = this.f3319q0;
    ...
    public final void X0() {
        FrameLayout frameLayout = this.f3324v0;
        if (frameLayout == null || frameLayout.getChildCount() == 0) {
            return;
        }
        FrameLayout frameLayout2 = this.f3324v0;
    ...
    public final boolean a1() {
        ...
        if (z9) {
            ...
            textView.setText(t.a(getString(R.string.msg_update_app_status_526)));
        ...
        gVarL2.c();
        if (q2VarY2 != null && 728 < q2VarY2.f11346l && (rVar = q2VarY2.f11353s) != null && rVar.c()) {
            setContentView(R.layout.dialog_auto_update);
            ((TextView) findViewById(R.id.tv_title_auto_update)).setTypeface(f4.c.f4883w);
            ((TextView) findViewById(R.id.tv_desc_auto_update)).setTypeface(f4.c.f4884x);
            ((TextView) findViewById(R.id.tv_info_auto_update)).setTypeface(f4.c.f4884x);
            ...
            textView3.setText(getString(R.string.autoupdate_installed_version, i.e(packageManager, packageName3, 0).versionName));
            TextView textView4 = (TextView) findViewById(R.id.tv_update_version_auto_update);
            textView4.setTypeface(f4.c.f4883w);
            textView4.setText(getString(R.string.autoupdate_update_version, q2VarY2.f11347m));
            TextView textView5 = (TextView) findViewById(R.id.tv_update_size_auto_update);
            textView5.setTypeface(f4.c.f4884x);
            r rVar2 = q2VarY2.f11353s;
            if (rVar2 != null) {
                textView5.setText(getString(R.string.autoupdate_update_size, i5.H(this, rVar2.k())));
            }
            RelativeLayout relativeLayout = (RelativeLayout) findViewById(R.id.rl_uptodown_version_details);
            ((TextView) findViewById(R.id.tv_uptodown_version_details_label)).setTypeface(f4.c.f4884x);
            ...
            LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
            e eVar = m0.f8289a;
            c0.s(lifecycleScope, v7.d.f10885a, null, new m(this, q2VarY2, textView6, cVar, 3), 2);
            relativeLayout.setOnClickListener(new c.e(6, textView6, imageView));
            ((TextView) findViewById(R.id.tv_update)).setTypeface(f4.c.f4883w);
            ((RelativeLayout) findViewById(R.id.rl_update)).setOnClickListener(new s(3, this));
            ((TextView) findViewById(R.id.tv_cancel)).setTypeface(f4.c.f4883w);
            ((RelativeLayout) findViewById(R.id.rl_cancel)).setOnClickListener(new s(4, this));
        }
        return true;
    }
    ...
    public final void b0(x4.d0 d0Var) {
        ...
        if (rVarA != null) {
            ...
            LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
            e eVar = m0.f8289a;
            c0.s(lifecycleScope, n.f10349a, null, new b.n(iC, this, rVarA, (t6.c) null), 2);
        }
    }
    ...
    public final RelativeLayout c1() {
        View viewInflate = LayoutInflater.from(this).inflate(R.layout.wizard_continue, (ViewGroup) this.W, false);
        viewInflate.getClass();
        RelativeLayout relativeLayout = (RelativeLayout) viewInflate;
        ((TextView) relativeLayout.findViewById(R.id.tv_welcome_to_wizard_continue)).setTypeface(f4.c.f4884x);
        ((TextView) relativeLayout.findViewById(R.id.tv_app_name_wizard_continue)).setTypeface(f4.c.f4883w);
        ((TextView) relativeLayout.findViewById(R.id.tv_continue_to_wizard_continue)).setTypeface(f4.c.f4884x);
    ...
    public final void d0(u0 u0Var) {
        ...
        dVar.getClass();
        String str = dVar.f8070a.F;
        r rVarA = u0Var.a();
        rVarA.getClass();
        if (!u.m0(str, rVarA.f11356b, true) || (dVar2 = this.L) == null) {
            return;
        }
        r rVarA2 = u0Var.a();
        rVarA2.getClass();
    ...
    public final RelativeLayout d1(g gVar) {
        int i = 0;
        View viewInflate = LayoutInflater.from(this).inflate(R.layout.wizard_deep_link, (ViewGroup) this.W, false);
        viewInflate.getClass();
        RelativeLayout relativeLayout = (RelativeLayout) viewInflate;
        ...
        textView.setTypeface(f4.c.f4884x);
        int i6 = f.f6671l;
        String string = getString(R.string.wizard_deep_link_download, gVar.f11160b);
        string.getClass();
        ...
        ((TextView) relativeLayout.findViewById(R.id.tv_app_name_wizard_deep_link)).setTypeface(f4.c.f4883w);
        ((TextView) relativeLayout.findViewById(R.id.tv_welcome_to_wizard_deep_link)).setTypeface(f4.c.f4884x);
        ((TextView) relativeLayout.findViewById(R.id.tv_terms_wizard_deep_link)).setTypeface(f4.c.f4883w);
        ((TextView) relativeLayout.findViewById(R.id.tv_terms_wizard_deep_link)).setOnClickListener(new s(5, this));
        ((TextView) relativeLayout.findViewById(R.id.tv_privacy_settings_wizard_deep_link)).setTypeface(f4.c.f4883w);
        ((TextView) relativeLayout.findViewById(R.id.tv_privacy_settings_wizard_deep_link)).setOnClickListener(new s(6, this));
        ...
        bundle.putString("appId", String.valueOf(gVar.f11159a));
    ...
    public final RelativeLayout e1() {
        View viewInflate = LayoutInflater.from(this).inflate(R.layout.wizard_login, (ViewGroup) this.W, false);
        viewInflate.getClass();
        RelativeLayout relativeLayout = (RelativeLayout) viewInflate;
        RelativeLayout relativeLayout2 = (RelativeLayout) relativeLayout.findViewById(R.id.rl_header_wl);
        if (relativeLayout2 != null) {
            ((TextView) relativeLayout2.findViewById(R.id.tv_title_header_wizard)).setTypeface(f4.c.f4883w);
        }
        ((TextView) relativeLayout.findViewById(R.id.tv_title_wl)).setTypeface(f4.c.f4883w);
        RelativeLayout relativeLayout3 = (RelativeLayout) relativeLayout.findViewById(R.id.rl_login_google_wl);
        float f = UptodownApp.I;
        ((TextView) relativeLayout.findViewById(R.id.tv_login_google_wl)).setTypeface(f4.c.f4883w);
        ...
        ((TextView) relativeLayout.findViewById(R.id.tv_login_anonymous_wl)).setTypeface(f4.c.f4884x);
        ((TextView) relativeLayout.findViewById(R.id.tv_login_anonymous_wl)).setOnClickListener(new s(11, this));
        return relativeLayout;
    }
    ...
    public final RelativeLayout f1() {
        View viewInflate = LayoutInflater.from(this).inflate(R.layout.wizard_permissions, (ViewGroup) this.W, false);
        viewInflate.getClass();
        RelativeLayout relativeLayout = (RelativeLayout) viewInflate;
        ...
        ((TextView) relativeLayout.findViewById(R.id.tv_title_wp)).setTypeface(f4.c.f4883w);
        RelativeLayout relativeLayout3 = (RelativeLayout) relativeLayout.findViewById(R.id.rl_notifications_wp);
        if (Build.VERSION.SDK_INT >= 33) {
            ((TextView) relativeLayout.findViewById(R.id.tv_notifications_title_wp)).setTypeface(f4.c.f4883w);
            ((TextView) relativeLayout.findViewById(R.id.tv_notifications_msg_wp)).setTypeface(f4.c.f4884x);
        ...
        ((ScrollableTextView) relativeLayout.findViewById(R.id.tv_unknown_sources_title_wp)).setTypeface(f4.c.f4883w);
        ((TextView) relativeLayout.findViewById(R.id.tv_unknown_sources_badge_wp)).setTypeface(f4.c.f4883w);
    ...
    public final RelativeLayout g1() {
        View viewInflate = LayoutInflater.from(this).inflate(R.layout.wizard_welcome, (ViewGroup) this.W, false);
        viewInflate.getClass();
        RelativeLayout relativeLayout = (RelativeLayout) viewInflate;
        ((TextView) relativeLayout.findViewById(R.id.tv_welcome_to_wizard_welcome)).setTypeface(f4.c.f4884x);
        ((TextView) relativeLayout.findViewById(R.id.tv_app_name_wizard_welcome)).setTypeface(f4.c.f4883w);
        ((TextView) relativeLayout.findViewById(R.id.tv_slogan_to_wizard_welcome)).setTypeface(f4.c.f4884x);
        ((TextView) relativeLayout.findViewById(R.id.tv_terms_wizard_welcome)).setTypeface(f4.c.f4883w);
        ((RelativeLayout) relativeLayout.findViewById(R.id.rl_terms_wizard_welcome)).setOnClickListener(new s(26, this));
        ((TextView) relativeLayout.findViewById(R.id.tv_privacy_settings_wizard_welcome)).setTypeface(f4.c.f4883w);
        ((RelativeLayout) relativeLayout.findViewById(R.id.rl_privacy_settings_wizard_welcome)).setOnClickListener(new s(27, this));
    ...
    public final void h1() {
        ...
        RelativeLayout relativeLayout2 = this.f3313j0;
        if (relativeLayout2 != null && relativeLayout2.getVisibility() == 0 && (relativeLayout = this.f3313j0) != null) {
    ...
    public final void i0(long j) {
        if (T()) {
            ...
            if (this.f3321s0 == -1) {
                ...
                LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
                e eVar = m0.f8289a;
                c0.s(lifecycleScope, n.f10349a, null, new n3(this, j, null, 0), 2);
            }
        }
    }
    ...
    public final void i1() {
        ...
        ViewPager2 viewPager2 = this.f3311h0;
        boolean z11 = viewPager2 != null && viewPager2.getCurrentItem() == 0;
        if (z9 && z10 && z11 && z3.f2928c) {
            LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
            e eVar = m0.f8289a;
            c0.s(lifecycleScope, n.f10349a, null, new b.n(this, null, 17), 2);
        }
    }
    ...
    public final void j1() {
        ...
        if (b1()) {
            ...
            if (z9) {
                LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
                e eVar = m0.f8289a;
                c0.s(lifecycleScope, n.f10349a, null, new h3(this, gVar, cVar, i), 2);
            } else {
                this.f3310g0 = 0;
                c cVar2 = new c(10, this, gVar);
                this.f3328z0 = cVar2;
                this.f3309f0.postDelayed(cVar2, 2000L);
            }
        }
    }
    ...
    */
    ...
    public final void m1() {
        ProgressBar progressBar = this.f3314k0;
        if (progressBar == null || progressBar.getVisibility() == 0) {
            return;
        }
        ProgressBar progressBar2 = this.f3314k0;
        progressBar2.getClass();
        progressBar2.setVisibility(0);
        LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
        e eVar = m0.f8289a;
        c0.s(lifecycleScope, v7.d.f10885a, null, new g3(this, null, 5), 2);
        m1 m1Var = this.f3317o0;
        if (m1Var != null) {
            m1Var.c();
        }
        g1 g1Var = this.f3316m0;
        if (g1Var != null) {
            g1Var.f10676p = false;
            g1Var.c();
        }
    ...
    public final void o1(e3 e3Var) {
        ...
        Bundle bundleE = k.e(ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, str);
        if (str.equals("deeplink") && (gVar = this.f3307d0) != null) {
            long j = gVar.f11159a;
            if (j > 0) {
    ...
    public final void onCreate(Bundle bundle) throws Throwable {
        ...
        this.f3322t0 = (FrameLayout) findViewById(R.id.fl_sign_in_popup);
        this.f3324v0 = (FrameLayout) findViewById(R.id.fl_uptodown_turbo_popup);
        ...
        ((ImageView) findViewById(R.id.home_uptodown_logo)).setOnClickListener(new s(20, this));
        RelativeLayout relativeLayout3 = (RelativeLayout) findViewById(R.id.rl_main_search_view);
        ((TextView) findViewById(R.id.tv_main_search_view)).setTypeface(f4.c.f4884x);
        relativeLayout3.setOnClickListener(new s(28, this));
        int i6 = 6;
        ((ImageView) findViewById(R.id.home_uptodown_turbo)).setOnClickListener(new c3(i6, this));
        u1();
        Object[] objArr = 0;
        Object[] objArr2 = 0;
        Object[] objArr3 = 0;
        ...
        if (strY != null) {
            g gVar = new g();
            gVar.f11159a = Long.parseLong(strY);
            x0(gVar);
            ...
            LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
            e eVar = m0.f8289a;
            c0.s(lifecycleScope, v7.d.f10885a, null, new g3(this, objArr == true ? 1 : 0, i10), 2);
        }
                ...
                if (data != null) {
                    ...
                    if (strB != null && u.k0(strB, ".apk", false)) {
                        ...
                        if (strC != null) {
                            ...
                            e eVar2 = m0.f8289a;
                            c0.s(lifecycleScope2, n.f10349a, null, new j(this, strC, kVar, objArr6 == true ? 1 : 0, 1), 2);
                        } else {
                        ...
                        c0.s(LifecycleOwnerKt.getLifecycleScope(this), v7.d.f10885a, null, new m3(this, string, objArr5 == true ? 1 : 0, i13), 2);
                        ...
                        c0.s(LifecycleOwnerKt.getLifecycleScope(this), v7.d.f10885a, null, new m3(this, j5.c.d(data), objArr4 == true ? 1 : 0, i12), 2);
                    }
                }
                Intent intent4 = getIntent();
                String string2 = (intent4 == null || (extras3 = intent4.getExtras()) == null) ? null : extras3.getString("action");
                if (string2 != null) {
                    int i14 = MyFirebaseMessagingService.f3406r;
                    if (string2.equalsIgnoreCase("notificationApp")) {
                        ...
                        if (string3 != null) {
                            ...
                            wVar.f7024a = -1L;
                            try {
                                wVar.f7024a = Long.parseLong(string3);
                            ...
                            if (wVar.f7024a > 0) {
                                ...
                                c0.s(LifecycleOwnerKt.getLifecycleScope(this), n.f10349a, null, new b.n((Object) this, (Object) wVar, (t6.c) (objArr3 == true ? 1 : 0), 14), 2);
                            }
                        }
                    ...
                    r1 r1VarA = i5.A(this);
                    if (r1VarA != null && r1VarA.f11376e <= 0) {
                        c0.s(LifecycleOwnerKt.getLifecycleScope(this), n.f10349a, null, new b.n((Object) this, (Object) r1VarA, (t6.c) (objArr2 == true ? 1 : 0), 15), 2);
                    }
                }
            }
        }
        ...
        this.f3311h0 = viewPager22;
        if (viewPager22 != null) {
            viewPager22.setOffscreenPageLimit(4);
        }
        ViewPager2 viewPager23 = this.f3311h0;
        if (viewPager23 != null) {
            viewPager23.setUserInputEnabled(false);
        }
        this.f3315l0 = (TabLayout) findViewById(R.id.tabs);
        this.f3313j0 = (RelativeLayout) findViewById(R.id.rl_app_detail_open);
        ImageView imageView = (ImageView) findViewById(R.id.iv_avatar_user);
        this.f3325w0 = imageView;
        if (imageView != null) {
            imageView.setOnClickListener(new c3(i, this));
        }
        ImageView imageView2 = this.f3325w0;
        if (imageView2 != null) {
        ...
        this.f3326x0 = (ImageView) findViewById(R.id.iv_badge_user);
        q3 q3Var = new q3(this, getSupportFragmentManager(), getLifecycle());
        ViewPager2 viewPager24 = this.f3311h0;
        if (viewPager24 != null) {
            viewPager24.setAdapter(q3Var);
        }
        if (UptodownApp.f3293f0) {
            ViewPager2 viewPager25 = this.f3311h0;
            if (viewPager25 != null) {
                viewPager25.setCurrentItem(G0, false);
            }
            UptodownApp.f3293f0 = false;
            if (G0 == 3) {
        ...
        TabLayout tabLayout = this.f3315l0;
        if (tabLayout == null || (viewPager2 = this.f3311h0) == null) {
            return;
        }
    ...
    public final void onDestroy() {
        super.onDestroy();
        b3 b3Var = this.f3327y0;
        Handler handler = this.f3309f0;
        if (b3Var != null) {
    ...
    public final void onResume() {
        ...
        RelativeLayout relativeLayout = this.f3312i0;
    ...
    */
                                                            ...
                                                            if (textView7 != null) {
                                                                ...
                                                                if (textView8 != null) {
                                                                    ...
                                                                    if (textView9 != null) {
                                                                        ...
                                                                        if (iY0 >= 0) {
                                                                            spannableString.setSpan(new j5.b(linearGradient, getResources().getDimension(R.dimen.font_size_26)), iY0, string.length() + iY0, 33);
                                                                        }
                                                                        textView9.setText(spannableString);
                                                                        ConcurrentHashMap concurrentHashMap = t.f6709a;
                                                                        Spanned spannedA = t.a(getString(R.string.turbo_welcome_popup_description, getString(R.string.turbo_welcome_popup_manage_subscription)));
    ...
    public final void v0(long j) {
        ...
        View viewInflate = LayoutInflater.from(this).inflate(R.layout.wizard_kill, (ViewGroup) this.W, false);
        viewInflate.getClass();
        RelativeLayout relativeLayout4 = (RelativeLayout) viewInflate;
        ((TextView) relativeLayout4.findViewById(R.id.tv_title_wizard_kill)).setTypeface(f4.c.f4883w);
        ...
        ((TextView) relativeLayout4.findViewById(R.id.tv_slide_wizard_kill)).setTypeface(f4.c.f4883w);
    ...
    public final void v1() {
        ...
        int size = arrayList.size();
        int i = this.T;
        if (size > i && ((e3) arrayList.get(i)).f11142a == 4 && m()) {
    ...
    public final void x0(g gVar) {
        ...
        if (T()) {
            Fragment fragmentW0 = W0();
            RelativeLayout relativeLayout = this.f3313j0;
            if (relativeLayout != null) {
            ...
            if (!(fragmentW0 instanceof f0)) {
                R0(gVar, false);
            } else if (((f0) fragmentW0).B().f11159a != gVar.f11159a) {
                R0(gVar, true);
            }
            AppBarLayout appBarLayout = this.Y;
            appBarLayout.getClass();
    ...
    public final void x1(x4.j jVar) {
        ...
        if (T()) {
            ...
            FragmentTransaction fragmentTransactionBeginTransaction = getSupportFragmentManager().beginTransaction();
            fragmentTransactionBeginTransaction.getClass();
            String str = jVar.f11226b;
            str.getClass();
            w0 w0Var = new w0(str);
            jVar.getClass();
            Bundle bundle = new Bundle();
            bundle.putInt("id", jVar.f11225a);
            bundle.putString("name", jVar.f11226b);
            bundle.putString("description", jVar.f11227l);
            bundle.putBoolean("isFloating", jVar.f11228m);
            bundle.putInt("parentCategoryId", jVar.f11230o);
            bundle.putInt("isGame", jVar.f11231p);
            bundle.putBoolean("isLeaf", jVar.f11229n);
            w0Var.setArguments(bundle);
            fragmentTransactionBeginTransaction.add(R.id.fl_apps_category_fragment, w0Var);
    ...
    public final void y1(x4.j jVar) {
        ...
        if (T()) {
            ...
            try {
                ...
                fragmentTransactionBeginTransaction.add(R.id.rl_main_scrollable, z1Var);
                fragmentTransactionBeginTransaction.addToBackStack(z1Var.f10684m.f11226b);
                if (W0() instanceof z1) {
                    fragmentTransactionBeginTransaction.setTransition(FragmentTransaction.TRANSIT_FRAGMENT_FADE);
                }
                if (isFinishing() || getSupportFragmentManager().isDestroyed()) {
