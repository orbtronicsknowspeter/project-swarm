...
public final class ReviewsActivity extends k0 {
    ...
    public final void C0(String str) {
        ...
        if (1 > iIntValue || iIntValue >= 6) {
            ...
            e eVar = m0.f8289a;
            c0.s(viewModelScope, d.f10885a, null, new l(this, str, g9VarA0, (c) null, 11), 2);
        }
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = y0().f10088a;
        ...
        if (intent != null && (extras = intent.getExtras()) != null) {
            ...
            if (extras.containsKey("myReview")) {
                ...
                if (A0().j.getValue() != null) {
                    ...
                    value.getClass();
                    Integer numValueOf = Integer.valueOf(((k2) value).f11265p);
                    o0Var2.getClass();
        ...
        if (drawable != null) {
            y0().f10100w.setNavigationIcon(drawable);
            y0().f10100w.setNavigationContentDescription(getString(R.string.back));
        }
        final int i = 3;
        y0().f10100w.setNavigationOnClickListener(new View.OnClickListener(this) { // from class: c4.x8
                ...
                switch (i6) {
                    case 0:
                        ...
                        if (!kotlin.jvm.internal.l.a(reviewsActivity.A0().f1640k.getValue(), "date")) {
                            ...
                            reviewsActivity.y0().B.setBackground(ContextCompat.getDrawable(reviewsActivity, R.drawable.ripple_header_categories));
                            reviewsActivity.y0().B.setTextColor(ContextCompat.getColorStateList(reviewsActivity, R.color.selector_wizard_accept_button_text));
                            reviewsActivity.y0().D.setBackground(ContextCompat.getDrawable(reviewsActivity, R.drawable.ripple_header_categories));
                            reviewsActivity.y0().D.setTextColor(ContextCompat.getColorStateList(reviewsActivity, R.color.selector_wizard_accept_button_text));
                            reviewsActivity.B0();
                        }
                        break;
                    case 1:
                        ...
                        if (!kotlin.jvm.internal.l.a(reviewsActivity.A0().f1640k.getValue(), "best")) {
                            ...
                            reviewsActivity.y0().C.setBackground(ContextCompat.getDrawable(reviewsActivity, R.drawable.ripple_header_categories));
                            reviewsActivity.y0().C.setTextColor(ContextCompat.getColorStateList(reviewsActivity, R.color.selector_wizard_accept_button_text));
                            reviewsActivity.y0().D.setBackground(ContextCompat.getDrawable(reviewsActivity, R.drawable.ripple_header_categories));
                            reviewsActivity.y0().D.setTextColor(ContextCompat.getColorStateList(reviewsActivity, R.color.selector_wizard_accept_button_text));
                            reviewsActivity.B0();
                        }
                    ...
                    default:
                        ...
                        ((InputMethodManager) systemService).hideSoftInputFromWindow(reviewsActivity.y0().f10089b.getWindowToken(), 0);
                        reviewsActivity.y0().f10089b.clearFocus();
                        x4.w2 w2VarH = x4.u2.h(reviewsActivity);
                        String str = w2VarH != null ? w2VarH.f11432a : null;
                        if (str == null || str.length() == 0) {
                            ...
                            Editable text = reviewsActivity.y0().f10089b.getText();
                            text.getClass();
        ...
        l0VarE.e(y0().f10090l, null);
        y0().E.setTypeface(f4.c.f4883w);
        y0().f10102y.setTypeface(f4.c.f4883w);
        TextView textView = y0().f10102y;
        g gVar2 = (g) A0().i.getValue();
        textView.setText(gVar2 != null ? gVar2.f11160b : null);
        y0().f10103z.setTypeface(f4.c.f4884x);
        TextView textView2 = y0().f10103z;
        g gVar3 = (g) A0().i.getValue();
        textView2.setText(gVar3 != null ? gVar3.f11171l : null);
        y0().f10101x.setTypeface(f4.c.f4884x);
        TextView textView3 = y0().f10101x;
        g gVar4 = (g) A0().i.getValue();
        textView3.setText(gVar4 != null ? gVar4.f11191w : null);
        y0().A.setTypeface(f4.c.f4884x);
        y0().f10089b.setTypeface(f4.c.f4884x);
        final int i6 = 4;
        y0().f10091m.setOnClickListener(new View.OnClickListener(this) { // from class: c4.x8
        ...
        if (A0().j.getValue() != null) {
            ...
            value2.getClass();
            if (((k2) value2).f11265p >= 1) {
                y0().f10092n.setImageDrawable(drawable2);
            }
            Object value3 = A0().j.getValue();
            value3.getClass();
            if (((k2) value3).f11265p >= 2) {
                y0().f10093o.setImageDrawable(drawable2);
            }
            Object value4 = A0().j.getValue();
            value4.getClass();
            if (((k2) value4).f11265p >= 3) {
                y0().f10094p.setImageDrawable(drawable2);
            }
            Object value5 = A0().j.getValue();
            value5.getClass();
            if (((k2) value5).f11265p >= 4) {
                y0().f10095q.setImageDrawable(drawable2);
            }
            Object value6 = A0().j.getValue();
            value6.getClass();
            if (((k2) value6).f11265p == 5) {
                y0().f10096r.setImageDrawable(drawable2);
            }
            Object value7 = A0().j.getValue();
            value7.getClass();
            String str = ((k2) value7).f11264o;
            if (str != null && str.length() != 0) {
                EditText editText = y0().f10089b;
                Object value8 = A0().j.getValue();
                value8.getClass();
                editText.setText(String.valueOf(((k2) value8).f11264o));
            }
        }
        y0().f10092n.setOnClickListener(new View.OnClickListener(this) { // from class: c4.w8
                ...
                switch (i12) {
                    case 0:
                        ...
                        if (b4.d.t()) {
                            ...
                            o0Var3.getClass();
                            o0Var3.g(null, 4);
                            reviewsActivity.y0().f10092n.setImageDrawable(drawable5);
                            reviewsActivity.y0().f10093o.setImageDrawable(drawable5);
                            reviewsActivity.y0().f10094p.setImageDrawable(drawable5);
                            reviewsActivity.y0().f10095q.setImageDrawable(drawable5);
                            reviewsActivity.y0().f10096r.setImageDrawable(drawable4);
                        }
                        break;
                    case 1:
                        int i14 = ReviewsActivity.T;
                        ...
                        if (b4.d.t()) {
                            ...
                            o0Var4.g(null, 1);
                            reviewsActivity.y0().f10092n.setImageDrawable(drawable5);
                            reviewsActivity.y0().f10093o.setImageDrawable(drawable4);
                            reviewsActivity.y0().f10094p.setImageDrawable(drawable4);
                            reviewsActivity.y0().f10095q.setImageDrawable(drawable4);
                            reviewsActivity.y0().f10096r.setImageDrawable(drawable4);
                        }
                        break;
                    case 2:
        ...
        y0().f10093o.setOnClickListener(new View.OnClickListener(this) { // from class: c4.w8
        ...
        y0().f10094p.setOnClickListener(new View.OnClickListener(this) { // from class: c4.w8
        ...
        final int i12 = 0;
        y0().f10095q.setOnClickListener(new View.OnClickListener(this) { // from class: c4.w8
        ...
        y0().f10096r.setOnClickListener(new c.e(17, this, drawable2));
            ...
            public final void onClick(View view) {
                ...
                switch (i62) {
                    ...
                    default:
                        ...
                        reviewsActivity.y0().f10089b.clearFocus();
                        x4.w2 w2VarH = x4.u2.h(reviewsActivity);
                        String str2 = w2VarH != null ? w2VarH.f11432a : null;
        ...
        y0().f10099u.setOnScrollChangeListener(new y8(this));
        y0().f10098t.setOnClickListener(new c4.e(19));
        ViewCompat.setOnApplyWindowInsetsListener(y0().f10088a, new y8(this));
    ...
    public final void z0() {
        if (A0().f1642m) {
            ...
            a0 viewModelScope = ViewModelKt.getViewModelScope(g9VarA0);
            e eVar = m0.f8289a;
            c0.s(viewModelScope, d.f10885a, null, new a(g9VarA0, this, null, 25), 2);
        }
    }
}
