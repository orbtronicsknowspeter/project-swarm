    ...
    */
    public static final java.lang.Object y0(com.uptodown.activities.PasswordRecoveryActivity r14, v6.c r15) {
        ...
        L41:
            ...
            r6.<init>()
            v7.e r2 = o7.m0.f8289a
            p7.c r13 = t7.n.f10349a
            c4.w r2 = new c4.w
            r7 = 0
            r8 = 4
            r4 = r14
        ...
        L75:
            ...
            r6 = r3
        L79:
            v7.e r0 = o7.m0.f8289a
            v7.d r0 = v7.d.f10885a
            c4.z r2 = new c4.z
            r8 = 0
            r3 = r14
            r2.<init>(r3, r4, r5, r6, r7, r8)
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = z0().f9817a;
                    ...
                    public final void onClick(View view) {
                        ...
                        switch (i6) {
                            ...
                            default:
                                ...
                                if (l7.u.m0(passwordRecoveryActivity.z0().f9819l.getText().toString(), "", true) || l7.u.m0(passwordRecoveryActivity.z0().f9818b.getText().toString(), "", true)) {
                                    String string = passwordRecoveryActivity.getString(R.string.error_email_vacio_recuperar_pass);
                                    if (string != null) {
                                        passwordRecoveryActivity.A(string);
                                    }
                                } else if (!l7.u.m0(passwordRecoveryActivity.z0().f9819l.getText().toString(), passwordRecoveryActivity.z0().f9818b.getText().toString(), true)) {
                                    String string2 = passwordRecoveryActivity.getString(R.string.error_emails_no_coinciden);
                                    if (string2 != null) {
        ...
        z0().f9819l.setTypeface(c.f4884x);
        z0().f9818b.setTypeface(c.f4884x);
        z0().f9821n.setTypeface(c.f4883w);
        final int i6 = 1;
        z0().f9821n.setOnClickListener(new View.OnClickListener(this) { // from class: c4.x6
        ...
        z0().f9820m.setOnClickListener(new e(16));
    }
