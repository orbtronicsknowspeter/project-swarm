...
public final class AppInstalledDetailsActivity extends w4 {
    ...
    public static final /* synthetic */ int f3301e0 = 0;
    ...
    */
    ...
    public static final void O0(AppInstalledDetailsActivity appInstalledDetailsActivity) {
        f.s(appInstalledDetailsActivity.R0().f9744s, appInstalledDetailsActivity.R0().f9720b);
        appInstalledDetailsActivity.R0().f9738p.setVisibility(8);
        appInstalledDetailsActivity.R0().f9730k0.setVisibility(8);
        appInstalledDetailsActivity.R0().C.setVisibility(8);
        appInstalledDetailsActivity.R0().f9737o0.setVisibility(0);
    }
    ...
    public static final void P0(AppInstalledDetailsActivity appInstalledDetailsActivity, String str) {
        ...
        z3.J(appInstalledDetailsActivity.R0().f9730k0);
        appInstalledDetailsActivity.R0().f9730k0.setVisibility(0);
        appInstalledDetailsActivity.R0().f9730k0.setOnClickListener(new c.e(1, appInstalledDetailsActivity, str));
    }
    ...
    public final void Q0() {
        if (this.f3303c0 == null) {
            e eVar = this.f3302b0;
            eVar.getClass();
            if (eVar.F > 0) {
                LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
                v7.e eVar2 = m0.f8289a;
                c0.s(lifecycleScope, n.f10349a, null, new j(this, null, 1), 2);
            }
        }
    }
    ...
    public final void S0() {
        f.I(R0().f9744s, R0().f9720b);
        R0().f9744s.setIndeterminate(true);
        R0().f9738p.setVisibility(0);
        R0().f9737o0.setVisibility(0);
        R0().V.setVisibility(8);
        R0().f9730k0.setVisibility(8);
    ...
    public final void d0(u0 u0Var) {
        ...
        if ((u0Var instanceof o0) || (u0Var instanceof p0)) {
            ...
            LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(this);
            v7.e eVar = m0.f8289a;
            c0.s(lifecycleScope, n.f10349a, null, new b.n(this, u0Var, (c) null, 9), 2);
        }
    }
    ...
    */
    ...
    public final void onResume() {
        super.onResume();
        if (this.f3302b0 != null) {
            a aVarC = f4.a.f4870a.c();
            c cVar = null;
            String str = aVarC != null ? aVarC.f7096a : null;
            e eVar = this.f3302b0;
            eVar.getClass();
            if (!u.m0(str, eVar.f11124l, true)) {
