...
public final class PreferencesActivity extends k0 {
    ...
    public PreferencesActivity() {
        ...
        this.O = new m(new a(this) { // from class: d4.o
            ...
            public final /* synthetic */ PreferencesActivity f3594b;
            ...
            public final Object invoke() {
                int i6 = i;
                PreferencesActivity preferencesActivity = this.f3594b;
                switch (i6) {
                    case 0:
                            ...
                            if (viewFindChildViewById2 != null) {
                                ...
                                if (viewFindChildViewById3 != null) {
                                    ...
                                    if (viewFindChildViewById4 != null) {
                                        ...
                                        i11 = R.id.age_verification_setting;
                                        View viewFindChildViewById5 = ViewBindings.findChildViewById(viewInflate, R.id.age_verification_setting);
                                        if (viewFindChildViewById5 != null) {
                                            b5.m mVarZ = b5.m.z(viewFindChildViewById5);
                                            i11 = R.id.auto_update_root_switch_setting;
                                            View viewFindChildViewById6 = ViewBindings.findChildViewById(viewInflate, R.id.auto_update_root_switch_setting);
                                            if (viewFindChildViewById6 != null) {
                                                d0 d0VarG = d0.g(viewFindChildViewById6);
                                                i11 = R.id.downloads_notification_setting;
                                                View viewFindChildViewById7 = ViewBindings.findChildViewById(viewInflate, R.id.downloads_notification_setting);
                                                if (viewFindChildViewById7 != null) {
                                                    d0 d0VarG2 = d0.g(viewFindChildViewById7);
                                                    i11 = R.id.file_management_category;
                                                    View viewFindChildViewById8 = ViewBindings.findChildViewById(viewInflate, R.id.file_management_category);
                                                    if (viewFindChildViewById8 != null) {
                                                        m8.q qVarC = m8.q.c(viewFindChildViewById8);
                                                        i11 = R.id.installable_files_notification_setting;
                                                        View viewFindChildViewById9 = ViewBindings.findChildViewById(viewInflate, R.id.installable_files_notification_setting);
                                                        if (viewFindChildViewById9 != null) {
                                                            d0 d0VarG3 = d0.g(viewFindChildViewById9);
                                                            i11 = R.id.installations_notification_setting;
                                                            View viewFindChildViewById10 = ViewBindings.findChildViewById(viewInflate, R.id.installations_notification_setting);
                                                            if (viewFindChildViewById10 != null) {
                                                                d0 d0VarG4 = d0.g(viewFindChildViewById10);
                                                                i11 = R.id.language_setting;
                                                                View viewFindChildViewById11 = ViewBindings.findChildViewById(viewInflate, R.id.language_setting);
                                                                if (viewFindChildViewById11 != null) {
                                                                    ...
                                                                    if (linearLayout != null) {
                                                                        i11 = R.id.mobile_data_usage_setting;
                                                                        View viewFindChildViewById12 = ViewBindings.findChildViewById(viewInflate, R.id.mobile_data_usage_setting);
                                                                        if (viewFindChildViewById12 != null) {
                                                                            b5.m mVarZ2 = b5.m.z(viewFindChildViewById12);
                                                                            i11 = R.id.more_info_category;
                                                                            View viewFindChildViewById13 = ViewBindings.findChildViewById(viewInflate, R.id.more_info_category);
                                                                            if (viewFindChildViewById13 != null) {
                                                                                m8.q qVarC2 = m8.q.c(viewFindChildViewById13);
                                                                                i11 = R.id.notifications_category;
                                                                                View viewFindChildViewById14 = ViewBindings.findChildViewById(viewInflate, R.id.notifications_category);
                                                                                if (viewFindChildViewById14 != null) {
                                                                                    m8.q qVarC3 = m8.q.c(viewFindChildViewById14);
                                                                                    i11 = R.id.performance_category;
                                                                                    View viewFindChildViewById15 = ViewBindings.findChildViewById(viewInflate, R.id.performance_category);
                                                                                    if (viewFindChildViewById15 != null) {
                                                                                        m8.q qVarC4 = m8.q.c(viewFindChildViewById15);
                                                                                        i11 = R.id.privacy_and_policy_category;
                                                                                        View viewFindChildViewById16 = ViewBindings.findChildViewById(viewInflate, R.id.privacy_and_policy_category);
                                                                                        if (viewFindChildViewById16 != null) {
                                                                                            m8.q qVarC5 = m8.q.c(viewFindChildViewById16);
                                                                                            i11 = R.id.privacy_setting;
                                                                                            View viewFindChildViewById17 = ViewBindings.findChildViewById(viewInflate, R.id.privacy_setting);
                                                                                            if (viewFindChildViewById17 != null) {
                                                                                                h0 h0VarA6 = h0.a(viewFindChildViewById17);
                                                                                                i11 = R.id.quick_install_root_switch_setting;
                                                                                                View viewFindChildViewById18 = ViewBindings.findChildViewById(viewInflate, R.id.quick_install_root_switch_setting);
                                                                                                if (viewFindChildViewById18 != null) {
                                                                                                    ...
                                                                                                    View viewFindChildViewById19 = ViewBindings.findChildViewById(viewInflate, R.id.root_category);
                                                                                                    if (viewFindChildViewById19 != null) {
                                                                                                        m8.q qVarC6 = m8.q.c(viewFindChildViewById19);
                                                                                                        i11 = R.id.show_notifications_setting;
                                                                                                        View viewFindChildViewById20 = ViewBindings.findChildViewById(viewInflate, R.id.show_notifications_setting);
                                                                                                        if (viewFindChildViewById20 != null) {
                                                                                                            d0 d0VarG6 = d0.g(viewFindChildViewById20);
                                                                                                            i11 = R.id.support_setting;
                                                                                                            View viewFindChildViewById21 = ViewBindings.findChildViewById(viewInflate, R.id.support_setting);
                                                                                                            if (viewFindChildViewById21 != null) {
                                                                                                                ...
                                                                                                                if (toolbar != null) {
                                                                                                                    ...
                                                                                                                    View viewFindChildViewById22 = ViewBindings.findChildViewById(viewInflate, R.id.tos_setting);
                                                                                                                    if (viewFindChildViewById22 != null) {
                                                                                                                        ...
                                                                                                                        if (textView != null) {
                                                                                                                            ...
                                                                                                                            View viewFindChildViewById23 = ViewBindings.findChildViewById(viewInflate, R.id.updates_category);
                                                                                                                            if (viewFindChildViewById23 != null) {
                                                                                                                                m8.q qVarC7 = m8.q.c(viewFindChildViewById23);
                                                                                                                                i11 = R.id.updates_notification_setting;
                                                                                                                                View viewFindChildViewById24 = ViewBindings.findChildViewById(viewInflate, R.id.updates_notification_setting);
                                                                                                                                if (viewFindChildViewById24 != null) {
                                                                                                                                    b5.m mVarZ3 = b5.m.z(viewFindChildViewById24);
                                                                                                                                    i11 = R.id.updates_setting;
                                                                                                                                    View viewFindChildViewById25 = ViewBindings.findChildViewById(viewInflate, R.id.updates_setting);
        ...
        ActivityResultLauncher activityResultLauncherRegisterForActivityResult = registerForActivityResult(new ActivityResultContracts.StartActivityForResult(), new ActivityResultCallback(this) { // from class: d4.q
            ...
            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ PreferencesActivity f3598b;
            ...
            public final void onActivityResult(Object obj) {
                int i11 = i10;
                PreferencesActivity preferencesActivity = this.f3598b;
                switch (i11) {
                    case 0:
                        int i12 = PreferencesActivity.T;
                    ...
                    default:
                        ...
                        if (zBooleanValue) {
                            ...
                            if (Build.VERSION.SDK_INT >= 33 && i15 >= 2 && ContextCompat.checkSelfPermission(preferencesActivity, "android.permission.POST_NOTIFICATIONS") != 0) {
                                ...
                                builder.setPositiveButton(R.string.button_notification_dialog_permission, new p(preferencesActivity, i14));
                                builder.create().show();
                                break;
                            }
                        }
    ...
    public final void B0() {
        ((TextView) z0().E.f84n).setText(getString(R.string.disabled));
        ...
        RelativeLayout relativeLayout2 = (RelativeLayout) z0().f9885q.f81b;
        relativeLayout2.getClass();
        v4Var2.g(relativeLayout2, 0.3f);
        ((SwitchCompat) z0().f9885q.f83m).setClickable(false);
        v4 v4Var3 = new v4(this, 1);
        RelativeLayout relativeLayout3 = (RelativeLayout) z0().f9888t.f81b;
        relativeLayout3.getClass();
        v4Var3.g(relativeLayout3, 0.3f);
        ((SwitchCompat) z0().f9888t.f83m).setClickable(false);
        v4 v4Var4 = new v4(this, 1);
        RelativeLayout relativeLayout4 = (RelativeLayout) z0().f9887s.f81b;
        relativeLayout4.getClass();
        v4Var4.g(relativeLayout4, 0.3f);
        ((SwitchCompat) z0().f9887s.f83m).setClickable(false);
    }

    public final void C0() {
        SharedPreferences sharedPreferences;
        ((TextView) z0().E.f84n).setText(getString(R.string.enabled));
        try {
        ...
        v4 v4Var3 = new v4(this, 1);
        RelativeLayout relativeLayout3 = (RelativeLayout) z0().f9885q.f81b;
        relativeLayout3.getClass();
        v4Var3.g(relativeLayout3, 1.0f);
        ((SwitchCompat) z0().f9885q.f83m).setClickable(true);
        v4 v4Var4 = new v4(this, 1);
        RelativeLayout relativeLayout4 = (RelativeLayout) z0().f9888t.f81b;
        relativeLayout4.getClass();
        v4Var4.g(relativeLayout4, 1.0f);
        ((SwitchCompat) z0().f9888t.f83m).setClickable(true);
        v4 v4Var5 = new v4(this, 1);
        RelativeLayout relativeLayout5 = (RelativeLayout) z0().f9887s.f81b;
        relativeLayout5.getClass();
        v4Var5.g(relativeLayout5, 1.0f);
        ((SwitchCompat) z0().f9887s.f83m).setClickable(true);
    }
    ...
    */
    public final void finish() {
        /*
            ...
            x4.m2 r0 = r7.Q
            if (r0 == 0) goto L20
            java.lang.String r2 = r0.f11287a
            java.lang.String r3 = r1.f11287a
            if (r2 != 0) goto L11
            if (r3 == 0) goto L19
        L11:
            if (r2 == 0) goto L20
            ...
            if (r2 == 0) goto L20
        L19:
            boolean r0 = r0.f11288b
            boolean r2 = r1.f11288b
            if (r0 != r2) goto L20
            goto L39
        L20:
            x4.p r3 = new x4.p
    ...
    public final void onCreate(Bundle bundle) {
        ...
        LinearLayout linearLayout = z0().f9878a;
        ...
        if (drawable != null) {
            ...
            z0().G.setNavigationContentDescription(getString(R.string.back));
        }
        final int i10 = 16;
        z0().G.setNavigationOnClickListener(new View.OnClickListener(this) { // from class: d4.m

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ PreferencesActivity f3590b;
            ...
            public final void onClick(View view) {
                int i11 = i10;
                PreferencesActivity preferencesActivity = this.f3590b;
                switch (i11) {
                    case 0:
                        int i12 = PreferencesActivity.T;
                        ((SwitchCompat) preferencesActivity.z0().f9885q.f83m).performClick();
                        break;
                    case 1:
                        int i13 = PreferencesActivity.T;
                        ((SwitchCompat) preferencesActivity.z0().f9888t.f83m).performClick();
                        break;
                    case 2:
                        int i14 = PreferencesActivity.T;
                        v vVar = new v();
                        vVar.f7023a = preferencesActivity.getSharedPreferences("SettingsPreferences", 0).getInt("ageVerificationYear", -1);
                        ...
                        TextView textView = uVarC.f5272p;
                        ...
                        TextView textView3 = uVarC.f5270n;
                    ...
                    case 7:
                        ...
                        intent4.putExtra("advanced_settings_title", preferencesActivity.getString(R.string.support));
                    ...
                    case 12:
                        ...
                        ((SwitchCompat) preferencesActivity.z0().f9887s.f83m).performClick();
                        break;
                    case 13:
                    ...
                    case 14:
                        ...
                        ((SwitchCompat) preferencesActivity.z0().f9884p.f83m).performClick();
                        break;
                    case 15:
        ...
        z0().f9889u.f9845n.setTypeface(c.f4883w);
        l.y(this, R.string.item_menu_idioma, z0().f9889u.f9845n).f9889u.f9844m.setTypeface(c.f4884x);
        z0().f9889u.f9844m.setVisibility(0);
        try {
        ...
        z0().f9889u.f9844m.setText(str);
        final int i12 = 3;
        z0().f9889u.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        ((TextView) z0().J.f7782l).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.updates, (TextView) z0().J.f7782l).L.f85o).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.updates, (TextView) z0().L.f85o).L.f84n).setTypeface(c.f4884x);
        final int i13 = 11;
        ...
        if (z3.p(this, "updates_active", true)) {
            ...
            relativeLayout.getClass();
            v4Var.g(relativeLayout, 1.0f);
            ((SwitchCompat) l.y(this, R.string.enabled, (TextView) z0().L.f84n).L.f83m).setChecked(true);
        } else {
            v4 v4Var2 = new v4(this, 1);
            RelativeLayout relativeLayout2 = (RelativeLayout) z0().K.f1061b;
            relativeLayout2.getClass();
            v4Var2.g(relativeLayout2, 0.3f);
            ((SwitchCompat) l.y(this, R.string.disabled, (TextView) z0().L.f84n).L.f83m).setChecked(false);
        }
        final int i14 = 2;
        ((SwitchCompat) z0().L.f83m).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(this) { // from class: d4.n

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ PreferencesActivity f3592b;
            ...
            public final void onCheckedChanged(CompoundButton compoundButton, boolean z10) {
                int i15 = i14;
                PreferencesActivity preferencesActivity = this.f3592b;
                switch (i15) {
                    case 0:
                        int i16 = PreferencesActivity.T;
                    ...
                    case 2:
                        ...
                        if (!z10) {
                            ...
                            editorEdit3.apply();
                            ((TextView) preferencesActivity.z0().L.f84n).setText(preferencesActivity.getString(R.string.disabled));
                        } else {
                            ...
                            editorEdit4.apply();
                            ((TextView) preferencesActivity.z0().L.f84n).setText(preferencesActivity.getString(R.string.enabled));
                        }
                        break;
                    case 3:
                        int i19 = PreferencesActivity.T;
        ...
        ((TextView) z0().f9886r.f7782l).setTypeface(c.f4883w);
        final int i15 = 12;
        ((RelativeLayout) l.y(this, R.string.preference_file_management, (TextView) z0().f9886r.f7782l).f9887s.f81b).setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        ((TextView) z0().f9887s.f85o).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.search_apk_file_worker_preference_title, (TextView) z0().f9887s.f85o).f9887s.f84n).setTypeface(c.f4884x);
        SwitchCompat switchCompat = (SwitchCompat) l.y(this, R.string.preference_locate_files_in_storage, (TextView) z0().f9887s.f84n).f9887s.f83m;
        try {
        ...
        ((SwitchCompat) z0().f9887s.f83m).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(this) { // from class: d4.n
        ...
        ((TextView) z0().f9893z.f7782l).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.data_saver_preference_title, (TextView) z0().f9893z.f7782l).f9890w.f1063m).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.data_usage_title, (TextView) z0().f9890w.f1063m).f9890w.f1062l).setTypeface(c.f4884x);
        final int i16 = 13;
        ((RelativeLayout) l.y(this, R.string.data_saver_preference_description, (TextView) z0().f9890w.f1062l).f9890w.f1061b).setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        if (((h4.a) this.P.getValue()).c("system_app", false) || f.A()) {
            ((TextView) z0().D.f7782l).setTypeface(c.f4883w);
            i = 3;
            final int i20 = 14;
            ((RelativeLayout) l.y(this, R.string.pref_category_title_install_as_root_system, (TextView) z0().D.f7782l).f9884p.f81b).setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
            ...
            ((TextView) z0().f9884p.f85o).setTypeface(c.f4883w);
            ((TextView) l.y(this, R.string.pref_auto_update_title, (TextView) z0().f9884p.f85o).f9884p.f84n).setTypeface(c.f4884x);
            ((SwitchCompat) l.y(this, R.string.pref_auto_update_sumary, (TextView) z0().f9884p.f84n).f9884p.f83m).setChecked(z3.p(this, "install_apk_rooted", false));
            ((SwitchCompat) z0().f9884p.f83m).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(this) { // from class: d4.n
            ...
            ((TextView) z0().C.f85o).setTypeface(c.f4883w);
            ((TextView) l.y(this, R.string.pref_install_apk_as_root_system_title, (TextView) z0().C.f85o).C.f84n).setTypeface(c.f4884x);
            ((SwitchCompat) l.y(this, R.string.pref_install_apk_as_root_system_summary, (TextView) z0().C.f84n).C.f83m).setChecked(z3.p(this, "install_apk_as_root_system", false));
            ...
            ((TextView) z0().D.f7782l).setVisibility(8);
            ((RelativeLayout) z0().f9884p.f81b).setVisibility(8);
            ((RelativeLayout) z0().C.f81b).setVisibility(8);
            i = 3;
        }
        ((TextView) z0().f9892y.f7782l).setTypeface(c.f4883w);
        final int i22 = 17;
        ((RelativeLayout) l.y(this, R.string.recibir_notificaciones, (TextView) z0().f9892y.f7782l).E.f81b).setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        ((TextView) z0().E.f85o).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.preference_notifications, (TextView) z0().E.f85o).E.f84n).setTypeface(c.f4884x);
        ...
        ((TextView) z0().K.f1063m).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.updates, (TextView) z0().K.f1063m).K.f1062l).setTypeface(c.f4884x);
        ((TextView) z0().K.f1062l).setText(A0());
        i iVar = new i(1, getString(R.string.answer_always));
        i iVar2 = new i(2, getString(R.string.answer_daily));
        i iVar3 = new i(Integer.valueOf(i), getString(R.string.answer_weekly));
        i iVar4 = new i(4, getString(R.string.answer_never));
        i[] iVarArr = new i[4];
        iVarArr[0] = iVar;
        iVarArr[1] = iVar2;
        iVarArr[2] = iVar3;
        ...
        ((RelativeLayout) z0().f9885q.f81b).setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        ((TextView) z0().f9885q.f85o).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.downloads_title, (TextView) z0().f9885q.f85o).f9885q.f84n).setTypeface(c.f4884x);
        ((SwitchCompat) l.y(this, R.string.downloads_notification_permission_description, (TextView) z0().f9885q.f84n).f9885q.f83m).setChecked(z3.p(this, "download_notification", true));
        ((SwitchCompat) z0().f9885q.f83m).setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(this) { // from class: d4.n
        ...
        ((TextView) z0().f9888t.f85o).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.installations, (TextView) z0().f9888t.f85o).f9888t.f84n).setTypeface(c.f4884x);
        ((SwitchCompat) l.y(this, R.string.installs_notification_permission_description, (TextView) z0().f9888t.f84n).f9888t.f83m).setChecked(z3.p(this, "installation_notification", true));
        SwitchCompat switchCompat2 = (SwitchCompat) z0().f9888t.f83m;
        ...
        map2.put(0, getString(R.string.internal_memory_free, i5.H(this, file.getFreeSpace())));
        ArrayList arrayListI = a.a.I(this);
        if (!arrayListI.isEmpty()) {
            map2.put(1, getString(R.string.sd_card_free, i5.H(this, ((l4.o) arrayListI.get(0)).f7129d)));
        }
        if (map2.size() > 1) {
            ...
            b5.m mVarZ = b5.m.z(getLayoutInflater().inflate(R.layout.preference_list, (ViewGroup) null, false));
            ...
            z0().v.addView(relativeLayout4, z0().v.indexOfChild((RelativeLayout) z0().f9887s.f81b));
        }
        ((TextView) z0().A.f7782l).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.preference_privacy_and_security, (TextView) z0().A.f7782l).f9883o.f1063m).setTypeface(c.f4883w);
        ((TextView) l.y(this, R.string.age_verification_title, (TextView) z0().f9883o.f1063m).f9883o.f1062l).setVisibility(8);
        ((RelativeLayout) z0().f9883o.f1061b).setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
            ...
            public final void onClick(View view) {
                ...
                switch (i112) {
                    ...
                    case 2:
                        int i142 = PreferencesActivity.T;
                        v vVar2 = new v();
                        vVar2.f7023a = preferencesActivity.getSharedPreferences("SettingsPreferences", 0).getInt("ageVerificationYear", -1);
                        int value = Year.now().getValue();
                        preferencesActivity.Q();
                        AlertDialog.Builder builder = new AlertDialog.Builder(preferencesActivity);
                        x xVar = new x();
                        u uVarC = u.c(preferencesActivity.getLayoutInflater());
                        ((TextView) uVarC.f5274r).setTypeface(f4.c.f4883w);
                        TextView textView2 = uVarC.f5272p;
                        ...
                        editText.setTypeface(f4.c.f4884x);
                        ((TextView) uVarC.f5273q).setTypeface(f4.c.f4884x);
                        TextView textView22 = uVarC.f5269m;
        ...
        z0().B.f9845n.setTypeface(c.f4883w);
        l.y(this, R.string.gdpr_title, z0().B.f9845n).B.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        if (!z9) {
            z0().B.f9842b.setVisibility(8);
        }
        z0().f9882n.f9845n.setTypeface(c.f4883w);
        final int i26 = 5;
        l.y(this, R.string.advanced_settings, z0().f9882n.f9845n).f9882n.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        ((TextView) z0().f9891x.f7782l).setTypeface(c.f4883w);
        l.y(this, R.string.app_detail_more_info_title, (TextView) z0().f9891x.f7782l).H.f9845n.setTypeface(c.f4883w);
        final int i27 = 6;
        l.y(this, R.string.preference_tos_and_pp, z0().H.f9845n).H.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        z0().F.f9845n.setTypeface(c.f4883w);
        final int i28 = 7;
        l.y(this, R.string.support, z0().F.f9845n).F.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        z0().f9881m.f9845n.setTypeface(c.f4883w);
        l.y(this, R.string.advertising, z0().f9881m.f9845n).f9881m.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        z0().f9879b.f9845n.setTypeface(c.f4883w);
        final int i29 = 9;
        l.y(this, R.string.about, z0().f9879b.f9845n).f9879b.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
        ...
        z0().f9880l.f9845n.setTypeface(c.f4883w);
        final int i30 = 10;
        l.y(this, R.string.about_uptodown, z0().f9880l.f9845n).f9880l.f9842b.setOnClickListener(new View.OnClickListener(this) { // from class: d4.m
    ...
    public final void y0(String str, HashMap map, int i, d7.l lVar) {
        ...
        TextView textView = (TextView) sVarX.f11758m;
        TextView textView2 = (TextView) sVarX.f11759n;
        v vVar = new v();
        vVar.f7023a = i;
        ...
        for (Map.Entry entry : map.entrySet()) {
            ...
            ((RadioGroup) sVarX.f11757l).addView(radioButton);
        }
        textView.setTypeface(c.f4883w);
        textView.setOnClickListener(new t(lVar, vVar, this, 11));
        builder.setView((LinearLayout) sVarX.f11756b);
