    ...
    */
    ...
    public final void C0(j jVar) {
        ...
        if (T()) {
            ...
            fragmentTransactionBeginTransaction.add(B0().D.getId(), z1Var, (String) null).addToBackStack(String.valueOf(jVar.f11225a)).commit();
        }
    }
