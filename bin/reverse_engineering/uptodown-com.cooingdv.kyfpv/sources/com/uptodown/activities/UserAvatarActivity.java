...
public final class UserAvatarActivity extends k0 {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = y0().f9588a;
        ...
        t4.a1 a1VarY0 = y0();
        if (drawable != null) {
            a1VarY0.f9594p.setNavigationIcon(drawable);
            a1VarY0.f9594p.setNavigationContentDescription(getString(R.string.back));
        }
        Toolbar toolbar = a1VarY0.f9594p;
        RecyclerView recyclerView = a1VarY0.f9592n;
        TextView textView = a1VarY0.f9596r;
        RecyclerView recyclerView2 = a1VarY0.f9593o;
        final int i = 0;
        ...
        a1VarY0.f9598t.setTypeface(c.f4883w);
        a1VarY0.f9597s.setTypeface(c.f4883w);
        textView.setTypeface(c.f4883w);
        a1VarY0.f9595q.setTypeface(c.f4883w);
        a1VarY0.f9599u.setTypeface(c.f4883w);
        final int i6 = 1;
        ...
        if (z0().f2184e.getValue() != null) {
            ...
            value.getClass();
            if (((w2) value).d()) {
                a1VarY0.f9589b.setOnClickListener(new View.OnClickListener(this) { // from class: c4.ob
        ...
        int i12 = 6;
        while (true) {
            if ((i11 - ((i12 + 1) * dimensionPixelSize)) / i12 > getResources().getDimensionPixelSize(R.dimen.icon_size_l)) {
                break;
            }
            i12--;
            if (i12 <= 0) {
        ...
        c0.s(LifecycleOwnerKt.getLifecycleScope(this), n.f10349a, null, new pb(this, cVar, i6), 2);
    }
