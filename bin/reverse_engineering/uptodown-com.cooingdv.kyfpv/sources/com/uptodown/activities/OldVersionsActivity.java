...
public final class OldVersionsActivity extends k0 {
    ...
    public final void D0(int i, r rVar) {
        Object value = A0().f1681d.getValue();
        value.getClass();
        if (u.m0(((x4.g) value).F, rVar != null ? rVar.f11356b : null, false)) {
            if (i == 203) {
                E0(rVar);
                return;
            }
            if (i == 208) {
                ...
                Long lValueOf = rVar != null ? Long.valueOf(rVar.f11362q) : null;
                x4.g gVar = (x4.g) A0().f1681d.getValue();
                if (l.a(lValueOf, gVar != null ? Long.valueOf(gVar.f11159a) : null)) {
                    E0(rVar);
                }
            }
        }
    ...
    public final void E0(r rVar) {
        ...
        if (arrayList != null) {
            ...
            while (true) {
                ...
                i++;
                t1 t1Var2 = (t1) obj;
                if (rVar != null && t1Var2.f11400m == rVar.f11359n) {
                    break;
                }
            }
            t1Var = (t1) obj;
    ...
    public final void b0(d0 d0Var) {
        d0Var.getClass();
        r rVarA = d0Var.a();
        if ((rVarA != null ? Long.valueOf(rVarA.f11359n) : null) != null) {
            D0(d0Var.c(), rVarA);
        }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = y0().f9668a;
        ...
        ((TextView) findViewById(R.id.tv_toolbar_old_versions)).setTypeface(f4.c.f4883w);
        y0().f9671m.setTypeface(f4.c.f4884x);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, 1, false);
        linearLayoutManager.setItemPrefetchEnabled(false);
        y0().f9670l.setLayoutManager(linearLayoutManager);
        y0().f9670l.setItemAnimator(null);
        y0().f9670l.addItemDecoration(new f((int) getResources().getDimension(R.dimen.margin_m), (int) getResources().getDimension(R.dimen.margin_xl)));
        y0().f9669b.setOnClickListener(new c4.e(15));
        c0.s(LifecycleOwnerKt.getLifecycleScope(this), n.f10349a, null, new b.s(this, (t6.c) null, 9), 2);
        z0();
    }
    ...
    public final void z0() {
        ...
        if (A0().f1681d.getValue() != null) {
            ...
            v7.e eVar = m0.f8289a;
            c0.s(viewModelScope, v7.d.f10885a, null, new b6.g(h6VarA0, this, null, 5), 2);
        }
    }
}
