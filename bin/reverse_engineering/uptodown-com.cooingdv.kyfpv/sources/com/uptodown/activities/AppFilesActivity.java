...
public final class AppFilesActivity extends k0 {
    ...
    */
    ...
    public final void A0() {
        ...
        e eVar = this.Q;
        eVar.getClass();
        z0().f9679b.setImageDrawable(t.b(this, eVar.f11124l));
        TextView textView = z0().f9683o;
        e eVar2 = this.Q;
        eVar2.getClass();
        textView.setText(eVar2.f11123b);
        z0().f9683o.setTypeface(c.f4883w);
        TextView textView2 = z0().f9684p;
        e eVar3 = this.Q;
        eVar3.getClass();
        textView2.setText(eVar3.f11126n);
        z0().f9684p.setTypeface(c.f4884x);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        try {
            RelativeLayout relativeLayout = z0().f9678a;
            ...
            t4.d dVarZ0 = z0();
            TextView textView = dVarZ0.f9686r;
            RecyclerView recyclerView = dVarZ0.f9681m;
            Toolbar toolbar = dVarZ0.f9682n;
            ...
            dVarZ0.f9685q.setTypeface(c.f4884x);
            dVarZ0.f9680l.setOnClickListener(new c4.e(0));
            recyclerView.setLayoutManager(new LinearLayoutManager(this, 1, false));
            recyclerView.setItemAnimator(new DefaultItemAnimator());
            recyclerView.addItemDecoration(new l((int) getResources().getDimension(R.dimen.margin_m)));
            if (this.Q != null) {
                A0();
