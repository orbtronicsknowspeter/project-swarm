...
public final class NotificationsRegistryActivity extends k0 {
    ...
    public static final void y0(NotificationsRegistryActivity notificationsRegistryActivity, int i, int i6) {
        ...
        if (qVar == null || qVar.f4658a.size() <= i) {
            return;
        }
        q qVar2 = notificationsRegistryActivity.R;
        qVar2.getClass();
        Object obj = qVar2.f4658a.get(i);
        obj.getClass();
        s1 s1Var = (s1) obj;
        String str = s1Var.f11389e;
        if (str != null) {
                ...
                switch (str2.hashCode()) {
                    ...
                    case -1335458389:
                        if (str2.equals("delete")) {
                            if (str3 == null) {
                                String string = notificationsRegistryActivity.getString(R.string.msg_no_action_available);
                                string.getClass();
                                notificationsRegistryActivity.A(string);
                                return;
                            } else {
                                File file = new File(str3);
                                String string2 = notificationsRegistryActivity.getString(R.string.dialog_delete_download_msg, file.getName());
                                string2.getClass();
                    ...
                    case -504325460:
                        if (str2.equals("open_app")) {
                            if (str3 == null) {
                                String string3 = notificationsRegistryActivity.getString(R.string.msg_no_action_available);
                                string3.getClass();
                            ...
                            try {
                                ...
                                e10.printStackTrace();
                                String string5 = notificationsRegistryActivity.getString(R.string.app_detail_not_found);
                                string5.getClass();
                    ...
                    case 1085191854:
                        if (str2.equals("update_uptodown")) {
                            if (str3 == null) {
                                String string6 = notificationsRegistryActivity.getString(R.string.msg_no_action_available);
                                string6.getClass();
                            ...
                            if (file2.exists()) {
                                ...
                                String string7 = notificationsRegistryActivity.getString(R.string.installable_files_not_found);
                                string7.getClass();
                    ...
                    case 1117687366:
                        if (str2.equals("preregister")) {
                            if (str3 != null) {
                                ...
                                e eVar = m0.f8289a;
                                c0.s(lifecycleScope, n.f10349a, null, new b.n(notificationsRegistryActivity, str3, (c) null, 22), 2);
                                return;
                            } else {
                    ...
                    case 1957569947:
                        if (str2.equals("install")) {
                            if (str3 == null) {
                                String string9 = notificationsRegistryActivity.getString(R.string.msg_no_action_available);
                                string9.getClass();
                            ...
                            if (file3.exists()) {
                                ...
                                String string10 = notificationsRegistryActivity.getString(R.string.installable_files_not_found);
                                string10.getClass();
    ...
    */
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = A0().f9640a;
        relativeLayout.getClass();
        setContentView(relativeLayout);
        Drawable drawable = ContextCompat.getDrawable(this, R.drawable.core_vector_back);
        if (drawable != null) {
            A0().f9643m.setNavigationIcon(drawable);
            A0().f9643m.setNavigationContentDescription(getString(R.string.back));
        }
        A0().f9643m.setNavigationOnClickListener(new c4.d(this, 9));
        A0().f9643m.inflateMenu(R.menu.menu_notifications_registry);
        A0().f9643m.setOverflowIcon(ContextCompat.getDrawable(this, R.drawable.vector_menu_dots_color_adaptable));
        A0().f9643m.setOnMenuItemClickListener(new a(this, 6));
        A0().f9645o.setTypeface(f4.c.f4883w);
        A0().f9644n.setTypeface(f4.c.f4884x);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this, 1, false);
        int dimension = (int) getResources().getDimension(R.dimen.margin_m);
        A0().f9642l.addItemDecoration(new f(dimension, dimension));
        A0().f9642l.setLayoutManager(linearLayoutManager);
        A0().f9642l.setItemAnimator(new DefaultItemAnimator());
        A0().f9641b.setOnClickListener(new c4.e(14));
        c0.s(LifecycleOwnerKt.getLifecycleScope(this), n.f10349a, null, new u5(this, null), 2);
    }
    ...
    public final void onResume() {
        ...
        if (this.Q) {
            ...
            e eVar = m0.f8289a;
            c0.s(viewModelScope, v7.d.f10885a, null, new z5(this, b6VarB0, null, 1), 2);
        }
    }
}
