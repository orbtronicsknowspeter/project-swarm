...
public final class LanguageSettingsActivity extends k0 {
    ...
    */
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = z0().f10104a;
        relativeLayout.getClass();
        setContentView(relativeLayout);
        Drawable drawable = ContextCompat.getDrawable(this, R.drawable.core_vector_back);
        if (drawable != null) {
            z0().f10107m.setNavigationIcon(drawable);
            z0().f10107m.setNavigationContentDescription(getString(R.string.back));
        }
        z0().f10108n.setTypeface(c.f4883w);
        int i = 5;
        z0().f10107m.setNavigationOnClickListener(new d(this, i));
        z0().f10105b.setOnClickListener(new e(5));
        z0().f10106l.setLayoutManager(new LinearLayoutManager(this, 1, false));
        z0().f10106l.setItemAnimator(new DefaultItemAnimator());
