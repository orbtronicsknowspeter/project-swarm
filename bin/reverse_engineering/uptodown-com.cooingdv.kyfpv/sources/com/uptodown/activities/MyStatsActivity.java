...
public final class MyStatsActivity extends k0 {
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = y0().f10258a;
        ...
        if (u.b(this)) {
            ...
            e eVar = m0.f8289a;
            c0.s(viewModelScope, v7.d.f10885a, null, new b6.a(s5Var, this, cVar, 16), 2);
        } else {
            this.Q.launch(new Intent("android.settings.USAGE_ACCESS_SETTINGS"));
        }
        c0.s(LifecycleOwnerKt.getLifecycleScope(this), n.f10349a, null, new s(this, cVar, 8), 2);
    }
    ...
    public final void z0() {
        ...
        if (drawable != null) {
            y0().f10262n.setNavigationIcon(drawable);
            y0().f10262n.setNavigationContentDescription(getString(R.string.back));
        }
        y0().f10262n.setNavigationOnClickListener(new c4.d(this, 8));
        y0().E.setTypeface(f4.c.f4883w);
        y0().F.setTypeface(f4.c.f4883w);
        y0().G.setTypeface(f4.c.f4883w);
        y0().f10264p.setTypeface(f4.c.f4884x);
        y0().f10265q.setTypeface(f4.c.f4883w);
        y0().H.setTypeface(f4.c.f4884x);
        y0().I.setTypeface(f4.c.f4883w);
        y0().f10263o.setTypeface(f4.c.f4884x);
        y0().B.setTypeface(f4.c.f4883w);
        y0().C.setTypeface(f4.c.f4883w);
        y0().f10268t.setTypeface(f4.c.f4883w);
        y0().f10269u.setTypeface(f4.c.f4883w);
        y0().f10273z.setTypeface(f4.c.f4883w);
        y0().A.setTypeface(f4.c.f4883w);
        y0().f10266r.setTypeface(f4.c.f4883w);
        y0().f10267s.setTypeface(f4.c.f4883w);
        y0().f10271x.setTypeface(f4.c.f4883w);
        y0().f10272y.setTypeface(f4.c.f4883w);
        y0().v.setTypeface(f4.c.f4883w);
        y0().f10270w.setTypeface(f4.c.f4883w);
        y0().J.setTypeface(f4.c.f4883w);
        y0().D.setTypeface(f4.c.f4883w);
        y0().f10260l.setOnClickListener(new c4.e(13));
    }
}
