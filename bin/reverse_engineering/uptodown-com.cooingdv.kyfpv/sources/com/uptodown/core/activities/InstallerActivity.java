...
public final class InstallerActivity extends h {
    ...
    public static final /* synthetic */ int f3395j0 = 0;
    public TextView A;
    public ImageView B;
    public TextView C;
    public TextView D;
    ...
    public final b f3401g0 = new b(this, 9);

    /* JADX INFO: renamed from: h0, reason: collision with root package name */
    public final h0 f3402h0 = new h0(this);

    /* JADX INFO: renamed from: i0, reason: collision with root package name */
    public final h0 f3403i0 = new h0(this);

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public ProgressBar f3404y;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    public TextView f3405z;
    ...
    */
    public static final java.lang.Object C(com.uptodown.core.activities.InstallerActivity r7, android.net.Uri r8, java.lang.String r9, v6.c r10) {
        ...
        L13:
            ...
            r0.<init>(r7, r10)
        L18:
            java.lang.Object r10 = r0.f5223l
            int r1 = r0.f5225n
            r2 = 2
            r3 = 1
            r4 = 0
        ...
        L2b:
            ...
            return r4
        L31:
            java.lang.String r9 = r0.f5222b
            android.net.Uri r8 = r0.f5221a
            p6.a.e(r10)
            goto L54
        L39:
            p6.a.e(r10)
    ...
    public final void E() {
        ...
        try {
            ...
            if (intent != null) {
                ...
                if (extras != null) {
                    ...
                    if (extras.containsKey("newFeatures")) {
                        this.f3397c0 = extras.getString("newFeatures");
                    }
                    if (extras.containsKey("requireUserAction")) {
                        this.f3398d0 = extras.getBoolean("requireUserAction");
                    }
                    ...
                    if (extras.containsKey("backgroundInstallation")) {
                        this.f3399e0 = extras.getBoolean("backgroundInstallation");
                    }
                }
            }
            this.a0 = (LinearLayout) findViewById(R.id.ll_installer_activity);
            ...
            this.f3405z = textView10;
            if (textView10 != null) {
                textView10.setTypeface(c.f4884x);
            }
            ...
            this.N = textView15;
            if (textView15 != null) {
                textView15.setTypeface(c.f4883w);
            }
            ...
            String str6 = this.f3397c0;
            if (str6 == null || str6.length() == 0) {
                installerActivity = this;
            } else {
                TextView textView18 = this.f3405z;
                textView18.getClass();
                ...
                textView19.setTypeface(c.f4883w);
                TextView textView20 = (TextView) findViewById(R.id.tv_version_new_features_content);
                textView20.setTypeface(c.f4884x);
                textView20.setText(this.f3397c0);
            ...
            str7.getClass();
            e eVar = m0.f8289a;
            c0.s(c0.b(v7.d.f10885a), null, null, new l0(this, uri, str7, (t6.c) null), 3);
        } catch (Exception e11) {
            e = e11;
        }
    }
    ...
    public final void F(File file) {
        ...
        hVar.f7970b = this.f3398d0;
        ArrayList arrayList = new ArrayList();
        arrayList.add(file);
        e eVar = m0.f8289a;
        c0.s(c0.b(v7.d.f10885a), null, null, new ya(hVar, arrayList, (t6.c) null, 21), 3);
    }
    ...
    public final void G(Activity activity, final File file) {
        ...
        if (!aVar.c("user_asked_for_show_permissions", false)) {
            ...
            builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener(this) { // from class: g4.d0

                /* JADX INFO: renamed from: b, reason: collision with root package name */
                public final /* synthetic */ InstallerActivity f5153b;
                ...
                public final void onClick(DialogInterface dialogInterface, int i10) {
                    int i11 = i;
                    File file2 = file;
                    InstallerActivity installerActivity = this.f5153b;
                    switch (i11) {
                        case 0:
                            int i12 = InstallerActivity.f3395j0;
                            ...
                            break;
                        default:
                            int i13 = InstallerActivity.f3395j0;
            ...
            builder.setNegativeButton(android.R.string.cancel, new DialogInterface.OnClickListener(this) { // from class: g4.d0
        ...
        if (aVar.c("device_rooted", false)) {
            ...
            c0.s(c0.b(m0.f8289a), null, null, new g(absolutePath, activity, this.f3403i0, cVar, 19), 3);
            return;
        }
        if (aVar.c("system_app", false)) {
            q qVar = new q(i6, activity, this.f3402h0);
            e eVar = m0.f8289a;
            c0.s(c0.b(v7.d.f10885a), null, null, new ya(qVar, file, cVar, 22), 3);
        }
    }
    ...
    public final void H(Activity activity, ArrayList arrayList) {
        ...
        if (z9 || z10) {
            ...
            if (!z11) {
                ...
                builder.setMessage(R.string.msg_dialog_install_auto);
                builder.setCancelable(false);
                builder.setPositiveButton(android.R.string.ok, new g4.c0(this, arrayList, i));
                builder.setNegativeButton(android.R.string.cancel, new g4.c0(this, arrayList, i6));
                builder.create().show();
                return;
            }
        }
        ...
        new n4.h(activity).k(arrayList, this.f3398d0);
    }
    ...
    */
    ...
    public final void M(String str) {
        ...
        ProgressBar progressBar = this.f3404y;
        if (progressBar != null) {
        ...
        TextView textView2 = this.f3405z;
        if (textView2 != null) {
    ...
    public final void N(ArrayList arrayList) {
        ...
        ((TextView) viewInflate.findViewById(R.id.tv_msg_installed_version)).setTypeface(c.f4884x);
    ...
    */
    public final java.lang.Object O(int r12, v6.c r13) {
        ...
        L13:
            ...
            r0.<init>(r11, r13)
        L18:
            java.lang.Object r13 = r0.f5236l
            int r1 = r0.f5238n
            r2 = 2
            r3 = 1
            r8 = 0
            u6.a r10 = u6.a.f10763a
            if (r1 == 0) goto L3c
            if (r1 == r3) goto L32
            if (r1 != r2) goto L2b
            p6.a.e(r13)
        ...
        L32:
            int r12 = r0.f5234a
            kotlin.jvm.internal.x r1 = r0.f5235b
            p6.a.e(r13)
        L39:
            r6 = r12
            r7 = r1
        ...
        L3c:
            ...
            goto L71
        L5a:
            v7.e r12 = o7.m0.f8289a
            p7.c r12 = t7.n.f10349a
            c4.ya r4 = new c4.ya
            r9 = 6
            r5 = r11
    ...
    public final void onCreate(Bundle bundle) {
        ...
        if (aVar.c() == null && c.v == null) {
            ...
            this.f3404y = (ProgressBar) findViewById(R.id.pb_installer_activity);
            TextView textView10 = (TextView) findViewById(R.id.tv_installation_in_progress_filename);
            this.K = textView10;
            textView10.getClass();
            textView10.setTypeface(c.f4884x);
            l4.a aVarC = aVar.c();
            String str = aVarC != null ? aVarC.f7098c : null;
            if (str != null && (textView = this.K) != null) {
                textView.setText(str);
            }
        }
        getOnBackPressedDispatcher().addCallback(this, this.f3401g0);
