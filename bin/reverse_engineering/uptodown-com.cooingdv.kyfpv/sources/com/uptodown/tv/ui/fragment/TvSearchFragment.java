...
public final class TvSearchFragment extends SearchSupportFragment implements SearchSupportFragment.SearchResultProvider {
    ...
    public static final /* synthetic */ int f3445m = 0;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final ArrayObjectAdapter f3446a = new ArrayObjectAdapter(new ListRowPresenter());
    ...
    public final void a(String str) {
        ...
        s1 s1Var = this.f3448l;
        c cVar = null;
        if (s1Var != null) {
            s1Var.c(null);
        }
        this.f3448l = c0.s(LifecycleOwnerKt.getLifecycleScope(this), null, null, new g0(this, str, cVar, 0), 3);
    }
    ...
    public final boolean onQueryTextChange(String str) {
        if (str == null || str.length() <= 2 || str.equalsIgnoreCase(this.f3447b)) {
            return true;
        }
        this.f3447b = str;
        a(str);
