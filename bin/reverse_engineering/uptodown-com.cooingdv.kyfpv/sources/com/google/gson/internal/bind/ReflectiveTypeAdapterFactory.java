...
public final class ReflectiveTypeAdapterFactory implements j {
    ...
    public final i a(com.google.gson.b bVar, TypeToken typeToken) {
        ...
        List list = Collections.EMPTY_LIST;
        f.e();
        return j3.c.f6567a.A(cls) ? new RecordAdapter(cls, c(bVar, typeToken, cls, true)) : new FieldReflectionAdapter(this.f3159a.B(typeToken, true), c(bVar, typeToken, cls, false));
    }
