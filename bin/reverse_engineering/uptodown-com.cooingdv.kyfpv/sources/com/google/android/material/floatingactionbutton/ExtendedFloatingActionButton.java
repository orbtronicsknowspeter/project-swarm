...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    public ExtendedFloatingActionButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, R.styleable.ExtendedFloatingActionButton, i, i6, new int[0]);
        ...
        setShapeAppearanceModel(ShapeAppearanceModel.builder(context2, attributeSet, i, i6, ShapeAppearanceModel.PILL).build());
        saveOriginalTextCsl();
    }
    ...
    private Size getSizeFromExtendStrategyType(int i) {
        ...
        final Size size2 = new Size() { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.3
            ...
            public int getHeight() {
                ...
                int i6 = ExtendedFloatingActionButton.this.originalHeight;
                ExtendedFloatingActionButton extendedFloatingActionButton = ExtendedFloatingActionButton.this;
                if (i6 != -1) {
    ...
    public void performMotion(int i, @Nullable final OnChangedCallback onChangedCallback) {
        ...
        if (i == 0) {
            ...
            if (i != 3) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.u(i, "Unknown strategy type: "));
                return;
            }
