...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    ...
    public SheetDialog(@NonNull Context context, @StyleRes int i, @AttrRes int i6, @StyleRes int i10) {
        super(context, getThemeResId(context, i, i6, i10));
    ...
    private static int getThemeResId(@NonNull Context context, @StyleRes int i, @AttrRes int i6, @StyleRes int i10) {
        if (i != 0) {
            return i;
        }
        TypedValue typedValue = new TypedValue();
        return context.getTheme().resolveAttribute(i6, typedValue, true) ? typedValue.resourceId : i10;
    }
    ...
    private View wrapInSheet(int i, @Nullable View view, @Nullable ViewGroup.LayoutParams layoutParams) {
        ...
        coordinatorLayout.findViewById(TOUCH_OUTSIDE_ID).setOnClickListener(new View.OnClickListener() { // from class: com.google.android.material.sidesheet.a
            ...
            public final void onClick(View view2) {
                this.f3040a.lambda$wrapInSheet$0(view2);
            }
        });
    ...
    public void setSheetEdge(@GravityInt int i) {
        ...
        if (frameLayout == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Sheet view reference is null; sheet edge cannot be changed if the sheet view is null.");
            return;
        }
        if (frameLayout.isLaidOut()) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Sheet view has been laid out; sheet edge cannot be changed once the sheet has been laid out.");
            return;
        }
