...
class EndCompoundLayout extends LinearLayout {
    ...
    public static class EndIconDelegates {
        ...
        private EndIconDelegate create(int i) {
            ...
            com.google.gson.internal.a.p(l.u(i, "Invalid end icon mode: "));
            return null;
        }
    ...
    public EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray tintTypedArray) {
        ...
        this.editTextWatcher = new TextWatcherAdapter() { // from class: com.google.android.material.textfield.EndCompoundLayout.1
            ...
            public void beforeTextChanged(CharSequence charSequence, int i, int i6, int i10) {
                EndCompoundLayout.this.getEndIconDelegate().beforeEditTextChanged(charSequence, i, i6, i10);
            }
        };
    ...
    public void setEndIconMinSize(@Px int i) {
        if (i < 0) {
            com.google.gson.internal.a.p("endIconSize cannot be less than 0");
