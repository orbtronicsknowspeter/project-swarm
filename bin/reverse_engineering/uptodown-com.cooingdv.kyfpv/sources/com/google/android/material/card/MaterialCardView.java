...
public class MaterialCardView extends CardView implements Checkable, Shapeable {
    ...
    public MaterialCardView(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, com.google.android.material.R.styleable.MaterialCardView, i, i6, new int[0]);
        MaterialCardViewHelper materialCardViewHelper = new MaterialCardViewHelper(this, attributeSet, i, i6);
    ...
    public void setAncestorContentPadding(int i, int i6, int i10, int i11) {
    ...
    public void setContentPadding(int i, int i6, int i10, int i11) {
        this.cardViewHelper.setUserContentPadding(i, i6, i10, i11);
    }
