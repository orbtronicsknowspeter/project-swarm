...
public class MaterialShapeDrawable extends Drawable implements TintAwareDrawable, Shapeable {
    ...
    public static class SpringAnimatedCornerSizeProperty extends FloatPropertyCompat<MaterialShapeDrawable> {
        ...
        @Override // androidx.dynamicanimation.animation.FloatPropertyCompat
        public void setValue(@NonNull MaterialShapeDrawable materialShapeDrawable, float f) {
    ...
    @Nullable
    private PorterDuffColorFilter calculatePaintColorTintFilter(@NonNull Paint paint, boolean z9) {
        if (!z9) {
            return null;
        }
    ...
    @NonNull
    private PorterDuffColorFilter calculateTintColorTintFilter(@NonNull ColorStateList colorStateList, @NonNull PorterDuff.Mode mode, boolean z9) {
    ...
    @NonNull
    private PorterDuffColorFilter calculateTintFilter(@Nullable ColorStateList colorStateList, @Nullable PorterDuff.Mode mode, @NonNull Paint paint, boolean z9) {
    ...
    private void maybeDrawCompatShadow(@NonNull Canvas canvas) {
        if (hasCompatShadow()) {
            ...
            if (iWidth < 0 || iHeight < 0) {
                a.i("Invalid shadow bounds. Check that the treatments result in a valid path.");
                return;
            }
            ...
            float f10 = (getBounds().top - this.drawableState.shadowCompatRadius) - iHeight;
    ...
    private static int modulateAlpha(int i, int i6) {
        return ((i6 + (i6 >>> 7)) * i) >>> 8;
    }
    ...
    private void updateShape(int[] iArr, boolean z9) {
        RectF boundsAsRectF = getBoundsAsRectF();
        if (this.drawableState.stateListShapeAppearanceModel == null || boundsAsRectF.isEmpty()) {
            return;
        }
        boolean z10 = z9 | (this.cornerSpringForce == null);
    ...
    private void updateZ() {
        float z9 = getZ();
        this.drawableState.shadowCompatRadius = (int) Math.ceil(0.75f * z9);
    ...
    @Deprecated
    public void getPathForSize(int i, int i6, @NonNull Path path) {
        calculatePathForSize(new RectF(0.0f, 0.0f, i, i6), path);
    }
    ...
    public boolean isPointInTransparentRegion(int i, int i6) {
        return getTransparentRegion().contains(i, i6);
    }
    ...
    public void setPadding(int i, int i6, int i10, int i11) {
        ...
        this.drawableState.padding.set(i, i6, i10, i11);
        invalidateSelf();
    }
    ...
    public MaterialShapeDrawable(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i6) {
        this(ShapeAppearanceModel.builder(context, attributeSet, i, i6).build());
    }
