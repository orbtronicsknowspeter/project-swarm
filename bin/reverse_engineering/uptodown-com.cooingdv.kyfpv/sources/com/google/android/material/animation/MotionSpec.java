...
public class MotionSpec {
    ...
    private static void addInfoFromAnimator(@NonNull MotionSpec motionSpec, Animator animator) {
        if (!(animator instanceof ObjectAnimator)) {
            a.h(animator, "Animator must be an ObjectAnimator: ");
            return;
        }
    ...
    @NonNull
    public <T> ObjectAnimator getAnimator(@NonNull String str, @NonNull T t9, @NonNull Property<T, ?> property) {
        ObjectAnimator objectAnimatorOfPropertyValuesHolder = ObjectAnimator.ofPropertyValuesHolder(t9, getPropertyValues(str));
