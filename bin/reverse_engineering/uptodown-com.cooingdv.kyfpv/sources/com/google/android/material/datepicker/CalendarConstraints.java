...
public final class CalendarConstraints implements Parcelable {
    ...
    private CalendarConstraints(@NonNull Month month, @NonNull Month month2, @NonNull DateValidator dateValidator, @Nullable Month month3, int i) {
        ...
        if (month3 != null && month.compareTo(month3) > 0) {
            com.google.gson.internal.a.p("start Month cannot be after current Month");
            throw null;
        }
        if (month3 != null && month3.compareTo(month2) > 0) {
            com.google.gson.internal.a.p("current Month cannot be after end Month");
            throw null;
        }
        if (i < 0 || i > UtcDates.getUtcCalendar().getMaximum(7)) {
            com.google.gson.internal.a.p("firstDayOfWeek is not valid");
            throw null;
        }
