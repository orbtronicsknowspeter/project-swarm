...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    @NonNull
    private Pair<MotionTiming, MotionTiming> calculateMotionTiming(float f, float f10, boolean z9, @NonNull FabTransformationSpec fabTransformationSpec) {
        MotionTiming timing;
    ...
    private void createChildrenFadeAnimation(View view, View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    private void createColorAnimation(@NonNull View view, View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
    ...
    private void createDependencyTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z9, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list) {
    ...
    private void createElevationAnimation(View view, @NonNull View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfFloat;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void createExpansionAnimation(@NonNull View view, View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, float f, float f10, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ...
        if (view2 instanceof CircularRevealWidget) {
            ...
            if (z9) {
                ...
                createPreFillRadialExpansion(view2, timing.getDelay(), i, i6, f11, list);
                createPostFillRadialExpansion(view2, timing.getDelay(), timing.getDuration(), fabTransformationSpec.timings.getTotalDuration(), i, i6, fWidth, list);
    ...
    /* JADX WARN: Multi-variable type inference failed */
    private void createIconFadeAnimation(View view, final View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, @NonNull List<Animator.AnimatorListener> list2) {
        ObjectAnimator objectAnimatorOfInt;
    ...
    private void createPostFillRadialExpansion(View view, long j, long j6, long j10, int i, int i6, float f, @NonNull List<Animator> list) {
        long j11 = j + j6;
        if (j11 < j10) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i, i6, f, f);
    ...
    private void createPreFillRadialExpansion(View view, long j, int i, int i6, float f, @NonNull List<Animator> list) {
        if (j > 0) {
            Animator animatorCreateCircularReveal = ViewAnimationUtils.createCircularReveal(view, i, i6, f, f);
    ...
    private void createTranslationAnimation(@NonNull View view, @NonNull View view2, boolean z9, boolean z10, @NonNull FabTransformationSpec fabTransformationSpec, @NonNull List<Animator> list, List<Animator.AnimatorListener> list2, @NonNull RectF rectF) {
    ...
    public boolean layoutDependsOn(@NonNull CoordinatorLayout coordinatorLayout, @NonNull View view, @NonNull View view2) {
        if (view.getVisibility() == 8) {
            a.i("This behavior cannot be attached to a GONE view. Set the view to INVISIBLE instead.");
            return false;
        }
    ...
    @NonNull
    public AnimatorSet onCreateExpandedStateChangeAnimation(@NonNull final View view, @NonNull final View view2, final boolean z9, boolean z10) {
