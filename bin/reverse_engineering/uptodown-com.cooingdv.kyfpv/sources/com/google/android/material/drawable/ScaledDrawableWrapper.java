...
public class ScaledDrawableWrapper extends DrawableWrapperCompat {
    ...
    public ScaledDrawableWrapper(@NonNull Drawable drawable, int i, int i6) {
        super(drawable);
        this.state = new ScaledDrawableWrapperState(getConstantStateFrom(drawable), i, i6);
    }
    ...
    public static final class ScaledDrawableWrapperState extends Drawable.ConstantState {
        ...
        public ScaledDrawableWrapperState(@Nullable Drawable.ConstantState constantState, int i, int i6) {
