...
public final class BadgeState {
    ...
    public BadgeState(Context context, @XmlRes int i, @AttrRes int i6, @StyleRes int i10, @Nullable State state) {
        ...
        TypedArray typedArrayGenerateTypedArray = generateTypedArray(context, state.badgeResId, i6, i10);
    ...
    private TypedArray generateTypedArray(Context context, @XmlRes int i, @AttrRes int i6, @StyleRes int i10) {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, drawableXml, R.styleable.Badge, i6, styleAttribute == 0 ? i10 : styleAttribute, new int[0]);
    }
