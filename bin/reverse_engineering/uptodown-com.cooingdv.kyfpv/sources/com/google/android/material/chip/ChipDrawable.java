...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private ChipDrawable(@NonNull Context context, AttributeSet attributeSet, @AttrRes int i, @StyleRes int i6) {
    ...
    @NonNull
    public static ChipDrawable createFromAttributes(@NonNull Context context, @Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i6) {
        ChipDrawable chipDrawable = new ChipDrawable(context, attributeSet, i, i6);
        chipDrawable.loadFromAttributes(attributeSet, i, i6);
        return chipDrawable;
    }
    ...
    private void loadFromAttributes(@Nullable AttributeSet attributeSet, @AttrRes int i, @StyleRes int i6) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(this.context, attributeSet, com.google.android.material.R.styleable.Chip, i, i6, new int[0]);
    ...
    public boolean refreshCloseIconFocus(boolean z9) {
        if (this.closeIcon != null) {
            return setCloseIconState(z9 ? new int[]{R.attr.state_pressed, R.attr.state_enabled} : DEFAULT_STATE);
        }
        return false;
    }
