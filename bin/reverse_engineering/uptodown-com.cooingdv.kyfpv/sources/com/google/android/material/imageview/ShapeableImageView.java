...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    public ShapeableImageView(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(attributeSet, R.styleable.ShapeableImageView, i, i6);
        setLayerType(2, null);
    ...
    private void updateShapeMask(int i, int i6) {
        this.destination.set(getPaddingLeft(), getPaddingTop(), i - getPaddingRight(), i6 - getPaddingBottom());
        this.pathProvider.calculatePath(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
        this.maskPath.rewind();
        this.maskPath.addPath(this.path);
        this.maskRect.set(0.0f, 0.0f, i, i6);
    ...
    public void onSizeChanged(int i, int i6, int i10, int i11) {
        ...
        updateShapeMask(i, i6);
    }

    public void setContentPadding(@Dimension int i, @Dimension int i6, @Dimension int i10, @Dimension int i11) {
        this.startContentPadding = Integer.MIN_VALUE;
        this.endContentPadding = Integer.MIN_VALUE;
        super.setPadding((super.getPaddingLeft() - this.leftContentPadding) + i, (super.getPaddingTop() - this.topContentPadding) + i6, (super.getPaddingRight() - this.rightContentPadding) + i10, (super.getPaddingBottom() - this.bottomContentPadding) + i11);
    ...
    public void setContentPaddingRelative(@Dimension int i, @Dimension int i6, @Dimension int i10, @Dimension int i11) {
        super.setPaddingRelative((super.getPaddingStart() - getContentPaddingStart()) + i, (super.getPaddingTop() - this.topContentPadding) + i6, (super.getPaddingEnd() - getContentPaddingEnd()) + i10, (super.getPaddingBottom() - this.bottomContentPadding) + i11);
        this.leftContentPadding = isRtl() ? i10 : i;
        this.topContentPadding = i6;
        if (!isRtl()) {
            i = i10;
        }
    ...
    @Override // android.view.View
    public void setPadding(@Dimension int i, @Dimension int i6, @Dimension int i10, @Dimension int i11) {
        super.setPadding(getContentPaddingLeft() + i, getContentPaddingTop() + i6, getContentPaddingRight() + i10, getContentPaddingBottom() + i11);
    }

    @Override // android.view.View
    public void setPaddingRelative(@Dimension int i, @Dimension int i6, @Dimension int i10, @Dimension int i11) {
