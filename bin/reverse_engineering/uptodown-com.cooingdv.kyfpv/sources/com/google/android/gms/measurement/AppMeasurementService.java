...
public final class AppMeasurementService extends Service implements z3 {
    ...
    public final IBinder onBind(Intent intent) {
        ...
        if ("com.google.android.gms.measurement.START".equals(action)) {
            return new c2(u4.C((Service) iVarD.f4812b));
        }
    ...
    public final int onStartCommand(final Intent intent, int i, final int i6) {
        ...
        final w0 w0Var = t1.s(service, null, null).f4265o;
        t1.m(w0Var);
        String action = intent.getAction();
        w0Var.f4347w.d(Integer.valueOf(i6), "Local AppMeasurementService called. startId, action", action);
        ...
        Runnable runnable = new Runnable() { // from class: e1.a4
            ...
            public final void run() {
                Service service2 = (Service) iVarD.f4812b;
                z3 z3Var = (z3) service2;
                int i10 = i6;
                if (z3Var.a(i10)) {
                    w0Var.f4347w.c(Integer.valueOf(i10), "Local AppMeasurementService processed last upload request. StartId");
                    w0 w0Var2 = t1.s(service2, null, null).f4265o;
                    t1.m(w0Var2);
                    w0Var2.f4347w.b("Completed wakeful intent.");
                    z3Var.b(intent);
                }
            }
        };
