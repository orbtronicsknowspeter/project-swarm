    ...
    public final n a(y2.s sVar, List list) {
        ...
        switch (this.f2684l) {
            ...
            case 1:
                ...
                n nVarC2 = ((t) sVar.f11757l).c(sVar, (n) list.get(0));
                n nVarC3 = ((t) sVar.f11757l).c(sVar, (n) list.get(1));
                String strF2 = nVarC2.f();
                android.support.v4.media.g gVar = (android.support.v4.media.g) this.f2685m;
                Map map3 = (Map) ((e1.m1) gVar.f248l).f4106m.get((String) gVar.f247b);
            ...
            default:
                b2.t1.S(this.f2650a, 3, list);
                ((t) sVar.f11757l).c(sVar, (n) list.get(0)).f();
                n nVar2 = (n) list.get(1);
                t tVar2 = (t) sVar.f11757l;
