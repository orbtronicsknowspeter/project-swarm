...
public abstract class i5 {
    public static x4.r1 A(Context context) {
        ...
        r1Var.f11372a = -1L;
        r1Var.f11374c = -1;
        r1Var.f11372a = z3.t(-1L, context, "fcm_app_id");
        r1Var.f11373b = z3.y(context, "fcm_packagename");
        r1Var.f11374c = z3.s(context, -1, "fcm_download_id");
        r1Var.f11375d = z3.t(-1L, context, "fcm_received_timestamp");
        r1Var.f11376e = z3.t(-1L, context, "fcm_shown_timestamp");
        if (r1Var.f11372a <= -1 || r1Var.f11373b == null) {
            r1Var = null;
        }
        if (r1Var != null) {
            if (r1Var.f11372a > -1 && r1Var.f11373b != null) {
                long j = r1Var.f11375d;
    ...
    public static void F(UsernameTextView usernameTextView) {
        ...
        usernameTextView.f3454a = null;
        usernameTextView.f3455b = 0.0f;
        usernameTextView.f3456l = null;
        usernameTextView.f3457m = Integer.valueOf(ContextCompat.getColor(usernameTextView.getContext(), R.color.text_terciary));
        usernameTextView.f3458n = 0L;
        usernameTextView.f3459o = 0L;
        ...
        Integer num = usernameTextView.f3457m;
        num.getClass();
    ...
    public static final w8.c L(File file) {
        ...
        file.getClass();
        return new w8.c(new FileInputStream(file), w8.i0.f10963d);
    }
    ...
    public static final long N(int i, m7.c cVar) {
        ...
        return o(TimeUnit.NANOSECONDS.convert(i, cVar.f7668a));
    }

    public static final long O(long j, m7.c cVar) {
        TimeUnit timeUnit = cVar.f7668a;
    ...
    public static q7.e a(int i, q7.a aVar, int i6) {
        ...
        if (i == -2) {
            ...
            q7.i.f8770k.getClass();
            return new q7.e(q7.h.f8769b);
        }
        if (i != -1) {
    ...
    public static Vector c(String str) throws w5.e {
        ...
        Object obj = w5.c.f10916a;
        ?? r12 = w5.c.f10917b;
        w5.d dVar = w5.d.f10921l;
        ...
        if (i == 2) {
            ...
            if (iB3 >= 0) {
                ...
                while (true) {
                    ...
                    Object obj2 = w5.c.f10916a;
                    ?? r72 = w5.c.f10917b;
                    Integer num9 = (Integer) r72.get(w5.d.f10928s);
                    int iIntValue4 = iIntValue + (num9 == null ? 0 : num9.intValue());
                    w5.d dVar4 = w5.d.f10929t;
    ...
    public static String d(String str) throws w5.e {
        ...
        while (i < length) {
            ...
            i++;
            Integer num = (Integer) w5.a.f10913a.get(String.valueOf(cCharAt));
            if (num == null) {
                string = null;
            } else {
    ...
    public static void g(UsernameTextView usernameTextView, boolean z9, String str) {
        ...
        if (str != null) {
            switch (str.hashCode()) {
                case 110843959:
                    if (str.equals("type1")) {
                        usernameTextView.f3458n = 2000L;
                        usernameTextView.f3459o = 200L;
                    }
                    break;
                case 110843960:
                    if (str.equals("type2")) {
                        usernameTextView.f3458n = 4000L;
                        usernameTextView.f3459o = 300L;
                    }
                    break;
                case 110843961:
                    if (str.equals("type3")) {
                        usernameTextView.f3458n = 3000L;
                        usernameTextView.f3459o = 400L;
                    }
                    break;
            }
        }
        long j = usernameTextView.f3459o;
        if (usernameTextView.f3460p) {
            usernameTextView.a();
            usernameTextView.f3462r = new Handler(Looper.getMainLooper());
            e1.w wVar = new e1.w(usernameTextView, j);
            String str2 = usernameTextView.f3461q;
            if (str2 != null) {
                switch (str2.hashCode()) {
                    case 110843959:
                        if (str2.equals("type1")) {
                            int color = ContextCompat.getColor(usernameTextView.getContext(), R.color.turbo_username_type_1_1);
                            usernameTextView.f3456l = new int[]{color, ContextCompat.getColor(usernameTextView.getContext(), R.color.turbo_username_type_1_2), color, color, color};
                        }
                        break;
                    case 110843960:
                        if (str2.equals("type2")) {
                            int color2 = ContextCompat.getColor(usernameTextView.getContext(), R.color.turbo_username_type_2_1);
                            usernameTextView.f3456l = new int[]{color2, ContextCompat.getColor(usernameTextView.getContext(), R.color.turbo_username_type_2_2), color2, color2, color2};
                        }
                        break;
                    case 110843961:
                        if (str2.equals("type3")) {
                            int color3 = ContextCompat.getColor(usernameTextView.getContext(), R.color.turbo_username_type_3_1);
                            usernameTextView.f3456l = new int[]{color3, ContextCompat.getColor(usernameTextView.getContext(), R.color.turbo_username_type_3_2), color3, color3, color3};
                        }
                        break;
                }
            }
            Handler handler = usernameTextView.f3462r;
            if (handler != null) {
                handler.post(wVar);
            }
        }
    ...
    public static void j(q4.c cVar, o4.a aVar) {
        while (!aVar.g) {
            ...
            sb.append(cVar.f8692o);
            sb.append(" and the number of commands is ");
            sb.append(arrayList.size());
            B(sb.toString());
            B("Processed " + aVar.f8164b + " of " + aVar.f8163a + " output from command.");
            synchronized (aVar) {
                try {
                    if (!aVar.g) {
                        aVar.wait(2000L);
            ...
            if (!aVar.f8167e && !aVar.g) {
                boolean z9 = cVar.f8688k;
                if (!z9 && !cVar.f8689l) {
    ...
    public static void r(ArrayList arrayList, c4.w4 w4Var) {
        ...
        while (true) {
            ...
            for (int i = 0; i < size; i++) {
                long j = ((x4.e) arrayList.get(i)).f11125m;
                if (l7.u.m0(q2Var.f11345b, ((x4.e) arrayList.get(i)).f11124l, true) && q2Var.f11346l > j) {
        ...
        while (i6 < size2) {
            ...
            while (i10 < size3) {
                ...
                if (eVar2.v == 1 || (kotlin.jvm.internal.l.a(eVar2.f11124l, q2Var2.f11345b) && q2Var2.c())) {
        ...
        int i11 = 0;
        while (i11 < arrayList.size() && (!l7.u.m0(w4Var.getPackageName(), ((x4.e) arrayList.get(i11)).f11124l, true) || ((x4.e) arrayList.get(i11)).f11128p != dVar)) {
            i11++;
        }
    ...
    public static final z7.a t(d8.b bVar, c8.c cVar, String str) {
        ...
        j7.c cVar2 = ((z7.e) bVar).f11987a;
        g8.d dVar = (g8.d) serializersModule;
        dVar.getClass();
        cVar2.getClass();
        Map map = (Map) dVar.f5380d.get(cVar2);
        ...
        if (bVar3 != null) {
            ...
            Object obj = dVar.f5381e.get(cVar2);
    ...
    */
    ...
    public static x4.a3 v(JSONObject jSONObject) {
        ...
        if (!jSONObject.isNull("appID")) {
            a3Var.f11047a = jSONObject.optLong("appID");
        }
        if (!jSONObject.isNull("name")) {
            a3Var.f11048b = jSONObject.optString("name");
        }
        if (!jSONObject.isNull("icon")) {
            a3Var.f11049c = jSONObject.optString("icon");
        }
        if (!jSONObject.isNull("packagename")) {
            a3Var.f11050d = jSONObject.optString("packagename");
        }
        if (!jSONObject.isNull("wishlistAdded")) {
            a3Var.f11051e = jSONObject.optString("wishlistAdded");
        }
    ...
    public static e0.a w(Context context, GoogleSignInOptions googleSignInOptions) {
        ...
        return new e0.a(context, d0.a.f3533a, googleSignInOptions, new i0.c(new e1.c0(19), Looper.getMainLooper()));
    }

    public static j1.p x(Intent intent) {
        e0.c cVar;
        GoogleSignInAccount googleSignInAccount;
        f8.o oVar = f0.h.f4809a;
        ...
        Status status3 = cVar.f3735a;
        if (status3.f2474a > 0 || (googleSignInAccount = cVar.f3736b) == null) {
    ...
    public static k7.g z(d7.p pVar) {
        k7.g gVar = new k7.g();
        gVar.f7001m = d0.b.B(pVar, gVar, gVar);
        return gVar;
    }
}
