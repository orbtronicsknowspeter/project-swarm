    ...
    */
    public static void h(r7.j0 r8, r7.i r9, t6.c r10) throws java.lang.Throwable {
        ...
        L13:
            ...
            r0.<init>(r8, r10)
        L18:
            java.lang.Object r10 = r0.f8987n
            int r1 = r0.f8989p
            r2 = 3
            r3 = 2
            if (r1 == 0) goto L5a
        ...
        L66:
            ...
            o7.x r4 = o7.x.f8328b     // Catch: java.lang.Throwable -> Laf
        ...
        L75:
            ...
            f8.w r5 = r7.k0.f9006a     // Catch: java.lang.Throwable -> L36
            u6.a r6 = u6.a.f10763a
            if (r10 != r5) goto L90
            r0.f8983a = r4     // Catch: java.lang.Throwable -> L36
            r0.f8984b = r1     // Catch: java.lang.Throwable -> L36
            r0.f8985l = r9     // Catch: java.lang.Throwable -> L36
            r0.f8986m = r8     // Catch: java.lang.Throwable -> L36
            r0.f8989p = r3     // Catch: java.lang.Throwable -> L36
        ...
        L9e:
            ...
            r0.f8985l = r9     // Catch: java.lang.Throwable -> L36
            r0.f8986m = r8     // Catch: java.lang.Throwable -> L36
            r0.f8989p = r2     // Catch: java.lang.Throwable -> L36
    ...
    public final Object emit(Object obj, t6.c cVar) throws Throwable {
        ...
        lVar.s();
        t6.c[] cVarArrK2 = s7.c.f9349a;
        synchronized (this) {
            try {
                if (o(obj)) {
                    try {
                        lVar.resumeWith(p6.x.f8464a);
                    ...
                    try {
                        h0 h0Var2 = new h0(this, l() + ((long) (this.f9001r + this.f9002s)), obj, lVar);
                        j(h0Var2);
                        this.f9002s++;
                        if (this.f8997n == 0) {
                ...
                return objR == aVar ? objR : p6.x.f8464a;
            } catch (Throwable th4) {
                th = th4;
            }
        }
    ...
    public final void g() {
        if (this.f8997n != 0 || this.f9002s > 1) {
            Object[] objArr = this.f8998o;
            objArr.getClass();
            while (this.f9002s > 0) {
                long jL = l();
                int i = this.f9001r;
                int i6 = this.f9002s;
                if (objArr[((int) ((jL + ((long) (i + i6))) - 1)) & (objArr.length - 1)] != k0.f9006a) {
                    return;
                }
                this.f9002s = i6 - 1;
                k0.d(objArr, l() + ((long) (this.f9001r + this.f9002s)), null);
            }
        }
    }
    ...
    public final void i() {
        ...
        if (this.f9000q < jL) {
            if (this.f9347b != 0 && (dVarArr = this.f9346a) != null) {
    ...
    public final void j(Object obj) {
        int i = this.f9001r + this.f9002s;
        Object[] objArrM = this.f8998o;
        if (objArrM == null) {
            objArrM = m(null, 0, 2);
    ...
    public final t6.c[] k(t6.c[] cVarArr) {
        ...
        if (this.f9347b != 0 && (dVarArr = this.f9346a) != null) {
            ...
            while (i < length2) {
                s7.d dVar = dVarArr[i];
                if (dVar != null && (lVar = (l0Var = (l0) dVar).f9015b) != null && p(l0Var) >= 0) {
    ...
    public final long l() {
        return Math.min(this.f9000q, this.f8999p);
    }
    ...
    public final boolean o(Object obj) {
        ...
        if (i != 0) {
            int i10 = this.f9001r;
            int i11 = this.f8997n;
            if (i10 >= i11 && this.f9000q <= this.f8999p) {
                return false;
            }
            j(obj);
            int i12 = this.f9001r + 1;
            this.f9001r = i12;
            if (i12 > i11) {
                i();
            }
            long jL = l() + ((long) this.f9001r);
            long j = this.f8999p;
            if (((int) (jL - j)) > i6) {
                r(1 + j, this.f9000q, l() + ((long) this.f9001r), l() + ((long) this.f9001r) + ((long) this.f9002s));
            }
        } else if (i6 != 0) {
            j(obj);
            int i13 = this.f9001r + 1;
            this.f9001r = i13;
            if (i13 > i6) {
                i();
            }
            this.f9000q = l() + ((long) this.f9001r);
            return true;
        }
        return true;
    }
    ...
    public final long p(l0 l0Var) {
        long j = l0Var.f9014a;
        if (j < l() + ((long) this.f9001r)) {
            return j;
        }
        if (this.f8997n <= 0 && j <= l() && this.f9002s != 0) {
            return j;
        }
        return -1L;
    }
    ...
    public final void r(long j, long j6, long j10, long j11) {
        ...
        this.f8999p = j;
        this.f9000q = j6;
        this.f9001r = (int) (j10 - jMin);
        this.f9002s = (int) (j11 - j10);
    }
    ...
    public final t6.c[] s(long j) {
        ...
        s7.d[] dVarArr;
        f8.w wVar = k0.f9006a;
        t6.c[] cVarArr3 = s7.c.f9349a;
        if (j <= this.f9000q) {
            long jL = l();
            long j12 = ((long) this.f9001r) + jL;
            int i = this.f8997n;
            if (i == 0 && this.f9002s > 0) {
                j12++;
            }
            int i6 = 0;
            if (this.f9347b != 0 && (dVarArr = this.f9346a) != null) {
            ...
            if (j12 > this.f9000q) {
                long jL2 = l() + ((long) this.f9001r);
                int i10 = this.f9347b;
                int iMin = this.f9002s;
                if (i10 > 0) {
                    j6 = 1;
                ...
                if (iMin > 0) {
                    ...
                    while (true) {
                        ...
                        if (obj != wVar) {
                            ...
                            j11 = j12;
                            int i11 = i6 + 1;
                            cVarArr2[i6] = h0Var.f8982m;
                            k0.d(objArr, jL2, wVar);
                            k0.d(objArr, j15, h0Var.f8981l);
                            j15 += j6;
                            if (i11 >= iMin) {
                                break;
                            }
                ...
                int i12 = (int) (jL2 - j10);
                long j16 = this.f9347b == 0 ? jL2 : j11;
                long jMax = Math.max(this.f8999p, jL2 - ((long) Math.min(this.f8996m, i12)));
                if (i == 0 && jMax < j14) {
                    Object[] objArr2 = this.f8998o;
                    objArr2.getClass();
