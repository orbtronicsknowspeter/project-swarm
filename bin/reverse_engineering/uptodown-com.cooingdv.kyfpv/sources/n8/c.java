...
public abstract class c {
    ...
    public static final byte[] f8115a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final String[] f8116b = new String[0];

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final d0 f8117c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final Charset f8118d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final TimeZone f8119e;
    ...
    static {
        ...
        k.d("0000ffff");
        k.d("ffff0000");
        f8118d = Charset.forName("UTF-8");
        Charset.forName("ISO-8859-1");
        Charset.forName("UTF-16BE");
        Charset.forName("UTF-16LE");
        Charset.forName("UTF-32BE");
        Charset.forName("UTF-32LE");
        f8119e = DesugarTimeZone.getTimeZone("GMT");
        f = new z(9);
    ...
    */
    ...
    public static String j(u uVar, boolean z9) {
        ...
        String strW = uVar.f7796d;
        if (zContains) {
            strW = l.w("[", strW, "]");
        }
        if (!z9 && i == u.b(uVar.f7793a)) {
            return strW;
        }
        return strW + ":" + i;
    }
