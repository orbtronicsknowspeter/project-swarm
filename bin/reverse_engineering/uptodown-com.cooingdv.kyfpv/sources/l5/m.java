...
public final class m implements Html.TagHandler {
    ...
    public final UsernameEditActivity f7144a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final ArrayList f7145b = new ArrayList();

    public m(UsernameEditActivity usernameEditActivity) {
        this.f7144a = usernameEditActivity;
    }
    ...
    public final void handleTag(boolean z9, String str, Editable editable, XMLReader xMLReader) {
        ...
        if (str.equalsIgnoreCase("turbo")) {
            ArrayList arrayList = this.f7145b;
            if (z9) {
            ...
            editable.setSpan(new ForegroundColorSpan(ContextCompat.getColor(this.f7144a, R.color.turbo_main)), iIntValue, length, 33);
            if (f4.c.f4883w != null) {
