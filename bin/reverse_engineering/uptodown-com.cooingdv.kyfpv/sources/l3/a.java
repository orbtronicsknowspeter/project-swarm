...
public final class a {
    ...
    public final void b(int i) {
        String str = (String) b.f9159b.get(Integer.valueOf(i));
        if (!this.f7095d) {
    ...
    public final String c() {
        ...
        if (str == null || str.isEmpty() || this.f7094c) {
            HashMap map = this.f7092a;
            ...
            try {
                ...
                this.f7093b = (String) Collection.EL.stream(arrayList).collect(Collectors.joining("~"));
                this.f7094c = false;
                this.f7095d = true;
            } catch (q3.b e10) {
                throw new a1.b(e10);
    ...
    public final s3.a e(String str) {
        ...
        if (this.f7092a.containsKey(str)) {
            return (s3.a) this.f7092a.get(str);
        }
        return null;
    }
    ...
    public final ArrayList f() {
        ...
        while (true) {
            ...
            if (this.f7092a.containsKey(str)) {
                arrayList.add(Integer.valueOf(((s3.a) this.f7092a.get(str)).e()));
            }
            i++;
        }
    }
    ...
    public final boolean g() {
        String str = (String) b.f9159b.get(2);
        if (!this.f7095d) {
            this.f7092a = a(this.f7093b);
            this.f7094c = false;
            this.f7095d = true;
    ...
    public final void h(String str, String str2, Object obj) {
        ...
        if (this.f7092a.containsKey(str)) {
            aVar = (s3.a) this.f7092a.get(str);
        } else if (str.equals("tcfcav1")) {
            aVar = new s3.a(1);
            this.f7092a.put("tcfcav1", aVar);
        } else if (str.equals("tcfeuv2")) {
            aVar = new s3.a(2);
            this.f7092a.put("tcfeuv2", aVar);
        } else if (str.equals("uspv1")) {
            aVar = new s3.a(20);
            this.f7092a.put("uspv1", aVar);
        } else if (str.equals("usnat")) {
            aVar = new s3.a(11);
            this.f7092a.put("usnat", aVar);
        } else if (str.equals("usca")) {
            aVar = new s3.a(3);
            this.f7092a.put("usca", aVar);
        } else if (str.equals("usva")) {
            aVar = new s3.a(19);
            this.f7092a.put("usva", aVar);
        } else if (str.equals("usco")) {
            aVar = new s3.a(4);
            this.f7092a.put("usco", aVar);
        } else if (str.equals("usut")) {
            aVar = new s3.a(18);
            this.f7092a.put("usut", aVar);
        } else if (str.equals("usct")) {
            aVar = new s3.a(5);
            this.f7092a.put("usct", aVar);
        } else if (str.equals("usfl")) {
            aVar = new s3.a(7);
            this.f7092a.put("usfl", aVar);
        } else if (str.equals("usmt")) {
            aVar = new s3.a(10);
            this.f7092a.put("usmt", aVar);
        } else if (str.equals("usor")) {
            aVar = new s3.a(15);
            this.f7092a.put("usor", aVar);
        } else if (str.equals("ustx")) {
            aVar = new s3.a(17);
            this.f7092a.put("ustx", aVar);
        } else if (str.equals("usde")) {
            aVar = new s3.a(6);
            this.f7092a.put("usde", aVar);
        } else if (str.equals("usia")) {
            aVar = new s3.a(8);
            this.f7092a.put("usia", aVar);
        } else if (str.equals("usne")) {
            aVar = new s3.a(12);
            this.f7092a.put("usne", aVar);
        } else if (str.equals("usnh")) {
            aVar = new s3.a(13);
            this.f7092a.put("usnh", aVar);
        } else if (str.equals("usnj")) {
            aVar = new s3.a(14);
            this.f7092a.put("usnj", aVar);
        } else if (str.equals("ustn")) {
            aVar = new s3.a(16);
            this.f7092a.put("ustn", aVar);
        } else if (str.equals("usmn")) {
            aVar = new s3.a(9);
            this.f7092a.put("usmn", aVar);
        } else {
            aVar = null;
        }
        if (aVar != null) {
