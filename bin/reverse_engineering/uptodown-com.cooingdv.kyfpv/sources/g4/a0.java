...
public final /* synthetic */ class a0 implements View.OnClickListener {
    ...
    public final /* synthetic */ InstallerActivity f5138b;

    public /* synthetic */ a0(InstallerActivity installerActivity, int i) {
        this.f5137a = i;
        this.f5138b = installerActivity;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        int i = this.f5137a;
        InstallerActivity installerActivity = this.f5138b;
        switch (i) {
            case 0:
                int i6 = InstallerActivity.f3395j0;
                f4.a aVar = f4.a.f4870a;
                f4.a.f4873d.n(l4.j.f7118a);
            ...
            case 1:
                ...
                f4.a aVar2 = f4.a.f4870a;
                l4.a aVarC = aVar2.c();
                aVar2.a();
                f4.a.f4873d.n(new l4.e(aVarC));
                installerActivity.D();
                break;
            case 2:
            ...
            case 3:
                ...
                f4.a aVar3 = f4.a.f4870a;
                f4.a.f4873d.n(l4.k.f7119a);
                installerActivity.E();
                break;
            case 4:
