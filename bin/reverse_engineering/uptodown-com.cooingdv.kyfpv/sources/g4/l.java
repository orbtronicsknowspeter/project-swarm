...
public final /* synthetic */ class l implements View.OnClickListener {
    ...
    public final /* synthetic */ kotlin.jvm.internal.x f5209b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final /* synthetic */ FileExplorerActivity f5210l;

    public /* synthetic */ l(kotlin.jvm.internal.x xVar, FileExplorerActivity fileExplorerActivity, int i) {
        this.f5208a = i;
        this.f5209b = xVar;
        this.f5210l = fileExplorerActivity;
    }

    @Override // android.view.View.OnClickListener
    public final void onClick(View view) {
        int i = this.f5208a;
        FileExplorerActivity fileExplorerActivity = this.f5210l;
        kotlin.jvm.internal.x xVar = this.f5209b;
        switch (i) {
            case 0:
                int i6 = FileExplorerActivity.f3380q0;
                e1 e1Var = (e1) xVar.f7025a;
                if (e1Var != null) {
                    e1Var.c(null);
                }
