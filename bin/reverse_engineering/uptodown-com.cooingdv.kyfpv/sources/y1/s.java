...
public final class s implements Thread.UncaughtExceptionHandler {
    ...
    public final g5.g f11675a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final g2.e f11676b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final Thread.UncaughtExceptionHandler f11677c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final v1.b f11678d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final AtomicBoolean f11679e = new AtomicBoolean(false);

    public s(g5.g gVar, g2.e eVar, Thread.UncaughtExceptionHandler uncaughtExceptionHandler, v1.b bVar) {
        this.f11675a = gVar;
        this.f11676b = eVar;
        this.f11677c = uncaughtExceptionHandler;
        this.f11678d = bVar;
    }
    ...
    public final void uncaughtException(Thread thread, Throwable th) {
        Thread.UncaughtExceptionHandler uncaughtExceptionHandler = this.f11677c;
        AtomicBoolean atomicBoolean = this.f11679e;
        atomicBoolean.set(true);
        try {
            try {
                if (a(thread, th)) {
                    this.f11675a.y(this.f11676b, thread, th);
