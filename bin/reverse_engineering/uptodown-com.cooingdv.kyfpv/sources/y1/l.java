...
public final class l {
    ...
    public static final e2.a f11635r = new e2.a(3);

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public static final Charset f11636s = Charset.forName("UTF-8");
    ...
    public final m8.q f11639c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final e2.d f11640d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final z1.e f11641e;
    public final x f;
    public final e2.d g;
    public final a h;
    public final a2.f i;
    ...
    public final w1.a f11642k;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final i f11643l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final e2.d f11644m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public s f11645n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final j1.i f11646o = new j1.i();

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public final j1.i f11647p = new j1.i();

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public final j1.i f11648q = new j1.i();
    ...
    public static j1.p a(l lVar) {
        ...
        for (File file : e2.d.n(((File) lVar.g.f4469m).listFiles(f11635r))) {
            try {
    ...
    */
    ...
    public final void c(String str, Boolean bool) {
        ...
        x xVar = this.f;
        a aVar = this.h;
        l1 l1Var = new l1(xVar.f11692c, aVar.f, aVar.g, xVar.c().f11608a, k0.k.d(aVar.f11603d != null ? 4 : 1), aVar.h);
        ...
        if (!TextUtils.isEmpty(str8)) {
            f fVar2 = (f) f.f11618b.get(str8.toLowerCase(locale));
            if (fVar2 != null) {
                fVar = fVar2;
            }
        ...
        if (!bool.booleanValue() || str == null) {
            ...
            e2.d dVar = this.f11640d;
            synchronized (((String) dVar.f4467b)) {
                dVar.f4467b = str;
                str4 = str11;
                str5 = str9;
                str2 = str7;
                str3 = str10;
                i = 4;
                ((z1.e) dVar.f4469m).f11910b.a(new a2.r(dVar, str, ((a2.e) ((AtomicMarkableReference) ((a2.t) dVar.f4470n).f53b).getReference()).a(), ((a2.q) dVar.f4472p).a(), 0));
            }
        }
        a2.f fVar3 = this.i;
        ((a2.d) fVar3.f19b).b();
        ...
        this.f11643l.b(str);
        e2.d dVar2 = this.f11644m;
        r rVar = (r) dVar2.f4467b;
        Charset charset = n2.f887a;
        a0 a0Var = new a0();
        a0Var.f715a = "20.0.4";
        a aVar2 = rVar.f11672c;
        String str12 = aVar2.f11600a;
        if (str12 == null) {
            com.google.gson.internal.a.i("Null gmpAppId");
            return;
        }
        a0Var.f716b = str12;
        x xVar2 = rVar.f11671b;
        String str13 = xVar2.c().f11608a;
        if (str13 == null) {
            com.google.gson.internal.a.i("Null installationUuid");
            return;
        }
        a0Var.f718d = str13;
        a0Var.f719e = xVar2.c().f11609b;
        a0Var.f = xVar2.c().f11610c;
        ...
        i0Var.f810a = str16;
        String str17 = xVar2.f11692c;
        if (str17 == null) {
            com.google.gson.internal.a.i("Null identifier");
            return;
        }
        String str18 = xVar2.c().f11608a;
        m8.q qVar = aVar2.h;
        if (((m8.q) qVar.f7782l) == null) {
            qVar.f7782l = new m8.q(qVar);
        }
        m8.q qVar2 = (m8.q) qVar.f7782l;
        String str19 = (String) qVar2.f7781b;
        if (qVar2 == null) {
            qVar.f7782l = new m8.q(qVar);
        }
        i0Var.g = new k0(str17, str14, str15, str18, str19, (String) ((m8.q) qVar.f7782l).f7782l);
        h1 h1Var = new h1();
        h1Var.f800a = 3;
        ...
        a0Var.j = i0Var.a();
        b0 b0VarA = a0Var.a();
        e2.d dVar3 = ((e2.b) dVar2.f4468l).f4462b;
        ...
        try {
            ...
            OutputStreamWriter outputStreamWriter = new OutputStreamWriter(new FileOutputStream(fileH), e2.b.f4460e);
            try {
    ...
    public final String e() {
        NavigableSet navigableSetC = ((e2.b) this.f11644m.f4468l).c();
    ...
    public final String f() throws IOException {
        ...
        if (string != null) {
            ...
            return Base64.encodeToString(string.getBytes(f11636s), 0);
        }
    ...
    public final void g() {
        try {
            ...
            if (strF != null) {
                try {
                    ((a2.t) this.f11640d.f4471o).l("com.crashlytics.version-control-info", strF);
    ...
    public final void h(j1.p pVar) {
        j1.p pVar2;
        j1.p pVarA;
        j1.i iVar = this.f11646o;
        e2.d dVar = ((e2.b) this.f11644m.f4468l).f4462b;
        if (e2.d.n(((File) dVar.f4471o).listFiles()).isEmpty() && e2.d.n(((File) dVar.f4472p).listFiles()).isEmpty() && e2.d.n(((File) dVar.f4473q).listFiles()).isEmpty()) {
            if (Log.isLoggable("FirebaseCrashlytics", 2)) {
        ...
        if (tVar.a()) {
            ...
            synchronized (tVar.f11682c) {
                pVar2 = tVar.f11683d.f6540a;
            }
            q1.a aVar = new q1.a(18);
            pVar2.getClass();
            p2 p2Var = j1.j.f6541a;
            j1.p pVar3 = new j1.p();
            pVar2.f6562b.e(new j1.m(p2Var, aVar, pVar3));
            pVar2.p();
            cVar.b("Waiting for send/deleteUnsentReports to be called.");
            pVarA = z1.a.a(pVar3, this.f11647p.f6540a);
        }
        pVarA.j(this.f11641e.f11909a, new m8.q(this, pVar));
    }
}
