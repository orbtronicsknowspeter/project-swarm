...
public final class o {
    ...
    public synchronized int a() {
        ...
        if (this.f5103a == 0) {
            try {
                packageInfoB = r0.c.a((Context) this.f5105c).b(0, "com.google.android.gms");
            } catch (PackageManager.NameNotFoundException e10) {
                Log.w("Metadata", "Failed to find package ".concat(e10.toString()));
                packageInfoB = null;
            }
            if (packageInfoB != null) {
                this.f5103a = packageInfoB.versionCode;
            }
        }
        return this.f5103a;
    }
    ...
    */
    public synchronized int b() {
        /*
            r5 = this;
            monitor-enter(r5)
            int r0 = r5.f5104b     // Catch: java.lang.Throwable -> L2e
            if (r0 == 0) goto L7
            monitor-exit(r5)
            return r0
        L7:
            java.lang.Object r0 = r5.f5105c     // Catch: java.lang.Throwable -> L2e
            ...
            android.content.Context r0 = r0.f8856a     // Catch: java.lang.Throwable -> L2e
        ...
        L50:
            ...
            r2 = r1
        L6a:
            r5.f5104b = r2     // Catch: java.lang.Throwable -> L2e
            monitor-exit(r5)
            return r2
        L6e:
            java.lang.String r0 = "Metadata"
