...
public abstract class c {
    ...
    public static long a(c0 c0Var) {
        String strA = c0Var.f7698o.a("Content-Length");
        if (strA == null) {
            return -1L;
        }
        try {
    ...
    public static boolean b(c0 c0Var) {
        if (c0Var.f7693a.f7675b.equals("HEAD")) {
            return false;
        }
        int i = c0Var.f7695l;
    ...
    /* JADX WARN: Code restructure failed: missing block: B:116:0x0208, code lost:
        ...
        if (r3.f8387a.get() != false) goto L241;
     */
    /* JADX WARN: Code restructure failed: missing block: B:118:0x0212, code lost:
    
        if (r3.f8387a.compareAndSet(false, true) == false) goto L241;
     */
