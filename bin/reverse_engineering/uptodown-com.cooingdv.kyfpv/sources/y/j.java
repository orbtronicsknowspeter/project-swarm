...
public final class j extends SQLiteOpenHelper {
    ...
    public static final String f11594l = "INSERT INTO global_log_event_state VALUES (" + System.currentTimeMillis() + ")";

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final int f11595m = 7;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final List f11596n = Arrays.asList(new i(0), new i(1), new i(2), new i(3), new i(4), new i(5), new i(6));
        ...
        while (i < i6) {
            switch (((i) list.get(i)).f11593a) {
                ...
                case 4:
                    ...
                    sQLiteDatabase.execSQL(f11594l);
                    break;
                case 5:
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        ...
        b(sQLiteDatabase, 0, this.f11597a);
    }
