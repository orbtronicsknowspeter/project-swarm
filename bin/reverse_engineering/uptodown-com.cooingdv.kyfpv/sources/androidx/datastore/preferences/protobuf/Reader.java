...
interface Reader {
    ...
    <T> void mergeGroupField(T t9, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;

    <T> void mergeMessageField(T t9, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws IOException;
