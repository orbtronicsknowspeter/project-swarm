...
final class BooleanArrayList extends AbstractProtobufList<Boolean> implements Internal.BooleanList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    private void addBoolean(int i, boolean z9) {
        int i6;
        ensureIsMutable();
    ...
    public void removeRange(int i, int i6) {
        ...
        boolean[] zArr = this.array;
        System.arraycopy(zArr, i6, zArr, i, this.size - i6);
        this.size -= i6 - i;
        ((AbstractList) this).modCount++;
    }
    ...
    @Override // androidx.datastore.preferences.protobuf.Internal.BooleanList
    public boolean setBoolean(int i, boolean z9) {
        ensureIsMutable();
        ensureIndexInRange(i);
        boolean[] zArr = this.array;
        boolean z10 = zArr[i];
    ...
    private BooleanArrayList(boolean[] zArr, int i, boolean z9) {
        super(z9);
        this.array = zArr;
        this.size = i;
    }
