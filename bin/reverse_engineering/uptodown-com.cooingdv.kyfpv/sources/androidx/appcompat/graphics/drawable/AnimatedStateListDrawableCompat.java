...
public class AnimatedStateListDrawableCompat extends StateListDrawableCompat implements TintAwareDrawable {
    ...
    public static class AnimationDrawableTransition extends Transition {
        ...
        public AnimationDrawableTransition(AnimationDrawable animationDrawable, boolean z9, boolean z10) {
            super();
            int numberOfFrames = animationDrawable.getNumberOfFrames();
            int i = z9 ? numberOfFrames - 1 : 0;
            int i6 = z9 ? 0 : numberOfFrames - 1;
            FrameInterpolator frameInterpolator = new FrameInterpolator(animationDrawable, z9);
            ObjectAnimator objectAnimatorOfInt = ObjectAnimator.ofInt(animationDrawable, "currentIndex", i, i6);
    ...
    public static class FrameInterpolator implements TimeInterpolator {
        ...
        public FrameInterpolator(AnimationDrawable animationDrawable, boolean z9) {
            updateFrames(animationDrawable, z9);
        }
        ...
        public float getInterpolation(float f) {
            ...
            return (i10 / i6) + (i10 < i6 ? i / this.mTotalDuration : 0.0f);
        }
        ...
        public int updateFrames(AnimationDrawable animationDrawable, boolean z9) {
            int numberOfFrames = animationDrawable.getNumberOfFrames();
    ...
    private int parseTransition(@NonNull Context context, @NonNull Resources resources, @NonNull XmlPullParser xmlPullParser, @NonNull AttributeSet attributeSet, @Nullable Resources.Theme theme) throws XmlPullParserException, IOException {
        ...
        boolean z9 = typedArrayObtainAttributes.getBoolean(R.styleable.AnimatedStateListDrawableTransition_android_reversible, false);
        typedArrayObtainAttributes.recycle();
        if (drawable == null) {
            do {
                next = xmlPullParser.next();
        ...
        if (resourceId != -1 && resourceId2 != -1) {
            return this.mState.addTransition(resourceId, resourceId2, drawable, z9);
        }
    ...
    public <T extends Drawable & Animatable> void addTransition(int i, int i6, @NonNull T t9, boolean z9) {
        ObjectsCompat.requireNonNull(t9);
        this.mState.addTransition(i, i6, t9, z9);
    }
    ...
    public boolean onStateChange(@NonNull int[] iArr) {
        ...
        boolean z9 = iIndexOfKeyframe != getCurrentIndex() && (selectTransition(iIndexOfKeyframe) || selectDrawable(iIndexOfKeyframe));
        Drawable current = getCurrent();
        return current != null ? current.setState(iArr) | z9 : z9;
    }
    ...
    public static class AnimatedStateListState extends StateListDrawableCompat.StateListState {
        ...
        private static long generateTransitionKey(int i, int i6) {
            return ((long) i6) | (((long) i) << 32);
        }
        ...
        public int addTransition(int i, int i6, @NonNull Drawable drawable, boolean z9) {
            int iAddChild = addChild(drawable);
            long jGenerateTransitionKey = generateTransitionKey(i, i6);
            long j = z9 ? REVERSIBLE_FLAG_BIT : 0L;
            long j6 = iAddChild;
            this.mTransitions.append(jGenerateTransitionKey, Long.valueOf(j6 | j));
            if (z9) {
                this.mTransitions.append(generateTransitionKey(i6, i), Long.valueOf(REVERSED_BIT | j6 | j));
            }
            return iAddChild;
        }
        ...
        public int indexOfTransition(int i, int i6) {
            return (int) this.mTransitions.get(generateTransitionKey(i, i6), -1L).longValue();
        }

        public boolean isTransitionReversed(int i, int i6) {
            return (this.mTransitions.get(generateTransitionKey(i, i6), -1L).longValue() & REVERSED_BIT) != 0;
        }
        ...
        public boolean transitionHasReversibleFlag(int i, int i6) {
            return (this.mTransitions.get(generateTransitionKey(i, i6), -1L).longValue() & REVERSIBLE_FLAG_BIT) != 0;
        }
