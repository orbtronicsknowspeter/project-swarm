...
public class WindowCallbackWrapper implements Window.Callback {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static void onPointerCaptureChanged(Window.Callback callback, boolean z9) {
    ...
    public WindowCallbackWrapper(Window.Callback callback) {
        if (callback != null) {
            ...
            a.p("Window callback may not be null");
            throw null;
        }
    }
    ...
    public void onPointerCaptureChanged(boolean z9) {
        Api26Impl.onPointerCaptureChanged(this.mWrapped, z9);
    }
    ...
    public void onWindowFocusChanged(boolean z9) {
        this.mWrapped.onWindowFocusChanged(z9);
    }
