...
public class ListMenuItemView extends LinearLayout implements MenuView.ItemView, AbsListView.SelectionBoundsAdjuster {
    ...
    public void setCheckable(boolean z9) {
        ...
        View view;
        if (!z9 && this.mRadioButton == null && this.mCheckBox == null) {
            return;
        }
    ...
    public void setForceShowIcon(boolean z9) {
        ...
        this.mPreserveIconSpacing = z9;
    }

    public void setGroupDividerEnabled(boolean z9) {
        ImageView imageView = this.mGroupDivider;
        if (imageView != null) {
            imageView.setVisibility((this.mHasListDivider || !z9) ? 8 : 0);
        }
    }

    @Override // androidx.appcompat.view.menu.MenuView.ItemView
    public void setIcon(Drawable drawable) {
        boolean z9 = this.mItemData.shouldShowIcon() || this.mForceShowIcon;
        if (z9 || this.mPreserveIconSpacing) {
    ...
    public void setShortcut(boolean z9, char c9) {
        int i = (z9 && this.mItemData.shouldShowShortcut()) ? 0 : 8;
        if (i == 0) {
