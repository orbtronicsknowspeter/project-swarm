...
public final class MenuItemImpl implements SupportMenuItem {
    ...
    public MenuItemImpl(MenuBuilder menuBuilder, int i, int i6, int i10, int i11, CharSequence charSequence, int i12) {
    ...
    private static void appendModifier(StringBuilder sb, int i, int i6, String str) {
        if ((i & i6) == i6) {
            sb.append(str);
        }
    }
    ...
    public MenuItem setAlphabeticShortcut(char c9, int i) {
        if (this.mShortcutAlphabeticChar == c9 && this.mShortcutAlphabeticModifiers == i) {
            return this;
        }
    ...
    public void setCheckedInt(boolean z9) {
        int i = this.mFlags;
        int i6 = (z9 ? 2 : 0) | (i & (-3));
        this.mFlags = i6;
        if (i != i6) {
    ...
    public void setExclusiveCheckable(boolean z9) {
        this.mFlags = (z9 ? 4 : 0) | (this.mFlags & (-5));
    }
    ...
    public MenuItem setNumericShortcut(char c9, int i) {
        if (this.mShortcutNumericChar == c9 && this.mShortcutNumericModifiers == i) {
            return this;
        }
    ...
    @Override // androidx.core.internal.view.SupportMenuItem, android.view.MenuItem
    @NonNull
    public MenuItem setShortcut(char c9, char c10, int i, int i6) {
        this.mShortcutNumericChar = c9;
        this.mShortcutNumericModifiers = KeyEvent.normalizeMetaState(i);
    ...
    public void setShowAsAction(int i) {
        int i6 = i & 3;
        if (i6 != 0 && i6 != 1 && i6 != 2) {
            a.p("SHOW_AS_ACTION_ALWAYS, SHOW_AS_ACTION_IF_ROOM, and SHOW_AS_ACTION_NEVER are mutually exclusive.");
        } else {
    ...
    public boolean setVisibleInt(boolean z9) {
        int i = this.mFlags;
        int i6 = (z9 ? 0 : 8) | (i & (-9));
        this.mFlags = i6;
        return i != i6;
