...
public class MenuBuilder implements SupportMenu {
    ...
    private MenuItemImpl createNewMenuItem(int i, int i6, int i10, int i11, CharSequence charSequence, int i12) {
        return new MenuItemImpl(this, i, i6, i10, i11, charSequence, i12);
    }
    ...
    private static int getOrdering(int i) {
        ...
        if (i6 >= 0) {
            ...
            if (i6 < iArr.length) {
                return (i & 65535) | (iArr[i6] << 16);
            }
        }
        a.p("order does not contain a valid category.");
        return 0;
    }

    private void removeItemAtInt(int i, boolean z9) {
    ...
    private void setHeaderInternal(int i, CharSequence charSequence, int i6, Drawable drawable, View view) {
    ...
    */
    ...
    @Override // android.view.Menu
    public int addIntentOptions(int i, int i6, int i10, ComponentName componentName, Intent[] intentArr, Intent intent, int i11, MenuItem[] menuItemArr) {
        int i12;
        ...
        for (int i13 = 0; i13 < size; i13++) {
            ...
            MenuItem intent3 = add(i, i6, i10, resolveInfo.loadLabel(packageManager)).setIcon(resolveInfo.loadIcon(packageManager)).setIntent(intent2);
    ...
    public MenuItem addInternal(int i, int i6, int i10, CharSequence charSequence) {
        int ordering = getOrdering(i10);
        MenuItemImpl menuItemImplCreateNewMenuItem = createNewMenuItem(i, i6, i10, ordering, charSequence, this.mDefaultShowAsAction);
    ...
    public int findGroupIndex(int i, int i6) {
        int size = size();
        if (i6 < 0) {
            i6 = 0;
        }
        while (i6 < size) {
            if (this.mItems.get(i6).getGroupId() == i) {
                return i6;
            }
            i6++;
        }
    ...
    public int findItemIndex(int i) {
        int size = size();
        for (int i6 = 0; i6 < size; i6++) {
            if (this.mItems.get(i6).getItemId() == i) {
                return i6;
            }
        }
        return -1;
    ...
    public ArrayList<MenuItemImpl> getVisibleItems() {
        boolean z9 = this.mIsVisibleItemsStale;
    ...
    @Override // android.view.Menu
    public boolean performIdentifierAction(int i, int i6) {
        return performItemAction(findItem(i), i6);
    }
    ...
    @Override // android.view.Menu
    public boolean performShortcut(int i, KeyEvent keyEvent, int i6) {
    ...
    public void removeGroup(int i) {
        ...
        if (iFindGroupIndex >= 0) {
            ...
            while (true) {
                int i10 = i6 + 1;
                if (i6 >= size || this.mItems.get(iFindGroupIndex).getGroupId() != i) {
                    break;
                }
    ...
    @Override // android.view.Menu
    public void setGroupCheckable(int i, boolean z9, boolean z10) {
        int size = this.mItems.size();
        for (int i6 = 0; i6 < size; i6++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i6);
    ...
    @Override // android.view.Menu
    public void setGroupEnabled(int i, boolean z9) {
        int size = this.mItems.size();
        for (int i6 = 0; i6 < size; i6++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i6);
            if (menuItemImpl.getGroupId() == i) {
    ...
    @Override // android.view.Menu
    public void setGroupVisible(int i, boolean z9) {
        int size = this.mItems.size();
        boolean z10 = false;
        for (int i6 = 0; i6 < size; i6++) {
            MenuItemImpl menuItemImpl = this.mItems.get(i6);
            if (menuItemImpl.getGroupId() == i && menuItemImpl.setVisibleInt(z9)) {
                z10 = true;
            }
        }
        if (z10) {
    ...
    @Override // android.view.Menu
    public MenuItem add(int i, int i6, int i10, CharSequence charSequence) {
        return addInternal(i, i6, i10, charSequence);
    }

    @Override // android.view.Menu
    public MenuItem add(int i, int i6, int i10, int i11) {
        return addInternal(i, i6, i10, this.mResources.getString(i11));
    }
    ...
    @Override // android.view.Menu
    public SubMenu addSubMenu(int i, int i6, int i10, int i11) {
        return addSubMenu(i, i6, i10, this.mResources.getString(i11));
    }
