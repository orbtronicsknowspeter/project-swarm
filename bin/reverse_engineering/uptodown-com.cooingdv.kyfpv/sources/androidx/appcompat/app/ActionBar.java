...
public abstract class ActionBar {
    ...
    @Deprecated
    public abstract void addTab(Tab tab, int i, boolean z9);

    @Deprecated
    public abstract void addTab(Tab tab, boolean z9);
    ...
    public abstract void setDisplayHomeAsUpEnabled(boolean z9);

    public abstract void setDisplayOptions(int i);

    public abstract void setDisplayOptions(int i, int i6);

    public abstract void setDisplayShowCustomEnabled(boolean z9);

    public abstract void setDisplayShowHomeEnabled(boolean z9);

    public abstract void setDisplayShowTitleEnabled(boolean z9);

    public abstract void setDisplayUseLogoEnabled(boolean z9);

    public void setElevation(float f) {
        if (f == 0.0f) {
            return;
        }
        a3.b.r("Setting a non-zero elevation is not supported in this action bar configuration.");
    }
    ...
    public void setHideOffset(int i) {
        ...
        a3.b.r("Setting an explicit action bar hide offset is not supported in this action bar configuration.");
    }

    public void setHideOnContentScrollEnabled(boolean z9) {
        if (z9) {
            a3.b.r("Hide on content scroll is not supported in this action bar configuration.");
        }
    }
