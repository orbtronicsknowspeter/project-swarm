...
class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    public static class Api33Impl {
        ...
        public static OnBackInvokedCallback registerOnBackPressedCallback(Object obj, final AppCompatDelegateImpl appCompatDelegateImpl) {
            ...
            a3.b.h(obj).registerOnBackInvokedCallback(1000000, onBackInvokedCallback);
            return onBackInvokedCallback;
        }

        @DoNotInline
        public static void unregisterOnBackInvokedCallback(Object obj, Object obj2) {
            a3.b.h(obj).unregisterOnBackInvokedCallback((OnBackInvokedCallback) obj2);
        }
    }
    ...
    public class ListMenuDecorView extends ContentFrameLayout {
        ...
        private boolean isOutOfBounds(int i, int i6) {
            return i < -5 || i6 < -5 || i > getWidth() + 5 || i6 > getHeight() + 5;
        }
    ...
    public final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(@NonNull MenuBuilder menuBuilder, boolean z9) {
            ...
            if (panelFeatureStateFindMenuPanel != null) {
                AppCompatDelegateImpl appCompatDelegateImpl2 = AppCompatDelegateImpl.this;
                if (!z10) {
                    appCompatDelegateImpl2.closePanel(panelFeatureStateFindMenuPanel, z9);
                } else {
    ...
    private boolean applyApplicationSpecificConfig(boolean z9, boolean z10) {
        if (this.mDestroyed) {
            return false;
        }
        ...
        if (!z10 && localeListCompatCalculateApplicationLocales != null) {
            localeListCompatCalculateApplicationLocales = getConfigurationLocales(this.mContext.getResources().getConfiguration());
        }
        boolean zUpdateAppConfiguration = updateAppConfiguration(iMapNightMode, localeListCompatCalculateApplicationLocales, z9);
    ...
    private void attachToWindow(@NonNull Window window) {
        if (this.mWindow != null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("AppCompat has already installed itself into the Window");
            return;
        }
    ...
    @NonNull
    private Configuration createOverrideAppConfiguration(@NonNull Context context, int i, @Nullable LocaleListCompat localeListCompat, @Nullable Configuration configuration, boolean z9) {
        int i6 = i != 1 ? i != 2 ? z9 ? 0 : context.getApplicationContext().getResources().getConfiguration().uiMode & 48 : 32 : 16;
    ...
    private ViewGroup createSubDecor() {
        ...
        if (!typedArrayObtainStyledAttributes.hasValue(androidx.appcompat.R.styleable.AppCompatTheme_windowActionBar)) {
            typedArrayObtainStyledAttributes.recycle();
            androidx.privacysandbox.ads.adservices.customaudience.a.i("You need to use a Theme.AppCompat theme (or descendant) with this activity.");
            return null;
        }
    ...
    private void ensureWindow() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i("We have not been given a Window");
    }
    ...
    */
    ...
    private boolean performPanelShortcut(PanelFeatureState panelFeatureState, int i, KeyEvent keyEvent, int i6) {
        ...
        if ((panelFeatureState.isPrepared || preparePanel(panelFeatureState, keyEvent)) && (menuBuilder = panelFeatureState.menu) != null) {
            zPerformShortcut = menuBuilder.performShortcut(i, keyEvent, i6);
        }
    ...
    private boolean preparePanel(PanelFeatureState panelFeatureState, KeyEvent keyEvent) {
        ...
        int i = panelFeatureState.featureId;
        boolean z9 = i == 0 || i == 108;
        if (z9 && (decorContentParent3 = this.mDecorContentParent) != null) {
            decorContentParent3.setMenuPrepared();
        }
        if (panelFeatureState.createdPanelView == null && (!z9 || !(peekSupportActionBar() instanceof ToolbarActionBar))) {
            ...
            if (menuBuilder == null || panelFeatureState.refreshMenuContent) {
                ...
                if (z9 && this.mDecorContentParent != null) {
                ...
                if (!windowCallback.onCreatePanelMenu(panelFeatureState.featureId, panelFeatureState.menu)) {
                    ...
                    if (z9 && (decorContentParent = this.mDecorContentParent) != null) {
            ...
            if (!windowCallback.onPreparePanel(0, panelFeatureState.createdPanelView, panelFeatureState.menu)) {
                if (z9 && (decorContentParent2 = this.mDecorContentParent) != null) {
    ...
    private void reopenMenu(boolean z9) {
        DecorContentParent decorContentParent = this.mDecorContentParent;
        ...
        Window.Callback windowCallback = getWindowCallback();
        if (this.mDecorContentParent.isOverflowMenuShowing() && z9) {
    ...
    */
    ...
    private void updateResourcesConfiguration(int i, @Nullable LocaleListCompat localeListCompat, boolean z9, @Nullable Configuration configuration) {
        ...
        if (z9 && (this.mHost instanceof Activity)) {
    ...
    public void closePanel(PanelFeatureState panelFeatureState, boolean z9) {
        ViewGroup viewGroup;
        DecorContentParent decorContentParent;
        if (z9 && panelFeatureState.featureId == 0 && (decorContentParent = this.mDecorContentParent) != null && decorContentParent.isOverflowMenuShowing()) {
    ...
    public View createView(View view, String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        ...
        if (z10) {
            ...
            if (this.mLayoutIncludeDetector.detect(attributeSet)) {
                ...
                z9 = zShouldInheritContext;
            }
        } else {
            z9 = zShouldInheritContext;
        }
        return this.mAppCompatViewInflater.createView(view, str, context, attributeSet, z9, z10, true, VectorEnabledTintResources.shouldBeUsed());
    }
    ...
    public PanelFeatureState getPanelState(int i, boolean z9) {
        PanelFeatureState[] panelFeatureStateArr = this.mPanels;
    ...
    public int mapNightMode(@NonNull Context context, int i) {
        ...
        if (i != -1) {
            ...
            if (i != 1 && i != 2) {
                ...
                androidx.privacysandbox.ads.adservices.customaudience.a.i("Unknown value set for night mode. Please use one of the MODE_NIGHT values from AppCompatDelegate.");
                return 0;
            }
        }
        return i;
    ...
    public boolean onBackPressed() {
        boolean z9 = this.mLongPressBackDown;
    ...
    */
    ...
    public void setHandleNativeActionModesEnabled(boolean z9) {
        this.mHandleNativeActionModes = z9;
    }
    ...
    */
    ...
    public void setSupportActionBar(Toolbar toolbar) {
        if (this.mHost instanceof Activity) {
            ...
            if (supportActionBar instanceof WindowDecorActionBar) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i("This Activity already has an action bar supplied by the window decor. Do not request Window.FEATURE_SUPPORT_ACTION_BAR and set windowActionBar to false in your theme to use a Toolbar instead.");
                return;
            }
    ...
    public ActionMode startSupportActionMode(@NonNull ActionMode.Callback callback) {
        ...
        if (callback == null) {
            com.google.gson.internal.a.p("ActionMode callback can not be null.");
            return null;
        }
        ActionMode actionMode = this.mActionMode;
        if (actionMode != null) {
    ...
    public final int updateStatusGuard(@Nullable WindowInsetsCompat windowInsetsCompat, @Nullable Rect rect) {
        ...
        if (actionBarContextView == null || !(actionBarContextView.getLayoutParams() instanceof ViewGroup.MarginLayoutParams)) {
            ...
            if (this.mActionModeView.isShown()) {
                ...
                if (marginLayoutParams.topMargin == i && marginLayoutParams.leftMargin == i6 && marginLayoutParams.rightMargin == i10) {
                    z10 = false;
                } else {
    ...
    private boolean applyApplicationSpecificConfig(boolean z9) {
        return applyApplicationSpecificConfig(z9, true);
    }
