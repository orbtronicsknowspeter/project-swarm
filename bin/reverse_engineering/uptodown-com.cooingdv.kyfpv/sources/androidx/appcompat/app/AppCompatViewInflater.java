...
public class AppCompatViewInflater {
    ...
    public static class DeclaredOnClickListener implements View.OnClickListener {
        ...
        private void resolveMethod(@Nullable Context context) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.k("Could not find method ", this.mMethodName, "(View) in a parent or ancestor Context for android:onClick attribute defined on view ", this.mHostView.getClass(), str);
        }
    ...
    private static Context themifyContext(Context context, AttributeSet attributeSet, boolean z9, boolean z10) {
        ...
        int resourceId = z9 ? typedArrayObtainStyledAttributes.getResourceId(androidx.appcompat.R.styleable.View_android_theme, 0) : 0;
