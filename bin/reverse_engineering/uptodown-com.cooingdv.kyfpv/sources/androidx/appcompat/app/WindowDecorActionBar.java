...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    public static boolean checkShowingFlags(boolean z9, boolean z10, boolean z11) {
        if (z11) {
            return true;
        }
    ...
    private void configureTab(ActionBar.Tab tab, int i) {
        ...
        if (tabImpl.getCallback() == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Action Bar Tab must have a Callback");
            return;
        }
    ...
    private void init(View view) {
        ...
        if (decorToolbar == null || this.mContextView == null || actionBarContainer == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(getClass().getSimpleName().concat(" can only be used with a compatible window decor layout"));
            return;
        }
    ...
    private void setHasEmbeddedTabs(boolean z9) {
        ...
        this.mDecorToolbar.setCollapsible(!this.mHasEmbeddedTabs && z10);
    ...
    public void animateToMode(boolean z9) {
        ...
        if (z9) {
            viewPropertyAnimatorCompat2 = decorToolbar2.setupAnimatorToVisibility(4, FADE_OUT_DURATION_MS);
            viewPropertyAnimatorCompat = this.mContextView.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
        } else {
            viewPropertyAnimatorCompat = decorToolbar2.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
    ...
    public void dispatchMenuVisibilityChanged(boolean z9) {
        ...
        for (int i = 0; i < size; i++) {
            this.mMenuVisibilityListeners.get(i).onMenuVisibilityChanged(z9);
        }
    }
    ...
    public void setDisplayOptions(int i, int i6) {
        ...
        this.mDecorToolbar.setDisplayOptions((i & i6) | ((~i6) & displayOptions));
    }
    ...
    public void setHideOffset(int i) {
        if (i == 0 || this.mOverlayLayout.isInOverlayMode()) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to set a non-zero hide offset");
        }
    }
    ...
    public void setHideOnContentScrollEnabled(boolean z9) {
        if (z9 && !this.mOverlayLayout.isInOverlayMode()) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Action bar must be in overlay mode (Window.FEATURE_OVERLAY_ACTION_BAR) to enable hide on content scroll");
        } else {
    ...
    public void setSelectedNavigationItem(int i) {
        ...
        if (navigationMode == 1) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i("setSelectedNavigationIndex not valid for current navigation mode");
        }
    }
    ...
    @Override // androidx.appcompat.app.ActionBar
    public void addTab(ActionBar.Tab tab, int i, boolean z9) {
        ensureTabsExist();
        this.mTabScrollView.addTab(tab, i, z9);
        configureTab(tab, i);
        if (z9) {
            selectTab(tab);
        }
