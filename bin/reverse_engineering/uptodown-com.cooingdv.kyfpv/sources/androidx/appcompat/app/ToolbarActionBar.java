...
class ToolbarActionBar extends ActionBar {
    ...
    public void setDisplayOptions(int i, int i6) {
        this.mDecorToolbar.setDisplayOptions((i & i6) | ((~i6) & this.mDecorToolbar.getDisplayOptions()));
    }
    ...
    public void setNavigationMode(int i) {
        if (i != 2) {
            ...
            com.google.gson.internal.a.p("Tabs not supported in this configuration");
        }
    }
