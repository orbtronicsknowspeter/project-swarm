...
class TooltipPopup {
    ...
    private void computePosition(View view, int i, int i6, boolean z9, WindowManager.LayoutParams layoutParams) {
        int height;
        int i10;
        ...
        if (view.getHeight() >= dimensionPixelOffset) {
            ...
            i10 = i6 - dimensionPixelOffset2;
        } else {
            height = view.getHeight();
            i10 = 0;
        }
        layoutParams.gravity = 49;
        int dimensionPixelOffset3 = this.mContext.getResources().getDimensionPixelOffset(z9 ? R.dimen.tooltip_y_offset_touch : R.dimen.tooltip_y_offset_non_touch);
        ...
        layoutParams.x = (i12 + i) - (appRootView.getWidth() / 2);
    ...
    public void show(View view, int i, int i6, boolean z9, CharSequence charSequence) {
        if (isShowing()) {
            hide();
        }
        this.mMessageView.setText(charSequence);
        computePosition(view, i, i6, z9, this.mLayoutParams);
