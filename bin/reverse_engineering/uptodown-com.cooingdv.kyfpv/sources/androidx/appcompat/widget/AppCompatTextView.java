...
public class AppCompatTextView extends TextView implements TintableBackgroundView, TintableCompoundDrawablesView, AutoSizeableTextView, EmojiCompatConfigurationView {
    ...
    public interface SuperCaller {
        ...
        void setAutoSizeTextTypeUniformWithConfiguration(int i, int i6, int i10, int i11);
    ...
    public void onLayout(boolean z9, int i, int i6, int i10, int i11) {
        ...
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onLayout(z9, i, i6, i10, i11);
        }
    }
    ...
    public void setAutoSizeTextTypeUniformWithConfiguration(int i, int i6, int i10, int i11) throws IllegalArgumentException {
        if (ViewUtils.SDK_LEVEL_SUPPORTS_AUTOSIZE) {
            getSuperCaller().setAutoSizeTextTypeUniformWithConfiguration(i, i6, i10, i11);
            return;
        }
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.setAutoSizeTextTypeUniformWithConfiguration(i, i6, i10, i11);
        }
    }
    ...
    public void setCompoundDrawablesRelativeWithIntrinsicBounds(int i, int i6, int i10, int i11) {
        ...
        setCompoundDrawablesRelativeWithIntrinsicBounds(i != 0 ? AppCompatResources.getDrawable(context, i) : null, i6 != 0 ? AppCompatResources.getDrawable(context, i6) : null, i10 != 0 ? AppCompatResources.getDrawable(context, i10) : null, i11 != 0 ? AppCompatResources.getDrawable(context, i11) : null);
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onSetCompoundDrawables();
        }
    ...
    public void setCompoundDrawablesWithIntrinsicBounds(int i, int i6, int i10, int i11) {
        Context context = getContext();
        setCompoundDrawablesWithIntrinsicBounds(i != 0 ? AppCompatResources.getDrawable(context, i) : null, i6 != 0 ? AppCompatResources.getDrawable(context, i6) : null, i10 != 0 ? AppCompatResources.getDrawable(context, i10) : null, i11 != 0 ? AppCompatResources.getDrawable(context, i11) : null);
        AppCompatTextHelper appCompatTextHelper = this.mTextHelper;
        if (appCompatTextHelper != null) {
            appCompatTextHelper.onSetCompoundDrawables();
        }
    ...
    @Override // android.widget.TextView
    public void setFirstBaselineToTopHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i) {
    ...
    @Override // android.widget.TextView
    public void setLastBaselineToBottomHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i) {
        if (Build.VERSION.SDK_INT >= 28) {
    ...
    @Override // android.widget.TextView
    public void setLineHeight(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) @Px int i) {
    ...
    public class SuperCallerApi26 implements SuperCaller {
        ...
        @Override // androidx.appcompat.widget.AppCompatTextView.SuperCaller
        public void setAutoSizeTextTypeUniformWithConfiguration(int i, int i6, int i10, int i11) {
            AppCompatTextView.super.setAutoSizeTextTypeUniformWithConfiguration(i, i6, i10, i11);
        }
