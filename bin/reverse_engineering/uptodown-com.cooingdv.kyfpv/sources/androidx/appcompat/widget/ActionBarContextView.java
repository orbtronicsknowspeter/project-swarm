...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public void onLayout(boolean z9, int i, int i6, int i10, int i11) {
        ...
        int paddingRight = zIsLayoutRtl ? (i10 - i) - getPaddingRight() : getPaddingLeft();
        ...
        int paddingLeft = zIsLayoutRtl ? getPaddingLeft() : (i10 - i) - getPaddingRight();
    ...
    public void onMeasure(int i, int i6) {
        ...
        if (mode != 1073741824) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(getClass().getSimpleName().concat(" can only be used with android:layout_width=\"match_parent\" (or fill_parent)"));
            return;
        }
        if (View.MeasureSpec.getMode(i6) == 0) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(getClass().getSimpleName().concat(" can only be used with android:layout_height=\"wrap_content\""));
            return;
        }
