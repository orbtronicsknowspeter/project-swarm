...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            StringBuilder sbP = x.p(iconResource, "Invalid icon resource ", " for ");
            sbP.append(componentName.flattenToShortString());
            Log.w(LOG_TAG, sbP.toString());
            return null;
        ...
        try {
            ...
            if (size == 1) {
                try {
                    ...
                    o.p(uri, "Single path segment is not a resource ID: ");
                    return null;
                }
            } else {
                if (size != 2) {
                    o.p(uri, "More than two path segments: ");
                    return null;
                }
            ...
            o.p(uri, "No resource found for: ");
            return null;
        } catch (PackageManager.NameNotFoundException unused2) {
            o.p(uri, "No package found for authority: ");
            return null;
        }
    }
