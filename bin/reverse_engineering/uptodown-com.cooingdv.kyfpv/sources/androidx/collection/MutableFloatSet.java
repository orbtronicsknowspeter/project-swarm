...
public final class MutableFloatSet extends FloatSet {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i10 < i6) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                int iFindFirstAvailableSlot = mutableFloatSet.findFirstAvailableSlot(i11 >>> 7);
                long j = i11 & 127;
                ...
                int i14 = mutableFloatSet._capacity;
    ...
    */
    ...
    public /* synthetic */ MutableFloatSet(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }
