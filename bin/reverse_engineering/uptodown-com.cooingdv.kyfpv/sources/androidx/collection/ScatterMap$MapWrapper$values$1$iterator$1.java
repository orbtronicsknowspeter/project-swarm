...
public final class ScatterMap$MapWrapper$values$1$iterator$1 extends h implements p {
    ...
    public ScatterMap$MapWrapper$values$1$iterator$1(ScatterMap<K, V> scatterMap, c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(k7.h hVar, c cVar) {
        return ((ScatterMap$MapWrapper$values$1$iterator$1) create(hVar, cVar)).invokeSuspend(x.f8464a);
    }
