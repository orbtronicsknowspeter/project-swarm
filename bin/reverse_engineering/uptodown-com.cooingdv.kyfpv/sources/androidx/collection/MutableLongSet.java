...
public final class MutableLongSet extends LongSet {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i10 < i6) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                int i12 = i11 ^ (i11 << 16);
                int iFindFirstAvailableSlot = mutableLongSet.findFirstAvailableSlot(i12 >>> 7);
                long j6 = i12 & 127;
                ...
                int i15 = mutableLongSet._capacity;
                int i16 = ((iFindFirstAvailableSlot - 7) & i15) + (i15 & 7);
                int i17 = i16 >> 3;
                int i18 = (i16 & 7) << 3;
                jArr = jArr2;
                jArr5[i17] = ((~(255 << i18)) & jArr5[i17]) | (j6 << i18);
    ...
    */
    ...
    public /* synthetic */ MutableLongSet(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }
