...
public final class MutableIntIntMap extends IntIntMap {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i10 < i6) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                int i13 = i12 ^ (i12 << 16);
                int iFindFirstAvailableSlot = mutableIntIntMap.findFirstAvailableSlot(i13 >>> 7);
                long j = i13 & 127;
                ...
                int i16 = mutableIntIntMap._capacity;
                int i17 = ((iFindFirstAvailableSlot - 7) & i16) + (i16 & 7);
                int i18 = i17 >> 3;
                int i19 = (i17 & 7) << 3;
                jArr = jArr2;
                jArr3[i18] = ((~(255 << i19)) & jArr3[i18]) | (j << i19);
                iArr3[iFindFirstAvailableSlot] = i11;
                iArr4[iFindFirstAvailableSlot] = iArr2[i10];
            } else {
                jArr = jArr2;
            }
            i10++;
    ...
    public final int getOrPut(int i, d7.a aVar) {
        aVar.getClass();
    ...
    public final int put(int i, int i6, int i10) {
    ...
    public final boolean remove(int i, int i6) {
        int iFindKeyIndex = findKeyIndex(i);
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (((Boolean) pVar.invoke(Integer.valueOf(this.keys[i11]), Integer.valueOf(this.values[i11]))).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(int i, int i6) {
        int iFindInsertIndex = findInsertIndex(i);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        }
    ...
    public /* synthetic */ MutableIntIntMap(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }

    public final void put(int i, int i6) {
        set(i, i6);
    }
