...
public abstract class ObjectIntMap<K> {
    ...
    public static /* synthetic */ String joinToString$default(ObjectIntMap objectIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, p pVar, int i6, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i10;
        if (obj != null) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr3;
                            sbR.append((CharSequence) pVar.invoke(obj2, Integer.valueOf(i19)));
                            i13++;
                        } else {
                            jArr2 = jArr3;
                            i10 = i15;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (!((Boolean) pVar.invoke(objArr[i11], Integer.valueOf(iArr[i11]))).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j) < 128) {
                        int i12 = (i << 3) + i11;
                        if (((Boolean) pVar.invoke(objArr[i12], Integer.valueOf(iArr[i12]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j >>= 8;
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        pVar.invoke(objArr[i11], Integer.valueOf(iArr[i11]));
                    }
                    j >>= 8;
                }
                if (i6 != 8) {
    ...
    public final int getOrDefault(K k5, int i) {
        int iFindKeyIndex = findKeyIndex(k5);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : i;
    }

    public final int getOrElse(K k5, a aVar) {
        aVar.getClass();
        int iFindKeyIndex = findKeyIndex(k5);
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        ...
                        iHashCode += iArr[i11] ^ (obj != null ? obj.hashCode() : 0);
                    }
                    j >>= 8;
                }
                if (i6 != 8) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            sbR.append((CharSequence) pVar.invoke(obj, Integer.valueOf(i15)));
                            i10++;
                        } else {
                            objArr2 = objArr3;
                        }
    ...
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, java.lang.CharSequence r23, int r24, d7.p r25) {
        ...
        L85:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.ObjectIntMap.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, int, d7.p):java.lang.String");
    }
    ...
    public static /* synthetic */ String joinToString$default(ObjectIntMap objectIntMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i6, Object obj) {
        if (obj != null) {
            b.r("Super calls with default arguments not supported in this target, function: joinToString");
            return null;
        }
    ...
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, java.lang.CharSequence r23, d7.p r24) {
        ...
        L84:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.ObjectIntMap.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, d7.p):java.lang.String");
    }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((255 & j) < 128) {
                            ...
                            i = i11;
                            sb.append((CharSequence) pVar.invoke(obj, Integer.valueOf(i15)));
                            i10++;
                        } else {
                            i = i11;
                        }
