...
public class CustomTabsSessionToken {
    ...
    public CustomTabsSessionToken(@Nullable android.support.customtabs.c cVar, @Nullable PendingIntent pendingIntent) {
        if (cVar == null && pendingIntent == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("CustomTabsSessionToken must have either a session id or a callback (or both).");
            throw null;
        }
        ...
        this.mCallback = cVar == null ? null : new CustomTabsCallback() { // from class: androidx.browser.customtabs.CustomTabsSessionToken.1
            ...
            @Override // androidx.browser.customtabs.CustomTabsCallback
            public void onActivityLayout(int i, int i6, int i10, int i11, int i12, @NonNull Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onActivityLayout(i, i6, i10, i11, i12, bundle);
                } catch (RemoteException unused) {
                    Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                }
            }
            ...
            @Override // androidx.browser.customtabs.CustomTabsCallback
            public void onActivityResized(int i, int i6, @NonNull Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onActivityResized(i, i6, bundle);
                } catch (RemoteException unused) {
                    Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                }
            }
            ...
            @Override // androidx.browser.customtabs.CustomTabsCallback
            public void onRelationshipValidationResult(int i, @NonNull Uri uri, boolean z9, @Nullable Bundle bundle) {
                try {
                    CustomTabsSessionToken.this.mCallbackBinder.onRelationshipValidationResult(i, uri, z9, bundle);
                } catch (RemoteException unused) {
                    Log.e(CustomTabsSessionToken.TAG, "RemoteException during ICustomTabsCallback transaction");
                }
            }
    ...
    private IBinder getCallbackBinderAssertNotNull() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i("CustomTabSessionToken must have valid binder or pending session");
        return null;
    }
    ...
    public static class MockCallback extends android.support.customtabs.b {
        ...
        @Override // android.support.customtabs.c
        public void onActivityResized(int i, int i6, Bundle bundle) {
        }
