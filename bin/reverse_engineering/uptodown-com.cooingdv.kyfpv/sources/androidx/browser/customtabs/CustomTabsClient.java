...
public class CustomTabsClient {
    ...
    private android.support.customtabs.b createCallbackWrapper(@Nullable final CustomTabsCallback customTabsCallback) {
        return new android.support.customtabs.b() { // from class: androidx.browser.customtabs.CustomTabsClient.2
            ...
            @Override // android.support.customtabs.c
            public void onActivityLayout(final int i, final int i6, final int i10, final int i11, final int i12, @NonNull final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.8
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onActivityLayout(i, i6, i10, i11, i12, bundle);
                    }
                });
            }

            @Override // android.support.customtabs.c
            public void onActivityResized(final int i, final int i6, @Nullable final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.6
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onActivityResized(i, i6, bundle);
                    }
                });
            }
            ...
            @Override // android.support.customtabs.c
            public void onRelationshipValidationResult(final int i, final Uri uri, final boolean z9, @Nullable final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
                this.mHandler.post(new Runnable() { // from class: androidx.browser.customtabs.CustomTabsClient.2.5
                    @Override // java.lang.Runnable
                    public void run() {
                        customTabsCallback.onRelationshipValidationResult(i, uri, z9, bundle);
                    }
                });
            }
    ...
    @Nullable
    public static String getPackageName(@NonNull Context context, @Nullable List<String> list, boolean z9) {
