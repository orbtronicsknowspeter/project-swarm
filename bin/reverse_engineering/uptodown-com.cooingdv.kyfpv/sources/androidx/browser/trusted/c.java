...
public final /* synthetic */ class c implements Runnable {
    ...
    private final void a() {
        ...
        synchronized (nVar) {
            try {
                if (nVar.f9145b == null) {
                    nVar.f9144a.add(bVar);
                } else {
                    nVar.f9145b.add(bVar.get());
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    public final void run() {
        ...
        switch (this.f324a) {
            ...
            case 10:
                ...
                if (z9) {
                    mainActivity.f3310g0 = 0;
                    LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(mainActivity);
                    e eVar = m0.f8289a;
                    c0.s(lifecycleScope, t7.n.f10349a, null, new h3(mainActivity, gVar, objArr2 == true ? 1 : 0, i10), 2);
                    return;
                }
                int i12 = mainActivity.f3310g0;
                if (i12 >= 5) {
                    mainActivity.f3310g0 = 0;
                    LifecycleCoroutineScope lifecycleScope2 = LifecycleOwnerKt.getLifecycleScope(mainActivity);
                    e eVar2 = m0.f8289a;
                    c0.s(lifecycleScope2, t7.n.f10349a, null, new h3(mainActivity, gVar, objArr == true ? 1 : 0, i), 2);
                    return;
                }
                mainActivity.f3310g0 = i12 + 1;
                Handler handler = mainActivity.f3309f0;
                c cVar = mainActivity.f3328z0;
                if (cVar != null) {
            ...
            case 12:
                ...
                try {
                    r.a().f8853d.a(((j) cVar2.h.f81b).a(d.f8129l), 1);
                    break;
            ...
            case 13:
                ...
                g gVar2 = tvAppDetailFragment.f3414a;
                if (gVar2 == null || rVar == null || (str = rVar.f11356b) == null || !str.equalsIgnoreCase(gVar2.F)) {
                    return;
                }
                if (i15 == 200) {
                ...
                if (i15 == 202) {
                    ...
                    builder.setTitle(rVar.f11367w);
                    builder.setPositiveButton(R.string.option_button_install, new g5.c(rVar, tvAppDetailFragment));
                    builder.setNegativeButton(android.R.string.cancel, new f5.b(3));
            ...
            case 16:
                ...
                String string = s0Var.getString(R.string.msg_connected_to_service);
            ...
            case 17:
                ...
                s0Var2.E();
                View viewInflate = View.inflate(s0Var2, R.layout.dialog_confirm_receive, null);
                View viewFindViewById = viewInflate.findViewById(R.id.tv_msg_confirm);
                viewFindViewById.getClass();
                TextView textView = (TextView) viewFindViewById;
                textView.setTypeface(f4.c.f4884x);
                String string2 = s0Var2.getString(R.string.msg_confirm_receive_file);
                string2.getClass();
                textView.setText(String.format(string2, Arrays.copyOf(new Object[]{cVar3.f, cVar3.f7105b}, 2)));
            ...
            case 18:
                ...
                if (viewFindSnapView == null || (childAdapterPosition = recyclerView.getChildAdapterPosition(viewFindSnapView) % jVar.f4570c.size()) == -1) {
                    return;
                }
                Object obj = jVar.f4570c.get(childAdapterPosition);
                obj.getClass();
                g gVar3 = (g) obj;
                if (!gVar3.m() || vVar.f7613p) {
                    return;
                }
                lVar.c(gVar3);
                vVar.f7613p = true;
            ...
            case 22:
                ...
                Process.setThreadPriority(aVar2.f9505c);
                StrictMode.ThreadPolicy threadPolicy = aVar2.f9506d;
            ...
            case 23:
                ...
                h hVar = (h) ((g5.g) this.f326l).f5316b;
                try {
