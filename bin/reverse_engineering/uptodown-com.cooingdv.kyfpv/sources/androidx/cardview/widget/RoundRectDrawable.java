...
class RoundRectDrawable extends Drawable {
    ...
    public boolean onStateChange(int[] iArr) {
        ...
        boolean z9 = colorForState != this.mPaint.getColor();
        if (z9) {
    ...
    public void setPadding(float f, boolean z9, boolean z10) {
        if (f == this.mPadding && this.mInsetForPadding == z9 && this.mInsetForRadius == z10) {
            return;
        }
        this.mPadding = f;
        this.mInsetForPadding = z9;
        this.mInsetForRadius = z10;
        updateBounds(null);
        invalidateSelf();
    }
