...
public final class MeasurementManagerFutures$Api33Ext5JavaImpl$registerTriggerAsync$1 extends i implements p {
    ...
    public MeasurementManagerFutures$Api33Ext5JavaImpl$registerTriggerAsync$1(MeasurementManagerFutures.Api33Ext5JavaImpl api33Ext5JavaImpl, Uri uri, c cVar) {
        super(2, cVar);
    ...
    public final Object invoke(a0 a0Var, c cVar) {
        return ((MeasurementManagerFutures$Api33Ext5JavaImpl$registerTriggerAsync$1) create(a0Var, cVar)).invokeSuspend(x.f8464a);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            Object objRegisterTrigger = measurementManager.registerTrigger(uri, this);
            u6.a aVar = u6.a.f10763a;
            if (objRegisterTrigger == aVar) {
                return aVar;
            }
        } else {
            if (i != 1) {
