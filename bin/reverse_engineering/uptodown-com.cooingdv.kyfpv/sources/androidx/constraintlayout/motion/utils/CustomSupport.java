...
public class CustomSupport {
    ...
    public static void setInterpolatedValue(ConstraintAttribute constraintAttribute, View view, float[] fArr) {
        ...
        try {
            ...
            StringBuilder sbV = x.v("Cannot access method ", str, " on View \"");
            sbV.append(Debug.getName(view));
            sbV.append("\"");
            Log.e(TAG, sbV.toString(), e10);
        } catch (NoSuchMethodException e11) {
            StringBuilder sbV2 = x.v("No method ", str, " on View \"");
            sbV2.append(Debug.getName(view));
            sbV2.append("\"");
            Log.e(TAG, sbV2.toString(), e11);
        } catch (InvocationTargetException e12) {
            StringBuilder sbV3 = x.v("Cannot invoke method ", str, " on View \"");
            sbV3.append(Debug.getName(view));
            sbV3.append("\"");
            Log.e(TAG, sbV3.toString(), e12);
        }
    }
}
