...
public class Constraint {
    ...
    public void linkToBaseline(VAnchor vAnchor, int i, int i6) {
    ...
    public void linkToBottom(VAnchor vAnchor, int i, int i6) {
    ...
    public void linkToEnd(HAnchor hAnchor, int i, int i6) {
    ...
    public void linkToLeft(HAnchor hAnchor, int i, int i6) {
    ...
    public void linkToRight(HAnchor hAnchor, int i, int i6) {
    ...
    public void linkToStart(HAnchor hAnchor, int i, int i6) {
    ...
    public void linkToTop(VAnchor vAnchor, int i, int i6) {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(x.n(new StringBuilder(), this.mId, ":{\n"));
        this.mLeft.build(sb);
