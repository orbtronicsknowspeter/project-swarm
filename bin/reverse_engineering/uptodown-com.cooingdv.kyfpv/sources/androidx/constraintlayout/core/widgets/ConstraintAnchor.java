...
public class ConstraintAnchor {
    ...
    public boolean connect(ConstraintAnchor constraintAnchor, int i, int i6, boolean z9) {
        if (constraintAnchor == null) {
            reset();
            return true;
        }
        if (!z9 && !isValidConnection(constraintAnchor)) {
            return false;
        }
    ...
    public boolean isValidConnection(ConstraintAnchor constraintAnchor) {
        ...
        switch (type2) {
            ...
            case LEFT:
            case RIGHT:
                boolean z9 = type == Type.LEFT || type == Type.RIGHT;
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    if (z9 || type == Type.CENTER_X) {
                    }
                }
                break;
            case TOP:
            case BOTTOM:
                boolean z10 = type == Type.TOP || type == Type.BOTTOM;
                if (constraintAnchor.getOwner() instanceof Guideline) {
                    if (z10 || type == Type.CENTER_Y) {
                    }
                }
                break;
            case BASELINE:
