    ...
    public final int compare(Object obj, Object obj2) {
        switch (this.f329a) {
            ...
            case 5:
                ...
                eVar3.getClass();
                eVar4.getClass();
                String str3 = eVar3.f11123b;
                if (str3 == null) {
                    return 1;
                }
                String str4 = eVar4.f11123b;
                if (str4 == null) {
                    return -1;
                }
            ...
            case 6:
                ...
                nVar.getClass();
                nVar2.getClass();
                File file = nVar.f7121a;
                if (file == null) {
                    return 1;
                }
                if (nVar2.f7121a == null) {
                    return -1;
                }
                String name2 = file.getName();
                name2.getClass();
                File file2 = nVar2.f7121a;
                file2.getClass();
            ...
            case 7:
                ...
                nVar3.getClass();
                nVar4.getClass();
                if (nVar3.f7121a == null) {
                    return 1;
                }
                if (nVar4.f7121a == null) {
                    return -1;
                }
                return Boolean.compare(!nVar3.f7122b, !nVar4.f7122b);
            case 8:
                n nVar5 = (n) obj;
                n nVar6 = (n) obj2;
                nVar5.getClass();
                nVar6.getClass();
                File file3 = nVar5.f7121a;
                if (file3 == null) {
                    return 1;
                }
                if (nVar6.f7121a == null) {
                    return -1;
                }
                String name4 = file3.getName();
                name4.getClass();
                File file4 = nVar6.f7121a;
                file4.getClass();
            ...
            case 9:
                ...
                nVar7.getClass();
                nVar8.getClass();
                File file5 = nVar7.f7121a;
                if (file5 == null) {
                    return 1;
                }
                if (nVar8.f7121a == null) {
                    return -1;
                }
                String name6 = file5.getName();
                name6.getClass();
                File file6 = nVar8.f7121a;
                file6.getClass();
            ...
            case 10:
                ...
                nVar9.getClass();
                nVar10.getClass();
                File file7 = nVar9.f7121a;
                if (file7 == null) {
                    return 1;
                }
                if (nVar10.f7121a == null) {
                    return -1;
                }
                String name8 = file7.getName();
                name8.getClass();
                File file8 = nVar10.f7121a;
                file8.getClass();
            ...
            case 11:
                ...
                eVar5.getClass();
                eVar6.getClass();
                String str5 = eVar5.f11123b;
                if (str5 == null) {
                    return 1;
                }
                String str6 = eVar6.f11123b;
                if (str6 == null) {
                    return -1;
                }
