...
public class SharedValues {
    ...
    public interface SharedValuesListener {
        void onNewValue(int i, int i6, int i10);
    }
    ...
    public void fireNewValue(int i, int i6) {
        int i10 = this.mValues.get(i, -1);
        if (i10 == i6) {
            return;
        }
        this.mValues.put(i, i6);
        HashSet<WeakReference<SharedValuesListener>> hashSet = this.mValuesListeners.get(Integer.valueOf(i));
        if (hashSet == null) {
            return;
        }
        ...
        while (it.hasNext()) {
            ...
            if (sharedValuesListener != null) {
                sharedValuesListener.onNewValue(i, i6, i10);
            } else {
                z9 = true;
            }
        }
