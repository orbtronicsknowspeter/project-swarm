...
public class ConstraintLayoutStates {
    ...
    public boolean needsToChange(int i, float f, float f10) {
        ...
        State stateValueAt = i == -1 ? sparseArray.valueAt(0) : sparseArray.get(i6);
        int i10 = this.mCurrentConstraintNumber;
        return (i10 == -1 || !stateValueAt.mVariants.get(i10).match(f, f10)) && this.mCurrentConstraintNumber != stateValueAt.findMatch(f, f10);
    }
    ...
    public void updateConstraints(int i, float f, float f10) {
        int iFindMatch;
        int i6 = this.mCurrentStateId;
        if (i6 == i) {
            SparseArray<State> sparseArray = this.mStateList;
            State stateValueAt = i == -1 ? sparseArray.valueAt(0) : sparseArray.get(i6);
            int i10 = this.mCurrentConstraintNumber;
            if ((i10 == -1 || !stateValueAt.mVariants.get(i10).match(f, f10)) && this.mCurrentConstraintNumber != (iFindMatch = stateValueAt.findMatch(f, f10))) {
        ...
        if (constraintSet2 == null) {
            Log.v("ConstraintLayoutStates", "NO Constraint set found ! id=" + i + ", dim =" + f + ", " + f10);
            return;
        }
