                ...
                if (preference instanceof PreferenceGroup) {
                    ...
                    if (!preferenceGroup2.isOnSameScreenAsChildren()) {
                        ...
                        if (isGroupExpandable(preferenceGroup) && isGroupExpandable(preferenceGroup2)) {
                            androidx.privacysandbox.ads.adservices.customaudience.a.i("Nesting an expandable group inside of another expandable group is not supported!");
                            return null;
                        }
        ...
        if (preferenceManager == null || preferenceManager.getPreferenceComparisonCallback() == null) {
            ...
            DiffUtil.calculateDiff(new DiffUtil.Callback() { // from class: androidx.preference.PreferenceGroupAdapter.2
                ...
                public boolean areContentsTheSame(int i, int i6) {
                    return preferenceComparisonCallback.arePreferenceContentsTheSame((Preference) list.get(i), (Preference) listCreateVisiblePreferencesList.get(i6));
                }

                @Override // androidx.recyclerview.widget.DiffUtil.Callback
                public boolean areItemsTheSame(int i, int i6) {
                    return preferenceComparisonCallback.arePreferenceItemsTheSame((Preference) list.get(i), (Preference) listCreateVisiblePreferencesList.get(i6));
                }
