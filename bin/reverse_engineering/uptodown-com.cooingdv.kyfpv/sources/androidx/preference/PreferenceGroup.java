...
public abstract class PreferenceGroup extends Preference {
    ...
    public PreferenceGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i6) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.PreferenceGroup, i, i6);
        int i10 = R.styleable.PreferenceGroup_orderingFromXml;
        this.mOrderingAsAdded = TypedArrayUtils.getBoolean(typedArrayObtainStyledAttributes, i10, i10, true);
        if (typedArrayObtainStyledAttributes.hasValue(R.styleable.PreferenceGroup_initialExpandedChildrenCount)) {
            ...
            setInitialExpandedChildrenCount(TypedArrayUtils.getInt(typedArrayObtainStyledAttributes, i11, i11, Integer.MAX_VALUE));
        }
    ...
    public <T extends Preference> T findPreference(@NonNull CharSequence charSequence) {
        ...
        if (charSequence == null) {
            com.google.gson.internal.a.p("Key cannot be null");
            return null;
        }
