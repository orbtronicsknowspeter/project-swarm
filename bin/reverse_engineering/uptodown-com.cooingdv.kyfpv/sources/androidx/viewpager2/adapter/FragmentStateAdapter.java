...
public abstract class FragmentStateAdapter extends RecyclerView.Adapter<FragmentViewHolder> implements StatefulAdapter {
    ...
    public class FragmentMaxLifecycleEnforcer {
        ...
        private ViewPager2 inferViewPager(@NonNull RecyclerView recyclerView) {
            ...
            b.l(parent, "Expected ViewPager2 instance. Got: ");
            return null;
        }
        ...
        public void updateFragmentMaxLifecycle(boolean z9) {
            ...
            if ((itemId != this.mPrimaryItemId || z9) && (fragment = FragmentStateAdapter.this.mFragments.get(itemId)) != null && fragment.isAdded()) {
    ...
    private Long itemForViewHolder(int i) {
        ...
        for (int i6 = 0; i6 < this.mItemIdToViewHolder.size(); i6++) {
            if (this.mItemIdToViewHolder.valueAt(i6).intValue() == i) {
                if (lValueOf != null) {
                    a.i("Design assumption violated: a ViewHolder can only be bound to one item at a time.");
                    return null;
                }
    ...
    public final void restoreState(@NonNull Parcelable parcelable) {
        if (!this.mSavedStates.isEmpty() || !this.mFragments.isEmpty()) {
            a.i("Expected the adapter to be 'fresh' while restoring state.");
            return;
        }
        ...
        for (String str : bundle.keySet()) {
            if (isValidKey(str, KEY_PREFIX_FRAGMENT)) {
                ...
                if (!isValidKey(str, KEY_PREFIX_STATE)) {
                    com.google.gson.internal.a.p(x.j("Unexpected key in savedState: ", str));
                    return;
                }
