...
public class ViewPager extends ViewGroup {
    ...
    public interface OnPageChangeListener {
        ...
        void onPageScrolled(int i, float f, @Px int i6);
    ...
    private int determineTargetPage(int i, float f, int i6, int i10) {
        if (Math.abs(i10) <= this.mFlingDistance || Math.abs(i6) <= this.mMinimumVelocity) {
    ...
    private void dispatchOnPageScrolled(int i, float f, int i6) {
        ...
        if (list != null) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (onPageChangeListener2 != null) {
                    onPageChangeListener2.onPageScrolled(i, f, i6);
                }
            }
        }
        OnPageChangeListener onPageChangeListener3 = this.mInternalPageChangeListener;
        if (onPageChangeListener3 != null) {
            onPageChangeListener3.onPageScrolled(i, f, i6);
        }
    }
    ...
    private void enableLayers(boolean z9) {
        ...
        for (int i = 0; i < childCount; i++) {
            getChildAt(i).setLayerType(z9 ? this.mPageTransformerLayerType : 0, null);
        }
    }
    ...
    private ItemInfo infoForCurrentScrollPosition() {
        ...
        while (i6 < this.mItems.size()) {
            ...
            if (!z9 && itemInfo2.position != (i = i10 + 1)) {
            ...
            if (scrollX < f12 || i6 == this.mItems.size() - 1) {
                return itemInfo3;
            }
    ...
    private boolean pageScrolled(int i) {
        if (this.mItems.size() == 0) {
            ...
            a.i("onPageScrolled did not call superclass implementation");
            return false;
        }
        ...
        float f10 = ((i / f) - itemInfoInfoForCurrentScrollPosition.offset) / (itemInfoInfoForCurrentScrollPosition.widthFactor + (i6 / f));
        this.mCalledSuper = false;
    ...
    private void recomputeScrollPosition(int i, int i6, int i10, int i11) {
    ...
    private void scrollToItem(int i, boolean z9, int i6, boolean z10) {
        int iMax;
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        ...
        if (!this.mInLayout) {
            ...
            a.i("Cannot add pager decor view during layout");
        } else {
    ...
    */
    ...
    public void endFakeDrag() {
        if (!this.mFakeDragging) {
            a.i("No fake drag in progress. Call beginFakeDrag first.");
            return;
        }
        if (this.mAdapter != null) {
            VelocityTracker velocityTracker = this.mVelocityTracker;
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (action == 0) {
            ...
            if (i != -1) {
                ...
                float f = x9 - this.mLastMotionX;
                float fAbs = Math.abs(f);
                float y10 = motionEvent.getY(iFindPointerIndex);
                float fAbs2 = Math.abs(y10 - this.mInitialMotionY);
                if (f != 0.0f && !isGutterDrag(this.mLastMotionX, f) && canScroll(this, false, (int) f, (int) x9, (int) y10)) {
    ...
    */
    ...
    public void onSizeChanged(int i, int i6, int i10, int i11) {
        ...
        if (i != i10) {
            ...
            recomputeScrollPosition(i, i10, i12, i12);
        }
    }
    ...
    */
    ...
    public void setCurrentItemInternal(int i, boolean z9, boolean z10, int i6) {
        PagerAdapter pagerAdapter = this.mAdapter;
        if (pagerAdapter == null || pagerAdapter.getCount() <= 0) {
            setScrollingCacheEnabled(false);
            return;
        }
        if (!z10 && this.mCurItem == i && this.mItems.size() != 0) {
            setScrollingCacheEnabled(false);
            return;
        }
        if (i < 0) {
        ...
        boolean z11 = this.mCurItem != i;
        if (!this.mFirstLayout) {
            populate(i);
            scrollToItem(i, z9, i6, z11);
        } else {
            this.mCurItem = i;
            if (z11) {
                dispatchOnPageSelected(i);
    ...
    public void setPageMargin(int i) {
        ...
        this.mPageMargin = i;
        int width = getWidth();
        recomputeScrollPosition(width, width, i, i6);
        requestLayout();
    }
    ...
    public void setPageTransformer(boolean z9, @Nullable PageTransformer pageTransformer, int i) {
    ...
    public void smoothScrollTo(int i, int i6, int i10) {
        int scrollX;
        if (getChildCount() == 0) {
            setScrollingCacheEnabled(false);
            return;
        ...
        float f = clientWidth;
        float f10 = i14;
        float fDistanceInfluenceForSnapDuration = (distanceInfluenceForSnapDuration(Math.min(1.0f, (Math.abs(i12) * 1.0f) / f)) * f10) + f10;
        int iAbs = Math.abs(i10);
        int iMin = Math.min(iAbs > 0 ? Math.round(Math.abs(fDistanceInfluenceForSnapDuration / iAbs) * 1000.0f) * 4 : (int) (((Math.abs(i12) / ((this.mAdapter.getPageWidth(this.mCurItem) * f) + this.mPageMargin)) + 1.0f) * 100.0f), 600);
    ...
    public void setCurrentItem(int i, boolean z9) {
        this.mPopulatePending = false;
        setCurrentItemInternal(i, z9, false);
    }
    ...
    public void setCurrentItemInternal(int i, boolean z9, boolean z10) {
        setCurrentItemInternal(i, z9, z10, 0);
    }
