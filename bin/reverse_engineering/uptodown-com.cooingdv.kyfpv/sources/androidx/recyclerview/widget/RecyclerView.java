...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static abstract class OnFlingListener {
        public abstract boolean onFling(int i, int i6);
    }
    ...
    public static class RecycledViewPool {
        ...
        public void putRecycledView(ViewHolder viewHolder) {
            ...
            if (this.mScrap.get(itemViewType).mMaxScrap <= arrayList.size()) {
                ...
                a.p("this scrap item already exists");
            } else {
        ...
        public boolean willBindInTime(int i, long j, long j6) {
            long j10 = getScrapDataForType(i).mBindRunningAverageNs;
            return j10 == 0 || j + j10 < j6;
        }

        public boolean willCreateInTime(int i, long j, long j6) {
            long j10 = getScrapDataForType(i).mCreateRunningAverageNs;
            return j10 == 0 || j + j10 < j6;
        }
    }
    ...
    public class RecyclerViewDataObserver extends AdapterDataObserver {
        ...
        public void onItemRangeChanged(int i, int i6, Object obj) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeChanged(i, i6, obj)) {
        ...
        public void onItemRangeInserted(int i, int i6) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeInserted(i, i6)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeMoved(int i, int i6, int i10) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeMoved(i, i6, i10)) {
                triggerUpdateProcessor();
            }
        }
        ...
        public void onItemRangeRemoved(int i, int i6) {
            RecyclerView.this.assertNotInLayoutOrScroll(null);
            if (RecyclerView.this.mAdapterHelper.onItemRangeRemoved(i, i6)) {
                triggerUpdateProcessor();
            }
        }
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.j("Layout state should be one of ", Integer.toBinaryString(i), " but it is ", Integer.toBinaryString(this.mLayoutStep));
        }
    ...
    public static abstract class ViewCacheExtension {
        @Nullable
        public abstract View getViewForPositionAndType(@NonNull Recycler recycler, int i, int i6);
    }
    ...
    public class ViewFlinger implements Runnable {
        ...
        private int computeScrollDuration(int i, int i6) {
            int iAbs = Math.abs(i);
        ...
        public void fling(int i, int i6) {
            ...
            this.mOverScroller.fling(0, 0, i, i6, Integer.MIN_VALUE, Integer.MAX_VALUE, Integer.MIN_VALUE, Integer.MAX_VALUE);
            postOnAnimation();
        }
        ...
        public void run() {
            ...
            if (overScroller.computeScrollOffset()) {
                ...
                int iConsumeFlingInHorizontalStretch = RecyclerView.this.consumeFlingInHorizontalStretch(i10);
                int iConsumeFlingInVerticalStretch = RecyclerView.this.consumeFlingInVerticalStretch(i11);
                ...
                if (recyclerView3.mAdapter != null) {
                    ...
                    int i12 = iArr4[0];
                    int i13 = iArr4[1];
                    iConsumeFlingInHorizontalStretch -= i12;
                ...
                int i14 = iConsumeFlingInHorizontalStretch;
                int i15 = iConsumeFlingInVerticalStretch;
                ...
                iArr5[0] = 0;
                iArr5[1] = 0;
                recyclerView5.dispatchNestedScroll(i, i6, i14, i15, null, 1, iArr5);
                RecyclerView recyclerView6 = RecyclerView.this;
                int[] iArr6 = recyclerView6.mReusableIntPair;
                int i16 = i14 - iArr6[0];
                int i17 = i15 - iArr6[1];
                if (i != 0 || i6 != 0) {
                    recyclerView6.dispatchOnScrolled(i, i6);
                }
                ...
                if ((smoothScroller2 == null || !smoothScroller2.isPendingInitialRun()) && z9) {
                    ...
                    if (gapWorker != null) {
                        gapWorker.postFromTraversal(recyclerView7, i, i6);
                    }
                }
        ...
        public void smoothScrollBy(int i, int i6, int i10, @Nullable Interpolator interpolator) {
            if (i10 == Integer.MIN_VALUE) {
                i10 = computeScrollDuration(i, i6);
            }
            int i11 = i10;
            ...
            this.mLastFlingX = 0;
            RecyclerView.this.setScrollState(2);
            this.mOverScroller.startScroll(0, 0, i, i6, i11);
            postOnAnimation();
        }
    ...
    public static abstract class ViewHolder {
        ...
        public void flagRemovedAndOffsetPosition(int i, int i6, boolean z9) {
            addFlags(8);
            offsetPosition(i6, z9);
            this.mPosition = i;
        }
        ...
        public void offsetPosition(int i, boolean z9) {
        ...
        public void resetInternal() {
            if (RecyclerView.sDebugAssertionsEnabled && isTmpDetached()) {
                androidx.core.view.contentcapture.a.p(this, "Attempting to reset temp-detached ViewHolder: ", ". ViewHolders should be fully detached before resetting.");
                return;
            }
            this.mFlags = 0;
            this.mPosition = -1;
        ...
        public void setFlags(int i, int i6) {
        ...
        public final void setIsRecyclable(boolean z9) {
            ...
            if (i6 < 0) {
                ...
                if (RecyclerView.sDebugAssertionsEnabled) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.h(this, "isRecyclable decremented below 0: unmatched pair of setIsRecyable() calls for ");
                    return;
                } else {
        ...
        public String toString() {
            StringBuilder sbU = x.u(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            sbU.append(Integer.toHexString(hashCode()));
            sbU.append(" position=");
            sbU.append(this.mPosition);
            sbU.append(" id=");
            sbU.append(this.mItemId);
            sbU.append(", oldPos=");
            sbU.append(this.mOldPosition);
            sbU.append(", pLpos:");
            sbU.append(this.mPreLayoutPosition);
            StringBuilder sb = new StringBuilder(sbU.toString());
            if (isScrap()) {
                sb.append(" scrap ");
    ...
    public RecyclerView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        DifferentialMotionFlingTarget differentialMotionFlingTarget = new DifferentialMotionFlingTarget() { // from class: androidx.recyclerview.widget.RecyclerView.5
            ...
            public boolean startDifferentialMotionFling(float f) {
                ...
                return RecyclerView.this.flingNoThresholdCheck(i6, i10);
            }
    ...
    private int consumeFlingInStretch(int i, EdgeEffect edgeEffect, EdgeEffect edgeEffect2, int i6) {
        if (i > 0 && edgeEffect != null && EdgeEffectCompat.getDistance(edgeEffect) != 0.0f) {
            int iRound = Math.round(EdgeEffectCompat.onPullDistance(edgeEffect, ((-i) * FLING_DESTRETCH_FACTOR) / i6, 0.5f) * ((-i6) / FLING_DESTRETCH_FACTOR));
            if (iRound != i) {
                edgeEffect.finish();
            }
            return i - iRound;
    ...
    private void createLayoutManager(Context context, String str, AttributeSet attributeSet, int i, int i6) {
        ...
        if (str != null) {
            ...
            try {
                ...
                androidx.privacysandbox.ads.adservices.customaudience.a.g(attributeSet.getPositionDescription(), ": Class is not a LayoutManager ", fullClassName, e12);
            } catch (ClassNotFoundException e13) {
                androidx.privacysandbox.ads.adservices.customaudience.a.g(attributeSet.getPositionDescription(), ": Unable to find LayoutManager ", fullClassName, e13);
            } catch (IllegalAccessException e14) {
                androidx.privacysandbox.ads.adservices.customaudience.a.g(attributeSet.getPositionDescription(), ": Cannot access non-public constructor ", fullClassName, e14);
            } catch (InstantiationException e15) {
                androidx.privacysandbox.ads.adservices.customaudience.a.g(attributeSet.getPositionDescription(), ": Could not instantiate the LayoutManager: ", fullClassName, e15);
            } catch (InvocationTargetException e16) {
                androidx.privacysandbox.ads.adservices.customaudience.a.g(attributeSet.getPositionDescription(), ": Could not instantiate the LayoutManager: ", fullClassName, e16);
            }
        }
    }
    ...
    private boolean fling(int i, int i6, int i10, int i11) {
        int iMax;
        int i12;
        ...
        if (!zCanScrollHorizontally || Math.abs(i) < i10) {
            i = 0;
        }
        if (!zCanScrollVertically || Math.abs(i6) < i10) {
            i6 = 0;
        }
        if (i == 0 && i6 == 0) {
            return false;
        ...
        if (iMax != 0 || i6 != 0) {
            int i15 = -i11;
            iMax = Math.max(i15, Math.min(iMax, i11));
            i6 = Math.max(i15, Math.min(i6, i11));
        ...
        if (!dispatchNestedPreFling(f, f10)) {
            ...
            if (onFlingListener != null && onFlingListener.onFling(i, i12)) {
                return true;
            }
            if (z9) {
                startNestedScrollForType(1);
                int i16 = -i11;
                this.mViewFlinger.fling(Math.max(i16, Math.min(i, i11)), Math.max(i16, Math.min(i12, i11)));
                return true;
            }
        }
        return false;
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter == null || !adapter.hasStableIds()) {
                    ...
                    androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, sb));
                    return;
                }
                ...
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, sb2));
                return;
            }
        }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        if ((i11 < i12 || rect.right <= i12) && rect.right < rect2.right) {
            ...
            int i13 = rect.right;
            int i14 = rect2.right;
            i6 = ((i13 > i14 || i11 >= i14) && i11 > i12) ? -1 : 0;
        }
        int i15 = rect.top;
        int i16 = rect2.top;
    ...
    private void nestedScrollByInternal(int i, int i6, @Nullable MotionEvent motionEvent, int i10) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
        ...
        if (dispatchNestedPreScroll(zCanScrollHorizontally ? iReleaseHorizontalGlow : 0, zCanScrollVertically ? iReleaseVerticalGlow : 0, this.mReusableIntPair, this.mScrollOffset, i10)) {
            int[] iArr2 = this.mReusableIntPair;
            iReleaseHorizontalGlow -= iArr2[0];
            iReleaseVerticalGlow -= iArr2[1];
        }
        scrollByInternal(zCanScrollHorizontally ? iReleaseHorizontalGlow : 0, zCanScrollVertically ? iReleaseVerticalGlow : 0, motionEvent, i10);
    ...
    */
    ...
    private boolean shouldAbsorb(@NonNull EdgeEffect edgeEffect, int i, int i6) {
        if (i > 0) {
            return true;
        }
        return getSplineFlingDistance(-i) < EdgeEffectCompat.getDistance(edgeEffect) * ((float) i6);
    }

    /* JADX WARN: Multi-variable type inference failed */
    private void startNestedScrollForType(int i) {
        boolean zCanScrollHorizontally = this.mLayout.canScrollHorizontally();
        int i6 = zCanScrollHorizontally;
        if (this.mLayout.canScrollVertically()) {
            i6 = (zCanScrollHorizontally ? 1 : 0) | 2;
        }
        startNestedScroll(i6, i);
    }
    ...
    public void addFocusables(ArrayList<View> arrayList, int i, int i6) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null || !layoutManager.onAddFocusables(this, arrayList, i, i6)) {
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, new StringBuilder("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        } else {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, x.t(str)));
        }
    }
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (!isComputingLayout()) {
            if (this.mDispatchScrollCounter > 0) {
                Log.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException(l.v(this, new StringBuilder(""))));
            }
        } else if (str == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, new StringBuilder("Cannot call this method while RecyclerView is computing a layout or scrolling")));
        } else {
    ...
    public void defaultOnMeasure(int i, int i6) {
        setMeasuredDimension(LayoutManager.chooseSize(i, getPaddingRight() + getPaddingLeft(), ViewCompat.getMinimumWidth(this)), LayoutManager.chooseSize(i6, getPaddingBottom() + getPaddingTop(), ViewCompat.getMinimumHeight(this)));
    }
    ...
    public boolean dispatchNestedPreScroll(int i, int i6, int[] iArr, int[] iArr2, int i10) {
        return getScrollingChildHelper().dispatchNestedPreScroll(i, i6, iArr, iArr2, i10);
    }

    @Override // androidx.core.view.NestedScrollingChild2
    public boolean dispatchNestedScroll(int i, int i6, int i10, int i11, int[] iArr, int i12) {
        return getScrollingChildHelper().dispatchNestedScroll(i, i6, i10, i11, iArr, i12);
    }
    ...
    public void dispatchOnScrolled(int i, int i6) {
        ...
        OnScrollListener onScrollListener = this.mScrollListener;
        if (onScrollListener != null) {
            onScrollListener.onScrolled(this, i, i6);
        }
        List<OnScrollListener> list = this.mScrollListeners;
        if (list != null) {
            for (int size = list.size() - 1; size >= 0; size--) {
                this.mScrollListeners.get(size).onScrolled(this, i, i6);
            }
        }
        this.mDispatchScrollCounter--;
    }
    ...
    */
    ...
    public boolean flingNoThresholdCheck(int i, int i6) {
        return fling(i, i6, 0, Integer.MAX_VALUE);
    }
    ...
    */
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, new StringBuilder("RecyclerView has no LayoutManager")));
        return null;
    }
    ...
    public int getChildDrawingOrder(int i, int i6) {
        ...
        return childDrawingOrderCallback == null ? super.getChildDrawingOrder(i, i6) : childDrawingOrderCallback.onGetChildDrawingOrder(i, i6);
    }
    ...
    public ViewHolder getChildViewHolder(@NonNull View view) {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.t("View ", view, " is not a direct child of ", this);
        return null;
    }
    ...
    public void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new AdapterHelper.Callback() { // from class: androidx.recyclerview.widget.RecyclerView.7
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void markViewHoldersUpdated(int i, int i6, Object obj) {
                RecyclerView.this.viewRangeUpdate(i, i6, obj);
                RecyclerView.this.mItemsChanged = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForAdd(int i, int i6) {
                RecyclerView.this.offsetPositionRecordsForInsert(i, i6);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForMove(int i, int i6) {
                RecyclerView.this.offsetPositionRecordsForMove(i, i6);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }

            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingInvisible(int i, int i6) {
                RecyclerView.this.offsetPositionRecordsForRemove(i, i6, true);
                RecyclerView recyclerView = RecyclerView.this;
            ...
            @Override // androidx.recyclerview.widget.AdapterHelper.Callback
            public void offsetPositionsForRemovingLaidOutOrNewView(int i, int i6) {
                RecyclerView.this.offsetPositionRecordsForRemove(i, i6, false);
                RecyclerView.this.mItemsAddedOrRemoved = true;
            }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        if (stateListDrawable == null || drawable == null || stateListDrawable2 == null || drawable2 == null) {
            a.p(l.v(this, new StringBuilder("Trying to set fast scroller without both required drawables.")));
        } else {
    ...
    public void nestedScrollBy(int i, int i6) {
        nestedScrollByInternal(i, i6, null, 1);
    }

    public void offsetChildrenHorizontal(@Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i6 = 0; i6 < childCount; i6++) {
            this.mChildHelper.getChildAt(i6).offsetLeftAndRight(i);
        }
    }
    ...
    public void offsetChildrenVertical(@Px int i) {
        int childCount = this.mChildHelper.getChildCount();
        for (int i6 = 0; i6 < childCount; i6++) {
            this.mChildHelper.getChildAt(i6).offsetTopAndBottom(i);
        }
    }
        ...
        for (int i10 = 0; i10 < unfilteredChildCount; i10++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore() && childViewHolderInt.mPosition >= i) {
                if (sVerboseLoggingEnabled) {
                    Log.d(TAG, "offsetPositionRecordsForInsert attached child " + i10 + " holder " + childViewHolderInt + " now at position " + (childViewHolderInt.mPosition + i6));
                }
                childViewHolderInt.offsetPosition(i6, false);
                this.mState.mStructureChanged = true;
            }
        }
        this.mRecycler.offsetPositionRecordsForInsert(i, i6);
        requestLayout();
    }
    ...
    public void offsetPositionRecordsForMove(int i, int i6) {
        ...
        for (int i14 = 0; i14 < unfilteredChildCount; i14++) {
            ...
            if (childViewHolderInt != null && (i13 = childViewHolderInt.mPosition) >= i11 && i13 <= i10) {
                ...
                if (childViewHolderInt.mPosition == i) {
                    childViewHolderInt.offsetPosition(i6 - i, false);
                } else {
        ...
        this.mRecycler.offsetPositionRecordsForMove(i, i6);
        requestLayout();
    }

    public void offsetPositionRecordsForRemove(int i, int i6, boolean z9) {
        int i10 = i + i6;
        int unfilteredChildCount = this.mChildHelper.getUnfilteredChildCount();
        for (int i11 = 0; i11 < unfilteredChildCount; i11++) {
            ...
            if (childViewHolderInt != null && !childViewHolderInt.shouldIgnore()) {
                ...
                if (i12 >= i10) {
                    if (sVerboseLoggingEnabled) {
                        Log.d(TAG, "offsetPositionRecordsForRemove attached child " + i11 + " holder " + childViewHolderInt + " now at position " + (childViewHolderInt.mPosition - i6));
                    }
                    childViewHolderInt.offsetPosition(-i6, z9);
                    this.mState.mStructureChanged = true;
                } else if (i12 >= i) {
                    if (sVerboseLoggingEnabled) {
                        Log.d(TAG, "offsetPositionRecordsForRemove attached child " + i11 + " holder " + childViewHolderInt + " now REMOVED");
                    }
                    childViewHolderInt.flagRemovedAndOffsetPosition(i - 1, -i6, z9);
                    this.mState.mStructureChanged = true;
                }
            }
        }
        this.mRecycler.offsetPositionRecordsForRemove(i, i6, z9);
        requestLayout();
    }
    ...
    */
    ...
    public void onExitLayoutOrScroll(boolean z9) {
        ...
        if (i < 1) {
            if (sDebugAssertionsEnabled && i < 0) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, new StringBuilder("layout or scroll counter cannot go below zero.Some calls are not matching")));
                return;
            }
            this.mLayoutOrScrollCounter = 0;
            if (z9) {
    ...
    public boolean onGenericMotionEvent(MotionEvent motionEvent) {
        ...
        if (this.mLayout != null && !this.mLayoutSuppressed && motionEvent.getAction() == 8) {
            ...
            int i6 = (int) (f * this.mScaledVerticalScrollFactor);
            int i10 = (int) (axisValue * this.mScaledHorizontalScrollFactor);
            if (z9) {
                OverScroller overScroller = this.mViewFlinger.mOverScroller;
                recyclerView = this;
                recyclerView.smoothScrollBy((overScroller.getFinalX() - overScroller.getCurrX()) + i10, (overScroller.getFinalY() - overScroller.getCurrY()) + i6, null, Integer.MIN_VALUE, true);
            } else {
                recyclerView = this;
                nestedScrollByInternal(i10, i6, motionEvent, 1);
            }
            if (i != 0 && !z9) {
    ...
    public void onMeasure(int i, int i6) {
        ...
        if (layoutManager.isAutoMeasureEnabled()) {
            ...
            this.mLayout.onMeasure(this.mRecycler, this.mState, i, i6);
            ...
            this.mLayout.setMeasureSpecs(i, i6);
            this.mState.mIsMeasuring = true;
            dispatchLayoutStep2();
            this.mLayout.setMeasuredDimensionFromChildren(i, i6);
    ...
    */
    ...
    public void requestDisallowInterceptTouchEvent(boolean z9) {
        int size = this.mOnItemTouchListeners.size();
        for (int i = 0; i < size; i++) {
            this.mOnItemTouchListeners.get(i).onRequestDisallowInterceptTouchEvent(z9);
        }
    ...
    public void saveOldPositions() {
        ...
        for (int i = 0; i < unfilteredChildCount; i++) {
            ...
            if (sDebugAssertionsEnabled && childViewHolderInt.mPosition == -1 && !childViewHolderInt.isRemoved()) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, new StringBuilder("view holder cannot have position -1 unless it is removed")));
                return;
            } else {
                if (!childViewHolderInt.shouldIgnore()) {
    ...
    public void scrollBy(int i, int i6) {
        ...
        if (zCanScrollHorizontally || zCanScrollVertically) {
            ...
            scrollByInternal(i, i6, null, 0);
        }
    }

    public boolean scrollByInternal(int i, int i6, MotionEvent motionEvent, int i10) {
        int i11;
        int i12;
        int i13;
        int i14;
    ...
    public void scrollStep(int i, int i6, @Nullable int[] iArr) {
        startInterceptRequestLayout();
        onEnterLayoutOrScroll();
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView != null) {
                ...
                a.p(l.v(layoutManager.mRecyclerView, sb));
                return;
            }
    ...
    public void setLayoutTransition(LayoutTransition layoutTransition) {
        if (layoutTransition == null) {
            ...
            a.p("Providing a LayoutTransition into RecyclerView is not supported. Please use setItemAnimator() instead for animating changes to the items in this RecyclerView");
        }
    }
    ...
    public void setScrollState(int i) {
        ...
        if (sVerboseLoggingEnabled) {
            StringBuilder sbP = x.p(i, "setting scroll state to ", " from ");
            sbP.append(this.mScrollState);
            Log.d(TAG, sbP.toString(), new Exception());
        }
        this.mScrollState = i;
        if (i != 2) {
    ...
    public void smoothScrollBy(@Px int i, @Px int i6, @Nullable Interpolator interpolator, int i10, boolean z9) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
        ...
        this.mViewFlinger.smoothScrollBy(i, i6, i10, interpolator);
    }
    ...
    public void stopInterceptRequestLayout(boolean z9) {
        if (this.mInterceptRequestLayoutDepth < 1) {
            if (sDebugAssertionsEnabled) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this, new StringBuilder("stopInterceptRequestLayout was called more times than startInterceptRequestLayout.")));
                return;
            }
    ...
    public void viewRangeUpdate(int i, int i6, Object obj) {
        ...
        this.mRecycler.viewRangeUpdate(i, i6);
    }
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z9) {
            ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
            ...
            if (childViewHolderInt.wasReturnedFromScrap() || childViewHolderInt.isScrap()) {
                ...
                if (parent == recyclerView) {
                    ...
                    if (iIndexOfChild == -1) {
                        ...
                        androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(this.mRecyclerView, sb));
                        return;
                    } else if (iIndexOfChild != i) {
        ...
        public static int chooseSize(int i, int i6, int i10) {
            int mode = View.MeasureSpec.getMode(i);
        ...
        */
        ...
        public static Properties getProperties(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i6) {
            Properties properties = new Properties();
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, androidx.recyclerview.R.styleable.RecyclerView, i, i6);
        ...
        private boolean isFocusedChildVisibleAfterScrolling(RecyclerView recyclerView, int i, int i6) {
            ...
            return rect.left - i < width && rect.right - i > paddingLeft && rect.top - i6 < height && rect.bottom - i6 > paddingTop;
        }

        private static boolean isMeasurementUpToDate(int i, int i6, int i10) {
        ...
        public void ignoreView(@NonNull View view) {
            ...
            if (parent != recyclerView || recyclerView.indexOfChild(view) == -1) {
                a.p(l.v(this.mRecyclerView, new StringBuilder("View should be fully attached to be ignored")));
            } else {
                ViewHolder childViewHolderInt = RecyclerView.getChildViewHolderInt(view);
        ...
        public void layoutDecorated(@NonNull View view, int i, int i6, int i10, int i11) {
            Rect rect = ((LayoutParams) view.getLayoutParams()).mDecorInsets;
            view.layout(i + rect.left, i6 + rect.top, i10 - rect.right, i11 - rect.bottom);
        }

        public void layoutDecoratedWithMargins(@NonNull View view, int i, int i6, int i10, int i11) {
            LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
            Rect rect = layoutParams.mDecorInsets;
            view.layout(i + rect.left + ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i6 + rect.top + ((ViewGroup.MarginLayoutParams) layoutParams).topMargin, (i10 - rect.right) - ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin, (i11 - rect.bottom) - ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin);
        }
        ...
        public void measureChild(@NonNull View view, int i, int i6) {
            ...
            int i11 = itemDecorInsetsForChild.top + itemDecorInsetsForChild.bottom + i6;
        ...
        public void moveView(int i, int i6) {
            View childAt = getChildAt(i);
            if (childAt != null) {
                detachViewAt(i);
        ...
        public boolean onAddFocusables(@NonNull RecyclerView recyclerView, @NonNull ArrayList<View> arrayList, int i, int i6) {
            return false;
        }
        ...
        public void onItemsUpdated(@NonNull RecyclerView recyclerView, int i, int i6, @Nullable Object obj) {
            onItemsUpdated(recyclerView, i, i6);
        }
        ...
        public void onMeasure(@NonNull Recycler recycler, @NonNull State state, int i, int i6) {
            this.mRecyclerView.defaultOnMeasure(i, i6);
        }
        ...
        */
        ...
        public boolean requestChildRectangleOnScreen(@NonNull RecyclerView recyclerView, @NonNull View view, @NonNull Rect rect, boolean z9, boolean z10) {
            ...
            if ((z10 && !isFocusedChildVisibleAfterScrolling(recyclerView, i, i6)) || (i == 0 && i6 == 0)) {
                return false;
            }
            if (z9) {
                recyclerView.scrollBy(i, i6);
            } else {
                recyclerView.smoothScrollBy(i, i6);
            }
            return true;
        }
        ...
        public void setMeasureSpecs(int i, int i6) {
        ...
        public void setMeasuredDimension(Rect rect, int i, int i6) {
            setMeasuredDimension(chooseSize(i, getPaddingRight() + getPaddingLeft() + rect.width(), getMinimumWidth()), chooseSize(i6, getPaddingBottom() + getPaddingTop() + rect.height(), getMinimumHeight()));
        }

        public void setMeasuredDimensionFromChildren(int i, int i6) {
            int childCount = getChildCount();
            if (childCount == 0) {
                this.mRecyclerView.defaultOnMeasure(i, i6);
                return;
            ...
            setMeasuredDimension(this.mRecyclerView.mTempRect, i, i6);
        }
        ...
        public boolean shouldMeasureChild(View view, int i, int i6, LayoutParams layoutParams) {
            return (!view.isLayoutRequested() && this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getWidth(), i, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getHeight(), i6, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public boolean shouldReMeasureChild(View view, int i, int i6, LayoutParams layoutParams) {
            return (this.mMeasurementCacheEnabled && isMeasurementUpToDate(view.getMeasuredWidth(), i, ((ViewGroup.MarginLayoutParams) layoutParams).width) && isMeasurementUpToDate(view.getMeasuredHeight(), i6, ((ViewGroup.MarginLayoutParams) layoutParams).height)) ? false : true;
        }
        ...
        public void onItemsUpdated(@NonNull RecyclerView recyclerView, int i, int i6) {
        }
        ...
        public void setMeasuredDimension(int i, int i6) {
            this.mRecyclerView.setMeasuredDimension(i, i6);
        }
        ...
        */
        ...
        @SuppressLint({"UnknownNullness"})
        public void collectAdjacentPrefetchPositions(int i, int i6, State state, LayoutPrefetchRegistry layoutPrefetchRegistry) {
        }

        public void onItemsMoved(@NonNull RecyclerView recyclerView, int i, int i6, int i10) {
        }
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(@NonNull VH vh, int i) {
            ...
            if (RecyclerView.sDebugAssertionsEnabled) {
                ...
                if (vh.itemView.getParent() == null && vh.itemView.isAttachedToWindow()) {
                    b.l(vh, "Attempting to bind attached holder with no parent (AKA temp detached): ");
                    return;
                }
            }
        ...
        public void setHasStableIds(boolean z9) {
            if (hasObservers()) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i("Cannot change whether this adapter has stable IDs while the adapter has registered observers.");
            } else {
        ...
        public final void notifyItemRangeChanged(int i, int i6, @Nullable Object obj) {
    ...
    public final class Recycler {
        ...
        private boolean tryBindViewHolderByDeadline(@NonNull ViewHolder viewHolder, int i, int i6, long j) {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            RecyclerView recyclerView = RecyclerView.this;
            if (childViewHolderInt == null) {
                a.p(l.v(recyclerView, new StringBuilder("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
                return;
            }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder sbP = x.p(i, "invalid position ", ". State item count is ");
            sbP.append(RecyclerView.this.mState.getItemCount());
            a.r(l.v(RecyclerView.this, sbP));
            return 0;
        }
        ...
        public ViewHolder getScrapOrCachedViewForId(long j, int i, boolean z9) {
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z9) {
            ...
            if (!z9 && (viewFindHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) != null) {
                ...
                sb.append(childViewHolderInt);
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(RecyclerView.this, sb));
                return null;
            }
            int size2 = this.mCachedViews.size();
        ...
        public View getViewForPosition(int i, boolean z9) {
            return tryGetViewHolderForPositionByDeadline(i, z9, Long.MAX_VALUE).itemView;
        }
        ...
        public void offsetPositionRecordsForInsert(int i, int i6) {
            ...
            for (int i10 = 0; i10 < size; i10++) {
                ...
                if (viewHolder != null && viewHolder.mPosition >= i) {
                    if (RecyclerView.sVerboseLoggingEnabled) {
                        Log.d(RecyclerView.TAG, "offsetPositionRecordsForInsert cached " + i10 + " holder " + viewHolder + " now at position " + (viewHolder.mPosition + i6));
                    }
        ...
        public void offsetPositionRecordsForMove(int i, int i6) {
            ...
            for (int i14 = 0; i14 < size; i14++) {
                ...
                if (viewHolder != null && (i13 = viewHolder.mPosition) >= i12 && i13 <= i11) {
                    if (i13 == i) {
                        viewHolder.offsetPosition(i6 - i, false);
                    } else {
            ...
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ...
                if (viewHolder != null) {
                    ...
                    if (i11 >= i10) {
                        ...
                        viewHolder.offsetPosition(-i6, z9);
                    } else if (i11 >= i) {
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (viewHolder.isScrap() || viewHolder.itemView.getParent() != null) {
                ...
                throw new IllegalArgumentException(l.v(RecyclerView.this, sb));
            }
            if (viewHolder.isTmpDetached()) {
            ...
            if (viewHolder.shouldIgnore()) {
                a.p(l.v(RecyclerView.this, new StringBuilder("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
                return;
            }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.isInvalid() || childViewHolderInt.isRemoved() || RecyclerView.this.mAdapter.hasStableIds()) {
                ...
                a.p(l.v(RecyclerView.this, new StringBuilder("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            }
        }
        ...
        /* JADX WARN: Removed duplicated region for block: B:115:0x0240 A[ADDED_TO_REGION] */
        ...
        */
        ...
        public boolean validateViewHolderForOffsetPosition(ViewHolder viewHolder) {
            if (viewHolder.isRemoved()) {
                ...
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.v(RecyclerView.this, new StringBuilder("should not receive a removed view unless it is pre layout")));
                return false;
            }
        ...
        public void viewRangeUpdate(int i, int i6) {
            int i10;
            int i11 = i6 + i;
            for (int size = this.mCachedViews.size() - 1; size >= 0; size--) {
                ViewHolder viewHolder = this.mCachedViews.get(size);
                if (viewHolder != null && (i10 = viewHolder.mPosition) >= i && i10 < i11) {
    ...
    public boolean dispatchNestedScroll(int i, int i6, int i10, int i11, int[] iArr) {
        return getScrollingChildHelper().dispatchNestedScroll(i, i6, i10, i11, iArr);
    }
    ...
    public final void dispatchNestedScroll(int i, int i6, int i10, int i11, int[] iArr, int i12, @NonNull int[] iArr2) {
        getScrollingChildHelper().dispatchNestedScroll(i, i6, i10, i11, iArr, i12, iArr2);
    }
    ...
    public static abstract class SmoothScroller {
        ...
        public void onAnimation(int i, int i6) {
            ...
            if (this.mRunning) {
                onSeekTargetStep(i, i6, recyclerView.mState, this.mRecyclingAction);
        ...
        public abstract void onSeekTargetStep(@Px int i, @Px int i6, @NonNull State state, @NonNull Action action);
        ...
        public static class Action {
            ...
            public Action(@Px int i, @Px int i6, int i10, @Nullable Interpolator interpolator) {
            ...
            private void validate() {
                if (this.mInterpolator != null && this.mDuration < 1) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("If you provide an interpolator, you must set a positive duration");
                } else {
                    if (this.mDuration >= 1) {
                        return;
                    }
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("Scroll duration must be a positive number");
                }
            }
            ...
            public void update(@Px int i, @Px int i6, int i10, @Nullable Interpolator interpolator) {
                this.mDx = i;
                this.mDy = i6;
                this.mDuration = i10;
                this.mInterpolator = interpolator;
            ...
            public Action(@Px int i, @Px int i6, int i10) {
                this(i, i6, i10, null);
            }

            public Action(@Px int i, @Px int i6) {
    ...
    public static class AdapterDataObservable extends Observable<AdapterDataObserver> {
        ...
        public void notifyItemMoved(int i, int i6) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeMoved(i, i6, 1);
            }
        }

        public void notifyItemRangeChanged(int i, int i6, @Nullable Object obj) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeChanged(i, i6, obj);
            }
        }

        public void notifyItemRangeInserted(int i, int i6) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeInserted(i, i6);
            }
        }

        public void notifyItemRangeRemoved(int i, int i6) {
            for (int size = ((Observable) this).mObservers.size() - 1; size >= 0; size--) {
                ((AdapterDataObserver) ((Observable) this).mObservers.get(size)).onItemRangeRemoved(i, i6);
            }
        }
        ...
        public void notifyItemRangeChanged(int i, int i6) {
            notifyItemRangeChanged(i, i6, null);
        }
    }
    ...
    public void onScrolled(@Px int i, @Px int i6) {
    }
    ...
    public void smoothScrollBy(@Px int i, @Px int i6, @Nullable Interpolator interpolator) {
        smoothScrollBy(i, i6, interpolator, Integer.MIN_VALUE);
    }

    public void smoothScrollBy(@Px int i, @Px int i6, @Nullable Interpolator interpolator, int i10) {
        smoothScrollBy(i, i6, interpolator, i10, false);
    }

    public void smoothScrollBy(@Px int i, @Px int i6) {
        smoothScrollBy(i, i6, null);
    }

    public boolean fling(int i, int i6) {
        return fling(i, i6, this.mMinFlingVelocity, this.mMaxFlingVelocity);
    }
