...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private boolean checkSpanForGap(Span span) {
        ...
        if (span.getEndLine() < this.mPrimaryOrientation.getEndAfterPadding()) {
            z9 = span.getLayoutParams(span.mViews.get(r0.size() - 1)).mFullSpan;
            return !z9;
        }
        return false;
    }
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromEnd(int i) {
        ...
        for (int i6 = 0; i6 < this.mSpanCount; i6++) {
            fullSpanItem.mGapPerSpan[i6] = i - this.mSpans[i6].getEndLine(i);
        }
        return fullSpanItem;
    }
    ...
    private LazySpanLookup.FullSpanItem createFullSpanItemFromStart(int i) {
        ...
        fullSpanItem.mGapPerSpan = new int[this.mSpanCount];
        for (int i6 = 0; i6 < this.mSpanCount; i6++) {
            fullSpanItem.mGapPerSpan[i6] = this.mSpans[i6].getStartLine(i) - i;
        }
        return fullSpanItem;
    }
    ...
    private int fill(RecyclerView.Recycler recycler, LayoutState layoutState, RecyclerView.State state) {
        ...
        boolean z9 = staggeredGridLayoutManager.mShouldReverseLayout;
        ...
        while (layoutState.hasMore(state) && (r03.mLayoutState.mInfinite || !r03.mRemainingSpans.isEmpty())) {
            ...
            if (i6 == 1) {
                decoratedMeasurement = z11 ? r03.getMaxEnd(endAfterPadding) : span2.getEndLine(endAfterPadding);
                ...
                minStart = z11 ? r03.getMinStart(endAfterPadding) : span2.getStartLine(endAfterPadding);
            ...
            if (r03.isLayoutRTL() && r03.mOrientation == 1) {
                ...
                OrientationHelper orientationHelper2 = r03.mSecondaryOrientation;
                decoratedMeasurement2 = z12 ? orientationHelper2.getEndAfterPadding() : orientationHelper2.getEndAfterPadding() - (((r03.mSpanCount - 1) - span2.mIndex) * r03.mSizePerSpan);
            ...
            if (r03.mOrientation == 1) {
                r03.layoutDecoratedWithMargins(next, i11, decoratedMeasurement, i10, minStart);
                r02 = this;
            } else {
                r03.layoutDecoratedWithMargins(next, decoratedMeasurement, i11, minStart, i10);
                r02 = r03;
            }
            boolean z13 = layoutParams.mFullSpan;
            LayoutState layoutState2 = r02.mLayoutState;
            if (z13) {
                r02.updateAllRemainingSpans(layoutState2.mLayoutDirection, i);
            } else {
                r02.updateRemainingSpans(span2, layoutState2.mLayoutDirection, i);
            }
            ...
            if (r02.mLayoutState.mStopInFocusable && next.hasFocusable()) {
                ...
                BitSet bitSet = r02.mRemainingSpans;
                if (z14) {
                    bitSet.clear();
                } else {
        ...
        int i12 = r03.mLayoutState.mLayoutDirection;
        OrientationHelper orientationHelper3 = r03.mPrimaryOrientation;
        int startAfterPadding2 = i12 == -1 ? r03.mPrimaryOrientation.getStartAfterPadding() - r03.getMinStart(orientationHelper3.getStartAfterPadding()) : r03.getMaxEnd(orientationHelper3.getEndAfterPadding()) - r03.mPrimaryOrientation.getEndAfterPadding();
    ...
    private int getMaxEnd(int i) {
        ...
        for (int i6 = 1; i6 < this.mSpanCount; i6++) {
            int endLine2 = this.mSpans[i6].getEndLine(i);
            if (endLine2 > endLine) {
                endLine = endLine2;
            }
        }
    ...
    private int getMaxStart(int i) {
        ...
        for (int i6 = 1; i6 < this.mSpanCount; i6++) {
            int startLine2 = this.mSpans[i6].getStartLine(i);
    ...
    private Span getNextSpan(LayoutState layoutState) {
        ...
        int i12 = layoutState.mLayoutDirection;
        OrientationHelper orientationHelper = this.mPrimaryOrientation;
        Span span = null;
        if (i12 == 1) {
    ...
    */
    ...
    private void updateAllRemainingSpans(int i, int i6) {
        for (int i10 = 0; i10 < this.mSpanCount; i10++) {
            if (!this.mSpans[i10].mViews.isEmpty()) {
                updateRemainingSpans(this.mSpans[i10], i, i6);
            }
        }
    }
    ...
    private void updateLayoutState(int i, RecyclerView.State state) {
        ...
        if (!isSmoothScrolling() || (targetScrollPosition = state.getTargetScrollPosition()) == -1) {
            ...
            boolean z11 = targetScrollPosition < i;
            OrientationHelper orientationHelper = this.mPrimaryOrientation;
            if (z10 == z11) {
    ...
    private void updateRemainingSpans(Span span, int i, int i6) {
    ...
    private int updateSpecWithExtra(int i, int i6, int i10) {
        int mode;
    ...
    public boolean checkForGaps() {
        ...
        LazySpanLookup.FullSpanItem firstFullSpanItemInRange = this.mLazySpanLookup.getFirstFullSpanItemInRange(firstChildPosition, i6, i, true);
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        ...
        if (iArr == null) {
            ...
            a.f(this.mSpanCount, iArr.length, ", array size:", "Provided int[]'s size must be more than or equal to span count. Expected:");
            return null;
        }
        for (int i6 = 0; i6 < this.mSpanCount; i6++) {
            iArr[i6] = this.mSpans[i6].findFirstCompletelyVisibleItemPosition();
        }
        return iArr;
    }
    ...
    public int[] findFirstVisibleItemPositions(int[] iArr) {
        ...
        for (int i6 = 0; i6 < this.mSpanCount; i6++) {
            iArr[i6] = this.mSpans[i6].findFirstVisibleItemPosition();
        }
        return iArr;
    }
    ...
    */
        ...
        if (preferLastSpan(iConvertFocusDirectionToLayoutDirection)) {
            for (int i11 = this.mSpanCount - 1; i11 >= 0; i11--) {
                if (i11 != span.mIndex) {
                    ...
                    View viewFindViewByPosition2 = findViewByPosition(z10 ? spanArr[i11].findFirstPartiallyVisibleItemPosition() : spanArr[i11].findLastPartiallyVisibleItemPosition());
            ...
            for (int i12 = 0; i12 < this.mSpanCount; i12++) {
                ...
                View viewFindViewByPosition3 = findViewByPosition(z10 ? spanArr2[i12].findFirstPartiallyVisibleItemPosition() : spanArr2[i12].findLastPartiallyVisibleItemPosition());
    ...
    public Parcelable onSaveInstanceState() {
        ...
        for (int i6 = 0; i6 < this.mSpanCount; i6++) {
            ...
            Span[] spanArr = this.mSpans;
            if (z9) {
                startLine = spanArr[i6].getEndLine(Integer.MIN_VALUE);
                if (startLine != Integer.MIN_VALUE) {
                    startAfterPadding = this.mPrimaryOrientation.getEndAfterPadding();
                    startLine -= startAfterPadding;
                }
            } else {
                startLine = spanArr[i6].getStartLine(Integer.MIN_VALUE);
                if (startLine != Integer.MIN_VALUE) {
    ...
    public void setGapStrategy(int i) {
        ...
        if (i != 0 && i != 2) {
            com.google.gson.internal.a.p("invalid gap strategy. Must be GAP_HANDLING_NONE or GAP_HANDLING_MOVE_ITEMS_BETWEEN_SPANS");
        } else {
            this.mGapStrategy = i;
            requestLayout();
        }
    ...
    public class Span {
        ...
        public void cacheReferenceLineAndClear(boolean z9, int i) {
        ...
        public int findOnePartiallyOrCompletelyVisibleChild(int i, int i6, boolean z9, boolean z10, boolean z11) {
        ...
        public int findOnePartiallyVisibleChild(int i, int i6, boolean z9) {
            return findOnePartiallyOrCompletelyVisibleChild(i, i6, false, false, z9);
        }

        public int findOneVisibleChild(int i, int i6, boolean z9) {
            return findOnePartiallyOrCompletelyVisibleChild(i, i6, z9, true, false);
        }
        ...
        public View getFocusableViewAfter(int i, int i6) {
            ArrayList<View> arrayList = this.mViews;
            View view = null;
            if (i6 != -1) {
        ...
        public void onOffset(int i) {
            int i6 = this.mCachedStart;
            if (i6 != Integer.MIN_VALUE) {
                this.mCachedStart = i6 + i;
            }
            int i10 = this.mCachedEnd;
            if (i10 != Integer.MIN_VALUE) {
                this.mCachedEnd = i10 + i;
            }
        }
    ...
    public static class LazySpanLookup {
        ...
        private int invalidateFullSpansAfter(int i) {
            ...
            while (true) {
                ...
                if (this.mFullSpanItems.get(i6).mPosition >= i) {
                    break;
                }
                i6++;
            }
        ...
        private void offsetFullSpansForAddition(int i, int i6) {
            ...
            for (int size = list.size() - 1; size >= 0; size--) {
                ...
                if (i10 >= i) {
                    fullSpanItem.mPosition = i10 + i6;
                }
            }
        }

        private void offsetFullSpansForRemoval(int i, int i6) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return;
            }
        ...
        public FullSpanItem getFirstFullSpanItemInRange(int i, int i6, int i10, boolean z9) {
            List<FullSpanItem> list = this.mFullSpanItems;
            if (list == null) {
                return null;
            }
            ...
            for (int i11 = 0; i11 < size; i11++) {
                ...
                if (i12 >= i && (i10 == 0 || fullSpanItem.mGapDir == i10 || (z9 && fullSpanItem.mHasUnwantedGapAfter))) {
                    return fullSpanItem;
                }
            }
            return null;
        ...
        public void offsetForAddition(int i, int i6) {
            int[] iArr = this.mData;
            if (iArr == null || i >= iArr.length) {
                return;
            }
            ...
            ensureSize(i10);
            int[] iArr2 = this.mData;
            System.arraycopy(iArr2, i, iArr2, i10, (iArr2.length - i) - i6);
            Arrays.fill(this.mData, i, i10, -1);
            offsetFullSpansForAddition(i, i6);
        }

        public void offsetForRemoval(int i, int i6) {
            int[] iArr = this.mData;
            if (iArr == null || i >= iArr.length) {
                return;
            }
            ...
            ensureSize(i10);
            int[] iArr2 = this.mData;
            System.arraycopy(iArr2, i10, iArr2, i, (iArr2.length - i) - i6);
            int[] iArr3 = this.mData;
            Arrays.fill(iArr3, iArr3.length - i6, iArr3.length, -1);
            offsetFullSpansForRemoval(i, i6);
        }
    ...
    private void measureChildWithDecorationsAndMargin(View view, int i, int i6, boolean z9) {
        ...
        int iUpdateSpecWithExtra = updateSpecWithExtra(i, i10 + rect.left, ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin + rect.right);
        int i11 = ((ViewGroup.MarginLayoutParams) layoutParams).topMargin;
        Rect rect2 = this.mTmpRect;
        int iUpdateSpecWithExtra2 = updateSpecWithExtra(i6, i11 + rect2.top, ((ViewGroup.MarginLayoutParams) layoutParams).bottomMargin + rect2.bottom);
        if (z9) {
