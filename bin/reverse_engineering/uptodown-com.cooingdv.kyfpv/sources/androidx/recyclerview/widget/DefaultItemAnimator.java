...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public static class MoveInfo {
        ...
        public MoveInfo(RecyclerView.ViewHolder viewHolder, int i, int i6, int i10, int i11) {
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    @SuppressLint({"UnknownNullness"})
    public boolean animateChange(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i, int i6, int i10, int i11) {
        if (viewHolder == viewHolder2) {
            return animateMove(viewHolder, i, i6, i10, i11);
        }
        ...
        this.mPendingChanges.add(new ChangeInfo(viewHolder, viewHolder2, i, i6, i10, i11));
        return true;
    }
    ...
    @Override // androidx.recyclerview.widget.SimpleItemAnimator
    @SuppressLint({"UnknownNullness"})
    public boolean animateMove(RecyclerView.ViewHolder viewHolder, int i, int i6, int i10, int i11) {
    ...
    public void animateMoveImpl(final RecyclerView.ViewHolder viewHolder, int i, int i6, int i10, int i11) {
        final View view = viewHolder.itemView;
        final int i12 = i10 - i;
        final int i13 = i11 - i6;
        if (i12 != 0) {
    ...
    public static class ChangeInfo {
        ...
        public ChangeInfo(RecyclerView.ViewHolder viewHolder, RecyclerView.ViewHolder viewHolder2, int i, int i6, int i10, int i11) {
