    ...
    public static class MediaStyle extends NotificationCompat.Style {
        ...
        public Notification.MediaStyle fillInMediaStyle(Notification.MediaStyle mediaStyle) {
            ...
            if (mediaSessionCompat$Token != null) {
                mediaStyle.setMediaSession((MediaSession.Token) mediaSessionCompat$Token.f257a);
            }
            return mediaStyle;
        }
        ...
        public RemoteViews generateContentView() {
            ...
            if (iMin > 0) {
                for (int i = 0; i < iMin; i++) {
                    if (i >= size) {
                        a.o("setShowActionsInCompactView: action %d out of bounds (max %d)", new Object[]{Integer.valueOf(i), Integer.valueOf(size - 1)});
                        return null;
                    }
