...
public final class AmbiguousColumnResolver {
    ...
    public static final int[][] resolve(String[] strArr, String[][] strArr2) {
        ...
        while (i12 < length4) {
            ...
            int i14 = i13 + 1;
            if (iVarG.f8949a.containsKey(str)) {
        ...
        x xVar = new x();
        xVar.f7025a = Solution.Companion.getNO_SOLUTION();
        dfs$default(INSTANCE, arrayList, null, 0, new b(xVar, 0), 6, null);
        List<Match> matches = ((Solution) xVar.f7025a).getMatches();
    ...
    public static final p6.x resolve$lambda$19(x xVar, List list) {
        ...
        if (solutionBuild.compareTo((Solution) xVar.f7025a) < 0) {
            xVar.f7025a = solutionBuild;
        }
        return p6.x.f8464a;
    }
    ...
    public static final class Solution implements Comparable<Solution> {
        ...
        private static final Solution NO_SOLUTION = new Solution(t.f8725a, Integer.MAX_VALUE, Integer.MAX_VALUE);
        ...
        public static final class Companion {
            ...
            public final Solution build(List<Match> list) {
                ...
                for (Match match : list2) {
                    size += ((match.getResultRange().f5697b - match.getResultRange().f5696a) + 1) - match.getResultIndices().size();
                }
                ...
                int i6 = ((Match) it.next()).getResultRange().f5696a;
                while (it.hasNext()) {
                    int i10 = ((Match) it.next()).getResultRange().f5696a;
                    if (i6 > i10) {
                        i6 = i10;
                    }
                }
                ...
                int i11 = ((Match) it2.next()).getResultRange().f5697b;
                while (it2.hasNext()) {
                    int i12 = ((Match) it2.next()).getResultRange().f5697b;
                    if (i11 < i12) {
                        i11 = i12;
                    }
                }
                    ...
                    while (((i7.c) it3).f5701l) {
                        ...
                        while (true) {
                            if (it4.hasNext()) {
                                ...
                                if (resultRange.f5696a <= iNextInt && iNextInt <= resultRange.f5697b) {
                                    i14++;
                                }
                                if (i14 > 1) {
                                    i13++;
