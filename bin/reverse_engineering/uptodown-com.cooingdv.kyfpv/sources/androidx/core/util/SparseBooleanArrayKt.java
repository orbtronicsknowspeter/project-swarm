...
public final class SparseBooleanArrayKt {
    ...
    public static final boolean getOrDefault(SparseBooleanArray sparseBooleanArray, int i, boolean z9) {
        return sparseBooleanArray.get(i, z9);
    }

    public static final boolean getOrElse(SparseBooleanArray sparseBooleanArray, int i, d7.a aVar) {
    ...
    public static final boolean remove(SparseBooleanArray sparseBooleanArray, int i, boolean z9) {
        int iIndexOfKey = sparseBooleanArray.indexOfKey(i);
    ...
    public static final void set(SparseBooleanArray sparseBooleanArray, int i, boolean z9) {
