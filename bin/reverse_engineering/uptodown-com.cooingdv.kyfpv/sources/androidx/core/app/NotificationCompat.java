...
public class NotificationCompat {
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z9) {
            ...
            if (!z9 || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                i = 8;
            } else {
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            RemoteViews remoteViews = new RemoteViews(this.mBuilder.mContext.getPackageName(), z9 ? R.layout.notification_action_tombstone : R.layout.notification_action);
    ...
    public static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        boolean z9 = i10 >= 24 ? Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action) : Api20Impl.getExtras(action).getBoolean("android.support.allowGeneratedReplies");
        boolean z10 = Api20Impl.getExtras(action).getBoolean("android.support.action.showsUserInterface", true);
        ...
        boolean zIsContextual = i10 >= 29 ? Api29Impl.isContextual(action) : false;
        boolean zIsAuthenticationRequired = i10 >= 31 ? Api31Impl.isAuthenticationRequired(action) : false;
        if (Api23Impl.getIcon(action) != null || (i = action.icon) == 0) {
            return new Action(Api23Impl.getIcon(action) != null ? IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action)) : null, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z9, semanticAction, z10, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(i, action.title, action.actionIntent, Api20Impl.getExtras(action), remoteInputArr, (RemoteInput[]) null, z9, semanticAction, z10, zIsContextual, zIsAuthenticationRequired);
    }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i < size) {
                    ...
                    i++;
                    arrayList.add(Person.fromAndroidPerson(a3.b.f(obj)));
                }
            }
        } else {
    ...
    public static class BigPictureStyle extends Style {
        ...
        public static class Api31Impl {
            ...
            @RequiresApi(31)
            public static void showBigPictureWhenCollapsed(Notification.BigPictureStyle bigPictureStyle, boolean z9) {
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i < size) {
                    Object obj = parcelableArrayList.get(i);
                    i++;
                    addPerson(Person.fromAndroidPerson(a3.b.f(obj)));
                }
            }
        ...
        private void setFlag(int i, boolean z9) {
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            Notification notificationBuild = notificationCompatBuilder.build();
            return Build.VERSION.SDK_INT >= 24 ? Api24Impl.createHeadsUpContentView(Api24Impl.recoverBuilder(this.mContext, notificationBuild)) : notificationBuild.headsUpContentView;
        }
        ...
        @NonNull
        public Builder setLights(@ColorInt int i, int i6, int i10) {
            Notification notification = this.mNotification;
            notification.ledARGB = i;
            notification.ledOnMS = i6;
            notification.ledOffMS = i10;
            notification.flags = ((i6 == 0 || i10 == 0) ? 0 : 1) | (notification.flags & (-2));
            return this;
        }
        ...
        @NonNull
        public Builder setProgress(int i, int i6, boolean z9) {
            this.mProgressMax = i;
            this.mProgress = i6;
        ...
        @NonNull
        public Builder setSmallIcon(int i, int i6) {
            Notification notification = this.mNotification;
            notification.icon = i;
    ...
    public static class CallStyle extends Style {
        ...
        public static class Api24Impl {
            ...
            @DoNotInline
            public static Notification.Action.Builder setAllowGeneratedReplies(Notification.Action.Builder builder, boolean z9) {
        ...
        public static class Api31Impl {
            ...
            @DoNotInline
            public static Notification.Action.Builder setAuthenticationRequired(Notification.Action.Builder builder, boolean z9) {
            ...
            @DoNotInline
            public static Notification.CallStyle setIsVideo(Notification.CallStyle callStyle, boolean z9) {
        ...
        private CallStyle(int i, @NonNull Person person, @Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable PendingIntent pendingIntent3) {
            if (person == null || TextUtils.isEmpty(person.getName())) {
                com.google.gson.internal.a.p("person must have a non-empty a name");
                throw null;
            }
            this.mCallType = i;
            this.mPerson = person;
        ...
        @NonNull
        @RequiresApi(20)
        private Action makeAction(int i, int i6, Integer num, int i10, PendingIntent pendingIntent) {
            if (num == null) {
        ...
        private Action makeAnswerAction() {
            ...
            boolean z9 = this.mIsVideo;
            return makeAction(z9 ? i : i6, z9 ? R.string.call_notification_answer_video_action : R.string.call_notification_answer_action, this.mAnswerButtonColor, R.color.call_notification_answer_color, pendingIntent);
        }
            ...
            if (i < 31) {
                ...
                if (person2 != null) {
                    ...
                    if (i >= 28) {
                        ...
                        Api21Impl.addPerson(builder, person3.getUri());
                    }
                }
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(a3.b.f(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
        ...
        @NonNull
        public CallStyle setIsVideo(boolean z9) {
            this.mIsVideo = z9;
            return this;
        }
    ...
    public static class MessagingStyle extends Style {
        ...
        public static class Api28Impl {
            ...
            @DoNotInline
            public static Notification.MessagingStyle setGroupConversation(Notification.MessagingStyle messagingStyle, boolean z9) {
        ...
        public MessagingStyle(@NonNull Person person) {
            if (TextUtils.isEmpty(person.getName())) {
                com.google.gson.internal.a.p("User's name must not be empty.");
                throw null;
            }
            this.mUser = person;
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            for (int size = this.mMessages.size() - 1; size >= 0; size--) {
                Message message = this.mMessages.get(size);
                CharSequence charSequenceMakeMessageLine = z9 ? makeMessageLine(message) : message.getText();
    ...
    public static final class CarExtender implements Extender {
        ...
        public static class Api20Impl {
            ...
            @DoNotInline
            public static RemoteInput.Builder setAllowFreeFormInput(RemoteInput.Builder builder, boolean z9) {
    ...
    public static abstract class Style {
        ...
        public static class Api24Impl {
            ...
            @DoNotInline
            public static void setChronometerCountDown(RemoteViews remoteViews, int i, boolean z9) {
        ...
        private Bitmap createColoredBitmap(@NonNull IconCompat iconCompat, int i, int i6) {
        ...
        private Bitmap createIconWithBackground(int i, int i6, int i10, int i11) {
            int i12 = R.drawable.notification_icon_background;
            if (i11 == 0) {
                i11 = 0;
            }
            Bitmap bitmapCreateColoredBitmap = createColoredBitmap(i12, i11, i6);
        ...
        */
        ...
        private Bitmap createColoredBitmap(int i, int i6, int i10) {
            return createColoredBitmap(IconCompat.createWithResource(this.mBuilder.mContext, i), i6, i10);
        }

        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        public Bitmap createColoredBitmap(int i, int i6) {
            return createColoredBitmap(i, i6, 0);
        }
    }
    ...
    public static final class BubbleMetadata {
        ...
        private BubbleMetadata(@Nullable PendingIntent pendingIntent, @Nullable PendingIntent pendingIntent2, @Nullable IconCompat iconCompat, int i, @DimenRes int i6, int i10, @Nullable String str) {
        ...
        public static final class Builder {
            ...
            public Builder(@NonNull PendingIntent pendingIntent, @NonNull IconCompat iconCompat) {
                if (pendingIntent == null) {
                    com.google.gson.internal.a.i("Bubble requires non-null pending intent");
                    throw null;
                }
                if (iconCompat == null) {
                    com.google.gson.internal.a.i("Bubbles require non-null icon");
                    throw null;
                }
                this.mPendingIntent = pendingIntent;
                this.mIcon = iconCompat;
            ...
            @NonNull
            private Builder setFlag(int i, boolean z9) {
                int i6 = this.mFlags;
                if (z9) {
                    this.mFlags = i | i6;
                    return this;
            ...
            public BubbleMetadata build() {
                ...
                if (str == null && this.mPendingIntent == null) {
                    com.google.gson.internal.a.i("Must supply pending intent or shortcut to bubble");
                    return null;
                }
                if (str == null && this.mIcon == null) {
                    com.google.gson.internal.a.i("Must supply an icon or shortcut for the bubble");
                    return null;
                }
            ...
            public Builder setIcon(@NonNull IconCompat iconCompat) {
                if (this.mShortcutId != null) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("Created as a shortcut bubble, cannot set an Icon. Consider using BubbleMetadata.Builder(PendingIntent,Icon) instead.");
                    return null;
                }
                if (iconCompat != null) {
                    this.mIcon = iconCompat;
            ...
            public Builder setIntent(@NonNull PendingIntent pendingIntent) {
                if (this.mShortcutId != null) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("Created as a shortcut bubble, cannot set a PendingIntent. Consider using BubbleMetadata.Builder(PendingIntent,Icon) instead.");
                    return null;
                }
                if (pendingIntent != null) {
                    this.mPendingIntent = pendingIntent;
            ...
            public Builder(@NonNull String str) {
                if (!TextUtils.isEmpty(str)) {
                    ...
                    com.google.gson.internal.a.i("Bubble requires a non-null shortcut id");
                    throw null;
                }
            }
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            private Builder(@Nullable IconCompat iconCompat, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @NonNull Bundle bundle, @Nullable RemoteInput[] remoteInputArr, boolean z9, int i, boolean z10, boolean z11, boolean z12) {
            ...
            private void checkContextualActionNullFields() {
                if (this.mIsContextual && this.mIntent == null) {
                    com.google.gson.internal.a.i("Contextual Actions must contain a valid PendingIntent");
                }
            }
        ...
        public Action(int i, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z9, int i6, boolean z10, boolean z11, boolean z12) {
            this(i != 0 ? IconCompat.createWithResource(null, "", i) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z9, i6, z10, z11, z12);
        }
    ...
    public static final class TvExtender implements Extender {
        ...
        @NonNull
        public TvExtender setSuppressShowOverApps(boolean z9) {
            this.mSuppressShowOverApps = z9;
            return this;
        }
