...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(@NonNull Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                ...
                if (!collection.contains(Api26Impl.getId(notificationChannelD)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelD)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelD));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(@NonNull String str) {
        ...
        if (i >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupE = a3.b.e(it.next());
                if (Api26Impl.getId(notificationChannelGroupE).equals(str)) {
                    return notificationChannelGroupE;
                }
            }
        }
        return null;
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupE));
                    } else {
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupE, notificationChannels));
                    }
                }
                return arrayList;
            }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(a3.b.d(it.next())));
                }
                return arrayList;
            }
        }
    ...
    public static class CancelTask implements Task {
        ...
        public void send(android.support.v4.app.c cVar) throws RemoteException {
            ...
            if (z9) {
                ...
                cVar.cancel(str, this.id, this.tag);
            }
        }
