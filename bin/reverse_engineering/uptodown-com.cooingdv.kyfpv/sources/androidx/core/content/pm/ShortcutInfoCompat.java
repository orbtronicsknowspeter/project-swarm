...
public class ShortcutInfoCompat {
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, a.a(it.next())).build());
        }
        return arrayList;
    }
    ...
    public static class Builder {
        ...
        public ShortcutInfoCompat build() {
            if (TextUtils.isEmpty(this.mInfo.mLabel)) {
                com.google.gson.internal.a.p("Shortcut must have a non-empty label");
                return null;
            }
            ShortcutInfoCompat shortcutInfoCompat = this.mInfo;
            Intent[] intentArr = shortcutInfoCompat.mIntents;
            if (intentArr == null || intentArr.length == 0) {
                com.google.gson.internal.a.p("Shortcut must have an intent");
                return null;
            }
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(x.k(str, "/", str2), list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }
