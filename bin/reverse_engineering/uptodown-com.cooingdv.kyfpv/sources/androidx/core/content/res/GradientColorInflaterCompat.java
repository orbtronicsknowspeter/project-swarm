...
final class GradientColorInflaterCompat {
    ...
    private static ColorStops checkColors(@Nullable ColorStops colorStops, @ColorInt int i, @ColorInt int i6, boolean z9, @ColorInt int i10) {
        return colorStops != null ? colorStops : z9 ? new ColorStops(i, i10, i6) : new ColorStops(i, i6);
    }
    ...
    */
    ...
    public static final class ColorStops {
        ...
        public ColorStops(@ColorInt int i, @ColorInt int i6) {
            this.mColors = new int[]{i, i6};
            this.mOffsets = new float[]{0.0f, 1.0f};
        }

        public ColorStops(@ColorInt int i, @ColorInt int i6, @ColorInt int i10) {
            this.mColors = new int[]{i, i6, i10};
