...
class VersionedParcelParcel extends VersionedParcel {
    ...
    public void closeField() {
        ...
        if (i >= 0) {
            int i6 = this.mPositionLookup.get(i);
    ...
    public VersionedParcel createSubParcel() {
        ...
        return new VersionedParcelParcel(parcel, iDataPosition, i, x.n(new StringBuilder(), this.mPrefix, "  "), this.mReadCache, this.mWriteCache, this.mParcelizerCache);
    }
    ...
    public void writeByteArray(byte[] bArr, int i, int i6) {
        ...
        if (bArr != null) {
            parcel.writeInt(bArr.length);
            this.mParcel.writeByteArray(bArr, i, i6);
        } else {
            parcel.writeInt(-1);
        }
    }

    private VersionedParcelParcel(Parcel parcel, int i, int i6, String str, ArrayMap<String, Method> arrayMap, ArrayMap<String, Method> arrayMap2, ArrayMap<String, Class> arrayMap3) {
