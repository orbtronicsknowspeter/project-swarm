...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder sbU = x.u(strConcat, "current group is :");
        sbU.append(vGroup.getGroupName());
        sbU.append(" rotation is ");
        sbU.append(vGroup.mRotate);
        Log.v(LOGTAG, sbU.toString());
        Log.v(LOGTAG, strConcat + "matrix is :" + vGroup.getLocalMatrix().toString());
    ...
    public void setAutoMirrored(boolean z9) {
        ...
        if (drawable != null) {
            ...
            this.mVectorState.mAutoMirrored = z9;
        }
    }
    ...
    @Override // androidx.vectordrawable.graphics.drawable.VectorDrawableCommon, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setHotspotBounds(int i, int i6, int i10, int i11) {
        super.setHotspotBounds(i, i6, i10, i11);
    }
    ...
    public static class VectorDrawableCompatState extends Drawable.ConstantState {
        ...
        public boolean canReuseBitmap(int i, int i6) {
            return i == this.mCachedBitmap.getWidth() && i6 == this.mCachedBitmap.getHeight();
        }
        ...
        public void createCachedBitmapIfNeeded(int i, int i6) {
            if (this.mCachedBitmap == null || !canReuseBitmap(i, i6)) {
                this.mCachedBitmap = Bitmap.createBitmap(i, i6, Bitmap.Config.ARGB_8888);
        ...
        public void updateCachedBitmap(int i, int i6) {
            this.mCachedBitmap.eraseColor(0);
            this.mVPathRenderer.draw(new Canvas(this.mCachedBitmap), i, i6, null);
        }
    ...
    public static abstract class VPath extends VObject {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                sbT.append(pathDataNodeArr[i].mType);
                sbT.append(":");
                string = sbT.toString();
                for (float f : pathDataNodeArr[i].mParams) {
                    StringBuilder sbT2 = x.t(string);
                    sbT2.append(f);
                    sbT2.append(",");
        ...
        public void printVPath(int i) {
            ...
            StringBuilder sbU = x.u(strConcat, "current path is :");
            sbU.append(this.mPathName);
            sbU.append(" pathData is ");
            sbU.append(nodesToString(this.mNodes));
            Log.v(VectorDrawableCompat.LOGTAG, sbU.toString());
        }
    ...
    public static class VPathRenderer {
        ...
        private void drawGroupTree(VGroup vGroup, Matrix matrix, Canvas canvas, int i, int i6, ColorFilter colorFilter) {
            VGroup vGroup2 = vGroup;
            vGroup2.mStackedMatrix.set(matrix);
            vGroup2.mStackedMatrix.preConcat(vGroup2.mLocalMatrix);
            canvas.save();
            int i10 = 0;
            while (i10 < vGroup2.mChildren.size()) {
                VObject vObject = vGroup2.mChildren.get(i10);
                if (vObject instanceof VGroup) {
                    drawGroupTree((VGroup) vObject, vGroup2.mStackedMatrix, canvas, i, i6, colorFilter);
                } else if (vObject instanceof VPath) {
                    drawPath(vGroup2, (VPath) vObject, canvas, i, i6, colorFilter);
                }
                i10++;
                vGroup2 = vGroup;
            }
        ...
        private void drawPath(VGroup vGroup, VPath vPath, Canvas canvas, int i, int i6, ColorFilter colorFilter) {
            float f = i / this.mViewportWidth;
            float f10 = i6 / this.mViewportHeight;
            ...
            if (f11 != 0.0f || vFullPath.mTrimPathEnd != 1.0f) {
                ...
                if (f15 > f16) {
                    pathMeasure.getSegment(f15, length, path, true);
                    this.mPathMeasure.getSegment(0.0f, f16, path, true);
                } else {
                    pathMeasure.getSegment(f15, f16, path, true);
                }
        ...
        public void draw(Canvas canvas, int i, int i6, ColorFilter colorFilter) {
            drawGroupTree(this.mRootGroup, IDENTITY_MATRIX, canvas, i, i6, colorFilter);
        }
                ...
                if (vObject instanceof VGroup) {
                    ...
                    if (vObject instanceof VFullPath) {
                        ...
                        if (!(vObject instanceof VClipPath)) {
                            a.i("Unknown object in the tree!");
                            throw null;
                        }
