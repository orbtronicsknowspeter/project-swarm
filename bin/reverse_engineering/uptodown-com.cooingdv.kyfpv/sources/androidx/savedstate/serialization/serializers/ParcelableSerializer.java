...
public abstract class ParcelableSerializer<T extends Parcelable> implements b {
    private final e descriptor = t1.n("android.os.Parcelable", new e[0]);
    ...
    public final T deserialize(c8.e eVar) {
        ...
        T t9 = (T) SavedStateReader.m143getParcelableimpl(SavedStateReader.m97constructorimpl(savedStateDecoder.getSavedState$savedstate()), savedStateDecoder.getKey$savedstate(), y.a(Parcelable.class));
        t9.getClass();
        return t9;
    }
    ...
    public final void serialize(f fVar, T t9) {
        ...
        if (!(fVar instanceof SavedStateEncoder)) {
            ...
            SavedStateWriter.m207putParcelableimpl(SavedStateWriter.m183constructorimpl(savedStateEncoder.getSavedState$savedstate()), savedStateEncoder.getKey$savedstate(), t9);
        }
    }
}
