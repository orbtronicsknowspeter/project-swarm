    ...
    public static final RoundedPolygon RoundedPolygon(float[] fArr, CornerRounding cornerRounding, List<CornerRounding> list, float f, float f10) {
        ...
        for (int i19 = 0; i19 < length; i19++) {
            ...
            for (int i20 = 0; i20 < 2; i20++) {
                ...
                mutableFloatList.add(((((RoundedCorner) arrayList2.get(i19)).getExpectedCut() - ((RoundedCorner) arrayList2.get(i19)).getExpectedRoundCut()) * ((Number) iVar.f8443b).floatValue()) + (((RoundedCorner) arrayList2.get(i19)).getExpectedRoundCut() * ((Number) iVar.f8442a).floatValue()));
            }
