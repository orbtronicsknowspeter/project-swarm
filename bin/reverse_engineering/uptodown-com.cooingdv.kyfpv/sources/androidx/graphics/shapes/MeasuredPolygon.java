...
public final class MeasuredPolygon extends e {
    ...
    public final class MeasuredCubic {
        ...
        public final i cutAtProgress(float f) {
            ...
            return new i(new MeasuredCubic(this.this$0, (Cubic) iVarSplit.f8442a, this.startOutlineProgress, fI), new MeasuredCubic(this.this$0, (Cubic) iVarSplit.f8443b, fI, this.endOutlineProgress));
        }
    ...
    public final MeasuredPolygon cutAndShift(float f) {
        ...
        MeasuredCubic measuredCubic = (MeasuredCubic) iVarCutAtProgress.f8442a;
        MeasuredCubic measuredCubic2 = (MeasuredCubic) iVarCutAtProgress.f8443b;
        String unused = PolygonMeasureKt.LOG_TAG;
    ...
    public static final class Companion {
        ...
        public final MeasuredPolygon measurePolygon$graphics_shapes_release(Measurer measurer, RoundedPolygon roundedPolygon) {
            ...
            for (int i12 = 0; i12 < size5; i12++) {
                int iIntValue = ((Number) ((i) arrayList2.get(i12)).f8443b).intValue();
                cVarT.add(new ProgressableFeature((mutableFloatList.get(iIntValue + 1) + mutableFloatList.get(iIntValue)) / 2, (Feature) ((i) arrayList2.get(i12)).f8442a));
            }
