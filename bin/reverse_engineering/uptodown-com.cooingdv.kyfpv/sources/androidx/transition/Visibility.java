...
public abstract class Visibility extends Transition {
    ...
    private VisibilityInfo getVisibilityChangeInfo(TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (transitionValues != null && transitionValues2 != null) {
            ...
            if (i != i6 || visibilityInfo.mStartParent != visibilityInfo.mEndParent) {
                if (i != i6) {
                    if (i == 0) {
                        visibilityInfo.mFadeIn = false;
    ...
    public Animator createAnimator(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, @Nullable TransitionValues transitionValues2) {
        ...
        boolean z9 = visibilityChangeInfo.mFadeIn;
        int i = visibilityChangeInfo.mStartVisibility;
        return z9 ? onAppear(viewGroup, transitionValues, i, transitionValues2, visibilityChangeInfo.mEndVisibility) : onDisappear(viewGroup, transitionValues, i, transitionValues2, visibilityChangeInfo.mEndVisibility);
    }
    ...
    @Nullable
    public Animator onAppear(@NonNull ViewGroup viewGroup, @Nullable TransitionValues transitionValues, int i, @Nullable TransitionValues transitionValues2, int i6) {
    ...
    */
    ...
    public void setMode(int i) {
        if ((i & (-4)) == 0) {
            ...
            com.google.gson.internal.a.p("Only MODE_IN and MODE_OUT flags are allowed");
        }
    }
    ...
    public static class DisappearListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public DisappearListener(View view, int i, boolean z9) {
            this.mView = view;
        ...
        private void suppressLayout(boolean z9) {
            ...
            ViewGroupUtils.suppressLayout(viewGroup, z9);
        }
