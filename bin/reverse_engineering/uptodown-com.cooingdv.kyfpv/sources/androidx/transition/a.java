...
public final /* synthetic */ class a implements CancellationSignal.OnCancelListener, CallbackToFutureAdapter.Resolver, z.b, f, h, j1.a {
    ...
    public Object apply(Object obj) throws Throwable {
        ...
        switch (i) {
            case 4:
                ...
                if (jSimpleQueryForLong >= aVar.f11575a) {
                    hVar.f(1L, cVar3, str);
                    return -1L;
                }
                ...
                if (lC != null) {
                    ...
                    contentValues.put("backend_name", jVar.f8832a);
                    contentValues.put("priority", Integer.valueOf(b0.a.a(jVar.f8834c)));
                ...
                int i15 = aVar.f11579e;
                byte[] bArr2 = mVar.f8843b;
                boolean z9 = bArr2.length <= i15;
                ContentValues contentValues2 = new ContentValues();
                contentValues2.put("context_id", Long.valueOf(jInsert));
                contentValues2.put("transport_name", str);
                contentValues2.put("timestamp_ms", Long.valueOf(iVar.f8830d));
                contentValues2.put("uptime_ms", Long.valueOf(iVar.f8831e));
                contentValues2.put("payload_encoding", mVar.f8842a.f8126a);
                contentValues2.put("code", iVar.f8828b);
            ...
            case 5:
                ...
                while (true) {
                    if (cursor2.moveToNext()) {
                        ...
                        r.h hVar3 = new r.h();
                        hVar3.f8824r = new HashMap();
                        String string = cursor2.getString(i13);
                        if (string != null) {
                            hVar3.f8817b = string;
                            hVar3.f8822p = Long.valueOf(cursor2.getLong(i12));
                            hVar3.f8823q = Long.valueOf(cursor2.getLong(3));
                            if (i17 != 0) {
                                String string2 = cursor2.getString(4);
                                hVar3.f8821o = new m(string2 == null ? y.h.f11587o : new o.c(string2), cursor2.getBlob(5));
                            } else {
                                String string3 = cursor2.getString(4);
                                o.c cVar4 = string3 == null ? y.h.f11587o : new o.c(string3);
                                ...
                                try {
                                    ...
                                    cursorQuery.close();
                                    hVar3.f8821o = new m(cVar4, bArr3);
                                } catch (Throwable th2) {
                                    th = th2;
                                    cursor = cursorQuery;
                                }
                            ...
                            if (!cursor2.isNull(6)) {
                                hVar3.f8819m = Integer.valueOf(cursor2.getInt(6));
                            }
                            if (!cursor2.isNull(8)) {
                                hVar3.f8820n = Integer.valueOf(cursor2.getInt(8));
                            }
                            if (!cursor2.isNull(9)) {
                                hVar3.f8818l = cursor2.getString(9);
                            }
                            if (!cursor2.isNull(10)) {
                                hVar3.f8825s = cursor2.getBlob(10);
                            }
                            if (!cursor2.isNull(11)) {
                                hVar3.f8826t = cursor2.getBlob(11);
                            }
            ...
            default:
                ...
                s sVar = (s) obj2;
                ArrayList arrayList4 = (ArrayList) sVar.f11758m;
                ...
                try {
                    ...
                    try {
                        ...
                        sVar.f11757l = gVar;
                        sVar.f11759n = new u.b(new u.f(hVar4.b().compileStatement("PRAGMA page_size").simpleQueryForLong() * hVar4.b().compileStatement("PRAGMA page_count").simpleQueryForLong(), y.a.f.f11575a));
                        sVar.f11756b = (String) hVar4.f11592n.get();
                        return new u.a((g) sVar.f11757l, DesugarCollections.unmodifiableList(arrayList4), (u.b) sVar.f11759n, (String) sVar.f11756b);
                    } catch (Throwable th3) {
                        cursorRawQuery.close();
                        throw th3;
                    }
    ...
    public Object execute() {
        ...
        j jVar = (j) this.f519l;
        i iVar = (i) this.f520m;
        y.h hVar = (y.h) aVar.f10909d;
        hVar.getClass();
        o.d dVar = jVar.f8834c;
        String str = iVar.f8827a;
        String str2 = jVar.f8832a;
    ...
    public Object g(j1.p pVar) {
        ...
        if (pVar.i()) {
            ...
            ((j1.p) ((g5.f) gVar.f5316b).f5310b).l(null);
        }
        return t1.x(null);
    }
    ...
    public j1.p q(Object obj) {
        ...
        synchronized (gVarC) {
            ...
            if (strB2 != null) {
                SharedPreferences.Editor editorEdit = ((SharedPreferences) gVarC.f5316b).edit();
                editorEdit.putString(strD + "|T|" + str + "|*", strB2);
                editorEdit.commit();
            }
        }
        if (h2Var == null || !str2.equals(h2Var.f11212a)) {
            n1.f fVar2 = firebaseMessaging.f3085a;
            fVar2.a();
            if ("[DEFAULT]".equals(fVar2.f7910b)) {
                if (Log.isLoggable("FirebaseMessaging", 3)) {
                    StringBuilder sb = new StringBuilder("Invoking onNewToken for app: ");
                    fVar2.a();
                    sb.append(fVar2.f7910b);
