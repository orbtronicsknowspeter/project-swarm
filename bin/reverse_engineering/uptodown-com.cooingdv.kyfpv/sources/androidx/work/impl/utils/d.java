    ...
    public final Object call() {
        switch (this.f637a) {
            ...
            case 1:
                ...
                g2.a aVar = (g2.a) eVar.f5124p;
                g2.f fVar = (g2.f) eVar.f5120l;
            ...
            default:
                ...
                lVar.getClass();
                z1.e.a();
                m8.q qVar = lVar.f11639c;
                e2.d dVar = (e2.d) qVar.f7782l;
                String str3 = (String) qVar.f7781b;
                dVar.getClass();
                boolean z9 = true;
                if (new File((File) dVar.f4469m, str3).exists()) {
                    if (Log.isLoggable("FirebaseCrashlytics", 2)) {
                        Log.v("FirebaseCrashlytics", "Found previous crash marker.", null);
                    }
                    e2.d dVar2 = (e2.d) qVar.f7782l;
                    dVar2.getClass();
                    new File((File) dVar2.f4469m, str3).delete();
