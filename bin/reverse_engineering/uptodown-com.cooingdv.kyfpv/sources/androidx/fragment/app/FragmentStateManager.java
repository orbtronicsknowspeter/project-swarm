...
class FragmentStateManager {
    ...
    public void attach() {
        ...
        if (fragment2 != null) {
            ...
            if (str != null && (fragmentStateManager = this.mFragmentStore.getFragmentStateManager(str)) == null) {
                ...
                androidx.privacysandbox.ads.adservices.customaudience.a.i(x.n(sb2, this.mFragment.mTargetWho, " that does not belong to this FragmentManager!"));
                return;
            }
        }
    ...
    public int computeExpectedState() {
        ...
        if (fragment2.mFromLayout) {
            boolean z9 = fragment2.mInLayout;
            ...
            if (z9) {
                ...
                iMin = i6 < 4 ? Math.min(iMin, fragment2.mState) : Math.min(iMin, 1);
            }
        }
        ...
        if (FragmentManager.isLoggingEnabled(2)) {
            StringBuilder sbP = x.p(iMin, "computeExpectedState() of ", " for ");
            sbP.append(this.mFragment);
    ...
    public void createView() {
        ...
        if (viewGroup == null) {
            ...
            if (i == 0) {
                ...
                if (i == -1) {
                    a3.b.q(this.mFragment, "Cannot create fragment ", " for a container view with no id");
                    return;
                }
        ...
        if (view != null) {
            ...
            if (zIsAttachedToWindow) {
                ...
                final View view2 = fragment7.mView;
    ...
    public void destroy() {
        ...
        if (!z9 && !this.mFragmentStore.getNonConfig().shouldDestroy(this.mFragment)) {
        ...
        if ((z9 && !this.mFragment.mBeingSaved) || zIsChangingConfigurations) {
        ...
        try {
            ...
            while (true) {
                ...
                if (iComputeExpectedState == i) {
                    if (!z9 && i == -1 && fragment.mRemoving && !fragment.isInBackStack() && !this.mFragment.mBeingSaved) {
                        if (FragmentManager.isLoggingEnabled(3)) {
