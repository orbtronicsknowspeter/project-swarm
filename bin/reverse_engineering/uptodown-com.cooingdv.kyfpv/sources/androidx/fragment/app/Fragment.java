...
public class Fragment implements ComponentCallbacks, View.OnCreateContextMenuListener, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, ActivityResultCaller {
    ...
    public static Fragment instantiate(@NonNull Context context, @NonNull String str, @Nullable Bundle bundle) {
        try {
            ...
            throw new InstantiationException(l.w("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e10);
        } catch (java.lang.InstantiationException e11) {
            throw new InstantiationException(l.w("Unable to instantiate fragment ", str, ": make sure class name exists, is public, and has an empty constructor that is public"), e11);
        } catch (NoSuchMethodException e12) {
            throw new InstantiationException(l.w("Unable to instantiate fragment ", str, ": could not find Fragment constructor"), e12);
        } catch (InvocationTargetException e13) {
            throw new InstantiationException(l.w("Unable to instantiate fragment ", str, ": calling Fragment constructor caused an exception"), e13);
        }
    }
    ...
    private <I, O> ActivityResultLauncher<I> prepareCallInternal(@NonNull final ActivityResultContract<I, O> activityResultContract, @NonNull final Function<Void, ActivityResultRegistry> function, @NonNull final ActivityResultCallback<O> activityResultCallback) {
        if (this.mState > 1) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " is attempting to registerForActivityResult after being created. Fragments must call registerForActivityResult() before they are created (i.e. initialization, onAttach(), or onCreate())."));
            return null;
        }
        ...
        return new ActivityResultLauncher<I>() { // from class: androidx.fragment.app.Fragment.10
            ...
            public void launch(I i, @Nullable ActivityOptionsCompat activityOptionsCompat) {
                ...
                if (activityResultLauncher != null) {
                    ...
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("Operation cannot be started before fragment is in created state");
                }
            }
    ...
    public FragmentContainer createFragmentContainer() {
        return new FragmentContainer() { // from class: androidx.fragment.app.Fragment.5
            ...
            public View onFindViewById(int i) {
                ...
                androidx.core.view.contentcapture.a.n(Fragment.this, "Fragment ", " does not have a view");
                return null;
            }
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        this.mChildFragmentManager.dump(x.C(str, "  "), fileDescriptor, printWriter, strArr);
    }
    ...
    public final FragmentManager getChildFragmentManager() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " has not been attached yet."));
        return null;
    }
    ...
    public ViewModelProvider.Factory getDefaultViewModelProviderFactory() {
        Application application;
        if (this.mFragmentManager == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Can't access ViewModels from detached fragment");
            return null;
        }
    ...
    public LayoutInflater getLayoutInflater(@Nullable Bundle bundle) {
        FragmentHostCallback<?> fragmentHostCallback = this.mHost;
        if (fragmentHostCallback == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("onGetLayoutInflater() cannot be executed until the Fragment is attached to the FragmentManager.");
            return null;
        }
    ...
    public final FragmentManager getParentFragmentManager() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " not associated with a fragment manager."));
        return null;
    }
    ...
    public LifecycleOwner getViewLifecycleOwner() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i("Can't access the Fragment View's LifecycleOwner when getView() is null i.e., before onCreateView() or after onDestroyView()");
        return null;
    }
    ...
    public ViewModelStore getViewModelStore() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i("Calling getViewModelStore() before a Fragment reaches onCreate() when using setMaxLifecycle(INITIALIZED) is not supported");
        return null;
    }
    ...
    public void onActivityResult(int i, int i6, @Nullable Intent intent) {
        if (FragmentManager.isLoggingEnabled(2)) {
            Log.v(FragmentManager.TAG, "Fragment " + this + " received the following in onActivityResult(): requestCode: " + i + " resultCode: " + i6 + " data: " + intent);
        }
    }
    ...
    @Nullable
    @MainThread
    public Animation onCreateAnimation(int i, boolean z9, int i6) {
        return null;
    }

    @Nullable
    @MainThread
    public Animator onCreateAnimator(int i, boolean z9, int i6) {
        return null;
    }
    ...
    public void performActivityCreated(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onActivityCreated()"));
        }
        restoreViewState();
    ...
    public void performAttach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onAttach()"));
        }
    ...
    public void performCreate(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onCreate()"));
        }
    ...
    public boolean performCreateOptionsMenu(@NonNull Menu menu, @NonNull MenuInflater menuInflater) {
        ...
        return this.mChildFragmentManager.dispatchCreateOptionsMenu(menu, menuInflater) | z9;
    }
    ...
    public void performCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        if (viewOnCreateView == null) {
            if (fragmentViewLifecycleOwner.isInitialized()) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i("Called getViewLifecycleOwner() but onCreateView() returned null");
                return;
            } else {
    ...
    public void performDestroy() {
        ...
        onDestroy();
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onDestroy()"));
        }
    }
    ...
    public void performDestroyView() {
        ...
        onDestroyView();
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onDestroyView()"));
        }
    ...
    public void performDetach() {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onDetach()"));
        }
    ...
    public void performPause() {
        ...
        onPause();
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onPause()"));
        }
    }
    ...
    public boolean performPrepareOptionsMenu(@NonNull Menu menu) {
        ...
        return this.mChildFragmentManager.dispatchPrepareOptionsMenu(menu) | z9;
    }
    ...
    public void performResume() {
        ...
        onResume();
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onResume()"));
        }
    ...
    public void performStart() {
        ...
        onStart();
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onStart()"));
        }
        LifecycleRegistry lifecycleRegistry = this.mLifecycleRegistry;
    ...
    public void performStop() {
        ...
        onStop();
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onStop()"));
        }
    }
    ...
    public final void requestPermissions(@NonNull String[] strArr, int i) {
        if (this.mHost != null) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " not attached to Activity"));
        }
    }
    ...
    public final FragmentActivity requireActivity() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " not attached to an activity."));
        return null;
    }
    ...
    public final Bundle requireArguments() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " does not have any arguments."));
        return null;
    }
    ...
    public final Context requireContext() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " not attached to a context."));
        return null;
    }
    ...
    public final Object requireHost() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " not attached to a host."));
        return null;
    }
    ...
    public final Fragment requireParentFragment() {
        ...
        if (getContext() == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " is not attached to any Fragment or host"));
            return null;
        }
    ...
    public final View requireView() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " did not return a View from onCreateView() or this was called before onCreateView()."));
        return null;
    }
    ...
    public final void restoreViewState(Bundle bundle) {
        ...
        if (!this.mCalled) {
            throw new SuperNotCalledException(x.i("Fragment ", this, " did not call through to super.onViewStateRestored()"));
        }
        if (this.mView != null) {
    ...
    public void setAllowEnterTransitionOverlap(boolean z9) {
        ensureAnimationInfo().mAllowEnterTransitionOverlap = Boolean.valueOf(z9);
    }

    public void setAllowReturnTransitionOverlap(boolean z9) {
        ensureAnimationInfo().mAllowReturnTransitionOverlap = Boolean.valueOf(z9);
    }

    public void setAnimations(@AnimRes int i, @AnimRes int i6, @AnimRes int i10, @AnimRes int i11) {
        if (this.mAnimationInfo == null && i == 0 && i6 == 0 && i10 == 0 && i11 == 0) {
            return;
        }
    ...
    public void setArguments(@Nullable Bundle bundle) {
        if (this.mFragmentManager == null || !isStateSaved()) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Fragment already added and state has been saved");
        }
    }
    ...
    public void setInitialSavedState(@Nullable SavedState savedState) {
        Bundle bundle;
        if (this.mFragmentManager != null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Fragment already added");
            return;
        }
    ...
    public void setTargetFragment(@Nullable Fragment fragment, int i) {
        ...
        if (fragmentManager != null && fragmentManager2 != null && fragmentManager != fragmentManager2) {
            com.google.gson.internal.a.p(x.i("Fragment ", fragment, " must share the same FragmentManager to be set as a target fragment"));
            return;
        }
    ...
    public void setUserVisibleHint(boolean z9) {
        FragmentStrictMode.onSetUserVisibleHint(this, z9);
    ...
    @Deprecated
    public void startIntentSenderForResult(@SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i, @Nullable Intent intent, int i6, int i10, int i11, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        Bundle bundle2;
        if (this.mHost == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i(x.i("Fragment ", this, " not attached to Activity"));
            return;
        ...
        getParentFragmentManager().launchStartIntentSenderForResult(this, intentSender, i, intent, i6, i10, i11, bundle2);
    }
