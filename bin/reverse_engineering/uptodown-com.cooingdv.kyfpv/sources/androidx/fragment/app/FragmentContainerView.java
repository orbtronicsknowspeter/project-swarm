...
public final class FragmentContainerView extends FrameLayout {
    ...
    public FragmentContainerView(Context context, AttributeSet attributeSet, FragmentManager fragmentManager) {
        ...
        if (classAttribute != null && fragmentFindFragmentById == null) {
            if (id == -1) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i(l.w("FragmentContainerView must have an android:id to add Fragment ", classAttribute, string != null ? " with tag ".concat(string) : ""));
                throw null;
            }
    ...
    @Override // android.view.ViewGroup
    public void removeViews(int i, int i6) {
        int i10 = i + i6;
    ...
    @Override // android.view.ViewGroup
    public void removeViewsInLayout(int i, int i6) {
        int i10 = i + i6;
        for (int i11 = i; i11 < i10; i11++) {
            View childAt = getChildAt(i11);
            childAt.getClass();
    ...
    public /* synthetic */ FragmentContainerView(Context context, AttributeSet attributeSet, int i, int i6, g gVar) {
