...
public class FragmentActivity extends ComponentActivity implements ActivityCompat.OnRequestPermissionsResultCallback, ActivityCompat.RequestPermissionsRequestCodeValidator {
    ...
    private void init() {
        getSavedStateRegistry().registerSavedStateProvider(LIFECYCLE_TAG, new a(this, 0));
        final int i = 0;
        addOnConfigurationChangedListener(new Consumer(this) { // from class: androidx.fragment.app.b

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ FragmentActivity f422b;
            ...
            public final void accept(Object obj) {
                switch (i) {
                    case 0:
                        this.f422b.lambda$init$1((Configuration) obj);
                        break;
                    default:
                        this.f422b.lambda$init$2((Intent) obj);
                        break;
                }
            }
        });
        final int i6 = 1;
        addOnNewIntentListener(new Consumer(this) { // from class: androidx.fragment.app.b
        ...
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: androidx.fragment.app.c
            ...
            public final void onContextAvailable(Context context) {
                this.f423a.lambda$init$3(context);
            }
        });
    }
    ...
    @Deprecated
    public void startIntentSenderFromFragment(@NonNull Fragment fragment, @SuppressLint({"UnknownNullness"}) IntentSender intentSender, int i, @Nullable Intent intent, int i6, int i10, int i11, @Nullable Bundle bundle) throws IntentSender.SendIntentException {
        if (i == -1) {
            ActivityCompat.startIntentSenderForResult(this, intentSender, i, intent, i6, i10, i11, bundle);
        } else {
            fragment.startIntentSenderForResult(intentSender, i, intent, i6, i10, i11, bundle);
        }
    }
