...
public abstract class FragmentTransaction {
    ...
    private Fragment createFragment(@NonNull Class<? extends Fragment> cls, @Nullable Bundle bundle) {
        ...
        if (fragmentFactory == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Creating a Fragment requires that this FragmentTransaction was built with FragmentManager.beginTransaction()");
            return null;
        }
        ClassLoader classLoader = this.mClassLoader;
        if (classLoader == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("The FragmentManager must be attached to itshost to create a Fragment");
            return null;
        }
    ...
    public FragmentTransaction addSharedElement(@NonNull View view, @NonNull String str) {
        ...
        if (transitionName == null) {
            com.google.gson.internal.a.p("Unique transitionNames are required for all sharedElements");
            return null;
        }
        if (this.mSharedElementSourceNames == null) {
            ...
            if (this.mSharedElementTargetNames.contains(str)) {
                com.google.gson.internal.a.p(l.w("A shared element with the target name '", str, "' has already been added to the transaction."));
                return null;
            }
            if (this.mSharedElementSourceNames.contains(transitionName)) {
                com.google.gson.internal.a.p(l.w("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                return null;
            }
        }
    ...
    public FragmentTransaction addToBackStack(@Nullable String str) {
        if (!this.mAllowAddToBackStack) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("This FragmentTransaction is not allowed to be added to the back stack.");
            return null;
        }
    ...
    public FragmentTransaction disallowAddToBackStack() {
        if (this.mAddToBackStack) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("This transaction is already being added to the back stack");
            return null;
        }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i6) {
        ...
        if (cls.isAnonymousClass() || !Modifier.isPublic(modifiers) || (cls.isMemberClass() && !Modifier.isStatic(modifiers))) {
            androidx.core.view.contentcapture.a.n(cls.getCanonicalName(), "Fragment ", " must be a public static class to be  properly recreated from instance state.");
            return;
        }
        if (str != null) {
            ...
            if (str3 != null && !str.equals(str3)) {
                ...
                sb.append(fragment);
                sb.append(": was ");
                androidx.privacysandbox.ads.adservices.customaudience.a.i(x.o(sb, fragment.mTag, " now ", str));
                return;
            }
            fragment.mTag = str;
        }
    ...
    public FragmentTransaction replace(@IdRes int i, @NonNull Fragment fragment, @Nullable String str) {
        ...
        com.google.gson.internal.a.p("Must use non-zero containerViewId");
        return null;
    }
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i, @AnimRes @AnimatorRes int i6, @AnimRes @AnimatorRes int i10, @AnimRes @AnimatorRes int i11) {
        this.mEnterAnim = i;
        this.mExitAnim = i6;
    ...
    @NonNull
    public FragmentTransaction setCustomAnimations(@AnimRes @AnimatorRes int i, @AnimRes @AnimatorRes int i6) {
        return setCustomAnimations(i, i6, 0, 0);
    }
    ...
    public static final class Op {
        ...
        public Op(int i, Fragment fragment, boolean z9) {
            this.mCmd = i;
            this.mFragment = fragment;
