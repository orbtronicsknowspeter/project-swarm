...
public class DatePicker extends Picker {
    ...
    public DatePicker(Context context, AttributeSet attributeSet, int i) {
        ...
        ViewCompat.saveAttributeDataForStyleable(this, context, R.styleable.lbDatePicker, attributeSet, typedArrayObtainStyledAttributes, 0, 0);
        try {
    ...
    private boolean isNewDate(int i, int i6, int i10) {
        return (this.mCurrentDate.get(1) == i && this.mCurrentDate.get(2) == i10 && this.mCurrentDate.get(5) == i6) ? false : true;
    }
    ...
    public final void onColumnValueChanged(int i, int i6) {
    ...
    public void setDate(int i, int i6, int i10, boolean z9) {
        if (isNewDate(i, i6, i10)) {
            this.mCurrentDate.set(i, i6, i10);
    ...
    public void setDatePickerFormat(String str) {
        ...
        if (listExtractSeparators.size() != str.length() + 1) {
            a.i("Separators size: ", listExtractSeparators.size(), " must equal the size of datePickerFormat: ", str.length(), " + 1");
            return;
        }
        ...
        for (int i = 0; i < upperCase.length(); i++) {
            ...
            if (cCharAt == 'D') {
                if (this.mDayColumn != null) {
                    com.google.gson.internal.a.p("datePicker format error");
                    return;
                }
    ...
    public void updateSpinnersImpl(boolean z9) {
        ...
        for (int length = DATE_FIELDS.length - 1; length >= 0; length--) {
            ...
            if (i >= 0) {
                ...
                boolean zUpdateMin = (z10 ? updateMin(columnAt, this.mMinDate.get(i6)) : updateMin(columnAt, this.mCurrentDate.getActualMinimum(i6))) | (z11 ? updateMax(columnAt, this.mMaxDate.get(i6)) : updateMax(columnAt, this.mCurrentDate.getActualMaximum(i6)));
                z10 &= this.mCurrentDate.get(i6) == this.mMinDate.get(i6);
                z11 &= this.mCurrentDate.get(i6) == this.mMaxDate.get(i6);
                if (zUpdateMin) {
                    setColumnAt(iArr[length], columnAt);
                }
                setColumnValue(iArr[length], this.mCurrentDate.get(i6), z9);
            }
        }
    }
    ...
    private void setDate(int i, int i6, int i10) {
        setDate(i, i6, i10, false);
    }
