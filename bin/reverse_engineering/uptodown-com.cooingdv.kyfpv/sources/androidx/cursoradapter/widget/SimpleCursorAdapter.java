...
public class SimpleCursorAdapter extends ResourceCursorAdapter {
                ...
                if (viewBinder != null ? viewBinder.setViewValue(viewFindViewById, cursor, iArr2[i]) : false) {
                    ...
                    if (viewFindViewById instanceof TextView) {
                        ...
                        if (!(viewFindViewById instanceof ImageView)) {
                            a.i(viewFindViewById.getClass().getName().concat(" is not a  view that can be bounds by this SimpleCursorAdapter"));
                            return;
                        }
    ...
    public SimpleCursorAdapter(Context context, int i, Cursor cursor, String[] strArr, int[] iArr, int i6) {
        super(context, i, cursor, i6);
        this.mStringConversionColumn = -1;
        this.mTo = iArr;
        this.mOriginalFrom = strArr;
        findColumns(cursor, strArr);
