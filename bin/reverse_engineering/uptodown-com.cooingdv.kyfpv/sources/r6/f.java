...
public final class f implements Map, Serializable, e7.a {
    ...
    public f(int i) {
        ...
        this.f8934b = null;
        this.f8935l = iArr;
        this.f8936m = new int[iHighestOneBit];
        this.f8937n = 2;
        this.f8938o = 0;
        this.f8939p = Integer.numberOfLeadingZeros(iHighestOneBit) + 1;
    }
    ...
    public final int a(Object obj) {
        ...
        while (true) {
            int iJ = j(obj);
            int i = this.f8937n * 2;
            int length = this.f8936m.length / 2;
            if (i > length) {
                i = length;
            }
            int i6 = 0;
            while (true) {
                int[] iArr = this.f8936m;
                int i10 = iArr[iJ];
                if (i10 <= 0) {
                    int i11 = this.f8938o;
                    ...
                    if (l.a(this.f8933a[i10 - 1], obj)) {
                        return -i10;
                    }
                    i6++;
                    if (i6 > i) {
                        k(this.f8936m.length * 2);
                        break;
                    }
                    iJ = iJ == 0 ? this.f8936m.length - 1 : iJ - 1;
                }
            }
        }
    }
    ...
    public final void clear() {
        ...
        t1.L(this.f8933a, 0, this.f8938o);
        Object[] objArr = this.f8934b;
        if (objArr != null) {
            t1.L(objArr, 0, this.f8938o);
        }
        this.f8941r = 0;
        this.f8938o = 0;
        this.f8940q++;
    ...
    public final void e(boolean z9) {
        ...
        while (true) {
            ...
            if (i11 >= 0) {
                ...
                if (z9) {
                    iArr[i10] = i11;
                    this.f8936m[i11] = i10 + 1;
                }
                i10++;
            }
            i6++;
        }
        t1.L(this.f8933a, i10, i);
        if (objArr != null) {
            t1.L(objArr, i10, this.f8938o);
        }
        this.f8938o = i10;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        Map map = (Map) obj;
        return this.f8941r == map.size() && f(map.entrySet());
    }
    ...
    public final void g(int i) {
        ...
        if (i12 > objArr.length) {
            ...
            Object[] objArr2 = this.f8933a;
            objArr2.getClass();
            this.f8933a = Arrays.copyOf(objArr2, iE);
            Object[] objArr3 = this.f8934b;
            this.f8934b = objArr3 != null ? Arrays.copyOf(objArr3, iE) : null;
            this.f8935l = Arrays.copyOf(this.f8935l, iE);
            int iHighestOneBit = Integer.highestOneBit((iE >= 1 ? iE : 1) * 3);
            if (iHighestOneBit > this.f8936m.length) {
                k(iHighestOneBit);
            }
        }
    }
    ...
    public final int h(Object obj) {
        ...
        int i = this.f8937n;
        while (true) {
            int i6 = this.f8936m[iJ];
            if (i6 == 0) {
                return -1;
            }
            if (i6 > 0) {
                int i10 = i6 - 1;
                if (l.a(this.f8933a[i10], obj)) {
                    return i10;
                }
            }
            i--;
    ...
    public final int hashCode() {
        ...
        while (dVar.hasNext()) {
            ...
            dVar.f8925b = i6 + 1;
            dVar.f8926l = i6;
            Object obj = fVar.f8933a[i6];
            int iHashCode = obj != null ? obj.hashCode() : 0;
            Object[] objArr = fVar.f8934b;
            objArr.getClass();
            Object obj2 = objArr[dVar.f8926l];
    ...
    public final boolean isEmpty() {
        return this.f8941r == 0;
    }

    public final int j(Object obj) {
        return ((obj != null ? obj.hashCode() : 0) * (-1640531527)) >>> this.f8939p;
    }
    ...
    */
    public final void l(int r12) {
        /*
            r11 = this;
            java.lang.Object[] r0 = r11.f8933a
            r0.getClass()
            r1 = 0
            r0[r12] = r1
            java.lang.Object[] r0 = r11.f8934b
            if (r0 == 0) goto Le
            r0[r12] = r1
        Le:
            int[] r0 = r11.f8935l
        ...
        L44:
            ...
            goto L61
        L47:
            java.lang.Object[] r6 = r11.f8933a
            int r8 = r5 + (-1)
            r6 = r6[r8]
            int r6 = r11.j(r6)
            int r6 = r6 - r0
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder((this.f8941r * 3) + 2);
        sb.append("{");
        int i = 0;
        d dVar = new d(this, 0);
        while (dVar.hasNext()) {
