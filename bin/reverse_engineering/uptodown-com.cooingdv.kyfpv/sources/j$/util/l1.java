...
public final class l1 implements v0 {
    ...
    public l1(double[] dArr, int i, int i6, int i10) {
        ...
        this.f6092b = i;
        this.f6093c = i6;
        this.f6094d = i10 | 16448;
    }

    @Override // j$.util.e1, j$.util.Spliterator
    public final v0 trySplit() {
        int i = this.f6092b;
        int i6 = (this.f6093c + i) >>> 1;
        if (i >= i6) {
            return null;
        }
        this.f6092b = i6;
        return new l1(this.f6091a, i, i6, this.f6094d);
    }
    ...
    public final void forEachRemaining(DoubleConsumer doubleConsumer) {
        ...
        double[] dArr = this.f6091a;
        int length = dArr.length;
        int i6 = this.f6093c;
        if (length < i6 || (i = this.f6092b) < 0) {
            return;
        }
        this.f6092b = i6;
        if (i < i6) {
    ...
    public final boolean tryAdvance(DoubleConsumer doubleConsumer) {
        doubleConsumer.getClass();
        int i = this.f6092b;
        if (i < 0 || i >= this.f6093c) {
            return false;
        }
        this.f6092b = i + 1;
        doubleConsumer.accept(this.f6091a[i]);
        return true;
    }

    @Override // j$.util.Spliterator
    public final long estimateSize() {
        return this.f6093c - this.f6092b;
    }
