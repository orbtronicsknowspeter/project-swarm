...
public final class t extends w {
    ...
    public final void forEach(Consumer consumer) {
        ...
        Collection.EL.a(this.f6097a, new q(0, consumer));
    }

    @Override // j$.util.n, java.util.Collection, java.lang.Iterable, j$.util.Collection
    public final Spliterator spliterator() {
        return new s(Collection.EL.c(this.f6097a));
    }
    ...
    public final Object[] toArray() {
        Object[] array = this.f6097a.toArray();
    ...
    public final Object[] toArray(Object[] objArr) {
        Object[] array = this.f6097a.toArray(objArr.length == 0 ? objArr : Arrays.copyOf(objArr, 0));
        for (int i = 0; i < array.length; i++) {
            array[i] = new r((Map.Entry) array[i]);
        }
    ...
    public final boolean contains(Object obj) {
        if (obj instanceof Map.Entry) {
            return this.f6097a.contains(new r((Map.Entry) obj));
        }
        return false;
    }
