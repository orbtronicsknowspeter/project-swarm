...
public final /* synthetic */ class x0 implements Spliterator.OfInt {
    ...
    public final /* synthetic */ y0 f6477a;
    ...
    public static /* synthetic */ Spliterator.OfInt a(y0 y0Var) {
        ...
        return y0Var instanceof w0 ? ((w0) y0Var).f6474a : new x0(y0Var);
    }
    ...
    public final /* synthetic */ void forEachRemaining(IntConsumer intConsumer) {
        this.f6477a.forEachRemaining((Object) intConsumer);
    }

    @Override // java.util.Spliterator.OfInt, java.util.Spliterator
    public final /* synthetic */ void forEachRemaining(Consumer consumer) {
        this.f6477a.forEachRemaining(consumer);
    }

    @Override // java.util.Spliterator.OfInt
    /* JADX INFO: renamed from: forEachRemaining, reason: avoid collision after fix types in other method */
    public final /* synthetic */ void forEachRemaining2(IntConsumer intConsumer) {
        this.f6477a.forEachRemaining(intConsumer);
    }
    ...
    public final /* synthetic */ boolean tryAdvance(IntConsumer intConsumer) {
        return this.f6477a.tryAdvance((Object) intConsumer);
    }

    @Override // java.util.Spliterator.OfInt, java.util.Spliterator
    public final /* synthetic */ boolean tryAdvance(Consumer consumer) {
        return this.f6477a.tryAdvance(consumer);
    }
    ...
    public final /* synthetic */ boolean tryAdvance2(IntConsumer intConsumer) {
        return this.f6477a.tryAdvance(intConsumer);
    }
    ...
    public final /* synthetic */ Spliterator.OfPrimitive trySplit() {
        return d1.a(this.f6477a.trySplit());
    }

    @Override // java.util.Spliterator.OfInt, java.util.Spliterator.OfPrimitive, java.util.Spliterator
    public final /* synthetic */ java.util.Spliterator trySplit() {
        return Spliterator.Wrapper.convert(this.f6477a.trySplit());
    }
}
