...
public final class e extends b implements Set, Collection {
    ...
    public final boolean add(Object obj) {
        ...
        return this.f5995a.f(entry.getKey(), entry.getValue(), false) == null;
    }
    ...
    public final boolean contains(Object obj) {
        ...
        Object obj2;
        Object value;
        if (!(obj instanceof Map.Entry) || (key = (entry = (Map.Entry) obj).getKey()) == null || (obj2 = this.f5995a.get(key)) == null || (value = entry.getValue()) == null) {
            return false;
        }
    ...
    public final boolean remove(Object obj) {
        ...
        Object key;
        Object value;
        return (obj instanceof Map.Entry) && (key = (entry = (Map.Entry) obj).getKey()) != null && (value = entry.getValue()) != null && this.f5995a.remove(key, value);
    }
    ...
    public final boolean addAll(java.util.Collection collection) {
        ...
        while (it.hasNext()) {
            ...
            if (this.f5995a.f(entry.getKey(), entry.getValue(), false) == null) {
                z9 = true;
            }
        }
        return z9;
    ...
    public final void forEach(Consumer consumer) {
        ...
        while (true) {
            ...
            if (lVarA == null) {
                ...
                consumer.n(new k(lVarA.f6002b, lVarA.f6003c, this.f5995a));
            }
        }
    }
}
