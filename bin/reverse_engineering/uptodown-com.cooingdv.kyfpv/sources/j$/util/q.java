...
public final /* synthetic */ class q implements Consumer, Predicate, Supplier, DoubleFunction, Function, LongFunction, BooleanSupplier {
    ...
    public boolean test(Object obj) {
        return !((Predicate) this.f6105b).test(obj);
    }

    @Override // java.util.function.Function
    public Object apply(Object obj) {
        Object objApply = ((Function) this.f6105b).apply(obj);
        if (objApply == null) {
            return null;
        }
    ...
    public Object apply(double d10) {
        Object objApply = ((DoubleFunction) this.f6105b).apply(d10);
        if (objApply == null) {
            return null;
        }
        if (objApply instanceof j$.util.stream.e0) {
    ...
    public Object apply(long j) {
        Object objApply = ((LongFunction) this.f6105b).apply(j);
        if (objApply == null) {
            return null;
        }
        if (objApply instanceof j$.util.stream.n1) {
    ...
    public boolean getAsBoolean() {
        switch (this.f6104a) {
            case 10:
                k7 k7Var = (k7) this.f6105b;
                return k7Var.f6145d.tryAdvance(k7Var.f6146e);
            case 11:
                m7 m7Var = (m7) this.f6105b;
                return m7Var.f6145d.tryAdvance(m7Var.f6146e);
            case 12:
                o7 o7Var = (o7) this.f6105b;
                return o7Var.f6145d.tryAdvance(o7Var.f6146e);
            default:
                d8 d8Var = (d8) this.f6105b;
                return d8Var.f6145d.tryAdvance(d8Var.f6146e);
        }
    }
    ...
    public Object get() {
        switch (this.f6104a) {
            case 2:
                return ((j$.util.stream.a) this.f6105b).N(0);
            case 3:
                return (Spliterator) this.f6105b;
            default:
                CharSequence charSequence = (CharSequence) this.f6105b;
    ...
    public void accept(Object obj) {
        switch (this.f6104a) {
            case 0:
                ((Consumer) this.f6105b).accept(new r((Map.Entry) obj));
                break;
            case 8:
                ((m5) this.f6105b).accept(obj);
                break;
            default:
                ((ArrayList) ((java.util.List) this.f6105b)).add(obj);
                break;
        }
    }
}
