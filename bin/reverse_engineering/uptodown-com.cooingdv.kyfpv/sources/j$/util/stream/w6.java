...
public class w6 extends c implements Consumer, Iterable {
    ...
    public Object[] f6418e = new Object[1 << 4];
    public Object[][] f;
    ...
    public final void p(long j) {
        ...
        int i = this.f6154c;
        if (i == 0) {
            length = this.f6418e.length;
        } else {
            length = this.f6155d[i] + ((long) this.f[i].length);
        }
        if (j > length) {
            if (this.f == null) {
            ...
            while (j > length) {
                ...
                if (i6 >= objArr2.length) {
                    ...
                    this.f6155d = Arrays.copyOf(this.f6155d, length2);
                }
    ...
    public final void clear() {
        ...
        if (objArr != null) {
            this.f6418e = objArr[0];
            int i = 0;
            while (true) {
                Object[] objArr2 = this.f6418e;
                if (i >= objArr2.length) {
                    break;
                }
                objArr2[i] = null;
            ...
            for (int i6 = 0; i6 < this.f6153b; i6++) {
                this.f6418e[i6] = null;
            }
        }
        this.f6153b = 0;
        ...
        if (i == objArr.length) {
            ...
            if (i10 >= objArr3.length || objArr3[i10] == null) {
                if (i6 == 0) {
                    ...
                    length = ((long) objArr3[i6].length) + this.f6155d[i6];
                }
                p(length + 1);
            }
            this.f6153b = 0;
            ...
            this.f6154c = i11;
            this.f6418e = this.f[i11];
        }
        Object[] objArr4 = this.f6418e;
        int i12 = this.f6153b;
        this.f6153b = i12 + 1;
        objArr4[i12] = obj;
    }
    ...
    public j$.util.Spliterator spliterator() {
        return new n6(this, 0, this.f6154c, 0, this.f6153b);
    }
}
