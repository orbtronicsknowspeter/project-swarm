...
public final class l0 extends b {
    ...
    public final Object h() {
        return this.j.f6190b;
    }

    @Override // j$.util.stream.d
    public final Object a() {
        a aVar = this.f6169a;
        g8 g8Var = (g8) this.j.f6192d.get();
        aVar.Q(this.f6170b, g8Var);
        ...
        if (this.f6273k) {
            if (obj != null) {
                ...
                while (dVar != null) {
                    ...
                    if (dVar2 != null && dVar2.f6172d != dVar) {
                        g();
                        return obj;
                    }
                    dVar = dVar2;
    ...
    public final void onCompletion(CountedCompleter countedCompleter) {
        if (this.f6273k) {
            l0 l0Var = (l0) this.f6172d;
            l0 l0Var2 = null;
            while (true) {
                if (l0Var != l0Var2) {
                    Object objI = l0Var.i();
                    if (objI != null && this.j.f6191c.test(objI)) {
                        d(objI);
                        d dVar = this;
                        while (true) {
                            if (dVar != null) {
