...
public final class d8 extends b7 {
    ...
    public final b7 e(Spliterator spliterator) {
        return new d8(this.f6143b, spliterator, this.f6142a);
    }
    ...
    public final void d() {
        ...
        this.f6146e = this.f6143b.R(new c8(w6Var, 0));
    ...
    public final boolean tryAdvance(Consumer consumer) {
        ...
        if (w6Var.f6154c != 0) {
            ...
            for (int i = 0; i <= w6Var.f6154c; i++) {
                long j6 = w6Var.f6155d[i];
    ...
    public final void forEachRemaining(Consumer consumer) {
        if (this.h == null && !this.i) {
            ...
            this.f6143b.Q(this.f6145d, c8Var);
            this.i = true;
            return;
        }
