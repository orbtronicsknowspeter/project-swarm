...
public final class i8 extends c5 implements q8 {
    ...
    public final Spliterator K(a aVar, Spliterator spliterator) {
        switch (this.f6231l) {
            case 0:
                return z6.ORDERED.j(aVar.f) ? J(aVar, spliterator, new d1(9)).spliterator() : new x8(aVar.S(spliterator), this.f6232m, 1);
            default:
                return z6.ORDERED.j(aVar.f) ? J(aVar, spliterator, new d1(9)).spliterator() : new x8(aVar.S(spliterator), this.f6232m, 0);
        }
    }
