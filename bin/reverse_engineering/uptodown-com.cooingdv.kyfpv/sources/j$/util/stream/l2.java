...
public final class l2 implements h2 {
    ...
    public final Collection f6275a;
    ...
    public final Spliterator spliterator() {
        return Collection.EL.stream(this.f6275a).spliterator();
    }
    ...
    public final Object[] m(IntFunction intFunction) {
        java.util.Collection collection = this.f6275a;
    ...
    public final void forEach(Consumer consumer) {
        Collection.EL.a(this.f6275a, consumer);
    }

    public final String toString() {
        return String.format("CollectionNode[%d][%s]", Integer.valueOf(this.f6275a.size()), this.f6275a);
    }
}
