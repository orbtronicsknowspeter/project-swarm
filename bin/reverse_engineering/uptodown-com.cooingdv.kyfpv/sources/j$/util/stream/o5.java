...
public final class o5 extends c5 {
    ...
    public final /* synthetic */ long f6315l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final /* synthetic */ long f6316m;
    ...
    public final Spliterator K(a aVar, Spliterator spliterator) {
        ...
        if (jF > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            long j = this.f6315l;
            return new t7(spliteratorS, j, w3.A(j, this.f6316m));
        }
        if (z6.ORDERED.j(aVar.f)) {
            return ((h2) new w5(this, aVar, spliterator, new d1(9), this.f6315l, this.f6316m).invoke()).spliterator();
        }
        Spliterator spliteratorS2 = aVar.S(spliterator);
        long j6 = this.f6315l;
        long j10 = this.f6316m;
        if (j6 <= jF) {
            long jMin = jF - j6;
            if (j10 >= 0) {
    ...
    public final h2 J(a aVar, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jF <= 0 || !spliterator.hasCharacteristics(16384)) {
            ...
            return (h2) new w5(this, aVar, spliterator, intFunction, this.f6315l, this.f6316m).invoke();
        }
        a aVar2 = aVar;
        while (aVar2.f6130e > 0) {
            aVar2 = aVar2.f6127b;
        }
        return w3.B(aVar, w3.y(aVar2.H(), spliterator, this.f6315l, this.f6316m), true, intFunction);
    }
