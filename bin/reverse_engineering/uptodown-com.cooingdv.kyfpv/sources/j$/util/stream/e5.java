...
public abstract class e5 extends a implements Stream {
    ...
    public final Stream distinct() {
        return new n(this, z6.f6445m | z6.f6452t);
    }
    ...
    public final j$.util.b0 findAny() {
        return (j$.util.b0) C(j0.f6235d);
    }

    @Override // j$.util.stream.Stream
    public final j$.util.b0 findFirst() {
        return (j$.util.b0) C(j0.f6234c);
    }
    ...
    public final Stream filter(Predicate predicate) {
        ...
        return new r(this, z6.f6452t, predicate, 4);
    }

    @Override // j$.util.stream.Stream
    public final Stream map(Function function) {
        Objects.requireNonNull(function);
        return new r(this, z6.f6448p | z6.f6446n, function, 5);
    }

    @Override // j$.util.stream.Stream
    public final IntStream mapToInt(ToIntFunction toIntFunction) {
        Objects.requireNonNull(toIntFunction);
        return new v0(this, z6.f6448p | z6.f6446n, toIntFunction, 2);
    }
    ...
    public final n1 mapToLong(ToLongFunction toLongFunction) {
        ...
        return new g1(this, z6.f6448p | z6.f6446n, toLongFunction, 3);
    }

    @Override // j$.util.stream.Stream
    public final e0 mapToDouble(ToDoubleFunction toDoubleFunction) {
        Objects.requireNonNull(toDoubleFunction);
        return new x(this, z6.f6448p | z6.f6446n, toDoubleFunction, 2);
    }
    ...
    public final Stream b(j$.util.q qVar) {
        ...
        return new r(this, z6.f6448p | z6.f6446n | z6.f6452t, qVar, 6);
    }

    @Override // j$.util.stream.Stream
    public final IntStream r(j$.util.q qVar) {
        Objects.requireNonNull(qVar);
        return new v0(this, z6.f6448p | z6.f6446n | z6.f6452t, qVar, 3);
    }

    @Override // j$.util.stream.Stream
    public final e0 p(j$.util.q qVar) {
        Objects.requireNonNull(qVar);
        return new x(this, z6.f6448p | z6.f6446n | z6.f6452t, qVar, 3);
    }
    ...
    public final Object collect(Collector collector) {
        ...
        Object objC;
        if (!this.f6126a.f6131k || !collector.characteristics().contains(h.CONCURRENT) || (z6.ORDERED.j(this.f) && !collector.characteristics().contains(h.UNORDERED))) {
    ...
    public final n1 l(j$.util.q qVar) {
        Objects.requireNonNull(qVar);
        return new g1(this, z6.f6448p | z6.f6446n | z6.f6452t, qVar, 2);
    }
    ...
    public final Stream takeWhile(Predicate predicate) {
        int i = z8.f6459a;
        Objects.requireNonNull(predicate);
        return new i8(this, z8.f6459a, predicate, 0);
    }
    ...
    public final Stream dropWhile(Predicate predicate) {
        int i = z8.f6459a;
        Objects.requireNonNull(predicate);
        return new i8(this, z8.f6460b, predicate, 1);
    }
