...
public class t2 implements b2 {
    ...
    public final void f(int i, Object obj) {
        int i6 = this.f6366b;
        System.arraycopy(this.f6365a, 0, (double[]) obj, i, i6);
    }

    @Override // j$.util.stream.g2
    public final void g(Object obj) {
        DoubleConsumer doubleConsumer = (DoubleConsumer) obj;
        for (int i = 0; i < this.f6366b; i++) {
            doubleConsumer.accept(this.f6365a[i]);
        }
    }
    ...
    public t2(long j) {
        ...
        this.f6365a = new double[(int) j];
        this.f6366b = 0;
    }

    public t2(double[] dArr) {
        this.f6365a = dArr;
        this.f6366b = dArr.length;
    }

    @Override // j$.util.stream.h2
    public final Spliterator spliterator() {
        int i = this.f6366b;
        double[] dArr = this.f6365a;
    ...
    public String toString() {
        double[] dArr = this.f6365a;
        return String.format("DoubleArrayNode[%d][%s]", Integer.valueOf(dArr.length - this.f6366b), Arrays.toString(dArr));
    }
}
