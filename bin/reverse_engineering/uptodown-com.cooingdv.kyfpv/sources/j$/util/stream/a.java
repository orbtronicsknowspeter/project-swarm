...
public abstract class a implements g {
    ...
    public final h2 D(IntFunction intFunction) {
        ...
        this.h = true;
        if (this.f6126a.f6131k && this.f6127b != null && L()) {
            this.f6130e = 0;
            a aVar = this.f6127b;
    ...
    public Spliterator spliterator() {
        ...
        return P(this, new j$.util.q(2, this), aVar.f6131k);
    }
    ...
    public final Spliterator N(int i) {
        ...
        if (spliteratorK != null) {
            aVar.g = null;
            if (aVar.f6131k && aVar.i) {
                a aVar2 = aVar.f6129d;
                int i11 = 1;
                while (aVar != this) {
                    int i12 = aVar2.f6128c;
                    if (aVar2.L()) {
    ...
    public final m5 R(m5 m5Var) {
        Objects.requireNonNull(m5Var);
        for (a aVar = this; aVar.f6130e > 0; aVar = aVar.f6127b) {
            m5Var = aVar.M(aVar.f6127b.f, m5Var);
        }
        return m5Var;
    }

    public final Spliterator S(Spliterator spliterator) {
        return this.f6130e == 0 ? spliterator : P(this, new j$.util.q(3, spliterator), this.f6126a.f6131k);
    }
