...
public abstract class b0 extends a implements e0 {
    ...
    public final j$.util.c0 findAny() {
        return (j$.util.c0) C(g0.f6200d);
    }

    @Override // j$.util.stream.e0
    public final j$.util.c0 findFirst() {
        return (j$.util.c0) C(g0.f6199c);
    }

    @Override // j$.util.stream.e0
    public final e0 sorted() {
        return new e6(this, z6.f6449q | z6.f6447o, 0);
    }
    ...
    public final e0 e() {
        ...
        return new t(this, z6.f6448p | z6.f6446n, 0);
    }

    @Override // j$.util.stream.e0
    public final Stream mapToObj(DoubleFunction doubleFunction) {
        Objects.requireNonNull(doubleFunction);
        return new r(this, z6.f6448p | z6.f6446n, doubleFunction, 0);
    }

    @Override // j$.util.stream.e0
    public final IntStream w() {
        Objects.requireNonNull(null);
        return new u(this, z6.f6448p | z6.f6446n, 0);
    }

    @Override // j$.util.stream.e0
    public final n1 t() {
        Objects.requireNonNull(null);
        return new v(this, z6.f6448p | z6.f6446n, 0);
    }

    @Override // j$.util.stream.e0
    public final e0 b(j$.util.q qVar) {
        Objects.requireNonNull(qVar);
        return new x(this, z6.f6448p | z6.f6446n | z6.f6452t, qVar, 0);
    }

    @Override // j$.util.stream.e0
    public final e0 c() {
        Objects.requireNonNull(null);
        return new t(this, z6.f6452t, 2);
    }
    ...
    public final e0 a() {
        int i = z8.f6459a;
        Objects.requireNonNull(null);
        return new e6(this, z8.f6459a, 1);
    }
    ...
    public final e0 d() {
        int i = z8.f6459a;
        Objects.requireNonNull(null);
        return new e6(this, z8.f6460b, 2);
    }
