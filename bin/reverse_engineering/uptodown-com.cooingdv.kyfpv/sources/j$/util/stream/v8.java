            ...
            case 0:
                ...
                if (z9) {
                    ...
                    if (zTryAdvance && a()) {
                        ...
                        intPredicate.test(this.f6403e);
                        throw null;
                    }
                    if (!zTryAdvance) {
                        return zTryAdvance;
                    }
                    intConsumer.accept(this.f6403e);
                    return zTryAdvance;
                }
                return ((j$.util.y0) spliterator).tryAdvance(intConsumer);
            default:
                if (this.f6436c && a() && ((j$.util.y0) this.f6434a).tryAdvance((IntConsumer) this)) {
                    IntPredicate intPredicate2 = null;
                    intPredicate2.test(this.f6403e);
                    throw null;
                }
                this.f6436c = false;
                return false;
