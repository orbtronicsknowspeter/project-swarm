...
public final class k7 extends b7 implements j$.util.v0 {
    ...
    public final b7 e(Spliterator spliterator) {
        return new k7(this.f6143b, spliterator, this.f6142a);
    }
    ...
    public final void d() {
        ...
        this.f6146e = this.f6143b.R(new j7(p6Var, 1));
    ...
    public final boolean tryAdvance(DoubleConsumer doubleConsumer) {
        ...
        if (zA) {
            ...
            long j = this.g;
            int iR = p6Var.r(j);
            if (p6Var.f6154c == 0 && iR == 0) {
                d10 = ((double[]) p6Var.f6402e)[(int) j];
            } else {
                d10 = ((double[][]) p6Var.f)[iR][(int) (j - p6Var.f6155d[iR])];
            }
    ...
    public final void forEachRemaining(DoubleConsumer doubleConsumer) {
        if (this.h == null && !this.i) {
            ...
            this.f6143b.Q(this.f6145d, j7Var);
            this.i = true;
            return;
        }
