...
public final class o extends a implements Serializable {
    ...
    public static final o f5787l;
    private static final long serialVersionUID = 3127340209035924785L;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public volatile transient boolean f5788c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public transient int[] f5789d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public transient int f5790e;
    ...
    public final void f() {
        ...
        try {
            ...
            for (int i6 = 1300; i6 < 1600; i6++) {
                ...
                this.f5791k = Math.max(this.f5791k, iV);
            }
            this.f5788c = true;
        } catch (Exception e10) {
    ...
    public final j$.time.temporal.u q(j$.time.temporal.a aVar) {
        f();
        if (aVar != null) {
            switch (n.f5786a[aVar.ordinal()]) {
                case 1:
                    return j$.time.temporal.u.f(this.h, this.i);
                case 2:
                    return j$.time.temporal.u.e(1L, this.f5791k);
                case 3:
                    return j$.time.temporal.u.e(1L, 5L);
                case 4:
                case 5:
                    int i = this.g;
                    return j$.time.temporal.u.e(i / 12, (((this.f5789d.length - 1) + i) / 12) - 1);
                case 6:
    ...
    public final long j(int i, int i6, int i10) {
        ...
        if (i11 < 0 || i11 >= this.f5789d.length) {
