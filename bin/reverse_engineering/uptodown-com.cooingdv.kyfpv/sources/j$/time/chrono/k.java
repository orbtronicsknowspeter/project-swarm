...
public final class k implements ChronoZonedDateTime, Serializable {
    ...
    public final transient g f5783a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final transient ZoneOffset f5784b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final transient ZoneId f5785c;
    ...
    public static k v(ZoneId zoneId, ZoneOffset zoneOffset, g gVar) {
        ...
        if (listF.size() == 1) {
            ...
            gVar = gVar.x(gVar.f5770a, 0L, 0L, Duration.e(bVar.f5941d.f5752b - bVar.f5940c.f5752b, 0).f5735a, 0L);
    ...
    public final long q(j$.time.temporal.q qVar) {
        if (qVar instanceof j$.time.temporal.a) {
            ...
            return getOffset().f5752b;
        }
        return qVar.g(this);
    }

    public k(ZoneId zoneId, ZoneOffset zoneOffset, g gVar) {
        this.f5783a = (g) Objects.requireNonNull(gVar, "dateTime");
        this.f5784b = (ZoneOffset) Objects.requireNonNull(zoneOffset, TypedValues.CycleType.S_WAVE_OFFSET);
        this.f5785c = (ZoneId) Objects.requireNonNull(zoneId, "zone");
    }
    ...
    public final int hashCode() {
        return (this.f5783a.hashCode() ^ this.f5784b.f5752b) ^ Integer.rotateLeft(this.f5785c.hashCode(), 3);
    }
    ...
    public final String toString() {
        String str = this.f5783a.toString() + this.f5784b.f5753c;
        ZoneOffset zoneOffset = this.f5784b;
        ZoneId zoneId = this.f5785c;
    ...
    public final ChronoZonedDateTime m(ZoneId zoneId) {
        return v(zoneId, this.f5784b, this.f5783a);
    }
    ...
    public final j$.time.temporal.m a(long j, j$.time.temporal.q qVar) {
        ...
        int i = j.f5781a[aVar.ordinal()];
        if (i == 1) {
            return b(j - j$.com.android.tools.r8.a.u(this), j$.time.temporal.b.SECONDS);
        }
        if (i != 2) {
            return v(this.f5785c, this.f5784b, this.f5783a.a(j, qVar));
        }
        ZoneOffset zoneOffsetC = ZoneOffset.C(aVar.f5899b.a(j, aVar));
        g gVar = this.f5783a;
        gVar.getClass();
        Instant instantW = Instant.w(j$.com.android.tools.r8.a.t(gVar, zoneOffsetC), gVar.f5771b.f5877d);
        ZoneId zoneId = this.f5785c;
        ...
        return new k(zoneId, zoneOffsetD, (g) chronology.p(LocalDateTime.z(instantW.f5738a, instantW.f5739b, zoneOffsetD)));
    }
    ...
    public final k b(long j, j$.time.temporal.s sVar) {
        if (sVar instanceof j$.time.temporal.b) {
            return j(getChronology(), this.f5783a.b(j, sVar).j(this));
        }
