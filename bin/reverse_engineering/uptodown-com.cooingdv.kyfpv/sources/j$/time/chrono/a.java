...
public abstract class a implements l {
    ...
    public static final ConcurrentHashMap f5759a = new ConcurrentHashMap();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ConcurrentHashMap f5760b = new ConcurrentHashMap();
    ...
    public static l e(l lVar, String str) {
        String strI;
        l lVar2 = (l) f5759a.putIfAbsent(str, lVar);
        if (lVar2 == null && (strI = lVar.i()) != null) {
            f5760b.putIfAbsent(strI, lVar);
        }
        return lVar2;
    }
