...
public final class g0 extends a implements Serializable {
    ...
    public static final g0 f5772c = new g0();
    ...
    public final j$.time.temporal.u f(j$.time.temporal.a aVar) {
        int i = f0.f5769a[aVar.ordinal()];
        if (i == 1) {
            j$.time.temporal.u uVar = j$.time.temporal.a.PROLEPTIC_MONTH.f5899b;
            return j$.time.temporal.u.e(uVar.f5922a + 6516, uVar.f5925d + 6516);
        }
        if (i == 2) {
            j$.time.temporal.u uVar2 = j$.time.temporal.a.YEAR.f5899b;
            return j$.time.temporal.u.f((-(uVar2.f5922a + 543)) + 1, uVar2.f5925d + 543);
        }
        if (i != 3) {
            return aVar.f5899b;
        }
        j$.time.temporal.u uVar3 = j$.time.temporal.a.YEAR.f5899b;
        return j$.time.temporal.u.e(uVar3.f5922a + 543, uVar3.f5925d + 543);
    }
