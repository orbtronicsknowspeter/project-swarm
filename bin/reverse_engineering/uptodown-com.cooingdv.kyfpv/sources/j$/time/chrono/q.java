...
public final class q extends d {
    ...
    public final transient o f5793a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final transient int f5794b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final transient int f5795c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final transient int f5796d;
    ...
    public q(o oVar, long j) {
        int i = (int) j;
        oVar.f();
        if (i < oVar.f5790e || i >= oVar.f) {
            throw new j$.time.b("Hijrah date out of range");
        }
        int iBinarySearch = Arrays.binarySearch(oVar.f5789d, i);
        iBinarySearch = iBinarySearch < 0 ? (-iBinarySearch) - 2 : iBinarySearch;
        int i6 = oVar.g;
        int[] iArr = {(iBinarySearch + i6) / 12, ((i6 + iBinarySearch) % 12) + 1, (i - oVar.f5789d[iBinarySearch]) + 1};
        this.f5793a = oVar;
        this.f5794b = iArr[0];
        this.f5795c = iArr[1];
        this.f5796d = iArr[2];
    ...
    public final j$.time.temporal.u g(j$.time.temporal.q qVar) {
        ...
        int i = p.f5792a[aVar.ordinal()];
        return i != 1 ? i != 2 ? i != 3 ? this.f5793a.q(aVar) : j$.time.temporal.u.e(1L, 5L) : j$.time.temporal.u.e(1L, this.f5793a.v(this.f5794b, 12)) : j$.time.temporal.u.e(1L, this.f5793a.k(this.f5794b, this.f5795c));
    }
    ...
    public final long q(j$.time.temporal.q qVar) {
        ...
        switch (p.f5792a[((j$.time.temporal.a) qVar).ordinal()]) {
            case 1:
                return this.f5796d;
            case 2:
                return C();
            case 3:
                return ((this.f5796d - 1) / 7) + 1;
            case 4:
            ...
            case 9:
                return this.f5795c;
            case 10:
                return ((((long) this.f5794b) * 12) + ((long) this.f5795c)) - 1;
            case 11:
                return this.f5794b;
            case 12:
                return this.f5794b;
            case 13:
                return this.f5794b <= 1 ? 0 : 1;
            default:
                throw new j$.time.temporal.t(j$.time.c.a("Unsupported field: ", qVar));
        }
    }
    ...
    public final q a(long j, j$.time.temporal.q qVar) {
        ...
        j$.time.temporal.a aVar = (j$.time.temporal.a) qVar;
        this.f5793a.q(aVar).b(j, aVar);
        int i = (int) j;
        switch (p.f5792a[aVar.ordinal()]) {
            case 1:
                return F(this.f5794b, this.f5795c, i);
            case 2:
                return y(Math.min(i, this.f5793a.v(this.f5794b, 12)) - C());
            case 3:
            ...
            case 7:
                return new q(this.f5793a, j);
            case 8:
                return y((j - q(j$.time.temporal.a.ALIGNED_WEEK_OF_YEAR)) * 7);
            case 9:
                return F(this.f5794b, i, this.f5796d);
            case 10:
                return z(j - (((((long) this.f5794b) * 12) + ((long) this.f5795c)) - 1));
            case 11:
                if (this.f5794b < 1) {
                    i = 1 - i;
                }
                return F(i, this.f5795c, this.f5796d);
            case 12:
                return F(i, this.f5795c, this.f5796d);
            case 13:
                return F(1 - this.f5794b, this.f5795c, this.f5796d);
            default:
                throw new j$.time.temporal.t(j$.time.c.a("Unsupported field: ", qVar));
        }
    }
    ...
    public final q F(int i, int i6, int i10) {
        int iK = this.f5793a.k(i, i6);
        if (i10 > iK) {
            i10 = iK;
        }
        return new q(this.f5793a, i, i6, i10);
    }
    ...
    @Override // j$.time.chrono.d, j$.time.chrono.b
    public final long r() {
        return this.f5793a.j(this.f5794b, this.f5795c, this.f5796d);
    }

    public final int C() {
        return this.f5793a.v(this.f5794b, this.f5795c - 1) + this.f5796d;
    }
    ...
    public final b A(long j) {
        ...
        long j6 = ((long) this.f5794b) + ((long) ((int) j));
        int i = (int) j6;
        if (j6 == i) {
            return F(i, this.f5795c, this.f5796d);
        }
    ...
    public final q z(long j) {
        ...
        long j6 = (((long) this.f5794b) * 12) + ((long) (this.f5795c - 1)) + j;
        o oVar = this.f5793a;
        long jB = j$.com.android.tools.r8.a.B(j6, 12L);
        int i = oVar.g;
        if (jB >= i / 12 && jB <= (((oVar.f5789d.length - 1) + i) / 12) - 1) {
            return F((int) jB, ((int) j$.com.android.tools.r8.a.A(j6, 12L)) + 1, this.f5796d);
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof q) {
            q qVar = (q) obj;
            if (this.f5794b == qVar.f5794b && this.f5795c == qVar.f5795c && this.f5796d == qVar.f5796d && this.f5793a.equals(qVar.f5793a)) {
                return true;
            }
        }
        return false;
