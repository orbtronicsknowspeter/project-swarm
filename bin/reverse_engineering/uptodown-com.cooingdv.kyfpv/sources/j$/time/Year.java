...
public final class Year implements j$.time.temporal.m, j$.time.temporal.o, Comparable<Year>, Serializable {
    ...
    public final int compareTo(Year year) {
        return this.f5748a - year.f5748a;
    }
    ...
    public static Year now() {
        ...
        ZoneId zoneId = aVarF.f5758a;
        Objects.requireNonNull(instantOfEpochMilli, "instant");
        Objects.requireNonNull(zoneId, "zone");
        return v(h.E(j$.com.android.tools.r8.a.B(instantOfEpochMilli.f5738a + ((long) zoneId.v().d(instantOfEpochMilli).f5752b), 86400)).f5867a);
    }
    ...
    public final j$.time.temporal.u g(j$.time.temporal.q qVar) {
        if (qVar == j$.time.temporal.a.YEAR_OF_ERA) {
            return j$.time.temporal.u.e(1L, this.f5748a <= 0 ? 1000000000L : 999999999L);
        }
    ...
    public final long q(j$.time.temporal.q qVar) {
        ...
        int i = t.f5895a[((j$.time.temporal.a) qVar).ordinal()];
        if (i == 1) {
            int i6 = this.f5748a;
            if (i6 < 1) {
                i6 = 1 - i6;
    ...
    public final Year a(long j, j$.time.temporal.q qVar) {
        ...
        if (i == 3) {
            return q(j$.time.temporal.a.ERA) == j ? this : v(1 - this.f5748a);
        }
        throw new j$.time.temporal.t(c.a("Unsupported field: ", qVar));
    }
    ...
    public final Year b(long j, j$.time.temporal.s sVar) {
        if (sVar instanceof j$.time.temporal.b) {
            int i = t.f5896b[((j$.time.temporal.b) sVar).ordinal()];
            if (i == 1) {
                return x(j);
            }
            if (i == 2) {
    ...
    public final Year x(long j) {
        ...
        return v(aVar.f5899b.a(((long) this.f5748a) + j, aVar));
    }
    ...
    public final j$.time.temporal.m j(j$.time.temporal.m mVar) {
        ...
        return mVar.a(this.f5748a, j$.time.temporal.a.YEAR);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        return (obj instanceof Year) && this.f5748a == ((Year) obj).f5748a;
    }
    ...
    public final String toString() {
        return Integer.toString(this.f5748a);
    }
