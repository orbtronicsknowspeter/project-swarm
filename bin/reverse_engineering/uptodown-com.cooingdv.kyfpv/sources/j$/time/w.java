...
public final class w extends ZoneId {
    ...
    public final transient j$.time.zone.f f5933c;
    ...
    public final j$.time.zone.f v() {
        j$.time.zone.f fVar = this.f5933c;
        return fVar != null ? fVar : j$.time.zone.i.a(this.f5932b);
    }
    ...
    public final void z(DataOutput dataOutput) throws IOException {
        ...
        dataOutput.writeUTF(this.f5932b);
    }
}
