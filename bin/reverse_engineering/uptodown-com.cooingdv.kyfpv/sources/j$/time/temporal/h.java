...
public abstract class h implements q {
    ...
    public static final int[] f5903a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final /* synthetic */ h[] f5904b;
    ...
    static {
        h hVar = new h() { // from class: j$.time.temporal.d
            ...
            public final boolean e(n nVar) {
                ...
                h hVar2 = j.f5907a;
                return j$.com.android.tools.r8.a.v(nVar).equals(j$.time.chrono.s.f5798c);
            }
            ...
            public final long g(n nVar) {
                ...
                int i = (iE2 - 1) / 3;
                j$.time.chrono.s.f5798c.getClass();
                return iE - h.f5903a[i + (j$.time.chrono.s.f(jQ) ? 4 : 0)];
            }
        ...
        h hVar4 = new h() { // from class: j$.time.temporal.g
            ...
            public final m j(m mVar, long j) {
                ...
                int iA = a.YEAR.f5899b.a(j, h.WEEK_BASED_YEAR);
        ...
        f5904b = new h[]{hVar, hVar2, hVar3, hVar4};
        f5903a = new int[]{0, 90, 181, 273, 0, 91, 182, 274};
    }
    ...
    public static int k(j$.time.h hVar) {
        ...
        if (iA < i10) {
            return (int) u.e(1L, q(n(hVar.M(SubsamplingScaleImageView.ORIENTATION_180).I(-1L)))).f5925d;
        }
        int i11 = ((iA - i10) / 7) + 1;
