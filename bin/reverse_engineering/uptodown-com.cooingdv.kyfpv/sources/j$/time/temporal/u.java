...
public final class u implements Serializable {
    ...
    public final int a(long j, q qVar) {
        if (this.f5922a < -2147483648L || this.f5925d > 2147483647L || !d(j)) {
    ...
    public final boolean d(long j) {
        return j >= this.f5922a && j <= this.f5925d;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof u) {
            u uVar = (u) obj;
            if (this.f5922a == uVar.f5922a && this.f5923b == uVar.f5923b && this.f5924c == uVar.f5924c && this.f5925d == uVar.f5925d) {
                return true;
            }
        }
        return false;
    ...
    public final String toString() {
        ...
        if (this.f5922a != this.f5923b) {
            sb.append('/');
            sb.append(this.f5923b);
        }
        sb.append(" - ");
        sb.append(this.f5924c);
        if (this.f5924c != this.f5925d) {
            sb.append('/');
