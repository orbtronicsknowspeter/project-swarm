...
public final class o implements j$.time.temporal.n, j$.time.temporal.o, Comparable, Serializable {
    ...
    public static final /* synthetic */ int f5882c = 0;
    ...
    public final int compareTo(Object obj) {
        o oVar = (o) obj;
        int i = this.f5883a - oVar.f5883a;
        return i == 0 ? this.f5884b - oVar.f5884b : i;
    }
    ...
    public final j$.time.temporal.u g(j$.time.temporal.q qVar) {
        ...
        m mVarY = m.y(this.f5883a);
        mVarY.getClass();
        int i = l.f5878a[mVarY.ordinal()];
        return j$.time.temporal.u.f(i != 1 ? (i == 2 || i == 3 || i == 4 || i == 5) ? 30 : 31 : 28, m.y(this.f5883a).x());
    }
    ...
    public final long q(j$.time.temporal.q qVar) {
        ...
        int i6 = n.f5881a[((j$.time.temporal.a) qVar).ordinal()];
        if (i6 == 1) {
            i = this.f5884b;
        } else {
            if (i6 != 2) {
    ...
    public final j$.time.temporal.m j(j$.time.temporal.m mVar) {
        ...
        j$.time.temporal.m mVarA = mVar.a(this.f5883a, j$.time.temporal.a.MONTH_OF_YEAR);
        j$.time.temporal.a aVar = j$.time.temporal.a.DAY_OF_MONTH;
        return mVarA.a(Math.min(mVarA.g(aVar).f5925d, this.f5884b), aVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof o) {
            o oVar = (o) obj;
            if (this.f5883a == oVar.f5883a && this.f5884b == oVar.f5884b) {
                return true;
            }
        }
        return false;
    ...
    public final int hashCode() {
        return (this.f5883a << 6) + this.f5884b;
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder(10);
        sb.append("--");
        sb.append(this.f5883a < 10 ? "0" : "");
        sb.append(this.f5883a);
        sb.append(this.f5884b < 10 ? "-0" : "-");
