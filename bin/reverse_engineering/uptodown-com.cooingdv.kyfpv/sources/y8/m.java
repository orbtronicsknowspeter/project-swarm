...
public final class m {
    ...
    public static final Pattern f11857k = Pattern.compile("^[!\"#$%&'()*+,./:;<=>?@\\[\\\\\\]^_`{|}~-]");

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public static final Pattern f11858l = Pattern.compile("^&(?:#x[a-f0-9]{1,6}|#[0-9]{1,7}|[a-z][a-z0-9]{1,31});", 2);

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final Pattern f11859m = Pattern.compile("`+");

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public static final Pattern f11860n = Pattern.compile("^`+");

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public static final Pattern f11861o = Pattern.compile("^<([a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*)>");

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public static final Pattern f11862p = Pattern.compile("^<[a-zA-Z][a-zA-Z0-9.+-]{1,31}:[^<>\u0000- ]*>");

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public static final Pattern f11863q = Pattern.compile("^ *(?:\n *)?");

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static final Pattern f11864r = Pattern.compile("^[\\p{Zs}\t\r\n\f]");

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public static final Pattern f11865s = Pattern.compile("\\s+");

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public static final Pattern f11866t = Pattern.compile(" *$");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final BitSet f11867a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final BitSet f11868b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final HashMap f11869c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final m8.q f11870d;
    ...
    public final String c(Pattern pattern) {
        if (this.f >= this.f11871e.length()) {
            return null;
        }
        Matcher matcher = pattern.matcher(this.f11871e);
        matcher.region(this.f, this.f11871e.length());
        if (!matcher.find()) {
            return null;
        }
        this.f = matcher.end();
    ...
    */
    ...
    public final char g() {
        if (this.f < this.f11871e.length()) {
            return this.f11871e.charAt(this.f);
        }
        return (char) 0;
    }
    ...
    public final void h(f fVar) {
        ...
        while (fVar2 != null) {
            v vVar = fVar2.f11824a;
            char c9 = fVar2.f11825b;
            e9.a aVar = (e9.a) this.f11869c.get(Character.valueOf(c9));
            if (!fVar2.f11827d || aVar == null) {
                fVar2 = fVar2.f;
            } else {
                char cD = aVar.d();
                f fVar4 = fVar2.f11828e;
                int iE = 0;
                boolean z10 = false;
                while (fVar4 != null && fVar4 != fVar && fVar4 != map.get(Character.valueOf(c9))) {
                    if (fVar4.f11826c && fVar4.f11825b == cD) {
                ...
                if (z10) {
                    ...
                    f fVar5 = fVar2.f11828e;
                    while (fVar5 != null && fVar5 != fVar4) {
                        f fVar6 = fVar5.f11828e;
                        i(fVar5);
                        fVar5 = fVar6;
                    }
                    ...
                    if (!z9) {
                        map.put(Character.valueOf(c9), fVar2.f11828e);
                        if (!fVar2.f11826c) {
                            i(fVar2);
                        }
                    }
