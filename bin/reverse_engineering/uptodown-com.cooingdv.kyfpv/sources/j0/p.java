...
public final class p extends BroadcastReceiver {
    ...
    public final /* synthetic */ int f6521a = 1;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public Object f6522b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public Object f6523c;
    ...
    public void a() {
        ...
        y2.t tVar = (y2.t) this.f6523c;
        if (tVar != null) {
            Context context = tVar.f11762l.f3086b;
            this.f6522b = context;
        ...
        switch (this.f6521a) {
            case 0:
                ...
                if ("com.google.android.gms".equals(data != null ? data.getSchemeSpecificPart() : null)) {
                    Object obj = ((android.support.v4.media.g) this.f6523c).f248l;
                    throw null;
                }
                return;
            case 1:
                ...
                if (tVar != null && tVar.a()) {
                    ...
                    y2.t tVar2 = (y2.t) this.f6523c;
                    tVar2.f11762l.getClass();
                    FirebaseMessaging.b(tVar2, 0L);
                    Context context2 = (Context) this.f6522b;
                    if (context2 != null) {
            ...
            default:
                ...
                if (Build.VERSION.SDK_INT < 24 ? (activeNetworkInfo = connectivityManager.getActiveNetworkInfo()) == null || !activeNetworkInfo.isConnected() : (networkCapabilities = connectivityManager.getNetworkCapabilities(connectivityManager.getActiveNetwork())) == null || !(networkCapabilities.hasTransport(1) || networkCapabilities.hasTransport(0) || networkCapabilities.hasTransport(3))) {
                    ((y3.a) this.f6523c).invoke();
                    return;
                } else {
                    ((y3.a) this.f6522b).invoke();
                    return;
                }
        }
    }
