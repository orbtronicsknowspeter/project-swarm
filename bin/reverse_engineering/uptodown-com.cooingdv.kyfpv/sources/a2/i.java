...
public class i implements l {
    ...
    public void d(char c9) {
        ...
        qVar.b(qVar.f4965b, 1);
        char[] cArr = (char[]) qVar.f4966c;
        int i = qVar.f4965b;
        qVar.f4965b = i + 1;
        cArr[i] = c9;
    }
    ...
    public void h(String str) {
        ...
        str.getClass();
        f8.q qVar = (f8.q) this.f23b;
        qVar.b(qVar.f4965b, str.length() + 2);
        char[] cArr = (char[]) qVar.f4966c;
        int i = qVar.f4965b;
        int i6 = i + 1;
        cArr[i] = '\"';
        ...
        while (i11 < i10) {
            ...
            if (c9 < bArr.length && bArr[c9] != 0) {
                ...
                for (int i12 = i11 - i6; i12 < length2; i12++) {
                    ...
                    byte[] bArr2 = b0.f4938b;
                    if (cCharAt >= bArr2.length || (b7 = bArr2[cCharAt]) == 0) {
                        int i13 = i11 + 1;
                        ((char[]) qVar.f4966c)[i11] = cCharAt;
                        i11 = i13;
                    } else {
                        if (b7 == 1) {
                            String str2 = b0.f4937a[cCharAt];
                            str2.getClass();
                            qVar.b(i11, str2.length());
                            str2.getChars(0, str2.length(), (char[]) qVar.f4966c, i11);
                            int length3 = str2.length() + i11;
                            qVar.f4965b = length3;
                            i11 = length3;
                        } else {
                            char[] cArr2 = (char[]) qVar.f4966c;
                            cArr2[i11] = '\\';
                            cArr2[i11 + 1] = (char) b7;
                            i11 += 2;
                            qVar.f4965b = i11;
