        ...
        switch (this.f50a) {
            case 0:
                ...
                if (mapA != null) {
                    ...
                    ((h) dVar.f4468l).h((String) dVar.f4467b, mapA, tVar.f52a);
                    return;
                }
                return;
            case 1:
            ...
            case 5:
                ...
                appInstalledDetailsActivity.R0().F.smoothScrollTo(0, appInstalledDetailsActivity.R0().f9748x.getTop());
                return;
            case 6:
                OldVersionsActivity oldVersionsActivity = (OldVersionsActivity) this.f51b;
                int i12 = OldVersionsActivity.S;
                oldVersionsActivity.y0().f9670l.scrollToPosition(0);
                return;
            case 7:
                RecommendedActivity recommendedActivity = (RecommendedActivity) this.f51b;
                int i13 = RecommendedActivity.f3339g0;
            ...
            case 8:
                ...
                int i14 = WishlistActivity.f3368g0;
            ...
            case 17:
                ...
                ((y.h) ((z.c) sVar.f11759n)).h(new v4.a(sVar, 4));
                return;
            case 18:
                a();
                return;
            default:
                ...
                Log.w("FirebaseMessaging", "Service took too long to process intent: " + c0Var.f11716a.getAction() + " finishing.");
                c0Var.f11717b.c(null);
                return;
        }
    }
}
