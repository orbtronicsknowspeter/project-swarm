    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (this.f10736a) {
            case 0:
                ...
                l8.i iVar = m9.c.e().f7240n;
                ?? r02 = iVar.f7213t.f7229a;
                ArrayList arrayList = new ArrayList();
                for (Object obj3 : r02) {
                    if (iIntValue == ((l8.l) obj3).f7224a) {
                        arrayList.add(obj3);
                    }
                }
            ...
            case 1:
                ...
                if (iVar2 != null && m.b(iVar2)) {
                    mVar.f10757z.set(iIntValue2);
                }
                break;
            case 2:
                int iIntValue3 = ((Number) obj).intValue();
                ((Boolean) obj2).getClass();
                m mVar2 = this.f10737b;
            ...
            default:
                ...
                ((Boolean) obj2).getClass();
                m mVar4 = this.f10737b;
                h8.c cVar4 = mVar4.f10738a;
                ...
                if (iVar5 != null && m.b(iVar5)) {
                    mVar4.f10757z.unset(iIntValue5);
                }
                break;
        }
        return x.f8464a;
