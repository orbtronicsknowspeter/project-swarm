...
public final class o implements z7.b {
    ...
    public static final u0 f4782b = t1.a("kotlinx.serialization.json.JsonLiteral", b8.d.f1111p);
    ...
    public final void serialize(c8.f fVar, Object obj) {
        ...
        p6.s sVarP = t1.P(str);
        if (sVarP != null) {
            fVar.encodeInline(k1.f3667b).encodeLong(sVarP.f8459a);
            return;
        }
        Boolean bool = null;
