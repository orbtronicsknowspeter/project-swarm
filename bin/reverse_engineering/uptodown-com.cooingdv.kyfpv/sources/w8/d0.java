...
public final class d0 extends k {
    ...
    public final transient byte[][] f10954n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final transient int[] f10955o;

    public d0(byte[][] bArr, int[] iArr) {
        super(k.f10971m.f10972a);
        this.f10954n = bArr;
        this.f10955o = iArr;
    }
    ...
    public final k e(String str) throws NoSuchAlgorithmException {
        ...
        byte[][] bArr = this.f10954n;
        int length = bArr.length;
        int i = 0;
        int i6 = 0;
        while (i < length) {
            int[] iArr = this.f10955o;
    ...
    @Override // w8.k
    public final int f() {
        return this.f10955o[this.f10954n.length - 1];
    }
