...
public final class s implements g0 {
    ...
    public final Inflater f10992l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final t f10993m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final CRC32 f10994n;
    ...
    public s(g0 g0Var) {
        ...
        this.f10992l = inflater;
        this.f10993m = new t(a0Var, inflater);
        this.f10994n = new CRC32();
    }
    ...
    public final void c(h hVar, long j, long j6) {
        ...
        while (j6 > 0) {
            int i10 = (int) (((long) b0Var.f10941b) + j);
            int iMin = (int) Math.min(b0Var.f10942c - i10, j6);
            this.f10994n.update(b0Var.f10940a, i10, iMin);
            j6 -= (long) iMin;
            b0Var = b0Var.f;
            b0Var.getClass();
            j = 0;
    ...
    public final long p(h hVar, long j) throws IOException {
        ...
        byte b7 = sVar.f10990a;
        CRC32 crc32 = sVar.f10994n;
        a0 a0Var = sVar.f10991b;
        if (b7 == 0) {
            a0Var.t(10L);
        ...
        if (sVar.f10990a == 2) {
            ...
            b(a0Var.f(), (int) sVar.f10992l.getBytesWritten(), "ISIZE");
            sVar.f10990a = (byte) 3;
            if (!a0Var.b()) {
