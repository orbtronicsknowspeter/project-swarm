...
public class k implements Serializable, Comparable {
    ...
    public static final k f10971m = new k(new byte[0]);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final byte[] f10972a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public transient int f10973b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public transient String f10974l;
    ...
    public String a() {
        ...
        return new String(bArr3, l7.a.f7152a);
    }
    ...
    public k e(String str) throws NoSuchAlgorithmException {
        ...
        messageDigest.update(this.f10972a, 0, f());
    ...
    public int hashCode() {
        ...
        int iHashCode = Arrays.hashCode(this.f10972a);
        this.f10973b = iHashCode;
        return iHashCode;
    }
    ...
    public boolean o(int i, k kVar, int i6) {
        kVar.getClass();
        return kVar.p(0, this.f10972a, i, i6);
    }
    ...
    public final String t() {
        String str = this.f10974l;
        if (str != null) {
            return str;
        }
        byte[] bArrJ = j();
        bArrJ.getClass();
        String str2 = new String(bArrJ, l7.a.f7152a);
        this.f10974l = str2;
        return str2;
    }
