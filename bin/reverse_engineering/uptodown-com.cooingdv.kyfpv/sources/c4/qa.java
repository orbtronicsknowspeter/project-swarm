...
public final class qa implements Animation.AnimationListener {
    ...
    public final void onAnimationEnd(Animation animation) {
        switch (this.f2023a) {
            ...
            default:
                ...
                updates.T0().f10252p.setPadding(0, 0, 0, (int) updates.getResources().getDimension(R.dimen.bottom_button_updates_padding));
                break;
        }
    }
    ...
    public final void onAnimationStart(Animation animation) {
        switch (this.f2023a) {
            case 0:
                int i = Updates.n0;
                this.f2024b.T0().f10252p.setPadding(0, 0, 0, 0);
                break;
        }
    }
