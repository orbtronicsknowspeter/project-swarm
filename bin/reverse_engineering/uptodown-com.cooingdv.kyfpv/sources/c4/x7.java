...
public final class x7 extends v6.i implements d7.p {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((x7) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
    }
    ...
    public final Object invokeSuspend(Object obj) throws JSONException {
        ...
        switch (this.f2307a) {
            case 0:
                ...
                if (!g2VarQ.b() && (str = g2VarQ.f11204a) != null && str.length() != 0) {
                    String str3 = g2VarQ.f11204a;
                    str3.getClass();
            ...
            default:
                ...
                if (!g2VarY.b() && (jSONObject = g2VarY.f11207d) != null && !jSONObject.isNull("data")) {
                    ...
                    if (jSONArray != null && jSONArray.length() > 0) {
                        ...
                        for (int i6 = 0; i6 < length2; i6++) {
                            ...
                            if (w2Var != null && (str2 = w2Var.f11435m) != null && str2.length() != 0) {
                                k2VarR.f11261l = w2Var.f11435m;
                                if (w2Var.f11444w) {
                                    k2VarR.v = 1;
                                }
                            }
