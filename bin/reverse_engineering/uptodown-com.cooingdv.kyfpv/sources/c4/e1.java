...
public final class e1 extends v6.i implements d7.p {
    ...
    public final Object invoke(Object obj, Object obj2) throws Throwable {
        ...
        switch (this.f1542a) {
            case 0:
                return ((e1) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
            default:
                ((e1) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
                return u6.a.f10763a;
        }
    }
        ...
        switch (i) {
            case 0:
                ...
                if (i6 == 0) {
                    ...
                    Object objC = o7.c0.C(new s4.a(freeUpSpaceActivity, d1Var, null), v7.d.f10885a, this);
                    if (objC != aVar) {
                        objC = xVar;
                    }
                    if (objC == aVar) {
