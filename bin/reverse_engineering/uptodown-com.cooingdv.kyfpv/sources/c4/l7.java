    ...
    public final void onClick(View view) {
        ...
        switch (i) {
            case 0:
                ...
                if (b4.d.t()) {
                    publicProfileActivity.A0(1, w2Var.f11435m, w2Var.f11432a);
                }
                break;
            case 1:
                ...
                if (b4.d.t()) {
                    publicProfileActivity.A0(2, w2Var.f11435m, w2Var.f11432a);
                }
                break;
            case 2:
            ...
            default:
                ...
                if (b4.d.t()) {
                    ...
                    if (publicProfileActivity2.T()) {
                        ...
                        if ((string2 == null && sharedPreferences4.getString("is_turbo", null) == null) || (str = w2Var.f11432a) == null || str.length() == 0) {
                            ...
                            if (o0Var.getValue() instanceof j5.r) {
                                ...
                                value.getClass();
                                if (((x4.v2) ((j5.r) value).f6708a).f11426d != 1) {
                                    o7.a0 viewModelScope = ViewModelKt.getViewModelScope(y7VarZ0);
                                    v7.e eVar = o7.m0.f8289a;
                                    o7.c0.s(viewModelScope, v7.d.f10885a, null, new w7(publicProfileActivity2, str3, y7VarZ0, null, 0), 2);
                                } else {
                                    o7.a0 viewModelScope2 = ViewModelKt.getViewModelScope(y7VarZ0);
                                    v7.e eVar2 = o7.m0.f8289a;
                                    o7.c0.s(viewModelScope2, v7.d.f10885a, null, new w7(publicProfileActivity2, str3, y7VarZ0, null, 1), 2);
                                }
                            }
                        }
                    }
