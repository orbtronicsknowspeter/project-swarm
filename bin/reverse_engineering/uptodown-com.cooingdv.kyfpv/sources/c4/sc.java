...
public final class sc extends v6.i implements d7.p {
    ...
    private final Object b(Object obj) {
        ...
        try {
            boolean z9 = false;
            try {
                SharedPreferences sharedPreferences = ((Activity) qVar.f7781b).getSharedPreferences("CoreSettings", 0);
            ...
            if (z9) {
                ...
                g4.h0 h0Var = (g4.h0) qVar.f7782l;
                if (h0Var == null) {
                    return null;
                }
                file.getPath();
                h0Var.f5191a.M("error: not system permissions");
            }
            return xVar;
        } catch (Exception e10) {
            e10.printStackTrace();
    ...
    private final Object e(Object obj) {
        p6.a.e(obj);
        u4.y0 y0Var = (u4.y0) ((y2.s) this.f2097b).f11757l;
        ArrayList arrayList = (ArrayList) ((kotlin.jvm.internal.x) this.f2098l).f7025a;
        y0Var.getClass();
        arrayList.getClass();
        y0Var.f10665a.f10673m = arrayList;
        return p6.x.f8464a;
    }
    ...
    */
    ...
    private final Object h(Object obj) throws JSONException {
        ...
        p6.a.e(obj);
        AtomicBoolean atomicBoolean = s4.x.f9316b;
        if (atomicBoolean.compareAndSet(false, true)) {
            x4.w2 w2Var = new x4.w2();
            j5.v vVar = new j5.v(((s4.x) this.f2097b).f9317a);
            ...
            g2VarK.f11207d = vVar.i(g2VarK, "/eapi/profile/userID/data");
            if (g2VarK.b() || (jSONObject = g2VarK.f11207d) == null || jSONObject.isNull("data")) {
