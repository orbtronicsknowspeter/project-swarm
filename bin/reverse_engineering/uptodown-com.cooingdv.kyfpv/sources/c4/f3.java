        ...
        switch (i) {
            ...
            case 1:
                ...
                if (i6 >= 0 && i6 < arrayList2.size()) {
                    ...
                    if (((x4.e3) arrayList2.get(mainActivity.T)).f11142a == 2 && ((x4.e3) arrayList2.get(0)).f11142a == 1) {
                ...
                break;
            case 2:
                FrameLayout frameLayout = mainActivity.f3322t0;
                frameLayout.getClass();
                frameLayout.removeAllViews();
                break;
            case 3:
                FrameLayout frameLayout2 = mainActivity.f3324v0;
                frameLayout2.getClass();
                frameLayout2.removeAllViews();
                mainActivity.f3324v0 = null;
                break;
            default:
