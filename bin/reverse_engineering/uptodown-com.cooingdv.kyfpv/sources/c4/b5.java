    ...
    public final void onClick(View view) {
        ...
        switch (i) {
            case 0:
                ...
                boolean zA = kotlin.jvm.internal.l.a(rVar.f11356b, myDownloads.getPackageName());
                ArrayList arrayList = rVar.F;
                if (!zA) {
                    if (arrayList.size() != 1 || (str = ((x4.j0) rVar.F.get(0)).f11241q) == null || str.length() == 0) {
                        File fileG = rVar.g();
                        if (fileG == null) {
                        ...
                        String str3 = ((x4.j0) rVar.F.get(0)).f11241q;
                        str3.getClass();
                ...
                } else if (arrayList.isEmpty() || ((x4.j0) rVar.F.get(0)).f11241q == null) {
                    String string3 = myDownloads.getString(R.string.installable_files_not_found);
                    string3.getClass();
                    myDownloads.A(string3);
                } else {
                    String str4 = ((x4.j0) rVar.F.get(0)).f11241q;
                    str4.getClass();
            ...
            case 1:
                ...
                if (b4.d.t()) {
                    AlertDialog alertDialog2 = (AlertDialog) xVar.f7025a;
                    if (alertDialog2 != null) {
                        alertDialog2.dismiss();
                    }
                    if (rVar.c() && rVar.F.size() == 1 && (str2 = ((x4.j0) rVar.F.get(0)).f11241q) != null) {
                        ...
                        myDownloads.startActivity(Intent.createChooser(intent, myDownloads.getString(R.string.intent_chooser_title_share_file)));
                        break;
                    }
                }
                break;
            default:
                ...
                if (b4.d.t()) {
                    AlertDialog alertDialog3 = (AlertDialog) xVar.f7025a;
                    if (alertDialog3 != null) {
                        alertDialog3.dismiss();
                    }
                    myDownloads.i0(rVar.f11362q);
                }
                break;
        }
    }
