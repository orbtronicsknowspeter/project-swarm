...
public final class u6 extends v6.i implements d7.p {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (g2VarK.b()) {
            g2VarK.f11207d = vVar.j(g2VarK, "/eapi/user/set-new-password");
        } else {
            g2VarK.f11207d = vVar.i(g2VarK, "/eapi/user/set-new-password");
        }
        boolean zB = g2VarK.b();
        kotlin.jvm.internal.v vVar2 = this.f2167o;
        kotlin.jvm.internal.x xVar = this.f2166n;
        if (!zB && (jSONObject = g2VarK.f11207d) != null) {
            xVar.f7025a = x4.g2.e(jSONObject);
            vVar2.f7023a = jSONObject.optInt("success");
        }
        j5.r rVar = new j5.r(new t6(vVar2.f7023a, (String) xVar.f7025a, g2VarK.b()));
        o0Var.getClass();
        o0Var.g(null, rVar);
        return p6.x.f8464a;
    }
