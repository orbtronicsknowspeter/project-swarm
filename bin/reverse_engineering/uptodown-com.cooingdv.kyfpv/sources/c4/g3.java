...
public final class g3 extends v6.i implements d7.p {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((g3) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
    }
        ...
        switch (i) {
                    ...
                    if (file != null) {
                        ...
                        while (true) {
                            if (it.hasNext()) {
                                ...
                                next.getClass();
                                x4.k kVar = (x4.k) next;
                                String str3 = kVar.f11248a;
                                if (str3 != null && str3.length() != 0 && l7.u.m0(kVar.f11248a, file.getAbsolutePath(), true) && (str = kVar.f11249b) != null && str.length() != 0) {
                                    String str4 = kVar.f11249b;
                                    str4.getClass();
            ...
            case 1:
                ...
                if (i11 != 0) {
                    ...
                    while (it2.hasNext()) {
                        ...
                        if (rVar.p() && rVar.f11357l == 0 && rVar.c()) {
                            arrayList.add(rVar);
                        }
                    }
            ...
            case 2:
                ...
                if (i13 != 0) {
                    ...
                    g2VarK.f11207d = vVar.i(g2VarK, "/eapi/deep-link-hash");
                    if (!g2VarK.b() && (str2 = g2VarK.f11204a) != null && str2.length() != 0) {
                        JSONObject jSONObject = g2VarK.f11207d;
                        jSONObject.getClass();
                        ...
                        if (jSONObjectOptJSONObject != null) {
                            ...
                            if (jOptLong > 0 && jOptLong2 > 0) {
                                x4.k kVar2 = new x4.k();
                                UptodownApp.f3294g0 = kVar2;
                                kVar2.f11252e = jOptLong2;
                                ...
                                o7.c0.s(lifecycleScope, t7.n.f10349a, null, new n3(mainActivity4, jOptLong, cVar4, 1), 2);
                            }
                        }
            ...
            case 3:
                ...
                if (i15 != 0) {
                    ...
                    Object objC = o7.c0.C(new j3(mainActivity, objArr == true ? 1 : 0, i6), v7.d.f10885a, this);
                    if (objC != aVar) {
                        objC = xVar;
                    }
                    if (objC == aVar) {
            ...
            case 4:
                ...
                if (i17 != 0) {
                    ...
                    Object objC2 = o7.c0.C(new g(v4Var, objArr2 == true ? 1 : 0, 22), v7.d.f10885a, this);
                    if (objC2 != aVar) {
                        objC2 = xVar;
                    }
                    if (objC2 == aVar) {
            ...
            case 5:
                ...
                if (i18 != 0) {
                    ...
                    Object objC3 = o7.c0.C(new j3(mainActivity, objArr3 == true ? 1 : 0, i6), v7.d.f10885a, this);
                    if (objC3 != aVar) {
                        objC3 = xVar;
                    }
                    if (objC3 == aVar) {
                ...
                if (i20 != 0) {
                    ...
                    if (mainActivity5.getApplicationContext() != null) {
                        ...
                        while (it3.hasNext()) {
                            ...
                            if (rVar2.p() && rVar2.f11357l == 0 && rVar2.c()) {
                                i21++;
                            }
                        }
                        kotlin.jvm.internal.x xVar3 = new kotlin.jvm.internal.x();
                        xVar3.f7025a = ContextCompat.getDrawable(mainActivity5, R.drawable.vector_user_profile);
                        x4.w2 w2VarH = x4.u2.h(mainActivity5);
                        if (w2VarH != null) {
                            String str5 = w2VarH.f11434l;
                            String strK = str5 != null ? a4.x.k(str5, UptodownApp.R, ":webp") : null;
                            if (strK != null && strK.length() != 0) {
                                try {
                                    a4.l0 l0VarE = a4.g0.d().e(x4.u2.e(w2VarH.f11434l));
                                    ...
                                    resources.getClass();
                                    xVar3.f7025a = new BitmapDrawable(resources, bitmapC);
                                    break;
                                } catch (IOException unused3) {
                                }
                            }
                        }
                        v7.e eVar8 = o7.m0.f8289a;
                        p7.c cVar6 = t7.n.f10349a;
            ...
            default:
                ...
                v7.e eVar9 = o7.m0.f8289a;
                Object objC4 = o7.c0.C(new g3(mainActivity, objArr4 == true ? 1 : 0, 6), v7.d.f10885a, this);
                if (objC4 != aVar) {
                    objC4 = xVar;
                }
                if (objC4 == aVar) {
