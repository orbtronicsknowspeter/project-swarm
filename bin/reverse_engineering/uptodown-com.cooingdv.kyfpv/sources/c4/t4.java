...
public final class t4 extends v6.i implements d7.p {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((t4) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
    }
            ...
            case 1:
                ...
                if (!(objA instanceof p6.j)) {
                    ...
                    if (gVar.b()) {
                        ...
                        String string = w4Var.getString(R.string.rollback_not_available, gVar.f11160b);
                        string.getClass();
                        w4Var.A(string);
                    }
                }
                ...
                if (thA != null) {
                    int i11 = s4.y0.f9324l;
                    if (!d0.b.J(thA)) {
                        String string2 = w4Var.getString(R.string.rollback_not_available, eVar.f11123b);
                        string2.getClass();
                        w4Var.A(string2);
                    } else {
                        w4Var.J();
