...
public final /* synthetic */ class t3 implements View.OnClickListener {
    ...
    public final void onClick(View view) {
        ...
        switch (i) {
            ...
            case 7:
                int i14 = MoreInfo.V;
                if (moreInfo.B0().f10196s.getVisibility() != 0) {
                    moreInfo.B0().f10196s.setVisibility(0);
                    moreInfo.B0().f10188o.setImageResource(R.drawable.vector_more_info_collapse);
                    ...
                    moreInfo.B0().f10196s.setVisibility(8);
                    moreInfo.B0().f10188o.setImageResource(R.drawable.vector_more_info_expand);
                }
                break;
            case 8:
            ...
            default:
                int i15 = MoreInfo.V;
                if (moreInfo.B0().f10192q.getVisibility() != 0) {
                    moreInfo.B0().f10192q.setVisibility(0);
                    moreInfo.B0().f10187n.setImageResource(R.drawable.vector_more_info_collapse);
                    final int i16 = 1;
                    moreInfo.B0().M.post(new Runnable() { // from class: c4.v3
                        @Override // java.lang.Runnable
                        public final void run() {
                    ...
                    moreInfo.B0().f10192q.setVisibility(8);
                    moreInfo.B0().f10187n.setImageResource(R.drawable.vector_more_info_expand);
                }
                break;
        }
    }
