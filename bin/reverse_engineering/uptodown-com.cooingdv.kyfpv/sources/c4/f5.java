            ...
            case 1:
                ...
                if (!fragments.isEmpty()) {
                    ...
                    if (fragment instanceof TvMyDownloadsFragment) {
                        ...
                        switch (this.f1592b) {
                            case 201:
                                ArrayObjectAdapter arrayObjectAdapter = tvMyDownloadsFragment.f3438a;
                                arrayObjectAdapter.getClass();
                                ArrayObjectAdapter arrayObjectAdapter2 = tvMyDownloadsFragment.f3438a;
                                arrayObjectAdapter2.getClass();
                                arrayObjectAdapter.notifyArrayItemRangeChanged(0, arrayObjectAdapter2.size());
                                break;
                            case 202:
                            case 203:
                                ArrayObjectAdapter arrayObjectAdapter3 = tvMyDownloadsFragment.f3438a;
                                arrayObjectAdapter3.getClass();
                                ArrayObjectAdapter arrayObjectAdapter4 = tvMyDownloadsFragment.f3438a;
            ...
            case 2:
                ...
                if (!fragments2.isEmpty()) {
                    ...
                    if (fragment2 instanceof TvOldVersionsFragment) {
                        ...
                        switch (this.f1592b) {
                            case 201:
                                g5.x xVar = tvOldVersionsFragment.f3444m;
                                xVar.getClass();
                                g5.x xVar2 = tvOldVersionsFragment.f3444m;
                                xVar2.getClass();
                                xVar.notifyArrayItemRangeChanged(0, xVar2.size());
                                break;
                            case 202:
                            case 203:
                                g5.x xVar3 = tvOldVersionsFragment.f3444m;
                                xVar3.getClass();
                                g5.x xVar4 = tvOldVersionsFragment.f3444m;
                                xVar4.getClass();
