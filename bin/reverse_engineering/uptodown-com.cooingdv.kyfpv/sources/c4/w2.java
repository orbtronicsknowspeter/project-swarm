    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.f2250a) {
            case 0:
                ...
                JSONObject jSONObject = g2VarD.f11207d;
                ...
                if (jSONObject != null) {
                    ...
                    if (jSONObjectOptJSONObject != null) {
                        ...
                        if (string == null || string.length() == 0) {
                            ...
                            x4.w2 w2Var2 = (x4.w2) xVar3.f7025a;
                            if (w2Var2 != null) {
                                w2Var2.e(context);
                            }
                            vVar.f7023a = 1;
                        ...
                        if (!jSONObjectOptJSONObject.isNull("message")) {
                            xVar2.f7025a = jSONObjectOptJSONObject.optString("message");
                        }
                    }
                    xVar.f7025a = x4.g2.e(jSONObject);
                }
                if (xVar3.f7025a != null) {
                    ...
                    bundle.putString("responseCode", String.valueOf(g2VarD.f11205b));
                    String str = g2VarD.f11206c;
                    if (str != null && str.length() != 0) {
                        String str2 = g2VarD.f11206c;
                        str2.getClass();
                ...
                j5.r rVar = new j5.r(new u2(vVar.f7023a, (String) xVar2.f7025a, (String) xVar.f7025a));
                o0Var.getClass();
                o0Var.g(null, rVar);
                break;
            default:
                ...
                if (g2VarK.b()) {
                    g2VarK.f11207d = vVar2.j(g2VarK, "/eapi/user/signup");
                } else {
                    g2VarK.f11207d = vVar2.i(g2VarK, "/eapi/user/signup");
                }
                JSONObject jSONObject2 = g2VarK.f11207d;
                ...
                if (jSONObject2 != null) {
                    if (!jSONObject2.isNull("success")) {
                        vVar3.f7023a = jSONObject2.optInt("success");
                    }
                    ...
                    if (jSONObjectOptJSONObject2 != null && !jSONObjectOptJSONObject2.isNull("message")) {
                        xVar5.f7025a = jSONObjectOptJSONObject2.optString("message");
                    }
                    xVar4.f7025a = x4.g2.e(jSONObject2);
                }
                if (vVar3.f7023a == 1) {
                    ...
                    bundleF.putString("responseCode", String.valueOf(g2VarK.f11205b));
                    String str4 = g2VarK.f11206c;
                    if (str4 != null) {
                        bundleF.putString("exception", str4);
                    }
                    new android.support.v4.media.g(context2, 20).E(bundleF, "login");
                }
                j5.r rVar2 = new j5.r(new v2(vVar3.f7023a, (String) xVar5.f7025a, (String) xVar4.f7025a));
                o0Var2.getClass();
                o0Var2.g(null, rVar2);
                break;
        }
