    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                gVar.getClass();
                x4.g2 g2VarK = vVar2.k(k0.k.g(gVar.f11159a, "https://www.uptodown.app:443/eapi/apps/", "/permissions"), null, ShareTarget.METHOD_GET, false);
                g2VarK.f11207d = vVar2.i(g2VarK, "/eapi/apps/appId/permissions");
                if (!g2VarK.b() && (jSONObject = g2VarK.f11207d) != null) {
                    if (!jSONObject.isNull("success")) {
                        vVar.f7023a = jSONObject.optInt("success");
                    }
                    JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject("data");
                    if (vVar.f7023a == 1 && jSONObjectOptJSONObject != null) {
                        ...
                        if (jSONArrayOptJSONArray != null) {
                            ...
                            for (int i6 = 0; i6 < length; i6++) {
                                ...
                                if (!jSONObjectOptJSONObject2.isNull("permission")) {
                                    v1Var.f11422a = jSONObjectOptJSONObject2.optString("permission");
                                }
                        ...
                        if (jSONArrayOptJSONArray2 != null) {
                            ...
                            for (int i10 = 0; i10 < length2; i10++) {
                                ...
                                if (!jSONObjectOptJSONObject3.isNull("permission")) {
                                    v1Var2.f11422a = jSONObjectOptJSONObject3.optString("permission");
                                }
            ...
            default:
                ...
                if (vVar.f7023a == 1) {
                    ...
                    if (arrayList3 == null || arrayList3.isEmpty()) {
                        ...
                        MoreInfo.A0(moreInfo, moreInfo.S, moreInfo.B0().f10190p);
                    ...
                    if (arrayList5 != null && !arrayList5.isEmpty()) {
                        MoreInfo.A0(moreInfo, moreInfo.T, moreInfo.B0().f10194r);
                    ...
                    if (gVar2 != null && gVar2.H == 0) {
                        moreInfo.B0().f10199t0.setText(String.valueOf(size));
                    }
                } else {
                    int i12 = MoreInfo.V;
                    moreInfo.B0().G.setVisibility(8);
                }
                moreInfo.B0().f10198t.setVisibility(8);
