        ...
        switch (this.f1985a) {
            ...
            default:
                ...
                if (2 > length || length >= 40) {
                    ...
                    if (l0Var != null) {
                        l0Var.f4603a = new ArrayList();
                        l0Var.notifyDataSetChanged();
                    }
                    e4.m0 m0Var = searchActivity.S;
                    if (m0Var != null) {
                        m0Var.f4626a = new ArrayList();
                ...
                if (String.valueOf(editable).length() <= 0) {
                    ...
                    if (l0Var2 != null) {
                        l0Var2.f4603a = new ArrayList();
                        l0Var2.notifyDataSetChanged();
                    }
                    ((ImageView) searchActivity.z0().f10138b.f11758m).setVisibility(8);
                    ((ImageView) searchActivity.z0().f10138b.f11759n).setVisibility(0);
                } else {
                    ((ImageView) searchActivity.z0().f10138b.f11758m).setVisibility(0);
                    ((ImageView) searchActivity.z0().f10138b.f11759n).setVisibility(8);
                }
                break;
        }
    }
        ...
        switch (i11) {
            ...
            case 1:
                if (charSequence != null) {
                    ...
                    PasswordEditActivity.y0(passwordEditActivity, passwordEditActivity.z0().f9780l.getText().toString());
                }
                break;
        }
    }
