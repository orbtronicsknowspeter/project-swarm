...
public final class q1 extends RecyclerView.Adapter {
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View viewS = androidx.lifecycle.l.s(viewGroup, R.layout.gallery_item, viewGroup, false);
        int i6 = R.id.iv_imagen;
        SubsamplingScaleImageView subsamplingScaleImageView = (SubsamplingScaleImageView) ViewBindings.findChildViewById(viewS, R.id.iv_imagen);
        if (subsamplingScaleImageView != null) {
            i6 = R.id.pb_gallery_item;
            ProgressBar progressBar = (ProgressBar) ViewBindings.findChildViewById(viewS, R.id.pb_gallery_item);
            if (progressBar != null) {
