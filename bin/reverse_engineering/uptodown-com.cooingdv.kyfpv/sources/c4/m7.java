    ...
    public final void b(int i) {
        switch (this.f1869a) {
            case 0:
                ...
                this.f1870b.j0(((x4.g) ((u7) rVar.f6708a).f2168a.get(i)).f11159a, ((x4.g) ((u7) rVar.f6708a).f2168a.get(i)).f11175n);
                break;
            default:
                j5.r rVar2 = (j5.r) this.f1871l;
                this.f1870b.j0(((x4.g) ((ArrayList) rVar2.f6708a).get(i)).f11159a, ((x4.g) ((ArrayList) rVar2.f6708a).get(i)).f11175n);
                break;
        }
    }
}
