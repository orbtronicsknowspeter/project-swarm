    ...
    public final Object emit(Object obj, t6.c cVar) {
        ...
        if (z9) {
            ...
            if (z10) {
                ...
                repliesActivity.y0().f10037z.setVisibility(0);
            ...
            repliesActivity.y0().f10030r.setVisibility(0);
            repliesActivity.y0().f10028p.setVisibility(8);
