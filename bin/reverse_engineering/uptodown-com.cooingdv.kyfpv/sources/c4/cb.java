        ...
        switch (this.f1479a) {
                ...
                if (this.f1480b) {
                    ...
                    while (it.hasNext()) {
                        ...
                        if (rVarA == null || !rVarA.c()) {
                            ((kotlin.jvm.internal.u) this.f1483n).f7022a = false;
                        }
                    }
                }
                break;
            default:
                ...
                if (this.f1480b) {
                    x4.c cVar = new x4.c();
                    cVar.f11075d = gVar;
                    x4.g2 g2VarK = vVar.k(k0.k.g(gVar.f11159a, "https://www.uptodown.app:443/eapi/app/", "/alternatives"), j5.v.g(), ShareTarget.METHOD_GET, false);
                    g2VarK.f11207d = vVar.i(g2VarK, "/eapi/app/appID/alternatives");
                    if (!g2VarK.b() && (jSONObject2 = g2VarK.f11207d) != null && jSONObject2.optInt("success") == 1 && (jSONObjectOptJSONObject = jSONObject2.optJSONObject("data")) != null) {
                        if (!jSONObjectOptJSONObject.isNull("title")) {
                            cVar.f11072a = jSONObjectOptJSONObject.optString("title");
                        }
                        if (!jSONObjectOptJSONObject.isNull("description")) {
                            cVar.f11073b = jSONObjectOptJSONObject.optString("description");
                        }
                        ...
                        if (jSONArrayOptJSONArray != null) {
                            ...
                            cVar.f11074c = arrayList;
                        }
                        ArrayList arrayList2 = cVar.f11074c;
                        if (arrayList2 != null && !arrayList2.isEmpty()) {
                            r7.o0 o0Var = v0Var.f10626c;
                            o0Var.getClass();
                            o0Var.g(null, cVar);
                        }
                    }
                    ...
                    g2VarK2.f11207d = vVar.i(g2VarK2, "/eapi/appID/similar");
