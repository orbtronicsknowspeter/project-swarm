...
public final class fa extends v6.i implements d7.p {
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((fa) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
    }
            ...
            case 0:
                ...
                if (!(objA instanceof p6.j)) {
                    ...
                    if (gVar.b()) {
                        ...
                        String string = securityActivity.getString(R.string.rollback_not_available, gVar.f11160b);
                        string.getClass();
                ...
                if (thA != null) {
                    ...
                    if (!d0.b.J(thA)) {
                        String string2 = securityActivity.getString(R.string.rollback_not_available, eVar.f11123b);
                        string2.getClass();
