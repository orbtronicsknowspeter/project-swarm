    ...
    public final Object emit(Object obj, t6.c cVar) {
        ...
        if (zA) {
            ...
            if (oldVersionsActivity.A0().f) {
                oldVersionsActivity.y0().f9669b.setVisibility(0);
            }
        } else if (sVar instanceof j5.r) {
            g6 g6Var = (g6) ((j5.r) sVar).f6708a;
            ...
            if (z9) {
                ...
                if (arrayList != null) {
                    ...
                    if (sVar2 == null) {
                        ...
                        value2.getClass();
                        oldVersionsActivity.Q = new e4.s(gVar2, eVar, oldVersionsActivity, iVar, ((x4.g) value2).f11177o0);
                        oldVersionsActivity.y0().f9670l.setAdapter(oldVersionsActivity.Q);
                    } else {
                        int i10 = oldVersionsActivity.A0().h;
                        x4.e eVar2 = (x4.e) oldVersionsActivity.A0().f1680c.getValue();
                        sVar2.f4681a.E0 = arrayList;
                        sVar2.f = i10;
                        sVar2.f4682b = eVar2;
                        sVar2.notifyDataSetChanged();
                        oldVersionsActivity.y0().f9670l.post(new a2.s(oldVersionsActivity, 6));
                    }
                } else {
                    oldVersionsActivity.y0().f9671m.setVisibility(0);
                }
                oldVersionsActivity.A0().f = false;
                oldVersionsActivity.y0().f9669b.setVisibility(8);
