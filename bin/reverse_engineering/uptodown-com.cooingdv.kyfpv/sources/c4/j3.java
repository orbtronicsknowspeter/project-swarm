    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (this.f1753a) {
            ...
            case 2:
                ...
                return xVar3;
            case 3:
                return ((j3) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
            case 4:
        ...
        switch (i) {
                    ...
                    if (jSONObjectI != null && jSONObjectI.optInt("success") == 1 && (jSONObjectOptJSONObject = jSONObjectI.optJSONObject("data")) != null && (jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray("messages")) != null) {
                        ...
                        while (i10 < length) {
                            ...
                            if (jSONObjectOptJSONObject2 != null && (jSONArrayOptJSONArray2 = jSONObjectOptJSONObject2.optJSONArray("translations")) != null) {
                                ...
                                if (n2VarV != null) {
                                    gVarL.d0(n2VarV.f11297b, n2VarV.f11298c, n2VarV.f11299d, n2VarV.f11300e);
                                }
                            }
                            i10++;
                            i6 = 0;
            ...
            case 2:
                ...
                if (h2VarX == null || !h2VarX.a()) {
                    ...
                    g2VarK2.f11207d = vVar2.i(g2VarK2, "/eapi/v2/categories/parents");
                    if (!g2VarK2.b() && g2VarK2.f11204a != null) {
                        JSONObject jSONObject = g2VarK2.f11207d;
                        jSONObject.getClass();
                        arrayListW = t0.f.w(jSONObject);
                        String str = g2VarK2.f11204a;
                        str.getClass();
                    ...
                    arrayListW = t0.f.w(new JSONObject((String) h2VarX.f11213b));
                }
                gVarL2.c();
                if (!arrayListW.isEmpty()) {
                    mainActivity.f3320r0.addAll(arrayListW);
                }
                break;
            case 3:
                p6.a.e(obj);
                ...
                try {
                    SQLiteDatabase sQLiteDatabase2 = gVarL3.f6674a;
                ...
                if (n2Var != null) {
                    long j = n2Var.f11296a;
                    SQLiteDatabase sQLiteDatabase3 = gVarL3.f6674a;
