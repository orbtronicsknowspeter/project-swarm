        ...
        switch (i) {
            ...
            case 3:
                ...
                if (virusTotalReport.z0().f1971e.getValue() != null) {
                    ...
                    value.getClass();
                    String str = ((x4.f2) value).f11158p;
                    if (str != null && str.length() != 0) {
                        Object value2 = virusTotalReport.z0().f1971e.getValue();
                        value2.getClass();
                        String str2 = ((x4.f2) value2).f11158p;
                        str2.getClass();
            ...
            case 4:
                ...
                String string3 = virusTotalReport.getString(R.string.url_privacy);
                string3.getClass();
                j5.c.e(virusTotalReport, string3, null);
                break;
            default:
                int i14 = VirusTotalReport.Q;
                String string4 = virusTotalReport.getString(R.string.url_is_uptodown_safe);
                string4.getClass();
