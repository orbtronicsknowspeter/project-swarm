    ...
    public final void onClick(View view) {
        ...
        switch (i) {
            ...
            default:
                ...
                EditText editText = ((g4.u) obj3).f5268l;
                ...
                if (text.length() > 0 && numH0 != null) {
                    ...
                    if (iIntValue < i6 && string.length() == 4 && iIntValue > 1900) {
                        ...
                        String string2 = preferencesActivity.getString(R.string.age_verification_input_failed);
                        string2.getClass();
                        preferencesActivity.A(string2);
                    }
                } else {
                    String string3 = preferencesActivity.getString(R.string.age_verification_input_failed);
                    string3.getClass();
