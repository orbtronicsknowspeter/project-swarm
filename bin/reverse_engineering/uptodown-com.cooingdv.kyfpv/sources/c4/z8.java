        ...
        switch (i) {
            case 0:
                ...
                if (kotlin.jvm.internal.l.a(sVar, pVar)) {
                    ...
                    if (reviewsActivity.Q == null) {
                        reviewsActivity.y0().f10098t.setVisibility(0);
                    }
                    break;
                    ...
                    if (reviewsActivity.Q == null) {
                        ...
                        Iterator it = ((d9) ((j5.r) sVar).f6708a).f1518a.iterator();
                        it.getClass();
                        while (it.hasNext()) {
                            Object next = it.next();
                            next.getClass();
                    ...
                    reviewsActivity.y0().f10098t.setVisibility(8);
                    break;
            ...
            case 1:
                ...
                if (kotlin.jvm.internal.l.a(sVar2, pVar)) {
                    ...
                    e9 e9Var = (e9) ((j5.r) sVar2).f6708a;
                    int i14 = e9Var.f1561a;
                    if (i14 != 1) {
                        int i15 = e9Var.f1562b;
                        if (i15 == 403) {
                            String string = reviewsActivity.getString(R.string.email_validation_msg);
                            string.getClass();
                            ...
                            String string3 = reviewsActivity.getString(R.string.error_generico);
                            string3.getClass();
                        ...
                        reviewsActivity.y0().f10089b.setText("");
                    }
                    break;
            ...
            case 2:
                ...
                if (!kotlin.jvm.internal.l.a(sVar3, pVar)) {
                    if (sVar3 instanceof j5.r) {
                        x4.j2 j2Var = (x4.j2) ((j5.r) sVar3).f6708a;
                        if (j2Var.f11246b == 1) {
                            e4.i0 i0Var3 = reviewsActivity.Q;
                            if (i0Var3 != null) {
                                x4.k2 k2Var2 = j2Var.f11245a;
                                k2Var2.getClass();
                                ArrayList arrayList = i0Var3.f4561a;
                                Iterator it2 = arrayList.iterator();
                                while (true) {
                                    if (it2.hasNext()) {
                                        int i16 = i10 + 1;
                                        if (((x4.k2) it2.next()).f11259a == k2Var2.f11259a) {
                                            i6 = i10;
                                        } else {
                                            i10 = i16;
                                        }
            ...
            default:
                ...
                if (!kotlin.jvm.internal.l.a(sVar4, pVar)) {
                    if (sVar4 instanceof j5.r) {
                        ...
                        int i17 = v2Var.f11424b;
                        int i18 = v2Var.f11426d;
                        if (i17 != 1) {
                            int i19 = v2Var.f11425c;
                            if (i19 == 401) {
                                String string8 = reviewsActivity.getString(R.string.login_required_follow_title);
                                string8.getClass();
                                String string9 = reviewsActivity.getString(R.string.login_required_follow_msg);
                                string9.getClass();
                                b2.t1.v(reviewsActivity, string8, string9);
                            } else if (i19 != 409) {
                                String string10 = reviewsActivity.getString(R.string.error_generico);
                                string10.getClass();
                                reviewsActivity.A(string10);
                            } else {
                                String string11 = reviewsActivity.getString(R.string.already_following);
                                string11.getClass();
                            ...
                            if (i0Var4 != null) {
                                Iterator it3 = i0Var4.f4561a.iterator();
                                while (true) {
                                    if (it3.hasNext()) {
                                        int i20 = i10 + 1;
                                        if (kotlin.jvm.internal.l.a(((x4.k2) it3.next()).f11260b, str)) {
                                            i6 = i10;
                                        } else {
                                            i10 = i20;
                                        }
                            ...
                            if (i6 >= 0) {
                                ...
                                if (i0Var5 != null && (k2Var = (x4.k2) i0Var5.f4561a.get(i6)) != null) {
                                    k2Var.f11272x = i18;
                                }
