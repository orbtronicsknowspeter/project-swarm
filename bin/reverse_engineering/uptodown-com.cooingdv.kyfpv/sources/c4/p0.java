    ...
    public final Object emit(Object obj, t6.c cVar) {
        ...
        if (z9) {
            ...
            if (sVar instanceof j5.r) {
                ...
                if (feedActivity.Q == null) {
                    feedActivity.Q = new e4.c((ArrayList) ((j5.r) sVar).f6708a, feedActivity.R);
                    feedActivity.y0().f9899l.setAdapter(feedActivity.Q);
                } else {
                ...
                if (arrayList == null || arrayList.isEmpty()) {
                    feedActivity.y0().f9901n.setVisibility(0);
                } else {
                    feedActivity.y0().f9901n.setVisibility(8);
                }
