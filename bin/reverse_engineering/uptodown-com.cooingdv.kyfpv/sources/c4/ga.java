...
public final class ga extends v6.i implements d7.p {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (i) {
            case 0:
                p6.a.e(obj);
                int i6 = SecurityActivity.f3350g0;
                securityActivity.N0().f10212b.setVisibility(8);
                TextView textView = securityActivity.N0().f10217p;
                long jT = com.google.android.gms.internal.measurement.z3.t(0L, securityActivity, "last_analysis_timestamp");
                textView.setText(securityActivity.getString(R.string.uptodown_last_analysis, String.valueOf(jT <= 0 ? null : new SimpleDateFormat("dd MMM yyyy HH:mm", Locale.getDefault()).format(new Date(jT)))));
                break;
            default:
                p6.a.e(obj);
                if (securityActivity.N0().f10212b.getVisibility() == 8) {
                    securityActivity.O0();
                    securityActivity.P0();
                }
                break;
