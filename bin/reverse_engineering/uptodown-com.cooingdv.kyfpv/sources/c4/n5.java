...
public final class n5 implements Comparator {
    ...
    public final int compare(Object obj, Object obj2) {
        ...
        switch (this.f1902a) {
            case 0:
                x4.r rVar = (x4.r) obj2;
                if (!rVar.F.isEmpty() && ((x4.j0) rVar.F.get(0)).f11241q != null) {
                    String str = ((x4.j0) rVar.F.get(0)).f11241q;
                    str.getClass();
                ...
                x4.r rVar2 = (x4.r) obj;
                if (!rVar2.F.isEmpty() && ((x4.j0) rVar2.F.get(0)).f11241q != null) {
                    String str2 = ((x4.j0) rVar2.F.get(0)).f11241q;
                    str2.getClass();
                ...
                return t0.f.l(0L, 0L);
            case 1:
                return t0.f.l(((x4.r) obj).f11367w, ((x4.r) obj2).f11367w);
            case 2:
                return t0.f.l(Long.valueOf(((x4.r) obj).k()), Long.valueOf(((x4.r) obj2).k()));
            case 3:
                return t0.f.l(((x4.x1) obj).f11450b, ((x4.x1) obj2).f11450b);
            case 4:
                return t0.f.l(((x4.e) obj).f11123b, ((x4.e) obj2).f11123b);
            case 5:
                return t0.f.l(Long.valueOf(((x4.y2) obj).f11475c), Long.valueOf(((x4.y2) obj2).f11475c));
            case 6:
                return t0.f.l(Long.valueOf(((x4.y2) obj).f11475c), Long.valueOf(((x4.y2) obj2).f11475c));
            case 7:
                return t0.f.l(Long.valueOf(((x4.y2) obj2).f11475c), Long.valueOf(((x4.y2) obj).f11475c));
            case 8:
                return t0.f.l(Long.valueOf(((x4.y2) obj2).f11475c), Long.valueOf(((x4.y2) obj).f11475c));
            case 9:
                return t0.f.l(Long.valueOf(((x4.y2) obj).f11475c), Long.valueOf(((x4.y2) obj2).f11475c));
