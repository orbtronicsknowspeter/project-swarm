...
public abstract class d {
    ...
    public static final b[] f9392a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final Map f9393b;
    ...
    static {
        ...
        for (int i = 0; i < bVarArr.length; i++) {
            if (!linkedHashMap.containsKey(bVarArr[i].f9384a)) {
                linkedHashMap.put(bVarArr[i].f9384a, Integer.valueOf(i));
            }
        }
        f9393b = DesugarCollections.unmodifiableMap(linkedHashMap);
    }
