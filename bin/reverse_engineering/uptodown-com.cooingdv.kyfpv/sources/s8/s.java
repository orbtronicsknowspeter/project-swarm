...
public final class s implements Closeable {
    ...
    public static final Logger f9450n = Logger.getLogger(e.class.getName());

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final w8.j f9451a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final r f9452b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final boolean f9453l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final c f9454m;
    ...
    public final boolean c(boolean z9, o oVar) throws IOException {
        ...
        try {
            this.f9451a.t(9L);
            int iJ = j(this.f9451a);
            if (iJ < 0 || iJ > 16384) {
                e.c("FRAME_SIZE_ERROR: %s", Integer.valueOf(iJ));
                throw null;
            }
            byte b7 = (byte) (this.f9451a.readByte() & 255);
            if (z9 && b7 != 4) {
                e.c("Expected a SETTINGS frame but was %s", Byte.valueOf(b7));
                throw null;
            }
            byte b10 = (byte) (this.f9451a.readByte() & 255);
            int i6 = this.f9451a.readInt();
            int i10 = Integer.MAX_VALUE & i6;
            Logger logger = f9450n;
            ...
            switch (b7) {
                ...
                case 3:
                    ...
                    q qVar = (q) oVar.f9425l;
                    if (i10 != 0 && (i6 & 1) == 0) {
                        qVar.f9436r.execute(new j(qVar, new Object[]{qVar.f9431m, Integer.valueOf(i10)}, i10, i));
                        return true;
                    }
                    w wVarF = qVar.f(i10);
                    if (wVarF != null) {
                ...
                case 8:
                    ...
                    long j = ((long) this.f9451a.readInt()) & 2147483647L;
                    if (j == 0) {
                        e.c("windowSizeIncrement was 0", Long.valueOf(j));
                        throw null;
                    }
                    q qVar2 = (q) oVar.f9425l;
                    if (i10 == 0) {
                        synchronized (qVar2) {
                            q qVar3 = (q) oVar.f9425l;
                            qVar3.v += j;
                            qVar3.notifyAll();
                            break;
                        }
    ...
    public final void d(o oVar) {
        ...
        w8.k kVar = e.f9394a;
        w8.k kVarG = this.f9451a.g(kVar.f10972a.length);
    ...
    */
    ...
    public final void f(o oVar, int i, int i6) {
        ...
        w8.k kVarG = w8.k.f10971m;
        if (i13 > 0) {
            kVarG = this.f9451a.g(i13);
        }
        kVarG.f();
        synchronized (((q) oVar.f9425l)) {
            wVarArr = (w[]) ((q) oVar.f9425l).f9430l.values().toArray(new w[((q) oVar.f9425l).f9430l.size()]);
            ((q) oVar.f9425l).f9434p = true;
        }
        for (w wVar : wVarArr) {
            if (wVar.f9468c > i11 && wVar.f()) {
                wVar.j(5);
                ((q) oVar.f9425l).f(wVar.f9468c);
            }
        }
    }
    ...
    public final ArrayList h(int i, short s6, byte b7, int i6) throws IOException {
        ...
        rVar.f9447m = i6;
        c cVar = this.f9454m;
        w8.a0 a0Var = cVar.f9388b;
        ArrayList arrayList = cVar.f9387a;
        while (!a0Var.b()) {
            ...
            if ((b10 & 128) == 128) {
                ...
                int length = cVar.f + 1 + (i11 - d.f9392a.length);
                if (length >= 0) {
                    b[] bVarArr2 = cVar.f9391e;
            ...
            if (i10 == 64) {
                ...
                cVar.f9390d = iE2;
                if (iE2 < 0 || iE2 > cVar.f9389c) {
                    throw new IOException("Invalid dynamic table size update " + cVar.f9390d);
                }
                int i12 = cVar.h;
                if (iE2 < i12) {
                    if (iE2 == 0) {
                        Arrays.fill(cVar.f9391e, (Object) null);
                        cVar.f = cVar.f9391e.length - 1;
                        cVar.g = 0;
                        cVar.h = 0;
                    } else {
                        cVar.a(i12 - iE2);
    ...
    public final void i(o oVar, int i, byte b7, int i6) throws IOException {
        ...
        boolean z9 = (b7 & 1) != 0;
        short s6 = (b7 & 8) != 0 ? (short) (this.f9451a.readByte() & 255) : (short) 0;
        if ((b7 & 32) != 0) {
            w8.j jVar = this.f9451a;
            jVar.readInt();
            jVar.readByte();
        ...
        if (i6 != 0 && (i6 & 1) == 0) {
            try {
                qVar.f9436r.execute(new j(qVar, new Object[]{qVar.f9431m, Integer.valueOf(i6)}, i6, arrayListH, z9));
                return;
        ...
        synchronized (qVar) {
            try {
                ...
                if (i6 % 2 == qVar2.f9433o % 2) {
                    return;
                }
                w wVar = new w(i6, qVar2, false, z9, arrayListH);
                q qVar3 = (q) oVar.f9425l;
                qVar3.f9432n = i6;
                qVar3.f9430l.put(Integer.valueOf(i6), wVar);
                q.D.execute(new o(oVar, new Object[]{((q) oVar.f9425l).f9431m, Integer.valueOf(i6)}, wVar));
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    public final void n(o oVar, int i, byte b7, int i6) {
        ...
        int i10 = this.f9451a.readInt();
        int i11 = this.f9451a.readInt();
        boolean z9 = (b7 & 1) != 0;
        q qVar = (q) oVar.f9425l;
        if (!z9) {
            try {
                qVar.f9435q.execute(new n(qVar, true, i10, i11));
            } catch (RejectedExecutionException unused) {
            }
        } else {
            synchronized (qVar) {
    ...
    public final void r(o oVar, int i, byte b7, int i6) throws IOException {
        ...
        short s6 = (b7 & 8) != 0 ? (short) (this.f9451a.readByte() & 255) : (short) 0;
        int i10 = this.f9451a.readInt() & Integer.MAX_VALUE;
        ...
        synchronized (qVar) {
            try {
                ...
                try {
                    qVar.f9436r.execute(new j(qVar, new Object[]{qVar.f9431m, Integer.valueOf(i10)}, i10, arrayListH));
                } catch (RejectedExecutionException unused) {
                }
            } catch (Throwable th) {
                throw th;
    ...
    public final void s(o oVar, int i, byte b7, int i6) {
        ...
        for (int i10 = 0; i10 < i; i10 += 6) {
            int i11 = this.f9451a.readShort() & 65535;
            int i12 = this.f9451a.readInt();
            if (i11 == 2) {
                if (i12 != 0 && i12 != 1) {
        ...
        synchronized (((q) oVar.f9425l)) {
            try {
                int iC = ((q) oVar.f9425l).f9441x.c();
                f8.q qVar2 = ((q) oVar.f9425l).f9441x;
                qVar2.getClass();
                for (int i13 = 0; i13 < 10; i13++) {
                    if (((1 << i13) & qVar.f4965b) != 0) {
                        qVar2.h(i13, ((int[]) qVar.f4966c)[i13]);
                    }
                }
                try {
                    q qVar3 = (q) oVar.f9425l;
                    qVar3.f9435q.execute(new o(oVar, new Object[]{qVar3.f9431m}, qVar));
                } catch (RejectedExecutionException unused) {
                }
                int iC2 = ((q) oVar.f9425l).f9441x.c();
                if (iC2 == -1 || iC2 == iC) {
                    j = 0;
                } else {
                    j = iC2 - iC;
                    q qVar4 = (q) oVar.f9425l;
                    if (!qVar4.f9442y) {
                        qVar4.v += j;
                        if (j > 0) {
                            qVar4.notifyAll();
                        }
                        ((q) oVar.f9425l).f9442y = true;
                    }
                    if (!((q) oVar.f9425l).f9430l.isEmpty()) {
                        wVarArr = (w[]) ((q) oVar.f9425l).f9430l.values().toArray(new w[((q) oVar.f9425l).f9430l.size()]);
                    }
                }
                q.D.execute(new p(oVar, ((q) oVar.f9425l).f9431m));
            } finally {
            }
        }
        if (wVarArr == null || j == 0) {
