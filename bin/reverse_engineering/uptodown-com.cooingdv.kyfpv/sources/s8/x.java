...
public final class x implements Closeable {
    ...
    public static final Logger f9472p = Logger.getLogger(e.class.getName());

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final w8.i f9473a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final boolean f9474b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final w8.h f9475l;
    ...
    public final synchronized void b(f8.q qVar) {
        try {
            ...
            this.f9476m = i;
            if (((i6 & 2) != 0 ? ((int[]) qVar.f4966c)[1] : -1) != -1) {
                k0 k0Var = this.f9478o;
                int iMin = Math.min((i6 & 2) != 0 ? ((int[]) qVar.f4966c)[1] : -1, 16384);
                int i10 = k0Var.f129d;
                if (i10 != iMin) {
                    if (iMin < i10) {
    ...
    public final synchronized void e(int i, int i6, byte[] bArr) {
        try {
            ...
            this.f9473a.writeInt(i);
            this.f9473a.writeInt(k0.k.c(i6));
            if (bArr.length > 0) {
    ...
    */
    ...
    public final synchronized void j(f8.q qVar) {
        try {
            ...
            d(0, Integer.bitCount(qVar.f4965b) * 6, (byte) 4, (byte) 0);
            int i = 0;
            while (i < 10) {
                boolean z9 = true;
                if (((1 << i) & qVar.f4965b) == 0) {
                    z9 = false;
                }
                if (z9) {
                    this.f9473a.writeShort(i == 4 ? 3 : i == 7 ? 4 : i);
                    this.f9473a.writeInt(((int[]) qVar.f4966c)[i]);
                }
                i++;
            }
            this.f9473a.flush();
