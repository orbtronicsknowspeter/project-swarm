...
public abstract class c {
    ...
    public static void f(AccessibleObject accessibleObject) {
        try {
            ...
            StringBuilder sbV = x.v("Failed making ", d(accessibleObject, false), " accessible; either increase its visibility or write a custom TypeAdapter for its declaring type.");
            sbV.append(e(e10));
            throw new e(sbV.toString(), e10);
        }
    }
}
