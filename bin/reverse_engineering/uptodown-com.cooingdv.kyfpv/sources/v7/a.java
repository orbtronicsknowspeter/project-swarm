...
public final class a extends Thread {
    ...
    public static final /* synthetic */ AtomicIntegerFieldUpdater f10859r = AtomicIntegerFieldUpdater.newUpdater(a.class, "workerCtl$volatile");
    ...
    public final /* synthetic */ c f10867q;
    ...
    public a(c cVar, int i) {
        ...
        this.f10860a = new l();
        this.f10861b = new x();
        this.f10862l = b.f10871m;
        this.nextParkedWorker = c.f10877t;
        int iNanoTime = (int) System.nanoTime();
        this.f10865o = iNanoTime == 0 ? 42 : iNanoTime;
        f(i);
    }

    /* JADX WARN: Code restructure failed: missing block: B:20:0x0041, code lost:
    
        r12 = v7.l.f10901d.get(r9);
        r0 = v7.l.f10900c.get(r9);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:23:0x0055, code lost:
        ...
        if (v7.l.f10902e.get(r9) != 0) goto L25;
     */
    ...
    */
    public final v7.h a(boolean r12) {
        ...
        L10:
            ...
            r9.getClass()
        L23:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r12 = v7.l.f10899b
            java.lang.Object r0 = r12.get(r9)
            v7.h r0 = (v7.h) r0
            if (r0 != 0) goto L2e
            goto L41
        L2e:
            boolean r1 = r0.f10891b
            if (r1 != r8) goto L41
        L32:
        ...
        L3a:
            ...
            goto L23
        L41:
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r12 = v7.l.f10901d
            int r12 = r12.get(r9)
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r0 = v7.l.f10900c
            int r0 = r0.get(r9)
        L4d:
            if (r12 == r0) goto L61
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r1 = v7.l.f10902e
            int r1 = r1.get(r9)
            if (r1 != 0) goto L58
            goto L61
        L58:
        ...
        L73:
            ...
            long r5 = r3 - r5
            java.util.concurrent.atomic.AtomicLongFieldUpdater r1 = v7.c.f10875r
    ...
    public final void f(int i) {
        ...
        sb.append(this.f10867q.f10881m);
        sb.append("-worker-");
    ...
    public final boolean h(b bVar) {
        b bVar2 = this.f10862l;
        boolean z9 = bVar2 == b.f10868a;
        if (z9) {
            c.f10875r.addAndGet(this.f10867q, 4398046511104L);
        }
        if (bVar2 != bVar) {
            this.f10862l = bVar;
        }
