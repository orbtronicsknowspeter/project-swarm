...
public class a0 implements o5.e, a4.i {
    ...
    public Serializable f4933m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final Object f4934n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final Object f4935o;
    ...
    public void a(long j) {
        ((kotlin.jvm.internal.w) this.f4932l).f7024a = j;
    }

    @Override // o5.e
    public void b(long j) {
        ((kotlin.jvm.internal.w) this.f4933m).f7024a = j;
    }

    public int c(int i, CharSequence charSequence) {
        int i6 = i + 4;
        if (i6 < charSequence.length()) {
            ((StringBuilder) this.f4935o).append((char) (r(i + 3, charSequence) + (r(i, charSequence) << 12) + (r(i + 1, charSequence) << 8) + (r(i + 2, charSequence) << 4)));
            return i6;
        }
        this.f4931b = i;
        if (i6 < charSequence.length()) {
            return c(this.f4931b, charSequence);
        }
    ...
    public void e() {
        ...
        DownloadApkWorker downloadApkWorker = (DownloadApkWorker) this.f4934n;
        downloadApkWorker.r(bundleE, downloadApkWorker.f3477c, (j0) ((x4.r) this.f4935o).F.get(this.f4931b));
    }

    public void f(int i, String str) {
        String str2 = (String) this.f4934n;
        ...
        this.f4931b = str.length() + i;
    }

    public String g() {
        String string;
        StringBuilder sb = (StringBuilder) this.f4935o;
        String str = (String) this.f4934n;
        k('\"');
        int i = this.f4931b;
                ...
                while (cCharAt != '\"') {
                    if (cCharAt == '\\') {
                        ...
                        if (cCharAt2 == 'u') {
                            ...
                            char c9 = cCharAt2 < 'u' ? d.f4950a[cCharAt2] : (char) 0;
                            if (c9 == 0) {
    ...
    public void h(Exception exc) {
        j5.o.e(((PreRegisterWorker) this.f4932l).f3488a, (x4.g) this.f4935o, this.f4931b, null, (x1) this.f4934n);
    }
    ...
    */
    ...
    public String n() {
        ...
        StringBuilder sb = (StringBuilder) this.f4935o;
        String str = (String) this.f4934n;
        String str2 = (String) this.f4933m;
        if (str2 != null) {
            str2.getClass();
            this.f4933m = null;
            return str2;
        ...
        while (m.g(str.charAt(iW)) == 0) {
            iW++;
            if (iW >= str.length()) {
                sb.append((CharSequence) str, this.f4931b, iW);
                int iV = v(iW);
                if (iV == -1) {
                    this.f4931b = iW;
    ...
    public void o(int i, String str, String str2) {
        ...
        sbU.append(((o) this.f4932l).c());
        sbU.append(strConcat);
        throw m.e(sbU.toString(), (String) this.f4934n, i);
    }

    @Override // a4.i
    public void onSuccess() {
        v7.e eVar = m0.f8289a;
        t7.c cVarB = o7.c0.b(v7.d.f10885a);
        PreRegisterWorker preRegisterWorker = (PreRegisterWorker) this.f4932l;
        String str = (String) this.f4933m;
        x1 x1Var = (x1) this.f4934n;
        o7.c0.s(cVarB, null, null, new o5.m(this.f4931b, preRegisterWorker, str, null, (x4.g) this.f4935o, x1Var), 3);
    }
    ...
    public int v(int i) {
        if (i < ((String) this.f4934n).length()) {
            return i;
        }
        return -1;
    }
        ...
        if (i > 0 && c9 == '\"') {
            try {
                ...
                if (kotlin.jvm.internal.l.a(strN, "null")) {
                    o(this.f4931b - 1, "Expected string literal but 'null' literal was found", "Use 'coerceInputValues = true' in 'Json {}' builder to coerce nulls if property has a default value.");
                    throw null;
                }
            } catch (Throwable th) {
                this.f4931b = i;
    ...
    public /* synthetic */ a0(Object obj, Serializable serializable, Object obj2, Parcelable parcelable, int i, int i6) {
        this.f4930a = i6;
        this.f4932l = obj;
        this.f4933m = serializable;
        this.f4934n = obj2;
        this.f4935o = parcelable;
        this.f4931b = i;
    }
}
