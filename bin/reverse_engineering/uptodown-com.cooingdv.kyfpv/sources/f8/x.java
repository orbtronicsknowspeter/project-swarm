...
public final class x extends c8.a implements e8.i {
    ...
    public x(e8.b bVar, c0 c0Var, a0 a0Var, b8.e eVar, w wVar) {
        ...
        this.f4983b = c0Var;
        this.f4984c = a0Var;
        this.f4985d = bVar.f4763b;
        this.f4986e = -1;
        this.f = wVar;
        e8.h hVar = bVar.f4762a;
        this.g = hVar;
        this.h = hVar.f4771a ? null : new j(eVar);
    }

    @Override // e8.i
    public final e8.k a() {
        return new q(this.f4982a.f4762a, this.f4984c).d();
    }
    ...
    public final c8.c beginStructure(b8.e eVar) {
        eVar.getClass();
        e8.b bVar = this.f4982a;
        c0 c0VarN = m.n(eVar, bVar);
        a0 a0Var = this.f4984c;
        o oVar = (o) a0Var.f4932l;
        int i = oVar.f4962c + 1;
        oVar.f4962c = i;
        Object[] objArr = (Object[]) oVar.f4961b;
        if (i == objArr.length) {
            int i6 = i * 2;
            oVar.f4961b = Arrays.copyOf(objArr, i6);
            oVar.f4963d = Arrays.copyOf((int[]) oVar.f4963d, i6);
        }
        ((Object[]) oVar.f4961b)[i] = eVar;
        a0Var.k(c0VarN.f4948a);
        if (a0Var.t() != 4) {
            int iOrdinal = c0VarN.ordinal();
            return (iOrdinal == 1 || iOrdinal == 2 || iOrdinal == 3) ? new x(bVar, c0VarN, a0Var, eVar, this.f) : (this.f4983b == c0VarN && bVar.f4762a.f4771a) ? this : new x(bVar, c0VarN, a0Var, eVar, this.f);
        }
    ...
    public final boolean decodeBoolean() {
        ...
        a0 a0Var = this.f4984c;
        int iW = a0Var.w();
        String str = (String) a0Var.f4934n;
        if (iW == str.length()) {
        ...
        if (a0Var.f4931b == str.length()) {
            a0.p(a0Var, "EOF", 0, null, 6);
            throw null;
        }
        if (str.charAt(a0Var.f4931b) == '\"') {
            a0Var.f4931b++;
            return z10;
        }
        ...
        if (iOrdinal == 0) {
            ...
            while (true) {
                ...
                if (zD) {
                    ...
                    if (i6 != -3) {
                        if (jVar != null) {
                            d8.t tVar = jVar.f4956a;
                            if (i6 < 64) {
                                tVar.f3709c |= 1 << i6;
                            } else {
                                int i10 = (i6 >>> 6) - 1;
                                long[] jArr = tVar.f3710d;
                        ...
                        w wVar = this.f;
                        if (wVar == null || !kotlin.jvm.internal.l.a(wVar.f4981b, strG)) {
                            break;
                        }
                        wVar.f4981b = null;
                                ...
                                if (bT2 == b7) {
                                    ...
                                    if (bT2 == 8 || bT2 == 6) {
                                        ...
                                        if (((Number) q6.l.y0(arrayList)).byteValue() != 8) {
                                            throw m.e("found ] instead of } at path: " + oVar, str, a0Var.f4931b);
                                        }
                                        q6.r.n0(arrayList);
                                    } else if (bT2 == 7) {
                    ...
                    if (jVar != null) {
                        d8.t tVar2 = jVar.f4956a;
                        i iVar = tVar2.f3708b;
                        b8.e eVar2 = tVar2.f3707a;
                        int iE = eVar2.e();
                        while (true) {
                            long j = tVar2.f3709c;
                            long j6 = -1;
            ...
            a0Var.o(l7.m.A0(strG, str.subSequence(0, a0Var.f4931b).toString(), 6), "Encountered an unknown key '" + strG + '\'', "Use 'ignoreUnknownKeys = true' in 'Json {}' builder to ignore unknown keys.");
            throw null;
        }
        if (iOrdinal != 2) {
            boolean zX3 = a0Var.x();
    ...
    public final int decodeEnum(b8.e eVar) {
        ...
        String strConcat = " at path ".concat(((o) this.f4984c.f4932l).c());
        eVar.getClass();
        e8.b bVar = this.f4982a;
        bVar.getClass();
    ...
    public final c8.e decodeInline(b8.e eVar) {
        eVar.getClass();
        return z.a(eVar) ? new g(this.f4984c, this.f4982a) : super.decodeInline(eVar);
    }
    ...
    public final long decodeLong() {
        return this.f4984c.l();
    }

    @Override // c8.a, c8.e
    public final boolean decodeNotNullMark() {
        j jVar = this.h;
        if (!(jVar != null ? jVar.f4957b : false)) {
            a0 a0Var = this.f4984c;
    ...
    public final Object decodeSerializableElement(b8.e eVar, int i, z7.a aVar, Object obj) {
        o oVar = (o) this.f4984c.f4932l;
        eVar.getClass();
        aVar.getClass();
        boolean z9 = this.f4983b == c0.f4944n && (i & 1) == 0;
        if (z9) {
            int[] iArr = (int[]) oVar.f4963d;
            int i6 = oVar.f4962c;
            if (iArr[i6] == -2) {
                ((Object[]) oVar.f4961b)[i6] = n.f4959a;
            }
        }
        Object objDecodeSerializableElement = super.decodeSerializableElement(eVar, i, aVar, obj);
        if (z9) {
            int[] iArr2 = (int[]) oVar.f4963d;
            int i10 = oVar.f4962c;
            if (iArr2[i10] != -2) {
                int i11 = i10 + 1;
                oVar.f4962c = i11;
                ...
                if (i11 == objArr.length) {
                    int i12 = i11 * 2;
                    oVar.f4961b = Arrays.copyOf(objArr, i12);
                    oVar.f4963d = Arrays.copyOf((int[]) oVar.f4963d, i12);
                }
            }
            Object[] objArr2 = (Object[]) oVar.f4961b;
            int i13 = oVar.f4962c;
            objArr2[i13] = objDecodeSerializableElement;
            ((int[]) oVar.f4963d)[i13] = -2;
        }
