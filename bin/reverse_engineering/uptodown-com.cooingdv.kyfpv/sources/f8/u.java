...
public final class u extends v6.h implements d7.q {
    ...
    public final Object invoke(Object obj, Object obj2, Object obj3) {
        u uVar = new u(this.f4972l, (t6.c) obj3);
        uVar.f4971b = (p6.b) obj;
        return uVar.invokeSuspend(p6.x.f8464a);
    }

    @Override // v6.a
    public final Object invokeSuspend(Object obj) {
        q qVar = this.f4972l;
        a0 a0Var = (a0) qVar.f4966c;
        int i = this.f4970a;
        if (i == 0) {
            p6.a.e(obj);
            p6.b bVar = this.f4971b;
            byte bT = a0Var.t();
            if (bT == 1) {
                return qVar.f(true);
            }
