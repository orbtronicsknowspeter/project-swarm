...
public abstract class a implements e8.i, c8.e, c8.c {
    ...
    public c8.c beginStructure(b8.e eVar) {
        ...
        if (!kotlin.jvm.internal.l.a(kind, b8.i.j)) {
            ...
            if (kVarC instanceof e8.t) {
                return new r(bVar, (e8.t) kVarC, this.f4928d, 8);
            }
        ...
        b8.e eVarF = m.f(eVar.h(0), bVar.f4763b);
    ...
    public final boolean d(Object obj) {
        ...
        try {
            d8.y yVar = e8.l.f4776a;
            String strC = xVar.c();
            String[] strArr = b0.f4937a;
            strC.getClass();
    ...
    public final c8.e decodeInline(b8.e eVar) {
        ...
        return new p(this.f4927c, q(), this.f4928d).decodeInline(eVar);
    }
