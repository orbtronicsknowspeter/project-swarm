...
public final class j {
    ...
    public final l9.a f6769a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final ChoiceCmpCallback f6770b;

    public j(l9.a aVar, ChoiceCmpCallback choiceCmpCallback) {
        aVar.getClass();
        this.f6769a = aVar;
        this.f6770b = choiceCmpCallback;
    }
    ...
    public final void a() {
        if (l.g.f7045a) {
            ...
            l9.a aVar = this.f6769a;
            Vector vectorK = aVar.k(40);
            if (vectorK != null) {
                vectorK.forEach(new l.e(0, vector));
            }
            aVar.e(40, vector);
            ChoiceCmpCallback choiceCmpCallback = this.f6770b;
