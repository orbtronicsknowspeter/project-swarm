...
public final class f {
    ...
    public final Locale f6756a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final i9.b f6757b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final l9.a f6758c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final i9.i f6759d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final g5.g f6760e;
    public h9.t f;
    public l8.r g;
    public l8.j h;
    ...
    */
    public final java.lang.Object a(v6.c r5) {
        ...
        L2e:
            p6.a.e(r5)
            l9.a r5 = r4.f6758c     // Catch: r5.a -> L51
            java.lang.String r1 = "en"
            r3 = 33
            r5.f(r3, r1)     // Catch: r5.a -> L51
            i9.i r5 = r4.f6759d     // Catch: r5.a -> L51
            java.lang.String r1 = r4.h()     // Catch: r5.a -> L51
            r0.f6740a = r4     // Catch: r5.a -> L51
            r0.f6743m = r2     // Catch: r5.a -> L51
    ...
    public final h9.i c() {
        ...
        String str = tVar.f5607a.f5513a;
        String strX0 = q6.l.x0(tVar.f5609c.f5559p, " ", null, null, null, 62);
        h9.t tVar2 = this.f;
        if (tVar2 == null) {
            kotlin.jvm.internal.l.i("translationsText");
            throw null;
        }
        h9.g gVar = tVar2.f5607a;
        String str2 = gVar.f5517e;
        String str3 = gVar.f5514b;
        String str4 = this.h.f7217b;
        if (str4.length() == 0) {
            h9.t tVar3 = this.f;
            if (tVar3 == null) {
                kotlin.jvm.internal.l.i("translationsText");
        ...
        String str6 = tVar4.f5607a.f5524q;
        String str7 = "";
        if (this.h.f7218c.isEmpty()) {
            h9.t tVar5 = this.f;
            if (tVar5 == null) {
                kotlin.jvm.internal.l.i("translationsText");
                throw null;
            }
            ArrayList arrayList = tVar5.f5608b.j;
            ...
            ArrayList arrayList2 = this.h.f7218c;
        ...
        String str9 = tVar6.f5607a.E;
        h9.e eVar = tVar6.f5610d;
        h9.e eVar2 = new h9.e(eVar.f5507a, eVar.f5508b, eVar.f5509c, eVar.f5510d, eVar.f, eVar.g, 16);
        h9.t tVar7 = this.f;
        if (tVar7 != null) {
            h9.a aVar = tVar7.f5611e;
            return new h9.i(str, strX0, str2, str3, str5, str6, str8, str9, eVar2, new h9.a(aVar.f5484a, aVar.f5485b, aVar.f5486c, aVar.f5487d, aVar.f, 16));
        }
        kotlin.jvm.internal.l.i("translationsText");
        throw null;
    }
    ...
    */
    public final java.lang.Object d(v6.c r8) {
        ...
        L3d:
            p6.a.e(r8)
            i9.b r8 = r7.f6757b     // Catch: r5.a -> L5d
            boolean r8 = r8.a()     // Catch: r5.a -> L5d
            if (r8 == 0) goto L60
            i9.i r8 = r7.f6759d     // Catch: r5.a -> L5d
            java.lang.String r1 = r7.h()     // Catch: r5.a -> L5d
            r0.f6748a = r7     // Catch: r5.a -> L5d
            r0.f6751m = r4     // Catch: r5.a -> L5d
        ...
        L6e:
            l9.a r8 = r7.f6758c     // Catch: r5.a -> L5d
            java.lang.String r8 = r8.j(r3)     // Catch: r5.a -> L5d
            r1 = r7
            goto L98
        L76:
            int[] r6 = j9.a.f6739a
            com.inmobi.cmp.model.ChoiceError r8 = r8.f8909a
            int r8 = r8.ordinal()
            r8 = r6[r8]
            if (r8 != r4) goto L92
            r0.f6748a = r1
    ...
    public final h9.l e() {
        ...
        h9.g gVar = tVar2.f5607a;
        String str2 = gVar.f5525r;
        String str3 = gVar.Q;
        h9.k kVar = tVar2.f5609c;
        String str4 = kVar.f;
        String str5 = gVar.f5522o;
        String str6 = gVar.f5515c;
        String str7 = gVar.f5523p;
        String str8 = gVar.A;
        String str9 = gVar.f5524q;
        String str10 = kVar.i;
        String str11 = kVar.j;
        String str12 = kVar.f5554k;
        String str13 = kVar.f5555l;
        String strB = b();
        h9.t tVar3 = this.f;
        if (tVar3 != null) {
            return new h9.l(str, strX0, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12, str13, strB, tVar3.f5607a.B, tVar3.f5610d, tVar3.f5611e);
        }
        kotlin.jvm.internal.l.i("translationsText");
        throw null;
    }
    ...
    public final h9.n f() {
        ...
        h9.k kVar = tVar.f5609c;
        String str = kVar.f;
        h9.g gVar = tVar.f5607a;
        return new h9.n(str, gVar.D, kVar.f5550b, gVar.f5524q, kVar.f5552d, kVar.f5553e, b());
    }
    ...
    public final h9.m g() {
        ...
        String upperCase2 = tVar2.f5607a.f5526s.toUpperCase(locale);
        upperCase2.getClass();
        h9.t tVar3 = this.f;
        if (tVar3 == null) {
            kotlin.jvm.internal.l.i("translationsText");
        ...
        h9.g gVar2 = tVar3.f5607a;
        String str3 = gVar2.f5528u;
        String str4 = gVar2.f5527t;
        String str5 = gVar2.v;
        String str6 = gVar2.E;
        String str7 = gVar2.R;
        String str8 = gVar2.S;
    ...
    public final String h() {
        String strO0;
        String str = (d0.b.C() || d0.b.s()) ? m9.c.e().f7240n.f7215w.f7257c : m9.c.e().f7240n.f7215w.f7255a;
        String strP = d0.b.p();
        Locale locale = this.f6756a;
        if (str == null) {
            strO0 = null;
    ...
    public final void i() {
        if (this.f == null) {
            String strJ = this.f6758c.j(28);
            this.f = strJ.length() > 0 ? (h9.t) this.f6760e.l(strJ) : new h9.t();
        }
    }
}
