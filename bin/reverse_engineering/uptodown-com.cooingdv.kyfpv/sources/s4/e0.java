...
public final class e0 extends v6.i implements d7.p {
    ...
    public final /* synthetic */ Object f9195l;
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f9193a) {
            case 0:
                return new e0((x4.g) this.f9194b, (r.k) this.f9195l, cVar, 0);
            case 1:
                return new e0((String) this.f9194b, (u4.d) this.f9195l, cVar, 1);
            case 2:
                return new e0((u4.d) this.f9195l, (x4.g) this.f9194b, cVar);
            case 3:
                return new e0((Context) this.f9194b, (u4.f0) this.f9195l, cVar, 3);
            case 4:
                e0 e0Var = new e0((u4.f0) this.f9195l, cVar, 4);
                e0Var.f9194b = obj;
                return e0Var;
            case 5:
                return new e0((String) this.f9194b, (z0) this.f9195l, cVar, 5);
            case 6:
                return new e0((String) this.f9194b, (m1) this.f9195l, cVar, 6);
            case 7:
                e0 e0Var2 = new e0((z1) this.f9195l, cVar, 7);
                e0Var2.f9194b = obj;
                return e0Var2;
            default:
                return new e0((z1) this.f9194b, (String) this.f9195l, cVar, 8);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (this.f9193a) {
            case 0:
                return ((e0) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
            case 1:
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.f9193a) {
            case 0:
                p6.a.e(obj);
                x4.g gVar = (x4.g) this.f9194b;
                long j = gVar.f11159a;
                gVar.f11160b.getClass();
                gVar.h();
                Context context = ((r.k) this.f9195l).f8835a;
                g2 g2VarA = new j5.v(context).a(gVar.f11159a);
                ...
                return new p6.k(obj2);
            case 1:
                u4.d dVar = (u4.d) this.f9195l;
                p6.a.e(obj);
                String str2 = (String) this.f9194b;
                if (str2 != null && str2.length() != 0 && (q0Var = dVar.f10449l) != null) {
                    Iterator it = q0Var.f4667l.iterator();
                    int i = 0;
                    while (it.hasNext()) {
                        int i6 = i + 1;
                        Object obj3 = ((e4.o0) it.next()).f4649a;
                        if ((obj3 instanceof x4.g) && (str = ((x4.g) obj3).F) != null && str.equals(str2)) {
                            e4.q0 q0Var2 = dVar.f10449l;
                            q0Var2.getClass();
            ...
            case 2:
                p6.a.e(obj);
                u4.d dVar2 = (u4.d) this.f9195l;
                Context contextRequireContext = dVar2.requireContext();
                contextRequireContext.getClass();
                j5.v vVar = new j5.v(contextRequireContext);
                x4.c cVar = dVar2.f10448b;
                if (cVar == null) {
                    kotlin.jvm.internal.l.i("alternatives");
                    throw null;
                }
                x4.g gVar2 = cVar.f11075d;
                String strValueOf = String.valueOf(gVar2 != null ? new Long(gVar2.f11159a) : null);
                String strValueOf2 = String.valueOf(((x4.g) this.f9194b).f11159a);
                ...
                g2VarK.f11207d = vVar.i(g2VarK, str3);
                return g2VarK;
            case 3:
                p6.a.e(obj);
                e1.c0 c0Var = j5.g.D;
                Context context2 = (Context) this.f9194b;
                j5.g gVarL2 = c0Var.l(context2);
                gVarL2.b();
                u4.f0 f0Var = (u4.f0) this.f9195l;
                ...
                return p6.x.f8464a;
            case 4:
                o7.a0 a0Var = (o7.a0) this.f9194b;
                p6.a.e(obj);
                u4.f0 f0Var2 = (u4.f0) this.f9195l;
                t6.c cVar2 = null;
            ...
            case 5:
                p6.a.e(obj);
                String str5 = (String) this.f9194b;
                if (str5 != null && str5.length() != 0 && (hVar = (z0Var = (z0) this.f9195l).f10671b) != null) {
                    hVar.d(str5, z0Var.h());
                }
                return p6.x.f8464a;
            case 6:
                p6.a.e(obj);
                String str6 = (String) this.f9194b;
                if (str6 != null && str6.length() != 0 && (hVar2 = (m1Var = (m1) this.f9195l).f10539b) != null) {
                    hVar2.d(str6, m1Var.b().f10041m);
                }
                return p6.x.f8464a;
            case 7:
                o7.a0 a0Var2 = (o7.a0) this.f9194b;
                p6.a.e(obj);
                z1 z1Var = (z1) this.f9195l;
                t6.c cVar3 = null;
            ...
            default:
                p6.a.e(obj);
                z1 z1Var2 = (z1) this.f9194b;
                String str7 = (String) this.f9195l;
                int iC = z1Var2.c(str7);
                e4.q0 q0Var3 = z1Var2.f10686o;
                if (iC > -1) {
                    if (q0Var3 != null) {
