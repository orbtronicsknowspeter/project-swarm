...
public final class r extends v6.i implements d7.p {
    ...
    public final /* synthetic */ int f9272a = 0;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public j5.g f9273b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public ArrayList f9274l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public Iterator f9275m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public ArrayList f9276n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public int f9277o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public /* synthetic */ Object f9278p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public final /* synthetic */ s f9279q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final /* synthetic */ ArrayList f9280r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ j5.v f9281s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public r(ArrayList arrayList, s sVar, j5.v vVar, t6.c cVar) {
        super(2, cVar);
        this.f9280r = arrayList;
        this.f9279q = sVar;
        this.f9281s = vVar;
    }
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f9272a) {
            case 0:
                r rVar = new r(this.f9280r, this.f9279q, this.f9281s, cVar);
                rVar.f9278p = obj;
                return rVar;
            default:
                r rVar2 = new r(this.f9279q, this.f9280r, this.f9281s, cVar);
                rVar2.f9278p = obj;
                return rVar2;
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((r) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
    }
