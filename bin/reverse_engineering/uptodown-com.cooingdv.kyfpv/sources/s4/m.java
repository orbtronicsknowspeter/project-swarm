...
public final class m extends v6.i implements d7.p {
    ...
    public final /* synthetic */ s f9241l;
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f9239a) {
            case 0:
                return new m(this.f9241l, this.f9242m, cVar, 0);
            case 1:
                return new m(this.f9241l, this.f9242m, cVar, 1);
            case 2:
                return new m(this.f9241l, this.f9242m, cVar, 2);
            case 3:
                return new m(this.f9241l, this.f9242m, cVar, 3);
            case 4:
                return new m(this.f9241l, this.f9242m, cVar, 4);
            case 5:
                return new m(this.f9241l, cVar);
            case 6:
                return new m(this.f9241l, this.f9242m, cVar, 6);
            case 7:
                return new m(this.f9241l, this.f9242m, cVar, 7);
            case 8:
                return new m(this.f9241l, this.f9242m, cVar, 8);
            default:
                return new m(this.f9241l, this.f9242m, cVar, 9);
        }
    }
