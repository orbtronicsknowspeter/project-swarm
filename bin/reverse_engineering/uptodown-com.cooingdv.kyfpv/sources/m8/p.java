...
public final class p {
    ...
    public static final Pattern f7772k = Pattern.compile("(?i)(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec).*");

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public static final Pattern f7773l = Pattern.compile("(\\d{1,2})[^\\d]*");

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public static final Pattern f7774m = Pattern.compile("(\\d{1,2}):(\\d{1,2}):(\\d{1,2})[^\\d]*");
    ...
    */
    ...
    public final boolean equals(Object obj) {
        ...
        p pVar = (p) obj;
        return pVar.f7775a.equals(this.f7775a) && pVar.f7776b.equals(this.f7776b) && pVar.f7778d.equals(this.f7778d) && pVar.f7779e.equals(this.f7779e) && pVar.f7777c == this.f7777c && pVar.f == this.f && pVar.g == this.g && pVar.h == this.h && pVar.i == this.i;
    }

    public final int hashCode() {
        int iO = androidx.lifecycle.l.o(androidx.lifecycle.l.o(androidx.lifecycle.l.o(androidx.lifecycle.l.o(527, 31, this.f7775a), 31, this.f7776b), 31, this.f7778d), 31, this.f7779e);
        long j6 = this.f7777c;
    ...
    public final String toString() {
        ...
        if (this.h) {
            ...
            if (j6 == Long.MIN_VALUE) {
                ...
                sb.append("; expires=");
                sb.append(((DateFormat) q8.b.f8783a.get()).format(new Date(j6)));
            }
        }
        if (!this.i) {
            sb.append("; domain=");
