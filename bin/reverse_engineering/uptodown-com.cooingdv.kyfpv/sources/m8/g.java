...
public final class g implements Closeable, Flushable {
    ...
    public final g5.g f7722a = new g5.g(this, 7);

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final o8.f f7723b;
    ...
    public g(File file, long j) {
        ...
        this.f7723b = new o8.f(file, j, new ThreadPoolExecutor(0, 1, 60L, TimeUnit.SECONDS, linkedBlockingQueue, new n8.b("OkHttp DiskLruCache", true)));
    }
    ...
    public final void c(a0 a0Var) {
        o8.f fVar = this.f7723b;
        String str = a0Var.f7674a.i;
        ...
        synchronized (fVar) {
            ...
            fVar.b();
            o8.f.z(strG);
            o8.d dVar = (o8.d) fVar.f8366t.get(strG);
            if (dVar == null) {
                return;
            }
            fVar.u(dVar);
            if (fVar.f8364r <= fVar.f8362p) {
                fVar.f8370y = false;
            }
        }
    }
