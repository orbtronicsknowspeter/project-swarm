...
public final class u {
    ...
    public u(t tVar) {
        this.f7793a = tVar.f7788a;
        String str = tVar.f7789b;
        this.f7794b = h(str, 0, str.length(), false);
        String str2 = tVar.f7790c;
        this.f7795c = h(str2, 0, str2.length(), false);
        this.f7796d = tVar.f7791d;
        int i = tVar.f7792e;
        this.f7797e = i == -1 ? b(tVar.f7788a) : i;
    ...
    public static String a(String str, int i, int i6, String str2, boolean z9, boolean z10, boolean z11, boolean z12) throws EOFException {
        ...
        while (iCharCount < i6) {
            ...
            if (iCodePointAt < 32 || iCodePointAt == 127 || ((iCodePointAt >= 128 && z12) || str2.indexOf(iCodePointAt) != -1 || ((iCodePointAt == 37 && (!z9 || (z10 && !j(iCharCount, i6, str)))) || (iCodePointAt == 43 && z11)))) {
                ...
                return hVar.r(hVar.f10962b, l7.a.f7152a);
            }
    ...
    */
    public static java.lang.String h(java.lang.String r8, int r9, int r10, boolean r11) {
        ...
        L5b:
            long r8 = r1.f10962b
            java.nio.charset.Charset r10 = l7.a.f7152a
    ...
    public final String c() {
        ...
        int length = this.f7793a.length() + 3;
        String str = this.i;
