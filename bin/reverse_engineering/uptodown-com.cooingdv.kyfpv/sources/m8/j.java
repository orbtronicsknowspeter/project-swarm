...
public final class j {
    ...
    public static final j f7744c = new j(new LinkedHashSet(new ArrayList()), null);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final LinkedHashSet f7745a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final z3 f7746b;

    public j(LinkedHashSet linkedHashSet, z3 z3Var) {
        this.f7745a = linkedHashSet;
        this.f7746b = z3Var;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        j jVar = (j) obj;
        return n8.c.i(this.f7746b, jVar.f7746b) && this.f7745a.equals(jVar.f7745a);
    }

    public final int hashCode() {
        z3 z3Var = this.f7746b;
        return this.f7745a.hashCode() + ((z3Var != null ? z3Var.hashCode() : 0) * 31);
    }
}
