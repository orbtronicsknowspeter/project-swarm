...
public final class c {
    ...
    public static final Pattern f10802d = Pattern.compile("[0-9]+s");

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final Charset f10803e = Charset.forName("UTF-8");

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Context f10804a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final s2.b f10805b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final p.b f10806c = new p.b();
    ...
    public static void b(HttpURLConnection httpURLConnection, String str, String str2, String str3) {
        ...
        String str4 = null;
        if (errorStream != null) {
            BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(errorStream, f10803e));
            try {
    ...
    public static long d(String str) {
        y.a("Invalid Expiration Timestamp.", f10802d.matcher(str).matches());
    ...
    public static a e(HttpURLConnection httpURLConnection) throws IOException {
        ...
        JsonReader jsonReader = new JsonReader(new InputStreamReader(inputStream, f10803e));
        byte b7 = (byte) (0 | 1);
