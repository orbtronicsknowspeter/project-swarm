...
public class l extends k0 implements j, v6.d, c2 {
    ...
    public static final /* synthetic */ AtomicIntegerFieldUpdater f8278o = AtomicIntegerFieldUpdater.newUpdater(l.class, "_decisionAndIndex$volatile");

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public static final /* synthetic */ AtomicReferenceFieldUpdater f8279p = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_state$volatile");

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public static final /* synthetic */ AtomicReferenceFieldUpdater f8280q = AtomicReferenceFieldUpdater.newUpdater(l.class, Object.class, "_parentHandle$volatile");
    private volatile /* synthetic */ int _decisionAndIndex$volatile;
    private volatile /* synthetic */ Object _parentHandle$volatile;
    private volatile /* synthetic */ Object _state$volatile;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final t6.c f8281m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final t6.h f8282n;

    public l(int i, t6.c cVar) {
        super(i);
        this.f8281m = cVar;
        this.f8282n = cVar.getContext();
        this._decisionAndIndex$volatile = 536870911;
        this._state$volatile = b.f8233a;
    }
    ...
    public final void A(d7.l lVar, Object obj) {
        B(obj, this.f8273l, new k(lVar, 0));
    }

    public final void B(Object obj, int i, d7.q qVar) {
        while (true) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f8279p;
            ...
            if (obj2 instanceof m) {
                m mVar = (m) obj2;
                if (m.f8288c.compareAndSet(mVar, 0, 1)) {
                    if (qVar != null) {
                        k(qVar, mVar.f8316a, obj);
                        return;
                    }
                    return;
                }
    ...
    public final void C(w wVar) {
        t6.c cVar = this.f8281m;
        t7.f fVar = cVar instanceof t7.f ? (t7.f) cVar : null;
        B(p6.x.f8464a, (fVar != null ? fVar.f10327m : null) == wVar ? 4 : this.f8273l, null);
    }
    ...
    public final f8.w E(Object obj, d7.q qVar) {
        ...
        while (true) {
            ...
            Object objD = D((r1) obj2, obj, this.f8273l, qVar);
            while (!atomicReferenceFieldUpdater.compareAndSet(this, obj2, objD)) {
                if (atomicReferenceFieldUpdater.get(this) != obj2) {
                    break;
                }
    ...
    public final void a(t7.s sVar, int i) {
        ...
        int i6;
        do {
            atomicIntegerFieldUpdater = f8278o;
    ...
    public final void b(CancellationException cancellationException) {
        ...
        while (true) {
            ...
            d7.q qVar = tVar2.f8310c;
            if (qVar != null) {
                k(qVar, cancellationException, tVar2.f8308a);
                return;
            }
            return;
            cancellationException = cancellationException2;
    ...
    public final Object e(Object obj) {
        return obj instanceof t ? ((t) obj).f8308a : obj;
    }

    @Override // o7.j
    public final void g(Object obj, d7.q qVar) {
        B(obj, this.f8273l, qVar);
    }
    ...
    public final void j(i iVar, Throwable th) {
        try {
            ...
            c0.q(new a1.b("Exception in invokeOnCancellation handler for " + this, th2), this.f8282n);
        }
    }

    public final void k(d7.q qVar, Throwable th, Object obj) {
        t6.h hVar = this.f8282n;
        try {
    ...
    public final void l(t7.s sVar, Throwable th) {
        t6.h hVar = this.f8282n;
        int i = f8278o.get(this) & 536870911;
        if (i == 536870911) {
    ...
    public final void m() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f8280q;
        o0 o0Var = (o0) atomicReferenceFieldUpdater.get(this);
        if (o0Var == null) {
            return;
        }
        o0Var.dispose();
        atomicReferenceFieldUpdater.set(this, q1.f8301a);
    }
            ...
            if (i10 != 0) {
                ...
                if (!z9 && (cVar instanceof t7.f)) {
                    ...
                    if (z10 == (i11 == 1 || i11 == 2)) {
                        t7.f fVar = (t7.f) cVar;
                        w wVar = fVar.f10327m;
                        t6.h context = fVar.f10328n.getContext();
    ...
    public final Object r() {
        ...
        do {
            ...
            if (i6 != 0) {
                ...
                Object obj = f8279p.get(this);
                if (obj instanceof u) {
                    throw ((u) obj).f8316a;
                }
                int i10 = this.f8273l;
                if ((i10 != 1 && i10 != 2) || (e1Var = (e1) this.f8282n.get(x.f8328b)) == null || e1Var.b()) {
                    return e(obj);
                }
    ...
    public final void resumeWith(Object obj) {
        ...
        B(obj, this.f8273l, null);
    }

    public final void s() {
        o0 o0VarT = t();
        if (o0VarT == null || (f8279p.get(this) instanceof r1)) {
            return;
        }
        o0VarT.dispose();
        f8280q.set(this, q1.f8301a);
    }

    public final o0 t() {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater;
        e1 e1Var = (e1) this.f8282n.get(x.f8328b);
        if (e1Var == null) {
            return null;
        }
        o0 o0VarR = c0.r(e1Var, true, new n(this, 0));
        do {
            atomicReferenceFieldUpdater = f8280q;
    ...
    */
    public final void v(o7.r1 r8) {
        /*
            r7 = this;
        L0:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r0 = o7.l.f8279p
        ...
        L19:
            ...
            r0 = r2
            o7.u r0 = (o7.u) r0
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r1 = o7.u.f8315b
            r4 = 0
            r5 = 1
            ...
            if (r1 == 0) goto La1
            java.lang.Throwable r0 = r0.f8316a
        ...
        L60:
            ...
            r4 = r8
            o7.i r4 = (o7.i) r4
            java.lang.Throwable r5 = r1.f8312e
            if (r5 == 0) goto L6e
            r7.j(r4, r5)
            return
        L6e:
    ...
    public final boolean w() {
        if (this.f8273l == 2) {
            return t7.f.f10326q.get((t7.f) this.f8281m) != null;
        }
        return false;
    }
