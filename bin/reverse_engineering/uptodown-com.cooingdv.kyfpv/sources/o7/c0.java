...
public abstract class c0 {
    ...
    public static final f8.w f8244a = new f8.w("RESUME_TOKEN");

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final f8.w f8245b = new f8.w("REMOVED_TASK");

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final f8.w f8246c = new f8.w("CLOSED_EMPTY");

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static final f8.w f8247d = new f8.w("COMPLETING_ALREADY");

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final f8.w f8248e = new f8.w("COMPLETING_WAITING_CHILDREN");
    ...
    public static final Object A(Object obj) {
        ...
        return (c1Var == null || (b1Var = c1Var.f8249a) == null) ? obj : b1Var;
    }

    public static final a2 B(t6.c cVar, t6.h hVar, Object obj) {
        a2 a2Var = null;
        if ((cVar instanceof v6.d) && hVar.get(b2.f8239a) != null) {
    ...
    public static final Object C(d7.p pVar, t6.h hVar, t6.c cVar) throws Throwable {
        ...
        try {
            t7.a.h(p6.x.f8464a, d0.b.I(d0.b.B(pVar, j0Var, j0Var)));
            AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = j0.f8269n;
            do {
                ...
                if (i6 != 0) {
                    ...
                    Object objA = A(m1.f8290a.get(j0Var));
    ...
    */
    public static final java.lang.Object E(long r5, d7.p r7, v6.c r8) throws java.lang.Throwable {
        ...
        L13:
            ...
            r0.<init>(r8)
        L18:
            java.lang.Object r8 = r0.f8332b
            int r1 = r0.f8333l
            r2 = 1
            if (r1 == 0) goto L30
            if (r1 != r2) goto L29
            kotlin.jvm.internal.x r5 = r0.f8331a
        ...
        L3a:
            ...
            r8.<init>()
            r0.f8331a = r8     // Catch: o7.w1 -> L54
            r0.f8333l = r2     // Catch: o7.w1 -> L54
            o7.x1 r1 = new o7.x1     // Catch: o7.w1 -> L54
            r1.<init>(r5, r0)     // Catch: o7.w1 -> L54
            r8.f7025a = r1     // Catch: o7.w1 -> L54
    ...
    public static g0 e(a0 a0Var, d7.p pVar) {
        g0 g0Var = new g0(t(a0Var, t6.i.f10315a), true);
        g0Var.f0(b0.f8234a, g0Var, pVar);
        return g0Var;
    }
    ...
    public static final Object f(f0[] f0VarArr, v6.i iVar) {
        ...
        for (int i10 = 0; i10 < length; i10++) {
            c cVar2 = cVarArr[i10];
            cVar2.getClass();
            c.f8240q.set(cVar2, dVar);
        }
        if (l.f8279p.get(lVar) instanceof r1) {
            lVar.v(dVar);
        } else {
            dVar.b();
        }
    ...
    */
    ...
    public static void h(a0 a0Var) {
        e1 e1Var = (e1) a0Var.getCoroutineContext().get(x.f8328b);
        if (e1Var != null) {
            e1Var.c(null);
        } else {
    ...
    public static final Object j(long j6, t6.c cVar) {
        if (j6 > 0) {
            ...
            if (j6 < LocationRequestCompat.PASSIVE_INTERVAL) {
                n(lVar.f8282n).i(j6, lVar);
            }
            Object objR = lVar.r();
            if (objR == u6.a.f10763a) {
                return objR;
            }
        }
        return p6.x.f8464a;
    ...
    public static final w m(Executor executor) {
        ...
        return l0Var != null ? l0Var.f8283a : new y0(executor);
    }

    public static final h0 n(t6.h hVar) {
        t6.f fVar = hVar.get(t6.d.f10314a);
        h0 h0Var = fVar instanceof h0 ? (h0) fVar : null;
        return h0Var == null ? e0.f8258a : h0Var;
    }
    ...
    public static final l p(t6.c cVar) {
        ...
        if (lVar2 != null) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = l.f8279p;
            Object obj2 = atomicReferenceFieldUpdater2.get(lVar2);
            if (!(obj2 instanceof t) || ((t) obj2).f8311d == null) {
                l.f8278o.set(lVar2, 536870911);
                atomicReferenceFieldUpdater2.set(lVar2, b.f8233a);
                lVar = lVar2;
            } else {
                lVar2.m();
            }
    ...
    public static s1 s(a0 a0Var, t6.h hVar, b0 b0Var, d7.p pVar, int i6) {
        ...
        b0Var.getClass();
        s1 n1Var = b0Var == b0.f8235b ? new n1(hVarT, pVar) : new s1(hVarT, true);
    ...
    public static final t6.h t(a0 a0Var, t6.h hVar) {
        ...
        v7.e eVar = m0.f8289a;
        return (hVarL == eVar || hVarL.get(t6.d.f10314a) != null) ? hVarL : hVarL.plus(eVar);
    }

    public static final Object u(Object obj) {
        return obj instanceof u ? p6.a.b(((u) obj).f8316a) : obj;
    }

    public static final void v(l lVar, t6.c cVar, boolean z9) {
        Object obj = l.f8279p.get(lVar);
        ...
        cVar.getClass();
        t7.f fVar = (t7.f) cVar;
        t6.c cVar2 = fVar.f10328n;
        Object obj2 = fVar.f10330p;
        t6.h context = cVar2.getContext();
        Object objL = t7.a.l(context, obj2);
        a2 a2VarB = objL != t7.a.f10319d ? B(cVar2, context, objL) : null;
        try {
    ...
    public static final Object w(t6.h hVar, d7.p pVar) throws Throwable {
        ...
        fVar.f0(b0.f8234a, fVar, pVar);
        r0 r0Var = fVar.f8260n;
        if (r0Var != null) {
            int i6 = r0.f8302m;
            r0Var.A(false);
        }
        while (!Thread.interrupted()) {
            try {
                ...
                if (fVar.O()) {
                    ...
                    Object objA = A(m1.f8290a.get(fVar));
    ...
    public static final Object y(x1 x1Var, d7.p pVar) throws Throwable {
        Object uVar;
        Object objR;
        r(x1Var, true, new p0(n(x1Var.f10354m.getContext()).e(x1Var.f8329n, x1Var, x1Var.f8230l), 0));
        try {
        ...
        if (uVar == aVar || (objR = x1Var.R(uVar)) == f8248e) {
            return aVar;
        }
        if (objR instanceof u) {
            Throwable th2 = ((u) objR).f8316a;
            if (!(th2 instanceof w1) || ((w1) th2).f8326a != x1Var) {
                throw th2;
            }
