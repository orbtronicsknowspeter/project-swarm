...
public class m1 implements e1 {
    ...
    public static final /* synthetic */ AtomicReferenceFieldUpdater f8290a = AtomicReferenceFieldUpdater.newUpdater(m1.class, Object.class, "_state$volatile");

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final /* synthetic */ AtomicReferenceFieldUpdater f8291b = AtomicReferenceFieldUpdater.newUpdater(m1.class, Object.class, "_parentHandle$volatile");
    ...
    public static p T(t7.j jVar) {
        while (jVar.h()) {
            AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = t7.j.f10340b;
            t7.j jVarE = jVar.e();
            if (jVarE == null) {
    ...
    public static String a0(Object obj) {
        ...
        l1 l1Var = (l1) obj;
        return l1Var.e() ? "Cancelling" : l1.f8284b.get(l1Var) != 0 ? "Completing" : "Active";
    }
    ...
    public final void C(b1 b1Var, Object obj) {
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f8291b;
        ...
        Throwable th = uVar != null ? uVar.f8316a : null;
        ...
        if (o1VarC != null) {
            ...
            Object obj2 = t7.j.f10339a.get(o1VarC);
            obj2.getClass();
    ...
    public final Object E(l1 l1Var, Object obj) {
        ...
        if (thG != null && (z(thG) || K(thG))) {
            obj.getClass();
            u.f8315b.compareAndSet((u) obj, 0, 1);
        }
        V(obj);
        AtomicReferenceFieldUpdater atomicReferenceFieldUpdater = f8290a;
    ...
    public final o0 N(boolean z9, i1 i1Var) {
        ...
        i1Var.f8268m = this;
        loop0: while (true) {
            atomicReferenceFieldUpdater = f8290a;
        ...
        if (z9) {
            ...
            i1Var.k(uVar != null ? uVar.f8316a : null);
        }
        return q1Var;
    }

    public final boolean O() {
        return !(f8290a.get(this) instanceof b1);
    }
    ...
    public final Object R(Object obj) {
        ...
        do {
            ...
            if (objB0 == c0.f8247d) {
                ...
                u uVar = obj instanceof u ? (u) obj : null;
                throw new IllegalStateException(str, uVar != null ? uVar.f8316a : null);
            }
        } while (objB0 == c0.f);
        return objB0;
    }
    ...
    public final void U(o1 o1Var, Throwable th) {
        ...
        Object obj = t7.j.f10339a.get(o1Var);
        obj.getClass();
        a1.b bVar = null;
    ...
    public final Object b0(Object obj, Object obj2) {
        ...
        synchronized (l1Var) {
            AtomicIntegerFieldUpdater atomicIntegerFieldUpdater = l1.f8284b;
            if (atomicIntegerFieldUpdater.get(l1Var) != 0) {
                return c0.f8247d;
            }
            atomicIntegerFieldUpdater.set(l1Var, 1);
            if (l1Var != b1Var2) {
                AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2 = f8290a;
            ...
            p pVarT2 = T(o1VarJ);
            return (pVarT2 == null || !c0(l1Var, pVarT2, obj2)) ? E(l1Var, obj2) : c0.f8248e;
        }
    }
    ...
    public final boolean c0(l1 l1Var, p pVar, Object obj) {
        while (c0.r(pVar.f8296n, false, new k1(this, l1Var, pVar, obj)) == q1.f8301a) {
            pVar = T(pVar);
            if (pVar == null) {
                return false;
            }
        ...
        loop0: while (true) {
            ...
            if (obj instanceof q0) {
                ...
                if (!z9) {
                    Object obj2 = atomicReferenceFieldUpdater.get(this);
                    u uVar = obj2 instanceof u ? (u) obj2 : null;
                    pVar.k(uVar != null ? uVar.f8316a : null);
                    return q1Var;
                }
                o1 o1VarC = ((b1) obj).c();
                if (o1VarC == null) {
    ...
    public final String toString() {
        ...
        sb.append(S() + '{' + a0(f8290a.get(this)) + '}');
        sb.append('@');
        sb.append(c0.o(this));
        return sb.toString();
    }
    ...
    */
    ...
    public final boolean z(Throwable th) {
        ...
        o oVar = (o) f8291b.get(this);
        return (oVar == null || oVar == q1.f8301a) ? z9 : oVar.a(th) || z9;
    }
