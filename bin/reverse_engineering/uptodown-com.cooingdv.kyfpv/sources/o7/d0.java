...
public final class d0 extends w0 implements Runnable {
    ...
    public static final d0 f8251q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static final long f8252r;
    ...
    static {
        ...
        f8252r = TimeUnit.MILLISECONDS.toNanos(l10.longValue());
    }
    ...
    public final Thread G() {
        ...
        synchronized (this) {
            ...
            if (thread == null) {
                ...
                _thread = thread;
                thread.setContextClassLoader(f8251q.getClass().getClassLoader());
    ...
    public final synchronized void K() {
        ...
        if (i == 2 || i == 3) {
            debugStatus = 3;
            w0.f8323n.set(this, null);
            w0.f8324o.set(this, null);
            notifyAll();
        }
    }
