...
public abstract class u0 implements Runnable, Comparable, o0 {
        ...
        synchronized (this) {
            ...
            synchronized (v0Var) {
                try {
                    ...
                    if (w0.f8325p.get(w0Var) != 0) {
                        return 1;
                    }
                    if (u0Var == null) {
                        v0Var.f8321c = j;
                    } else {
                        long j6 = u0Var.f8317a;
                        if (j6 - j < 0) {
                            j = j6;
                        }
                        if (j - v0Var.f8321c > 0) {
    ...
    public final int compareTo(Object obj) {
        long j = this.f8317a - ((u0) obj).f8317a;
        if (j > 0) {
            return 1;
        }
        return j < 0 ? -1 : 0;
    ...
    public String toString() {
        return "Delayed[nanos=" + this.f8317a + ']';
    }
}
