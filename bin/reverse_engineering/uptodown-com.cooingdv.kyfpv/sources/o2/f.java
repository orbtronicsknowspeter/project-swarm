...
public final class f implements l2.e {
    ...
    public final HashMap f8140b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final HashMap f8141c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final l2.d f8142d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final h f8143e = new h(this);

    public f(ByteArrayOutputStream byteArrayOutputStream, HashMap map, HashMap map2, l2.d dVar) {
        this.f8139a = byteArrayOutputStream;
        this.f8140b = map;
        this.f8141c = map2;
        this.f8142d = dVar;
    }
    ...
    public static int k(l2.c cVar) {
        e eVar = (e) ((Annotation) cVar.f7091b.get(e.class));
        if (eVar != null) {
            return eVar.tag();
        }
    ...
    public final void b(l2.c cVar, double d10, boolean z9) throws IOException {
        ...
        l((k(cVar) << 3) | 1);
        this.f8139a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putDouble(d10).array());
    }
    ...
    public final void c(l2.c cVar, int i6, boolean z9) {
        ...
        if (iOrdinal == 0) {
            ...
            l((eVar.tag() << 3) | 5);
            this.f8139a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putInt(i6).array());
        }
    }
    ...
    public final void h(l2.c cVar, long j, boolean z9) throws IOException {
        ...
        if (iOrdinal == 0) {
            ...
            l((eVar.tag() << 3) | 1);
            this.f8139a.write(ByteBuffer.allocate(8).order(ByteOrder.LITTLE_ENDIAN).putLong(j).array());
        }
    }
    ...
    public final void i(l2.c cVar, Object obj, boolean z9) {
        ...
        if (obj instanceof Float) {
            ...
            l((k(cVar) << 3) | 5);
            this.f8139a.write(ByteBuffer.allocate(4).order(ByteOrder.LITTLE_ENDIAN).putFloat(fFloatValue).array());
            return;
        }
        ...
        l2.d dVar = (l2.d) this.f8140b.get(obj.getClass());
        if (dVar != null) {
            j(dVar, cVar, obj, z9);
            return;
        }
        l2.f fVar = (l2.f) this.f8141c.get(obj.getClass());
        if (fVar != null) {
            h hVar = this.f8143e;
            hVar.f8145a = false;
            hVar.f8147c = cVar;
    ...
    public final void j(l2.d dVar, l2.c cVar, Object obj, boolean z9) throws IOException {
        ...
        bVar.f8136a = 0L;
        try {
            OutputStream outputStream = this.f8139a;
            this.f8139a = bVar;
            try {
                dVar.a(obj, this);
