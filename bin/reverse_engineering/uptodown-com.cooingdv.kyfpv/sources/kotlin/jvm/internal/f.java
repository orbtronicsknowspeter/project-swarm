...
public final class f implements j7.c, e {
    ...
    public static final Map f7018b;
    ...
    public final String toString() {
        return this.f7019a + " (Kotlin reflection is not available)";
    }
}
