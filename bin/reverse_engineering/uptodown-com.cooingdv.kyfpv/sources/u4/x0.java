...
public final class x0 implements w4.a, w4.j {
    ...
    public final /* synthetic */ z0 f10658a;
        ...
        if (b4.d.t()) {
            ...
            if (((c4.k0) activity).T() && z0Var.getActivity() != null && (z0Var.getActivity() instanceof MainActivity)) {
                if (gVar.m()) {
                    ...
                    o7.c0.s(lifecycleScope, t7.n.f10349a, null, new d0(z0Var, gVar, null, 2), 2);
                } else {
    ...
    public void h(p2 p2Var) {
        ...
        if (b4.d.t()) {
            ...
            activity.getClass();
            if (((c4.k0) activity).T()) {
                if (kotlin.jvm.internal.l.a(p2Var.f11330a.f11226b, z0Var.getString(R.string.top_downloads_title))) {
                    p2Var.f11330a.f11226b = z0Var.b();
                }
                z0Var.k(p2Var);
            }
        }
