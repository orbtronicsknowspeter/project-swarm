...
public final class l1 extends v6.i implements d7.p {
    ...
    public final /* synthetic */ int f10526a = 1;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final /* synthetic */ ArrayList f10527b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final /* synthetic */ m1 f10528l;
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f10526a) {
            case 0:
                return new l1(this.f10528l, this.f10527b, cVar);
            default:
                return new l1(this.f10527b, this.f10528l, cVar);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.f10526a) {
            case 0:
                ...
                if (arrayList2 != null) {
                    ...
                    while (it.hasNext()) {
                        Object next = it.next();
                        next.getClass();
                        x4.j jVar = ((p2) next).f11330a;
                        if (jVar.f11228m) {
                            arrayList.add(new Integer(jVar.f11225a));
                        }
                    }
                }
                if (arrayList.isEmpty()) {
                    ...
                    g2VarK.f11207d = vVar.i(g2VarK, "/eapi/floating-category/additional/apps");
            ...
            default:
                p6.a.e(obj);
                ArrayList arrayList5 = this.f10527b;
                int size = arrayList5.size();
                m1 m1Var2 = this.f10528l;
                if (size < 4) {
                    m1Var2.f10547s = false;
                }
