...
public final class d2 extends ViewModel {
    ...
    public final r7.o0 f10459a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final r7.o0 f10460b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final r7.o0 f10461c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final r7.o0 f10462d;
    ...
    public d2() {
        ...
        this.f10461c = o0VarB2;
        this.f10462d = o0VarB2;
    }
    ...
    public static final p2 a(d2 d2Var, Context context, x4.j jVar) {
        ...
        if (i > 0) {
            if (jVar.f11228m) {
                ...
                int i10 = jVar.f11230o;
                if ((i10 == 0 || i10 == 831) && !jVar.f11229n) {
                    p2Var.f11331b = j5.v.E(vVar.t(i, 40, d2Var.h));
                } else {
                    p2Var = a.a.J(vVar.v(i, 40, d2Var.h), jVar);
                }
            }
        } else if (i == -1) {
            p2Var.f11331b = j5.v.E(vVar.s(40, d2Var.h));
        } else if (i == -2) {
            int i11 = jVar.f11230o;
            int i12 = d2Var.h;
            p2Var.f11331b = j5.v.E(i11 > 0 ? vVar.p(i11, 40, i12) : vVar.m(40, i12));
        } else if (i == -3) {
            int i13 = d2Var.h;
            ...
            g2VarK2.f11207d = vVar.i(g2VarK2, "/eapi/apps/latest-updates");
            p2Var.f11331b = j5.v.E(g2VarK2);
        }
        d2Var.h = p2Var.f11331b.size() + d2Var.h;
        return p2Var;
    }

    public final String b() {
        r7.o0 o0Var = this.f10459a;
        if (!(o0Var.getValue() instanceof j5.r)) {
            return null;
        }
        Object value = o0Var.getValue();
        value.getClass();
        return ((a2) ((j5.r) value).f6708a).f10424a.f11330a.f11228m ? "floatingCategory" : "leafCategory";
    }

    public final void c(Context context, int i) {
        o7.a0 viewModelScope = ViewModelKt.getViewModelScope(this);
        v7.e eVar = o7.m0.f8289a;
        o7.c0.s(viewModelScope, v7.d.f10885a, null, new b2(context, this, i, null), 2);
    }
    ...
    public final void d(Context context, x4.g gVar, String str) {
        ...
        if (gVar.m()) {
            o7.a0 viewModelScope = ViewModelKt.getViewModelScope(this);
            v7.e eVar = o7.m0.f8289a;
            o7.c0.s(viewModelScope, v7.d.f10885a, null, new c4.w(this, context, gVar, str, (t6.c) null), 2);
        }
    }
}
