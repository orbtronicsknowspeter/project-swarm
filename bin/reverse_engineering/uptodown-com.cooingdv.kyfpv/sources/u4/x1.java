...
public final class x1 extends v6.i implements d7.p {
    ...
    public final /* synthetic */ z1 f10660b;
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f10659a) {
            case 0:
                return new x1(this.f10660b, cVar, 0);
            default:
                return new x1(this.f10660b, cVar, 1);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) {
        int i = this.f10659a;
        p6.x xVar = p6.x.f8464a;
        z1 z1Var = this.f10660b;
        switch (i) {
            case 0:
                p6.a.e(obj);
                FragmentActivity activity = z1Var.getActivity();
                activity.getClass();
                String string = z1Var.getString(R.string.error_generico);
                string.getClass();
