...
public final class x implements w4.f, a4.i, w4.a {
    ...
    public final /* synthetic */ f0 f10657b;
    ...
    public void onSuccess() {
        ...
        bVar.getClass();
        ((FullWidthImageView) bVar.R.f7782l).setVisibility(0);
        if (!((Boolean) f0Var.G().P.getValue()).booleanValue()) {
            t4.b bVar2 = f0Var.f10474b;
            bVar2.getClass();
            bVar2.f9614m.setTitle(f0Var.B().f11160b);
            t4.b bVar3 = f0Var.f10474b;
            bVar3.getClass();
            bVar3.f9601b.setExpanded(false, false);
        }
