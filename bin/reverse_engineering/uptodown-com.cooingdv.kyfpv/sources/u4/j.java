...
public final /* synthetic */ class j implements View.OnClickListener {
    ...
    public final /* synthetic */ f0 f10509b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final /* synthetic */ k2 f10510l;
    ...
    public final void onClick(View view) {
        int i = this.f10508a;
        k2 k2Var = this.f10510l;
        f0 f0Var = this.f10509b;
        switch (i) {
            case 0:
                f0Var.U(k2Var);
                break;
            ...
            case 2:
                ...
                if (((c4.k0) activity).T()) {
                    ...
                    if (u2.h(contextRequireContext) != null) {
                        ...
                        activity2.getClass();
                        String string = f0Var.getString(R.string.login_required_follow_title);
                        string.getClass();
                        String string2 = f0Var.getString(R.string.login_required_follow_msg);
                        string2.getClass();
            ...
            case 6:
                ...
                if (((c4.k0) activity3).T()) {
                    ...
                    if (u2.h(contextRequireContext3) != null) {
                        ...
                        int i10 = k2Var.f11272x;
                        String str2 = k2Var.f11260b;
                        str2.getClass();
                        v0VarG2.a(contextRequireContext4, i10, str2);
                    } else if (f0Var.getActivity() != null) {
                        FragmentActivity activity4 = f0Var.getActivity();
                        activity4.getClass();
                        String string3 = f0Var.getString(R.string.login_required_follow_title);
                        string3.getClass();
                        String string4 = f0Var.getString(R.string.login_required_follow_msg);
                        string4.getClass();
