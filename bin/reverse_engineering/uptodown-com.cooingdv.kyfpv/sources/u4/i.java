...
public final /* synthetic */ class i implements ActivityResultCallback, Toolbar.OnMenuItemClickListener, NestedScrollView.OnScrollChangeListener {
    ...
    public final /* synthetic */ f0 f10504b;
    ...
    public void onActivityResult(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                o7.c0.s(lifecycleScope, v7.d.f10885a, null, new d0(f0Var, aVar, null, i6), 2);
                break;
            default:
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        ...
        if (b4.d.t()) {
            ...
            if (itemId == R.id.action_search) {
                ...
                } else if (menuItem.getItemId() == R.id.action_open_web) {
                    if (f0Var.getActivity() != null && !f0Var.requireActivity().isFinishing() && (str = f0Var.B().f11175n) != null && str.length() != 0) {
                        ...
                        if (((c4.k0) activity3).T()) {
                            ...
                            String str2 = f0Var.B().f11175n;
                            str2.getClass();
                            j5.c.e((c4.k0) fragmentActivityRequireActivity2, str2, f0Var.B().f11160b);
                            return true;
                        }
                    }
                } else {
                        ...
                        if (menuItem.getItemId() == R.id.action_exclude) {
                            ...
                            if (str5 != null && str5.length() != 0 && f0Var.getContext() != null) {
                                ...
                                if (eVarB != null) {
                                    if (eVarB.v == 0) {
                                        eVarB.v = 1;
                                        x4.d dVar = eVarB.f11128p;
                                        x4.d dVar2 = x4.d.f11089b;
                                        if (dVar != dVar2) {
                                            eVarB.f11128p = dVar2;
                                            String str7 = eVarB.f11124l;
                                            str7.getClass();
                                            gVarL.s(str7);
                                            Context contextRequireContext2 = f0Var.requireContext();
                                            contextRequireContext2.getClass();
                            ...
                            if (f0Var.G().f10643z.getValue() instanceof j5.r) {
                                Object value = f0Var.G().f10643z.getValue();
                                value.getClass();
                                f0Var.o0((ArrayList) ((j5.r) value).f6708a);
                                return true;
                            }
                        }
                    }
    ...
    public void onScrollChange(NestedScrollView nestedScrollView, int i, int i6, int i10, int i11) {
        ...
        if (arrayList == null || arrayList.isEmpty()) {
            ...
            if (strE == null || strE.length() == 0) {
                ...
                bVar4.getClass();
                bVar4.f9614m.setTitleEnabled(false);
                zBooleanValue = true;
            } else {
        ...
        if (zBooleanValue2 && zBooleanValue) {
            if (f0Var.getResources().getConfiguration().getLayoutDirection() == 1) {
                ...
                if (i12 > 0) {
                    ...
                    bVar5.getClass();
                    bVar5.f9614m.setRtlTextDirectionHeuristicsEnabled(false);
                    t4.b bVar6 = f0Var.f10474b;
                    bVar6.getClass();
                    bVar6.f9614m.setLayoutDirection(0);
                }
            }
            t4.b bVar7 = f0Var.f10474b;
            bVar7.getClass();
            CollapsingToolbarLayout collapsingToolbarLayout = bVar7.f9614m;
            String str4 = f0Var.B().f11160b;
            str4.getClass();
