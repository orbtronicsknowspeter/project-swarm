...
public final class o1 implements w4.a, w4.e, w4.d {
    ...
    public final /* synthetic */ z1 f10565a;
    ...
    public void b(x4.g gVar) {
        ...
        if (b4.d.t()) {
            ...
            int i = 2;
            t6.c cVar = null;
            if (z1Var.f10684m.f11225a != 1090) {
                LifecycleCoroutineScope lifecycleScope = LifecycleOwnerKt.getLifecycleScope(z1Var);
                v7.e eVar = o7.m0.f8289a;
                o7.c0.s(lifecycleScope, t7.n.f10349a, null, new v1(z1Var, gVar, cVar, i), 2);
                ...
                if (u2.h(contextRequireContext) != null) {
                    ...
                    o7.c0.s(lifecycleScope2, v7.d.f10885a, null, new v1(z1Var, gVar, cVar, 1), 2);
                } else {
