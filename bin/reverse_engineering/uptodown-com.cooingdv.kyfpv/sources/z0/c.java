...
public final class c extends e {
    ...
    public final transient e f11894l;
    ...
    public final boolean contains(Object obj) {
        return this.f11894l.contains(obj);
    }
    ...
    public final int indexOf(Object obj) {
        int iLastIndexOf = this.f11894l.lastIndexOf(obj);
        if (iLastIndexOf >= 0) {
    ...
    public final int lastIndexOf(Object obj) {
        int iIndexOf = this.f11894l.indexOf(obj);
        if (iIndexOf >= 0) {
