...
public final class h {
    ...
    public final String g() {
        l8.i iVar = this.f678p.f7240n;
        return t1.m(iVar.f7213t.f7231c + iVar.f7203e + iVar.f7208o + iVar.f7209p + iVar.f7207n + iVar.f7205l + iVar.f7206m);
    }

    public final int h() {
        l9.a aVar = this.f668a;
        aVar.getClass();
        int i = aVar.f7263a.getInt("IABTCF_PolicyVersion", 0);
        if (i != 0) {
            return i;
        }
        aVar.getClass();
        return aVar.f7263a.getInt("IABGPP_TCFEU2_PolicyVersion", 0);
    }

    public final int i() {
        h8.c cVar = this.f669b.f10738a;
        Integer num = cVar == null ? null : cVar.f5461b;
        if (num != null) {
            return num.intValue();
        }
        l9.a aVar = this.f668a;
        aVar.getClass();
        return aVar.f7263a.getInt("gvl_version", 0);
    }

    public final boolean j() {
        n6.a aVar = this.f675m;
        return u.m0(aVar == null ? null : aVar.f8106a, "USA", true);
    }
    ...
    public final boolean k() {
        ...
        return (System.currentTimeMillis() - sharedPreferences.getLong("gvl_last_updated", 0L)) / 86400000 < ((long) this.f678p.f7240n.f) || i() <= sharedPreferences.getInt("gvl_version", 0);
    }
        ...
        if (zG) {
            ...
            if (strJ != null) {
                ...
                while (i21 < size) {
                    ...
                    int iIntValue11 = (jVar == jVar2 || (num = (Integer) w5.c.f10918c.get("segmentType")) == null) ? z9 ? 1 : 0 : num.intValue();
                    ...
                    if (strArr2 != null) {
                        ...
                        while (i23 < length) {
                            ...
                            int i24 = i23 + 1;
                            Object obj3 = y5.a.f11807a;
                            str6.getClass();
                            Integer numValueOf = (Integer) w5.c.f10918c.get(str6);
                            if (numValueOf == null) {
                                list = listG0;
                                if (l7.m.y0(str6, "publisherCustom", r62, r62, 6) == 0) {
                                    numValueOf = Integer.valueOf(mVar2.f10748p);
                                }
                            } else {
                                list = listG0;
                            }
                            if ((numValueOf != null && numValueOf.intValue() == 0) || numValueOf == null) {
                                ...
                                if (str6.equals("version")) {
                                    ...
                                    if (str6.equals("created")) {
                                        strArr = strArr2;
                                        mVar2.f10739b = t0.f.a(numValueOf.intValue(), strSubstring);
                                    } else {
                                        strArr = strArr2;
                                        if (str6.equals("lastUpdated")) {
                                            mVar2.f10740c = t0.f.a(numValueOf.intValue(), strSubstring);
                                            ...
                                            mVar2.f10744l = z3.a(numValueOf.intValue(), strSubstring);
                                            ...
                                            if (str6.equals("isServiceSpecific")) {
                                                mVar2.f10742e = strSubstring.equals("1");
                                            } else if (str6.equals("useNonStandardStacks")) {
                                                mVar2.f = strSubstring.equals("1");
                                            } else if (str6.equals("specialFeatureOptions")) {
                                                mVar2.f10749q = a.a.b(numValueOf.intValue(), strSubstring);
                                            } else if (str6.equals("purposeConsents")) {
                                                mVar2.f10750r = a.a.b(numValueOf.intValue(), strSubstring);
                                            } else if (str6.equals("purposeLegitimateInterests")) {
                                                mVar2.f10751s = a.a.b(numValueOf.intValue(), strSubstring);
                                                ...
                                                if (str6.equals("publisherRestrictions")) {
                                                    ...
                                                    Object obj9 = w5.c.f10916a;
                                                    ?? r42 = w5.c.f10917b;
                                                    w5.d dVar2 = w5.d.f10924o;
                                                    ...
                                                    while (i25 < iB6) {
                                                        int i26 = i25 + 1;
                                                        Object obj10 = w5.c.f10916a;
                                                        ?? r14 = w5.c.f10917b;
                                                        int i27 = iB6;
                                                        w5.d dVar3 = w5.d.f10925p;
                                                        ...
                                                        if (iB9 >= 0) {
                                                            ...
                                                            while (true) {
                                                                int i29 = i28 + 1;
                                                                Object obj11 = w5.c.f10916a;
                                                                int i30 = i22;
                                                                ?? r11 = w5.c.f10917b;
                                                                int i31 = length;
                                                                w5.d dVar6 = w5.d.f10919a;
                                                    ...
                                                    if (str6.equals("publisherConsents")) {
                                                        ...
                                                        mVar2.f10754w = a.a.b(numValueOf.intValue(), strSubstring);
                                                    } else if (str6.equals("numCustomPurposes")) {
                                                        mVar2.f10748p = t1.b(numValueOf.intValue(), strSubstring);
                                                    } else if (str6.equals("publisherCustomConsents")) {
                                                        mVar2.f10755x = a.a.b(numValueOf.intValue(), strSubstring);
                                                    } else if (str6.equals("publisherCustomLegitimateInterests")) {
                                                        mVar2.f10756y = a.a.b(numValueOf.intValue(), strSubstring);
                ...
                mVar.f10750r.set(mVar2.f10750r);
                Vector vector8 = mVar.f10751s;
                vector8.unsetAllOwnedItems();
                vector8.set(mVar2.f10751s);
                mVar.f10749q.set(mVar2.f10749q);
                Vector vector9 = mVar.f10757z;
                vector9.unsetAllOwnedItems();
                vector9.setOwnedItems(mVar2.f10757z);
                ...
                Vector vector12 = mVar.f10754w;
                vector12.unsetAllOwnedItems();
                vector12.set(mVar2.f10754w);
            }
        }
        if (m9.c.c().g() || aVar.j(8).length() > 0) {
            String str8 = this.f678p.f7240n.f7199a;
            j9.h hVar2 = this.i;
            if (str8 != null) {
            ...
            String str9 = this.f678p.f7240n.f7199a;
            if (str9 != null) {
    ...
    public final void m() {
        ...
        l9.a aVar = this.f668a;
        aVar.c(43, i);
        aVar.c(44, mVar.f10746n);
        aVar.c(45, mVar.d());
        aVar.c(46, this.f678p.f7232a.contains(Regulations.GDPR) ? 1 : 0);
        aVar.f(47, this.f678p.f7235d);
    ...
    public final void n() {
        ...
        l9.a aVar = this.f668a;
        aVar.c(1, i);
        aVar.c(2, mVar.f10746n);
        aVar.c(3, mVar.d());
        if (this.f676n <= 0) {
            this.f676n = mVar.d();
        }
        aVar.c(4, this.f678p.f7232a.contains(Regulations.GDPR) ? 1 : 0);
        aVar.f(5, this.f678p.f7235d);
        aVar.c(6, mVar.g ? 1 : 0);
        aVar.c(7, mVar.f ? 1 : 0);
    }

    public final boolean o() {
        long j = this.f678p.f7239m;
        l9.a aVar = this.f668a;
        aVar.getClass();
        long j6 = aVar.f7263a.getLong("LastVisitTime", 0L);
