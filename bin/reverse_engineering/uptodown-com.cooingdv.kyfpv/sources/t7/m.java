...
public final class m {
    ...
    public static final /* synthetic */ AtomicReferenceFieldUpdater f10344e = AtomicReferenceFieldUpdater.newUpdater(m.class, Object.class, "_next$volatile");
    ...
    public final /* synthetic */ AtomicReferenceArray f10348d;
    ...
    public m(int i, boolean z9) {
        ...
        int i6 = i - 1;
        this.f10347c = i6;
        this.f10348d = new AtomicReferenceArray(i);
        if (i6 > 1073741823) {
    ...
    public final int a(Object obj) {
        while (true) {
            ...
            boolean z9 = this.f10346b;
            AtomicReferenceArray atomicReferenceArray = this.f10348d;
            if (z9 || atomicReferenceArray.get(i6 & i10) == null) {
                if (f.compareAndSet(this, j, ((-1152921503533105153L) & j) | (((long) ((i6 + 1) & 1073741823)) << 30))) {
                    ...
                    while ((atomicLongFieldUpdater.get(mVarC) & 1152921504606846976L) != 0) {
                        mVarC = mVarC.c();
                        AtomicReferenceArray atomicReferenceArray2 = mVarC.f10348d;
                        int i11 = mVarC.f10347c & i6;
                        Object obj2 = atomicReferenceArray2.get(i11);
                        if ((obj2 instanceof l) && ((l) obj2).f10343a == i6) {
    ...
    public final m c() {
        ...
        while (true) {
            ...
            m mVar3 = new m(mVar.f10345a * 2, mVar.f10346b);
            int i = (int) (1073741823 & j);
            int i6 = (int) ((1152921503533105152L & j) >> 30);
            while (true) {
                ...
                Object lVar = mVar.f10348d.get(i11);
                if (lVar == null) {
                    lVar = new l(i);
                }
                mVar3.f10348d.set(mVar3.f10347c & i, lVar);
                i++;
            }
    ...
    */
    public final java.lang.Object d() {
        ...
        L15:
            ...
            goto L41
        L2e:
            java.util.concurrent.atomic.AtomicReferenceArray r15 = r1.f10348d
            java.lang.Object r4 = r15.get(r13)
            boolean r5 = r1.f10346b
            if (r4 != 0) goto L3b
            if (r5 == 0) goto L2
            goto L41
        L3b:
        ...
        L7d:
            ...
            r2 = r23
            if (r1 == 0) goto L99
            java.util.concurrent.atomic.AtomicReferenceArray r1 = r2.f10348d
            int r2 = r2.f10347c
            r0 = r0 & r2
            r1.set(r0, r14)
            r1 = r14
