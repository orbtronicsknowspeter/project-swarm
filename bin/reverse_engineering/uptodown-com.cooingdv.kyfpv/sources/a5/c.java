...
public abstract class c {
    ...
    public static r a() {
        ...
        if (a1Var instanceof w0) {
            return ((w0) a1Var).f11428a;
        }
        if (a1Var instanceof y0) {
            return ((y0) a1Var).f11467a;
        }
        return null;
    }
    ...
    public static boolean b(long j) {
        ...
        value.getClass();
        r rVar = ((w0) value).f11428a;
        return rVar != null && rVar.f11362q == j;
    }
