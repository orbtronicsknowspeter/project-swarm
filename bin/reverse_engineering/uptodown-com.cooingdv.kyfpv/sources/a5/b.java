...
public abstract class b {
    ...
    public static r b() {
        ...
        if (i0Var instanceof f0) {
            return ((f0) i0Var).f11151a;
        }
        if (i0Var instanceof h0) {
            return ((h0) i0Var).f11210a;
        }
        return null;
    }
    ...
    public static boolean c(long j) {
        ...
        value.getClass();
        return ((f0) value).f11151a.f11362q == j;
    }
    ...
    public static boolean e(long j) {
        ...
        Object value = o0Var.getValue();
        value.getClass();
        return ((h0) value).f11210a.f11362q == j;
    }
