...
public abstract class t {
    ...
    public static final ConcurrentHashMap f6709a = new ConcurrentHashMap();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final ArrayList f6710b = new ArrayList();

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final ArrayList f6711c = new ArrayList();
    ...
    public static Drawable b(Context context, String str) {
        ...
        context.getClass();
        if (str != null) {
            ConcurrentHashMap concurrentHashMap = f6709a;
