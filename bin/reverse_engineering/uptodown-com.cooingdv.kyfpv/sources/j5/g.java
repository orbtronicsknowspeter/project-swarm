...
public final class g extends SQLiteOpenHelper {
    ...
    public g(Context context) {
        ...
        this.f6675b = new String[]{"id", "name", "packagename", "versionCode", "issystemapp", "isSystemService", "urlFicha", "md5signature", "exclude", "size", "excludeFromTracking", "defaultName", "sha256", "positiveNotified", "appID", "hasOldVersions", "trackInfoRegistered"};
        this.f6676l = new String[]{"id", "app_id", "sha256", "size", "path"};
        this.f6677m = new String[]{"id", "packagename", "versionCode", "versionName", "notified", "ignoreVersion", "isPartialUpdate", "newFeatures", "installationAttempts"};
        this.f6678n = new String[]{"id", "packagename", "checked", "incomplete", "versioncode", "versionname", "attempts", "idPrograma", "downloadAnyway", "md5signature", "supportedAbis", "minsdk", "urlIcon", "appName", "nextAttemptTimeStamp", "updateId", "deeplink", "is_rollback"};
        this.f6679o = new String[]{"id", "downloadId", "fileId", ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, "size", "size_downloaded", "filehash", "absolutePath", "attempts", "nextAttemptTimeStamp"};
        this.f6680p = new String[]{"id", "appId", "categoryFrom", "promotedIndex"};
        this.f6681q = new String[]{"search", "timestamp"};
        this.f6682r = new String[]{"id", "path"};
        this.f6683s = new String[]{"id", "timestamp", "title", NotificationCompat.CATEGORY_MESSAGE, "actions", "extra_info"};
        this.f6684t = new String[]{"appId", "automaticDownload"};
        this.f6685u = new String[]{"appId"};
        this.v = new String[]{"path", "date"};
        this.f6686w = new String[]{"id", "notificationId", "packagename", "versioncode", ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY};
        this.f6687x = new String[]{"id", ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY, "json", "timestamp"};
        this.f6688y = new String[]{"id", "json", "timestamp"};
        this.f6689z = new String[]{"id", "json", "timestamp"};
    ...
    public static x4.e g0(Cursor cursor) {
        x4.e eVar = new x4.e();
        eVar.f11122a = cursor.getLong(0);
        eVar.f11123b = cursor.getString(1);
        eVar.f11124l = cursor.getString(2);
        String string = cursor.getString(3);
        string.getClass();
        eVar.f11125m = Long.parseLong(string);
        eVar.f11129q = cursor.getInt(4);
        eVar.f11130r = cursor.getInt(5);
        eVar.f11127o = cursor.getString(6);
        eVar.f11133u = cursor.getString(7);
        eVar.v = cursor.getInt(8);
        String string2 = cursor.getString(9);
        string2.getClass();
        eVar.f11134w = Long.parseLong(string2);
        eVar.f11136y = cursor.getInt(10);
        eVar.f11137z = cursor.getString(11);
    ...
    public static e1 h0(Cursor cursor) {
        ...
        cursor.getInt(1);
        e1 e1Var = new e1();
        e1Var.f11139a = cursor.getString(2);
        String string = cursor.getString(3);
        string.getClass();
        e1Var.f11140b = Long.parseLong(string);
        e1Var.f11141c = cursor.getString(4);
        return e1Var;
    }

    public static x4.r i0(Cursor cursor) {
        x4.r rVar = new x4.r();
        rVar.f11355a = cursor.getInt(0);
        rVar.f11356b = cursor.getString(1);
        rVar.f11357l = cursor.getInt(2);
        rVar.f11358m = cursor.getInt(3);
        rVar.f11359n = cursor.getLong(4);
        rVar.f11360o = cursor.getString(5);
        rVar.f11361p = cursor.getInt(6);
        rVar.f11362q = cursor.getLong(7);
        rVar.f11363r = cursor.getInt(8);
        rVar.f11364s = cursor.getString(9);
        rVar.f11365t = cursor.getString(10);
        rVar.f11366u = cursor.getInt(11);
        rVar.v = cursor.getString(12);
        rVar.f11367w = cursor.getString(13);
        rVar.f11368x = cursor.getLong(14);
        rVar.f11370z = cursor.getLong(15);
    ...
    public static j0 j0(Cursor cursor) {
        j0 j0Var = new j0();
        j0Var.f11234a = cursor.getLong(0);
        j0Var.f11235b = cursor.getLong(1);
        j0Var.f11236l = cursor.getLong(2);
        j0Var.f11237m = cursor.getString(3);
        j0Var.f11238n = cursor.getLong(4);
        j0Var.f11239o = cursor.getLong(5);
        j0Var.f11240p = cursor.getString(6);
        j0Var.f11241q = cursor.getString(7);
        j0Var.f11242r = cursor.getInt(8);
        j0Var.f11243s = cursor.getLong(9);
        return j0Var;
    }

    public static b1 k0(Cursor cursor) {
        b1 b1Var = new b1();
        b1Var.f11058a = cursor.getLong(0);
        b1Var.f11059b = cursor.getString(1);
        cursor.getLong(2);
        return b1Var;
    }
    ...
    public static q2 l0(Cursor cursor) {
        ...
        string2.getClass();
        q2Var.f11346l = Long.parseLong(string2);
        q2Var.f11347m = cursor.getString(3);
        q2Var.f11348n = cursor.getInt(4);
        q2Var.f11349o = cursor.getInt(5);
        q2Var.f11350p = cursor.getInt(6);
        q2Var.f11351q = cursor.getString(7);
        q2Var.f11352r = cursor.getInt(8);
        return q2Var;
    }
    ...
    public final x4.b A(int i) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("active_notifications", this.f6686w, "id=?", strArr, null, null, null);
        } catch (Exception e10) {
            e = e10;
            cursorQuery = null;
        }
    ...
    public final x4.e B(String str) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("apps", this.f6675b, "packagename=?", new String[]{str}, null, null, null);
        } catch (Exception e10) {
            e = e10;
            cursorQuery = null;
        }
    ...
    public final ArrayList C(long j) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("app_files", this.f6676l, "app_id=?", strArr, null, null, null);
    ...
    public final ArrayList E() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("apps", this.f6675b, null, null, null, null, null);
            if (cursorQuery.moveToFirst()) {
    ...
    public final ArrayList F() {
        ...
        try {
            ...
            if (cursorQuery.moveToFirst()) {
                x4.k kVar = new x4.k();
                kVar.f11248a = cursorQuery.getString(0);
                kVar.f11249b = cursorQuery.getString(1);
                arrayList.add(kVar);
            }
            while (cursorQuery.moveToNext()) {
                x4.k kVar2 = new x4.k();
                kVar2.f11248a = cursorQuery.getString(0);
                kVar2.f11249b = cursorQuery.getString(1);
                arrayList.add(kVar2);
            }
            cursorQuery.close();
            return arrayList;
    ...
    public final x4.r I(String str) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("download_files", this.f6679o, "fileId=?", new String[]{str}, null, null, null);
            try {
        ...
        if ((j0VarJ0 != null ? Long.valueOf(j0VarJ0.f11235b) : null) == null) {
            return null;
        }
        try {
            SQLiteDatabase sQLiteDatabase2 = this.f6674a;
            sQLiteDatabase2.getClass();
            cursorQuery2 = sQLiteDatabase2.query("downloads", this.f6678n, "id=?", new String[]{String.valueOf(j0VarJ0.f11235b)}, null, null, null);
        } catch (Exception e13) {
            e = e13;
            cursorQuery2 = null;
        }
    ...
    public final x4.r J(int i) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("downloads", this.f6678n, "id=?", strArr, null, null, null);
        } catch (Exception e10) {
            e = e10;
            cursorQuery = null;
        }
        try {
            ...
            cursorQuery.close();
            if (rVarI0 != null && (i6 = rVarI0.f11355a) >= 0) {
                rVarI0.F = N(i6);
            }
            return rVarI0;
        } catch (Exception e11) {
    ...
    public final x4.r K(String str) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("downloads", this.f6678n, "packagename=?", new String[]{str}, null, null, "versioncode DESC");
        } catch (Exception e10) {
            e = e10;
            cursorQuery = null;
        }
    ...
    public final x4.r L(long j, String str) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("downloads", this.f6678n, "packagename=? AND versioncode=?", new String[]{str, String.valueOf(j)}, null, null, null);
        } catch (Exception e10) {
            exc = e10;
            cursorQuery = null;
        }
    ...
    public final x4.r M(long j) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("downloads", this.f6678n, "updateId=?", strArr, null, null, null);
        } catch (Exception e10) {
            exc = e10;
            cursorQuery = null;
        }
    ...
    public final ArrayList N(int i) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("download_files", this.f6679o, "downloadId=?", new String[]{String.valueOf(i)}, null, null, null);
            if (cursorQuery.moveToFirst()) {
    ...
    public final k0 O(long j) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("download_promoted", this.f6680p, "appId=?", strArr, null, null, null);
            try {
                if (cursorQuery.moveToFirst()) {
                    k0Var = new k0();
                    k0Var.f11253a = -1;
                    k0Var.f11256m = 1;
                    k0Var.f11253a = cursorQuery.getInt(0);
                    k0Var.f11254b = cursorQuery.getLong(1);
                    k0Var.f11255l = cursorQuery.getString(2);
                    k0Var.f11256m = cursorQuery.getInt(3);
                } else {
                    k0Var = null;
                }
                cursorQuery.close();
    ...
    public final ArrayList P() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("downloads", this.f6678n, null, null, null, null, null);
            if (cursorQuery.moveToFirst()) {
                x4.r rVarI0 = i0(cursorQuery);
                int i = rVarI0.f11355a;
                if (i >= 0) {
                    rVarI0.F = N(i);
                }
    ...
    public final ArrayList Q() {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("events", this.f6688y, null, null, null, null, null, strValueOf);
            if (cursorQuery.moveToFirst()) {
    ...
    public final ArrayList R() {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("errors", this.f6689z, null, null, null, null, null, strValueOf);
            if (cursorQuery.moveToFirst()) {
                arrayList.add(k0(cursorQuery));
                while (cursorQuery.moveToNext()) {
                    arrayList.add(k0(cursorQuery));
    ...
    public final ArrayList S() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("installable_files", this.f6682r, null, null, null, null, null);
            if (cursorQuery.moveToFirst()) {
    ...
    public final x1 U(long j) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("preregistrations", this.f6684t, "appId=?", strArr, null, null, null);
        } catch (Exception e10) {
            exc = e10;
            cursorQuery = null;
        }
        try {
            if (cursorQuery.moveToFirst()) {
                x1Var = new x1();
                x1Var.f11449a = cursorQuery.getLong(0);
                x1Var.f11453e = cursorQuery.getInt(1);
            } else {
                x1Var = null;
            }
            cursorQuery.close();
    ...
    public final ArrayList V() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("recent_searches", this.f6681q, null, null, null, null, null);
            if (cursorQuery.moveToFirst()) {
                z1 z1Var = new z1();
                z1Var.f11480a = cursorQuery.getString(0);
                z1Var.f11481b = cursorQuery.getString(1);
                arrayList.add(z1Var);
            }
            while (cursorQuery.moveToNext()) {
                z1 z1Var2 = new z1();
                z1Var2.f11480a = cursorQuery.getString(0);
                z1Var2.f11481b = cursorQuery.getString(1);
    ...
    public final h2 X(String str) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("responses", this.f6687x, "type=?", new String[]{str}, null, null, null);
        } catch (Exception e10) {
            e = e10;
            h2Var = null;
        }
        try {
            if (cursorQuery.moveToFirst()) {
                ...
                string3.getClass();
                h2Var3.f11214c = Long.parseLong(string3);
                h2Var2 = h2Var3;
            }
            cursorQuery.close();
            return h2Var2;
    ...
    public final q2 Y(String str) {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("updates", this.f6677m, "packagename=?", new String[]{str}, null, null, null);
        } catch (Exception e10) {
            e = e10;
            cursorQuery = null;
        }
        try {
            if (cursorQuery.moveToFirst()) {
                ...
                x4.r rVarM = M(q2VarL0.f11344a);
                q2VarL0.f11353s = rVarM;
                q2VarL0.f11354t = Z(rVarM);
            } else {
                q2VarL0 = null;
            }
            cursorQuery.close();
    ...
    public final ArrayList a0() {
        ...
        try {
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("updates", this.f6677m, null, null, null, null, null);
            if (cursorQuery.moveToFirst()) {
            ...
            while (cursorQuery.moveToNext()) {
                ...
                x4.r rVarM2 = M(q2VarL02.f11344a);
                q2VarL02.f11353s = rVarM2;
                q2VarL02.f11354t = Z(rVarM2);
            }
            cursorQuery.close();
            return arrayList;
        } catch (Exception e10) {
    ...
    public final synchronized void b() {
        if (this.C.incrementAndGet() == 1) {
            g gVar = E;
            gVar.getClass();
            gVar.f6674a = gVar.getWritableDatabase();
        }
    }
    ...
    public final void b0(x4.r rVar) {
        ...
        contentValues.put("packagename", rVar.f11356b);
        contentValues.put("checked", Integer.valueOf(rVar.f11357l));
        contentValues.put("incomplete", Integer.valueOf(rVar.f11358m));
        contentValues.put("versioncode", Long.valueOf(rVar.f11359n));
        contentValues.put("versionname", rVar.f11360o);
        contentValues.put("attempts", Integer.valueOf(rVar.f11361p));
        contentValues.put("idPrograma", Long.valueOf(rVar.f11362q));
        contentValues.put("downloadAnyway", Integer.valueOf(rVar.f11363r));
        contentValues.put("md5signature", rVar.f11364s);
        contentValues.put("supportedAbis", rVar.f11365t);
        contentValues.put("minsdk", Integer.valueOf(rVar.f11366u));
        contentValues.put("urlIcon", rVar.v);
        contentValues.put("appName", rVar.f11367w);
        contentValues.put("nextAttemptTimeStamp", Long.valueOf(rVar.f11368x));
        contentValues.put("updateId", Long.valueOf(rVar.f11370z));
    ...
    public final void c0(j0 j0Var, long j) {
        ...
        contentValues.put("fileId", Long.valueOf(j0Var.f11236l));
        contentValues.put("size", Long.valueOf(j0Var.f11238n));
        contentValues.put("size_downloaded", Long.valueOf(j0Var.f11239o));
        contentValues.put("filehash", j0Var.f11240p);
        contentValues.put("absolutePath", j0Var.f11241q);
        contentValues.put("attempts", Integer.valueOf(j0Var.f11242r));
        contentValues.put("nextAttemptTimeStamp", Long.valueOf(j0Var.f11243s));
        SQLiteDatabase sQLiteDatabase = this.f6674a;
        sQLiteDatabase.getClass();
    ...
    public final void e(String str) {
        ...
        if (eVarB != null) {
            ...
            String[] strArr = {String.valueOf(eVarB.f11122a)};
            SQLiteDatabase sQLiteDatabase2 = this.f6674a;
            sQLiteDatabase2.getClass();
    ...
    public final void e0(q2 q2Var) {
        x4.r rVar;
        x4.r rVar2 = q2Var.f11353s;
        if (rVar2 != null) {
            b0(rVar2);
            q2Var.f11353s = rVar2;
        }
        ContentValues contentValues = new ContentValues();
        contentValues.put("packagename", q2Var.f11345b);
        contentValues.put("versionCode", Long.valueOf(q2Var.f11346l));
        contentValues.put("versionName", q2Var.f11347m);
        contentValues.put("notified", Integer.valueOf(q2Var.f11348n));
        contentValues.put("ignoreVersion", Integer.valueOf(q2Var.f11349o));
        contentValues.put("isPartialUpdate", Integer.valueOf(q2Var.f11350p));
        contentValues.put("newFeatures", q2Var.f11351q);
        contentValues.put("installationAttempts", Integer.valueOf(q2Var.f11352r));
        SQLiteDatabase sQLiteDatabase = this.f6674a;
        sQLiteDatabase.getClass();
        long jInsert = sQLiteDatabase.insert("updates", null, contentValues);
        x4.r rVar3 = q2Var.f11353s;
        if (rVar3 != null) {
            if (jInsert < 0) {
                j(rVar3);
                return;
            }
            rVar3.f11370z = jInsert;
            ArrayList arrayList = q2Var.f11354t;
            if (arrayList != null && !arrayList.isEmpty() && (rVar = q2Var.f11353s) != null && rVar.f11355a >= 0) {
                ...
                while (it.hasNext()) {
                    ...
                    x4.r rVar4 = q2Var.f11353s;
                    rVar4.getClass();
                    contentValues2.put("downloadId", Integer.valueOf(rVar4.f11355a));
                    SQLiteDatabase sQLiteDatabase2 = this.f6674a;
                    sQLiteDatabase2.getClass();
                    sQLiteDatabase2.insert("download_required_features", null, contentValues2);
                }
            }
            x4.r rVar5 = q2Var.f11353s;
            rVar5.getClass();
            q0(rVar5);
        }
    }
    ...
    public final void f(x4.e eVar) {
        if (eVar.f11122a < 0) {
            ...
            x4.e eVarB = B(str);
            if (eVarB != null) {
                eVar.f11122a = eVarB.f11122a;
            }
        }
        String[] strArr = {eVar.f11124l};
        SQLiteDatabase sQLiteDatabase = this.f6674a;
        sQLiteDatabase.getClass();
        sQLiteDatabase.delete("apps", "packagename=?", strArr);
        String[] strArr2 = {String.valueOf(eVar.f11122a)};
        SQLiteDatabase sQLiteDatabase2 = this.f6674a;
        sQLiteDatabase2.getClass();
    ...
    public final int j(x4.r rVar) {
        ...
        String[] strArr = {String.valueOf(rVar.f11355a)};
        SQLiteDatabase sQLiteDatabase = this.f6674a;
        sQLiteDatabase.getClass();
        int iDelete = sQLiteDatabase.delete("downloads", "id=?", strArr);
        String[] strArr2 = {String.valueOf(rVar.f11355a)};
        SQLiteDatabase sQLiteDatabase2 = this.f6674a;
        sQLiteDatabase2.getClass();
    ...
    public final void n0(x4.e eVar) {
        ...
        contentValues.put("issystemapp", Integer.valueOf(eVar.f11129q));
        contentValues.put("isSystemService", Integer.valueOf(eVar.f11130r));
        String str2 = eVar.f11127o;
        if (str2 != null) {
            contentValues.put("urlFicha", str2);
        }
        String str3 = eVar.f11133u;
        if (str3 != null) {
            contentValues.put("md5signature", str3);
        }
        contentValues.put("exclude", Integer.valueOf(eVar.v));
        contentValues.put("size", String.valueOf(eVar.f11134w));
        contentValues.put("excludeFromTracking", Integer.valueOf(eVar.f11136y));
        String str4 = eVar.f11137z;
        if (str4 != null) {
    ...
    public final void r0(j0 j0Var) {
        ...
        contentValues.put("attempts", Integer.valueOf(j0Var.f11242r));
        contentValues.put("nextAttemptTimeStamp", Long.valueOf(j0Var.f11243s));
        String[] strArr = {String.valueOf(j0Var.f11234a)};
        SQLiteDatabase sQLiteDatabase = this.f6674a;
        sQLiteDatabase.getClass();
    ...
    public final void s(String str) {
        ...
        q2 q2VarY = Y(str);
        if (q2VarY != null) {
            x4.r rVar = q2VarY.f11353s;
            if (rVar != null && (i = rVar.f11355a) >= 0) {
    ...
    public final void t0(a2 a2Var) {
        ContentValues contentValues = new ContentValues();
        contentValues.put("downloadId", Integer.valueOf(a2Var.f11046d));
        String[] strArr = {String.valueOf(a2Var.f11044b)};
        SQLiteDatabase sQLiteDatabase = this.f6674a;
        sQLiteDatabase.getClass();
    ...
    public final x4.b y(int i) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("active_notifications", this.f6686w, "notificationId=?", strArr, null, null, null);
        } catch (Exception e10) {
            e = e10;
            cursorQuery = null;
        }
    ...
    public final x4.b z(long j, String str) {
        ...
        try {
            ...
            SQLiteDatabase sQLiteDatabase = this.f6674a;
            sQLiteDatabase.getClass();
            cursorQuery = sQLiteDatabase.query("active_notifications", this.f6686w, "packagename=? AND versioncode=?", strArr, null, null, null);
            try {
                x4.b bVarF0 = cursorQuery.moveToFirst() ? f0(cursorQuery) : null;
                cursorQuery.close();
                return bVarF0;
