...
public final class d extends AbstractAccountAuthenticator {
    ...
    public final AuthenticatorService f6666a;

    public d(AuthenticatorService authenticatorService) {
        super(authenticatorService);
        this.f6666a = authenticatorService;
    }

    @Override // android.accounts.AbstractAccountAuthenticator
    public final Bundle addAccount(AccountAuthenticatorResponse accountAuthenticatorResponse, String str, String str2, String[] strArr, Bundle bundle) {
        Intent intent = new Intent(this.f6666a, (Class<?>) LoginActivity.class);
    ...
    public final Bundle getAuthToken(AccountAuthenticatorResponse accountAuthenticatorResponse, Account account, String str, Bundle bundle) {
        ...
        str.getClass();
        bundle.getClass();
        AuthenticatorService authenticatorService = this.f6666a;
        ...
        if (TextUtils.isEmpty(strPeekAuthToken) && (password = accountManager.getPassword(account)) != null) {
            ...
            if (!g2VarD.b() && (jSONObject = g2VarD.f11207d) != null && (jSONObjectOptJSONObject = jSONObject.optJSONObject("data")) != null) {
                w2 w2Var = new w2();
