...
public abstract class o {
    ...
    public static void c(Context context) {
        ...
        if (rVarB != null) {
            ...
            int i11 = i6 + i10;
            String str = rVarB.f11367w;
            String str2 = (str == null || str.length() == 0) ? rVarB.f11356b : rVarB.f11367w;
            String string2 = context.getResources().getString(R.string.notification_line_downloading);
            int i12 = rVarB.i();
            String string3 = context.getResources().getString(R.string.percent);
            ...
            if (i10 > 0) {
                String string4 = context.getString(R.string.queue_downloading_counter);
                string4.getClass();
            ...
            if (a5.b.d()) {
                ...
                string.getClass();
                i = R.drawable.vector_play_resume;
            } else {
                intent = new Intent(context, (Class<?>) DownloadNotificationReceiver.class);
            ...
            builder.setAutoCancel(false);
            builder.setOngoing(true);
            String string5 = context.getString(R.string.preparing_update_download);
            string5.getClass();
            ...
            if (z11) {
                ...
                if (l7.u.k0(name, ".apk", false)) {
                    ...
                    if (l7.u.k0(name2, ".xapk", true) || l7.u.k0(name2, ".apks", true) || l7.u.k0(name2, ".apkm", true) || l7.u.k0(name2, ".zip", true)) {
                        Drawable drawable = (Drawable) n4.m.f7986a.get(file.getName());
                        if (drawable == null) {
                                ...
                                if (fileArrListFiles != null && fileArrListFiles.length != 0) {
                                    ...
                                    while (i12 < fileArrListFiles.length) {
                                        ...
                                        try {
                                            ...
                                            n4.m.f7986a.put(file.getName(), drawableLoadIcon);
                                            try {
                                                file4.delete();
                                            } catch (Exception e11) {
                                                e11.printStackTrace();
    ...
    public static void e(Context context, x4.g gVar, int i, Bitmap bitmap, x1 x1Var) {
        ...
        if (a(context)) {
            ...
            string.getClass();
            String str = String.format(string, Arrays.copyOf(new Object[]{gVar.f11160b, context.getString(R.string.app_name)}, 2));
            if (bitmap != null) {
            ...
            k(null, String.valueOf(System.currentTimeMillis()), str, "preregister", String.valueOf(gVar.f11159a), context);
            ...
            gVarL.b();
            try {
                String[] strArr = {String.valueOf(x1Var.f11449a)};
                SQLiteDatabase sQLiteDatabase = gVarL.f6674a;
                sQLiteDatabase.getClass();
                cursorQuery = sQLiteDatabase.query("preregistrations_to_notify", gVarL.f6685u, "appId=?", strArr, null, null, null);
            } catch (Exception e10) {
                e = e10;
                cursorQuery = null;
            }
            try {
                if (cursorQuery.moveToFirst()) {
                    x1Var2 = new x1();
                    x1Var2.f11449a = cursorQuery.getLong(0);
                    x1Var2.f11453e = cursorQuery.getInt(1);
                } else {
                    x1Var2 = null;
                }
                cursorQuery.close();
            ...
            if (x1Var2 == null) {
                ...
                contentValues.put("appId", Long.valueOf(x1Var.f11449a));
    ...
    public static void i(Context context, x4.r rVar, String str) {
        ...
        if (a(context)) {
            ...
            if (z9) {
                String str2 = null;
                String str3 = rVar != null ? rVar.f11367w : null;
                if (str3 == null || str3.length() == 0) {
                    String str4 = rVar != null ? rVar.f11356b : null;
                ...
                String str5 = str2;
                if (str.length() == 0) {
                    strC = context.getString(R.string.descarga_error);
                    strC.getClass();
                } else {
                    strC = x.C(context.getString(R.string.descarga_error), str);
                }
                Object systemService = context.getSystemService("notification");
                systemService.getClass();
                NotificationManager notificationManager = (NotificationManager) systemService;
    ...
    public static void k(String str, String str2, String str3, String str4, String str5, Context context) {
        ...
        if (i6 > 100) {
            ...
            if (i > 0) {
                ...
                SQLiteDatabase sQLiteDatabase4 = gVarL.f6674a;
