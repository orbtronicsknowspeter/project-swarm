...
public final class i extends v6.i implements p {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        ArrayList arrayList = (ArrayList) this.f1040b.f7025a;
        ArrayList arrayList2 = (ArrayList) this.f1041l.f7025a;
        int i = this.f1043n.f7023a;
        arrayList.getClass();
        arrayList2.getClass();
        ...
        if (i <= 1) {
            ...
            if (!arrayList2.isEmpty() && ((x4.j) arrayList2.get(0)).f11230o == 523) {
                if (!arrayList3.isEmpty()) {
            ...
            if (!arrayList3.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (nVar.getContext() != null) {
                        ...
                        nVar.f5339b.add(new ListRow(headerItem, arrayObjectAdapter));
                    } else {
                        nVar.f5338a = false;
                    }
                }
