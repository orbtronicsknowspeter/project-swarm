...
public final class m implements e3.b, k4.a, a4.i, w4.m, d3, y0, j1.d, o5.e, t.b, ViewBinding {
    ...
    */
    ...
    public static final f2 v(m mVar, JSONObject jSONObject) {
        ...
        if (!jSONObjectOptJSONObject.isNull("sha256")) {
            f2Var.f11152a = jSONObjectOptJSONObject.optString("sha256");
        }
        if (!jSONObjectOptJSONObject.isNull("scans")) {
            f2Var.f11154l = jSONObjectOptJSONObject.optInt("scans");
        }
        if (!jSONObjectOptJSONObject.isNull("positives")) {
            f2Var.f11155m = jSONObjectOptJSONObject.optInt("positives");
        }
        if (!jSONObjectOptJSONObject.isNull("lastAnalysis")) {
            f2Var.f11156n = jSONObjectOptJSONObject.optString("lastAnalysis");
        }
        if (!jSONObjectOptJSONObject.isNull("md5Signature")) {
            f2Var.f11153b = jSONObjectOptJSONObject.optString("md5Signature");
        }
        JSONArray jSONArrayOptJSONArray = jSONObjectOptJSONObject.optJSONArray("infections");
        if (jSONArrayOptJSONArray != null) {
            f2Var.f11157o = new ArrayList();
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (jSONObjectOptJSONObject2 != null) {
                    if (!jSONObjectOptJSONObject2.isNull("antivirusName")) {
                        g1Var.f11200a = jSONObjectOptJSONObject2.optString("antivirusName");
                    }
                    if (!jSONObjectOptJSONObject2.isNull("virusName")) {
                        g1Var.f11201b = jSONObjectOptJSONObject2.optString("virusName");
                    }
                    if (!jSONObjectOptJSONObject2.isNull("isPup")) {
                        g1Var.f11202l = jSONObjectOptJSONObject2.optInt("isPup");
                    }
                    if (!jSONObjectOptJSONObject2.isNull("isAdware")) {
                        g1Var.f11203m = jSONObjectOptJSONObject2.optInt("isAdware");
                    }
                }
    ...
    */
    public java.lang.Object F(v6.c r9) {
        ...
        L2b:
            ...
            return r4
        L31:
            kotlin.jvm.internal.x r1 = r0.f9268a
            p6.a.e(r9)
            goto L54
        L37:
            p6.a.e(r9)
    ...
    public synchronized void G(int i, int i6, long j, long j6) {
        ((t1) this.f1061b).f4270t.getClass();
        ...
        s0 s0Var = new s0();
        s0Var.f4244b = this;
        s0Var.f4243a = jElapsedRealtime;
        pVarB.getClass();
        pVarB.b(j1.j.f6541a, s0Var);
    }

    @Override // o5.e
    public void a(long j) {
        ((w) this.f1061b).f7024a = j;
    }

    @Override // o5.e
    public void b(long j) {
        ((w) this.f1062l).f7024a = j;
    }
    ...
    */
    ...
    public void e() {
        ...
        String str = downloadApkWorker.f3477c;
        r rVar = downloadApkWorker.f3478d;
        rVar.getClass();
    ...
    public void g(int i) {
        ...
        if (publicProfileActivity.T()) {
            Object obj = ((u7) ((j5.r) ((s) this.f1062l)).f6708a).f2169b.get(i);
            obj.getClass();
            publicProfileActivity.i0(((k2) obj).f11263n);
        }
    }
    ...
    public Object get() {
        ...
        switch (this.f1060a) {
            case 1:
                Context context = (Context) ((f0.i) this.f1061b).f4812b;
    ...
    public void p(int i) {
        ...
        if (publicProfileActivity.T()) {
            ...
            v7.e eVar = m0.f8289a;
            c0.s(viewModelScope, v7.d.f10885a, null, new b6.g(k2Var, publicProfileActivity, y7VarZ0, (t6.c) null, 7), 2);
        }
    }
    ...
    public void q(int i) {
        ...
        if (publicProfileActivity.T()) {
            ...
            k2Var.f11260b = w2Var != null ? w2Var.f11432a : null;
            Intent intent = new Intent(publicProfileActivity, (Class<?>) RepliesActivity.class);
            intent.putExtra("review", k2Var);
            intent.putExtra("appId", k2Var.f11263n);
            intent.putExtra("appName", k2Var.f11270u);
            intent.putExtra("appIconUrl", str);
            intent.putExtra("username", k2Var.f11261l);
            w2 w2Var2 = (w2) xVar.f7025a;
            intent.putExtra("userAvatarUrl", w2Var2 != null ? w2Var2.f11434l : null);
    ...
    @Override // k4.a
    public void y() {
        ((k0) this.f1061b).W((File) this.f1062l, ((q2) this.f1063m).f11351q);
    }
    ...
    public m(Context context, t1 t1Var) {
        ...
        this.f1062l = new m0.b(context, m0.b.f7268k, new o("measurement:api"), i0.c.f5612c);
        this.f1061b = t1Var;
    }
