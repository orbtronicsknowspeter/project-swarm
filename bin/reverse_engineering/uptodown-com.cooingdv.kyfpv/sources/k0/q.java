...
public final class q implements DialogInterface.OnClickListener {
    ...
    public final /* synthetic */ Intent f6921b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final /* synthetic */ Object f6922l;
    ...
    public final void a() {
        switch (this.f6920a) {
            case 0:
                Intent intent = this.f6921b;
                if (intent != null) {
                    ((GoogleApiActivity) this.f6922l).startActivityForResult(intent, 2);
                }
                break;
            default:
                Intent intent2 = this.f6921b;
                if (intent2 != null) {
                    this.f6922l.a(intent2, 2);
                }
                break;
        }
    }
