...
public final class s extends l0.a {
    ...
    public final IBinder f6928b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final h0.b f6929l;
    ...
    public final boolean equals(Object obj) {
        ...
        s sVar = (s) obj;
        if (!this.f6929l.equals(sVar.f6929l)) {
            return false;
        }
        Object l0Var2 = null;
        IBinder iBinder = this.f6928b;
        if (iBinder == null) {
            l0Var = null;
        } else {
            int i = a.j;
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        a.a.X(parcel, 1, 4);
        parcel.writeInt(this.f6927a);
        a.a.R(parcel, 2, this.f6928b);
        a.a.S(parcel, 3, this.f6929l, i);
        a.a.X(parcel, 4, 4);
        parcel.writeInt(this.f6930m ? 1 : 0);
        a.a.X(parcel, 5, 4);
        parcel.writeInt(this.f6931n ? 1 : 0);
        a.a.a0(parcel, iY);
    }
}
