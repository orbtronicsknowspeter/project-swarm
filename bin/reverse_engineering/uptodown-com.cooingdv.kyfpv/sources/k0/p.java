...
public abstract class p {
    ...
    public static final SimpleArrayMap f6918a = new SimpleArrayMap();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static Locale f6919b;

    public static String a(Context context) {
        String packageName = context.getPackageName();
        try {
            Context context2 = r0.c.a(context).f8856a;
    ...
    public static String b(Context context, int i) {
        ...
        if (i == 2) {
            return p0.b.c(context) ? resources.getString(R.string.common_google_play_services_wear_update_text) : resources.getString(R.string.common_google_play_services_update_text, strA);
        }
        if (i == 3) {
    ...
    public static String e(Context context, String str) {
        ...
        SimpleArrayMap simpleArrayMap = f6918a;
        synchronized (simpleArrayMap) {
            try {
                Locale locale = ConfigurationCompat.getLocales(context.getResources().getConfiguration()).get(0);
                if (!locale.equals(f6919b)) {
