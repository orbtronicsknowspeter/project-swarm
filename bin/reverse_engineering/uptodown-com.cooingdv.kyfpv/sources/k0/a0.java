...
public abstract class a0 {
    ...
    public static final Uri f6835a = new Uri.Builder().scheme("content").authority("com.google.android.gms.chimera").build();

    public static Intent a(Context context, h0 h0Var) throws z {
        Bundle bundleCall;
        ContentProviderClient contentProviderClientAcquireUnstableContentProviderClient;
        String str = h0Var.f6881a;
        Intent intent = null;
        if (str == null) {
        ...
        if (h0Var.f6883c) {
            ...
            try {
                contentProviderClientAcquireUnstableContentProviderClient = context.getContentResolver().acquireUnstableContentProviderClient(f6835a);
        ...
        return intent == null ? new Intent(str).setPackage(h0Var.f6882b) : intent;
    }
}
