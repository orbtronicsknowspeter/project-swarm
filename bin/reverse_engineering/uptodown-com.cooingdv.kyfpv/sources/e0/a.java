...
public final class a extends i0.d {
    ...
    public final Intent b() {
        ...
        i0.a aVar = this.f5618d;
        Context context = this.f5615a;
        if (i == 2) {
            h.f4809a.b("getFallbackSignInIntent()", new Object[0]);
        ...
        h.f4809a.b("getNoImplementationSignInIntent()", new Object[0]);
    ...
    public final void c() {
        ...
        boolean z9 = d() == 3;
        h.f4809a.b("Signing out", new Object[0]);
        h.b(this.f5615a);
        o oVar = this.h;
        if (z9) {
            i iVar = new i(oVar);
