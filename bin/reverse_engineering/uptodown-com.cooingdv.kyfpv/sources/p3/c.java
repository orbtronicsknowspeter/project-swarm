...
public abstract class c {
    ...
    public static final Logger f8422a = Logger.getLogger(c.class.getName());

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final Pattern f8423b = Pattern.compile("^[0-1]*$", 2);

    public static ArrayList a(String str) {
        if (f8423b.matcher(str).matches()) {
            int iIndexOf = 12;
            if (str.length() >= 12) {
