...
public abstract class d extends a implements List, RandomAccess {
    ...
    public static final b f7054b = new b(i.f7065n, 0);

    public static i g(int i, Object[] objArr) {
        return i == 0 ? i.f7065n : new i(i, objArr);
    }
    ...
    public final b listIterator(int i) {
        a.a.p(i, size());
        return isEmpty() ? f7054b : new b(this, i);
    }
    ...
    public d subList(int i, int i6) {
        a.a.q(i, i6, size());
        int i10 = i6 - i;
        return i10 == size() ? this : i10 == 0 ? i.f7065n : new c(this, i, i10);
    }
