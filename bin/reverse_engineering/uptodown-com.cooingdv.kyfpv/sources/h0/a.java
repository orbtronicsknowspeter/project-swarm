...
public final class a implements ServiceConnection {
    ...
    public final LinkedBlockingQueue f5393b = new LinkedBlockingQueue();
    ...
    public final IBinder a() throws TimeoutException {
        ...
        this.f5392a = true;
        IBinder iBinder = (IBinder) this.f5393b.poll(WorkRequest.MIN_BACKOFF_MILLIS, TimeUnit.MILLISECONDS);
        if (iBinder != null) {
            return iBinder;
        }
