...
public final class h extends v6.i implements p {
    ...
    public final /* synthetic */ String f5726l;
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f5724a) {
            case 0:
                return new h(this.f5725b, this.f5726l, cVar, 0);
            default:
                return new h(this.f5725b, this.f5726l, cVar, 1);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) throws IOException {
        ...
        switch (this.f5724a) {
            case 0:
                return new h(this.f5725b, this.f5726l, cVar, 0).invokeSuspend(x.f8464a);
            default:
    ...
    public final Object invokeSuspend(Object obj) throws IOException {
        switch (this.f5724a) {
            ...
            default:
                p6.a.e(obj);
                ComponentCallbacks2 componentCallbacks2 = f4.c.f4876o;
                if (componentCallbacks2 != null && (componentCallbacks2 instanceof k0)) {
                    c0.s(LifecycleOwnerKt.getLifecycleScope((LifecycleOwner) componentCallbacks2), null, null, new b5.l(componentCallbacks2, this.f5725b, this.f5726l, (t6.c) null, 23), 3);
                }
                return x.f8464a;
        }
    }
