...
public final class g extends v6.i implements p {
    ...
    private final Object a(Object obj) {
        ...
        if (i == 0) {
            ...
            o6.e.f8226b = new n9.a(eVar.f7188a == null ? null : new Float(r8.f7194c.intValue()));
            o6.e.f8227c = new n9.a(eVar.f7189b == null ? null : new Float(r8.f7194c.intValue()));
            o6.e.f8228d = new n9.a(eVar.f7190c == null ? null : new Float(r8.f7194c.intValue()));
            o6.e.f8229e = new n9.a(eVar.f7191d == null ? null : new Float(r8.f7194c.intValue()));
        ...
        h9.c cVar = m9.c.f7860c;
        n9.a aVar2 = o6.e.f8226b;
        if (aVar2 != null) {
            if (typeface2 == null) {
                typeface2 = cVar == null ? null : cVar.f5494a;
            }
            aVar2.f8120a = typeface2;
        }
        n9.a aVar3 = o6.e.f8227c;
        if (aVar3 != null) {
            if (typeface3 == null) {
                typeface3 = cVar == null ? null : cVar.f5494a;
            }
            aVar3.f8120a = typeface3;
        }
        n9.a aVar4 = o6.e.f8228d;
        if (aVar4 != null) {
            if (typeface4 == null) {
                typeface4 = cVar == null ? null : cVar.f5495b;
            }
            aVar4.f8120a = typeface4;
        }
        n9.a aVar5 = o6.e.f8229e;
        if (aVar5 != null) {
            if (typeface5 != null) {
                typeface = typeface5;
            } else if (cVar != null) {
                typeface = cVar.f5495b;
            }
            aVar5.f8120a = typeface;
        }
        a.a.f("All fonts set: Title=" + o6.e.f8226b + ", Subtitle=" + o6.e.f8227c + ", Body=" + o6.e.f8228d + ", Button=" + o6.e.f8229e);
        return x.f8464a;
    }
    ...
    private final Object b(Object obj) throws Throwable {
        ...
        if (i == 0) {
            ...
            xVar.f7025a = new ArrayList();
            gVarL = j5.g.D.l(sVar.f9285a);
            gVarL.b();
            ...
            if (h2VarX == null || !h2VarX.a()) {
                ...
                g2VarK.f11207d = vVar.i(g2VarK, "/eapi/home");
                if (!g2VarK.b() && (jSONObject = g2VarK.f11207d) != null) {
                    xVar.f7025a = t0.f.x(jSONObject);
                ...
                xVar.f7025a = t0.f.x(new JSONObject((String) h2VarX.f11213b));
            }
            if (!((Collection) xVar.f7025a).isEmpty()) {
                p2 p2VarA = s.a(sVar, (j) l.q0((List) xVar.f7025a), vVar, gVarL);
                v7.e eVar = m0.f8289a;
                p7.c cVar = n.f10349a;
    ...
    private final Object c(Object obj) throws Throwable {
        ...
        switch (dVar.f8967m) {
            case 2:
                t6.h hVar = dVar.f8964a;
                int i6 = dVar.f8965b;
                ya yaVar = new ya(dVar, null, 26);
                o7.a rVar = new r(c0.t(a0Var, hVar), i5.a(i6, q7.a.f8730a, 4));
                rVar.f0(b0.f8234a, rVar, yaVar);
                r42 = rVar;
                break;
            default:
                t6.h hVar2 = dVar.f8964a;
                int i10 = dVar.f8965b;
                if (i10 == -3) {
                    i10 = -2;
                }
                q7.a aVar = dVar.f8966l;
                ya yaVar2 = new ya(dVar, null, 26);
                o7.a rVar2 = new r(c0.t(a0Var, hVar2), i5.a(i10, aVar, 4));
                rVar2.f0(b0.f8236l, rVar2, yaVar2);
                r42 = rVar2;
                break;
        }
        this.f1088b = 1;
    ...
    public final Object invoke(Object obj, Object obj2) throws Throwable {
        ...
        switch (this.f1087a) {
            ...
            case 11:
                ...
                break;
            case 14:
                ((g) create(a0Var, cVar)).invokeSuspend(x.f8464a);
                break;
        }
