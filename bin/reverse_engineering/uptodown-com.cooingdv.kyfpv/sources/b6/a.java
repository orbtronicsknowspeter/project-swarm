...
public final class a extends v6.i implements p {
    ...
    private final Object a(Object obj) {
        ...
        e1 e1Var = publicListActivity.f3337c0;
        if (e1Var == null || e1Var.f4520a.isEmpty() || str == null || str.length() == 0) {
            e1 e1Var2 = publicListActivity.f3337c0;
            if (e1Var2 != null) {
                e1Var2.notifyDataSetChanged();
            }
        } else {
            e1 e1Var3 = publicListActivity.f3337c0;
            e1Var3.getClass();
            ArrayList arrayList = e1Var3.f4520a;
            ...
            while (true) {
                ...
                i++;
                if (l.a(((a3) obj2).f11050d, str)) {
                    break;
                }
            }
            e1 e1Var4 = publicListActivity.f3337c0;
            e1Var4.getClass();
            int iU0 = q6.l.u0(e1Var4.f4520a, (a3) obj2);
            e1 e1Var5 = publicListActivity.f3337c0;
            if (iU0 > -1) {
                e1Var5.getClass();
    ...
    private final Object b(Object obj) {
        ...
        e1 e1Var = recommendedActivity.f3341c0;
        if (e1Var == null || e1Var.f4520a.isEmpty() || str == null || str.length() == 0) {
            e1 e1Var2 = recommendedActivity.f3341c0;
            if (e1Var2 != null) {
                e1Var2.notifyDataSetChanged();
            }
        } else {
            e1 e1Var3 = recommendedActivity.f3341c0;
            e1Var3.getClass();
            ArrayList arrayList = e1Var3.f4520a;
            int size = arrayList.size();
            int i = 0;
            ...
            e1 e1Var4 = recommendedActivity.f3341c0;
            e1Var4.getClass();
            int iU0 = q6.l.u0(e1Var4.f4520a, (a3) obj2);
    ...
    private final Object c(Object obj) throws JSONException {
        ...
        g2VarK.f11207d = vVar.i(g2VarK, "/eapi/apps/appId/comments");
            ...
            if (str != null && eVar.v == 0) {
                ...
                while (true) {
                    if (i6 < size2) {
                        ...
                        i6++;
                        q2 q2Var = (q2) obj3;
                        if (str.equalsIgnoreCase(q2Var.f11345b)) {
    ...
    private final Object e(Object obj) throws JSONException {
        ...
        String str = ((w2) o0Var.getValue()).f11432a;
        str.getClass();
        g2 g2VarY = vVar.y(20, bcVar.i, str);
        if (!g2VarY.b() && (jSONObject = g2VarY.f11207d) != null) {
