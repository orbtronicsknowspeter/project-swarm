...
public final class f extends m.a {
    ...
    public final void b(ViewStub viewStub) {
        ...
        this.f1076n = (ConstraintLayout) viewInflate.findViewById(R.id.privacy_container);
        this.f1077o = (ImageView) viewInflate.findViewById(R.id.iv_cmp_logo);
        this.f1078p = (Button) viewInflate.findViewById(R.id.btn_more_options);
        this.f1079q = (Button) viewInflate.findViewById(R.id.btn_disagree);
        this.f1080r = (Button) viewInflate.findViewById(R.id.btn_agree);
        this.f1081s = (TextView) viewInflate.findViewById(R.id.tv_login_and_continue);
        this.f1082t = (TextView) viewInflate.findViewById(R.id.tv_message);
        this.f1083u = (TextView) viewInflate.findViewById(R.id.tv_title);
        this.v = (Group) viewInflate.findViewById(R.id.group_powered_by);
        this.f1085x = (ImageView) viewInflate.findViewById(R.id.iv_ia_logo);
        this.f1084w = (TextView) viewInflate.findViewById(R.id.tv_powered_by);
    }
    ...
    public final void c(String str, SpannableString spannableString, String str2, ClickableSpan clickableSpan, boolean z9) {
        ...
        if (((d7.a) dVarA.f6993b).invoke() == null) {
            dVarA = null;
        }
        if (dVarA == null) {
            listD0 = null;
            ...
            listD0 = m.d0(Integer.valueOf(dVarB.f5696a), Integer.valueOf(str2.length() + dVarB.f5696a));
        }
        if (listD0 == null) {
            listD0 = t.f8725a;
        }
        ...
        h9.d dVar = this.f7264a;
        Integer num = dVar != null ? dVar.f5502l : null;
        spannableString.setSpan(new ForegroundColorSpan(num == null ? ContextCompat.getColor(context, R.color.colorBlueAccent) : num.intValue()), ((Number) l.q0(listD0)).intValue(), ((Number) l.y0(listD0)).intValue(), 33);
    }
