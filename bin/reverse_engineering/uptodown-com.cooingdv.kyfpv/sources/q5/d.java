...
public final class d extends p9.a {
    ...
    public final void onCancel(DialogInterface dialogInterface) {
        ...
        DisplayInfo displayInfo = new DisplayInfo(DisplayStatus.DISMISSED, "User dismissed US regulations screen", Regulations.MSPA, l.g.f7045a);
        ChoiceCmpCallback choiceCmpCallback = iVar.f8712c;
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        this.f8702z = (LinearLayout) view.findViewById(R.id.container_ccpa_links);
        ...
        this.C = (Button) view.findViewById(R.id.btn_opt_out);
        this.D = (Button) view.findViewById(R.id.btn_confirm);
        this.I = (TextView) view.findViewById(R.id.tv_preferences);
        boolean z9 = m9.c.e().f7247u;
        ...
        if (textView2 != null) {
            ...
            String string = eVar.f8383c.f5489a;
            if (string.length() == 0) {
        ...
        if (textView4 != null) {
            ...
            textView4.append(l.g.f7045a ? eVar4.f.f6984b.f6979c : "");
        }
        ...
        LinearLayout linearLayout = this.f8702z;
        final int i6 = 1;
        ...
        a(textView6, str2, strC, eVar7.c().length() > 0 && (nVar3 = eVar7.f8384d) != null && (rVar5 = nVar3.f7244r) != null && rVar5.g.length() > 0);
        ...
        a(textView7, str3, strA, eVar9.a().length() > 0 && (nVar2 = eVar9.f8384d) != null && (rVar3 = nVar2.f7244r) != null && rVar3.h.length() > 0);
        ...
        a(textView8, str, strD, eVar11.d().length() > 0 && (nVar = eVar11.f8384d) != null && (rVar = nVar.f7244r) != null && rVar.i.length() > 0);
        ImageView imageView = this.f8496l;
        if (imageView != null) {
            imageView.setOnClickListener(new View.OnClickListener(this) { // from class: q5.b

                /* JADX INFO: renamed from: b, reason: collision with root package name */
                public final /* synthetic */ d f8699b;
                ...
                public final void onClick(View view2) {
                    ...
                    switch (i10) {
                        case 0:
                            ...
                            DisplayInfo displayInfo = new DisplayInfo(DisplayStatus.DISMISSED, "User dismissed US regulations screen", Regulations.MSPA, l.g.f7045a);
                            ChoiceCmpCallback choiceCmpCallback = iVar2.f8712c;
                            if (choiceCmpCallback != null) {
                                choiceCmpCallback.onCMPUIStatusChanged(displayInfo);
                            }
                            dVar.dismiss();
                        ...
                        case 1:
                            ...
                            if (sVar != 0) {
                                ...
                                if (r02 != 0) {
                                    ...
                                    for (j8.b bVar2 : r02) {
                                        bVar2.f6723c = Boolean.FALSE;
                                        ?? r32 = bVar2.f;
                                        if (r32 != 0) {
                                            Iterator it = r32.iterator();
                                            while (it.hasNext()) {
                                                ((j8.c) it.next()).f6729d = Boolean.FALSE;
                                            }
                                        }
                                    }
                        ...
                        case 2:
                            ...
                            if (sVar2 != 0) {
                                ...
                                if (r03 != 0) {
                                    ...
                                    for (j8.b bVar4 : r03) {
                                        bVar4.f6723c = Boolean.TRUE;
                                        ?? r62 = bVar4.f;
                                        if (r62 != 0) {
                                            Iterator it2 = r62.iterator();
                                            while (it2.hasNext()) {
                                                ((j8.c) it2.next()).f6729d = Boolean.TRUE;
                                            }
                                        }
                                    }
            ...
            imageView.setContentDescription(eVar12.f8383c.f);
        }
        ...
        t1.f(this.f8505u, this.D, this.C);
        i iVar2 = this.K;
        if (iVar2 == null) {
            l.i("mspaViewModel");
            throw null;
