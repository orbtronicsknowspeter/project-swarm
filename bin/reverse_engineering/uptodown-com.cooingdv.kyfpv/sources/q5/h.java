    ...
    public final Object invoke(Object obj) {
        ...
        switch (this.f8708a) {
            case 0:
                ...
                i.c();
                x xVar4 = x.f8464a;
                if (uSRegulationData == null || (choiceCmpCallback2 = iVar.f8712c) == null) {
                    xVar = null;
                } else {
                    choiceCmpCallback2.onReceiveUSRegulationsConsent(uSRegulationData);
                    xVar = xVar4;
                }
                if (xVar == null && (choiceCmpCallback = iVar.f8712c) != null) {
            ...
            case 1:
                ...
                i.c();
                x xVar5 = x.f8464a;
                if (uSRegulationData2 == null || (choiceCmpCallback4 = iVar2.f8712c) == null) {
                    xVar2 = null;
                } else {
                    choiceCmpCallback4.onReceiveUSRegulationsConsent(uSRegulationData2);
                    xVar2 = xVar5;
                }
                if (xVar2 == null && (choiceCmpCallback3 = iVar2.f8712c) != null) {
                    choiceCmpCallback3.onCmpError(ChoiceError.ERROR_WHILE_SAVING_CONSENT);
                }
                return xVar5;
            default:
                ChoiceCmpCallback choiceCmpCallback5 = this.f8709b.f8712c;
