...
public final /* synthetic */ class s1 implements d3 {
    ...
    public boolean b() {
        ...
        g1 g1Var = t1Var.f4264n;
        t1.k(g1Var);
        return jCurrentTimeMillis - g1Var.G.a() > t1Var.f4263m.n(null, f0.f3937k0);
    }

    @Override // e1.d3, e1.y0
    public /* synthetic */ void c(String str, int i, Throwable th, byte[] bArr, Map map) {
        this.f4245a.i(i, th, bArr);
    }

    public boolean d() {
        g1 g1Var = this.f4245a.f4264n;
        t1.k(g1Var);
        return g1Var.G.a() > 0;
    }
}
