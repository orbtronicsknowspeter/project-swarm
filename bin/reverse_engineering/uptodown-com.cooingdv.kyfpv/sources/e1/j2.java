...
public final class j2 {
    ...
    public static final j2 f4055c = new j2(100);

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final EnumMap f4056a;
    ...
    public static j2 b(int i, Bundle bundle) {
        ...
        EnumMap enumMap = new EnumMap(i2.class);
        for (i2 i2Var : h2.STORAGE.f4021a) {
            enumMap.put(i2Var, d(bundle.getString(i2Var.f4039a)));
        }
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof j2) {
            ...
            while (true) {
                if (i < length) {
                    i2 i2Var = i2VarArr[i];
                    if (this.f4056a.get(i2Var) != j2Var.f4056a.get(i2Var)) {
                        break;
                    }
                    i++;
                } else if (this.f4057b == j2Var.f4057b) {
                    return true;
                }
            }
        }
    ...
    */
    public final java.lang.String f() {
        ...
        Ld:
            if (r3 >= r2) goto L38
            r4 = r1[r3]
            java.util.EnumMap r5 = r7.f4056a
    ...
    public final String g() {
        ...
        for (i2 i2Var : h2.STORAGE.f4021a) {
            sb.append(h((g2) this.f4056a.get(i2Var)));
        }
        return sb.toString();
    }
    ...
    public final boolean i(i2 i2Var) {
        return ((g2) this.f4056a.get(i2Var)) != g2.DENIED;
    }
    ...
    */
    public final e1.j2 j(e1.j2 r9) {
        ...
        Ld:
            if (r3 >= r2) goto L48
            r4 = r1[r3]
            java.util.EnumMap r5 = r8.f4056a
            java.lang.Object r5 = r5.get(r4)
            e1.g2 r5 = (e1.g2) r5
            java.util.EnumMap r6 = r9.f4056a
    ...
    public final j2 k(j2 j2Var) {
        EnumMap enumMap = new EnumMap(i2.class);
        for (i2 i2Var : h2.STORAGE.f4021a) {
            g2 g2Var = (g2) this.f4056a.get(i2Var);
            if (g2Var == g2.UNINITIALIZED) {
                g2Var = (g2) j2Var.f4056a.get(i2Var);
            }
            if (g2Var != null) {
                enumMap.put(i2Var, g2Var);
            }
        }
        return new j2(enumMap, this.f4057b);
    }

    public final String toString() {
        StringBuilder sb = new StringBuilder("source=");
        sb.append(a(this.f4057b));
        for (i2 i2Var : h2.STORAGE.f4021a) {
            sb.append(",");
