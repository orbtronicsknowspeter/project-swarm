...
public final class c2 extends com.google.android.gms.internal.measurement.y implements i0 {
    ...
    public final List E(String str, String str2, boolean z9, c5 c5Var) {
        ...
        try {
            ...
            e = e10;
            u4Var.a().f4340o.d(w0.o(str3), "Failed to query user properties. appId", e);
    ...
    public final void G(String str, boolean z9) {
        ...
        u4 u4Var = this.i;
        if (zIsEmpty) {
            u4Var.a().f4340o.b("Measurement Service called without app package");
        ...
        if (z9) {
            try {
                if (this.j == null) {
                    boolean z10 = true;
                    if (!"com.google.android.gms".equals(this.f3847k) && !p0.b.b(u4Var.f4317u.f4260a, Binder.getCallingUid()) && !h0.h.a(u4Var.f4317u.f4260a).b(Binder.getCallingUid())) {
                        z10 = false;
                    }
                ...
                u4Var.a().f4340o.c(w0.o(str), "Measurement Service called with invalid calling package. appId");
                throw e10;
            }
        }
        if (this.f3847k == null) {
            Context context = u4Var.f4317u.f4260a;
        ...
        switch (i) {
            ...
            case 7:
                ...
                try {
                    ...
                    e = e10;
                    u4Var.a().f4340o.d(w0.o(str), "Failed to get user properties. appId", e);
                } catch (ExecutionException e11) {
                    e = e11;
                    u4Var.a().f4340o.d(w0.o(str), "Failed to get user properties. appId", e);
                }
            ...
            case 24:
                ...
                com.google.android.gms.internal.measurement.z.d(parcel);
                d(c5Var14);
                String str2 = c5Var14.f3851a;
                k0.y.g(str2);
                if (!u4Var.e0().q(null, f0.Z0)) {
                    try {
                        list = (List) u4Var.b().n(new z1(this, c5Var14, bundle2, 1)).get();
                    } catch (InterruptedException | ExecutionException e12) {
                        u4Var.a().f4340o.d(w0.o(str2), "Failed to get trigger URIs. appId", e12);
                    ...
                    try {
                        ...
                        u4Var.a().f4340o.d(w0.o(str2), "Failed to get trigger URIs. appId", e13);
                        list = Collections.EMPTY_LIST;
                    }
                    break;
                }
    ...
    public final i f(c5 c5Var) {
        ...
        try {
            ...
            u4Var.a().f4340o.d(w0.o(str), "Failed to get consent. appId", e10);
            return new i(null);
        }
    }
    ...
    public final List h(String str, String str2, String str3, boolean z9) {
        ...
        try {
            ...
            e = e10;
            u4Var.a().f4340o.d(w0.o(str), "Failed to get user properties as. appId", e);
            return Collections.EMPTY_LIST;
        } catch (ExecutionException e11) {
            e = e11;
            u4Var.a().f4340o.d(w0.o(str), "Failed to get user properties as. appId", e);
    ...
    public final byte[] n(u uVar, String str) {
        ...
        try {
            ...
            if (bArr == null) {
                u4Var.a().f4340o.c(w0.o(str), "Log and bundle returned null. appId");
                bArr = new byte[0];
            }
            u4Var.f().getClass();
            u4Var.a().v.e("Log and bundle processed. event, size, time_ms", t1Var.f4269s.a(str2), Integer.valueOf(bArr.length), Long.valueOf((System.nanoTime() / 1000000) - jNanoTime));
            return bArr;
        } catch (InterruptedException e10) {
            e = e10;
            u4Var.a().f4340o.e("Failed to log and bundle. appId, event, error", w0.o(str), t1Var.f4269s.a(str2), e);
            return null;
        } catch (ExecutionException e11) {
            e = e11;
            u4Var.a().f4340o.e("Failed to log and bundle. appId, event, error", w0.o(str), t1Var.f4269s.a(str2), e);
    ...
    public final List o(String str, String str2, String str3) {
        ...
        try {
            ...
            u4Var.a().f4340o.c(e10, "Failed to get conditional user properties as");
            return Collections.EMPTY_LIST;
        }
    }
    ...
    public final List y(String str, String str2, c5 c5Var) {
        ...
        try {
            ...
            u4Var.a().f4340o.c(e10, "Failed to get conditional user properties");
            return Collections.EMPTY_LIST;
        }
    }
    ...
    public final String z(c5 c5Var) {
        ...
        try {
            ...
            u4Var.a().f4340o.d(w0.o(c5Var.f3851a), "Failed to get app instance id. appId", e10);
            return null;
        }
    }
}
