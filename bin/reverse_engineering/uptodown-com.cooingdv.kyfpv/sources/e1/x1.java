...
public final class x1 implements Runnable {
    ...
    public final /* synthetic */ Object f4395l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final Object f4396m;

    public x1(w3 w3Var, AtomicReference atomicReference, c5 c5Var) {
        this.f4393a = 5;
        this.f4396m = atomicReference;
        this.f4394b = c5Var;
    ...
    private final void a() {
        ...
        t1 t1Var;
        g1 g1Var;
        AtomicReference atomicReference2 = (AtomicReference) this.f4396m;
        synchronized (atomicReference2) {
            try {
                try {
                    w3Var = (w3) this.f4395l;
                    t1Var = w3Var.f3876a;
                    g1Var = t1Var.f4264n;
                    t1.k(g1Var);
                } catch (RemoteException e10) {
                    w0 w0Var = ((w3) this.f4395l).f3876a.f4265o;
                    t1.m(w0Var);
                    w0Var.f4340o.c(e10, "Failed to get app instance id");
                    atomicReference = (AtomicReference) this.f4396m;
                }
                if (g1Var.n().i(i2.ANALYTICS_STORAGE)) {
                    i0 i0Var = w3Var.f4360m;
                    if (i0Var != null) {
                        atomicReference2.set(i0Var.z((c5) this.f4394b));
                        String str = (String) atomicReference2.get();
                        if (str != null) {
                            b3 b3Var = w3Var.f3876a.v;
                            t1.l(b3Var);
                            b3Var.f3814p.set(str);
                    ...
                    t1.m(w0Var2);
                    w0Var2.f4340o.b("Failed to get app instance id");
                } else {
                    w0 w0Var3 = t1Var.f4265o;
                    t1.m(w0Var3);
                    w0Var3.f4345t.b("Analytics storage consent denied; will not get app instance id");
                    b3 b3Var2 = w3Var.f3876a.v;
                    t1.l(b3Var2);
                    b3Var2.f3814p.set(null);
                    g1 g1Var3 = t1Var.f4264n;
                    t1.k(g1Var3);
                    g1Var3.f3986p.o(null);
                    atomicReference2.set(null);
                }
                atomicReference2.notify();
            } catch (Throwable th) {
                ((AtomicReference) this.f4396m).notify();
                throw th;
            }
        }
    }
