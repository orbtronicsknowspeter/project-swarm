...
public final class a5 extends e2 {
    ...
    public static final String[] f3772r = {"firebase_", "google_", "ga_"};

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public static final String[] f3773s = {"_err"};

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public SecureRandom f3774l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final AtomicLong f3775m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public int f3776n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public MeasurementManagerFutures f3777o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public Boolean f3778p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public Integer f3779q;

    public a5(t1 t1Var) {
        super(t1Var);
        this.f3779q = null;
        this.f3775m = new AtomicLong(0L);
    }
    ...
    public static boolean D(String str) {
        String str2 = (String) f0.f3954s0.a(null);
    ...
    public static ArrayList W(List list) {
        ...
        while (it.hasNext()) {
            ...
            bundle.putString("app_id", eVar.f3883a);
            bundle.putString("origin", eVar.f3884b);
            bundle.putLong("creation_timestamp", eVar.f3886m);
            bundle.putString("name", eVar.f3885l.f4403b);
            Object objC = eVar.f3885l.c();
            k0.y.g(objC);
            k2.c(bundle, objC);
            bundle.putBoolean("active", eVar.f3887n);
            String str = eVar.f3888o;
            if (str != null) {
                bundle.putString("trigger_event_name", str);
            }
            u uVar = eVar.f3889p;
            if (uVar != null) {
                bundle.putString("timed_out_event_name", uVar.f4290a);
                t tVar = uVar.f4291b;
                if (tVar != null) {
                    bundle.putBundle("timed_out_event_params", tVar.g());
                }
            }
            bundle.putLong("trigger_timeout", eVar.f3890q);
            u uVar2 = eVar.f3891r;
            if (uVar2 != null) {
                bundle.putString("triggered_event_name", uVar2.f4290a);
                t tVar2 = uVar2.f4291b;
                if (tVar2 != null) {
                    bundle.putBundle("triggered_event_params", tVar2.g());
                }
            }
            bundle.putLong("triggered_timestamp", eVar.f3885l.f4404l);
            bundle.putLong("time_to_live", eVar.f3892s);
            u uVar3 = eVar.f3893t;
            if (uVar3 != null) {
                bundle.putString("expired_event_name", uVar3.f4290a);
                t tVar3 = uVar3.f4291b;
                if (tVar3 != null) {
    ...
    public static void Y(j3 j3Var, Bundle bundle, boolean z9) {
        if (bundle != null && j3Var != null) {
            if (!bundle.containsKey("_sc") || z9) {
                String str = j3Var.f4058a;
                if (str != null) {
                    bundle.putString("_sn", str);
                } else {
                    bundle.remove("_sn");
                }
                String str2 = j3Var.f4059b;
                if (str2 != null) {
                    bundle.putString("_sc", str2);
                } else {
                    bundle.remove("_sc");
                }
                bundle.putLong("_si", j3Var.f4060c);
                return;
            }
            z9 = false;
        }
    ...
    */
    public final long C() {
        ...
        L4d:
            ...
            if (r1 != 0) goto Lbd
            java.lang.Boolean r1 = r11.f3778p
            if (r1 != 0) goto Lb3
            androidx.privacysandbox.ads.adservices.java.measurement.MeasurementManagerFutures r1 = r11.f3777o
            if (r1 != 0) goto L61
            android.content.Context r0 = r0.f4260a
            ...
            r11.f3777o = r0
        L61:
            androidx.privacysandbox.ads.adservices.java.measurement.MeasurementManagerFutures r0 = r11.f3777o
            r1 = 0
            if (r0 != 0) goto L67
            goto Lb9
        L67:
        ...
        L88:
            ...
            r11.f3778p = r1     // Catch: java.util.concurrent.TimeoutException -> L80 java.lang.InterruptedException -> L82 java.util.concurrent.ExecutionException -> L84 java.util.concurrent.CancellationException -> L86
            goto La9
        L8f:
            r5 = r0
            goto L9a
        ...
        La9:
            ...
            r1.c(r0, r2)
        Lb3:
            java.lang.Boolean r0 = r11.f3778p
    ...
    public final boolean E(String str) {
        ...
        if (r0.c.a(t1Var.f4260a).f8856a.checkCallingOrSelfPermission(str) == 0) {
            return true;
        }
    ...
    public final boolean H(String str, String str2) {
        ...
        return this.f3876a.f4263m.k("debug.firebase.analytics.app").equals(str);
    }
        ...
        if (bundle != null) {
            for (String str : bundle.keySet()) {
                ...
                if (objN == null) {
                    ...
                    w0 w0Var = t1Var.f4265o;
                    t1.m(w0Var);
                    w0Var.f4345t.c(t1Var.f4269s.b(str), "Param value can't be null");
                } else {
                    v(objN, str, bundle2);
                }
            }
    ...
    public final u J(String str, Bundle bundle, String str2, long j, boolean z9) {
        ...
        if (l0(str) != 0) {
            ...
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.c(t1Var.f4269s.c(str), "Invalid conditional property event name");
            s1.o.n();
            return null;
        }
    ...
    public final boolean K(Context context, String str) {
        ...
        try {
            ...
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.c(e10, "Package name not found");
            return true;
        } catch (CertificateException e11) {
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4340o.c(e11, "Error obtaining certificate");
            return true;
        }
    }

    public final boolean M(int i) {
        Boolean bool = this.f3876a.p().f4361n;
        if (N() < i / 1000) {
    ...
    public final int N() {
        if (this.f3779q == null) {
            h0.f fVar = h0.f.f5410b;
            Context context = this.f3876a.f4260a;
            fVar.getClass();
            AtomicBoolean atomicBoolean = h0.g.f5411a;
            int i = 0;
            try {
            ...
            this.f3779q = Integer.valueOf(i / 1000);
        }
        return this.f3779q.intValue();
    }
    ...
    public final void O(Bundle bundle, long j) {
        ...
        if (j6 != 0) {
            ...
            t1.m(w0Var);
            w0Var.f4343r.c(Long.valueOf(j6), "Params already contained engagement");
        } else {
            j6 = 0;
        }
    ...
    public final void P(String str, com.google.android.gms.internal.measurement.m0 m0Var) {
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error returning string value to wrapper");
        }
    }
    ...
    public final void Q(com.google.android.gms.internal.measurement.m0 m0Var, long j) {
        ...
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error returning long value to wrapper");
        }
    }
    ...
    public final void R(com.google.android.gms.internal.measurement.m0 m0Var, int i) {
        ...
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error returning int value to wrapper");
        }
    }
    ...
    public final void S(com.google.android.gms.internal.measurement.m0 m0Var, byte[] bArr) {
        ...
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error returning byte array to wrapper");
        }
    }
    ...
    public final void T(com.google.android.gms.internal.measurement.m0 m0Var, boolean z9) {
        ...
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error returning boolean value to wrapper");
        }
    }
    ...
    public final void U(com.google.android.gms.internal.measurement.m0 m0Var, Bundle bundle) {
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error returning bundle value to wrapper");
        }
    }
    ...
    public final void V(com.google.android.gms.internal.measurement.m0 m0Var, ArrayList arrayList) {
        ...
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error returning bundle list to wrapper");
        }
    }
    ...
    public final long d0() {
        long andIncrement;
        long j;
        AtomicLong atomicLong = this.f3775m;
        if (atomicLong.get() != 0) {
            AtomicLong atomicLong2 = this.f3775m;
    ...
    public final Bundle g0(Uri uri) {
        ...
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Install referrer url isn't a hierarchical URI");
            return null;
        }
    }
    ...
    public final boolean h0(String str, String str2) {
        ...
        if (str2 == null) {
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4342q.c(str, "Name is required and can't be null. Type");
            return false;
        }
        if (str2.length() == 0) {
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4342q.c(str, "Name is required and can't be empty. Type");
            return false;
        }
        ...
        if (!Character.isLetter(iCodePointAt)) {
            ...
            t1.m(w0Var3);
            w0Var3.f4342q.d(str, "Name must start with a letter. Type, name", str2);
            return false;
        }
        ...
        while (iCharCount < length) {
            ...
            if (iCodePointAt2 != 95 && !Character.isLetterOrDigit(iCodePointAt2)) {
                ...
                t1.m(w0Var4);
                w0Var4.f4342q.d(str, "Name must consist of letters, digits or _ (underscores). Type, name", str2);
                return false;
            }
    ...
    public final boolean i0(String str, String str2) {
        ...
        if (!Character.isLetter(iCodePointAt)) {
            if (iCodePointAt != 95) {
                w0 w0Var3 = t1Var.f4265o;
                t1.m(w0Var3);
                w0Var3.f4342q.d(str, "Name must start with a letter or _ (underscore). Type, name", str2);
                return false;
            }
            iCodePointAt = 95;
        }
    ...
    public final boolean j0(String str, String[] strArr, String[] strArr2, String str2) {
        ...
        for (int i = 0; i < 3; i++) {
            if (str2.startsWith(f3772r[i])) {
                w0 w0Var2 = t1Var.f4265o;
                t1.m(w0Var2);
                w0Var2.f4342q.d(str, "Name starts with reserved prefix. Type, name", str2);
                return false;
            }
        }
        ...
        w0 w0Var3 = t1Var.f4265o;
        t1.m(w0Var3);
        w0Var3.f4342q.d(str, "Name is reserved. Type, name", str2);
        return false;
    }
    ...
    public final boolean k(String str) {
        ...
        if (zIsEmpty) {
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4342q.b("Missing google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI");
            return false;
        }
        k0.y.g(str);
        ...
        w0 w0Var2 = t1Var.f4265o;
        t1.m(w0Var2);
        w0Var2.f4342q.c(w0.o(str), "Invalid google_app_id. Firebase Analytics disabled. See https://goo.gl/NAOOOI. provided id");
        return false;
    }
    ...
    public final boolean k0(int i, String str, String str2) {
        ...
        w0 w0Var2 = t1Var.f4265o;
        t1.m(w0Var2);
        w0Var2.f4342q.e("Name is too long. Type, maximum supported length, name", str, Integer.valueOf(i), str2);
        return false;
    }
    ...
    public final int l0(String str) {
        ...
        if (!j0(NotificationCompat.CATEGORY_EVENT, k2.f4073a, k2.f4074b, str)) {
            return 13;
        }
    ...
    */
        ...
        for (String str4 : new TreeSet(bundle.keySet())) {
            ...
            if (iN0 != 0) {
                ...
                if (f0(str4)) {
                    i6++;
                    if (i6 > i) {
                        if (t1Var.f4263m.q(str3, f0.f3927f1) && z10) {
                            str2 = str3;
                        } else {
                            ...
                            t1.m(w0Var);
                            str2 = str3;
                            w0Var.f4342q.d(q0Var.a(str), string, q0Var.e(bundle));
                        }
                        a0(5, bundle2);
                        bundle2.remove(str4);
                        z10 = true;
    ...
    public final void p(x0 x0Var, int i) {
        Bundle bundle = (Bundle) x0Var.f4392e;
        int i6 = 0;
        boolean z9 = false;
        for (String str : new TreeSet(bundle.keySet())) {
            if (f0(str) && (i6 = i6 + 1) > i) {
                ...
                if (!gVar.q(null, f0.f3927f1) || !z9) {
                    ...
                    w0 w0Var = t1Var.f4265o;
                    t1.m(w0Var);
                    w0Var.f4342q.d(q0Var.a((String) x0Var.f4390c), string, q0Var.e(bundle));
                    a0(5, bundle);
                }
                bundle.remove(str);
                z9 = true;
    ...
    public final boolean q0(String str, String str2, int i, Object obj) {
        ...
        if (string.codePointCount(0, string.length()) > i) {
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4345t.e("Value is too long; discarded. Value kind, name, value length", str, str2, Integer.valueOf(string.length()));
            return false;
        }
        return true;
    }
        ...
        for (String str4 : new TreeSet(bundle.keySet())) {
            ...
            if (iN0 != 0) {
                ...
                if (p0(bundle.get(str4))) {
                    t1.m(w0Var);
                    w0Var.f4345t.e("Nested Bundle parameters are not allowed; discarded. event name, param name, child param name", str, str2, str4);
                    iM = 22;
                    str3 = null;
                } else {
                    str3 = null;
                ...
                if (iM != 0 && !"_ev".equals(str4)) {
                    ...
                    if (!M(231100000)) {
                        t1.m(w0Var);
                        w0Var.f4342q.d(q0Var.a(str), "Item array not supported on client's version of Google Play Services (Android Only)", q0Var.e(bundle));
                        a0(23, bundle);
                        bundle.remove(str4);
                    } else if (i10 > i) {
                        if (!t1Var.f4263m.q(str3, f0.f3927f1) || !z10) {
    ...
    public final void v(Object obj, String str, Bundle bundle) {
        ...
        if (str != null) {
            ...
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4345t.d(t1Var.f4269s.b(str), "Not putting event parameter. Invalid value type. name, type", simpleName);
        }
    }
}
