...
public final class m1 extends p4 implements f {
    ...
    public final ArrayMap f4106m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final ArrayMap f4107n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final ArrayMap f4108o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public final ArrayMap f4109p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public final ArrayMap f4110q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final ArrayMap f4111r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final j1 f4112s;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public final f0.i f4113t;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    public final ArrayMap f4114u;
    public final ArrayMap v;

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public final ArrayMap f4115w;

    public m1(u4 u4Var) {
        super(u4Var);
        this.f4106m = new ArrayMap();
        this.f4107n = new ArrayMap();
        this.f4108o = new ArrayMap();
        this.f4109p = new ArrayMap();
        this.f4110q = new ArrayMap();
        this.f4114u = new ArrayMap();
        this.v = new ArrayMap();
        this.f4115w = new ArrayMap();
        this.f4111r = new ArrayMap();
        this.f4112s = new j1(this);
        this.f4113t = new f0.i(this, 21);
    }
    ...
    public final String d(String str, String str2) {
        g();
        m(str);
        Map map = (Map) this.f4106m.get(str);
        if (map != null) {
    ...
    public final void m(String str) {
        ...
        g();
        k0.y.d(str);
        ArrayMap arrayMap = this.f4110q;
        if (arrayMap.get(str) == 0) {
            m mVar = this.f4093b.f4308l;
            u4.U(mVar);
            b5.m mVarM0 = mVar.m0(str);
            ArrayMap arrayMap2 = this.f4115w;
            ArrayMap arrayMap3 = this.v;
            ArrayMap arrayMap4 = this.f4114u;
            ArrayMap arrayMap5 = this.f4106m;
            if (mVarM0 != null) {
            ...
            this.f4108o.put(str, null);
            this.f4107n.put(str, null);
            this.f4109p.put(str, null);
            arrayMap.put(str, null);
            arrayMap4.put(str, null);
            arrayMap3.put(str, null);
            arrayMap2.put(str, null);
            this.f4111r.put(str, null);
        }
    }
    ...
    public final void n(String str, com.google.android.gms.internal.measurement.e2 e2Var) {
        ...
        for (int i = 0; i < ((com.google.android.gms.internal.measurement.f2) e2Var.f2687b).t(); i++) {
            ...
            if (zIsEmpty) {
                ...
                t1.m(w0Var);
                w0Var.f4343r.b("EventConfig contained null event name");
            } else {
                String strG = c2Var.g();
                String strG2 = k2.g(c2Var.g(), k2.f4073a, k2.f4075c);
                ...
                if (((com.google.android.gms.internal.measurement.d2) c2Var.f2687b).t()) {
                    if (((com.google.android.gms.internal.measurement.d2) c2Var.f2687b).u() < 2 || ((com.google.android.gms.internal.measurement.d2) c2Var.f2687b).u() > 65535) {
                        ...
                        t1.m(w0Var2);
                        w0Var2.f4343r.d(c2Var.g(), "Invalid sampling rate. Event name, sample rate", Integer.valueOf(((com.google.android.gms.internal.measurement.d2) c2Var.f2687b).u()));
                    } else {
        ...
        this.f4107n.put(str, hashSet);
        this.f4108o.put(str, arrayMap);
        this.f4109p.put(str, arrayMap2);
        this.f4111r.put(str, arrayMap3);
    }

    public final void o(String str, com.google.android.gms.internal.measurement.f2 f2Var) {
        int iX = f2Var.x();
        j1 j1Var = this.f4112s;
        if (iX == 0) {
            j1Var.remove(str);
            return;
        }
        ...
        w0 w0Var = t1Var.f4265o;
        t1.m(w0Var);
        w0Var.f4347w.c(Integer.valueOf(f2Var.x()), "EES programs found");
        ...
        try {
            ...
            ((HashMap) ((z5) sVar.f11759n).f2934a).put("internal.remoteConfig", new k1(this, str, 2));
            ((HashMap) ((z5) sVar.f11759n).f2934a).put("internal.appMetadata", new k1(this, str, 0));
            ((HashMap) ((z5) sVar.f11759n).f2934a).put("internal.logger", new l1(this));
            e0Var.b(v3Var);
            j1Var.put(str, e0Var);
            t1.m(w0Var);
            ...
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4340o.c(str, "Failed to load EES program. appId");
        }
    }
    ...
    public final com.google.android.gms.internal.measurement.f2 p(String str, byte[] bArr) {
        ...
        try {
            ...
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4347w.d(f2Var.o() ? Long.valueOf(f2Var.p()) : null, "Parsed config. version, gmp_app_id", f2Var.q() ? f2Var.r() : null);
            return f2Var;
        } catch (t5 e10) {
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4343r.d(w0.o(str), "Unable to merge remote config. appId", e10);
            return com.google.android.gms.internal.measurement.f2.F();
        } catch (RuntimeException e11) {
            w0 w0Var3 = t1Var.f4265o;
            t1.m(w0Var3);
            w0Var3.f4343r.d(w0.o(str), "Unable to merge remote config. appId", e11);
            return com.google.android.gms.internal.measurement.f2.F();
        }
    }
    ...
    public final com.google.android.gms.internal.measurement.f2 s(String str) {
        ...
        k0.y.d(str);
        m(str);
        return (com.google.android.gms.internal.measurement.f2) this.f4110q.get(str);
    }
    ...
    public final String t(String str) {
        g();
        m(str);
        return (String) this.f4114u.get(str);
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:109:0x0433, code lost:
        ...
        r0 = r13.f4265o;
        e1.t1.m(r0);
        r0.f4340o.c(e1.w0.o(r30), "Failed to insert property filter (got -1). appId");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:114:0x044e, code lost:
        ...
        r1 = r13.f4265o;
        e1.t1.m(r1);
        r1.f4340o.d(e1.w0.o(r30), "Error storing property filter. appId", r0);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:58:0x027a, code lost:
        ...
        r0 = r13.f4265o;
        e1.t1.m(r0);
        r0.f4343r.d(e1.w0.o(r30), "Property filter with no ID. Audience definition ignored. appId, audienceId", java.lang.Integer.valueOf(r7));
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:84:0x0353, code lost:
        ...
        r0 = r13.f4265o;
        e1.t1.m(r0);
        r0.f4340o.c(e1.w0.o(r30), "Failed to insert event filter (got -1). appId");
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:87:0x0370, code lost:
        ...
        r1 = r13.f4265o;
        e1.t1.m(r1);
        r1.f4340o.d(e1.w0.o(r30), "Error storing event filter. appId", r0);
     */
    ...
    */
    ...
    public final boolean v(String str, String str2) {
        ...
        Map map = (Map) this.f4108o.get(str);
    ...
    public final boolean w(String str, String str2) {
        ...
        Map map = (Map) this.f4109p.get(str);
        if (map == null || (bool = (Boolean) map.get(str2)) == null) {
            return false;
        }
        return bool.booleanValue();
    ...
    public final int x(String str, String str2) {
        ...
        g();
        m(str);
        Map map = (Map) this.f4111r.get(str);
