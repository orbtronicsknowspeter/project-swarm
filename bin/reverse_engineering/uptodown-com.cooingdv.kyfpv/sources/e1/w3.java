...
public final class w3 extends h0 {
    ...
    public final v3 f4359l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public i0 f4360m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public volatile Boolean f4361n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public final s3 f4362o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public ScheduledExecutorService f4363p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public final s0 f4364q;

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public final ArrayList f4365r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final s3 f4366s;

    public w3(t1 t1Var) {
        super(t1Var);
        this.f4365r = new ArrayList();
        this.f4364q = new s0(t1Var.f4270t);
        this.f4359l = new v3(this);
        this.f4362o = new s3(this, t1Var, 0);
        this.f4366s = new s3(this, t1Var, 1);
    }
    ...
    */
    ...
    public final void m() {
        ...
        List<ResolveInfo> listQueryIntentServices = t1Var.f4260a.getPackageManager().queryIntentServices(new Intent().setClassName(t1Var.f4260a, "com.google.android.gms.measurement.AppMeasurementService"), 65536);
        if (listQueryIntentServices == null || listQueryIntentServices.isEmpty()) {
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.b("Unable to use remote or local measurement implementation. Please register the AppMeasurementService service in the app manifest");
            return;
        }
        Intent intent = new Intent("com.google.android.gms.measurement.START");
        intent.setComponent(new ComponentName(t1Var.f4260a, "com.google.android.gms.measurement.AppMeasurementService"));
        v3 v3Var = this.f4359l;
        ...
        synchronized (v3Var) {
            try {
                boolean z9 = v3Var.f4329a;
                w3 w3Var2 = v3Var.f4331l;
                if (z9) {
                    w0 w0Var2 = w3Var2.f3876a.f4265o;
                    t1.m(w0Var2);
                    w0Var2.f4347w.b("Connection attempt already in progress");
                } else {
                    w0 w0Var3 = w3Var2.f3876a.f4265o;
                    t1.m(w0Var3);
                    w0Var3.f4347w.b("Using local app measurement service");
                    v3Var.f4329a = true;
                    aVarB.a(context, intent, w3Var2.f4359l, 129);
                }
            } catch (Throwable th) {
                throw th;
            }
    ...
    */
    ...
    public final void o() {
        ...
        h();
        v3 v3Var = this.f4359l;
        if (v3Var.f4330b != null && (v3Var.f4330b.g() || v3Var.f4330b.d())) {
            v3Var.f4330b.o();
        }
        v3Var.f4330b = null;
        try {
            o0.a.b().c(this.f3876a.f4260a, v3Var);
    ...
    public final void r(ComponentName componentName) {
        ...
        if (this.f4360m != null) {
            ...
            t1.m(w0Var);
            w0Var.f4347w.c(componentName, "Disconnected from device MeasurementService");
            g();
            m();
        }
    }
    ...
    public final void u(Runnable runnable) {
        ...
        ArrayList arrayList = this.f4365r;
        ...
        if (size >= 1000) {
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.b("Discarding data. Max runnable queue size reached");
        } else {
            arrayList.add(runnable);
            this.f4366s.b(60000L);
            m();
        }
    }
    ...
    public final void v() {
        ...
        while (i < size) {
            ...
            try {
                ...
                t1.m(w0Var2);
                w0Var2.f4340o.c(e10, "Task exception while flushing queue");
            }
        }
        arrayList.clear();
        this.f4366s.c();
    ...
    */
    ...
    public final void z(e eVar) {
        ...
        t1Var.getClass();
        p0 p0VarO = t1Var.o();
        t1 t1Var2 = p0VarO.f3876a;
        t1.k(t1Var2.f4268r);
        byte[] bArrL = a5.L(eVar);
        if (bArrL.length > 131072) {
            w0 w0Var = t1Var2.f4265o;
            t1.m(w0Var);
            w0Var.f4341p.b("Conditional user property too long for local database. Sending directly to service");
            zN = false;
        } else {
            zN = p0VarO.n(2, bArrL);
        }
