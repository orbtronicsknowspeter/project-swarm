...
public final class v2 implements Runnable {
    ...
    public final /* synthetic */ Bundle f4327b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final /* synthetic */ b3 f4328l;
    ...
    public final void run() {
        ...
        switch (this.f4326a) {
            case 0:
                b3 b3Var = this.f4328l;
                b3Var.g();
                b3Var.h();
                Bundle bundle2 = this.f4327b;
                ...
                if (!t1Var.d()) {
                    ...
                    t1.m(w0Var);
                    w0Var.f4347w.b("Conditional property not set since app measurement is disabled");
                } else {
                ...
                break;
            case 1:
                b3 b3Var2 = this.f4328l;
                b3Var2.g();
                b3Var2.h();
                Bundle bundle3 = this.f4327b;
                ...
                if (!t1Var2.d()) {
                    ...
                    t1.m(w0Var2);
                    w0Var2.f4347w.b("Conditional property not cleared since app measurement is disabled");
                } else {
                    x4 x4Var2 = new x4(0L, null, string3, "");
                    try {
                        a5 a5Var2 = t1Var2.f4268r;
                        t1.k(a5Var2);
                ...
                break;
            default:
                b3 b3Var3 = this.f4328l;
                a3.d dVar = b3Var3.F;
                t1 t1Var3 = b3Var3.f3876a;
                Bundle bundle4 = this.f4327b;
                if (bundle4.isEmpty()) {
                    bundle = bundle4;
                } else {
                    g1 g1Var = t1Var3.f4264n;
                    a5 a5Var3 = t1Var3.f4268r;
                    g gVar = t1Var3.f4263m;
                    w0 w0Var3 = t1Var3.f4265o;
                    t1.k(g1Var);
                    ...
                    for (String str : bundle4.keySet()) {
                        ...
                        if (obj != null && !(obj instanceof String) && !(obj instanceof Long) && !(obj instanceof Double)) {
                            ...
                            t1.m(w0Var3);
                            w0Var3.f4345t.d(str, "Invalid default event parameter type. Name, value", obj);
                        } else if (a5.F(str)) {
                            t1.m(w0Var3);
                            w0Var3.f4345t.c(str, "Invalid default event parameter name. Name");
                        } else if (obj == null) {
                            bundle.remove(str);
                        } else {
                            t1.k(a5Var3);
                    ...
                    if (bundle.size() > i) {
                        ...
                        t1.m(w0Var3);
                        w0Var3.f4345t.b("Too many default event parameters set. Discarding beyond event parameter limit");
                    }
                }
                g1 g1Var2 = t1Var3.f4264n;
                t1.k(g1Var2);
                g1Var2.H.K(bundle);
                if (!bundle4.isEmpty() || t1Var3.f4263m.q(null, f0.X0)) {
                    t1Var3.p().l(bundle);
                }
                break;
        }
