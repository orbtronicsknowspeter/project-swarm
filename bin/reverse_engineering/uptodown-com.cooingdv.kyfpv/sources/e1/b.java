...
public final class b {
                    ...
                    case 1:
                        if (str2 != null) {
                            try {
                                ...
                                if (w0Var != null) {
                                    w0Var.f4343r.c(str2, "Invalid regular expression in REGEXP audience filter. expression");
                                }
                            }
                        }
                        break;
    ...
    */
    ...
    public boolean b(Long l10, Long l11, com.google.android.gms.internal.measurement.s3 s3Var, boolean z9) {
        ...
        Boolean boolE3;
        r7.a();
        t1 t1Var = this.h.f3876a;
        g gVar = t1Var.f4263m;
        q0 q0Var = t1Var.f4269s;
        w0 w0Var = t1Var.f4265o;
        boolean zQ = gVar.q(this.f3780a, f0.E0);
        ...
        if (z9 && !z11) {
            t1.m(w0Var);
            w0Var.f4347w.d(Integer.valueOf(this.f3781b), "Property filter already evaluated true and it is not associated with an enhanced audience. audience ID, filter ID", v1Var.o() ? Integer.valueOf(v1Var.p()) : null);
            return true;
        }
        ...
        if (!s3Var.t()) {
            ...
            if (!s3Var.x()) {
                if (!s3Var.r()) {
                    t1.m(w0Var);
                    w0Var.f4343r.c(q0Var.c(s3Var.q()), "User property has no value, property");
                } else if (q1VarR.o()) {
                    String strS = s3Var.s();
                    ...
                    t1.m(w0Var);
                    w0Var.f4343r.c(q0Var.c(s3Var.q()), "No string or number filter defined. property");
                    ...
                    t1.m(w0Var);
                    w0Var.f4343r.d(q0Var.c(s3Var.q()), "Invalid user property value for Numeric number filter. property, value", s3Var.s());
                }
                boolC = null;
            } else if (q1VarR.q()) {
                double dY = s3Var.y();
                ...
                t1.m(w0Var);
                w0Var.f4343r.c(q0Var.c(s3Var.q()), "No number filter for double property. property");
                boolC = null;
            }
        } else if (q1VarR.q()) {
            z10 = zV;
            ...
            t1.m(w0Var);
            w0Var.f4343r.c(q0Var.c(s3Var.q()), "No number filter for long property. property");
            z10 = zV;
            boolC = null;
        }
        t1.m(w0Var);
        w0Var.f4347w.c(boolC == null ? "null" : boolC, "Property filter result");
        if (boolC == null) {
            return false;
        }
        this.f3782c = Boolean.TRUE;
