...
public final class l extends SQLiteOpenHelper {
    ...
    public final /* synthetic */ d2 f4088b;
    ...
    public final SQLiteDatabase getWritableDatabase() {
        switch (this.f4087a) {
            case 0:
                m mVar = (m) this.f4088b;
                t1 t1Var = mVar.f3876a;
                t1 t1Var2 = mVar.f3876a;
                t1Var.getClass();
                s0 s0Var = mVar.f4105n;
                if (s0Var.f4243a != 0) {
                    ((p0.a) s0Var.f4244b).getClass();
                    if (SystemClock.elapsedRealtime() - s0Var.f4243a < 3600000) {
                ...
                try {
                    ...
                    ((p0.a) s0Var.f4244b).getClass();
                    s0Var.f4243a = SystemClock.elapsedRealtime();
                    w0 w0Var = t1Var2.f4265o;
                    t1.m(w0Var);
                    w0Var.f4340o.b("Opening the database failed, dropping and recreating it");
                    if (!t1Var2.f4260a.getDatabasePath("google_app_measurement.db").delete()) {
                        w0 w0Var2 = t1Var2.f4265o;
                        t1.m(w0Var2);
                        w0Var2.f4340o.c("google_app_measurement.db", "Failed to delete corrupted db file");
                    }
                    try {
                        ...
                        t1.m(w0Var3);
                        w0Var3.f4340o.c(e10, "Failed to open freshly created database");
                        throw e10;
                    }
                }
            default:
                p0 p0Var = (p0) this.f4088b;
                try {
                    return super.getWritableDatabase();
                } catch (SQLiteDatabaseLockedException e11) {
                    throw e11;
                } catch (SQLiteException unused2) {
                    t1 t1Var3 = p0Var.f3876a;
                    w0 w0Var4 = t1Var3.f4265o;
                    t1.m(w0Var4);
                    w0Var4.f4340o.b("Opening the local database failed, dropping and recreating it");
                    if (!t1Var3.f4260a.getDatabasePath("google_app_measurement_local.db").delete()) {
                        w0 w0Var5 = t1Var3.f4265o;
                        t1.m(w0Var5);
                        w0Var5.f4340o.c("google_app_measurement_local.db", "Failed to delete corrupted local db file");
                    }
                    try {
                        return super.getWritableDatabase();
                    } catch (SQLiteException e12) {
                        w0 w0Var6 = p0Var.f3876a.f4265o;
                        t1.m(w0Var6);
                        w0Var6.f4340o.c(e12, "Failed to open local database. Events will bypass local storage");
                        return null;
                    }
                }
        }
    ...
    public final void onCreate(SQLiteDatabase sQLiteDatabase) {
        switch (this.f4087a) {
            case 0:
                w0 w0Var = ((m) this.f4088b).f3876a.f4265o;
                t1.m(w0Var);
                k2.f(w0Var, sQLiteDatabase);
                break;
            default:
                w0 w0Var2 = ((p0) this.f4088b).f3876a.f4265o;
                t1.m(w0Var2);
    ...
    public final void onOpen(SQLiteDatabase sQLiteDatabase) throws Throwable {
        switch (this.f4087a) {
            case 0:
                t1 t1Var = ((m) this.f4088b).f3876a;
                w0 w0Var = t1Var.f4265o;
                t1.m(w0Var);
                k2.d(w0Var, sQLiteDatabase, "events", "CREATE TABLE IF NOT EXISTS events ( app_id TEXT NOT NULL, name TEXT NOT NULL, lifetime_count INTEGER NOT NULL, current_bundle_count INTEGER NOT NULL, last_fire_timestamp INTEGER NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,lifetime_count,current_bundle_count,last_fire_timestamp", m.f4094o);
                ...
                t1.m(w0Var2);
                k2.d(w0Var2, sQLiteDatabase, "user_attributes", "CREATE TABLE IF NOT EXISTS user_attributes ( app_id TEXT NOT NULL, name TEXT NOT NULL, set_timestamp INTEGER NOT NULL, value BLOB NOT NULL, PRIMARY KEY (app_id, name)) ;", "app_id,name,set_timestamp,value", m.f4096q);
                t1.m(w0Var2);
                ...
                t1.m(w0Var2);
                k2.d(w0Var2, sQLiteDatabase, "queue", "CREATE TABLE IF NOT EXISTS queue ( app_id TEXT NOT NULL, bundle_end_timestamp INTEGER NOT NULL, data BLOB NOT NULL);", "app_id,bundle_end_timestamp,data", m.f4099t);
                t1.m(w0Var2);
                ...
                t1.m(w0Var2);
                k2.d(w0Var2, sQLiteDatabase, "raw_events", "CREATE TABLE IF NOT EXISTS raw_events ( app_id TEXT NOT NULL, name TEXT NOT NULL, timestamp INTEGER NOT NULL, metadata_fingerprint INTEGER NOT NULL, data BLOB NOT NULL);", "app_id,name,timestamp,metadata_fingerprint,data", m.f4098s);
                t1.m(w0Var2);
                k2.d(w0Var2, sQLiteDatabase, "event_filters", "CREATE TABLE IF NOT EXISTS event_filters ( app_id TEXT NOT NULL, audience_id INTEGER NOT NULL, filter_id INTEGER NOT NULL, event_name TEXT NOT NULL, data BLOB NOT NULL, PRIMARY KEY (app_id, event_name, audience_id, filter_id));", "app_id,audience_id,filter_id,event_name,data", m.f4100u);
                t1.m(w0Var2);
                ...
                t1.m(w0Var2);
                k2.d(w0Var2, sQLiteDatabase, "app2", "CREATE TABLE IF NOT EXISTS app2 ( app_id TEXT NOT NULL, first_open_count INTEGER NOT NULL, PRIMARY KEY (app_id));", "app_id,first_open_count", m.f4101w);
                t1.m(w0Var2);
                ...
                t1.m(w0Var2);
                k2.d(w0Var2, sQLiteDatabase, "consent_settings", "CREATE TABLE IF NOT EXISTS consent_settings ( app_id TEXT NOT NULL, consent_state TEXT NOT NULL, PRIMARY KEY (app_id));", "app_id,consent_state", m.f4102x);
                f8.a();
                t1.m(w0Var2);
                k2.d(w0Var2, sQLiteDatabase, "trigger_uris", "CREATE TABLE IF NOT EXISTS trigger_uris ( app_id TEXT NOT NULL, trigger_uri TEXT NOT NULL, timestamp_millis INTEGER NOT NULL, source INTEGER NOT NULL);", "app_id,trigger_uri,source,timestamp_millis", m.f4103y);
                t1.m(w0Var2);
                ...
                break;
            default:
                w0 w0Var3 = ((p0) this.f4088b).f3876a.f4265o;
                t1.m(w0Var3);
                k2.d(w0Var3, sQLiteDatabase, "messages", "create table if not exists messages ( type INTEGER NOT NULL, entry BLOB NOT NULL)", "type,entry", p0.f4184n);
                break;
        }
    }
