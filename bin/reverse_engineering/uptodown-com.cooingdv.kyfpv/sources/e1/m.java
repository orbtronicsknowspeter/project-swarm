...
public final class m extends p4 {
    ...
    public static final String[] f4094o = {"last_bundled_timestamp", "ALTER TABLE events ADD COLUMN last_bundled_timestamp INTEGER;", "last_bundled_day", "ALTER TABLE events ADD COLUMN last_bundled_day INTEGER;", "last_sampled_complex_event_id", "ALTER TABLE events ADD COLUMN last_sampled_complex_event_id INTEGER;", "last_sampling_rate", "ALTER TABLE events ADD COLUMN last_sampling_rate INTEGER;", "last_exempt_from_sampling", "ALTER TABLE events ADD COLUMN last_exempt_from_sampling INTEGER;", "current_session_count", "ALTER TABLE events ADD COLUMN current_session_count INTEGER;"};

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public static final String[] f4095p = {"associated_row_id", "ALTER TABLE upload_queue ADD COLUMN associated_row_id INTEGER;", "last_upload_timestamp", "ALTER TABLE upload_queue ADD COLUMN last_upload_timestamp INTEGER;"};

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public static final String[] f4096q = {"origin", "ALTER TABLE user_attributes ADD COLUMN origin TEXT;"};

    /* JADX INFO: renamed from: r, reason: collision with root package name */
    public static final String[] f4097r = {"app_version", "ALTER TABLE apps ADD COLUMN app_version TEXT;", "app_store", "ALTER TABLE apps ADD COLUMN app_store TEXT;", "gmp_version", "ALTER TABLE apps ADD COLUMN gmp_version INTEGER;", "dev_cert_hash", "ALTER TABLE apps ADD COLUMN dev_cert_hash INTEGER;", "measurement_enabled", "ALTER TABLE apps ADD COLUMN measurement_enabled INTEGER;", "last_bundle_start_timestamp", "ALTER TABLE apps ADD COLUMN last_bundle_start_timestamp INTEGER;", "day", "ALTER TABLE apps ADD COLUMN day INTEGER;", "daily_public_events_count", "ALTER TABLE apps ADD COLUMN daily_public_events_count INTEGER;", "daily_events_count", "ALTER TABLE apps ADD COLUMN daily_events_count INTEGER;", "daily_conversions_count", "ALTER TABLE apps ADD COLUMN daily_conversions_count INTEGER;", "remote_config", "ALTER TABLE apps ADD COLUMN remote_config BLOB;", "config_fetched_time", "ALTER TABLE apps ADD COLUMN config_fetched_time INTEGER;", "failed_config_fetch_time", "ALTER TABLE apps ADD COLUMN failed_config_fetch_time INTEGER;", "app_version_int", "ALTER TABLE apps ADD COLUMN app_version_int INTEGER;", "firebase_instance_id", "ALTER TABLE apps ADD COLUMN firebase_instance_id TEXT;", "daily_error_events_count", "ALTER TABLE apps ADD COLUMN daily_error_events_count INTEGER;", "daily_realtime_events_count", "ALTER TABLE apps ADD COLUMN daily_realtime_events_count INTEGER;", "health_monitor_sample", "ALTER TABLE apps ADD COLUMN health_monitor_sample TEXT;", "android_id", "ALTER TABLE apps ADD COLUMN android_id INTEGER;", "adid_reporting_enabled", "ALTER TABLE apps ADD COLUMN adid_reporting_enabled INTEGER;", "ssaid_reporting_enabled", "ALTER TABLE apps ADD COLUMN ssaid_reporting_enabled INTEGER;", "admob_app_id", "ALTER TABLE apps ADD COLUMN admob_app_id TEXT;", "linked_admob_app_id", "ALTER TABLE apps ADD COLUMN linked_admob_app_id TEXT;", "dynamite_version", "ALTER TABLE apps ADD COLUMN dynamite_version INTEGER;", "safelisted_events", "ALTER TABLE apps ADD COLUMN safelisted_events TEXT;", "ga_app_id", "ALTER TABLE apps ADD COLUMN ga_app_id TEXT;", "config_last_modified_time", "ALTER TABLE apps ADD COLUMN config_last_modified_time TEXT;", "e_tag", "ALTER TABLE apps ADD COLUMN e_tag TEXT;", "session_stitching_token", "ALTER TABLE apps ADD COLUMN session_stitching_token TEXT;", "sgtm_upload_enabled", "ALTER TABLE apps ADD COLUMN sgtm_upload_enabled INTEGER;", "target_os_version", "ALTER TABLE apps ADD COLUMN target_os_version INTEGER;", "session_stitching_token_hash", "ALTER TABLE apps ADD COLUMN session_stitching_token_hash INTEGER;", "ad_services_version", "ALTER TABLE apps ADD COLUMN ad_services_version INTEGER;", "unmatched_first_open_without_ad_id", "ALTER TABLE apps ADD COLUMN unmatched_first_open_without_ad_id INTEGER;", "npa_metadata_value", "ALTER TABLE apps ADD COLUMN npa_metadata_value INTEGER;", "attribution_eligibility_status", "ALTER TABLE apps ADD COLUMN attribution_eligibility_status INTEGER;", "sgtm_preview_key", "ALTER TABLE apps ADD COLUMN sgtm_preview_key TEXT;", "dma_consent_state", "ALTER TABLE apps ADD COLUMN dma_consent_state INTEGER;", "daily_realtime_dcu_count", "ALTER TABLE apps ADD COLUMN daily_realtime_dcu_count INTEGER;", "bundle_delivery_index", "ALTER TABLE apps ADD COLUMN bundle_delivery_index INTEGER;", "serialized_npa_metadata", "ALTER TABLE apps ADD COLUMN serialized_npa_metadata TEXT;", "unmatched_pfo", "ALTER TABLE apps ADD COLUMN unmatched_pfo INTEGER;", "unmatched_uwa", "ALTER TABLE apps ADD COLUMN unmatched_uwa INTEGER;", "ad_campaign_info", "ALTER TABLE apps ADD COLUMN ad_campaign_info BLOB;", "daily_registered_triggers_count", "ALTER TABLE apps ADD COLUMN daily_registered_triggers_count INTEGER;", "client_upload_eligibility", "ALTER TABLE apps ADD COLUMN client_upload_eligibility INTEGER;", "gmp_version_for_remote_config", "ALTER TABLE apps ADD COLUMN gmp_version_for_remote_config INTEGER;"};

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public static final String[] f4098s = {"realtime", "ALTER TABLE raw_events ADD COLUMN realtime INTEGER;"};

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public static final String[] f4099t = {"has_realtime", "ALTER TABLE queue ADD COLUMN has_realtime INTEGER;", "retry_count", "ALTER TABLE queue ADD COLUMN retry_count INTEGER;"};

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    public static final String[] f4100u = {"session_scoped", "ALTER TABLE event_filters ADD COLUMN session_scoped BOOLEAN;"};
    public static final String[] v = {"session_scoped", "ALTER TABLE property_filters ADD COLUMN session_scoped BOOLEAN;"};

    /* JADX INFO: renamed from: w, reason: collision with root package name */
    public static final String[] f4101w = {"previous_install_count", "ALTER TABLE app2 ADD COLUMN previous_install_count INTEGER;"};

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    public static final String[] f4102x = {"consent_source", "ALTER TABLE consent_settings ADD COLUMN consent_source INTEGER;", "dma_consent_settings", "ALTER TABLE consent_settings ADD COLUMN dma_consent_settings TEXT;", "storage_consent_at_bundling", "ALTER TABLE consent_settings ADD COLUMN storage_consent_at_bundling TEXT;"};

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    public static final String[] f4103y = {"idempotent", "CREATE INDEX IF NOT EXISTS trigger_uris_index ON trigger_uris (app_id);"};

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final l f4104m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final s0 f4105n;

    public m(u4 u4Var) {
        super(u4Var);
        this.f4105n = new s0(this.f3876a.f4270t);
        this.f3876a.getClass();
        this.f4104m = new l(this, this.f3876a.f4260a);
    }
    ...
    public final void A(String str, j4 j4Var) {
        ...
        if (j < jLongValue || j > ((Long) e0Var.a(null)).longValue() + jCurrentTimeMillis) {
            t1.m(w0Var);
            w0Var.f4343r.e("Storing trigger URI outside of the max retention time span. appId, now, timestamp", w0.o(str), Long.valueOf(jCurrentTimeMillis), Long.valueOf(j));
        }
        t1.m(w0Var);
        w0Var.f4347w.b("Saving trigger URI");
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("trigger_uri", j4Var.f4063a);
        contentValues.put("source", Integer.valueOf(j4Var.f4065l));
        contentValues.put("timestamp_millis", Long.valueOf(j));
        try {
            if (V().insert("trigger_uris", null, contentValues) == -1) {
                t1.m(w0Var);
                w0Var.f4340o.c(w0.o(str), "Failed to insert trigger URI (got -1). appId");
            }
        } catch (SQLiteException e10) {
            t1.m(w0Var);
            w0Var.f4340o.d(w0.o(str), "Error storing trigger URI. appId", e10);
        }
    }
    ...
    public final void B(String str, j2 j2Var) {
        ...
        contentValues.put("consent_source", Integer.valueOf(j2Var.f4057b));
        D(contentValues);
    }
    ...
    */
    public final java.lang.String C(java.lang.String r4, java.lang.String[] r5) {
        ...
        L20:
            r5 = move-exception
            e1.t1 r0 = r3.f3876a     // Catch: java.lang.Throwable -> L1e
            e1.w0 r0 = r0.f4265o     // Catch: java.lang.Throwable -> L1e
            e1.t1.m(r0)     // Catch: java.lang.Throwable -> L1e
            e1.u0 r0 = r0.f4340o     // Catch: java.lang.Throwable -> L1e
    ...
    public final void D(ContentValues contentValues) {
        ...
        try {
            ...
            if (contentValues.getAsString("app_id") == null) {
                w0 w0Var = t1Var.f4265o;
                t1.m(w0Var);
                w0Var.f4342q.c(w0.o("app_id"), "Value of the primary key is not set.");
                return;
            }
            ...
            if (sQLiteDatabaseV.update("consent_settings", contentValues, r6.toString(), new String[]{r5}) == 0 && sQLiteDatabaseV.insertWithOnConflict("consent_settings", null, contentValues, 5) == -1) {
                ...
                t1.m(w0Var2);
                w0Var2.f4340o.d(w0.o("consent_settings"), "Failed to insert/update table (got -1). key", w0.o("app_id"));
            }
        } catch (SQLiteException e10) {
            w0 w0Var3 = t1Var.f4265o;
            t1.m(w0Var3);
            w0Var3.f4340o.e("Error storing into table. key", w0.o("consent_settings"), w0.o("app_id"), e10);
        }
    }
    ...
    */
    ...
    public final void F(String str, r rVar) {
        ...
        h();
        ContentValues contentValues = new ContentValues();
        String str2 = rVar.f4224a;
        contentValues.put("app_id", str2);
        contentValues.put("name", rVar.f4225b);
        contentValues.put("lifetime_count", Long.valueOf(rVar.f4226c));
        contentValues.put("current_bundle_count", Long.valueOf(rVar.f4227d));
        ...
        contentValues.put("current_session_count", Long.valueOf(rVar.f4228e));
        Boolean bool = rVar.f4229k;
        contentValues.put("last_exempt_from_sampling", (bool == null || !bool.booleanValue()) ? null : 1L);
        try {
            if (V().insertWithOnConflict(str, null, contentValues, 5) == -1) {
                w0 w0Var = t1Var.f4265o;
                t1.m(w0Var);
                w0Var.f4340o.c(w0.o(str2), "Failed to insert/update event aggregates (got -1). appId");
            }
        } catch (SQLiteException e10) {
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4340o.d(w0.o(str2), "Error storing event aggregates. appId", e10);
        }
    }
    ...
    public final void G(String str, String str2) {
        ...
        try {
            ...
            t1.m(w0Var);
            w0Var.f4340o.d(w0.o(str2), "Error deleting snapshot. appId", e10);
        }
    }
    ...
    public final w4 H(String str, long j, byte[] bArr, String str2, String str3, int i, int i6, long j6, long j10, long j11) {
        ...
        t1 t1Var2 = this.f3876a;
        if (zIsEmpty) {
            w0 w0Var = t1Var2.f4265o;
            t1.m(w0Var);
        ...
        try {
            ...
            if (str3 != null) {
                ...
                while (true) {
                    ...
                    if (strArrSplit2.length != 2) {
                        ...
                        t1.m(w0Var2);
                        w0Var2.f4340o.c(str4, "Invalid upload header: ");
                        break;
                    }
            ...
            try {
                ...
                w0 w0Var3 = t1Var.f4265o;
                t1.m(w0Var3);
                w0Var3.f4340o.d(str, "Failed to queued MeasurementBatch from upload_queue. appId", e);
                return w4Var;
            }
    ...
    public final r M(String str, com.google.android.gms.internal.measurement.b3 b3Var, String str2) {
        ...
        if (rVarE != null) {
            long j = rVarE.f4228e + 1;
            long j6 = rVarE.f4227d + 1;
            return new r(rVarE.f4224a, rVarE.f4225b, rVarE.f4226c + 1, j6, j, rVarE.f, rVarE.g, rVarE.h, rVarE.i, rVarE.j, rVarE.f4229k);
        }
        t1 t1Var = this.f3876a;
        w0 w0Var = t1Var.f4265o;
        t1.m(w0Var);
        w0Var.f4343r.d(w0.o(str), "Event aggregate wasn't created during raw event logging. appId, event", t1Var.f4269s.a(str2));
        return new r(str, b3Var.r(), 1L, 1L, 1L, b3Var.t(), 0L, null, null, null, null);
    }

    public final boolean N() {
        return this.f3876a.f4260a.getDatabasePath("google_app_measurement.db").exists();
    }
    ...
    */
    ...
    public final long Q(String str, String[] strArr) {
        ...
        try {
            try {
                ...
                w0 w0Var = this.f3876a.f4265o;
                t1.m(w0Var);
                w0Var.f4340o.d(str, "Database error", e10);
                throw e10;
            }
        } catch (Throwable th) {
            if (0 != 0) {
    ...
    public final SQLiteDatabase V() {
        g();
        try {
            return this.f4104m.getWritableDatabase();
        } catch (SQLiteException e10) {
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.c(e10, "Error opening database");
            throw e10;
        }
    }
    ...
    public final void W(String str) {
        ...
        try {
            try {
                ...
                w0 w0Var = this.f3876a.f4265o;
                t1.m(w0Var);
                w0Var.f4340o.d(w0.o(str), "Error creating snapshot. appId", e10);
            }
            if (cursorQuery != null) {
                cursorQuery.close();
            }
    ...
    */
    ...
    public final void Y(String str, String str2) {
        ...
        try {
            ...
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.e("Error deleting user property. appId", w0.o(str), t1Var.f4269s.c(str2), e10);
        }
    }

    public final boolean Z(y4 y4Var) {
        String str = y4Var.f4427b;
        g();
        h();
        String str2 = y4Var.f4426a;
        String str3 = y4Var.f4428c;
        y4 y4VarA0 = a0(str2, str3);
        t1 t1Var = this.f3876a;
        if (y4VarA0 == null) {
            if (a5.f0(str3)) {
                if (Q("select count(1) from user_attributes where app_id=? and name not like '!_%' escape '!'", new String[]{str2}) >= Math.max(Math.min(t1Var.f4263m.o(str2, f0.W), 100), 25)) {
                    return false;
                }
        ...
        contentValues.put("set_timestamp", Long.valueOf(y4Var.f4429d));
        P(contentValues, y4Var.f4430e);
        try {
            ...
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.c(w0.o(str2), "Failed to insert/update user property (got -1). appId");
            return true;
        } catch (SQLiteException e10) {
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4340o.d(w0.o(str2), "Error storing user property. appId", e10);
            return true;
        }
    }
    ...
    */
    public final e1.y4 a0(java.lang.String r12, java.lang.String r13) {
        ...
        L41:
            ...
            if (r12 == 0) goto L6a
            e1.w0 r12 = r1.f4265o     // Catch: java.lang.Throwable -> L64 android.database.sqlite.SQLiteException -> L67
            e1.t1.m(r12)     // Catch: java.lang.Throwable -> L64 android.database.sqlite.SQLiteException -> L67
            e1.u0 r12 = r12.f4340o     // Catch: java.lang.Throwable -> L64 android.database.sqlite.SQLiteException -> L67
        ...
        L77:
            ...
            r3 = r2
        L7c:
            e1.w0 r13 = r1.f4265o     // Catch: java.lang.Throwable -> L64
            e1.t1.m(r13)     // Catch: java.lang.Throwable -> L64
            e1.u0 r13 = r13.f4340o     // Catch: java.lang.Throwable -> L64
            java.lang.String r0 = "Error querying user property. appId"
            e1.v0 r4 = e1.w0.o(r5)     // Catch: java.lang.Throwable -> L64
            e1.q0 r1 = r1.f4269s     // Catch: java.lang.Throwable -> L64
                    ...
                    if (cursorQuery.moveToFirst()) {
                        while (true) {
                            ...
                            if (objT == null) {
                                w0 w0Var = t1Var.f4265o;
                                t1.m(w0Var);
                                w0Var.f4340o.c(w0.o(str), "Read invalid user property value, ignoring it. appId");
                                str2 = str;
                            } else {
                                str2 = str;
                                try {
                                    ...
                                    w0 w0Var2 = t1Var.f4265o;
                                    t1.m(w0Var2);
                                    w0Var2.f4340o.d(w0.o(str2), "Error querying user properties. appId", e);
    ...
    /* JADX WARN: Code restructure failed: missing block: B:21:0x00af, code lost:
        ...
        e1.t1.m(r13);
        r13.f4340o.c(1000, "Read more than the max allowed user properties, ignoring excess");
     */
    /* JADX WARN: Multi-variable type inference failed */
    ...
    */
    ...
    public final boolean d0(e eVar) {
        g();
        h();
        String str = eVar.f3883a;
        k0.y.g(str);
        y4 y4VarA0 = a0(str, eVar.f3885l.f4403b);
        t1 t1Var = this.f3876a;
        if (y4VarA0 == null) {
        ...
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        contentValues.put("origin", eVar.f3884b);
        contentValues.put("name", eVar.f3885l.f4403b);
        Object objC = eVar.f3885l.c();
        k0.y.g(objC);
        P(contentValues, objC);
        contentValues.put("active", Boolean.valueOf(eVar.f3887n));
        contentValues.put("trigger_event_name", eVar.f3888o);
        contentValues.put("trigger_timeout", Long.valueOf(eVar.f3890q));
        u uVar = eVar.f3889p;
        a5 a5Var = t1Var.f4268r;
        w0 w0Var = t1Var.f4265o;
        t1.k(a5Var);
        contentValues.put("timed_out_event", a5.L(uVar));
        contentValues.put("creation_timestamp", Long.valueOf(eVar.f3886m));
        t1.k(a5Var);
        contentValues.put("triggered_event", a5.L(eVar.f3891r));
        contentValues.put("triggered_timestamp", Long.valueOf(eVar.f3885l.f4404l));
        contentValues.put("time_to_live", Long.valueOf(eVar.f3892s));
        contentValues.put("expired_event", a5.L(eVar.f3893t));
        try {
            if (V().insertWithOnConflict("conditional_properties", null, contentValues, 5) != -1) {
                return true;
            }
            t1.m(w0Var);
            w0Var.f4340o.c(w0.o(str), "Failed to insert/update conditional user property (got -1)");
            return true;
        } catch (SQLiteException e10) {
            t1.m(w0Var);
            w0Var.f4340o.d(w0.o(str), "Error storing conditional user property", e10);
            return true;
        }
    }
    ...
    */
    ...
    public final void f0(String str, String str2) {
        ...
        try {
            ...
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.e("Error deleting conditional property", w0.o(str), t1Var.f4269s.c(str2), e10);
        }
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:7:0x0053, code lost:
        ...
        r3 = r2.f4265o;
        e1.t1.m(r3);
        r3.f4340o.c(1000, "Read more than the max allowed conditional properties, ignoring extra");
     */
    /* JADX WARN: Multi-variable type inference failed */
    /* JADX WARN: Type inference failed for: r0v0, types: [java.util.ArrayList] */
    /* JADX WARN: Type inference failed for: r0v3, types: [java.util.List] */
    ...
    */
    ...
    public final void j0(b1 b1Var, boolean z9) {
        ...
        if (u4Var.d(strD).i(i2.AD_STORAGE)) {
            ...
            t1.m(q1Var);
            q1Var.g();
            contentValues.put("resettable_device_id_hash", b1Var.f3789e);
        }
        ...
        q1 q1Var4 = t1Var.f4266p;
        t1.m(q1Var4);
        q1Var4.g();
        contentValues.put("last_bundle_end_timestamp", Long.valueOf(b1Var.i));
        contentValues.put("app_version", b1Var.N());
        q1 q1Var5 = t1Var.f4266p;
        t1.m(q1Var5);
        q1Var5.g();
        contentValues.put("app_store", b1Var.f3791l);
        q1 q1Var6 = t1Var.f4266p;
        t1.m(q1Var6);
        q1Var6.g();
        contentValues.put("gmp_version", Long.valueOf(b1Var.f3792m));
        q1 q1Var7 = t1Var.f4266p;
        t1.m(q1Var7);
        q1Var7.g();
        contentValues.put("dev_cert_hash", Long.valueOf(b1Var.f3793n));
        q1 q1Var8 = t1Var.f4266p;
        t1.m(q1Var8);
        q1Var8.g();
        contentValues.put("measurement_enabled", Boolean.valueOf(b1Var.f3794o));
        q1 q1Var9 = t1Var.f4266p;
        q1 q1Var10 = t1Var.f4266p;
        t1.m(q1Var9);
        q1Var9.g();
        ...
        q1 q1Var13 = t1Var.f4266p;
        t1.m(q1Var13);
        q1Var13.g();
        contentValues.put("adid_reporting_enabled", Boolean.valueOf(b1Var.f3795p));
        contentValues.put("dynamite_version", Long.valueOf(b1Var.b()));
        if (u4Var.d(strD).i(i2Var)) {
            q1 q1Var14 = t1Var.f4266p;
            t1.m(q1Var14);
            q1Var14.g();
            contentValues.put("session_stitching_token", b1Var.f3799t);
        }
        contentValues.put("sgtm_upload_enabled", Boolean.valueOf(b1Var.y()));
        q1 q1Var15 = t1Var.f4266p;
        t1.m(q1Var15);
        q1Var15.g();
        contentValues.put("target_os_version", Long.valueOf(b1Var.v));
        q1 q1Var16 = t1Var.f4266p;
        t1.m(q1Var16);
        q1Var16.g();
        contentValues.put("session_stitching_token_hash", Long.valueOf(b1Var.f3801w));
        f8.a();
        t1 t1Var2 = this.f3876a;
        g gVar = t1Var2.f4263m;
        w0 w0Var = t1Var2.f4265o;
        if (gVar.q(strD, f0.Q0)) {
            q1 q1Var17 = t1Var.f4266p;
            t1.m(q1Var17);
            q1Var17.g();
            contentValues.put("ad_services_version", Integer.valueOf(b1Var.f3802x));
            q1 q1Var18 = t1Var.f4266p;
            t1.m(q1Var18);
            q1Var18.g();
            contentValues.put("attribution_eligibility_status", Long.valueOf(b1Var.B));
        }
        q1 q1Var19 = t1Var.f4266p;
        t1.m(q1Var19);
        q1Var19.g();
        contentValues.put("unmatched_first_open_without_ad_id", Boolean.valueOf(b1Var.f3803y));
        contentValues.put("npa_metadata_value", b1Var.w());
        q1 q1Var20 = t1Var.f4266p;
        t1.m(q1Var20);
        q1Var20.g();
        ...
        q1 q1Var21 = t1Var.f4266p;
        t1.m(q1Var21);
        q1Var21.g();
        ArrayList arrayList = b1Var.f3798s;
        if (arrayList != null) {
            if (arrayList.isEmpty()) {
                t1.m(w0Var);
                w0Var.f4343r.c(strD, "Safelisted events should not be an empty list. appId");
            } else {
                contentValues.put("safelisted_events", TextUtils.join(",", arrayList));
            }
        }
        if (t1Var2.f4263m.q(null, f0.L0) && !contentValues.containsKey("safelisted_events")) {
            contentValues.put("safelisted_events", (String) null);
        }
        q1 q1Var22 = t1Var.f4266p;
        t1.m(q1Var22);
        q1Var22.g();
        contentValues.put("unmatched_pfo", b1Var.f3804z);
        q1 q1Var23 = t1Var.f4266p;
        t1.m(q1Var23);
        q1Var23.g();
        contentValues.put("unmatched_uwa", b1Var.A);
        q1 q1Var24 = t1Var.f4266p;
        t1.m(q1Var24);
        q1Var24.g();
        ...
        try {
            ...
            if (sQLiteDatabaseV.update("apps", contentValues, "app_id = ?", new String[]{strD}) == 0 && sQLiteDatabaseV.insertWithOnConflict("apps", null, contentValues, 5) == -1) {
                t1.m(w0Var);
                w0Var.f4340o.c(w0.o(strD), "Failed to insert/update app (got -1). appId");
            }
        } catch (SQLiteException e10) {
            t1.m(w0Var);
            w0Var.f4340o.d(w0.o(strD), "Error storing app. appId", e10);
        }
    }
    ...
    public final long k(String str, com.google.android.gms.internal.measurement.h3 h3Var, String str2, Map map, i3 i3Var, Long l10) {
        ...
        if (zN) {
            u4 u4Var = this.f4093b;
            long jA = u4Var.f4314r.f4421o.a();
            p0.a aVar = t1Var.f4270t;
            w0 w0Var = t1Var.f4265o;
            aVar.getClass();
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            if (Math.abs(jElapsedRealtime - jA) > ((Long) f0.N.a(null)).longValue()) {
                u4Var.f4314r.f4421o.b(jElapsedRealtime);
                g();
                h();
                if (N() && (iDelete = V().delete("upload_queue", I(), new String[0])) > 0) {
                    t1.m(w0Var);
                    w0Var.f4347w.c(Integer.valueOf(iDelete), "Deleted stale MeasurementBatch rows from upload_queue. rowsDeleted");
                }
                k0.y.d(str);
                g();
                h();
                try {
                    int iO = t1Var.f4263m.o(str, f0.A);
                    if (iO > 0) {
                    ...
                    t1.m(w0Var);
                    w0Var.f4340o.d(w0.o(str), "Error deleting over the limit queued batches. appId", e10);
                }
            }
        }
        ArrayList arrayList = new ArrayList();
        ...
        contentValues.put("upload_type", Integer.valueOf(i3Var.f4047a));
        p0.a aVar2 = t1Var.f4270t;
        w0 w0Var2 = t1Var.f4265o;
        aVar2.getClass();
        ...
        try {
            ...
            t1.m(w0Var2);
            w0Var2.f4340o.c(str, "Failed to insert MeasurementBatch (got -1) to upload_queue. appId");
            return -1L;
        } catch (SQLiteException e11) {
            t1.m(w0Var2);
            w0Var2.f4340o.d(str, "Error storing MeasurementBatch to upload_queue. appId", e11);
            return -1L;
        }
    }
    ...
    */
            ...
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    if (cursorQuery.getLong(0) == j) {
                        jVar.f4050b = cursorQuery.getLong(1);
                        jVar.f4049a = cursorQuery.getLong(2);
                        jVar.f4051c = cursorQuery.getLong(3);
                        jVar.f4052d = cursorQuery.getLong(4);
                        jVar.f4053e = cursorQuery.getLong(5);
                    ...
                    contentValues.put("daily_public_events_count", Long.valueOf(jVar.f4049a));
                    contentValues.put("daily_events_count", Long.valueOf(jVar.f4050b));
                    contentValues.put("daily_conversions_count", Long.valueOf(jVar.f4051c));
                    contentValues.put("daily_error_events_count", Long.valueOf(jVar.f4052d));
                    contentValues.put("daily_realtime_events_count", Long.valueOf(jVar.f4053e));
                    ...
                    w0 w0Var = t1Var.f4265o;
                    t1.m(w0Var);
                    w0Var.f4343r.c(w0.o(str), "Not updating daily counts, app is not known. appId");
                }
            } catch (SQLiteException e10) {
                w0 w0Var2 = t1Var.f4265o;
                t1.m(w0Var2);
                w0Var2.f4340o.d(w0.o(str), "Error updating daily counts. appId", e10);
            }
            if (cursorQuery != null) {
                cursorQuery.close();
            }
    ...
    public final boolean m(String str) {
        ...
        arrayList.add(Integer.valueOf(i3VarArr[0].f4047a));
    ...
    */
    public final b5.m m0(java.lang.String r12) throws java.lang.Throwable {
        ...
        L30:
            ...
            if (r6 == 0) goto L5b
            e1.w0 r6 = r1.f4265o     // Catch: java.lang.Throwable -> L56 android.database.sqlite.SQLiteException -> L59
            e1.t1.m(r6)     // Catch: java.lang.Throwable -> L56 android.database.sqlite.SQLiteException -> L59
            e1.u0 r6 = r6.f4340o     // Catch: java.lang.Throwable -> L56 android.database.sqlite.SQLiteException -> L59
        ...
        L6d:
            ...
            r3 = r2
        L6f:
            e1.w0 r1 = r1.f4265o     // Catch: java.lang.Throwable -> L56
            e1.t1.m(r1)     // Catch: java.lang.Throwable -> L56
            e1.u0 r1 = r1.f4340o     // Catch: java.lang.Throwable -> L56
    ...
    public final void n(Long l10) {
        ...
        try {
            if (V().delete("upload_queue", "rowid=?", new String[]{l10.toString()}) != 1) {
                w0 w0Var = t1Var.f4265o;
                t1.m(w0Var);
                w0Var.f4343r.b("Deleted fewer rows from upload_queue than expected");
            }
        } catch (SQLiteException e10) {
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4340o.c(e10, "Failed to delete a MeasurementBatch in a upload_queue table");
            throw e10;
        }
    }
    ...
    public final void n0(com.google.android.gms.internal.measurement.j3 j3Var, boolean z9) {
        ...
        if (jB2 < jCurrentTimeMillis - ((Long) e0Var.a(null)).longValue() || j3Var.b2() > ((Long) e0Var.a(null)).longValue() + jCurrentTimeMillis) {
            t1.m(w0Var);
            w0Var.f4343r.e("Storing bundle outside of the max uploading time span. appId, now, timestamp", w0.o(j3Var.o()), Long.valueOf(jCurrentTimeMillis), Long.valueOf(j3Var.b2()));
        }
        byte[] bArrA = j3Var.a();
        try {
            a1 a1Var = this.f4093b.f4312p;
            u4.U(a1Var);
            byte[] bArrS = a1Var.S(bArrA);
            t1.m(w0Var);
            w0Var.f4347w.c(Integer.valueOf(bArrS.length), "Saving bundle, size");
            ContentValues contentValues = new ContentValues();
            ...
            try {
                if (V().insert("queue", null, contentValues) == -1) {
                    t1.m(w0Var);
                    w0Var.f4340o.c(w0.o(j3Var.o()), "Failed to insert bundle (got -1). appId");
                }
            } catch (SQLiteException e10) {
                t1.m(w0Var);
                w0Var.f4340o.d(w0.o(j3Var.o()), "Error storing bundle. appId", e10);
            }
        } catch (IOException e11) {
            t1.m(w0Var);
            w0Var.f4340o.d(w0.o(j3Var.o()), "Data loss. Failed to serialize bundle. appId", e11);
        }
    }
    ...
    */
    public final java.lang.String o() throws java.lang.Throwable {
        ...
        L24:
            ...
            r0 = r1
        L27:
            e1.t1 r3 = r6.f3876a     // Catch: java.lang.Throwable -> L1a
            e1.w0 r3 = r3.f4265o     // Catch: java.lang.Throwable -> L1a
            e1.t1.m(r3)     // Catch: java.lang.Throwable -> L1a
            e1.u0 r3 = r3.f4340o     // Catch: java.lang.Throwable -> L1a
    ...
    public final void p(long j) {
        ...
        try {
            ...
            w0 w0Var = this.f3876a.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.c(e10, "Failed to delete a bundle in a queue table");
            throw e10;
        }
    }
    ...
    public final void q() {
        ...
        if (N()) {
            u4 u4Var = this.f4093b;
            long jA = u4Var.f4314r.f4420n.a();
            t1 t1Var = this.f3876a;
            t1Var.f4270t.getClass();
            long jElapsedRealtime = SystemClock.elapsedRealtime();
            if (Math.abs(jElapsedRealtime - jA) > ((Long) f0.N.a(null)).longValue()) {
                u4Var.f4314r.f4420n.b(jElapsedRealtime);
                g();
                h();
                if (N()) {
                    SQLiteDatabase sQLiteDatabaseV = V();
                    ...
                    if (iDelete > 0) {
                        w0 w0Var = t1Var.f4265o;
                        t1.m(w0Var);
                        w0Var.f4347w.c(Integer.valueOf(iDelete), "Deleted stale rows. rowsDeleted");
                    }
                }
            }
        }
    ...
    public final void r(ArrayList arrayList) {
        ...
        if (N()) {
            ...
            if (jQ > 0) {
                w0 w0Var = t1Var.f4265o;
                t1.m(w0Var);
                w0Var.f4343r.b("The number of upload retries exceeds the limit. Will remain unchanged.");
            }
            try {
                SQLiteDatabase sQLiteDatabaseV = V();
                ...
                w0 w0Var2 = t1Var.f4265o;
                t1.m(w0Var2);
                w0Var2.f4340o.c(e10, "Error incrementing retry count. error");
            }
        }
    }
    ...
    public final Object t(Cursor cursor, int i) {
        ...
        if (type == 0) {
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.b("Loaded invalid null value from database");
            return null;
        }
        if (type == 1) {
        ...
        if (type != 4) {
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4340o.c(Integer.valueOf(type), "Loaded invalid unknown value type, ignoring it");
            return null;
        }
        w0 w0Var3 = t1Var.f4265o;
        t1.m(w0Var3);
        w0Var3.f4340o.b("Loaded invalid blob type value, ignoring it");
        return null;
    }
    ...
    */
    public final long u(java.lang.String r14) {
        /*
            ...
            int r1 = (r9 > r7 ? 1 : (r9 == r7 ? 0 : -1))
            if (r1 != 0) goto L6f
            e1.w0 r1 = r0.f4265o     // Catch: java.lang.Throwable -> L6b android.database.sqlite.SQLiteException -> L6d
            e1.t1.m(r1)     // Catch: java.lang.Throwable -> L6b android.database.sqlite.SQLiteException -> L6d
            e1.u0 r1 = r1.f4340o     // Catch: java.lang.Throwable -> L6b android.database.sqlite.SQLiteException -> L6d
        ...
        L70:
            ...
            if (r1 != 0) goto La4
            e1.w0 r1 = r0.f4265o     // Catch: java.lang.Throwable -> L6b android.database.sqlite.SQLiteException -> La2
            e1.t1.m(r1)     // Catch: java.lang.Throwable -> L6b android.database.sqlite.SQLiteException -> La2
            e1.u0 r1 = r1.f4340o     // Catch: java.lang.Throwable -> L6b android.database.sqlite.SQLiteException -> La2
        ...
        La9:
            r4 = r9
        Laa:
            e1.w0 r0 = r0.f4265o     // Catch: java.lang.Throwable -> L6b
            e1.t1.m(r0)     // Catch: java.lang.Throwable -> L6b
            e1.u0 r0 = r0.f4340o     // Catch: java.lang.Throwable -> L6b
    ...
    public final void x(String str, Long l10, long j, com.google.android.gms.internal.measurement.b3 b3Var) {
        ...
        w0 w0Var2 = t1Var.f4265o;
        t1.m(w0Var);
        w0Var.f4347w.d(t1Var.f4269s.a(str), "Saving complex main event, appId, data size", Integer.valueOf(bArrA.length));
        ContentValues contentValues = new ContentValues();
        contentValues.put("app_id", str);
        ...
        try {
            if (V().insertWithOnConflict("main_event_params", null, contentValues, 5) == -1) {
                t1.m(w0Var2);
                w0Var2.f4340o.c(w0.o(str), "Failed to insert complex main event (got -1). appId");
            }
        } catch (SQLiteException e10) {
            t1.m(w0Var2);
            w0Var2.f4340o.d(w0.o(str), "Error storing complex main event. appId", e10);
        }
    }
    ...
    */
    public final e1.j2 z(java.lang.String r5) {
        /*
            ...
            if (r1 != 0) goto L34
            e1.w0 r1 = r0.f4265o     // Catch: java.lang.Throwable -> L30 android.database.sqlite.SQLiteException -> L32
            e1.t1.m(r1)     // Catch: java.lang.Throwable -> L30 android.database.sqlite.SQLiteException -> L32
            e1.u0 r1 = r1.f4347w     // Catch: java.lang.Throwable -> L30 android.database.sqlite.SQLiteException -> L32
        ...
        L48:
            ...
            r5 = r2
        L4b:
            e1.w0 r0 = r0.f4265o     // Catch: java.lang.Throwable -> L30
            e1.t1.m(r0)     // Catch: java.lang.Throwable -> L30
            e1.u0 r0 = r0.f4340o     // Catch: java.lang.Throwable -> L30
