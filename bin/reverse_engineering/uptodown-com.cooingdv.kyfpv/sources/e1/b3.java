...
public final class b3 extends h0 {
    ...
    public android.support.v4.media.g f3811m;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final CopyOnWriteArraySet f3812n;

    /* JADX INFO: renamed from: o, reason: collision with root package name */
    public boolean f3813o;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public final AtomicReference f3814p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public final Object f3815q;
    ...
    public final AtomicLong f3822y;
    ...
    public b3(t1 t1Var) {
        super(t1Var);
        this.f3812n = new CopyOnWriteArraySet();
        this.f3815q = new Object();
        this.f3816r = false;
        this.f3817s = 1;
        this.B = true;
        this.F = new a3.d(this, 24);
        this.f3814p = new AtomicReference();
        this.f3821x = j2.f4055c;
        this.f3823z = -1L;
        this.f3822y = new AtomicLong(0L);
        this.A = new s1(t1Var);
    }
    ...
    public final void A(Bundle bundle, int i, long j) {
        ...
        if (string != null) {
            ...
            t1.m(w0Var);
            w0Var.f4345t.c(string, "Ignoring invalid consent setting");
            w0 w0Var2 = t1Var.f4265o;
            t1.m(w0Var2);
            w0Var2.f4345t.b("Valid consent values are 'granted', 'denied'");
        }
        q1 q1Var = t1Var.f4266p;
        t1.m(q1Var);
        boolean zM = q1Var.m();
        j2 j2VarB = j2.b(i, bundle);
        Iterator it = j2VarB.f4056a.values().iterator();
        while (true) {
        ...
        Iterator it2 = oVarC.f4172e.values().iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
    ...
    public final void D() {
        ...
        if (gVar.q(null, f0.R0)) {
            ...
            if (q1Var.m()) {
                t1.m(w0Var);
                w0Var.f4340o.b("Cannot get trigger URIs from analytics worker thread");
                return;
            }
            if (q2.e.g()) {
                t1.m(w0Var);
                w0Var.f4340o.b("Cannot get trigger URIs from main thread");
                return;
            }
            h();
            t1.m(w0Var);
            w0Var.f4347w.b("Getting trigger URIs (FE)");
            ...
            if (list == null) {
                t1.m(w0Var);
                w0Var.f4342q.b("Timed out waiting for get trigger URIs");
            } else {
                t1.m(q1Var);
                q1Var.p(new Runnable() { // from class: e1.y2
                    @Override // java.lang.Runnable
                    public final void run() {
                        b3 b3Var = this.f4417a;
                        b3Var.g();
                        ...
                        for (j4 j4Var : list) {
                            int i = j4Var.f4065l;
                            if (!sparseArrayM.contains(i) || ((Long) sparseArrayM.get(i)).longValue() < j4Var.f4064b) {
                                b3Var.E().add(j4Var);
                            }
                        }
                        b3Var.F();
    ...
    public final PriorityQueue E() {
        if (this.v == null) {
            this.v = new PriorityQueue(Comparator$CC.comparing(z2.f4458a, n5.f1901b));
        }
        return this.v;
    }
    ...
    public final void F() {
        ...
        g();
        this.f3820w = false;
        if (E().isEmpty() || this.f3816r || (j4Var = (j4) E().poll()) == null) {
            return;
        }
        t1 t1Var = this.f3876a;
        a5 a5Var = t1Var.f4268r;
        t1.k(a5Var);
        if (a5Var.f3777o == null) {
            a5Var.f3777o = MeasurementManagerFutures.from(a5Var.f3876a.f4260a);
        }
        MeasurementManagerFutures measurementManagerFutures = a5Var.f3777o;
        if (measurementManagerFutures != null) {
            this.f3816r = true;
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            u0 u0Var = w0Var.f4347w;
            String str = j4Var.f4063a;
    ...
    public final void k(j2 j2Var) {
        g();
        boolean z9 = (j2Var.i(i2.ANALYTICS_STORAGE) && j2Var.i(i2.AD_STORAGE)) || this.f3876a.p().p();
        t1 t1Var = this.f3876a;
        q1 q1Var = t1Var.f4266p;
        t1.m(q1Var);
        q1Var.g();
    ...
    */
    ...
    public final void m() {
        ...
        if (((Boolean) e0Var.a(null)).booleanValue()) {
            ...
            l1.l lVar = nVarA2.f7059b;
            if (lVar == null) {
                str2 = strA;
                i17 = i15;
                i18 = i16;
                l1.l lVar2 = new l1.l(nVarA2, new l1.m(nVarA2.f7079n, 0, nVarA2.f7080o));
                nVarA2.f7059b = lVar2;
                lVar = lVar2;
            } else {
                i17 = i15;
        ...
        t1.m(w0Var);
        w0 w0Var3 = w0Var;
        u0 u0Var = w0Var3.f4347w;
        u0Var.c(g4Var, "Tcf preferences read");
        if (!t1Var.f4263m.q(null, e0Var)) {
            if (g1Var.o(g4Var)) {
        ...
        if (TextUtils.isEmpty(string)) {
            ...
            for (String str4 : string.split(";")) {
                ...
                if (strArrSplit.length >= 2 && i4.f4048a.contains(strArrSplit[0])) {
        ...
        if (g1Var.o(g4Var)) {
            ...
            String str6 = (String) g4Var.f4003a.get("PurposeDiagnostics");
    ...
    */
    ...
    public final void s() {
        ...
        if (t1Var.h()) {
            ...
            w3VarP.s();
            t1 t1Var2 = w3VarP.f3876a;
            t1Var2.f4263m.q(null, f0.f3920c1);
    ...
    public final void t(Bundle bundle, long j) {
        ...
        if (!zIsEmpty) {
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4343r.b("Package name should be null when calling setConditionalUserProperty");
        }
        ...
        if (a5Var.m0(string) != 0) {
            t1.m(w0Var2);
            w0Var2.f4340o.c(q0Var.c(string), "Invalid conditional user property name");
            return;
        }
        t1.k(a5Var);
        if (a5Var.t(obj, string) != 0) {
            t1.m(w0Var2);
            w0Var2.f4340o.d(q0Var.c(string), "Invalid conditional user property value", obj);
            return;
        }
        Object objU = a5Var.u(obj, string);
        if (objU == null) {
            t1.m(w0Var2);
            w0Var2.f4340o.d(q0Var.c(string), "Unable to normalize conditional user property value", obj);
            return;
        }
        k2.c(bundle2, objU);
        ...
        if (!TextUtils.isEmpty(bundle2.getString("trigger_event_name")) && (j6 > 15552000000L || j6 < 1)) {
            t1.m(w0Var2);
            w0Var2.f4340o.d(q0Var.c(string), "Invalid conditional user property timeout", Long.valueOf(j6));
            return;
        }
        long j10 = bundle2.getLong("time_to_live");
        if (j10 > 15552000000L || j10 < 1) {
            t1.m(w0Var2);
            w0Var2.f4340o.d(q0Var.c(string), "Invalid conditional user property time to live", Long.valueOf(j10));
        } else {
            q1 q1Var = t1Var.f4266p;
            t1.m(q1Var);
    ...
    public final String v() {
        t1 t1Var = this.f3876a;
        try {
            return k2.b(t1Var.f4260a, t1Var.f4274y);
        } catch (IllegalStateException e10) {
            w0 w0Var = t1Var.f4265o;
            t1.m(w0Var);
            w0Var.f4340o.c(e10, "getGoogleAppId failed with exception");
            return null;
        }
    }
    ...
    public final void w(j2 j2Var, long j, boolean z9) {
        ...
        t1.k(g1Var);
        j2 j2VarN = g1Var.n();
        if (j <= this.f3823z && j2.l(j2VarN.f4057b, i)) {
            t1.m(w0Var);
            w0Var.f4346u.c(j2Var, "Dropped out-of-date consent setting, proposed settings");
            return;
        }
        ...
        if (!j2.l(i, g1Var2.k().getInt("consent_source", 100))) {
            t1.m(w0Var);
            w0Var.f4346u.c(Integer.valueOf(i), "Lower precedence consent source ignored, proposed source");
            return;
        }
        ...
        editorEdit.apply();
        t1.m(w0Var);
        w0Var.f4347w.c(j2Var, "Setting storage consent(FE)");
        this.f3823z = j;
        if (t1Var.p().q()) {
            w3 w3VarP = t1Var.p();
            w3VarP.g();
    ...
    public final void z() {
        t1 t1Var = this.f3876a;
        if (!(t1Var.f4260a.getApplicationContext() instanceof Application) || this.f3810l == null) {
            return;
        }
        ((Application) t1Var.f4260a.getApplicationContext()).unregisterActivityLifecycleCallbacks(this.f3810l);
    }
}
