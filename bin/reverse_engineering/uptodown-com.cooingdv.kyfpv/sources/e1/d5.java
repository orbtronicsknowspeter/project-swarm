...
public final class d5 {
    ...
    public final com.google.android.gms.internal.measurement.m3 f3880c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final BitSet f3881d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final BitSet f3882e;
    ...
    public final void a(b bVar) {
        ...
        if (bVar.f3782c != null) {
            this.f3882e.set(iP, true);
        }
        Boolean bool = bVar.f3783d;
        if (bool != null) {
            this.f3881d.set(iP, bool.booleanValue());
        }
        if (bVar.f3784e != null) {
            Integer numValueOf = Integer.valueOf(iP);
            ArrayMap arrayMap = this.f;
            Long l10 = (Long) arrayMap.get(numValueOf);
            long jLongValue = bVar.f3784e.longValue() / 1000;
        ...
        if (bVar.f != null) {
            ...
            r7.a();
            boolean zQ = t1Var.f4263m.q(str, e0Var);
            Long l11 = bVar.f;
            if (!zQ) {
    ...
    public final com.google.android.gms.internal.measurement.t2 b(int i) {
        ...
        s2VarV.b();
        ((com.google.android.gms.internal.measurement.t2) s2VarV.f2687b).z(this.f3879b);
        com.google.android.gms.internal.measurement.m3 m3Var = this.f3880c;
        if (m3Var != null) {
            s2VarV.b();
        ...
        ArrayList arrayListO = a1.O(this.f3881d);
        l3VarW.b();
        ((com.google.android.gms.internal.measurement.m3) l3VarW.f2687b).A(arrayListO);
        ArrayList arrayListO2 = a1.O(this.f3882e);
        l3VarW.b();
    ...
    public /* synthetic */ d5(c cVar, String str) {
        ...
        this.f3878a = str;
        this.f3879b = true;
        this.f3881d = new BitSet();
        this.f3882e = new BitSet();
        this.f = new ArrayMap();
        this.g = new ArrayMap();
    }
}
