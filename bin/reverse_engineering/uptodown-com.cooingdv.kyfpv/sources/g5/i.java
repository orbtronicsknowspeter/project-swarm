...
public final class i implements OnItemViewSelectedListener {
    ...
    public final /* synthetic */ TvAppsListFragment f5323a;

    public i(TvAppsListFragment tvAppsListFragment) {
        this.f5323a = tvAppsListFragment;
    }

    @Override // androidx.leanback.widget.BaseOnItemViewSelectedListener
    public final void onItemSelected(Presenter.ViewHolder viewHolder, Object obj, RowPresenter.ViewHolder viewHolder2, Row row) {
        if (obj != null) {
            TvAppsListFragment tvAppsListFragment = this.f5323a;
            ...
            int i = tvAppsListFragment.f3430l;
            if (iIndexOf >= i || iIndexOf < i - 5 || tvAppsListFragment.f3431m) {
                return;
            }
