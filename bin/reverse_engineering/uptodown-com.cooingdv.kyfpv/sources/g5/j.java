...
public final class j extends v6.i implements d7.p {
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f5325a) {
            case 0:
                return new j(this.f5327l, cVar, 0);
            default:
                return new j(this.f5327l, cVar, 1);
        }
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        int i = this.f5325a;
        int i6 = 0;
        TvAppsListFragment tvAppsListFragment = this.f5327l;
        ...
        switch (i) {
            case 0:
                ...
                if (i10 != 0) {
                    ...
                    tvAppsListFragment.f3431m = true;
                    ...
                    x4.j jVar = tvAppsListFragment.f3429b;
                    if (jVar != null) {
                        int i11 = jVar.f11225a;
                        if (i11 == -2) {
                            g2VarM = vVar.m(75, tvAppsListFragment.f3430l);
                        } else if (i11 != -1) {
                            jVar.getClass();
                            boolean z9 = jVar.f11228m;
                            x4.j jVar2 = tvAppsListFragment.f3429b;
                            if (z9) {
                                jVar2.getClass();
                                g2VarM = vVar.u(jVar2.f11225a, 75, tvAppsListFragment.f3430l);
                            } else {
                                jVar2.getClass();
                                g2VarM = vVar.t(jVar2.f11225a, 75, tvAppsListFragment.f3430l);
                            }
                        } else {
                            g2VarM = vVar.s(75, tvAppsListFragment.f3430l);
                        }
                    } else {
                        g2VarM = null;
                    }
            ...
            default:
                ...
                if (i12 != 0) {
                    ...
                    Object objC = o7.c0.C(new j(tvAppsListFragment, cVar, i6), v7.d.f10885a, this);
                    if (objC != aVar) {
                        objC = xVar;
                    }
                    if (objC == aVar) {
