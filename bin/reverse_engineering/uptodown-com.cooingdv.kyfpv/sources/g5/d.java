...
public final class d extends v6.i implements d7.p {
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f5303a) {
            case 0:
                return new d(this.f5304b, cVar, 0);
            case 1:
                return new d(this.f5304b, cVar, 1);
            default:
                return new d(this.f5304b, cVar, 2);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        switch (this.f5303a) {
            case 0:
                ...
                return xVar;
            case 1:
                return ((d) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
            default:
    ...
    public final Object invokeSuspend(Object obj) {
        int i = this.f5303a;
        p6.x xVar = p6.x.f8464a;
        TvAppDetailFragment tvAppDetailFragment = this.f5304b;
        switch (i) {
            case 0:
                p6.a.e(obj);
                if (tvAppDetailFragment.getContext() != null) {
                    e5.b bVar = tvAppDetailFragment.f3424t;
                    bVar.getClass();
                    ...
                    if (bVar2 != null) {
                        LinearLayout linearLayout = bVar2.f5669q;
            ...
            case 1:
                ...
                try {
                    ...
                    if ((gVar2 != null ? gVar2.e() : null) != null) {
                        BackgroundManager backgroundManager = tvAppDetailFragment.f3418n;
                        ...
                        Drawable drawable = ContextCompat.getDrawable(tvAppDetailFragment.requireContext(), R.drawable.feature_tv);
                        BackgroundManager backgroundManager2 = tvAppDetailFragment.f3418n;
