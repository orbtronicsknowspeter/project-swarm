...
public final class c0 implements OnItemViewClickedListener {
    ...
    public final /* synthetic */ TvMyDownloadsFragment f5302a;

    public c0(TvMyDownloadsFragment tvMyDownloadsFragment) {
        this.f5302a = tvMyDownloadsFragment;
    }
    ...
    public final void onItemClicked(Presenter.ViewHolder viewHolder, Object obj, RowPresenter.ViewHolder viewHolder2, Row row) {
        if (obj instanceof x4.r) {
            ...
            final TvMyDownloadsFragment tvMyDownloadsFragment = this.f5302a;
            AlertDialog alertDialog = tvMyDownloadsFragment.f3439b;
            if (alertDialog != null) {
                alertDialog.dismiss();
            }
            ...
            ((TextView) viewInflate.findViewById(R.id.tv_install)).setOnClickListener(new View.OnClickListener() { // from class: g5.b0
                ...
                public final void onClick(View view) {
                    ...
                    switch (i6) {
                        case 0:
                            ...
                            AlertDialog alertDialog2 = tvMyDownloadsFragment2.f3439b;
                        ...
                        default:
                            ...
                            gVarL.j(rVar2);
                            gVarL.c();
                            ArrayObjectAdapter arrayObjectAdapter = tvMyDownloadsFragment2.f3438a;
                            arrayObjectAdapter.getClass();
                            arrayObjectAdapter.remove(rVar2);
                            AlertDialog alertDialog3 = tvMyDownloadsFragment2.f3439b;
            ...
            final int i6 = 1;
            ((TextView) viewInflate.findViewById(R.id.tv_delete)).setOnClickListener(new View.OnClickListener() { // from class: g5.b0
                @Override // android.view.View.OnClickListener
                public final void onClick(View view) {
                    File fileG;
                    int i62 = i6;
            ...
            tvMyDownloadsFragment.f3439b = alertDialogCreate;
