...
public final /* synthetic */ class u implements ActivityResultCallback, OnItemViewClickedListener {
    ...
    public final /* synthetic */ v f5359a;
    ...
    public void onActivityResult(Object obj) {
        if (((ActivityResult) obj).getResultCode() == 1003) {
            ...
            gVarL.c();
            String string = vVar.getString(R.string.restart_for_changes_take_effect);
            string.getClass();
            AlertDialog.Builder builder = new AlertDialog.Builder(vVar.getContext());
            builder.setMessage(string);
            builder.setPositiveButton(android.R.string.ok, new f5.b(7));
    ...
    public void onItemClicked(Presenter.ViewHolder viewHolder, Object obj, RowPresenter.ViewHolder viewHolder2, Row row) {
        if (obj instanceof c5.b) {
            ...
            if (i == 2) {
                ...
                vVar.f5361b.launch(new Intent(vVar.getContext(), (Class<?>) PreferencesActivity.class));
            }
        }
    }
}
