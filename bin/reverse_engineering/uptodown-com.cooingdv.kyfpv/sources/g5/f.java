...
public final class f implements a4.i, g8.h, j1.f, t.b, ViewBinding, w1.a, j1.h, j1.d, SearchView.OnQueryTextListener {
    ...
    public f(int i) {
        ...
        switch (i) {
            case 5:
                break;
            case 9:
                this.f5310b = new ArrayList(20);
                break;
            case 12:
                this.f5310b = new LinkedHashSet();
                break;
            default:
                this.f5310b = new j1.p();
                break;
        }
    }
    ...
    public String C(String str) {
        ArrayList arrayList = (ArrayList) this.f5310b;
    ...
    public String L(String str) {
        Bundle bundle = (Bundle) this.f5310b;
    ...
    public void a(j7.c cVar, j7.c cVar2, z7.b bVar) {
        ((g8.g) this.f5310b).j(cVar, cVar2, bVar, true);
    }

    @Override // g8.h
    public void b(j7.c cVar, d7.l lVar) {
        cVar.getClass();
        ((g8.g) this.f5310b).k(cVar, new g8.b(lVar), true);
    }

    @Override // j1.f
    public void c(Object obj) {
        ((j1.i) ((g) this.f5310b).f5316b).f6540a.n();
    }

    @Override // g8.h
    public void d(j7.c cVar, z7.b bVar) {
        bVar.getClass();
        ((g8.g) this.f5310b).k(cVar, new g8.a(bVar), true);
    }

    @Override // g8.h
    public void e(j7.c cVar, d7.l lVar) {
        ((g8.g) this.f5310b).h(cVar, lVar, true);
    }

    @Override // g8.h
    public void f(j7.c cVar, d7.l lVar) {
        ((g8.g) this.f5310b).i(cVar, lVar, true);
    }
    ...
    public View getRoot() {
        return (RelativeLayout) this.f5310b;
    }
    ...
    public void i(Bundle bundle) {
        ((p1.b) ((p1.a) this.f5310b)).a("clx", "_ae", bundle);
    }
    ...
    public h8.c j(JSONObject jSONObject) throws JSONException, ParseException {
        ...
        g2.c cVar;
        h8.c cVar2 = new h8.c();
        cVar2.f5460a = jSONObject.optInt("gvlSpecificationVersion");
        cVar2.f5461b = Integer.valueOf(jSONObject.optInt("vendorListVersion"));
        cVar2.f5462c = Integer.valueOf(jSONObject.optInt("tcfPolicyVersion"));
        String strOptString = jSONObject.optString("lastUpdated");
        strOptString.getClass();
        Date date = new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss", (Locale) this.f5310b).parse(strOptString);
        if (date != null) {
            date.getTime();
        }
    ...
    public Object k(String str) {
        ...
        switch (this.f5309a) {
            case 5:
                str.getClass();
                try {
                    this.f5310b = new JSONArray(str);
                    LinkedHashMap linkedHashMapL = l();
                    u5.d dVar = new u5.d();
                    dVar.f10711a = linkedHashMapL;
                    return dVar;
                } catch (JSONException unused) {
            ...
            case 6:
                ...
                try {
                    ...
                    ChoiceCmpCallback choiceCmpCallback = (ChoiceCmpCallback) this.f5310b;
    ...
    public LinkedHashMap l() throws JSONException {
        LinkedHashMap linkedHashMap = new LinkedHashMap();
        JSONArray jSONArray = (JSONArray) this.f5310b;
        if (jSONArray == null) {
        ...
        while (i < length) {
            int i6 = i + 1;
            JSONArray jSONArray2 = (JSONArray) this.f5310b;
            if (jSONArray2 == null) {
                kotlin.jvm.internal.l.i("googleVendorsJson");
                throw null;
            }
            ...
            JSONArray jSONArray3 = (JSONArray) this.f5310b;
            if (jSONArray3 == null) {
                kotlin.jvm.internal.l.i("googleVendorsJson");
                throw null;
            }
    ...
    public j1.p q(Object obj) {
        g2.d dVar = (g2.d) obj;
        y1.l lVar = ((y1.j) this.f5310b).f11632e;
        if (dVar != null) {
            return t1.Q(Arrays.asList(y1.l.a(lVar), lVar.f11644m.o(null, lVar.f11641e.f11909a)));
        }
    ...
    public void s(j1.p pVar) {
        ...
        if (excF != null) {
            ((o7.l) this.f5310b).resumeWith(new p6.j(excF));
            return;
        }
        boolean z9 = pVar.f6564d;
        o7.l lVar = (o7.l) this.f5310b;
        if (z9) {
            lVar.o(null);
        } else {
    ...
    public synchronized void w(m8.f0 f0Var) {
        ((LinkedHashSet) this.f5310b).remove(f0Var);
    }

    public String z(Object obj) {
        StringWriter stringWriter = new StringWriter();
        try {
            n2.d dVar = (n2.d) this.f5310b;
            n2.e eVar = new n2.e(stringWriter, dVar.f7928a, dVar.f7929b, dVar.f7930c, dVar.f7931d);
            eVar.h(obj);
            eVar.j();
            eVar.f7933b.flush();
    ...
    public f(RelativeLayout relativeLayout, ImageView imageView, RelativeLayout relativeLayout2, TextView textView, TextView textView2) {
        this.f5309a = 14;
        this.f5310b = relativeLayout;
    }

    public f(Bundle bundle) {
        this.f5309a = 18;
        if (bundle != null) {
            this.f5310b = new Bundle(bundle);
        } else {
