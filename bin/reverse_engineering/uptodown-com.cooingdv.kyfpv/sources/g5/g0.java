...
public final class g0 extends v6.i implements d7.p {
    ...
    public final /* synthetic */ TvSearchFragment f5319l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final /* synthetic */ String f5320m;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public /* synthetic */ g0(TvSearchFragment tvSearchFragment, String str, t6.c cVar, int i) {
        super(2, cVar);
        this.f5317a = i;
        this.f5319l = tvSearchFragment;
        this.f5320m = str;
    }
    ...
    public final t6.c create(Object obj, t6.c cVar) {
        switch (this.f5317a) {
            case 0:
                return new g0(this.f5319l, this.f5320m, cVar, 0);
            default:
                return new g0(this.f5319l, this.f5320m, cVar, 1);
        }
    }
    ...
    public final Object invoke(Object obj, Object obj2) {
        ...
        return ((g0) create(a0Var, cVar)).invokeSuspend(p6.x.f8464a);
    }
    ...
    public final Object invokeSuspend(Object obj) throws Throwable {
        ...
        switch (i) {
            case 0:
                ...
                Object objC = o7.c0.C(new g0(this.f5319l, this.f5320m, cVar, i6), v7.d.f10885a, this);
                if (objC != aVar) {
                    objC = xVar;
                }
                if (objC != aVar) {
            ...
            default:
                ...
                if (i12 != 0) {
                    ...
                    TvSearchFragment tvSearchFragment = this.f5319l;
                    ...
                    if (!g2VarH.b() && (jSONObject = g2VarH.f11207d) != null && (jSONObjectOptJSONObject = jSONObject.optJSONObject("data")) != null) {
