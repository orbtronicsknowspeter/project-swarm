...
public final class q extends RowsSupportFragment {
    ...
    public ArrayList f5351b = new ArrayList();

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final ArrayList f5352l = new ArrayList();

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final ArrayList f5353m = new ArrayList();

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    public final ArrayObjectAdapter f5354n;
    ...
    public q() {
        ...
        this.f5354n = arrayObjectAdapter;
    ...
    public static final void a(q qVar) {
        ...
        ArrayList arrayList = qVar.f5352l;
        ArrayList arrayList2 = qVar.f5353m;
        ...
        while (it.hasNext()) {
            ...
            if (qVar.getContext() != null) {
                ...
                e5.g gVar = new e5.g();
                gVar.f4741a = contextRequireContext;
                ...
                qVar.f5354n.add(new ListRow(headerItem, arrayObjectAdapter));
            }
        }
    }
    ...
    public final void b(ArrayList arrayList, int i) {
        ...
        while (true) {
            ...
            if (p2Var.f11330a.f11225a != i) {
                ...
                cVar.f2417a = p2Var.f11330a;
                arrayObjectAdapter.add(cVar);
                this.f5354n.add(new ListRow(headerItem, arrayObjectAdapter));
            }
        }
        if (i6 >= 0) {
            arrayList.remove(i6);
    ...
    public final void onResume() {
        super.onResume();
        if (this.f5350a != null && !this.f5351b.isEmpty()) {
