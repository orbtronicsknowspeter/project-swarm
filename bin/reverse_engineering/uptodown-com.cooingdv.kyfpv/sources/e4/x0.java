...
public final class x0 extends RecyclerView.Adapter {
    ...
    public final w4.n f4716a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final w4.b f4717b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final ra f4718c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final w4.k f4719d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public ArrayList f4720e;
    public final w0 f;
    public int g;
    public boolean h;
    public int i;
    ...
    public final ArrayList a() {
        ArrayList arrayList = this.f4720e;
        if (arrayList != null) {
            return arrayList;
        }
            ...
            if ((obj instanceof x4.e) && (str = (eVar = (x4.e) obj).f11124l) != null && str.length() != 0) {
                ...
                if (rVarA != null && rVarA.F.size() > 0) {
                    ...
                    while (it.hasNext()) {
                        Object next = it.next();
                        next.getClass();
                        if (l7.u.m0(((x4.j0) next).f11241q, file.getAbsolutePath(), true)) {
                            i = i6;
                            break;
                            break;
                        }
                ...
                if ((rVar != null ? rVar.F : null) != null) {
                    ...
                    if (rVar.F.size() > 0) {
                        ...
                        while (it2.hasNext()) {
                            ...
                            next2.getClass();
                            if (l7.u.m0(((x4.j0) next2).f11241q, file.getAbsolutePath(), true)) {
                                i = i6;
                                break;
                            }
                        }
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder instanceof m5.f0) {
            ...
            layoutParams.setMargins(0, (int) f0Var.itemView.getContext().getResources().getDimension(R.dimen.margin_l), 0, 0);
        ...
        if (viewHolder instanceof c2) {
            ((c2) viewHolder).f7337a.setVisibility(0);
            return;
        }
        if (viewHolder instanceof m5.l1) {
            m5.l1 l1Var = (m5.l1) viewHolder;
            int i6 = this.f.f4712a;
            LinearLayout linearLayout = l1Var.f7467l;
            TextView textView = l1Var.f7466b;
            TextView textView2 = l1Var.f7469n;
            if (i6 != 0) {
                textView.setText(l1Var.itemView.getContext().getString(R.string.my_downloads_pending));
            ...
            textView.setText(l1Var.itemView.getContext().getString(R.string.you_are_up_to_date));
            TextView textView3 = l1Var.f7468m;
            ...
            textView3.setText(resources.getString(R.string.last_check, String.valueOf(j > 0 ? new SimpleDateFormat("dd MMM yyyy HH:mm", Locale.getDefault()).format(new Date(j)) : null)));
        ...
        if (viewHolder instanceof d2) {
            ...
            LinearLayout linearLayout2 = d2Var.f7369a;
            if (z9) {
        ...
        if (viewHolder instanceof m5.a) {
            ...
            if (obj3 instanceof x4.e) {
                ...
                if (obj3 instanceof v0) {
                    Object obj5 = a().get(i);
                    obj5.getClass();
                    ((m5.a) viewHolder).a(((v0) obj5).f4709a);
                    return;
                }
                return;
            }
        ...
        obj6.getClass();
        v0 v0Var = (v0) obj6;
        TextView textView4 = k1Var.f7451p;
        TextView textView5 = k1Var.f7449n;
        x4.e eVar = v0Var.f4709a;
        boolean z10 = eVar.K;
        ...
        context6.getClass();
        k1Var.f7446b.setImageDrawable(j5.t.b(context6, eVar.f11124l));
        k1Var.f7447l.setText(eVar.f11123b);
        k1Var.f7448m.setText(eVar.f11126n);
        long j10 = eVar.f11134w;
        Context context7 = k1Var.itemView.getContext();
        context7.getClass();
        textView5.setText(i5.H(context7, j10));
        TextView textView6 = k1Var.f7450o;
        long j11 = eVar.f11135x;
        textView6.setText(j11 > 0 ? new SimpleDateFormat("dd MMM yyyy", Locale.getDefault()).format(new Date(j11)) : null);
        float f10 = UptodownApp.I;
        if (v0Var.f4710b.f11349o == 1) {
            textView4.setText(k1Var.itemView.getContext().getString(R.string.skipped_update));
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        viewGroup.getClass();
        ra raVar = this.f4718c;
        w4.b bVar = this.f4717b;
        switch (i) {
            case 0:
                return new p1(androidx.lifecycle.l.E(viewGroup, R.layout.update_item, viewGroup, false), this.f4716a);
            case 1:
                return new m5.d(androidx.lifecycle.l.E(viewGroup, R.layout.installed_app_item, viewGroup, false), bVar);
            case 2:
                return new c2(androidx.lifecycle.l.E(viewGroup, R.layout.warning_not_space_available, viewGroup, false));
            case 3:
            default:
                com.google.gson.internal.a.p("viewType unknown");
                return null;
            case 4:
                return new d2(androidx.lifecycle.l.E(viewGroup, R.layout.tracking_disabled, viewGroup, false), raVar);
            case 5:
            ...
            case 7:
                ...
                string3.getClass();
                return new m5.f0(viewE3, string3, this.f4719d);
            case 8:
                return new m5.l1(androidx.lifecycle.l.E(viewGroup, R.layout.updates_header, viewGroup, false), raVar);
            case 9:
                return new m5.a(androidx.lifecycle.l.E(viewGroup, R.layout.installed_app_item, viewGroup, false), bVar);
            case 10:
                return new m5.k1(androidx.lifecycle.l.E(viewGroup, R.layout.installed_app_item, viewGroup, false), bVar);
        }
    }
}
