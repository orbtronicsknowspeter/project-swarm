...
public final class j extends RecyclerView.Adapter {
    ...
    public final w4.j f4568a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final w4.a f4569b;
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        obj.getClass();
        x4.g gVar = (x4.g) obj;
        ImageView imageView = iVar.f4558l;
        TextView textView = iVar.f4559m;
        ...
        int i10 = 1;
        if (gVar.f11185s0 != x4.f.f11149o) {
            textView.setText(gVar.f11183r0);
            textView.setVisibility(0);
            textView.setTextColor(ContextCompat.getColor(iVar.itemView.getContext(), R.color.white));
            int iOrdinal = gVar.f11185s0.ordinal();
            if (iOrdinal == 0) {
        ...
        iVar.f4560n.setText(gVar.f11160b);
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View viewS = androidx.lifecycle.l.s(viewGroup, R.layout.home_fragment_header_image, viewGroup, false);
        viewS.getClass();
        return new i(viewS, this.f4568a, this.f4569b);
    }
}
