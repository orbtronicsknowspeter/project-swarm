...
public final class h0 extends RecyclerView.Adapter {
    ...
    public final void b(d2 d2Var) {
        ...
        while (true) {
            ...
            int i6 = i + 1;
            if (((d2) it.next()).f11108a == d2Var.f11108a) {
                break;
            } else {
                i = i6;
            }
    ...
    public final int getItemCount() {
        return this.f4550a.size() + (this.f4553d ? 1 : 0);
    }

    @Override // androidx.recyclerview.widget.RecyclerView.Adapter
    public final int getItemViewType(int i) {
        return i == this.f4550a.size() ? 1 : 0;
    }
    ...
    */
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        viewGroup.getClass();
        if (i == 0) {
            View viewB = c.j.b(viewGroup, R.layout.reply, viewGroup, false);
            viewB.getClass();
            return new m5.q0(this.f4552c, this.f4551b, viewB);
        }
        if (i != 1) {
            com.google.gson.internal.a.p("viewType unknown");
            return null;
        }
        View viewB2 = c.j.b(viewGroup, R.layout.pb_loading_more_content, viewGroup, false);
        viewB2.getClass();
