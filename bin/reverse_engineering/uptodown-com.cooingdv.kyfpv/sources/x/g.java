...
public final class g {
    ...
    public final s.d f11030b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final y.d f11031c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final n0 f11032d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final Executor f11033e;
    public final z.c f;
    public final q2.e g;
    public final q2.e h;
    public final y.c i;
    ...
    public final void a(j jVar, int i) {
        ...
        final g gVar = this;
        final j jVar2 = jVar;
        byte[] bArr2 = jVar2.f8833b;
        s.e eVarA = gVar.f11030b.a(jVar2.f8832a);
        long jMax = 0;
        while (true) {
            final int i10 = 0;
            z.b bVar = new z.b(gVar) { // from class: x.f
                ...
                /* JADX INFO: renamed from: b, reason: collision with root package name */
                public final /* synthetic */ g f11027b;
                ...
                public final Object execute() {
                    ...
                    switch (i10) {
                        ...
                        default:
                            h hVar2 = (h) this.f11027b.f11031c;
                            hVar2.getClass();
            ...
            Iterable iterable = (Iterable) hVar.h(new z.b(gVar) { // from class: x.f
                ...
                public final Object execute() {
                    ...
                    switch (i11) {
                        ...
                        default:
                            h hVar22 = (h) this.f11027b.f11031c;
                            hVar22.getClass();
            ...
            if (eVarA == null) {
                ...
                while (it.hasNext()) {
                    arrayList2.add(((y.b) it.next()).f11582c);
                }
                if (bArr2 != null) {
                    y.c cVar = gVar.i;
                    ...
                    r.h hVar2 = new r.h();
                    hVar2.f8824r = new HashMap();
                    hVar2.f8822p = Long.valueOf(gVar.g.f());
                    hVar2.f8823q = Long.valueOf(gVar.h.f());
                    hVar2.f8817b = "GDT_CLIENT_METRICS";
                    ...
                    hVar2.f8821o = new r.m(cVar2, byteArrayOutputStream.toByteArray());
                ...
                for (Map.Entry entry : map.entrySet()) {
                    ...
                    for (i iVar3 : (List) entry.getValue()) {
                        byte[] bArr3 = bArr2;
                        r.m mVar2 = iVar3.f8829c;
                        byte[] bArr4 = iVar3.j;
                        o.c cVar4 = mVar2.f8842a;
                        byte[] bArr5 = mVar2.f8843b;
                        long j6 = jMax;
                        ...
                        eVar.f5119b = Long.valueOf(iVar3.f8830d);
                        eVar.f5122n = Long.valueOf(iVar3.f8831e);
                        String str5 = (String) iVar3.f.get("tz-offset");
                        eVar.f5125q = Long.valueOf(str5 == null ? 0L : Long.valueOf(str5).longValue());
                        eVar.f5126r = new v((h0) h0.f8582a.get(iVar3.b("net-type")), (g0) g0.f8578a.get(iVar3.b("mobile-subtype")));
                        Integer num = iVar3.f8828b;
                        if (num != null) {
                            eVar.f5120l = num;
                        }
                        ...
                        if (bArr6 != null || bArr4 != null) {
                            ...
                            eVar.f5127s = new p(bArr6, bArr4 != null ? bArr4 : null);
                        }
                        String strConcat = ((Long) eVar.f5119b) == null ? " eventTimeMs" : "";
                        if (((Long) eVar.f5122n) == null) {
                            strConcat = strConcat.concat(" eventUptimeMs");
                        }
                        if (((Long) eVar.f5125q) == null) {
                        ...
                        if (!strConcat.isEmpty()) {
                            ...
                            arrayList5.add(new s(((Long) eVar.f5119b).longValue(), (Integer) eVar.f5120l, (q.o) eVar.f5121m, ((Long) eVar.f5122n).longValue(), (byte[]) eVar.f5123o, (String) eVar.f5124p, ((Long) eVar.f5125q).longValue(), (v) eVar.f5126r, (p) eVar.f5127s));
                            bArr2 = bArr3;
                            jMax = j6;
                        }
                    }
                ...
                try {
                    ...
                    int i15 = bVarA.f8397b;
                    if (i15 == 200) {
                        aVar = new s.a(1, bVarA.f8396a);
            ...
            if (i16 == 1) {
                ...
                if (i16 == 4) {
                    ...
                    while (it2.hasNext()) {
                        String str7 = ((y.b) it2.next()).f11582c.f8827a;
