...
public final class d {
    ...
    */
    ...
    public static Bundle a(Activity activity) {
        ...
        if (z9) {
            return ActivityOptions.makeCustomAnimation(activity, R.anim.right_to_left_in, R.anim.right_to_left_out).toBundle();
        }
        return null;
    }
    ...
    public static ActivityOptionsCompat b(Activity activity) {
        ...
        if (z9) {
            return ActivityOptionsCompat.makeCustomAnimation(activity, R.anim.right_to_left_in, R.anim.right_to_left_out);
        }
        return null;
    }
    ...
    public static ArrayList c(x4.e eVar) {
        ...
        synchronized (UptodownApp.f3295h0) {
            try {
                if (eVar.F > 0) {
                    ArrayList arrayList2 = UptodownApp.f3296i0;
                    if (arrayList2 != null) {
                        arrayList2.add(eVar);
                    } else {
                        ArrayList arrayList3 = new ArrayList();
                        UptodownApp.f3296i0 = arrayList3;
                        arrayList3.add(eVar);
                    }
                }
                arrayList = UptodownApp.f3296i0;
            } catch (Throwable th) {
                throw th;
            }
        }
    ...
    */
    ...
    public static Drawable f(Context context) {
        context.getClass();
        Drawable drawable = ContextCompat.getDrawable(context, R.drawable.shape_bg_placeholder);
        return drawable != null ? drawable : new ColorDrawable(ContextCompat.getColor(context, R.color.placeholder_color));
    }

    public static x4.e g() {
        x4.e eVar;
        synchronized (UptodownApp.f3295h0) {
            ArrayList arrayList = UptodownApp.f3296i0;
    ...
    public static boolean l(q2 q2Var) {
        ...
        synchronized (UptodownApp.f3300m0) {
            ...
            while (true) {
                ...
                next.getClass();
                z9 = true;
                if (u.m0(((q2) next).f11345b, q2Var.f11345b, true)) {
                    break;
                }
            }
        }
        ...
        synchronized (UptodownApp.f3295h0) {
            ...
            if (arrayList != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ArrayList arrayList2 = UptodownApp.f3296i0;
                    arrayList2.getClass();
                    if (str.equalsIgnoreCase(((x4.e) arrayList2.get(i)).f11124l)) {
                        return true;
                    }
                }
            }
    ...
    */
    public static void s(android.content.Context r8, java.io.File r9) {
        ...
        L26:
            ...
            r4 = 1
            if (r9 == 0) goto L61
            java.lang.String r5 = r9.f11356b
            if (r5 == 0) goto L61
            int r6 = r9.A
            if (r6 != r4) goto L3e
            r6 = r4
        ...
        L3f:
            ...
            java.lang.String r6 = r9.f11356b
            r0.putString(r5, r6)
            long r5 = r9.f11370z
        ...
        L7e:
            ...
            r8 = 0
            if (r9 == 0) goto L99
            java.lang.String r9 = r9.f11356b
            goto L9a
        L99:
            r9 = r8
        L9a:
    ...
    public static boolean t() {
        ...
        if (jCurrentTimeMillis - UptodownApp.f3297j0 <= 600) {
            return false;
        }
        UptodownApp.f3297j0 = jCurrentTimeMillis;
        return true;
    }
        ...
        synchronized (UptodownApp.f3300m0) {
            try {
                ...
                while (true) {
                    ...
                    int i6 = i + 1;
                    if (u.m0(((q2) it.next()).f11345b, q2Var.f11345b, true)) {
                        break;
                    } else {
                        i = i6;
                    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:10:0x0025, code lost:
        ...
        r0 = com.uptodown.UptodownApp.f3296i0;
        r0.getClass();
        r0.remove(r4);
     */
    ...
    */
    public static void v(x4.q2 r7) {
        /*
            java.lang.String r0 = r7.f11345b
            java.lang.Object r1 = com.uptodown.UptodownApp.f3295h0
            monitor-enter(r1)
            java.util.ArrayList r2 = com.uptodown.UptodownApp.f3296i0     // Catch: java.lang.Throwable -> L2f
            r3 = 0
            if (r2 == 0) goto L34
        ...
        Lf:
            if (r4 >= r2) goto L34
            java.util.ArrayList r5 = com.uptodown.UptodownApp.f3296i0     // Catch: java.lang.Throwable -> L2f
            ...
            java.lang.String r5 = r5.f11124l     // Catch: java.lang.Throwable -> L2f
            r6 = 1
            boolean r5 = l7.u.m0(r0, r5, r6)     // Catch: java.lang.Throwable -> L2f
            if (r5 == 0) goto L31
            java.util.ArrayList r0 = com.uptodown.UptodownApp.f3296i0     // Catch: java.lang.Throwable -> L2f
    ...
    public static n5.g w(Context context) {
        context.getClass();
        return new n5.g((int) context.getResources().getDimension(R.dimen.border_radius_m));
    }

    public static n5.g x(Context context) {
        context.getClass();
        n5.g gVar = UptodownApp.W;
        return gVar != null ? gVar : new n5.g((int) context.getResources().getDimension(R.dimen.border_radius_m));
    }

    public static n5.g y(Context context) {
        context.getClass();
        return new n5.g((int) context.getResources().getDimension(R.dimen.border_radius_s));
    }
