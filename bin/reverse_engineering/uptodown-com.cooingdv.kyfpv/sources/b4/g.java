...
public final class g implements p {
    ...
    public static void a(String str) {
        ...
        bVar2.getClass();
        Socket socket = bVar2.f7285e;
        if (socket == null || socket.isClosed()) {
            if (f4.c.f4885y == null || (bVar = f4.c.f4886z) == null || (dVar = bVar.f7282b) == null) {
                return;
            }
            dVar.p();
            return;
    ...
    public static void b(String str) {
        ...
        if (bVar == null || (gVar = bVar.f7283c) == null) {
            return;
        }
    ...
    public static void d(l4.c cVar) {
        ...
        android.support.v4.media.g gVar;
        cVar.getClass();
        File file = cVar.f7104a;
        if (file == null || (bVar = f4.c.f4886z) == null || (gVar = bVar.f7283c) == null) {
            return;
        }
    ...
    public void e(int i) {
        ...
        if (gVar2 != null) {
            ...
            try {
                gVar2.f7292b.registerService(nsdServiceInfo, 1, bVar);
            } catch (Exception unused2) {
                gVar2.f7291a.f1004a.b();
            }
        }
        m4.g gVar3 = f4.c.f4885y;
        if (gVar3 != null) {
            gVar3.b();
        }
    }
    ...
    public void i(String str) {
        ...
        if (socket == null || socket.isClosed()) {
            ...
            s0 s0Var = (s0) activity;
            activity.getClass();
            String string = activity.getString(R.string.error_nsd_service_not_found, str.substring(0, m.y0(str, "_d:_", 0, false, 6)));
            string.getClass();
