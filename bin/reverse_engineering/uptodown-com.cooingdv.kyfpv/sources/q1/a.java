...
public final /* synthetic */ class a implements d, t.b, t0.c, t5.b, p, w1.a, w7.a, h {
    ...
    public static final /* synthetic */ a f8634b = new a(0);

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public static a f8635l;
    ...
    public static d2 g(JSONObject jSONObject) {
        ...
        if (!jSONObject.isNull("id")) {
            d2Var.f11108a = jSONObject.optLong("id");
        }
        if (!jSONObject.isNull("userName")) {
            d2Var.f11109b = jSONObject.optString("userName");
            if (!jSONObject.isNull("userAvatar")) {
                d2Var.f11111m = jSONObject.optString("userAvatar");
            }
            if (!jSONObject.isNull("userID")) {
                d2Var.f11110l = jSONObject.optString("userID");
            }
        }
        if (!jSONObject.isNull("text")) {
            d2Var.f11113o = jSONObject.optString("text");
        }
        if (!jSONObject.isNull("timeAgo")) {
            d2Var.f11114p = jSONObject.optString("timeAgo");
        }
        if (!jSONObject.isNull("likes")) {
            d2Var.f11115q = jSONObject.optInt("likes");
        }
        if (!jSONObject.isNull("isAuthorVerified")) {
            d2Var.f11116r = jSONObject.optInt("isAuthorVerified");
        }
        if (!jSONObject.isNull("isTurbo")) {
            d2Var.f11117s = jSONObject.optInt("isTurbo");
        }
        if (!jSONObject.isNull("usernameFormat")) {
            d2Var.f11118t = jSONObject.optString("usernameFormat");
        }
        if (!jSONObject.isNull("following")) {
            d2Var.f11119u = jSONObject.optInt("following");
        }
        return d2Var;
    }
    ...
    public static k2 h(JSONObject jSONObject) {
        k2 k2Var = new k2();
        if (!jSONObject.isNull("id")) {
            k2Var.f11259a = jSONObject.optLong("id");
        }
        if (!jSONObject.isNull("userID")) {
            k2Var.f11260b = jSONObject.optString("userID");
            if (!jSONObject.isNull("userName")) {
                k2Var.f11261l = jSONObject.optString("userName");
            }
            if (!jSONObject.isNull("userAvatar")) {
                k2Var.f11262m = jSONObject.optString("userAvatar");
            }
        }
        if (!jSONObject.isNull("text")) {
            k2Var.f11264o = jSONObject.optString("text");
        }
        if (!jSONObject.isNull("rating")) {
            k2Var.f11265p = jSONObject.optInt("rating");
        }
        if (!jSONObject.isNull("totalAnswers")) {
            k2Var.f11266q = jSONObject.optInt("totalAnswers");
        }
        if (!jSONObject.isNull("timeAgo")) {
            k2Var.f11267r = jSONObject.optString("timeAgo");
        }
        if (!jSONObject.isNull("likes")) {
            k2Var.f11268s = jSONObject.optInt("likes");
        }
        if (!jSONObject.isNull("isAuthorVerified")) {
            k2Var.f11269t = jSONObject.optInt("isAuthorVerified");
        }
        if (!jSONObject.isNull("isTurbo")) {
            k2Var.v = jSONObject.optInt("isTurbo");
        }
        if (!jSONObject.isNull("usernameFormat")) {
            k2Var.f11271w = jSONObject.optString("usernameFormat");
        }
        if (!jSONObject.isNull("following")) {
            k2Var.f11272x = jSONObject.optInt("following");
        }
        return k2Var;
    }
    ...
    public static k2 r(JSONObject jSONObject) {
        ...
        if (!jSONObject.isNull("appName")) {
            k2Var.f11270u = jSONObject.optString("appName");
        }
        if (!jSONObject.isNull("appID")) {
            k2Var.f11263n = jSONObject.optLong("appID");
        }
        if (!jSONObject.isNull("appIcon")) {
            k2Var.f11262m = jSONObject.optString("appIcon");
        }
        if (!jSONObject.isNull("text")) {
            k2Var.f11264o = jSONObject.optString("text");
        }
        if (!jSONObject.isNull("rate")) {
            k2Var.f11265p = jSONObject.optInt("rate");
        }
        if (!jSONObject.isNull("publishedDate")) {
            k2Var.f11267r = jSONObject.optString("publishedDate");
        }
        if (!jSONObject.isNull("likes")) {
            k2Var.f11268s = jSONObject.optInt("likes");
        }
    ...
    public Object get() {
        ...
        switch (this.f8636a) {
            ...
            default:
                ...
                map.put(o.d.f8127a, new x.b(WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, 86400000L, set));
                if (set == null) {
                    com.google.gson.internal.a.i("Null flags");
                    return null;
                }
                map.put(o.d.f8129l, new x.b(1000L, 86400000L, set));
                if (set == null) {
                    com.google.gson.internal.a.i("Null flags");
                    return null;
                }
                Set setUnmodifiableSet = DesugarCollections.unmodifiableSet(new HashSet(Arrays.asList(x.c.f11016b)));
                if (setUnmodifiableSet == null) {
                    com.google.gson.internal.a.i("Null flags");
                    return null;
                }
                map.put(o.d.f8128b, new x.b(86400000L, 86400000L, setUnmodifiableSet));
    ...
    */
    public java.lang.Object m(x4.d2 r11, android.content.Context r12, v6.c r13) throws java.lang.Throwable {
        ...
        L13:
            ...
            r0.<init>(r10, r13)
        L18:
            java.lang.Object r13 = r0.f11063m
            int r1 = r0.f11065o
            r2 = 1
            if (r1 == 0) goto L34
            if (r1 != r2) goto L2d
            kotlin.jvm.internal.v r11 = r0.f11062l
            kotlin.jvm.internal.v r12 = r0.f11061b
            x4.d2 r0 = r0.f11060a
            p6.a.e(r13)
            r6 = r11
            r11 = r0
        ...
        L34:
            p6.a.e(r13)
            long r3 = r11.f11108a
            java.util.ArrayList r13 = j5.t.f6711c
    ...
    */
    public java.lang.Object n(x4.k2 r11, android.content.Context r12, v6.c r13) throws java.lang.Throwable {
        ...
        L13:
            ...
            r0.<init>(r10, r13)
        L18:
            java.lang.Object r13 = r0.f11222m
            int r1 = r0.f11224o
            r2 = 1
            if (r1 == 0) goto L34
            if (r1 != r2) goto L2d
            kotlin.jvm.internal.v r11 = r0.f11221l
            kotlin.jvm.internal.v r12 = r0.f11220b
            x4.k2 r0 = r0.f11219a
            p6.a.e(r13)
            r6 = r11
            r11 = r0
        ...
        L34:
            p6.a.e(r13)
            long r3 = r11.f11259a
            java.util.ArrayList r13 = j5.t.f6710b
            java.lang.Long r1 = java.lang.Long.valueOf(r3)
            r13.add(r1)
            kotlin.jvm.internal.v r7 = new kotlin.jvm.internal.v
            r7.<init>()
