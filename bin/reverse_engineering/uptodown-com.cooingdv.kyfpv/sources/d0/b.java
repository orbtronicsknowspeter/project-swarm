...
public final class b {
    ...
    */
    ...
    public static t6.c B(p pVar, t6.c cVar, t6.c cVar2) {
        ...
        return context == i.f10315a ? new u6.b(pVar, cVar2, cVar) : new u6.c(cVar2, context, pVar, cVar);
    }

    public static boolean C() {
        if (!m9.c.e().f7237k.f7186c.equals(Boolean.TRUE)) {
            return false;
        }
        ArrayList arrayList = m9.c.e().f7240n.v.f7182a;
    ...
    public static x4.i E(JSONObject jSONObject) {
        ...
        if (!jSONObject.isNull("id")) {
            iVar.f11215a = jSONObject.optLong("id");
        }
        if (!jSONObject.isNull("sha256")) {
            jSONObject.optString("sha256");
        }
        if (!jSONObject.isNull("active")) {
            iVar.f11216b = jSONObject.optInt("active");
        }
        if (!jSONObject.isNull("url")) {
            iVar.f11217c = jSONObject.optString("url");
        }
    ...
    public static boolean J(Throwable th) {
        ...
        return y0Var != null && y0Var.f9325a == 451;
    }
    ...
    public static void M(Context context, x4.e eVar, Bundle bundle) {
        ...
        if (eVar != null) {
            ...
            if (str != null && str.length() != 0) {
                ...
                str2.getClass();
                r rVarL = gVarL.L(eVar.f11125m, str2);
                if (rVarL != null && rVarL.B == 1) {
                    eVar.v = 1;
                    eVar.f11128p = d.f11089b;
                    gVarL.m0(eVar);
        ...
        if (k0Var.T()) {
            if (!z3.f) {
                ...
                if (z10) {
                    ...
                    CheckBox checkBox = (CheckBox) dVarJ.f4468l;
                    TextView textView = (TextView) dVarJ.f4471o;
                    TextView textView2 = (TextView) dVarJ.f4469m;
                    TextView textView3 = (TextView) dVarJ.f4472p;
                    ((TextView) dVarJ.f4473q).setTypeface(f4.c.f4883w);
                    ((TextView) dVarJ.f4470n).setTypeface(f4.c.f4884x);
                    ...
                    builder.setView((RelativeLayout) dVarJ.f4467b);
    ...
    public static Object Q(p pVar, Object obj, t6.c cVar) {
        ...
        Object dVar = context == i.f10315a ? new u6.d(cVar) : new u6.e(cVar, context);
        a0.b(2, pVar);
    ...
    public static int a() {
        ...
        if (r02 == 0) {
            ...
            while (it.hasNext()) {
                if (!((j8.b) it.next()).f6722b.equals(Boolean.FALSE)) {
                    if (r02.isEmpty()) {
                        i = 3;
                    } else {
                        Iterator it2 = r02.iterator();
                        while (it2.hasNext()) {
                            if (!((j8.b) it2.next()).f6722b.equals(Boolean.TRUE)) {
                                i = 2;
                                break;
                            }
                        }
    ...
    public static String c(Vector vector) {
        ...
        xVar.f7025a = u.n0(vector.getMaxId());
        vector.forEach(new w5.b(xVar, 0));
        return (String) xVar.f7025a;
    }

    public static String d(f9.d dVar, l9.a aVar) {
        aVar.getClass();
        SharedPreferences sharedPreferences = aVar.f7263a;
        ...
        return j8.e.f6735d ? sharedPreferences.getBoolean("MSPAConsentGivenExplicitly", false) ? aVar.j(73) : l.k(a()) : l.k(a());
    }
    ...
    public static final void k(Context context, k0 k0Var, w4.g gVar, x4.g gVar2, boolean z9) {
            ...
            if (q2VarY == null || q2VarY.c() || (eVarB != null && eVarB.v == 1)) {
                ...
                if (launchIntentForPackage != null) {
                    try {
                        ...
                        String string = context.getString(R.string.error_open_app, gVar2.f11160b);
                        string.getClass();
                        gVar.A(string);
                        return;
                    } catch (SecurityException unused2) {
                        String string2 = context.getString(R.string.error_open_app, gVar2.f11160b);
                        string2.getClass();
                        gVar.A(string2);
                        return;
                    }
        ...
        if (str6 != null && str6.length() != 0) {
            ...
            if (!z10) {
                ...
                String string3 = context.getString(R.string.download_error_message);
                string3.getClass();
                gVar.A(string3);
                return;
            }
        ...
        if (!kotlin.jvm.internal.l.a(gVar2.W, "ExternalDownload") || (str = gVar2.f11168i0) == null || str.length() == 0) {
            String str10 = gVar2.f11175n;
            if (str10 != null && str10.length() != 0) {
                t1.u(k0Var, gVar2.f11175n);
                return;
            }
            String string4 = context.getString(R.string.download_error_message);
            string4.getClass();
            gVar.A(string4);
            return;
        }
        ...
        k0Var.Q();
        View viewInflate = k0Var.getLayoutInflater().inflate(R.layout.dialog_external_download, (ViewGroup) null, false);
        int i = R.id.iv_close_dialog_external_download;
        ImageView imageView = (ImageView) ViewBindings.findChildViewById(viewInflate, R.id.iv_close_dialog_external_download);
        if (imageView != null) {
            i = R.id.tv_action_dialog_external_download;
            TextView textView = (TextView) ViewBindings.findChildViewById(viewInflate, R.id.tv_action_dialog_external_download);
            if (textView != null) {
                i = R.id.tv_description_dialog_external_download;
                TextView textView2 = (TextView) ViewBindings.findChildViewById(viewInflate, R.id.tv_description_dialog_external_download);
                if (textView2 != null) {
                    i = R.id.tv_title_dialog_external_download;
                    TextView textView3 = (TextView) ViewBindings.findChildViewById(viewInflate, R.id.tv_title_dialog_external_download);
                    if (textView3 != null) {
                        textView3.setTypeface(f4.c.f4883w);
                        textView2.setTypeface(f4.c.f4884x);
                        textView2.setText(gVar2.f11169j0);
    ...
    public static b3 l(JSONObject jSONObject) {
        b3 b3Var = new b3();
        if (!jSONObject.isNull("id")) {
            b3Var.f11066a = jSONObject.optLong("id");
        }
        if (!jSONObject.isNull("name")) {
            b3Var.f11067b = jSONObject.optString("name");
        }
        if (!jSONObject.isNull("isInstalled")) {
            b3Var.f11069m = jSONObject.optInt("isInstalled");
        }
        if (!jSONObject.isNull("isCompatible")) {
            b3Var.f11070n = jSONObject.optInt("isCompatible");
        }
        if (!jSONObject.isNull("isCurrentDevice")) {
            b3Var.f11068l = jSONObject.optInt("isCurrentDevice");
        }
        if (!jSONObject.isNull("isLinked")) {
            b3Var.f11071o = jSONObject.optInt("isLinked");
        }
        return b3Var;
    }
    ...
    public static final Object n(j1.p pVar, w wVar) throws Exception {
        if (!pVar.h()) {
            ...
            lVar.s();
            pVar.a(y7.a.f11809a, new g5.f(lVar, 19));
            return lVar.r();
        }
    ...
    */
    public static final java.lang.Object o(q7.s r4, d7.a r5, v6.c r6) {
        ...
        L30:
            ...
            t6.f r6 = r6.get(r1)
            if (r6 != r4) goto L6c
            r0.f8776a = r5     // Catch: java.lang.Throwable -> L27
            r0.f8778l = r2     // Catch: java.lang.Throwable -> L27
    ...
    public static boolean s() {
        return m9.c.e().f7237k.f7185b.equals(Boolean.TRUE);
    }
    ...
    public static void w(int i, boolean z9) {
        q qVar = (q) n4.h.f7967c.get(Integer.valueOf(i));
        if (qVar != null) {
    ...
    public static void x(int i, boolean z9) {
        q qVar = (q) n4.h.f7968d.get(Integer.valueOf(i));
        if (qVar != null) {
            ((o7.r) qVar).Q(Boolean.valueOf(z9));
        }
    }
    ...
    public static final double z(double d10, m7.c cVar, m7.c cVar2) {
        long jConvert = cVar2.f7668a.convert(1L, cVar.f7668a);
    ...
    public i0.b r(Context context, Looper looper, v vVar, Object obj, i0.e eVar, i0.f fVar) {
        switch (this.f3535a) {
            ...
            case 2:
                vVar.getClass();
                Integer num = (Integer) vVar.f5281p;
