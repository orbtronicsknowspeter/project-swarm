...
public abstract class t1 {
    ...
    public static q2 G(x4.e eVar, JSONObject jSONObject) throws JSONException {
        ...
        if (!jSONObject.isNull("versionName")) {
            q2Var.f11347m = jSONObject.optString("versionName");
        }
        if (!jSONObject.isNull("versionCode")) {
            q2Var.f11346l = jSONObject.optLong("versionCode");
        }
        ...
        if (jSONArrayOptJSONArray != null) {
            ...
            q2Var.f11354t = arrayList;
        }
        x4.r rVar = new x4.r();
        rVar.f11356b = q2Var.f11345b;
        rVar.f11362q = eVar.F;
        rVar.f11367w = eVar.f11123b;
        rVar.f11364s = eVar.f11133u;
        rVar.f11359n = q2Var.f11346l;
        rVar.f11360o = q2Var.f11347m;
        long j = q2Var.f11344a;
        if (j == -1) {
            rVar.f11370z = 0L;
        } else {
            rVar.f11370z = j;
        ...
        if (jSONArrayOptJSONArray2 != null) {
            ...
            if (!jSONObject.isNull("size")) {
                j0Var2.f11238n = jSONObject.optLong("size");
            }
            if (!jSONObject.isNull("fileID")) {
                String strOptString2 = jSONObject.optString("fileID");
                try {
                    strOptString2.getClass();
                    j0Var2.f11236l = Long.parseLong(strOptString2);
    ...
    public static j1.p Q(List list) {
        ...
        while (it2.hasNext()) {
            ...
            j1.o oVar = j1.j.f6542b;
            pVar2.c(oVar, kVar);
            pVar2.b(oVar, kVar);
            pVar2.f6562b.e(new j1.m((Executor) oVar, (j1.c) kVar));
            pVar2.p();
        }
        return pVar;
    }
    ...
    public static final d8.u0 a(String str, b8.d dVar) {
        ...
        Iterator it = ((r6.h) d8.v0.f3717a.values()).iterator();
    ...
    public static final String d(String str) {
        str.getClass();
        return q6.l.x0(l7.m.G0(str, new String[]{" "}), " ", null, null, g9.a.f5389b, 30);
    }
    ...
    public static void i(Context context, String str, Bundle bundle, boolean z9) {
        ...
        if (kVar != null) {
            ...
            if (str2 == null || str2.length() == 0) {
                x4.k kVar2 = UptodownApp.f3294g0;
                kVar2.getClass();
                String strA = kVar2.a();
                ...
                x4.k kVar3 = UptodownApp.f3294g0;
                kVar3.getClass();
                if (l7.u.m0(kVar3.f11250c, str, true)) {
                    bundle.putString("source", "deeplink");
                    return;
                }
            }
        ...
        if (r1VarA == null || !l7.u.m0(r1VarA.f11373b, str, true)) {
            return;
        }
    ...
    public static Object j(j1.p pVar) throws InterruptedException {
        ...
        Executor executor = j1.j.f6542b;
        pVar.c(executor, gVar);
        pVar.b(executor, gVar);
        pVar.f6562b.e(new j1.m(executor, (j1.c) gVar));
        pVar.p();
        ((CountDownLatch) gVar.f5316b).await();
        return R(pVar);
    }
    ...
    public static Object k(j1.p pVar, long j, TimeUnit timeUnit) throws TimeoutException {
        ...
        pVar.f6562b.e(new j1.m(executor, (j1.c) gVar));
        pVar.p();
        if (((CountDownLatch) gVar.f5316b).await(j, timeUnit)) {
            return R(pVar);
        }
    ...
    public static w8.d l() throws InterruptedException {
        w8.d dVar = w8.d.f10952l;
        dVar.getClass();
        w8.d dVar2 = dVar.f;
        if (dVar2 == null) {
            long jNanoTime = System.nanoTime();
            w8.d.i.await(w8.d.j, TimeUnit.MILLISECONDS);
            w8.d dVar3 = w8.d.f10952l;
            dVar3.getClass();
            if (dVar3.f != null || System.nanoTime() - jNanoTime < w8.d.f10951k) {
                return null;
            }
            return w8.d.f10952l;
        }
    ...
    public static final String m(String str) throws NoSuchAlgorithmException {
        ...
        bArrDigest.getClass();
        return q6.j.k0(bArrDigest, "", g9.a.f5390l, 30);
    }
    ...
    public static final void u(c4.k0 k0Var, String str) {
        ...
        textView2.setText(k0Var.getString(R.string.go_to_web_dialog_message));
        textView.setTypeface(f4.c.f4883w);
        textView.setOnClickListener(new c4.o(k0Var, 9));
        textView3.setTypeface(f4.c.f4883w);
        textView3.setText(k0Var.getString(R.string.open_web));
    ...
    public static final void v(c4.k0 k0Var, String str, String str2) {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(k0Var);
        View viewInflate = k0Var.getLayoutInflater().inflate(R.layout.dialog_login_required, (ViewGroup) null, false);
    ...
    public static void y(UptodownApp uptodownApp) {
        ...
        pVar.getClass();
        pVar.f6562b.e(new j1.m(j1.j.f6541a, aVar));
        pVar.p();
    }
