...
public final class j {
    ...
    public static final Object f11737c = new Object();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public static d0 f11738d;
    ...
    public j(g5.f fVar) {
        this.f11739a = fVar.L("gcm.n.title");
        fVar.I("gcm.n.title");
        ...
        this.f11740b = fVar.L("gcm.n.body");
        fVar.I("gcm.n.body");
    ...
    public static j1.p a(Context context, Intent intent, boolean z9) {
        ...
        synchronized (f11737c) {
            try {
                if (f11738d == null) {
                    f11738d = new d0(context);
                }
                d0Var = f11738d;
            } catch (Throwable th) {
                throw th;
    ...
    public j1.p b(final Intent intent) {
        ...
        final Context context = (Context) this.f11739a;
        androidx.arch.core.executor.a aVar = (androidx.arch.core.executor.a) this.f11740b;
        ...
        return (!z9 || z10) ? t1.q(aVar, new Callable() { // from class: y2.h
            ...
            public final Object call() {
                ...
                ((ArrayDeque) sVarT.f11759n).offer(intent2);
                Intent intent3 = new Intent("com.google.firebase.MESSAGING_EVENT");
                intent3.setPackage(context2.getPackageName());
                synchronized (sVarT) {
                    try {
                        str = (String) sVarT.f11756b;
                        if (str == null) {
                            ...
                            if (resolveInfoResolveService == null || (serviceInfo = resolveInfoResolveService.serviceInfo) == null) {
                                ...
                                if (context2.getPackageName().equals(serviceInfo.packageName) && (str2 = serviceInfo.name) != null) {
                                    if (str2.startsWith(".")) {
                                        sVarT.f11756b = context2.getPackageName() + serviceInfo.name;
                                    } else {
                                        sVarT.f11756b = serviceInfo.name;
                                    }
                                    str = (String) sVarT.f11756b;
                                }
    ...
    public j(Context context) {
        ...
        this.f11740b = new androidx.arch.core.executor.a(2);
    }

    public j(ExecutorService executorService) {
        this.f11740b = new ArrayMap();
        this.f11739a = executorService;
    }
}
