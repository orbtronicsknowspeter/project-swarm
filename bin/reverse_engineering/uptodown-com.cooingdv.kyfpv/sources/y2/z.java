...
public final class z implements Runnable {
    ...
    public static final Object f11784o = new Object();

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    public static Boolean f11785p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    public static Boolean f11786q;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final Context f11787a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final s4.s f11788b;

    /* JADX INFO: renamed from: l, reason: collision with root package name */
    public final PowerManager.WakeLock f11789l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final x f11790m;
    ...
    public z(x xVar, Context context, s4.s sVar, long j) {
        ...
        this.f11791n = j;
        this.f11788b = sVar;
        this.f11789l = ((PowerManager) context.getSystemService("power")).newWakeLock(1, "wake:com.google.firebase.messaging");
    }

    public static boolean a(Context context) {
        boolean zBooleanValue;
        synchronized (f11784o) {
            try {
                Boolean bool = f11786q;
    ...
    */
    public final synchronized boolean d() {
        /*
            r2 = this;
            monitor-enter(r2)
            android.content.Context r0 = r2.f11787a     // Catch: java.lang.Throwable -> L12
    ...
    public final void run() {
        ...
        PowerManager.WakeLock wakeLock = this.f11789l;
        if (zC) {
