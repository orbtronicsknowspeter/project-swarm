        ...
        if (activity != null) {
            ...
            if (activity instanceof Updates) {
                if (i == 600) {
                    ...
                    v7.e eVar = m0.f8289a;
                    c0.s(lifecycleScope, n.f10349a, null, new g(updates, objArr4 == true ? 1 : 0, 7), 2);
                    return;
                }
                if (i != 601) {
                    return;
                ...
                c0.s(lifecycleScope2, n.f10349a, null, new ta(updates2, i, (t6.c) null), 2);
                return;
            }
            if (activity instanceof MyApps) {
                if (i == 601) {
                    ...
                    c0.s(lifecycleScope3, n.f10349a, null, new j4((MyApps) activity, objArr3 == true ? 1 : 0, i6), 2);
                    return;
                }
                return;
            }
            if (activity instanceof SecurityActivity) {
                if (i == 601) {
                    ...
                    c0.s(lifecycleScope4, n.f10349a, null, new ga(securityActivity, objArr2 == true ? 1 : 0, i6), 2);
                    return;
                }
                return;
            }
            ...
            if (activity instanceof MainActivity) {
                ...
                v7.e eVar5 = m0.f8289a;
                c0.s(lifecycleScope5, n.f10349a, null, new j3(mainActivity2, objArr == true ? 1 : 0, 6), 2);
                return;
            }
