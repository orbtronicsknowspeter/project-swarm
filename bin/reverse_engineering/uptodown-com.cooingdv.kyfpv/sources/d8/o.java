...
public abstract class o extends a {
    ...
    public void h(c8.c cVar, int i, Object obj) {
        k(i, obj, cVar.decodeSerializableElement(getDescriptor(), i, this.f3683a, null));
    }
    ...
    public void serialize(c8.f fVar, Object obj) {
        ...
        Iterator itD = d(obj);
        for (int i = 0; i < iE; i++) {
            dVarBeginCollection.encodeSerializableElement(getDescriptor(), i, this.f3683a, itD.next());
        }
