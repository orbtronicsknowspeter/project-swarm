...
public abstract class a {
    ...
    public static ArrayList I(Context context) {
        ...
        try {
            ...
            for (int i = 0; i < size; i++) {
                if (!m.q0(((o) arrayListG.get(i)).f7126a, "/emulated/", false) && ((o) arrayListG.get(i)).f7128c && "mounted".equals(((o) arrayListG.get(i)).f7127b)) {
                    String str = "/Android/data/" + context.getPackageName();
                    File file = new File(((o) arrayListG.get(i)).f7126a + str);
                    if (file.exists()) {
                        if (file.canWrite()) {
    ...
    public static p2 J(g2 g2Var, j jVar) {
        ...
        p2Var.f11330a = jVar;
        JSONObject jSONObject = g2Var.f11207d;
        if (jSONObject != null) {
            ...
            if (jSONObjectOptJSONObject3 != null) {
                if (!jSONObjectOptJSONObject3.isNull("category") && (jSONObjectOptJSONObject2 = jSONObjectOptJSONObject3.optJSONObject("category")) != null && !jSONObjectOptJSONObject2.isNull("description")) {
                    p2Var.f11330a.f11227l = jSONObjectOptJSONObject2.optString("description");
                }
                if (!jSONObjectOptJSONObject3.isNull("title")) {
                    p2Var.f11330a.f11226b = jSONObjectOptJSONObject3.optString("title");
                }
                if (!jSONObjectOptJSONObject3.isNull("description")) {
                    p2Var.f11330a.f11227l = jSONObjectOptJSONObject3.optString("description");
                }
                if (jVar.f11228m) {
                    o2 o2Var = new o2();
                    o2Var.f11308a = -1L;
                    ...
                    if (!jSONObjectOptJSONObject3.isNull("lastUpdate")) {
                        o2 o2Var2 = p2Var.f11333d;
                        o2Var2.getClass();
                        o2Var2.f11308a = jSONObjectOptJSONObject3.optLong("lastUpdate");
                    }
                    if (!jSONObjectOptJSONObject3.isNull("totalApps")) {
                        o2 o2Var3 = p2Var.f11333d;
                        o2Var3.getClass();
                        o2Var3.f11309b = jSONObjectOptJSONObject3.optInt("totalApps");
                    }
                    if (!jSONObjectOptJSONObject3.isNull("url")) {
                        o2 o2Var4 = p2Var.f11333d;
                        o2Var4.getClass();
                    ...
                    if (!jSONObjectOptJSONObject3.isNull("editor") && (jSONObjectOptJSONObject = jSONObjectOptJSONObject3.optJSONObject("editor")) != null) {
                        if (!jSONObjectOptJSONObject.isNull("editorID")) {
                            o2 o2Var5 = p2Var.f11333d;
                            o2Var5.getClass();
                            o2Var5.f11310c = jSONObjectOptJSONObject.optInt("editorID");
                        }
                        if (!jSONObjectOptJSONObject.isNull("name")) {
                            o2 o2Var6 = p2Var.f11333d;
                            o2Var6.getClass();
                            o2Var6.f11311d = jSONObjectOptJSONObject.optString("name");
                        }
                        if (!jSONObjectOptJSONObject.isNull("avatar")) {
                            o2 o2Var7 = p2Var.f11333d;
                            o2Var7.getClass();
                            o2Var7.f11312e = jSONObjectOptJSONObject.optString("avatar");
                        }
                        if (!jSONObjectOptJSONObject.isNull("jobTitle")) {
                            o2 o2Var8 = p2Var.f11333d;
                            o2Var8.getClass();
                ...
                if (!jSONObjectOptJSONObject3.isNull("floatingCategoryRelated") && (jSONArrayOptJSONArray = jSONObjectOptJSONObject3.optJSONArray("floatingCategoryRelated")) != null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        if (!jSONObjectOptJSONObject4.isNull("id")) {
                            jVar2.f11225a = jSONObjectOptJSONObject4.optInt("id");
                        }
                        if (!jSONObjectOptJSONObject4.isNull("name")) {
                            jVar2.f11226b = jSONObjectOptJSONObject4.optString("name");
                        }
                        jVar2.f11228m = true;
                        ArrayList arrayList = p2Var.f11334e;
                        arrayList.getClass();
                        arrayList.add(jVar2);
                    }
                }
    ...
    public static h K(f fVar, t6.g gVar) {
        gVar.getClass();
        return l.a(fVar.getKey(), gVar) ? t6.i.f10315a : fVar;
    }

    public static h L(f fVar, h hVar) {
        hVar.getClass();
        return hVar == t6.i.f10315a ? fVar : (h) hVar.fold(fVar, new j1(14));
    }
    ...
    public static SpannableStringBuilder M(String str, Context context, w4.f fVar) {
        ...
        for (x4.o oVar : listW) {
            int i6 = oVar.f11301a;
            String str2 = oVar.f11305e;
            String str3 = oVar.f11304d;
            int i10 = i6 - length;
                            ...
                            if (iHashCode != 1524339519) {
                                if (iHashCode != 3274) {
                                    if (iHashCode == 3275 && str4.equals("h3")) {
                                        ...
                                        typeface.getClass();
                                        spannableStringBuilder.setSpan(new j5.e(dimension, typeface, ContextCompat.getColor(context, R.color.text_primary)), i10, length2, 33);
                                    }
                                } else if (str4.equals("h2")) {
                                    float dimension2 = context.getResources().getDimension(R.dimen.text_size_l);
                                    Typeface typeface2 = f4.c.f4883w;
                                    typeface2.getClass();
                                    spannableStringBuilder.setSpan(new j5.e(dimension2, typeface2, ContextCompat.getColor(context, R.color.text_primary)), i10, length2, 33);
                                }
    ...
    */
    ...
    public static Object Z(Class cls, String str, q... qVarArr) {
        ...
        for (int i = 0; i < qVarArr.length; i++) {
            q qVar = qVarArr[i];
            qVar.getClass();
            clsArr[i] = (Class) qVar.f7781b;
            objArr[i] = qVarArr[i].f7782l;
        }
    ...
    public static void e(ImageView imageView, Context context) {
        ...
        if (bitmapDecodeFile != null) {
            ...
            imageView.setImageResource(R.drawable.ia_logo);
        }
    }
    ...
    public static r6.c m(r6.c cVar) {
        cVar.k();
        cVar.f8923l = true;
        return cVar.f8922b > 0 ? cVar : r6.c.f8920m;
    }
    ...
    public static void r(Context context) {
        ...
        while (it.hasNext()) {
            ...
            while (it2.hasNext()) {
                ...
                next2.getClass();
                q2 q2Var = (q2) next2;
                if (!q2Var.c() && (rVar = q2Var.f11353s) != null && !rVar.F.isEmpty()) {
                    ...
                    while (true) {
                        if (it3.hasNext()) {
                            ...
                            next3.getClass();
                            if (u.m0(((j0) next3).f11241q, file2.getAbsolutePath(), false)) {
                                z9 = true;
                                break;
                            }
                        }
