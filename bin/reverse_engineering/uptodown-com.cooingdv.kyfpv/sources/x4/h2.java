...
public final class h2 {
    ...
    public h2(e1.m mVar, String str, long j) {
        ...
        k0.y.d(str);
        this.f11212a = str;
        this.f11214c = mVar.R("select rowid from raw_events where app_id = ? and timestamp < ? order by rowid desc limit 1", new String[]{str, String.valueOf(j)}, -1L);
    }
    ...
    public boolean a() {
        long jCurrentTimeMillis = System.currentTimeMillis() - this.f11214c;
    ...
    public g2 c() {
        g2 g2Var = new g2();
        String str = (String) this.f11213b;
        g2Var.f11204a = str;
        g2Var.f11205b = 200;
        g2Var.f11207d = new JSONObject(str);
        return g2Var;
    }

    public List e() {
        List list;
        e1.m mVar = (e1.m) this.f11213b;
        ArrayList arrayList = new ArrayList();
        String strValueOf = String.valueOf(this.f11214c);
        String str = this.f11212a;
        ...
        try {
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    do {
                        ...
                        try {
                            ...
                            e1.w0 w0Var = mVar.f3876a.f4265o;
                            e1.t1.m(w0Var);
                            w0Var.f4340o.d(e1.w0.o(str), "Data loss. Failed to merge raw event. appId", e10);
                        }
                ...
                e1.w0 w0Var2 = mVar.f3876a.f4265o;
                e1.t1.m(w0Var2);
                w0Var2.f4340o.d(e1.w0.o(str), "Data loss. Error querying raw events batch. appId", e11);
                list = arrayList;
            }
            return list;
        } finally {
