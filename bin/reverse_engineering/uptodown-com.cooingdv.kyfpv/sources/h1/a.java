...
public final class a extends h {
    ...
    public final Bundle r() {
        v vVar = this.J;
        boolean zEquals = this.f6842l.getPackageName().equals((String) vVar.f5278m);
        Bundle bundle = this.K;
        if (!zEquals) {
            bundle.putString("com.google.android.gms.signin.internal.realClientPackageName", (String) vVar.f5278m);
        }
        return bundle;
    }
