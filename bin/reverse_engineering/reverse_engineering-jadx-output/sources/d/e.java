...
public final class e {
    ...
    static {
        ...
        while (true) {
            ...
            if (i >= cVarArr6.length) {
                HashMap map = f3526z;
                c[] cVarArr7 = v;
                map.put(Integer.valueOf(cVarArr7[0].f3506a), 5);
                map.put(Integer.valueOf(cVarArr7[1].f3506a), 1);
                map.put(Integer.valueOf(cVarArr7[2].f3506a), 2);
                map.put(Integer.valueOf(cVarArr7[3].f3506a), 3);
                map.put(Integer.valueOf(cVarArr7[4].f3506a), 7);
                map.put(Integer.valueOf(cVarArr7[5].f3506a), 8);
                Pattern.compile(".*[1-9].*");
    ...
    public final void a() {
        ...
        if (c(ExifInterface.TAG_IMAGE_WIDTH) == null) {
            mapArr[0].put(ExifInterface.TAG_IMAGE_WIDTH, b.a(0L, this.f3530d));
        }
        if (c(ExifInterface.TAG_IMAGE_LENGTH) == null) {
            mapArr[0].put(ExifInterface.TAG_IMAGE_LENGTH, b.a(0L, this.f3530d));
        }
        if (c(ExifInterface.TAG_ORIENTATION) == null) {
            mapArr[0].put(ExifInterface.TAG_ORIENTATION, b.a(0L, this.f3530d));
        }
        if (c(ExifInterface.TAG_LIGHT_SOURCE) == null) {
            mapArr[1].put(ExifInterface.TAG_LIGHT_SOURCE, b.a(0L, this.f3530d));
        }
    }
    ...
    public final String c(String str) {
        ...
        if (bVarD != null) {
            ...
            if (str.equals(ExifInterface.TAG_GPS_TIMESTAMP)) {
                ...
                d[] dVarArr = (d[]) bVarD.g(this.f3530d);
                if (dVarArr == null || dVarArr.length != 3) {
                    Log.w("ExifInterface", "Invalid GPS Timestamp array. array=" + Arrays.toString(dVarArr));
                    return null;
                }
                d dVar = dVarArr[0];
                Integer numValueOf = Integer.valueOf((int) (dVar.f3510a / dVar.f3511b));
                d dVar2 = dVarArr[1];
                Integer numValueOf2 = Integer.valueOf((int) (dVar2.f3510a / dVar2.f3511b));
                d dVar3 = dVarArr[2];
                return String.format("%02d:%02d:%02d", numValueOf, numValueOf2, Integer.valueOf((int) (dVar3.f3510a / dVar3.f3511b)));
            }
            try {
                return Double.toString(bVarD.d(this.f3530d));
    ...
    */
            ...
            if (bArr[i] != bArr2[i]) {
                ...
                for (int i6 = 0; i6 < bytes.length; i6++) {
                    if (bArr[i6] != bytes[i6]) {
                        ...
                        this.f3530d = byteOrderO;
                        aVar.f3500b = byteOrderO;
                        short s6 = aVar.readShort();
                        aVar.close();
                        ...
                        this.f3530d = byteOrderO2;
                        aVar2.f3500b = byteOrderO2;
    ...
    public final void g(a aVar) throws Throwable {
        ...
        if (bVar != null) {
            ...
            if (bVar4 != null) {
                ...
                b bVarC = b.c(i12, this.f3530d);
                b bVarC2 = b.c(i13, this.f3530d);
    ...
    public final void h(a aVar) throws IOException {
        ...
        for (int i11 = 0; i11 < i10; i11++) {
            ...
            if (unsignedShort == f3521t.f3506a) {
                short s6 = aVar.readShort();
                short s9 = aVar.readShort();
                b bVarC = b.c(s6, this.f3530d);
                b bVarC2 = b.c(s9, this.f3530d);
                HashMap[] mapArr = this.f3529c;
    ...
    public final void i(a aVar) throws Throwable {
        ...
        if (this.f3528b != 8 || (bVar = (b) mapArr[1].get(ExifInterface.TAG_MAKER_NOTE)) == null) {
            return;
        }
        a aVar2 = new a(bVar.f3505c);
        aVar2.f3500b = this.f3530d;
    ...
    public final void k(a aVar, HashMap map) throws Throwable {
        ...
        int iE = bVar.e(this.f3530d);
        int iMin = Math.min(bVar2.e(this.f3530d), aVar.f3499a.available() - iE);
        int i6 = this.f3528b;
        if (i6 != 4 && i6 != 9 && i6 != 10) {
            if (i6 == 7) {
                i = this.f;
            }
            if (iE > 0 || iMin <= 0 || this.f3527a != null) {
                return;
            }
            aVar.b(iE);
    ...
    */
    ...
    public final void q(a aVar) throws Throwable {
        b bVar;
        HashMap map = this.f3529c[4];
        b bVar2 = (b) map.get(ExifInterface.TAG_COMPRESSION);
        if (bVar2 == null) {
            k(aVar, map);
            return;
        }
        int iE = bVar2.e(this.f3530d);
        if (iE != 1) {
            if (iE == 6) {
                k(aVar, map);
                return;
        ...
        if (bVar3 != null) {
            ...
            if (!Arrays.equals(iArr2, iArr)) {
                if (this.f3528b != 3 || (bVar = (b) map.get(ExifInterface.TAG_PHOTOMETRIC_INTERPRETATION)) == null) {
                    return;
                }
                int iE2 = bVar.e(this.f3530d);
                if ((iE2 != 1 || !Arrays.equals(iArr, f3514m)) && (iE2 != 6 || !Arrays.equals(iArr, iArr2))) {
                    return;
                }
            }
            ...
            long[] jArrB = b(bVar4.g(this.f3530d));
            long[] jArrB2 = b(bVar5.g(this.f3530d));
            if (jArrB == null) {
    ...
    public final void r(int i, int i6) throws Throwable {
        ...
        int iE = bVar.e(this.f3530d);
        int iE2 = bVar2.e(this.f3530d);
        int iE3 = bVar3.e(this.f3530d);
        int iE4 = bVar4.e(this.f3530d);
        if (iE >= iE3 || iE2 >= iE4) {
            return;
        }
    ...
    public final void s(a aVar, int i) throws Throwable {
        ...
        if (bVar2 != null) {
            ...
            if (i6 == 5) {
                ...
                bVarC = b.b(dVarArr[0], this.f3530d);
                bVarC2 = b.b(dVarArr[1], this.f3530d);
            } else {
                ...
                bVarC = b.c(iArr[0], this.f3530d);
                bVarC2 = b.c(iArr[1], this.f3530d);
            }
        ...
        int iE = bVar3.e(this.f3530d);
        int iE2 = bVar5.e(this.f3530d);
        int iE3 = bVar6.e(this.f3530d);
        int iE4 = bVar4.e(this.f3530d);
        if (iE2 <= iE || iE3 <= iE4) {
            return;
        }
        b bVarC3 = b.c(iE2 - iE, this.f3530d);
        b bVarC4 = b.c(iE3 - iE4, this.f3530d);
