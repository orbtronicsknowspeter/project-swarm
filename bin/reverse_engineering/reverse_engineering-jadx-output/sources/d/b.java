...
public final class b {
    ...
    public static b a(long j, ByteOrder byteOrder) {
        long[] jArr = {j};
        ByteBuffer byteBufferWrap = ByteBuffer.wrap(new byte[e.f3519r[4]]);
    ...
    public static b b(d dVar, ByteOrder byteOrder) {
        d[] dVarArr = {dVar};
        ByteBuffer byteBufferWrap = ByteBuffer.wrap(new byte[e.f3519r[5]]);
        byteBufferWrap.order(byteOrder);
        d dVar2 = dVarArr[0];
        byteBufferWrap.putInt((int) dVar2.f3510a);
        byteBufferWrap.putInt((int) dVar2.f3511b);
        return new b(5, 1, byteBufferWrap.array());
    }

    public static b c(int i, ByteOrder byteOrder) {
        ByteBuffer byteBufferWrap = ByteBuffer.wrap(new byte[e.f3519r[3]]);
        byteBufferWrap.order(byteOrder);
