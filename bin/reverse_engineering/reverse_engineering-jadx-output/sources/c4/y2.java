                ...
                if (!(obj4 instanceof File)) {
                    if (!(obj4 instanceof DocumentFile)) {
                        ...
                        if (usableSpace > documentFile.length() * ((long) 2)) {
                            ...
                            xVar4.f7024a = o7.c0.s(o7.c0.b(v7.d.f10884a), null, null, new b.m(documentFile, str3, vVar, fileExplorerActivity, (t6.c) null, 11), 3);
                        }
                    } else if (fileExplorerActivity.f3388j0 == null) {
                        ...
                        if (usableSpace > documentFile3.length() * ((long) 2)) {
                            ...
                            xVar4.f7024a = o7.c0.s(o7.c0.b(v7.d.f10884a), null, null, new b.m(documentFile3, uri3, vVar, fileExplorerActivity, (t6.c) null, 12), 3);
                        }
                    }
                } else if (fileExplorerActivity.f3389k0 != null) {
                    File file4 = fileExplorerActivity.f3381c0;
                    ...
                    if (lValueOf.longValue() > file5.length() * ((long) 2)) {
                        ...
                        xVar4.f7024a = o7.c0.s(o7.c0.b(v7.d.f10884a), null, null, new b.m(file5, str4, vVar, fileExplorerActivity, (t6.c) null, 9), 3);
                    }
                } else if (fileExplorerActivity.f3388j0 != null) {
                    ...
                    if (usableSpace > file6.length() * ((long) 2)) {
                        ...
                        xVar4.f7024a = o7.c0.s(o7.c0.b(v7.d.f10884a), null, null, new b.m(file6, uri5, vVar, fileExplorerActivity, (t6.c) null, 10), 3);
                    }
                }
                break;
        }
