        ...
        switch (i) {
            ...
            default:
                ...
                if (b4.d.t()) {
                    ...
                    w4Var.U = false;
                    String str = q2Var.f11350q;
                    str.getClass();
                    AlertDialog.Builder builder = new AlertDialog.Builder(w4Var);
                    View viewInflate = w4Var.getLayoutInflater().inflate(2131558495, (ViewGroup) null, false);
                    int i10 = 2131362642;
                    LinearLayout linearLayout = (LinearLayout) ViewBindings.findChildViewById(viewInflate, 2131362642);
                    if (linearLayout != null) {
                        i10 = 2131363604;
                        TextView textView = (TextView) ViewBindings.findChildViewById(viewInflate, 2131363604);
                        if (textView != null) {
                            i10 = 2131363709;
                            TextView textView2 = (TextView) ViewBindings.findChildViewById(viewInflate, 2131363709);
                            if (textView2 != null) {
                                i10 = 2131364370;
                                TextView textView3 = (TextView) ViewBindings.findChildViewById(viewInflate, 2131364370);
                                if (textView3 != null) {
