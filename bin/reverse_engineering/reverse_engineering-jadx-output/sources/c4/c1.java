        ...
        switch (i6) {
            case 0:
                ...
                if (iY0 >= 0) {
                    ...
                    arrayListA.getClass();
                    ((x4.e) arrayListA.get(iY0)).f11133w = j;
            ...
            case 1:
                ...
                if (iQ0 >= 0 && (pVar = myApps.f3330c0) != null && (pVar.f4654d.get(iQ0) instanceof x4.e)) {
                    e4.p pVar2 = myApps.f3330c0;
                    ArrayList arrayList = pVar2 != null ? pVar2.f4654d : null;
                    arrayList.getClass();
            ...
            case 3:
                ...
                try {
                    ...
                    cursorQuery = sQLiteDatabase.query("downloads", gVarL.f6677n, "packagename=?", new String[]{str}, null, null, null);
                    while (cursorQuery.moveToNext()) {
                        x4.r rVarI0 = j5.g.i0(cursorQuery);
                        int i12 = rVarI0.f11354a;
                        if (i12 >= 0) {
                ...
                if (activity != null && (activity instanceof k0)) {
                    ...
                    k0Var.H(a4.x.k(str, "\n", (String) obj2), new d7.a() { // from class: c4.q
                        ...
                        public final Object invoke() {
                            ...
                            o7.c0.s(lifecycleScope, t7.n.f10348a, null, new x(k0Var2, j, null, 0), 2);
                            return p6.x.f8463a;
                        }
                    });
                }
