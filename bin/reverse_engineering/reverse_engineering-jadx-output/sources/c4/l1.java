        ...
        switch (this.f1813a) {
            ...
            case 1:
                ...
                while (it2.hasNext()) {
                    ...
                    ArrayList arrayList7 = UptodownApp.f3297k0;
                    if (arrayList7 != null) {
            ...
            default:
                ...
                for (int i6 = 0; i6 < size2; i6++) {
                    if (!l7.u.m0(rollbackActivity.getPackageName(), ((x4.e) arrayListI2.get(i6)).f11123l, true)) {
                        String str9 = ((x4.e) arrayListI2.get(i6)).f11123l;
                        str9.getClass();
                        try {
