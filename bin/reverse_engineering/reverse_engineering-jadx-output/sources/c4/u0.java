    ...
    public final void onScrolled(RecyclerView recyclerView, int i, int i6) {
        ...
        if (i6 > 0) {
            ...
            if (i11 == 1) {
                ...
                o7.c0.s(viewModelScope, v7.d.f10884a, null, new a1(b1VarZ0, followListActivity, str, cVar, 0), 2);
                return;
            }
            if (i11 == 2) {
                ...
                o7.c0.s(viewModelScope2, v7.d.f10884a, null, new a1(b1VarZ02, followListActivity, str, cVar, 1), 2);
            }
        }
    }
}
