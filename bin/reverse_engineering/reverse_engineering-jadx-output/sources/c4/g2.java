    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.f1617a) {
            case 0:
                ...
                g2VarK.f11206d = vVar.i(g2VarK, "/eapi/user/categories");
                boolean zB = g2VarK.b();
                ArrayList arrayList = this.f1620m;
                if (!zB && (jSONObject = g2VarK.f11206d) != null && (jSONArrayOptJSONArray = jSONObject.optJSONArray("data")) != null) {
                    ...
                    for (int i = 0; i < length; i++) {
                        ...
                        if (!jSONObjectOptJSONObject2.isNull("categoryID")) {
                            c1Var.f11076a = jSONObjectOptJSONObject2.optInt("categoryID");
                        }
                        if (!jSONObjectOptJSONObject2.isNull("categoryName")) {
                            c1Var.f11077b = jSONObjectOptJSONObject2.optString("categoryName");
                        }
                        if (!jSONObjectOptJSONObject2.isNull("categoryIcons") && (jSONArrayOptJSONArray2 = jSONObjectOptJSONObject2.optJSONArray("categoryIcons")) != null) {
                            ...
                            for (int i6 = 0; i6 < length2; i6++) {
                                c1Var.f11078c.add(jSONArrayOptJSONArray2.optString(i6));
                            }
                        }
                        if (!jSONObjectOptJSONObject2.isNull("categoryAppsCount")) {
                            c1Var.f11079d = jSONObjectOptJSONObject2.optInt("categoryAppsCount");
                        }
                        arrayList.add(c1Var);
                    }
                }
            ...
            default:
                ...
                g2VarK2.f11206d = vVar2.i(g2VarK2, "/eapi/v2/pre-register-apps-by-user");
                boolean zB2 = g2VarK2.b();
                ArrayList arrayList2 = this.f1620m;
                if (!zB2 && (jSONObject2 = g2VarK2.f11206d) != null && (jSONObjectOptJSONObject = jSONObject2.optJSONObject("data")) != null) {
                    ...
                    if (jSONArrayOptJSONArray3 != null) {
                        ...
                        while (iOptInt < length3) {
                            ...
                            if (!jSONObjectOptJSONObject3.isNull("appID")) {
                                x1Var.f11448a = jSONObjectOptJSONObject3.optLong("appID");
                            }
                            if (!jSONObjectOptJSONObject3.isNull("name")) {
                                x1Var.f11449b = jSONObjectOptJSONObject3.optString("name");
                            }
                            if (!jSONObjectOptJSONObject3.isNull("iconURL")) {
                                x1Var.f11450c = jSONObjectOptJSONObject3.optString("iconURL");
                            }
                            if (!jSONObjectOptJSONObject3.isNull("authorName")) {
                                x1Var.f11451d = jSONObjectOptJSONObject3.optString("authorName");
                            }
