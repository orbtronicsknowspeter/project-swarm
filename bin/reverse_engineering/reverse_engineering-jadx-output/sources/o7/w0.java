...
public abstract class w0 extends r0 implements h0 {
    ...
    */
    public final long B() {
        /*
            r10 = this;
            f8.w r0 = o7.c0.f8245c
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r1 = o7.w0.f8322n
            boolean r2 = r10.C()
            r3 = 0
            if (r2 == 0) goto Le
            goto Lb4
        ...
        L90:
            ...
            if (r0 == 0) goto Lb8
            monitor-enter(r0)
            o7.u0[] r1 = r0.f10363a     // Catch: java.lang.Throwable -> La3
            if (r1 == 0) goto La5
            r2 = 0
        ...
        do {
            synchronized (v0Var) {
                try {
                    ...
                    if (u0Var != null) {
                        u0VarC = ((jNanoTime - u0Var.f8316a) > 0L ? 1 : ((jNanoTime - u0Var.f8316a) == 0L ? 0 : -1)) >= 0 ? F(u0Var) : false ? v0Var.c(0) : null;
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    */
    ...
    public void shutdown() {
        ...
        while (true) {
            ...
            synchronized (v0Var) {
                u0VarC = t7.x.f10362b.get(v0Var) > 0 ? v0Var.c(0) : null;
            }
            if (u0VarC == null) {
                return;
            } else {
