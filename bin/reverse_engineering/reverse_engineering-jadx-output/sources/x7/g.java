    ...
    */
    public final boolean tryLock(java.lang.Object r7) {
        /*
            r6 = this;
        L0:
            java.util.concurrent.atomic.AtomicIntegerFieldUpdater r0 = x7.l.f11536p
            int r1 = r0.get(r6)
            int r2 = r6.f11537a
            if (r1 <= r2) goto L17
        La:
            ...
            goto L0
        L17:
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r2 = x7.g.f11527q
            r3 = 1
            if (r1 > 0) goto L43
            r4 = 0
            if (r7 != 0) goto L20
