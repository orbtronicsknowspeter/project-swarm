    ...
    public final boolean H(int i, Parcel parcel, Parcel parcel2) {
        if (i == 1) {
            ...
            if (eVar2 instanceof v0.a) {
                f fVar = g0Var.f6879m;
                l lVarB = l.b();
                m mVar = fVar == null ? null : fVar.f6855a;
                synchronized (lVarB) {
                    if (mVar == null) {
                        mVar = l.f6906l;
                    } else {
                        m mVar2 = (m) lVarB.f6907a;
                        if (mVar2 == null || mVar2.f6908a < mVar.f6908a) {
                        }
                    }
                    lVarB.f6907a = mVar;
                }
            }
            Bundle bundle2 = g0Var.f6876a;
            y.h(this.j, "onPostInitComplete can be called only once per call to getRemoteService");
            e eVar3 = this.j;
            int i12 = this.f6836k;
            eVar3.getClass();
            e0 e0Var2 = new e0(eVar3, i11, strongBinder2, bundle2);
            b0 b0Var2 = eVar3.f6844o;
