        ...
        switch (i) {
            case 0:
                ...
                if (i6 != 0) {
                    ...
                    this.f1002b = 1;
                    v7.e eVar = m0.f8288a;
                    Object objC = c0.C(new b(uptodownApp, null), v7.d.f10884a, this);
                    if (objC != aVar) {
                        objC = xVar;
                    }
                    if (objC == aVar) {
            ...
            case 1:
                ...
                if (i10 != 0) {
                    ...
                    Object objC2 = c0.C(new e(uptodownApp, cVar, 0), v7.d.f10884a, this);
                    if (objC2 != aVar) {
                        objC2 = xVar;
                    }
                    if (objC2 == aVar) {
            ...
            default:
                ...
                try {
                    if (i11 != 0) {
                        ...
                        Object objC3 = c0.C(new j(uptodownApp, arrayListI, aVar2, (t6.c) null), v7.d.f10884a, this);
                        if (objC3 != aVar) {
                            objC3 = xVar;
                        }
                        if (objC3 == aVar) {
