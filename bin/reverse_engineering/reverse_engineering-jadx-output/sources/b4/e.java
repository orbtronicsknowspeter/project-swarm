        ...
        switch (this.f999a) {
            ...
            default:
                ...
                if (str == null || str.length() == 0) {
                    ...
                    g2VarK.f11206d = vVar.i(g2VarK, "api.country.is/");
                    Bundle bundle = new Bundle();
                    if (!g2VarK.b() && (jSONObject = g2VarK.f11206d) != null && !jSONObject.isNull("country")) {
                        String strOptString = jSONObject.optString("country");
                        z3.g = strOptString;
                        bundle.putString("country", strOptString);
                    }
                    bundle.putString("responseCode", String.valueOf(g2VarK.f11204b));
