...
public final class f0 extends Fragment {
    ...
    public f0() {
        ...
        this.f10485x = activityResultLauncherRegisterForActivityResult;
        ...
        this.f10486y = activityResultLauncherRegisterForActivityResult2;
    }
    ...
    */
    ...
    public final void A() {
        ...
        bVar2.getClass();
        bVar2.f9613m.setScrimVisibleHeightTrigger((int) (((double) UptodownApp.T) * 0.4d));
    }
    ...
    public final void E() {
        if (getContext() != null) {
            ...
            long j = B().f11158a;
            v0VarG.getClass();
            o7.c0.s(ViewModelKt.getViewModelScope(v0VarG), v7.d.f10884a, null, new n0(2, j, contextRequireContext, null, v0VarG), 2);
        }
    }
    ...
    */
    ...
    public final void M(File file) {
        ...
        if (!l7.u.k0(name, ".xapk", true) && !l7.u.k0(name, ".apks", true) && !l7.u.k0(name, ".apkm", true) && !l7.u.k0(name, ".zip", true)) {
            ...
            b4.d.q(fragmentActivityRequireActivity, B().f11161c0, file);
            return;
        }
    ...
    public final void N(k2 k2Var) {
        ...
        contextRequireContext.getClass();
        v0VarG.getClass();
        o7.c0.s(ViewModelKt.getViewModelScope(v0VarG), v7.d.f10884a, null, new b6.g(v0VarG, k2Var, contextRequireContext, cVar, 24), 2);
    }
    ...
    public final void O(String str) {
        ...
        if (B().f11158a >= 0) {
            bundleE.putString("appId", String.valueOf(B().f11158a));
        }
        if (B().J >= 0) {
    ...
    public final void R() {
        ...
        FragmentActivity fragmentActivityRequireActivity = requireActivity();
        fragmentActivityRequireActivity.getClass();
        this.f10485x.launch(intent, b4.d.b(fragmentActivityRequireActivity));
    }
    ...
    public final void W() {
        ...
        if (str3 == null || str3.length() == 0) {
            t4.b bVar = this.f10473b;
            bVar.getClass();
            bVar.T.f9652b.setImageDrawable(ContextCompat.getDrawable(contextRequireContext, 2131231296));
            t4.b bVar2 = this.f10473b;
            bVar2.getClass();
            ((ImageView) bVar2.H.f8822q).setImageDrawable(ContextCompat.getDrawable(contextRequireContext, 2131231296));
        } else {
        ...
        if (str5 != null && str5.length() != 0) {
            ...
            t4.b bVar6 = this.f10473b;
            bVar6.getClass();
            bVar6.F0.setText(contextRequireContext.getString(2131952605, B().f11159b));
        }
            ...
            if (str13 == null || str13.length() == 0) {
                ...
                if (str14 != null && str14.length() != 0) {
                    ...
                    if (str17 == null || str17.length() == 0) {
                        ...
                        a4.l0 l0VarE3 = a4.g0.d().e(B().f11173m0);
        ...
        if (i10 == 0) {
            ...
            bVar42.getClass();
            bVar42.T.E.setText(String.valueOf(((double) B().f11194y) / 10.0d));
            int i11 = B().f11196z;
        ...
        bVar57.getClass();
        ((TextView) bVar57.D.f8823r).setText(String.valueOf(((double) B().f11194y) / 10.0d));
        int i12 = B().f11196z;
        ...
        if (r1VarA != null && r1VarA.f11371a == B().f11158a && r1VarA.f11375e <= 0) {
            r1VarA.f11375e = System.currentTimeMillis();
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ...
            if (bVar71.F.getVisibility() == 8) {
                ...
                while (it.hasNext()) {
                    ...
                    if (str30.length() > 0) {
                        View viewInflate = getLayoutInflater().inflate(2131558854, (ViewGroup) null, false);
                        int i13 = 2131362541;
                        if (((ImageView) ViewBindings.findChildViewById(viewInflate, 2131362541)) != null) {
                            i13 = 2131364521;
                            TextView textView8 = (TextView) ViewBindings.findChildViewById(viewInflate, 2131364521);
                            if (textView8 != null) {
    ...
    public final RelativeLayout X(LinearLayout.LayoutParams layoutParams, k2 k2Var, Context context) {
        ...
        t4.p0 p0VarA = t4.p0.a(getLayoutInflater().inflate(2131558803, (ViewGroup) null, false));
        TextView textView = p0VarA.f10056x;
        LinearLayout linearLayout = p0VarA.f10053t;
        ImageView imageView = p0VarA.f10045l;
        TextView textView2 = p0VarA.f10058z;
        TextView textView3 = p0VarA.f10055w;
        LinearLayout linearLayout2 = p0VarA.f10054u;
        ImageView imageView2 = p0VarA.f10046m;
        TextView textView4 = p0VarA.f10057y;
        TextView textView5 = p0VarA.v;
        UsernameTextView usernameTextView = p0VarA.B;
        RelativeLayout relativeLayout = p0VarA.f10043a;
        relativeLayout.setLayoutParams(layoutParams);
        p0VarA.f10048o.setImageDrawable(ContextCompat.getDrawable(context, 2131231441));
        ImageView imageView3 = p0VarA.f10049p;
        imageView3.setImageDrawable(ContextCompat.getDrawable(context, 2131231439));
        ImageView imageView4 = p0VarA.f10050q;
        imageView4.setImageDrawable(ContextCompat.getDrawable(context, 2131231439));
        ImageView imageView5 = p0VarA.f10051r;
        imageView5.setImageDrawable(ContextCompat.getDrawable(context, 2131231439));
        ImageView imageView6 = p0VarA.f10052s;
        ...
        if (strE == null || strE.length() == 0) {
            ...
            a4.l0 l0VarE = a4.g0.d().e(u2.e(k2Var.f11261m));
            float f = UptodownApp.I;
        ...
        int i14 = 6;
        if (kotlin.jvm.internal.l.a(w2VarH != null ? w2VarH.f11431a : charSequenceK0, k2Var.f11259b)) {
        ...
        if (str4 == null || str4.length() == 0) {
            ...
            if (j5.t.f6709b.contains(Long.valueOf(k2Var.f11258a))) {
                k0.k.l(this, 2131231344, p0VarA.f10047n);
            }
    ...
    public final RelativeLayout Y(LinearLayout.LayoutParams layoutParams, k2 k2Var, Context context) {
        int i;
        CharSequence charSequenceK0;
        t4.q0 q0VarA = t4.q0.a(getLayoutInflater().inflate(2131558805, (ViewGroup) null, false));
        ImageView imageView = q0VarA.f10072t;
        LinearLayout linearLayout = q0VarA.f10073u;
        TextView textView = q0VarA.f10076y;
        TextView textView2 = q0VarA.A;
        TextView textView3 = q0VarA.f10075x;
        LinearLayout linearLayout2 = q0VarA.v;
        ImageView imageView2 = q0VarA.f10065m;
        ImageView imageView3 = q0VarA.f10064l;
        TextView textView4 = q0VarA.f10077z;
        TextView textView5 = q0VarA.f10074w;
        UsernameTextView usernameTextView = q0VarA.C;
        RelativeLayout relativeLayout = q0VarA.f10062a;
        relativeLayout.setLayoutParams(layoutParams);
        q0VarA.f10067o.setImageDrawable(ContextCompat.getDrawable(context, 2131231442));
        ImageView imageView4 = q0VarA.f10068p;
        imageView4.setImageDrawable(ContextCompat.getDrawable(context, 2131231440));
        ImageView imageView5 = q0VarA.f10069q;
        imageView5.setImageDrawable(ContextCompat.getDrawable(context, 2131231440));
        ImageView imageView6 = q0VarA.f10070r;
        imageView6.setImageDrawable(ContextCompat.getDrawable(context, 2131231440));
        ImageView imageView7 = q0VarA.f10071s;
        ...
        if (k2Var.f11263o != null) {
            ...
            textView.setText(String.valueOf(k2Var.f11267s));
            if (j5.t.f6709b.contains(Long.valueOf(k2Var.f11258a))) {
                k0.k.l(this, 2131231344, q0VarA.f10066n);
            }
    ...
    public final void Z(String str) {
        ...
        v0VarG.getClass();
        str.getClass();
        o7.c0.s(ViewModelKt.getViewModelScope(v0VarG), v7.d.f10884a, null, new t0(contextRequireContext, str, iIntValue2, j, v0VarG, null), 2);
    }
    ...
    */
    ...
    public final void c0(Context context) {
        ...
        if (z9) {
            string = context.getString(2131952428);
            string.getClass();
        } else {
            String str = B().f11164f0;
            if (str == null || str.length() == 0) {
                string = context.getString(2131952428);
                string.getClass();
            } else {
                HashMap map = B().f11186t0;
        ...
        t4.b bVar8 = this.f10473b;
        bVar8.getClass();
        bVar8.T.f9656o.setVisibility(0);
        t4.b bVar9 = this.f10473b;
        bVar9.getClass();
        bVar9.T.f9654m.setVisibility(8);
        t4.b bVar10 = this.f10473b;
        bVar10.getClass();
        ...
        t4.b bVar12 = this.f10473b;
        bVar12.getClass();
        bVar12.P.f9809s.setOnClickListener(new p(this, 2));
        t4.b bVar13 = this.f10473b;
        bVar13.getClass();
        bVar13.L.f9862b.setVisibility(4);
        t4.b bVar14 = this.f10473b;
        bVar14.getClass();
        TextView textView2 = bVar14.L.f9875y;
    ...
    public final void d0(x4.r rVar) {
        ...
        if (zL) {
            ...
            if (isAdded() && getContext() != null) {
                strValueOf = a4.x.C(strValueOf, requireContext().getString(2131952466));
            }
            t4.b bVar11 = this.f10473b;
            bVar11.getClass();
            ...
            if (rVar.k() > 0) {
                ...
                Context contextRequireContext2 = requireContext();
                contextRequireContext2.getClass();
                textView3.setText(getString(2131952467, numValueOf, i5.H(contextRequireContext2, jK)));
            }
            t4.b bVar14 = this.f10473b;
            bVar14.getClass();
    ...
    public final void e0() {
        ...
        if (!file.exists() && !file.mkdirs()) {
            String string = getString(2131951991);
            string.getClass();
            v(string);
            return;
        }
        ...
        if (!H()) {
            ...
            View viewInflate = getLayoutInflater().inflate(2131558886, (ViewGroup) null, false);
            int i10 = 2131363003;
            ProgressBar progressBar = (ProgressBar) ViewBindings.findChildViewById(viewInflate, 2131363003);
            if (progressBar != null) {
                LinearLayout linearLayout = (LinearLayout) viewInflate;
                int i11 = 2131364091;
                TextView textView = (TextView) ViewBindings.findChildViewById(viewInflate, 2131364091);
                if (textView != null) {
                    i11 = 2131364095;
                    TextView textView2 = (TextView) ViewBindings.findChildViewById(viewInflate, 2131364095);
                    if (textView2 != null) {
                        i11 = 2131364096;
                        TextView textView3 = (TextView) ViewBindings.findChildViewById(viewInflate, 2131364096);
                        if (textView3 != null) {
                            i11 = 2131364097;
                            if (((TextView) ViewBindings.findChildViewById(viewInflate, 2131364097)) != null) {
                                textView2.setTypeface(f4.c.f4883x);
                                progressBar.setProgress((int) j);
                                textView3.setTypeface(f4.c.f4883x);
                                textView3.setText(getString(2131952392, strH));
        ...
        t4.b bVar2 = this.f10473b;
        bVar2.getClass();
        bVar2.T.C.setText(getString(2131952625));
        t4.b bVar3 = this.f10473b;
        bVar3.getClass();
        bVar3.T.f9659r.setProgress(0);
        t4.b bVar4 = this.f10473b;
        bVar4.getClass();
        bVar4.L.f9871t.setVisibility(0);
        t4.b bVar5 = this.f10473b;
        bVar5.getClass();
        bVar5.L.v.setVisibility(8);
        t4.b bVar6 = this.f10473b;
        bVar6.getClass();
        bVar6.L.f9873w.setText(2131952830);
        t4.b bVar7 = this.f10473b;
        bVar7.getClass();
        TextView textView4 = bVar7.L.f9874x;
        Context contextRequireContext6 = requireContext();
        contextRequireContext6.getClass();
        textView4.setText(String.format("/%s", Arrays.copyOf(new Object[]{i5.H(contextRequireContext6, jF), requireContext()}, 2)));
        t4.b bVar8 = this.f10473b;
        bVar8.getClass();
        bVar8.L.f9865n.setProgress(0);
        AlertDialog alertDialog = this.f10477o;
        FragmentActivity fragmentActivityRequireActivity = requireActivity();
        fragmentActivityRequireActivity.getClass();
        AlertDialog alertDialogA = j5.c.a(alertDialog, fragmentActivityRequireActivity);
        this.f10477o = alertDialogA;
        if (alertDialogA == null) {
            if (B().j()) {
                x4.r rVar = new x4.r();
                rVar.a(B());
                if (B().m() && (str = B().f11189v0) != null && str.length() != 0) {
                    long j6 = B().f11158a;
                    String str2 = B().f11189v0;
                    str2.getClass();
                    int i12 = B().f11191w0;
                    Context contextRequireContext7 = requireContext();
                    contextRequireContext7.getClass();
                ...
                if (z9 && zD && zE && zIsEmpty) {
                    ...
                    O("sdk");
                    String string2 = getString(2131952293);
                    string2.getClass();
                    u(string2);
                } else if (!zD) {
                    O("abi");
                    String string3 = getString(2131952289);
                    string3.getClass();
                    u(string3);
                } else if (zE) {
                    O("required_feature");
                    String string4 = getString(2131952291);
                    string4.getClass();
                    u(string4);
                } else {
                    O("density");
                    String string5 = getString(2131952290);
                    string5.getClass();
                    u(string5);
                }
            } else {
                O("no_file_id");
                String string6 = getString(2131952263);
                string6.getClass();
                v(string6);
            }
            d0(null);
    ...
    public final void g0(Context context, x4.r rVar) {
        ...
        if (totalSpace > 0) {
            ...
            t4.b bVar2 = this.f10473b;
            bVar2.getClass();
            ((ProgressBar) bVar2.M0.f5279o).setProgress((int) j);
            t4.b bVar3 = this.f10473b;
            bVar3.getClass();
            ((TextView) bVar3.M0.f5277m).setTypeface(f4.c.f4883x);
            t4.b bVar4 = this.f10473b;
            bVar4.getClass();
            ((TextView) bVar4.M0.f5277m).setText(context.getString(2131952392, strH));
            t4.b bVar5 = this.f10473b;
            bVar5.getClass();
    ...
    public final void j0(q2 q2Var) {
        ...
        if (i > 0) {
            ...
            t4.b bVar13 = this.f10473b;
            bVar13.getClass();
            bVar13.T.f9659r.setProgress(rVarA.i());
            t4.b bVar14 = this.f10473b;
            bVar14.getClass();
            bVar14.L.f9865n.setIndeterminate(false);
        } else {
        ...
        Context contextRequireContext2 = requireContext();
        contextRequireContext2.getClass();
        textView4.setText(getString(2131952467, numValueOf, i5.H(contextRequireContext2, jK)));
        t4.b bVar17 = this.f10473b;
        bVar17.getClass();
        ...
        t4.b bVar19 = this.f10473b;
        bVar19.getClass();
        bVar19.L.f9865n.setProgress(rVarA.i());
        t4.b bVar20 = this.f10473b;
        bVar20.getClass();
        ...
        t4.b bVar22 = this.f10473b;
        bVar22.getClass();
        bVar22.L.v.setText(rVarA.i() + getString(2131952466));
        t4.b bVar23 = this.f10473b;
        bVar23.getClass();
    ...
    public final void l0(Rect rect) {
        ...
        t4.b bVar = this.f10473b;
        bVar.getClass();
        if (bVar.P.f9801b.getLocalVisibleRect(rect) && !((Boolean) G().L.getValue()).booleanValue()) {
            Context contextRequireContext = requireContext();
            contextRequireContext.getClass();
            t4.b bVar2 = this.f10473b;
            bVar2.getClass();
            ...
            if (z9) {
                float f10 = UptodownApp.I;
                relativeLayout.startAnimation(AnimationUtils.loadAnimation(contextRequireContext, 2130772034));
        ...
        t4.b bVar3 = this.f10473b;
        bVar3.getClass();
        if (bVar3.P.f9801b.getLocalVisibleRect(rect) || !((Boolean) G().L.getValue()).booleanValue()) {
            return;
        }
        Context contextRequireContext2 = requireContext();
        contextRequireContext2.getClass();
        ...
        if (z10) {
            ...
            relativeLayout2.startAnimation(AnimationUtils.loadAnimation(contextRequireContext2, 2130772030));
        ...
        if (getContext() != null) {
            ...
            if (((c4.k0) activity).T()) {
                ...
                if (B().C0 == 1) {
                    ...
                    v7.e eVar = o7.m0.f8288a;
                    o7.c0.s(viewModelScope, v7.d.f10884a, null, new r0(1, j, contextRequireContext2, null, v0VarG), 2);
                } else {
                    v0 v0VarG2 = G();
                    Context contextRequireContext3 = requireContext();
                    contextRequireContext3.getClass();
                    ...
                    o7.c0.s(viewModelScope2, v7.d.f10884a, null, new r0(0, j6, contextRequireContext3, null, v0VarG2), 2);
                }
        ...
        if (getContext() != null) {
            ...
            if (((c4.k0) activity).T()) {
                ...
                if (B().B0 == 1) {
                    ...
                    o7.a0 viewModelScope = ViewModelKt.getViewModelScope(v0VarG);
                    v7.e eVar = o7.m0.f8288a;
                    o7.c0.s(viewModelScope, v7.d.f10884a, null, new r0(3, j, contextRequireContext2, null, v0VarG), 2);
                } else {
                    v0 v0VarG2 = G();
                    Context contextRequireContext3 = requireContext();
                    contextRequireContext3.getClass();
                    ...
                    o7.a0 viewModelScope2 = ViewModelKt.getViewModelScope(v0VarG2);
                    v7.e eVar2 = o7.m0.f8288a;
                    o7.c0.s(viewModelScope2, v7.d.f10884a, null, new r0(2, j6, contextRequireContext3, null, v0VarG2), 2);
                }
                if (getActivity() instanceof AppDetailActivity) {
                    FragmentActivity activity2 = getActivity();
                    activity2.getClass();
    ...
    public final void o0(ArrayList arrayList) {
        ...
        if (((c4.k0) activity).T()) {
            final int i = 0;
            View viewInflate = getLayoutInflater().inflate(2131558800, (ViewGroup) null, false);
            int i6 = 2131362328;
            ImageView imageView = (ImageView) ViewBindings.findChildViewById(viewInflate, 2131362328);
            if (imageView != null) {
                i6 = 2131363249;
                if (((LinearLayout) ViewBindings.findChildViewById(viewInflate, 2131363249)) != null) {
                    i6 = 2131363305;
                    RelativeLayout relativeLayout = (RelativeLayout) ViewBindings.findChildViewById(viewInflate, 2131363305);
                    if (relativeLayout != null) {
                        i6 = 2131363345;
                        MaxHeightRecyclerView maxHeightRecyclerView = (MaxHeightRecyclerView) ViewBindings.findChildViewById(viewInflate, 2131363345);
                        if (maxHeightRecyclerView != null) {
                            i6 = 2131364223;
                            TextView textView = (TextView) ViewBindings.findChildViewById(viewInflate, 2131364223);
                            if (textView != null) {
                                i6 = 2131364411;
                                TextView textView2 = (TextView) ViewBindings.findChildViewById(viewInflate, 2131364411);
                                if (textView2 != null) {
                                    i6 = 2131364629;
                                    View viewFindChildViewById = ViewBindings.findChildViewById(viewInflate, 2131364629);
                                    if (viewFindChildViewById != null) {
                                        ...
                                        float f10 = UptodownApp.I;
                                        relativeLayout.startAnimation(AnimationUtils.loadAnimation(fragmentActivityRequireActivity2, 2130772030));
                                        relativeLayout.setVisibility(0);
                                        return;
                                    }
                                }
    ...
    */
    ...
    public final void q() {
        if (B().l()) {
            ...
            long j = B().f11158a;
            v0VarG.getClass();
            o7.c0.s(ViewModelKt.getViewModelScope(v0VarG), v7.d.f10884a, null, new n0(1, j, contextRequireContext, null, v0VarG), 2);
        }
    }
    ...
    public final void r(t4.n0 n0Var) {
        ...
        if (G().U.compareAndSet(false, true)) {
            FragmentActivity fragmentActivityRequireActivity = requireActivity();
            fragmentActivityRequireActivity.getClass();
            new v4(fragmentActivityRequireActivity, 1).g((View) n0Var.f10015l, 0.0f);
            FragmentActivity fragmentActivityRequireActivity2 = requireActivity();
            fragmentActivityRequireActivity2.getClass();
            RelativeLayout relativeLayout = (RelativeLayout) n0Var.f10014b;
            n5.c cVar = new n5.c(this, z9 ? 1 : 0);
            Animation animationLoadAnimation = AnimationUtils.loadAnimation(fragmentActivityRequireActivity2, 2130772034);
            float f = UptodownApp.I;
            try {
                SharedPreferences sharedPreferences = fragmentActivityRequireActivity2.getSharedPreferences("SettingsPreferences", 0);
                if (sharedPreferences.contains("animations")) {
    ...
    public final void x(Context context) {
        ...
        View viewInflate = getLayoutInflater().inflate(2131558529, (ViewGroup) null, false);
        LinearLayout linearLayout = (LinearLayout) viewInflate;
        int i6 = 2131362158;
        EditText editText = (EditText) ViewBindings.findChildViewById(viewInflate, 2131362158);
        if (editText != null) {
            i6 = 2131362300;
            ImageView imageView = (ImageView) ViewBindings.findChildViewById(viewInflate, 2131362300);
            if (imageView != null) {
                i6 = 2131362484;
                ImageView imageView2 = (ImageView) ViewBindings.findChildViewById(viewInflate, 2131362484);
                if (imageView2 != null) {
                    i6 = 2131362490;
                    ImageView imageView3 = (ImageView) ViewBindings.findChildViewById(viewInflate, 2131362490);
                    if (imageView3 != null) {
                        i6 = 2131362496;
                        ImageView imageView4 = (ImageView) ViewBindings.findChildViewById(viewInflate, 2131362496);
                        if (imageView4 != null) {
                            i6 = 2131362502;
                            ImageView imageView5 = (ImageView) ViewBindings.findChildViewById(viewInflate, 2131362502);
                            if (imageView5 != null) {
                                i6 = 2131362508;
                                ImageView imageView6 = (ImageView) ViewBindings.findChildViewById(viewInflate, 2131362508);
                                if (imageView6 != null) {
                                    i6 = 2131363640;
                                    TextView textView = (TextView) ViewBindings.findChildViewById(viewInflate, 2131363640);
                                    if (textView != null) {
                                        i6 = 2131363688;
                                        TextView textView2 = (TextView) ViewBindings.findChildViewById(viewInflate, 2131363688);
                                        if (textView2 != null) {
                                            i6 = 2131364110;
    ...
    public final void y() {
        ...
        if (getContext() != null) {
            ...
            if (b4.d.k(B().F)) {
                ...
                kVar.getClass();
                kVar.f11250d = rVarD.f11354a;
                e1.c0 c0Var = j5.g.D;
                Context contextRequireContext4 = requireContext();
                contextRequireContext4.getClass();
                j5.g gVarL2 = c0Var.l(contextRequireContext4);
                gVarL2.b();
                x4.r rVarJ = gVarL2.J(rVarD.f11354a);
            ...
            if (getContext() != null && i6 >= 0) {
                ...
                if (r1VarA != null && r1VarA.f11373c == -1 && kotlin.jvm.internal.l.a(r1VarA.f11372b, str3) && r1VarA.f11371a == j6) {
                    Context contextRequireContext6 = requireContext();
                    contextRequireContext6.getClass();
                    r1VarA.f11373c = i6;
            ...
            if (b4.d.p(contextRequireContext7, "downloadApkWorker")) {
                ...
                t4.b bVar3 = this.f10473b;
                bVar3.getClass();
                bVar3.P.f9809s.setOnClickListener(new e(this, 4));
                t4.b bVar4 = this.f10473b;
                bVar4.getClass();
                bVar4.L.f9862b.setVisibility(0);
                Context contextRequireContext8 = requireContext();
                contextRequireContext8.getClass();
                try {
                ...
                if (!z9) {
                    ...
                    string2.getClass();
                    ((c4.k0) activity2).A(String.format(string2, Arrays.copyOf(new Object[]{B().f11159b}, 1)));
                }
            } else {
