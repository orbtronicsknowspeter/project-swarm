    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.f10567a) {
            case 0:
                ...
                String strH = a4.x.h(this.f10569l, "https://www.uptodown.app:443/eapi/floating-categories/app/");
                j5.v vVar = this.f10568b;
                g2 g2VarK = vVar.k(strH, null, ShareTarget.METHOD_GET, false);
                g2VarK.f11206d = vVar.i(g2VarK, "/eapi/floating-categories/app");
                if (!g2VarK.b() && (jSONObject = g2VarK.f11206d) != null && (jSONArrayOptJSONArray = jSONObject.optJSONArray("data")) != null) {
            ...
            default:
                ...
                long j = this.f10569l;
                g2 g2VarA = vVar2.A(j);
                if (!g2VarA.b() && (jSONObject2 = g2VarA.f11206d) != null && jSONObject2.optInt("success") == 1 && (jSONObjectOptJSONObject = jSONObject2.optJSONObject("data")) != null && (jSONArrayOptJSONArray3 = jSONObjectOptJSONObject.optJSONArray("videos")) != null) {
                    ...
                    for (int i11 = 0; i11 < length4; i11++) {
                        ...
                        if (!jSONObjectOptJSONObject6.isNull("youtubeID")) {
                            d3Var.f11119a = jSONObjectOptJSONObject6.optString("youtubeID");
                        }
                        if (!jSONObjectOptJSONObject6.isNull("image")) {
                            d3Var.f11120b = jSONObjectOptJSONObject6.optString("image");
                        }
                ...
                g2 g2VarR = vVar2.r(j);
                if (!g2VarR.b() && (str = g2VarR.f11203a) != null && str.length() != 0) {
                    String str2 = g2VarR.f11203a;
                    str2.getClass();
                    ...
                    if (jSONObject3.optInt("success") == 1 && (jSONArrayOptJSONArray2 = jSONObject3.optJSONArray("data")) != null) {
                        ...
                        for (int i12 = 0; i12 < length5; i12++) {
                            ...
                            if (!jSONObjectOptJSONObject7.isNull("screenshotURL")) {
                                l2Var.f11277a = jSONObjectOptJSONObject7.optString("screenshotURL");
                            }
                            if (!jSONObjectOptJSONObject7.isNull("isVertical")) {
                                l2Var.f11280m = jSONObjectOptJSONObject7.optInt("isVertical");
                            }
                            if (!jSONObjectOptJSONObject7.isNull("featured")) {
                                l2Var.f11279l = jSONObjectOptJSONObject7.optInt("featured");
                            }
                            if (l2Var.f11279l == 0) {
