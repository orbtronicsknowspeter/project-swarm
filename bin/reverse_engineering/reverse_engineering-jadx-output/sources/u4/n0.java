    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (this.f10551a) {
            case 0:
                ...
                long j = this.f10553l;
                g2 g2VarB = vVar.b(j);
                if (!g2VarB.b() && (jSONObject = g2VarB.f11206d) != null && jSONObject.optInt("success") == 1) {
            ...
            case 1:
                ...
                boolean z9 = false;
                g2 g2VarK = vVar2.k(k0.k.g(this.f10553l, "https://www.uptodown.app:443/eapi/app/", "/pre-registered"), j5.v.g(), ShareTarget.METHOD_GET, false);
                g2VarK.f11206d = vVar2.i(g2VarK, "/eapi/app/appID/pre-registered");
                if (g2VarK.b() || (jSONObject2 = g2VarK.f11206d) == null || (jSONObjectOptJSONObject = jSONObject2.optJSONObject("data")) == null) {
                    strOptString = null;
                } else {
            ...
            case 2:
                ...
                g2 g2VarK2 = vVar3.k(k0.k.g(this.f10553l, "https://www.uptodown.app:443/eapi/v2/apps/", "/promoted"), j5.v.g(), ShareTarget.METHOD_GET, false);
                g2VarK2.f11206d = vVar3.i(g2VarK2, "/eapi/v2/apps/appID/promoted");
                if (!g2VarK2.b() && (jSONObject3 = g2VarK2.f11206d) != null) {
            ...
            default:
                ...
                if (value != null) {
                    ...
                    g2VarK3.f11206d = vVar4.i(g2VarK3, "/dwn/appID/native-external-update/increase");
                } else {
                    g2 g2VarK4 = vVar4.k(k0.k.g(j6, "https://www.uptodown.com:443/dwn/", "/native-external/increase"), null, ShareTarget.METHOD_POST, false);
                    g2VarK4.f11206d = vVar4.i(g2VarK4, "/dwn/appID/native-external/increase");
                }
                break;
        }
        return p6.x.f8463a;
