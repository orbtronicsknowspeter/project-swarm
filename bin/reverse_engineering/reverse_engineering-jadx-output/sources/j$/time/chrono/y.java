...
public final class y implements m, Serializable {
    ...
    public static final y f5806d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public static final y[] f5807e;
    private static final long serialVersionUID = 1466499369062886794L;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    public final transient int f5808a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final transient j$.time.h f5809b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final transient String f5810c;
    ...
    static {
        ...
        f5806d = yVar;
        f5807e = new y[]{yVar, new y(0, j$.time.h.D(1912, 7, 30), "Taisho"), new y(1, j$.time.h.D(1926, 12, 25), "Showa"), new y(2, j$.time.h.D(1989, 1, 8), "Heisei"), new y(3, j$.time.h.D(2019, 5, 1), "Reiwa")};
    }

    public final y i() {
        if (this == f5807e[r0.length - 1]) {
            return null;
        }
        return l(this.f5808a + 1);
    }
    ...
    */
    public static j$.time.chrono.y d(j$.time.h r5) {
        ...
        L22:
            if (r0 != 0) goto L3c
            j$.time.chrono.y[] r0 = j$.time.chrono.y.f5807e
            int r0 = r0.length
            int r0 = r0 - r2
        L28:
            if (r0 < 0) goto L3a
            j$.time.chrono.y[] r1 = j$.time.chrono.y.f5807e
            r1 = r1[r0]
            j$.time.h r2 = r1.f5809b
