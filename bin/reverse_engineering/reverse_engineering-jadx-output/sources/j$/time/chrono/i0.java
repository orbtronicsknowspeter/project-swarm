...
public final class i0 extends d {
    ...
    public final transient j$.time.h f5779a;
    ...
    public final int hashCode() {
        g0.f5771c.getClass();
        return this.f5779a.hashCode() ^ 146118545;
    }
    ...
    public final j$.time.temporal.u g(j$.time.temporal.q qVar) {
        ...
        int i = h0.f5777a[aVar.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return this.f5779a.g(qVar);
        }
        if (i != 4) {
            return g0.f5771c.f(aVar);
        }
        j$.time.temporal.u uVar = j$.time.temporal.a.YEAR.f5898b;
        return j$.time.temporal.u.e(1L, C() <= 0 ? (-(uVar.f5921a + 543)) + 1 : 543 + uVar.f5924d);
    }

    @Override // j$.time.temporal.n
    public final long q(j$.time.temporal.q qVar) {
        if (qVar instanceof j$.time.temporal.a) {
            int i = h0.f5777a[((j$.time.temporal.a) qVar).ordinal()];
            if (i == 4) {
                int iC = C();
                if (iC < 1) {
                    iC = 1 - iC;
            ...
            if (i == 5) {
                return ((((long) C()) * 12) + ((long) this.f5779a.f5867b)) - 1;
            }
            if (i == 6) {
                return C();
            }
            if (i != 7) {
                return this.f5779a.q(qVar);
            }
            return C() < 1 ? 0 : 1;
        }
        return qVar.g(this);
    ...
    */
    public final j$.time.chrono.i0 a(long r8, j$.time.temporal.q r10) {
        /*
            ...
            return r7
        L10:
            int[] r1 = j$.time.chrono.h0.f5777a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L5f
        L25:
            j$.time.chrono.g0 r10 = j$.time.chrono.g0.f5771c
            ...
            return r8
        L49:
            j$.time.chrono.g0 r2 = j$.time.chrono.g0.f5771c
            ...
            if (r0 == r3) goto L6a
        L5f:
            j$.time.h r0 = r7.f5779a
            j$.time.h r8 = r0.a(r8, r10)
            j$.time.chrono.i0 r8 = r7.E(r8)
            return r8
        L6a:
            j$.time.h r8 = r7.f5779a
            int r9 = r7.C()
            int r9 = (-542) - r9
            j$.time.h r8 = r8.N(r9)
            j$.time.chrono.i0 r8 = r7.E(r8)
    ...
    public final b A(long j) {
        return E(this.f5779a.I(j));
    }

    @Override // j$.time.chrono.d
    public final b z(long j) {
        return E(this.f5779a.H(j));
    }

    @Override // j$.time.chrono.d
    public final b y(long j) {
        return E(this.f5779a.G(j));
    }
    ...
    public final i0 E(j$.time.h hVar) {
        return hVar.equals(this.f5779a) ? this : new i0(hVar);
    }

    @Override // j$.time.chrono.d, j$.time.chrono.b
    public final long r() {
        return this.f5779a.r();
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof i0) {
            return this.f5779a.equals(((i0) obj).f5779a);
        }
        return false;
    }
