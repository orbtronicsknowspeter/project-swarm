...
public final class c0 extends d {
    ...
    public final transient j$.time.h f5763a;
    ...
    public final int hashCode() {
        a0.f5760c.getClass();
        return this.f5763a.hashCode() ^ (-1990173233);
    }
    ...
    public final j$.time.temporal.u g(j$.time.temporal.q qVar) {
        ...
        int i = b0.f5761a[aVar.ordinal()];
        if (i == 1 || i == 2 || i == 3) {
            return this.f5763a.g(qVar);
        }
        if (i != 4) {
            return a0.f5760c.f(aVar);
        }
        j$.time.temporal.u uVar = j$.time.temporal.a.YEAR.f5898b;
        return j$.time.temporal.u.e(1L, C() <= 0 ? (-uVar.f5921a) + 1912 : uVar.f5924d - 1911);
    }

    @Override // j$.time.temporal.n
    public final long q(j$.time.temporal.q qVar) {
        if (qVar instanceof j$.time.temporal.a) {
            int i = b0.f5761a[((j$.time.temporal.a) qVar).ordinal()];
            if (i == 4) {
                int iC = C();
                if (iC < 1) {
                    iC = 1 - iC;
            ...
            if (i == 5) {
                return ((((long) C()) * 12) + ((long) this.f5763a.f5867b)) - 1;
            }
            if (i == 6) {
                return C();
            }
            if (i != 7) {
                return this.f5763a.q(qVar);
            }
            return C() < 1 ? 0 : 1;
        }
        return qVar.g(this);
    ...
    public final int C() {
        return this.f5763a.f5866a - 1911;
    }
    ...
    */
    public final j$.time.chrono.c0 a(long r8, j$.time.temporal.q r10) {
        /*
            ...
            return r7
        L10:
            int[] r1 = j$.time.chrono.b0.f5761a
            int r2 = r0.ordinal()
            r2 = r1[r2]
            r3 = 7
            r4 = 6
            ...
            goto L5f
        L25:
            j$.time.chrono.a0 r10 = j$.time.chrono.a0.f5760c
            ...
            return r8
        L49:
            j$.time.chrono.a0 r2 = j$.time.chrono.a0.f5760c
            ...
            if (r0 == r3) goto L6a
        L5f:
            j$.time.h r0 = r7.f5763a
            j$.time.h r8 = r0.a(r8, r10)
            j$.time.chrono.c0 r8 = r7.E(r8)
            return r8
        L6a:
            j$.time.h r8 = r7.f5763a
            int r9 = r7.C()
            int r9 = 1912 - r9
            j$.time.h r8 = r8.N(r9)
            j$.time.chrono.c0 r8 = r7.E(r8)
    ...
    public final b A(long j) {
        return E(this.f5763a.I(j));
    }

    @Override // j$.time.chrono.d
    public final b z(long j) {
        return E(this.f5763a.H(j));
    }

    @Override // j$.time.chrono.d
    public final b y(long j) {
        return E(this.f5763a.G(j));
    }
    ...
    public final c0 E(j$.time.h hVar) {
        return hVar.equals(this.f5763a) ? this : new c0(hVar);
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (obj instanceof c0) {
            return this.f5763a.equals(((c0) obj).f5763a);
        }
        return false;
    }
