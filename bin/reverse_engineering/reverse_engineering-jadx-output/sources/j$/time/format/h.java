    ...
    public final boolean e(p pVar, StringBuilder sb) {
        switch (this.f5830a) {
            case 0:
                ...
                j$.time.temporal.n nVar = pVar.f5856a;
                ...
                int iA = aVar.f5898b.a(lValueOf != null ? lValueOf.longValue() : 0L, aVar);
                if (jLongValue >= -62167219200L) {
                    ...
                    if (localDateTimeZ.f5742b.f5875c == 0) {
                        sb.append(":00");
                    }
                } else {
                    ...
                    if (localDateTimeZ2.f5742b.f5875c == 0) {
                        sb.append(":00");
                    }
                    if (j10 < 0) {
                        if (localDateTimeZ2.f5741a.f5866a == -10000) {
            ...
            default:
                a aVar2 = n.f;
                j$.time.temporal.n nVar2 = pVar.f5856a;
                Object objK = nVar2.k(aVar2);
                if (objK == null && pVar.f5858c == 0) {
