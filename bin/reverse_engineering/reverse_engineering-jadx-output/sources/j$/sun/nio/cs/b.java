...
public final class b extends CharsetEncoder {
    ...
    public final CoderResult encodeLoop(CharBuffer charBuffer, ByteBuffer byteBuffer) {
        ...
        if (!charBuffer.hasArray() || !byteBuffer.hasArray()) {
            ...
            while (true) {
                try {
                    ...
                    if (c9 > 255) {
                        int iA = this.f5728a.a(c9, charBuffer);
                        e eVar = this.f5728a;
                        if (iA < 0) {
                            coderResultUnmappableForLength = eVar.f5731a;
                        } else {
                            if (!eVar.f5732b) {
                                i = 1;
                            }
        ...
        try {
            ...
            if (iA2 != i6) {
                int iB = this.f5728a.b(cArrArray[i11], cArrArray, i11, iLimit);
                e eVar2 = this.f5728a;
                if (iB < 0) {
                    coderResultUnmappableForLength2 = eVar2.f5731a;
                } else {
                    if (!eVar2.f5732b) {
                        i = 1;
                    }
