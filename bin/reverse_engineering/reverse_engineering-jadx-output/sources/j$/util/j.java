...
public final class j implements java.util.Map, Serializable, Map {
    ...
    public final boolean containsKey(Object obj) {
        ...
        synchronized (this.f6075b) {
            zContainsKey = this.f6074a.containsKey(obj);
        }
        return zContainsKey;
    }
    ...
    public final boolean containsValue(Object obj) {
        ...
        synchronized (this.f6075b) {
            zContainsValue = this.f6074a.containsValue(obj);
        }
    ...
    public final Object put(Object obj, Object obj2) {
        Object objPut;
        synchronized (this.f6075b) {
            objPut = this.f6074a.put(obj, obj2);
        }
        return objPut;
    }
    ...
    public final Object remove(Object obj) {
        Object objRemove;
        synchronized (this.f6075b) {
            objRemove = this.f6074a.remove(obj);
        }
        return objRemove;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        synchronized (this.f6075b) {
            zEquals = this.f6074a.equals(obj);
        }
        return zEquals;
    }
    ...
    public final int hashCode() {
        int iHashCode;
        synchronized (this.f6075b) {
            iHashCode = this.f6074a.hashCode();
        }
        return iHashCode;
    }
