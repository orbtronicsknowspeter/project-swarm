...
public final class s5 extends i1 {
    ...
    public final /* synthetic */ long f6353l;

    /* JADX INFO: renamed from: m, reason: collision with root package name */
    public final /* synthetic */ long f6354m;
    ...
    public final Spliterator K(a aVar, Spliterator spliterator) {
        ...
        if (jF > 0 && spliterator.hasCharacteristics(16384)) {
            ...
            long j = this.f6353l;
            return new r7(b1Var, j, w3.A(j, this.f6354m));
        }
        if (z6.ORDERED.j(aVar.f)) {
            return ((h2) new w5(this, aVar, spliterator, new d1(19), this.f6353l, this.f6354m).invoke()).spliterator();
        }
        j$.util.b1 b1Var2 = (j$.util.b1) aVar.S(spliterator);
        long j6 = this.f6353l;
        long j10 = this.f6354m;
        if (j6 <= jF) {
            long jMin = jF - j6;
            if (j10 >= 0) {
    ...
    public final h2 J(a aVar, Spliterator spliterator, IntFunction intFunction) {
        ...
        if (jF <= 0 || !spliterator.hasCharacteristics(16384)) {
            ...
            return (h2) new w5(this, aVar, spliterator, intFunction, this.f6353l, this.f6354m).invoke();
        }
        a aVar2 = aVar;
        while (aVar2.f6129e > 0) {
            aVar2 = aVar2.f6126b;
        }
        return w3.E(aVar, w3.y(aVar2.H(), spliterator, this.f6353l, this.f6354m), true);
    }
