...
public abstract class u7 {
    ...
    public final Spliterator trySplit() {
        ...
        while (true) {
            Spliterator spliteratorTrySplit = this.f6389c.trySplit();
            if (spliteratorTrySplit == null) {
                return null;
            }
            long jEstimateSize = spliteratorTrySplit.estimateSize() + this.f6390d;
            long jMin = Math.min(jEstimateSize, this.f6388b);
            long j6 = this.f6387a;
            if (j6 >= jMin) {
                this.f6390d = jMin;
            } else {
                ...
                if (jMin >= j10) {
                    this.f6389c = spliteratorTrySplit;
                    this.f6391e = jMin;
                } else {
