...
public abstract class k3 implements Spliterator {
    ...
    public Spliterator f6260c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public Spliterator f6261d;
    ...
    public final Deque b() {
        ...
        int iO = this.f6258a.o();
        while (true) {
            iO--;
            if (iO < this.f6259b) {
                return arrayDeque;
            }
            arrayDeque.addFirst(this.f6258a.a(iO));
        }
    }
    ...
    public final boolean c() {
        ...
        if (spliterator == null) {
            ...
            h2 h2VarA = a(dequeB);
            if (h2VarA != null) {
                this.f6261d = h2VarA.spliterator();
                return true;
            }
            this.f6258a = null;
            return false;
    ...
    public final Spliterator trySplit() {
        h2 h2Var = this.f6258a;
        if (h2Var == null || this.f6261d != null) {
            return null;
        }
        Spliterator spliterator = this.f6260c;
        if (spliterator != null) {
        ...
        this.f6258a = h2VarA;
        int iO2 = h2VarA.o();
        h2 h2Var3 = this.f6258a;
        if (iO2 == 0) {
            Spliterator spliterator2 = h2Var3.spliterator();
            this.f6260c = spliterator2;
    ...
    public final long estimateSize() {
        ...
        for (int i = this.f6259b; i < this.f6258a.o(); i++) {
            jCount += this.f6258a.a(i).count();
        }
        return jCount;
    }
