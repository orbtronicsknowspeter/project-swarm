...
public final class k extends v6.i implements d7.p {
    ...
    public final /* synthetic */ Activity f7982r;

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public final /* synthetic */ h0 f7983s;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public k(String str, Activity activity, h0 h0Var, t6.c cVar) {
        super(2, cVar);
        this.f7981q = str;
        this.f7982r = activity;
        this.f7983s = h0Var;
    }

    @Override // v6.a
    public final t6.c create(Object obj, t6.c cVar) {
        return new k(this.f7981q, this.f7982r, this.f7983s, cVar);
    }

    @Override // d7.p
    public final Object invoke(Object obj, Object obj2) {
        return ((k) create((a0) obj, (t6.c) obj2)).invokeSuspend(p6.x.f8463a);
    }
