...
public final class e implements l2.e, g {
    ...
    public final boolean f7931a = true;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final JsonWriter f7932b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final Map f7933c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final Map f7934d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    public final l2.d f7935e;
    public final boolean f;

    public e(Writer writer, HashMap map, HashMap map2, a aVar, boolean z9) {
        this.f7932b = new JsonWriter(writer);
        this.f7933c = map;
        this.f7934d = map2;
        this.f7935e = aVar;
        this.f = z9;
    ...
    public final l2.e d(l2.c cVar, boolean z9) throws IOException {
        ...
        j();
        JsonWriter jsonWriter = this.f7932b;
        jsonWriter.name(str);
        j();
        jsonWriter.value(z9);
        return this;
    ...
    public final e h(Object obj) throws IOException {
        ...
        if (!obj.getClass().isArray()) {
            ...
            l2.d dVar = (l2.d) this.f7933c.get(obj.getClass());
            if (dVar != null) {
                jsonWriter.beginObject();
                dVar.a(obj, this);
                jsonWriter.endObject();
            ...
            l2.f fVar = (l2.f) this.f7934d.get(obj.getClass());
            if (fVar != null) {
                fVar.a(obj, this);
                return this;
            }
