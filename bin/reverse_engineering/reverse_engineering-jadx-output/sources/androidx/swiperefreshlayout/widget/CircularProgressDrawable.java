...
public class CircularProgressDrawable extends Drawable implements Animatable {
    ...
    private void applyFinishTranslation(float f, Ring ring) {
        ...
        ring.setStartTrim(x.f(ring.getStartingEndTrim() - MIN_PROGRESS_ARC, ring.getStartingStartTrim(), f, ring.getStartingStartTrim()));
        ring.setEndTrim(ring.getStartingEndTrim());
        ring.setRotation(x.f(fFloor, ring.getStartingRotation(), f, ring.getStartingRotation()));
    }

    private int evaluateColorChange(float f, int i, int i6) {
        return ((((i >> 24) & 255) + ((int) ((((i6 >> 24) & 255) - r0) * f))) << 24) | ((((i >> 16) & 255) + ((int) ((((i6 >> 16) & 255) - r1) * f))) << 16) | ((((i >> 8) & 255) + ((int) ((((i6 >> 8) & 255) - r2) * f))) << 8) | ((i & 255) + ((int) (f * ((i6 & 255) - r8))));
    }
    ...
    public void applyTransformation(float f, Ring ring, boolean z9) {
        float interpolation;
