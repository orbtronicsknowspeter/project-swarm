...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 2) {
            ...
            float fAbs = Math.abs(x9 - this.mInitialMotionX);
    ...
    public void onMeasure(int i, int i6) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                int iMax3 = Math.max(i14 - (((ViewGroup.MarginLayoutParams) layoutParams).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams).rightMargin), 0);
                int i15 = ((ViewGroup.MarginLayoutParams) layoutParams).width;
                i11 = i12;
                childAt.measure(i15 == -2 ? View.MeasureSpec.makeMeasureSpec(iMax3, mode == 0 ? mode : Integer.MIN_VALUE) : i15 == -1 ? View.MeasureSpec.makeMeasureSpec(iMax3, mode) : View.MeasureSpec.makeMeasureSpec(i15, BasicMeasure.EXACTLY), ViewGroup.getChildMeasureSpec(i6, getPaddingBottom() + getPaddingTop(), ((ViewGroup.MarginLayoutParams) layoutParams).height));
        ...
        if (z9 || f > 0.0f) {
            ...
            while (i17 < childCount) {
                ...
                if (childAt2.getVisibility() != i10) {
                    ...
                    if (z9) {
                        iMax = i16 - (((ViewGroup.MarginLayoutParams) layoutParams2).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams2).rightMargin);
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, BasicMeasure.EXACTLY);
                    } else if (layoutParams2.weight > 0.0f) {
                        iMax = ((int) ((layoutParams2.weight * Math.max(0, i13)) / f)) + measuredWidth2;
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, BasicMeasure.EXACTLY);
                    } else {
                        iMax = measuredWidth2;
                        iMakeMeasureSpec = 0;
                    }
                    int iMeasureChildHeight = measureChildHeight(childAt2, i6, getPaddingBottom() + getPaddingTop());
        ...
        if (arrayListSplitViewPositions != null && !z9) {
            for (int i18 = 0; i18 < childCount; i18++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    Rect rect = arrayListSplitViewPositions.get(i18);
                    LayoutParams layoutParams3 = (LayoutParams) childAt3.getLayoutParams();
                    int i19 = ((ViewGroup.MarginLayoutParams) layoutParams3).leftMargin + ((ViewGroup.MarginLayoutParams) layoutParams3).rightMargin;
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(i16 - i19, BasicMeasure.EXACTLY), iMakeMeasureSpec2);
                        if (i18 != 0) {
