...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i6) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.SeekBarPreference, i, i6);
    ...
    private void setValueInternal(int i, boolean z9) {
        int i6 = this.mMin;
        if (i < i6) {
            i = i6;
        }
