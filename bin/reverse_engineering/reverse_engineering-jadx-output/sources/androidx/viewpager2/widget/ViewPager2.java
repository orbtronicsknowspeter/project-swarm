...
public final class ViewPager2 extends ViewGroup {
    ...
    private RecyclerView.OnChildAttachStateChangeListener enforceChildFillListener() {
        return new RecyclerView.OnChildAttachStateChangeListener() { // from class: androidx.viewpager2.widget.ViewPager2.4
            ...
            public void onChildViewAttachedToWindow(@NonNull View view) {
                ...
                a.i("Pages must fill the whole ViewPager2 (use match_parent)");
            }
    ...
    public void onLayout(boolean z9, int i, int i6, int i10, int i11) {
        ...
        this.mTmpContainerRect.right = (i10 - i) - getPaddingRight();
        this.mTmpContainerRect.top = getPaddingTop();
        this.mTmpContainerRect.bottom = (i11 - i6) - getPaddingBottom();
    ...
    public void onMeasure(int i, int i6) {
        measureChild(this.mRecyclerView, i, i6);
        int measuredWidth = this.mRecyclerView.getMeasuredWidth();
        int measuredHeight = this.mRecyclerView.getMeasuredHeight();
    ...
    public void setCurrentItem(int i, boolean z9) {
        if (isFakeDragging()) {
            a.i("Cannot change current item when ViewPager2 is fake dragging");
        } else {
            setCurrentItemInternal(i, z9);
        }
    }

    public void setCurrentItemInternal(int i, boolean z9) {
        ...
        this.mScrollEventAdapter.notifyProgrammaticScroll(iMin, z9);
        if (!z9) {
        ...
        recyclerView.scrollToPosition(d10 > relativeScrollPosition ? iMin - 3 : iMin + 3);
    ...
    public void setOffscreenPageLimit(int i) {
        if (i < 1 && i != -1) {
            com.google.gson.internal.a.p("Offscreen page limit must be OFFSCREEN_PAGE_LIMIT_DEFAULT or a number > 0");
        } else {
    ...
    public void setPageTransformer(@Nullable PageTransformer pageTransformer) {
        boolean z9 = this.mSavedItemAnimatorPresent;
    ...
    public void updateCurrentItem() {
        ...
        if (pagerSnapHelper == null) {
            a.i("Design assumption violated.");
            return;
        }
    ...
    public static abstract class OnPageChangeCallback {
        ...
        public void onPageScrolled(int i, float f, @Px int i6) {
        }
    }
    ...
    @RequiresApi(21)
    @SuppressLint({"ClassVerificationFailure"})
    public ViewPager2(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i6) {
