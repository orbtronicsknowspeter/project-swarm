...
final class ScrollEventAdapter extends RecyclerView.OnScrollListener {
    ...
    private void dispatchScrolled(int i, float f, int i6) {
        ViewPager2.OnPageChangeCallback onPageChangeCallback = this.mCallback;
        if (onPageChangeCallback != null) {
            onPageChangeCallback.onPageScrolled(i, f, i6);
        }
    }
    ...
    private void updateScrollEventValues() {
        ...
        if (i >= 0) {
            ...
            a.i("Page(s) contain a ViewGroup with a LayoutTransition (or animateLayoutChanges=\"true\"), which interferes with the scrolling animation. Make sure to call getLayoutTransition().setAnimateParentHierarchy(false) on all ViewGroups with a LayoutTransition before an animation is started.");
        } else {
            Locale locale = Locale.US;
            a.i(l.u(scrollEventValues.mOffsetPx, "Page can only be offset by a positive amount, not by "));
        }
    }
    ...
    public void notifyProgrammaticScroll(int i, boolean z9) {
        this.mAdapterState = z9 ? 2 : 3;
        this.mFakeDragging = false;
        boolean z10 = this.mTarget != i;
        this.mTarget = i;
        dispatchStateChanged(2);
        if (z10) {
            dispatchSelected(i);
