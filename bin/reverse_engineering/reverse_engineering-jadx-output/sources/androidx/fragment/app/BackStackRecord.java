...
final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManager.OpGenerator {
    ...
    public int commitInternal(boolean z9) {
        if (this.mCommitted) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("commit already called");
            return 0;
        }
        if (FragmentManager.isLoggingEnabled(2)) {
    ...
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        ...
        androidx.core.view.contentcapture.a.g(fragment, "Cannot detach Fragment attached to a different FragmentManager. Fragment ");
        return null;
    }

    @Override // androidx.fragment.app.FragmentTransaction
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i6) {
        super.doAddOp(i, fragment, str, i6);
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 2:
                default:
                    androidx.core.view.contentcapture.a.f(op.mCmd, "Unknown cmd: ");
                    return;
                case 3:
                    fragment.setAnimations(op.mEnterAnim, op.mExitAnim, op.mPopEnterAnim, op.mPopExitAnim);
    ...
    */
    ...
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        ...
        androidx.core.view.contentcapture.a.g(fragment, "Cannot hide Fragment attached to a different FragmentManager. Fragment ");
        return null;
    }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        ...
        androidx.core.view.contentcapture.a.g(fragment, "Cannot remove Fragment attached to a different FragmentManager. Fragment ");
        return null;
    }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        if (fragment.mFragmentManager != this.mManager) {
            androidx.privacysandbox.ads.adservices.customaudience.a.r(this.mManager, "Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
            return null;
        }
        if (state == Lifecycle.State.INITIALIZED && fragment.mState > -1) {
            androidx.core.view.contentcapture.a.h(state, "Cannot set maximum Lifecycle to ", " after the Fragment has been created");
            return null;
        }
        if (state != Lifecycle.State.DESTROYED) {
            return super.setMaxLifecycle(fragment, state);
        }
        androidx.core.view.contentcapture.a.h(state, "Cannot set maximum Lifecycle to ", ". Use remove() to remove the fragment from the FragmentManager and trigger its destruction.");
        return null;
    }
    ...
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        ...
        androidx.core.view.contentcapture.a.g(fragment, "Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
        return null;
    }
    ...
    public FragmentTransaction show(@NonNull Fragment fragment) {
        ...
        androidx.core.view.contentcapture.a.g(fragment, "Cannot show Fragment attached to a different FragmentManager. Fragment ");
        return null;
    }
