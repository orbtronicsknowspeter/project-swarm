...
public class FragmentController {
    ...
    public void dispatchMultiWindowModeChanged(boolean z9) {
        this.mHost.mFragmentManager.dispatchMultiWindowModeChanged(z9, true);
    }
    ...
    public void dispatchPictureInPictureModeChanged(boolean z9) {
        this.mHost.mFragmentManager.dispatchPictureInPictureModeChanged(z9, true);
    }
    ...
    public void restoreSaveState(@Nullable Parcelable parcelable) {
        ...
        if (fragmentHostCallback instanceof ViewModelStoreOwner) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Your FragmentHostCallback must implement ViewModelStoreOwner to call restoreSaveState(). Call restoreAllState()  if you're still using retainNestedNonConfig().");
        }
    }
