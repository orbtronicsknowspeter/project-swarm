...
public class ComponentActivity extends androidx.core.app.ComponentActivity implements ContextAware, LifecycleOwner, ViewModelStoreOwner, HasDefaultViewModelProviderFactory, SavedStateRegistryOwner, OnBackPressedDispatcherOwner, ActivityResultRegistryOwner, ActivityResultCaller, OnConfigurationChangedProvider, OnTrimMemoryProvider, OnNewIntentProvider, OnMultiWindowModeChangedProvider, OnPictureInPictureModeChangedProvider, MenuHost, FullyDrawnReporterOwner {
    ...
    public ComponentActivity() {
        ...
        this.mFullyDrawnReporter = new FullyDrawnReporter(reportFullyDrawnExecutorCreateFullyDrawnExecutor, new d7.a() { // from class: androidx.activity.a
            @Override // d7.a
            public final Object invoke() {
                return this.f288a.lambda$new$0();
            }
        });
        ...
        this.mActivityResultRegistry = new ActivityResultRegistry() { // from class: androidx.activity.ComponentActivity.1
            ...
            public <I, O> void onLaunch(final int i, @NonNull ActivityResultContract<I, O> activityResultContract, I i6, @Nullable ActivityOptionsCompat activityOptionsCompat) {
                Bundle bundle;
                final int i10;
                ...
                Intent intentCreateIntent = activityResultContract.createIntent(componentActivity, i6);
                ...
                try {
                    ...
                    new Handler(Looper.getMainLooper()).post(new Runnable() { // from class: androidx.activity.ComponentActivity.1.2
                        @Override // java.lang.Runnable
                        public void run() {
                            dispatchResult(i10, 0, new Intent().setAction(ActivityResultContracts.StartIntentSenderForResult.ACTION_INTENT_SENDER_REQUEST).putExtra(ActivityResultContracts.StartIntentSenderForResult.EXTRA_SEND_INTENT_EXCEPTION, sendIntentException));
                        }
                    });
                }
            }
        ...
        if (getLifecycle() == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("getLifecycle() returned null in ComponentActivity's constructor. Please make sure you are lazily constructing your Lifecycle in the first call to getLifecycle() rather than relying on field initialization.");
            throw null;
        }
    ...
    public ViewModelStore getViewModelStore() {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i("Your activity is not yet attached to the Application instance. You can't request ViewModel before onCreate call.");
        return null;
    }
    ...
    public void onActivityResult(int i, int i6, @Nullable Intent intent) {
        if (this.mActivityResultRegistry.dispatchResult(i, i6, intent)) {
            return;
        }
