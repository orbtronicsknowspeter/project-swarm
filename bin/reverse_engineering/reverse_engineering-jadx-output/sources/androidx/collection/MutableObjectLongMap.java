...
public final class MutableObjectLongMap<K> extends ObjectLongMap<K> {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i11 < i10) {
            if (((jArr[i11 >> 3] >> ((i11 & 7) << 3)) & 255) < 128) {
                ...
                i6 = i11;
                jArr4[i13] = (jArr4[i13] & (~(255 << i14))) | (j << i14);
                int i15 = this._capacity;
                int i16 = ((iFindFirstAvailableSlot - 7) & i15) + (i15 & 7);
                int i17 = i16 >> 3;
                int i18 = (i16 & 7) << 3;
                jArr4[i17] = (jArr4[i17] & (~(255 << i18))) | (j << i18);
    ...
    public final long getOrPut(K k5, d7.a aVar) {
        aVar.getClass();
    ...
    public final void plusAssign(ObjectLongMap<K> objectLongMap) {
        objectLongMap.getClass();
        putAll(objectLongMap);
    }

    public final long put(K k5, long j, long j6) {
    ...
    public final boolean remove(K k5, long j) {
        int iFindKeyIndex = findKeyIndex(k5);
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (((Boolean) pVar.invoke(this.keys[i11], Long.valueOf(this.values[i11]))).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(K k5, long j) {
        int iFindIndex = findIndex(k5);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        }
    ...
    public /* synthetic */ MutableObjectLongMap(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }
    ...
    public final void put(K k5, long j) {
        set(k5, j);
    }
