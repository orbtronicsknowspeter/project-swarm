...
public final class MutableIntSet extends IntSet {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i10 < i6) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                int i13 = i12 ^ (i12 << 16);
                int iFindFirstAvailableSlot = mutableIntSet.findFirstAvailableSlot(i13 >>> 7);
                long j = i13 & 127;
                long[] jArr3 = mutableIntSet.metadata;
                int i14 = iFindFirstAvailableSlot >> 3;
                int i15 = (iFindFirstAvailableSlot & 7) << 3;
                jArr3[i14] = ((~(255 << i15)) & jArr3[i14]) | (j << i15);
                int i16 = mutableIntSet._capacity;
    ...
    */
    ...
    public /* synthetic */ MutableIntSet(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }
