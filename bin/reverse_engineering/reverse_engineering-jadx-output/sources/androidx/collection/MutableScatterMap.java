...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
    ...
    public final class MutableMapWrapper extends ScatterMap<K, V>.MapWrapper implements Map<K, V>, j$.util.Map {
        ...
        public V put(K k5, V v) {
            return MutableScatterMap.this.put(k5, v);
        }
    ...
    public final V compute(K k5, p pVar) {
        pVar.getClass();
        int iFindInsertIndex = findInsertIndex(k5);
        boolean z9 = iFindInsertIndex < 0;
        V v = (V) pVar.invoke(k5, z9 ? null : this.values[iFindInsertIndex]);
        if (!z9) {
    ...
    public final V getOrPut(K k5, d7.a aVar) {
        aVar.getClass();
        V v = get(k5);
        if (v != null) {
            return v;
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (((Boolean) pVar.invoke(this.keys[i11], this.values[i11])).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(K k5, V v) {
        int iFindInsertIndex = findInsertIndex(k5);
        if (iFindInsertIndex < 0) {
            iFindInsertIndex = ~iFindInsertIndex;
        }
    ...
    public /* synthetic */ MutableScatterMap(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }
