...
public abstract class ObjectLongMap<K> {
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, p pVar, int i6, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i10;
        if (obj != null) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sbR.append((CharSequence) pVar.invoke(obj2, Long.valueOf(j6)));
                            i13++;
                        } else {
                            jArr2 = jArr4;
                            i10 = i15;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (!((Boolean) pVar.invoke(objArr[i11], Long.valueOf(jArr[i11]))).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j) < 128) {
                        int i12 = (i << 3) + i11;
                        if (((Boolean) pVar.invoke(objArr[i12], Long.valueOf(jArr[i12]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j >>= 8;
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        pVar.invoke(objArr[i11], Long.valueOf(jArr[i11]));
                    }
                    j >>= 8;
                }
                if (i6 != 8) {
    ...
    public final long getOrDefault(K k5, long j) {
        int iFindKeyIndex = findKeyIndex(k5);
        return iFindKeyIndex >= 0 ? this.values[iFindKeyIndex] : j;
    }

    public final long getOrElse(K k5, a aVar) {
        aVar.getClass();
        int iFindKeyIndex = findKeyIndex(k5);
    ...
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, java.lang.CharSequence r23, int r24, d7.p r25) {
        ...
        L85:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.ObjectLongMap.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, int, d7.p):java.lang.String");
    }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            sbR.append((CharSequence) pVar.invoke(obj, Long.valueOf(j6)));
                            i10++;
                        } else {
                            objArr2 = objArr3;
                        }
    ...
    public static /* synthetic */ String joinToString$default(ObjectLongMap objectLongMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i6, Object obj) {
        if (obj != null) {
            b.r("Super calls with default arguments not supported in this target, function: joinToString");
            return null;
        }
    ...
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, java.lang.CharSequence r23, d7.p r24) {
        ...
        L84:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.ObjectLongMap.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, d7.p):java.lang.String");
    }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((255 & j) < 128) {
                            ...
                            i = i11;
                            sb.append((CharSequence) pVar.invoke(obj, Long.valueOf(j6)));
                            i10++;
                        } else {
                            i = i11;
                        }
