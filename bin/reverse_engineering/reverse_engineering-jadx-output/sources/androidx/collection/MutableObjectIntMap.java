...
public final class MutableObjectIntMap<K> extends ObjectIntMap<K> {
    ...
    public final int getOrPut(K k5, d7.a aVar) {
        aVar.getClass();
    ...
    public final int put(K k5, int i, int i6) {
    ...
    public final boolean remove(K k5, int i) {
        int iFindKeyIndex = findKeyIndex(k5);
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (((Boolean) pVar.invoke(this.keys[i11], Integer.valueOf(this.values[i11]))).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j >>= 8;
    ...
    public final void set(K k5, int i) {
        int iFindIndex = findIndex(k5);
        if (iFindIndex < 0) {
            iFindIndex = ~iFindIndex;
        }
    ...
    public /* synthetic */ MutableObjectIntMap(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }

    public final void put(K k5, int i) {
        set(k5, i);
    }
