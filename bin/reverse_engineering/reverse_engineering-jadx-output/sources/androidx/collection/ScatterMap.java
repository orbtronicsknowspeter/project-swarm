...
public abstract class ScatterMap<K, V> {
    ...
    public static /* synthetic */ String joinToString$default(ScatterMap scatterMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, p pVar, int i6, Object obj) {
        if (obj != null) {
        ...
        p pVar2 = pVar;
        return scatterMap.joinToString(charSequence, charSequence2, charSequence3, i, charSequence5, pVar2);
    }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (!((Boolean) pVar.invoke(objArr[i11], objArr2[i11])).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j) < 128) {
                        int i12 = (i << 3) + i11;
                        if (((Boolean) pVar.invoke(objArr[i12], objArr2[i12])).booleanValue()) {
                            i6++;
                        }
                    }
                    j >>= 8;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        pVar.invoke(objArr[i11], objArr2[i11]);
                    }
                    j >>= 8;
                }
                if (i6 != 8) {
    ...
    */
    ...
    public final V getOrElse(K k5, a aVar) {
        aVar.getClass();
        V v = get(k5);
                    ...
                    while (i13 < i12) {
                        if ((j & 255) < 128) {
                            ...
                            if (pVar == null) {
                                ...
                                sbS.append((CharSequence) pVar.invoke(obj, obj2));
                            }
                            i10++;
                        } else {
                            objArr3 = objArr5;
    ...
    */
    ...
    /* JADX INFO: compiled from: r8-map-id-035a71e92ccd2a2b8039d43fa6fa76ac249b2a7f96061be914156707964ce49d */
    public class MapWrapper implements Map<K, V>, e7.a, j$.util.Map {
        public MapWrapper() {
        }
        ...
        @Override // java.util.Map, j$.util.Map
        public V merge(K k5, V v, BiFunction<? super V, ? super V, ? extends V> biFunction) {
            throw new UnsupportedOperationException("Operation is not supported for read-only collection");
        }
    ...
    public /* synthetic */ ScatterMap(g gVar) {
        this();
    }
