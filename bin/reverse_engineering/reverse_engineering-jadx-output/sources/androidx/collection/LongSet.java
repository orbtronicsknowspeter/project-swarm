...
public abstract class LongSet {
    ...
    public static /* synthetic */ String joinToString$default(LongSet longSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, l lVar, int i6, Object obj) {
        int i10;
        if (obj != null) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i16 < i15) {
                        if ((j & 255) < 128) {
                            ...
                            i10 = i14;
                            sb.append((CharSequence) lVar.invoke(Long.valueOf(j6)));
                            i13++;
                        } else {
                            i10 = i14;
                        }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128 && !((Boolean) lVar.invoke(Long.valueOf(jArr[(i << 3) + i10]))).booleanValue()) {
                        return false;
                    }
                    j >>= 8;
                }
    ...
    */
    public final boolean any(d7.l r15) {
        ...
        L55:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.LongSet.any(d7.l):boolean");
    }
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j) < 128 && ((Boolean) lVar.invoke(Long.valueOf(jArr[(i << 3) + i11]))).booleanValue()) {
                        i6++;
                    }
                    j >>= 8;
                }
    ...
    */
    ...
    public final int findElementIndex$collection(long j) {
        ...
        while (true) {
            ...
            long j10 = (((long) i10) * ScatterMapKt.BitmaskLsb) ^ j6;
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public final long first(d7.l r15) {
        /*
            r14 = this;
            r15.getClass()
            long[] r0 = r14.elements
        ...
        L54:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.LongSet.first(d7.l):long");
    }
    ...
    */
    ...
    public static /* synthetic */ String joinToString$default(LongSet longSet, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i6, Object obj) {
        if (obj != null) {
            b.r("Super calls with default arguments not supported in this target, function: joinToString");
            return null;
        }
