...
public final class MutableIntObjectMap<V> extends IntObjectMap<V> {
    ...
    private final void resizeStorage(int i) {
        ...
        while (i10 < i6) {
            if (((jArr2[i10 >> 3] >> ((i10 & 7) << 3)) & 255) < 128) {
                ...
                int i13 = i12 ^ (i12 << 16);
                int iFindFirstAvailableSlot = mutableIntObjectMap.findFirstAvailableSlot(i13 >>> 7);
                long j = i13 & 127;
                ...
                int i16 = mutableIntObjectMap._capacity;
    ...
    public final V getOrPut(int i, d7.a aVar) {
        aVar.getClass();
        V v = get(i);
        if (v != null) {
            return v;
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (((Boolean) pVar.invoke(Integer.valueOf(this.keys[i11]), this.values[i11])).booleanValue()) {
                            removeValueAt(i11);
                        }
                    }
                    j >>= 8;
    ...
    public /* synthetic */ MutableIntObjectMap(int i, int i6, g gVar) {
        this((i6 & 1) != 0 ? 6 : i);
    }
