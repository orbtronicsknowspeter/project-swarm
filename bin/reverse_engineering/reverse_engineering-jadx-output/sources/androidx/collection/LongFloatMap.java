...
public abstract class LongFloatMap {
    ...
    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, p pVar, int i6, Object obj) {
        long[] jArr;
        long[] jArr2;
        int i10;
        if (obj != null) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i17 < i16) {
                        if ((j & 255) < 128) {
                            ...
                            jArr2 = jArr4;
                            sbR.append((CharSequence) pVar.invoke(lValueOf, Float.valueOf(f)));
                            i13++;
                        } else {
                            jArr2 = jArr4;
                            i10 = i15;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        if (!((Boolean) pVar.invoke(Long.valueOf(jArr[i11]), Float.valueOf(fArr[i11]))).booleanValue()) {
                            return false;
                        }
                    }
                    j >>= 8;
    ...
    */
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i11 = 0; i11 < i10; i11++) {
                    if ((255 & j) < 128) {
                        int i12 = (i << 3) + i11;
                        if (((Boolean) pVar.invoke(Long.valueOf(jArr[i12]), Float.valueOf(fArr[i12]))).booleanValue()) {
                            i6++;
                        }
                    }
                    j >>= 8;
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                while (i10 < i6) {
                    if ((255 & j) < 128) {
                        ...
                        z10 = z11;
                        jArr2 = jArr3;
                        if (fArr[i11] != longFloatMap.get(jArr2[i11])) {
                            return false;
                        }
                    } else {
                        z10 = z11;
        ...
        while (true) {
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        pVar.invoke(Long.valueOf(jArr[i11]), Float.valueOf(fArr[i11]));
                    }
                    j >>= 8;
                }
                if (i6 != 8) {
    ...
    public final float getOrElse(long j, d7.a aVar) {
        aVar.getClass();
        int iFindKeyIndex = findKeyIndex(j);
            ...
            if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                ...
                for (int i10 = 0; i10 < i6; i10++) {
                    if ((255 & j) < 128) {
                        int i11 = (i << 3) + i10;
                        long j6 = jArr[i11];
                        iFloatToIntBits += Float.floatToIntBits(fArr[i11]) ^ ((int) (j6 ^ (j6 >>> 32)));
                    }
                    j >>= 8;
                }
                if (i6 != 8) {
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i14 < i13) {
                        if ((j & 255) < 128) {
                            ...
                            sbQ.append((CharSequence) pVar.invoke(Long.valueOf(j6), Float.valueOf(f)));
                            i11++;
                        } else {
                            i6 = i12;
                        }
    ...
    */
    public final java.lang.String joinToString(java.lang.CharSequence r22, java.lang.CharSequence r23, java.lang.CharSequence r24, int r25, java.lang.CharSequence r26, d7.p r27) {
        ...
        L8d:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.LongFloatMap.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, int, java.lang.CharSequence, d7.p):java.lang.String");
    }

    public static /* synthetic */ String joinToString$default(LongFloatMap longFloatMap, CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, int i, CharSequence charSequence4, int i6, Object obj) {
        if (obj != null) {
            b.r("Super calls with default arguments not supported in this target, function: joinToString");
            return null;
        }
    ...
    */
    public final java.lang.String joinToString(java.lang.CharSequence r21, java.lang.CharSequence r22, java.lang.CharSequence r23, d7.p r24) {
        ...
        L88:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.collection.LongFloatMap.joinToString(java.lang.CharSequence, java.lang.CharSequence, java.lang.CharSequence, d7.p):java.lang.String");
    }
                ...
                if ((((~j) << 7) & j & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i13 < i12) {
                        if ((255 & j) < 128) {
                            ...
                            i = i11;
                            sb.append((CharSequence) pVar.invoke(Long.valueOf(j6), Float.valueOf(f)));
                            i10++;
                        } else {
                            i = i11;
                        }
