...
final class SavedStateRegistryOwnerDelegate<T> implements b, SavedStateRegistry.SavedStateProvider {
    ...
    public SavedStateRegistryOwnerDelegate(SavedStateRegistry savedStateRegistry, z7.b bVar, String str, SavedStateConfiguration savedStateConfiguration, a aVar) {
    ...
    private final T loadInitialValue(String str) {
        ...
        bVar.getClass();
        return (T) SavedStateDecoderKt.decodeFromSavedStateNullable(bVar, bundleConsumeRestoredStateForKey, this.configuration);
    }
    ...
    public void setValue(Object obj, k kVar, T t9) {
        kVar.getClass();
        if (l.a(this.cachedValue, UNINITIALIZED.INSTANCE)) {
            this.registry.registerSavedStateProvider(getQualifiedKey(obj, kVar), this);
        }
        this.cachedValue = t9;
    }
}
