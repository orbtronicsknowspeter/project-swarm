...
public final class CharSequenceArraySerializer implements b {
    ...
    private static final e descriptor = t1.n("kotlin.Array<kotlin.CharSequence>", new e[0]);
    ...
    public CharSequence[] deserialize(c8.e eVar) {
        ...
        if (eVar instanceof SavedStateDecoder) {
            ...
            return SavedStateReader.m115getCharSequenceArrayimpl(SavedStateReader.m97constructorimpl(savedStateDecoder.getSavedState$savedstate()), savedStateDecoder.getKey$savedstate());
        }
    ...
    @Override // z7.h
    public void serialize(f fVar, CharSequence[] charSequenceArr) {
        fVar.getClass();
        ...
        if (!(fVar instanceof SavedStateEncoder)) {
            ...
            SavedStateWriter.m194putCharSequenceArrayimpl(SavedStateWriter.m183constructorimpl(savedStateEncoder.getSavedState$savedstate()), savedStateEncoder.getKey$savedstate(), charSequenceArr);
        }
    }
}
