...
public final class SharedPreferencesMigration<T> implements DataMigration<T> {
    ...
    public static final class AnonymousClass1 extends i implements p {
        ...
        public final Object invoke(T t9, c cVar) {
            return ((AnonymousClass1) create(t9, cVar)).invokeSuspend(x.f8463a);
        }
    ...
    public static final class AnonymousClass2 extends i implements p {
        ...
        @Override // d7.p
        public final Object invoke(T t9, c cVar) {
            return ((AnonymousClass2) create(t9, cVar)).invokeSuspend(x.f8463a);
        }
    ...
    public static final class AnonymousClass3 extends i implements p {
        ...
        @Override // d7.p
        public final Object invoke(T t9, c cVar) {
            return ((AnonymousClass3) create(t9, cVar)).invokeSuspend(x.f8463a);
        }
