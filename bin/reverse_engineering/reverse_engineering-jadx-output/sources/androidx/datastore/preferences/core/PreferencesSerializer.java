...
public final class PreferencesSerializer implements OkioSerializer<Preferences> {
    ...
    public Object readFrom(j jVar, c cVar) throws IOException {
        PreferencesProto.PreferenceMap from = PreferencesMapCompat.Companion.readFrom(jVar.x());
    ...
    @Override // androidx.datastore.core.okio.OkioSerializer
    public Object writeTo(Preferences preferences, i iVar, c cVar) throws IOException {
        ...
        builderNewBuilder.build().writeTo(iVar.v());
        return x.f8463a;
    }
