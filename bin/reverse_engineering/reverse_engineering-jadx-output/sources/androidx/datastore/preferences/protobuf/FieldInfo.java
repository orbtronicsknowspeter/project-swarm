...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    private FieldInfo(java.lang.reflect.Field field, int i, FieldType fieldType, Class<?> cls, java.lang.reflect.Field field2, int i6, boolean z9, boolean z10, OneofInfo oneofInfo, Class<?> cls2, Object obj, Internal.EnumVerifier enumVerifier, java.lang.reflect.Field field3) {
        this.field = field;
        this.type = fieldType;
    ...
    private static void checkFieldNumber(int i) {
        ...
        a.p(l.u(i, "fieldNumber must be positive: "));
    }

    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i6, boolean z9, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i6)) {
            return new FieldInfo(field, i, fieldType, null, field2, i6, false, z9, null, null, null, enumVerifier, null);
        }
        a.p(l.u(i6, "presenceMask must have exactly one bit set: "));
        return null;
    }

    public static FieldInfo forField(java.lang.reflect.Field field, int i, FieldType fieldType, boolean z9) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        if (fieldType != FieldType.MESSAGE_LIST && fieldType != FieldType.GROUP_LIST) {
            return new FieldInfo(field, i, fieldType, null, null, 0, false, z9, null, null, null, null, null);
        }
        androidx.privacysandbox.ads.adservices.customaudience.a.i("Shouldn't be called for repeated message fields.");
        return null;
    }
    ...
    public static FieldInfo forLegacyRequiredField(java.lang.reflect.Field field, int i, FieldType fieldType, java.lang.reflect.Field field2, int i6, boolean z9, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
        if (field2 == null || isExactlyOneBitSet(i6)) {
            return new FieldInfo(field, i, fieldType, null, field2, i6, true, z9, null, null, null, enumVerifier, null);
        }
        a.p(l.u(i6, "presenceMask must have exactly one bit set: "));
        return null;
    }
    ...
    public static FieldInfo forOneofMemberField(int i, FieldType fieldType, OneofInfo oneofInfo, Class<?> cls, boolean z9, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i);
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(oneofInfo, "oneof");
        Internal.checkNotNull(cls, "oneofStoredType");
        if (fieldType.isScalar()) {
            return new FieldInfo(null, i, fieldType, null, null, 0, false, z9, oneofInfo, cls, null, enumVerifier, null);
        }
    ...
    public static final class Builder {
        ...
        public FieldInfo build() {
            ...
            if (field != null) {
                ...
                return z9 ? FieldInfo.forLegacyRequiredField(field2, this.fieldNumber, this.type, field, this.presenceMask, this.enforceUtf8, this.enumVerifier) : FieldInfo.forExplicitPresenceField(field2, this.fieldNumber, this.type, field, this.presenceMask, this.enforceUtf8, this.enumVerifier);
            }
        ...
        public Builder withField(java.lang.reflect.Field field) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Cannot set field when building a oneof.");
            return null;
        }
        ...
        public Builder withOneof(OneofInfo oneofInfo, Class<?> cls) {
            if (this.field != null || this.presenceField != null) {
                androidx.privacysandbox.ads.adservices.customaudience.a.i("Cannot set oneof when field or presenceField have been provided");
                return null;
            }
            this.oneof = oneofInfo;
