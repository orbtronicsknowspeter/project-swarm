...
final class RopeByteString extends ByteString {
        ...
        private void doBalance(ByteString byteString) {
            if (byteString.isBalanced()) {
                ...
                if (!(byteString instanceof RopeByteString)) {
                    a.r(byteString.getClass(), "Has a new type of ByteString been created? Found ");
                    return;
                }
    ...
    private boolean equalsFragments(ByteString byteString) {
        ...
        while (true) {
            ...
            if (!(i == 0 ? next.equalsRange(next2, i6, iMin) : next2.equalsRange(next, i, iMin))) {
                return false;
            }
            i10 += iMin;
    ...
    public void copyToInternal(byte[] bArr, int i, int i6, int i10) {
        ...
        if (i11 <= i12) {
            this.left.copyToInternal(bArr, i, i6, i10);
        } else {
            if (i >= i12) {
                this.right.copyToInternal(bArr, i - i12, i6, i10);
                return;
            }
            int i13 = i12 - i;
            this.left.copyToInternal(bArr, i, i6, i13);
            this.right.copyToInternal(bArr, 0, i6 + i13, i10 - i13);
        }
    }
    ...
    public byte internalByteAt(int i) {
        ...
        return i < i6 ? this.left.internalByteAt(i) : this.right.internalByteAt(i - i6);
    }
    ...
    public int partialHash(int i, int i6, int i10) {
        ...
        int i12 = this.leftLength;
        if (i11 <= i12) {
            return this.left.partialHash(i, i6, i10);
        }
        if (i6 >= i12) {
            return this.right.partialHash(i, i6 - i12, i10);
        }
        int i13 = i12 - i6;
        return this.right.partialHash(this.left.partialHash(i, i6, i13), 0, i10 - i13);
    }
    ...
    public int partialIsValidUtf8(int i, int i6, int i10) {
        ...
        int i12 = this.leftLength;
        if (i11 <= i12) {
            return this.left.partialIsValidUtf8(i, i6, i10);
        }
        if (i6 >= i12) {
            return this.right.partialIsValidUtf8(i, i6 - i12, i10);
        }
        int i13 = i12 - i6;
        return this.right.partialIsValidUtf8(this.left.partialIsValidUtf8(i, i6, i13), 0, i10 - i13);
    }
    ...
    public ByteString substring(int i, int i6) {
        int iCheckRange = ByteString.checkRange(i, i6, this.totalLength);
        if (iCheckRange == 0) {
        ...
        return i6 <= i10 ? this.left.substring(i, i6) : i >= i10 ? this.right.substring(i - i10, i6 - i10) : new RopeByteString(this.left.substring(i), this.right.substring(0, i6 - this.leftLength));
    }
    ...
    public void writeToInternal(OutputStream outputStream, int i, int i6) throws IOException {
        ...
        if (i10 <= i11) {
            ...
            if (i >= i11) {
                this.right.writeToInternal(outputStream, i - i11, i6);
                return;
            }
            int i12 = i11 - i;
            this.left.writeToInternal(outputStream, i, i12);
            this.right.writeToInternal(outputStream, 0, i6 - i12);
        }
    }
    ...
    public class RopeInputStream extends InputStream {
        ...
        private int readSkipInternal(byte[] bArr, int i, int i6) {
            int i10 = i6;
            while (i10 > 0) {
        ...
        public int read(byte[] bArr, int i, int i6) {
            ...
            int skipInternal = readSkipInternal(bArr, i, i6);
            if (skipInternal != 0) {
                return skipInternal;
            }
