...
public final class WireFormat {
    ...
    public static int makeTag(int i, int i6) {
        return (i << 3) | i6;
    }
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, FieldType fieldType, Utf8Validation utf8Validation) throws IOException {
        switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[fieldType.ordinal()]) {
            ...
            case 15:
                break;
            case 16:
                a.p("readPrimitiveField() cannot handle nested groups.");
                break;
            case 17:
                a.p("readPrimitiveField() cannot handle embedded messages.");
                break;
            case 18:
                a.p("readPrimitiveField() cannot handle enums.");
                break;
            default:
    ...
    public static class FieldType {
        ...
        private FieldType(String str, int i, JavaType javaType, int i6) {
        ...
        public /* synthetic */ FieldType(String str, int i, JavaType javaType, int i6, AnonymousClass1 anonymousClass1) {
            this(str, i, javaType, i6);
        }
    }
}
