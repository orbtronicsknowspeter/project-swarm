...
public final class FieldType {
    ...
    private FieldType(String str, int i, int i6, Collection collection, JavaType javaType) {
        int i10;
        this.id = i6;
    ...
    private static java.lang.reflect.Type getListParameter(Class<?> cls, java.lang.reflect.Type[] typeArr) {
        while (true) {
            ...
            if (cls == List.class) {
                ...
                b.n("Unable to identify parameter type for List<T>");
                return null;
            }
                ...
                for (int i6 = 0; i6 < actualTypeArguments.length; i6++) {
                    ...
                    if (type instanceof TypeVariable) {
                        ...
                        if (typeArr.length != typeParameters.length) {
                            b.n("Type array mismatch");
                            return null;
                        }
                        for (int i10 = 0; i10 < typeParameters.length; i10++) {
                            if (type == typeParameters[i10]) {
                                actualTypeArguments[i6] = typeArr[i10];
                            }
                        }
                        a.h(type, "Unable to find replacement for ");
                        return null;
                    }
                }
