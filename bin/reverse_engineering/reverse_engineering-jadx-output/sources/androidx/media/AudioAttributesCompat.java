...
public class AudioAttributesCompat implements VersionedParcelable {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static void setForceLegacyBehavior(boolean z9) {
        sForceLegacyBehavior = z9;
    }

    public static int toVolumeStreamType(boolean z9, int i, int i6) {
        if ((i & 1) == 1) {
            return z9 ? 1 : 7;
        }
        if ((i & 4) == 4) {
        ...
        switch (i6) {
            ...
            default:
                ...
                com.google.gson.internal.a.p(x.g(i6, "Unknown usage value ", " in audio attributes"));
                return 0;
        }
    }
    ...
    public static class Builder {
        ...
        public Builder setLegacyStreamType(int i) {
            ...
            com.google.gson.internal.a.p("STREAM_ACCESSIBILITY is not a legacy stream type that was used for audio playback");
            return null;
        }
    ...
    public static int toVolumeStreamType(boolean z9, AudioAttributesCompat audioAttributesCompat) {
        return toVolumeStreamType(z9, audioAttributesCompat.getFlags(), audioAttributesCompat.getUsage());
    }
}
