...
public class StateSet {
    ...
    public int updateConstraints(int i, int i6, float f, float f10) {
        ...
        if (i == i6) {
            SparseArray<State> sparseArray = this.mStateList;
            State stateValueAt = i6 == -1 ? sparseArray.valueAt(0) : sparseArray.get(this.mCurrentStateId);
            if (stateValueAt == null) {
                return -1;
            }
            return ((this.mCurrentConstraintNumber == -1 || !stateValueAt.mVariants.get(i).match(f, f10)) && i != (iFindMatch = stateValueAt.findMatch(f, f10))) ? iFindMatch == -1 ? stateValueAt.mConstraintID : stateValueAt.mVariants.get(iFindMatch).mConstraintID : i;
        }
        State state = this.mStateList.get(i6);
        if (state == null) {
            return -1;
