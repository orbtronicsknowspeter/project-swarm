...
public class MotionPlaceholder extends VirtualLayout {
    ...
    public void onMeasure(androidx.constraintlayout.core.widgets.VirtualLayout virtualLayout, int i, int i6) {
    ...
    public MotionPlaceholder(Context context, AttributeSet attributeSet, int i, int i6) {
        super(context, attributeSet, i);
    }
    ...
    public void onMeasure(int i, int i6) {
        onMeasure(this.mPlaceholder, i, i6);
    }
