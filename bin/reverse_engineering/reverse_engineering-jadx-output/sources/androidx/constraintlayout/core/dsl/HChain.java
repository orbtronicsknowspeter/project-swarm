...
public class HChain extends Chain {
    ...
    public void linkToEnd(Constraint.HAnchor hAnchor, int i, int i6) {
    ...
    public void linkToLeft(Constraint.HAnchor hAnchor, int i, int i6) {
    ...
    public void linkToRight(Constraint.HAnchor hAnchor, int i, int i6) {
    ...
    public void linkToStart(Constraint.HAnchor hAnchor, int i, int i6) {
