...
public class VelocityMatrix {
    ...
    public void applyTransform(float f, float f10, int i, int i6, float[] fArr) {
        float f11 = fArr[0];
        float f12 = fArr[1];
        ...
        float f17 = (this.mDScaleX * f13) + f15;
        float f18 = (this.mDScaleY * f14) + f16;
        float radians = (float) Math.toRadians(this.mRotate);
        float radians2 = (float) Math.toRadians(this.mDRotate);
        double d10 = radians;
        double d11 = i6 * f14;
        float fSin = (((float) ((Math.sin(d10) * ((double) ((-i) * f13))) - (Math.cos(d10) * d11))) * radians2) + f17;
        float fCos = (radians2 * ((float) ((Math.cos(d10) * ((double) (i * f13))) - (Math.sin(d10) * d11)))) + f18;
        fArr[0] = fSin;
        fArr[1] = fCos;
    }
