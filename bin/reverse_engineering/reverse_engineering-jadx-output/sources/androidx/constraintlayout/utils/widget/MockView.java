...
public class MockView extends View {
    ...
    public void onDraw(@NonNull Canvas canvas) {
        ...
        if (this.mDrawDiagonals) {
            ...
            float f10 = height;
            canvas2 = canvas;
            canvas2.drawLine(0.0f, 0.0f, f, f10, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f10, f, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, 0.0f, f, 0.0f, this.mPaintDiagonals);
            canvas2.drawLine(f, 0.0f, f, f10, this.mPaintDiagonals);
            canvas2.drawLine(f, f10, 0.0f, f10, this.mPaintDiagonals);
            canvas2.drawLine(0.0f, f10, 0.0f, 0.0f, this.mPaintDiagonals);
        } else {
            canvas2 = canvas;
        }
