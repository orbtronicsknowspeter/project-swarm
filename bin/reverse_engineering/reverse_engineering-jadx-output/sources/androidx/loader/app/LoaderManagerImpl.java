...
class LoaderManagerImpl extends LoaderManager {
    ...
    public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
        ...
        @MainThread
        public Loader<D> destroy(boolean z9) {
            ...
            if ((loaderObserver == null || loaderObserver.hasDeliveredData()) && !z9) {
                return this.mLoader;
            }
            this.mLoader.reset();
        ...
        public void dump(String str, FileDescriptor fileDescriptor, PrintWriter printWriter, String[] strArr) {
            ...
            this.mLoader.dump(x.C(str, "  "), fileDescriptor, printWriter, strArr);
            if (this.mObserver != null) {
                printWriter.print(str);
                printWriter.print("mCallbacks=");
                printWriter.println(this.mObserver);
                this.mObserver.dump(x.C(str, "  "), printWriter);
            }
            printWriter.print(str);
    ...
    public void destroyLoader(int i) {
        if (this.mLoaderViewModel.isCreatingLoader()) {
            a.i("Called while creating a loader");
            return;
        }
        if (Looper.getMainLooper() != Looper.myLooper()) {
            a.i("destroyLoader must be called on the main thread");
            return;
        }
        if (DEBUG) {
    ...
    public <D> Loader<D> initLoader(int i, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        if (Looper.getMainLooper() != Looper.myLooper()) {
            a.i("initLoader must be called on the main thread");
            return null;
        }
        LoaderInfo<D> loader = this.mLoaderViewModel.getLoader(i);
        if (DEBUG) {
    ...
    public <D> Loader<D> restartLoader(int i, @Nullable Bundle bundle, @NonNull LoaderManager.LoaderCallbacks<D> loaderCallbacks) {
        ...
        if (Looper.getMainLooper() != Looper.myLooper()) {
            a.i("restartLoader must be called on the main thread");
            return null;
        }
        if (DEBUG) {
