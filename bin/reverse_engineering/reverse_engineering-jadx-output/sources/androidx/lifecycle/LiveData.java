...
public abstract class LiveData<T> {
    ...
    public static void assertMainThread(String str) {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i(l.w("Cannot invoke ", str, " on a background thread"));
    }
    ...
    public void observe(LifecycleOwner lifecycleOwner, Observer<? super T> observer) {
        ...
        if (observerWrapperPutIfAbsent != null && !observerWrapperPutIfAbsent.isAttachedTo(lifecycleOwner)) {
            com.google.gson.internal.a.p("Cannot add the same observer with different lifecycles");
        } else {
