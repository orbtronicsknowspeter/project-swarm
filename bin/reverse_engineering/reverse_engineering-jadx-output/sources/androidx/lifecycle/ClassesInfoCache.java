    ...
    public static final class MethodReference {
        ...
        public void invokeCallback(LifecycleOwner lifecycleOwner, Lifecycle.Event event, Object obj) {
            try {
                ...
                androidx.privacysandbox.ads.adservices.customaudience.a.m("Failed to call observer method", e11.getCause());
            }
        }
    }
            ...
            if (onLifecycleEvent != null) {
                ...
                if (parameterTypes.length <= 0) {
                    ...
                    if (!LifecycleOwner.class.isAssignableFrom(parameterTypes[0])) {
                        com.google.gson.internal.a.p("invalid parameter type. Must be one and instanceof LifecycleOwner");
                        return null;
                    }
                    i = 1;
                }
                ...
                if (parameterTypes.length > 1) {
                    if (!Lifecycle.Event.class.isAssignableFrom(parameterTypes[1])) {
                        com.google.gson.internal.a.p("invalid parameter type. second arg must be an event");
                        return null;
                    }
                    if (eventValue != Lifecycle.Event.ON_ANY) {
                        com.google.gson.internal.a.p("Second arg is supported only for ON_ANY value");
                        return null;
                    }
                    i = 2;
                }
                if (parameterTypes.length > 2) {
                    com.google.gson.internal.a.p("cannot have more than 2 params");
                    return null;
                }
