...
public final class LifecycleCoroutineScopeImpl extends LifecycleCoroutineScope implements LifecycleEventObserver {
    ...
    public LifecycleCoroutineScopeImpl(Lifecycle lifecycle, t6.h hVar) {
        ...
        if (getLifecycle$lifecycle_common().getCurrentState() != Lifecycle.State.DESTROYED || (e1Var = (e1) getCoroutineContext().get(o7.x.f8327b)) == null) {
            return;
        }
        e1Var.c(null);
    }
    ...
    public void onStateChanged(LifecycleOwner lifecycleOwner, Lifecycle.Event event) {
        ...
        if (getLifecycle$lifecycle_common().getCurrentState().compareTo(Lifecycle.State.DESTROYED) <= 0) {
            ...
            e1 e1Var = (e1) getCoroutineContext().get(o7.x.f8327b);
            if (e1Var != null) {
                e1Var.c(null);
            }
        }
    ...
    public final void register() {
        v7.e eVar = m0.f8288a;
        c0.s(this, n.f10348a.f8468l, null, new AnonymousClass1(null), 2);
    }
}
