...
public abstract class ExploreByTouchHelper extends AccessibilityDelegateCompat {
    ...
    public class MyNodeProvider extends AccessibilityNodeProviderCompat {
        ...
        public AccessibilityNodeInfoCompat findFocus(int i) {
            ...
            int i6 = i == 2 ? exploreByTouchHelper.mAccessibilityFocusedVirtualViewId : exploreByTouchHelper.mKeyboardFocusedVirtualViewId;
        ...
        public boolean performAction(int i, int i6, Bundle bundle) {
            return ExploreByTouchHelper.this.performAction(i, i6, bundle);
        }
    }

    public ExploreByTouchHelper(@NonNull View view) {
        if (view == null) {
            a.p("View may not be null");
            throw null;
        }
        this.mHost = view;
    ...
    private AccessibilityEvent createEvent(int i, int i6) {
        return i != -1 ? createEventForChild(i, i6) : createEventForHost(i6);
    }

    private AccessibilityEvent createEventForChild(int i, int i6) {
        ...
        if (accessibilityEventObtain.getText().isEmpty() && accessibilityEventObtain.getContentDescription() == null) {
            b.n("Callbacks must add text or a content description in populateEventForVirtualViewId()");
            return null;
        }
    ...
    private AccessibilityNodeInfoCompat createNodeForChild(int i) {
        ...
        if (accessibilityNodeInfoCompatObtain.getText() == null && accessibilityNodeInfoCompatObtain.getContentDescription() == null) {
            b.n("Callbacks must add text or a content description in populateNodeForVirtualViewId()");
            return null;
        }
        accessibilityNodeInfoCompatObtain.getBoundsInParent(this.mTempParentRect);
        if (this.mTempParentRect.equals(rect)) {
            b.n("Callbacks must set parent bounds in populateNodeForVirtualViewId()");
            return null;
        }
        int actions = accessibilityNodeInfoCompatObtain.getActions();
        if ((actions & 64) != 0) {
            b.n("Callbacks must not add ACTION_ACCESSIBILITY_FOCUS in populateNodeForVirtualViewId()");
            return null;
        }
        if ((actions & 128) != 0) {
            b.n("Callbacks must not add ACTION_CLEAR_ACCESSIBILITY_FOCUS in populateNodeForVirtualViewId()");
            return null;
        }
        ...
        boolean z9 = this.mKeyboardFocusedVirtualViewId == i;
        if (z9) {
    ...
    private AccessibilityNodeInfoCompat createNodeForHost() {
        ...
        if (accessibilityNodeInfoCompatObtain.getChildCount() > 0 && arrayList.size() > 0) {
            b.n("Views cannot have both real and virtual children");
            return null;
        }
    ...
    private boolean moveFocus(int i, @Nullable Rect rect) {
        ...
        if (i == 1 || i == 2) {
            ...
            if (i != 17 && i != 33 && i != 66 && i != 130) {
                a.p("direction must be one of {FOCUS_FORWARD, FOCUS_BACKWARD, FOCUS_UP, FOCUS_DOWN, FOCUS_LEFT, FOCUS_RIGHT}.");
                return false;
            }
            Rect rect2 = new Rect();
    ...
    private boolean performActionForChild(int i, int i6, Bundle bundle) {
        return i6 != 1 ? i6 != 2 ? i6 != 64 ? i6 != 128 ? onPerformActionForVirtualView(i, i6, bundle) : clearAccessibilityFocus(i) : requestAccessibilityFocus(i) : clearKeyboardFocusForVirtualView(i) : requestKeyboardFocusForVirtualView(i);
    }
    ...
    private boolean requestAccessibilityFocus(int i) {
        int i6;
        if (!this.mManager.isEnabled() || !this.mManager.isTouchExplorationEnabled() || (i6 = this.mAccessibilityFocusedVirtualViewId) == i) {
            return false;
        }
        if (i6 != Integer.MIN_VALUE) {
    ...
    */
    ...
    public final void invalidateVirtualView(int i, int i6) {
        ViewParent parent;
    ...
    public final void onFocusChanged(boolean z9, int i, @Nullable Rect rect) {
        int i6 = this.mKeyboardFocusedVirtualViewId;
        if (i6 != Integer.MIN_VALUE) {
    ...
    public abstract boolean onPerformActionForVirtualView(int i, int i6, @Nullable Bundle bundle);

    public abstract void onPopulateNodeForVirtualView(int i, @NonNull AccessibilityNodeInfoCompat accessibilityNodeInfoCompat);

    public boolean performAction(int i, int i6, Bundle bundle) {
        return i != -1 ? performActionForChild(i, i6, bundle) : performActionForHost(i6, bundle);
    }

    public final boolean requestKeyboardFocusForVirtualView(int i) {
        int i6;
        if ((!this.mHost.isFocused() && !this.mHost.requestFocus()) || (i6 = this.mKeyboardFocusedVirtualViewId) == i) {
            return false;
        }
        if (i6 != Integer.MIN_VALUE) {
            clearKeyboardFocusForVirtualView(i6);
    ...
    public final boolean sendEventForVirtualView(int i, int i6) {
        ViewParent parent;
        if (i == Integer.MIN_VALUE || !this.mManager.isEnabled() || (parent = this.mHost.getParent()) == null) {
            return false;
        }
        return parent.requestSendAccessibilityEvent(this.mHost, createEvent(i, i6));
    }
