                    ...
                    while (i < arrayList2.size()) {
                        ...
                        if (receiverRecord.broadcasting) {
                            ...
                            if (iMatch >= 0) {
                                ...
                                arrayList = arrayList2;
                                if (z9) {
                                    Log.v(TAG, "  Filter did not match: " + (iMatch != -4 ? iMatch != -3 ? iMatch != -2 ? iMatch != -1 ? "unknown reason" : ClassDiscriminatorModeKt.CLASS_DISCRIMINATOR_KEY : "data" : "action" : "category"));
                                }
                            }
                        }
                        i++;
