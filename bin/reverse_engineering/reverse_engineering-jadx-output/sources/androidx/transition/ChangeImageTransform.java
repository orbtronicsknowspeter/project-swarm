...
public class ChangeImageTransform extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues, boolean z9) {
        ...
        if ((view instanceof ImageView) && view.getVisibility() == 0) {
            ...
            Matrix matrixCopyImageMatrix = z9 ? (Matrix) imageView.getTag(R.id.transition_image_transform) : null;
    ...
    private static Matrix centerCropMatrix(ImageView imageView) {
        ...
        int iRound2 = Math.round((height - (f10 * fMax)) / 2.0f);
