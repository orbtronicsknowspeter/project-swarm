...
public class TransitionSet extends Transition {
    ...
    public Transition mo224clone() {
        ...
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            transitionSet.addTransitionInternal(this.mTransitions.get(i).mo224clone());
        }
    ...
    public Transition excludeTarget(@NonNull View view, boolean z9) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).excludeTarget(view, z9);
        }
    ...
    public TransitionSet removeTarget(@IdRes int i) {
        for (int i6 = 0; i6 < this.mTransitions.size(); i6++) {
            this.mTransitions.get(i6).removeTarget(i);
        }
    ...
    public void runAnimators() {
        ...
        while (true) {
            ...
            Transition transition2 = arrayList.get(i6 - 1);
    ...
    public void setCanRemoveViews(boolean z9) {
        ...
        int size = this.mTransitions.size();
        for (int i = 0; i < size; i++) {
            this.mTransitions.get(i).setCanRemoveViews(z9);
        }
    }
    ...
    */
    ...
    public TransitionSet setOrdering(int i) {
        ...
        if (i != 1) {
            throw new AndroidRuntimeException(l.u(i, "Invalid parameter for TransitionSet ordering: "));
        }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            ...
            sbU.append(this.mTransitions.get(i).toString(str + "  "));
            string = sbU.toString();
        }
        return string;
    }
    ...
    public Transition excludeTarget(@NonNull String str, boolean z9) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).excludeTarget(str, z9);
        }
    ...
    @Override // androidx.transition.Transition
    @NonNull
    public Transition excludeTarget(int i, boolean z9) {
        for (int i6 = 0; i6 < this.mTransitions.size(); i6++) {
            this.mTransitions.get(i6).excludeTarget(i, z9);
        }
    ...
    public TransitionSet addTarget(@IdRes int i) {
        for (int i6 = 0; i6 < this.mTransitions.size(); i6++) {
            this.mTransitions.get(i6).addTarget(i);
        }
    ...
    public Transition excludeTarget(@NonNull Class<?> cls, boolean z9) {
        for (int i = 0; i < this.mTransitions.size(); i++) {
            this.mTransitions.get(i).excludeTarget(cls, z9);
        }
