...
public final class ProfileVerifier {
    ...
    public static class Cache {
        ...
        public Cache(int i, int i6, long j, long j6) {
            this.mSchema = i;
            this.mResultCode = i6;
    ...
    public static class CompilationStatus {
        ...
        public CompilationStatus(int i, boolean z9, boolean z10, boolean z11) {
            this.mResultCode = i;
            this.mHasCurrentProfile = z10;
            this.mHasReferenceProfile = z9;
            this.mHasEmbeddedProfile = z11;
        }
    ...
    @NonNull
    public static m1.b getCompilationStatusAsync() {
        return sFuture;
    }
    ...
    private static CompilationStatus setCompilationStatus(int i, boolean z9, boolean z10, boolean z11) {
        CompilationStatus compilationStatus = new CompilationStatus(i, z9, z10, z11);
