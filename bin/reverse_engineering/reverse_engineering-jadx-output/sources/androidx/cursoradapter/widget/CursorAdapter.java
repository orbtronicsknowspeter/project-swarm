...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public CursorAdapter(Context context, Cursor cursor, boolean z9) {
        init(context, cursor, z9 ? 1 : 2);
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (!this.mDataValid) {
            a.i("this should only be called when the cursor is valid");
            return null;
        }
        if (!this.mCursor.moveToPosition(i)) {
            a.i(l.u(i, "couldn't move cursor to position "));
            return null;
        }
        if (view == null) {
    ...
    public void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z9 ? cursor.getColumnIndexOrThrow("_id") : -1;
        if ((i & 2) == 2) {
    ...
    @Deprecated
    public void init(Context context, Cursor cursor, boolean z9) {
        init(context, cursor, z9 ? 1 : 2);
    }
}
