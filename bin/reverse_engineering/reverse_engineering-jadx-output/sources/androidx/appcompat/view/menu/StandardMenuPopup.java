...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i, int i6, boolean z9) {
        this.mContext = context;
        this.mMenu = menuBuilder;
        this.mOverflowOnly = z9;
        this.mAdapter = new MenuAdapter(menuBuilder, LayoutInflater.from(context), z9, ITEM_LAYOUT);
        this.mPopupStyleAttr = i;
        this.mPopupStyleRes = i6;
        Resources resources = context.getResources();
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(R.dimen.abc_config_prefDialogWidth));
        this.mAnchorView = view;
        this.mPopup = new MenuPopupWindow(context, null, i, i6);
    ...
    private boolean tryShow() {
        ...
        boolean z9 = this.mTreeObserver == null;
    ...
    public void setForceShowIcon(boolean z9) {
        this.mAdapter.setForceShowIcon(z9);
    }
    ...
    public void show() {
        ...
        a.i("StandardMenuPopup cannot be used without an anchor");
    }
