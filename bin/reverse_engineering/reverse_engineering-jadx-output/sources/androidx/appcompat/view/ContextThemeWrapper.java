...
public class ContextThemeWrapper extends ContextWrapper {
    ...
    private void initializeTheme() {
        ...
        onApplyThemeResource(this.mTheme, this.mThemeResource, z9);
    }
    ...
    public void applyOverrideConfiguration(Configuration configuration) {
        if (this.mResources != null) {
            a.i("getResources() or getAssets() has already been called");
        } else if (this.mOverrideConfiguration == null) {
            this.mOverrideConfiguration = new Configuration(configuration);
        } else {
            a.i("Override configuration has already been set");
        }
    }
    ...
    public void onApplyThemeResource(Resources.Theme theme, int i, boolean z9) {
