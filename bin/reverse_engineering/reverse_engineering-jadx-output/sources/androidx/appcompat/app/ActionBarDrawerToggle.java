...
public class ActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    ...
    public ActionBarDrawerToggle(Activity activity, Toolbar toolbar, DrawerLayout drawerLayout, DrawerArrowDrawable drawerArrowDrawable, @StringRes int i, @StringRes int i6) {
    ...
    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, Toolbar toolbar, @StringRes int i, @StringRes int i6) {
        this(activity, toolbar, drawerLayout, null, i, i6);
    }

    public ActionBarDrawerToggle(Activity activity, DrawerLayout drawerLayout, @StringRes int i, @StringRes int i6) {
        this(activity, null, drawerLayout, null, i, i6);
    }
}
