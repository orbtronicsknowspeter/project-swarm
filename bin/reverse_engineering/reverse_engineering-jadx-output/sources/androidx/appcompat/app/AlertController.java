...
class AlertController {
    ...
    public static class CheckedItemAdapter extends ArrayAdapter<CharSequence> {
        public CheckedItemAdapter(Context context, int i, int i6, CharSequence[] charSequenceArr) {
            super(context, i, i6, charSequenceArr);
        }
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i6) {
        ...
        ViewCompat.setScrollIndicators(view, i, i6);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (!z9 || !canTextInput(viewInflate)) {
    ...
    private void setupView() {
        ...
        boolean z10 = (viewGroupResolvePanel == null || viewGroupResolvePanel.getVisibility() == 8) ? 0 : 1;
        boolean z11 = (viewGroupResolvePanel3 == null || viewGroupResolvePanel3.getVisibility() == 8) ? false : true;
        if (!z11 && viewGroupResolvePanel2 != null && (viewFindViewById2 = viewGroupResolvePanel2.findViewById(androidx.appcompat.R.id.textSpacerNoButtons)) != null) {
        ...
        if (listView instanceof RecycleListView) {
            ((RecycleListView) listView).setHasDecor(z10, z11);
        }
        if (!z9) {
            ...
            if (view != null) {
                setScrollIndicators(viewGroupResolvePanel2, view, z10 | (z11 ? 2 : 0), 3);
            }
        }
    ...
    public void setButton(int i, CharSequence charSequence, DialogInterface.OnClickListener onClickListener, Message message, Drawable drawable) {
        ...
        if (i == -3) {
            ...
            if (i != -1) {
                com.google.gson.internal.a.p("Button does not exist");
                return;
            }
    ...
    public void setView(View view, int i, int i6, int i10, int i11) {
        this.mView = view;
    ...
    public static class RecycleListView extends ListView {
        ...
        public void setHasDecor(boolean z9, boolean z10) {
            if (z10 && z9) {
                return;
            }
            setPadding(getPaddingLeft(), z9 ? getPaddingTop() : this.mPaddingTopNoTitle, getPaddingRight(), z10 ? getPaddingBottom() : this.mPaddingBottomNoButtons);
        }
