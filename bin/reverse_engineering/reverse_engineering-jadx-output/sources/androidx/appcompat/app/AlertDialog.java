...
public class AlertDialog extends AppCompatDialog implements DialogInterface {
    ...
    public void setView(View view, int i, int i6, int i10, int i11) {
        this.mAlert.setView(view, i, i6, i10, i11);
    }
    ...
    public static class Builder {
        ...
        public Builder setInverseBackgroundForced(boolean z9) {
            this.P.mForceInverseBackground = z9;
            return this;
        }
        ...
        public Builder setRecycleOnMeasureEnabled(boolean z9) {
            this.P.mRecycleOnMeasure = z9;
            return this;
        }

        public Builder setSingleChoiceItems(@ArrayRes int i, int i6, DialogInterface.OnClickListener onClickListener) {
            AlertController.AlertParams alertParams = this.P;
            alertParams.mItems = alertParams.mContext.getResources().getTextArray(i);
            AlertController.AlertParams alertParams2 = this.P;
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public Builder setView(View view, int i, int i6, int i10, int i11) {
            AlertController.AlertParams alertParams = this.P;
    ...
    public AlertDialog(@NonNull Context context, boolean z9, @Nullable DialogInterface.OnCancelListener onCancelListener) {
        this(context, 0);
        setCancelable(z9);
