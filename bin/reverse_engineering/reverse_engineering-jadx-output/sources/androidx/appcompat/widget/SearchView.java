...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            if (action != 0) {
                if (action == 1 || action == 2) {
                    ...
                    if (z10 && !this.mSlopBounds.contains(x3, y9)) {
                        z11 = z10;
                        z9 = false;
                    }
                } else {
                ...
                z11 = z10;
                z9 = true;
            } else if (this.mTargetBounds.contains(x3, y9)) {
            ...
            if (!z9 || this.mActualBounds.contains(x3, y9)) {
    ...
    private void getChildBoundsWithinSearchView(View view, Rect rect) {
        ...
        rect.set(i10, i6, view.getWidth() + i10, view.getHeight() + i6);
    }
    ...
    private boolean launchSuggestion(int i, int i6, String str) {
    ...
    private void updateSubmitButton(boolean z9) {
        this.mGoButton.setVisibility((this.mSubmitButtonEnabled && isSubmitAreaEnabled() && hasFocus() && (z9 || !this.mVoiceButtonEnabled)) ? 0 : 8);
    }

    private void updateViewsVisibility(boolean z9) {
        this.mIconified = z9;
        int i = 8;
        int i6 = z9 ? 0 : 8;
        boolean zIsEmpty = TextUtils.isEmpty(this.mSearchSrcTextView.getText());
        ...
        this.mSearchEditFrame.setVisibility(z9 ? 8 : 0);
    ...
    private void updateVoiceButton(boolean z9) {
        int i = 8;
        if (this.mVoiceButtonEnabled && !isIconified() && z9) {
    ...
    public boolean onItemClicked(int i, int i6, String str) {
    ...
    public void onLayout(boolean z9, int i, int i6, int i10, int i11) {
        ...
        if (z9) {
            ...
            rect.set(rect2.left, 0, rect2.right, i11 - i6);
    ...
    public void setIconifiedByDefault(boolean z9) {
        if (this.mIconifiedByDefault == z9) {
            return;
        }
        this.mIconifiedByDefault = z9;
        updateViewsVisibility(z9);
        updateQueryHint();
    }
    ...
    public void setQuery(CharSequence charSequence, boolean z9) {
    ...
    public void setQueryRefinementEnabled(boolean z9) {
        this.mQueryRefinement = z9;
        CursorAdapter cursorAdapter = this.mSuggestionsAdapter;
        if (cursorAdapter instanceof SuggestionsAdapter) {
            ((SuggestionsAdapter) cursorAdapter).setQueryRefinement(z9 ? 2 : 1);
        }
    }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public void onWindowFocusChanged(boolean z9) {
            super.onWindowFocusChanged(z9);
            if (z9 && this.mSearchView.hasFocus() && getVisibility() == 0) {
