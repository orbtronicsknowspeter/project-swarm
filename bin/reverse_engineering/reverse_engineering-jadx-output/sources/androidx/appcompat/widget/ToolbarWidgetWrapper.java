...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    public ToolbarWidgetWrapper(Toolbar toolbar, boolean z9, int i, int i6) {
        Drawable drawable;
    ...
    public void setCollapsible(boolean z9) {
        this.mToolbar.setCollapsible(z9);
    }
    ...
    public void setDropdownSelectedPosition(int i) {
        ...
        if (spinner != null) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i("Can't set dropdown selected position without an adapter");
        }
    }
    ...
    public void setNavigationMode(int i) {
        ...
        if (i != i6) {
            ...
            if (i != 0) {
                ...
                if (i != 2) {
                    com.google.gson.internal.a.p(l.u(i, "Invalid navigation mode "));
                    return;
                }
