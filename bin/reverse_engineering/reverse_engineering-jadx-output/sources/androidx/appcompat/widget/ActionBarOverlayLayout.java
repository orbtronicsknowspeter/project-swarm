...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    */
    ...
    private DecorToolbar getDecorToolbar(View view) {
        ...
        androidx.privacysandbox.ads.adservices.customaudience.a.i("Can't make a decor toolbar out of ".concat(view.getClass().getSimpleName()));
        return null;
    }
    ...
    public void onMeasure(int i, int i6) {
        int measuredHeight;
        pullChildren();
        measureChildWithMargins(this.mActionBarTop, i, 0, i6, 0);
        ...
        measureChildWithMargins(this.mContent, i, 0, i6, 0);
        ...
        setMeasuredDimension(View.resolveSizeAndState(Math.max(getPaddingRight() + getPaddingLeft() + iMax3, getSuggestedMinimumWidth()), i, iCombineMeasuredStates2), View.resolveSizeAndState(Math.max(getPaddingBottom() + getPaddingTop() + iMax4, getSuggestedMinimumHeight()), i6, iCombineMeasuredStates2 << 16));
    }
    ...
    public void onNestedScroll(View view, int i, int i6, int i10, int i11) {
        int i12 = this.mHideOnContentScrollReference + i6;
    ...
    public void onWindowSystemUiVisibilityChanged(int i) {
        ...
        pullChildren();
        int i6 = this.mLastSystemUiVisibility ^ i;
    ...
    public void onNestedScroll(View view, int i, int i6, int i10, int i11, int i12, int[] iArr) {
        onNestedScroll(view, i, i6, i10, i11, i12);
    }
