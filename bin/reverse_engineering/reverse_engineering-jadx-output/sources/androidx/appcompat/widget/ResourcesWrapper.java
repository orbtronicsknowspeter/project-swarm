...
class ResourcesWrapper extends Resources {
    ...
    @Override // android.content.res.Resources
    public Drawable getDrawableForDensity(int i, int i6) throws Resources.NotFoundException {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i, i6, null);
    }

    @Override // android.content.res.Resources
    public float getFraction(int i, int i6, int i10) {
        return this.mResources.getFraction(i, i6, i10);
    }
    ...
    @Override // android.content.res.Resources
    public String getQuantityString(int i, int i6, Object... objArr) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i, i6, objArr);
    }

    @Override // android.content.res.Resources
    public CharSequence getQuantityText(int i, int i6) throws Resources.NotFoundException {
        return this.mResources.getQuantityText(i, i6);
    }
    ...
    @Override // android.content.res.Resources
    public void getValue(int i, TypedValue typedValue, boolean z9) throws Resources.NotFoundException {
        this.mResources.getValue(i, typedValue, z9);
    }

    @Override // android.content.res.Resources
    public void getValueForDensity(int i, int i6, TypedValue typedValue, boolean z9) throws Resources.NotFoundException {
        this.mResources.getValueForDensity(i, i6, typedValue, z9);
    }
    ...
    @Override // android.content.res.Resources
    public void getValue(String str, TypedValue typedValue, boolean z9) throws Resources.NotFoundException {
        this.mResources.getValue(str, typedValue, z9);
    }
    ...
    public String getQuantityString(int i, int i6) throws Resources.NotFoundException {
        return this.mResources.getQuantityString(i, i6);
    }
    ...
    @Override // android.content.res.Resources
    @RequiresApi(21)
    public Drawable getDrawableForDensity(int i, int i6, Resources.Theme theme) {
        return ResourcesCompat.getDrawableForDensity(this.mResources, i, i6, theme);
    }
}
