...
abstract class AbsActionBarView extends ViewGroup {
    ...
    public static int next(int i, int i6, boolean z9) {
        return z9 ? i - i6 : i + i6;
    }
    ...
    public int measureChildView(View view, int i, int i6, int i10) {
        view.measure(View.MeasureSpec.makeMeasureSpec(i, Integer.MIN_VALUE), i6);
        return Math.max(0, (i - view.getMeasuredWidth()) - i10);
    }
    ...
    public int positionChild(View view, int i, int i6, int i10, boolean z9) {
