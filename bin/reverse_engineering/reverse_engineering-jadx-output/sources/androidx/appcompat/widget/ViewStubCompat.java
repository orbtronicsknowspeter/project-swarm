...
public final class ViewStubCompat extends View {
    ...
    public View inflate() {
        ...
        if (!(parent instanceof ViewGroup)) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("ViewStub must have a non-null ViewGroup viewParent");
            return null;
        }
        if (this.mLayoutResource == 0) {
            com.google.gson.internal.a.p("ViewStub must have a valid layoutResource");
            return null;
        }
    ...
    public void setVisibility(int i) {
        ...
        if (weakReference != null) {
            ...
            if (view != null) {
                ...
                androidx.privacysandbox.ads.adservices.customaudience.a.i("setVisibility called on un-referenced view");
                return;
            }
        }
