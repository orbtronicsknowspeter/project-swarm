...
class ActionMenuPresenter extends BaseMenuPresenter implements ActionProvider.SubUiVisibilityListener {
    ...
    public boolean flagActionItems() {
        ...
        if (actionMenuPresenter.mReserveOverflow && (z9 || i13 + i12 > i10)) {
            i10--;
        }
        int i15 = i10 - i12;
        ...
        if (actionMenuPresenter.mStrictWidthLimit) {
            ...
            i = ((i11 % i16) / iMeasureChildForCells) + i16;
        } else {
        ...
        while (i17 < size) {
            ...
            if (menuItemImpl2.requiresActionButton()) {
                ...
                boolean z11 = (i15 > 0 || z10) && i11 > 0 && (!r03.mStrictWidthLimit || iMeasureChildForCells > 0);
                boolean z12 = z11;
                i6 = size;
                if (z11) {
                    ...
                    z11 = z13 & (!r03.mStrictWidthLimit ? i11 + i18 <= 0 : i11 < 0);
                }
                if (z11 && groupId2 != 0) {
    ...
    public void setWidthLimit(int i, boolean z9) {
        this.mWidthLimit = i;
