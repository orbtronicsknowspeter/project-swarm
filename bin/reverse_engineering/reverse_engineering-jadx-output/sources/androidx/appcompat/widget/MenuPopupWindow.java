...
public class MenuPopupWindow extends ListPopupWindow implements MenuItemHoverListener {
    ...
    public static class MenuDropDownListView extends DropDownListView {
        ...
        public /* bridge */ /* synthetic */ int lookForSelectablePosition(int i, boolean z9) {
            return super.lookForSelectablePosition(i, z9);
        }

        @Override // androidx.appcompat.widget.DropDownListView
        public /* bridge */ /* synthetic */ int measureHeightOfChildrenCompat(int i, int i6, int i10, int i11, int i12) {
            return super.measureHeightOfChildrenCompat(i, i6, i10, i11, i12);
        }
    ...
    public MenuPopupWindow(@NonNull Context context, @Nullable AttributeSet attributeSet, int i, int i6) {
