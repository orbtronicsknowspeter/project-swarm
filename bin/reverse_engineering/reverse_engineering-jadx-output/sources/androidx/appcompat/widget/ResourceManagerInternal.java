...
public final class ResourceManagerInternal {
    ...
    private void checkVectorDrawableSetup(@NonNull Context context) {
        ...
        if (drawable == null || !isVectorDrawable(drawable)) {
            ...
            androidx.privacysandbox.ads.adservices.customaudience.a.i("This app has been built with an incorrect configuration. Please configure your build for VectorDrawableCompat.");
        }
    }
    ...
    public static void tintDrawable(Drawable drawable, TintInfo tintInfo, int[] iArr) {
        ...
        boolean z9 = tintInfo.mHasTintList;
        if (z9 || tintInfo.mHasTintMode) {
            drawable.setColorFilter(createTintFilter(z9 ? tintInfo.mTintList : null, tintInfo.mHasTintMode ? tintInfo.mTintMode : DEFAULT_MODE, iArr));
        } else {
    ...
    public synchronized Drawable getDrawable(@NonNull Context context, @DrawableRes int i, boolean z9) {
        ...
        try {
            ...
            if (drawableLoadDrawableFromDelegates != null) {
                drawableLoadDrawableFromDelegates = tintDrawable(context, i, z9, drawableLoadDrawableFromDelegates);
            }
            if (drawableLoadDrawableFromDelegates != null) {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z9, @NonNull Drawable drawable) {
        ...
        ResourceManagerHooks resourceManagerHooks = this.mHooks;
        if ((resourceManagerHooks == null || !resourceManagerHooks.tintDrawable(context, i, drawable)) && !tintDrawableUsingColorFilter(context, i, drawable) && z9) {
            return null;
        }
        return drawable;
    }
