...
class AppCompatTextViewAutoSizeHelper {
    ...
    public static final class Api23Impl {
        ...
        @NonNull
        @DoNotInline
        public static StaticLayout createStaticLayoutForMeasuring(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i, int i6, @NonNull TextView textView, @NonNull TextPaint textPaint, @NonNull Impl impl) {
    ...
    private int findLargestTextSizeWhichFits(RectF rectF) {
        ...
        if (length == 0) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("No available text sizes to choose from.");
            return 0;
        }
        int i = 1;
        int i6 = length - 1;
        ...
        while (true) {
            ...
            int i11 = (i + i6) / 2;
            if (suggestedSizeFitsInSpace(iArr[i11], rectF)) {
                int i12 = i11 + 1;
                i10 = i;
                i = i12;
            } else {
    ...
    public static <T> T invokeAndReturnWithDefault(@NonNull Object obj, @NonNull String str, @NonNull T t9) {
        try {
    ...
    private void validateAndSetAutoSizeTextTypeUniformConfiguration(float f, float f10, float f11) throws IllegalArgumentException {
        if (f <= 0.0f) {
            a3.b.o("Minimum auto-size text size (", f, "px) is less or equal to (0px)");
            return;
        }
        if (f10 <= f) {
        ...
        if (f11 <= 0.0f) {
            a3.b.o("The auto-size step granularity (", f11, "px) is less or equal to (0px)");
            return;
        }
        this.mAutoSizeTextType = 1;
    ...
    @NonNull
    @VisibleForTesting
    public StaticLayout createLayout(@NonNull CharSequence charSequence, @NonNull Layout.Alignment alignment, int i, int i6) {
        return Api23Impl.createStaticLayoutForMeasuring(charSequence, alignment, i, i6, this.mTextView, this.mTempTextPaint, this.mImpl);
    }
    ...
    public void setAutoSizeTextTypeUniformWithConfiguration(int i, int i6, int i10, int i11) throws IllegalArgumentException {
        if (supportsAutoSizeText()) {
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
            validateAndSetAutoSizeTextTypeUniformConfiguration(TypedValue.applyDimension(i11, i, displayMetrics), TypedValue.applyDimension(i11, i6, displayMetrics), TypedValue.applyDimension(i11, i10, displayMetrics));
            ...
            if (length > 0) {
                ...
                if (i == 0) {
                    ...
                    for (int i6 = 0; i6 < length; i6++) {
                        iArrCopyOf[i6] = Math.round(TypedValue.applyDimension(i, iArr[i6], displayMetrics));
                    }
                }
                this.mAutoSizeTextSizesInPx = cleanupAutoSizePresetSizes(iArrCopyOf);
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.r(Arrays.toString(iArr), "None of the preset sizes is valid: ");
                    return;
                }
            } else {
                this.mHasPresetAutoSizeValues = false;
    ...
    public void setAutoSizeTextTypeWithDefaults(int i) {
        if (supportsAutoSizeText()) {
            ...
            if (i != 1) {
                com.google.gson.internal.a.p(l.u(i, "Unknown auto-size text type: "));
                return;
            }
            DisplayMetrics displayMetrics = this.mContext.getResources().getDisplayMetrics();
