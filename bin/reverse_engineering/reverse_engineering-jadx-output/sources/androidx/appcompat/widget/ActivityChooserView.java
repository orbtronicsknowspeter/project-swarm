...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModel.ActivityChooserModelClient {
    ...
    public void onLayout(boolean z9, int i, int i6, int i10, int i11) {
        this.mActivityChooserContent.layout(0, 0, i10 - i, i11 - i6);
        if (isShowingPopup()) {
            return;
        }
        dismissPopup();
    ...
    public void onMeasure(int i, int i6) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            i6 = View.MeasureSpec.makeMeasureSpec(View.MeasureSpec.getSize(i6), BasicMeasure.EXACTLY);
        }
    ...
    public void showPopupUnchecked(int i) {
        if (this.mAdapter.getDataModel() == null) {
            androidx.privacysandbox.ads.adservices.customaudience.a.i("No data model. Did you call #setDataModel?");
            return;
        }
