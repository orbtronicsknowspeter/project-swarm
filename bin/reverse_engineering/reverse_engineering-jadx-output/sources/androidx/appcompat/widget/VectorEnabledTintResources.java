...
public class VectorEnabledTintResources extends ResourcesWrapper {
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i, int i6) throws Resources.NotFoundException {
        return super.getDrawableForDensity(i, i6);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ float getFraction(int i, int i6, int i10) {
        return super.getFraction(i, i6, i10);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i, int i6) throws Resources.NotFoundException {
        return super.getQuantityString(i, i6);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ CharSequence getQuantityText(int i, int i6) throws Resources.NotFoundException {
        return super.getQuantityText(i, i6);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValue(int i, TypedValue typedValue, boolean z9) throws Resources.NotFoundException {
        super.getValue(i, typedValue, z9);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ void getValueForDensity(int i, int i6, TypedValue typedValue, boolean z9) throws Resources.NotFoundException {
        super.getValueForDensity(i, i6, typedValue, z9);
    }
    ...
    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    @RequiresApi(21)
    public /* bridge */ /* synthetic */ Drawable getDrawableForDensity(int i, int i6, Resources.Theme theme) {
        return super.getDrawableForDensity(i, i6, theme);
    }

    @Override // androidx.appcompat.widget.ResourcesWrapper, android.content.res.Resources
    public /* bridge */ /* synthetic */ String getQuantityString(int i, int i6, Object[] objArr) throws Resources.NotFoundException {
        return super.getQuantityString(i, i6, objArr);
    }
