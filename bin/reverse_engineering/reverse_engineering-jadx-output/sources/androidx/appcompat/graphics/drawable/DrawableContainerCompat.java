...
public class DrawableContainerCompat extends Drawable implements Drawable.Callback {
    ...
    public static abstract class DrawableContainerState extends Drawable.ConstantState {
        ...
        public final boolean setLayoutDirection(int i, int i6) {
    ...
    */
    ...
    public void setAutoMirrored(boolean z9) {
        DrawableContainerState drawableContainerState = this.mDrawableContainerState;
        if (drawableContainerState.mAutoMirrored != z9) {
            drawableContainerState.mAutoMirrored = z9;
            Drawable drawable = this.mCurrDrawable;
            if (drawable != null) {
    ...
    public void setDither(boolean z9) {
        DrawableContainerState drawableContainerState = this.mDrawableContainerState;
        if (drawableContainerState.mDither != z9) {
            drawableContainerState.mDither = z9;
            Drawable drawable = this.mCurrDrawable;
            if (drawable != null) {
    ...
    public void setHotspotBounds(int i, int i6, int i10, int i11) {
        Rect rect = this.mHotspotBounds;
        if (rect == null) {
            this.mHotspotBounds = new Rect(i, i6, i10, i11);
        } else {
            rect.set(i, i6, i10, i11);
        }
        Drawable drawable = this.mCurrDrawable;
        if (drawable != null) {
            DrawableCompat.setHotspotBounds(drawable, i, i6, i10, i11);
        }
    }
