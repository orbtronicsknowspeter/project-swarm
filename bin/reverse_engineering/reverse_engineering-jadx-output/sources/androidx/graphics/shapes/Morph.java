    ...
    public static final class Companion {
        ...
        public final List<i> match$graphics_shapes_release(RoundedPolygon roundedPolygon, RoundedPolygon roundedPolygon2) {
            ...
            while (measuredCubic != null && measuredCubic2 != null) {
                ...
                MeasuredPolygon.MeasuredCubic measuredCubic3 = (MeasuredPolygon.MeasuredCubic) iVarCutAtProgress.f8441a;
                measuredCubic = (MeasuredPolygon.MeasuredCubic) iVarCutAtProgress.f8442b;
                if (fMapBack > f) {
                ...
                MeasuredPolygon.MeasuredCubic measuredCubic4 = (MeasuredPolygon.MeasuredCubic) iVarCutAtProgress2.f8441a;
                measuredCubic2 = (MeasuredPolygon.MeasuredCubic) iVarCutAtProgress2.f8442b;
