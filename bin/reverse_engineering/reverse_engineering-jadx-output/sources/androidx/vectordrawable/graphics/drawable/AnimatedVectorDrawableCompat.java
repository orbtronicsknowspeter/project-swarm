...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
                ...
                if (ANIMATED_VECTOR.equals(name)) {
                    ...
                    if (resourceId2 != 0) {
                        ...
                        if (context == null) {
                            ...
                            a.i("Context can't be null when inflating animators");
                            return;
                        }
    ...
    public void setAutoMirrored(boolean z9) {
        ...
        if (drawable != null) {
            ...
            this.mAnimatedVectorState.mVectorDrawable.setAutoMirrored(z9);
        }
    }
    ...
    public boolean setVisible(boolean z9, boolean z10) {
        ...
        this.mAnimatedVectorState.mVectorDrawable.setVisible(z9, z10);
