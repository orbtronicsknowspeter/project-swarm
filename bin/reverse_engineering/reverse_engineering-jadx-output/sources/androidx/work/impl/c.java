        ...
        switch (i) {
            ...
            case 3:
                ...
                if (!u.k0(str2, ".apk", true) && !u.k0(str2, ".xapk", true) && !u.k0(str2, ".apks", true) && !u.k0(str2, ".apkm", true) && !u.k0(str2, ".zip", true)) {
                    s0Var.i(s0Var.getString(2131952271) + str2 + " " + str3);
                    return;
                }
                s0Var.E();
                ...
                textView3.setText(s0Var.getString(R.string.ok));
