...
public class PreferenceUtils {
    ...
    public static /* synthetic */ Long lambda$getLastCancelAllTimeMillisLiveData$0(Long l10) {
    ...
    public LiveData<Long> getLastCancelAllTimeMillisLiveData() {
        return Transformations.map(this.mWorkDatabase.preferenceDao().getObservableLongValue(KEY_LAST_CANCEL_ALL_TIME_MS), new androidx.room.f(19));
    }
    ...
    public void setNeedsReschedule(boolean z9) {
        this.mWorkDatabase.preferenceDao().insertPreference(new Preference(KEY_RESCHEDULE_NEEDED, z9));
    }
}
