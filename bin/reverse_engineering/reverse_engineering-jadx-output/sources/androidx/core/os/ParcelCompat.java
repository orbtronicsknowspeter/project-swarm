    ...
    public static <T> T[] readParcelableArray(@NonNull Parcel parcel, @Nullable ClassLoader classLoader, @NonNull Class<T> cls) {
        ...
        for (int i = 0; i < tArr.length; i++) {
            try {
                ...
                StringBuilder sbP = x.p(i, "Parcelable at index ", " is not a subclass of required class ");
                sbP.append(cls.getName());
                sbP.append(" provided in the parameter");
                throw new BadParcelableException(sbP.toString());
            }
        }
        return tArr2;
    }
