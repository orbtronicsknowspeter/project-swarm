...
final class LocaleListCompatWrapper implements LocaleListInterface {
    ...
    private Locale computeFirstMatch(Collection<String> collection, boolean z9) {
        int iComputeFirstMatchIndex = computeFirstMatchIndex(collection, z9);
