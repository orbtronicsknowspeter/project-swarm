...
public class FontsContractCompat {
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
        @Deprecated
        public FontInfo(@NonNull Uri uri, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i, @IntRange(from = 1, to = 1000) int i6, boolean z9, int i10) {
        ...
        public static FontInfo create(@NonNull Uri uri, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i, @IntRange(from = 1, to = 1000) int i6, boolean z9, int i10) {
            return new FontInfo(uri, i, i6, z9, i10);
        }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    @Deprecated
    public static Typeface getFontSync(Context context, FontRequest fontRequest, @Nullable ResourcesCompat.FontCallback fontCallback, @Nullable Handler handler, boolean z9, int i, int i6) {
        return requestFont(context, fontRequest, i6, z9, i, ResourcesCompat.FontCallback.getHandler(handler), new TypefaceCompat.ResourcesCallbackAdapter(fontCallback));
    }
    ...
    @Nullable
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public static Typeface requestFont(@NonNull Context context, @NonNull FontRequest fontRequest, int i, boolean z9, @IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i6, @NonNull Handler handler, @NonNull FontRequestCallback fontRequestCallback) {
        CallbackWithHandler callbackWithHandler = new CallbackWithHandler(fontRequestCallback, handler);
        if (z9) {
            return FontRequestWorker.requestFontSync(context, fontRequest, callbackWithHandler, i, i6);
        }
