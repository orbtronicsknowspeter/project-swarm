...
public final class WindowInsetsAnimationCompat {
    ...
    public static class Impl21 extends Impl {
        ...
        public static void dispatchOnPrepare(View view, WindowInsetsAnimationCompat windowInsetsAnimationCompat, WindowInsets windowInsets, boolean z9) {
            Callback callback = getCallback(view);
            if (callback != null) {
                callback.mDispachedInsets = windowInsets;
                if (!z9) {
                    callback.onPrepare(windowInsetsAnimationCompat);
                    z9 = callback.getDispatchMode() == 0;
                }
            }
            if (view instanceof ViewGroup) {
                ViewGroup viewGroup = (ViewGroup) view;
                for (int i = 0; i < viewGroup.getChildCount(); i++) {
                    dispatchOnPrepare(viewGroup.getChildAt(i), windowInsetsAnimationCompat, windowInsets, z9);
                }
            }
        }
        ...
        public static WindowInsetsCompat interpolateInsets(WindowInsetsCompat windowInsetsCompat, WindowInsetsCompat windowInsetsCompat2, float f, int i) {
            ...
            for (int i6 = 1; i6 <= 256; i6 <<= 1) {
                if ((i & i6) == 0) {
                    ...
                    float f10 = 1.0f - f;
                    builder.setInsets(i6, WindowInsetsCompat.insetInsets(insets, (int) (((double) ((insets.left - insets2.left) * f10)) + 0.5d), (int) (((double) ((insets.top - insets2.top) * f10)) + 0.5d), (int) (((double) ((insets.right - insets2.right) * f10)) + 0.5d), (int) (((double) ((insets.bottom - insets2.bottom) * f10)) + 0.5d)));
                }
            }
