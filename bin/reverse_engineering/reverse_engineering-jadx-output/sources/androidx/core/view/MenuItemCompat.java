...
public final class MenuItemCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static MenuItem setAlphabeticShortcut(MenuItem menuItem, char c9, int i) {
        ...
        @DoNotInline
        public static MenuItem setNumericShortcut(MenuItem menuItem, char c9, int i) {
            return menuItem.setNumericShortcut(c9, i);
        }

        @DoNotInline
        public static MenuItem setShortcut(MenuItem menuItem, char c9, char c10, int i, int i6) {
    ...
    public static void setAlphabeticShortcut(@NonNull MenuItem menuItem, char c9, int i) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setAlphabeticShortcut(c9, i);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setAlphabeticShortcut(menuItem, c9, i);
        }
    }
    ...
    public static void setNumericShortcut(@NonNull MenuItem menuItem, char c9, int i) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setNumericShortcut(c9, i);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setNumericShortcut(menuItem, c9, i);
        }
    }
    ...
    public static void setShortcut(@NonNull MenuItem menuItem, char c9, char c10, int i, int i6) {
        if (menuItem instanceof SupportMenuItem) {
            ((SupportMenuItem) menuItem).setShortcut(c9, c10, i, i6);
        } else if (Build.VERSION.SDK_INT >= 26) {
            Api26Impl.setShortcut(menuItem, c9, c10, i, i6);
        }
    }
