...
public class AccessibilityNodeInfoCompat {
    ...
    public static class Api21Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat createCollectionItemInfo(int i, int i6, int i10, int i11, boolean z9, boolean z10) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i, i6, i10, i11, z9, z10));
        }
    }
    ...
    public static class Api30Impl {
        ...
        @DoNotInline
        public static Object createRangeInfo(int i, float f, float f10, float f11) {
            return new AccessibilityNodeInfo.RangeInfo(i, f, f10, f11);
        }
    ...
    public static class Api33Impl {
        ...
        @DoNotInline
        public static CollectionItemInfoCompat buildCollectionItemInfoCompat(boolean z9, int i, int i6, int i10, int i11, boolean z10, String str, String str2) {
            return new CollectionItemInfoCompat(new AccessibilityNodeInfo.CollectionItemInfo.Builder().setHeading(z9).setColumnIndex(i).setRowIndex(i6).setColumnSpan(i10).setRowSpan(i11).setSelected(z10).setRowTitle(str).setColumnTitle(str2).build());
        }

        @DoNotInline
        public static AccessibilityNodeInfoCompat getChild(AccessibilityNodeInfo accessibilityNodeInfo, int i, int i6) {
            return AccessibilityNodeInfoCompat.wrapNonNullInstance(accessibilityNodeInfo.getChild(i, i6));
        }
    ...
    public static class Api34Impl {
        ...
        @DoNotInline
        public static void setAccessibilityDataSensitive(AccessibilityNodeInfo accessibilityNodeInfo, boolean z9) {
        ...
        @DoNotInline
        public static void setQueryFromAppProcessEnabled(AccessibilityNodeInfo accessibilityNodeInfo, View view, boolean z9) {
            accessibilityNodeInfo.setQueryFromAppProcessEnabled(view, z9);
        }

        @DoNotInline
        public static void setRequestInitialAccessibilityFocus(AccessibilityNodeInfo accessibilityNodeInfo, boolean z9) {
    ...
    private void setBooleanProperty(int i, boolean z9) {
        Bundle extras = getExtras();
        if (extras != null) {
            int i6 = extras.getInt(BOOLEAN_PROPERTY_KEY, 0) & (~i);
            if (!z9) {
                i = 0;
            }
    ...
    @Nullable
    public AccessibilityNodeInfoCompat getChild(int i, int i6) {
        return Build.VERSION.SDK_INT >= 33 ? Api33Impl.getChild(this.mInfo, i, i6) : getChild(i);
    }
    ...
    public CharSequence getHintText() {
        int i = Build.VERSION.SDK_INT;
        AccessibilityNodeInfo accessibilityNodeInfo = this.mInfo;
        return i >= 26 ? accessibilityNodeInfo.getHintText() : accessibilityNodeInfo.getExtras().getCharSequence(HINT_TEXT_KEY);
    }
    ...
    public void setAccessibilityDataSensitive(boolean z9) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setAccessibilityDataSensitive(this.mInfo, z9);
        } else {
            setBooleanProperty(64, z9);
        }
    }
    ...
    public void setGranularScrollingSupported(boolean z9) {
        setBooleanProperty(67108864, z9);
    }
    ...
    public void setQueryFromAppProcessEnabled(@NonNull View view, boolean z9) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setQueryFromAppProcessEnabled(this.mInfo, view, z9);
        }
    }
    ...
    public void setRequestInitialAccessibilityFocus(boolean z9) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setRequestInitialAccessibilityFocus(this.mInfo, z9);
        } else {
            setBooleanProperty(32, z9);
        }
    }
    ...
    public void setTextSelectable(boolean z9) {
        if (Build.VERSION.SDK_INT >= 33) {
            Api33Impl.setTextSelectable(this.mInfo, z9);
        } else {
            setBooleanProperty(8388608, z9);
        }
    }

    public void setTextSelection(int i, int i6) {
        this.mInfo.setTextSelection(i, i6);
    }
    ...
    public static class CollectionInfoCompat {
        ...
        public static CollectionInfoCompat obtain(int i, int i6, boolean z9, int i10) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i, i6, z9, i10));
        }
        ...
        public static CollectionInfoCompat obtain(int i, int i6, boolean z9) {
            return new CollectionInfoCompat(AccessibilityNodeInfo.CollectionInfo.obtain(i, i6, z9));
        }
    }
    ...
    public static class CollectionItemInfoCompat {
        ...
        public static final class Builder {
            ...
            @NonNull
            public Builder setHeading(boolean z9) {
                this.mHeading = z9;
                return this;
            }
            ...
            @NonNull
            public Builder setSelected(boolean z9) {
                this.mSelected = z9;
                return this;
            }
        }
        ...
        public static CollectionItemInfoCompat obtain(int i, int i6, int i10, int i11, boolean z9, boolean z10) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i, i6, i10, i11, z9, z10));
        }
        ...
        public static CollectionItemInfoCompat obtain(int i, int i6, int i10, int i11, boolean z9) {
            return new CollectionItemInfoCompat(AccessibilityNodeInfo.CollectionItemInfo.obtain(i, i6, i10, i11, z9));
        }
    }
    ...
    public static final class TouchDelegateInfoCompat {
        ...
        @Nullable
        public Region getRegionAt(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY) int i) {
            if (Build.VERSION.SDK_INT >= 29) {
    ...
    public static class RangeInfoCompat {
        ...
        public RangeInfoCompat(int i, float f, float f10, float f11) {
            if (Build.VERSION.SDK_INT >= 30) {
                this.mInfo = Api30Impl.createRangeInfo(i, f, f10, f11);
            } else {
                this.mInfo = AccessibilityNodeInfo.RangeInfo.obtain(i, f, f10, f11);
            }
        }

        public static RangeInfoCompat obtain(int i, float f, float f10, float f11) {
            return new RangeInfoCompat(AccessibilityNodeInfo.RangeInfo.obtain(i, f, f10, f11));
        }
