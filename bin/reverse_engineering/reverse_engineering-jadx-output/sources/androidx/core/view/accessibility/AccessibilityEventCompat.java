...
public final class AccessibilityEventCompat {
    ...
    public static class Api34Impl {
        ...
        @DoNotInline
        public static void setAccessibilityDataSensitive(AccessibilityEvent accessibilityEvent, boolean z9) {
    ...
    public static void setAccessibilityDataSensitive(@NonNull AccessibilityEvent accessibilityEvent, boolean z9) {
        if (Build.VERSION.SDK_INT >= 34) {
            Api34Impl.setAccessibilityDataSensitive(accessibilityEvent, z9);
        }
    }
