...
public class NotificationChannelCompat {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static void enableLights(NotificationChannel notificationChannel, boolean z9) {
            notificationChannel.enableLights(z9);
        }

        @DoNotInline
        public static void enableVibration(NotificationChannel notificationChannel, boolean z9) {
        ...
        @DoNotInline
        public static void setShowBadge(NotificationChannel notificationChannel, boolean z9) {
    ...
    public static class Builder {
        ...
        public Builder setVibrationEnabled(boolean z9) {
            this.mChannel.mVibrationEnabled = z9;
            return this;
        }
