...
class NotificationCompatBuilder implements NotificationBuilderWithBuilderAccessor {
    ...
    public static class Api20Impl {
        ...
        @DoNotInline
        public static Notification.Builder setGroupSummary(Notification.Builder builder, boolean z9) {
            return builder.setGroupSummary(z9);
        }

        @DoNotInline
        public static Notification.Builder setLocalOnly(Notification.Builder builder, boolean z9) {
    ...
    public static class Api26Impl {
        ...
        @DoNotInline
        public static Notification.Builder setColorized(Notification.Builder builder, boolean z9) {
    ...
    public static class Api29Impl {
        ...
        @DoNotInline
        public static Notification.Builder setAllowSystemGeneratedContextualActions(Notification.Builder builder, boolean z9) {
        ...
        @DoNotInline
        public static Notification.Action.Builder setContextual(Notification.Action.Builder builder, boolean z9) {
    ...
    public NotificationCompatBuilder(NotificationCompat.Builder builder) {
        ...
        if (style instanceof NotificationCompat.CallStyle) {
            ...
            int i10 = 0;
            while (i10 < size) {
                NotificationCompat.Action action = actionsListWithSystemActions.get(i10);
                i10++;
                addAction(action);
            }
        } else {
            ...
            int i11 = 0;
            while (i11 < size2) {
                NotificationCompat.Action action2 = arrayList.get(i11);
                i11++;
                addAction(action2);
            }
        }
        ...
        if (i14 >= 31 && (i = builder.mFgsDeferBehavior) != 0) {
