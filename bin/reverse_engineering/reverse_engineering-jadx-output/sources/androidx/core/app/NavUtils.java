...
public final class NavUtils {
    ...
    public static void navigateUpFromSameTask(@NonNull Activity activity) {
        ...
        if (parentActivityIntent != null) {
            ...
            a3.b.q(activity.getClass().getSimpleName(), "Activity ", " does not have a parent activity name specified. (Did you forget to add the android.support.PARENT_ACTIVITY <meta-data>  element in your manifest?)");
        }
    }
