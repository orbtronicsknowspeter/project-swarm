...
public abstract class JobIntentService extends Service {
    ...
    public static void enqueueWork(@NonNull Context context, @NonNull ComponentName componentName, int i, @NonNull Intent intent) {
        if (intent == null) {
            com.google.gson.internal.a.p("work must not be null");
            return;
        }
        synchronized (sLock) {
    ...
    public static WorkEnqueuer getWorkEnqueuer(Context context, ComponentName componentName, boolean z9, int i) {
        ...
        if (Build.VERSION.SDK_INT < 26) {
            ...
            if (!z9) {
                com.google.gson.internal.a.p("Can't be here without a job id");
                return null;
            }
    ...
    public static abstract class WorkEnqueuer {
        ...
        public void ensureJobId(int i) {
            if (!this.mHasJobId) {
                ...
                StringBuilder sbP = x.p(i, "Given job ID ", " is different than previous ");
                sbP.append(this.mJobId);
