...
public final class c {
    ...
    public final int a() {
        ...
        int iCurrentTimeMillis = (int) ((System.currentTimeMillis() - this.f4831k) / this.f4828c);
        int size = this.f.size();
        int i = this.j;
        int iMin = size == this.f4830e ? Math.min(100, i + iCurrentTimeMillis) : Math.max(0, i - iCurrentTimeMillis);
        if (this.j != iMin) {
            this.j = iMin;
            this.f4831k = System.currentTimeMillis();
        }
        ...
        this.h.o(new o.a(bVar.f11604a, o.d.f8128l, null), new g() { // from class: f2.b
            ...
            public final void a(Exception exc) throws Throwable {
                ...
                if (z9) {
                    ...
                    new Thread(new androidx.browser.trusted.c(12, this.f4822a, countDownLatch)).start();
