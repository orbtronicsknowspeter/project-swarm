...
public final class h extends RecyclerView.Adapter {
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 1) {
            View viewB = j.b(viewGroup, 2131558668, viewGroup, false);
            viewB.getClass();
            return new c(viewB, num2, num, aVar);
        }
        if (i == 2) {
            View viewB2 = j.b(viewGroup, 2131558669, viewGroup, false);
            viewB2.getClass();
            return new d(viewB2, num2, num, this.i);
        }
        if (i == 3) {
            View viewB3 = j.b(viewGroup, 2131558665, viewGroup, false);
            viewB3.getClass();
            return new a(viewB3, num2, num, aVar);
        }
        View viewB4 = j.b(viewGroup, 2131558667, viewGroup, false);
        viewB4.getClass();
