...
public final class a implements ListIterator, e7.a {
    ...
    public a(c cVar, int i) {
        this.f8913n = cVar;
        this.f8910b = i;
        this.f8912m = ((AbstractList) cVar).modCount;
    }

    public void a() {
        if (((AbstractList) ((b) this.f8913n).f8918n).modCount == this.f8912m) {
            return;
        }
        a3.b.i();
    }
    ...
    public final void add(Object obj) {
        switch (this.f8909a) {
            case 0:
                ...
                bVar.add(i, obj);
                this.f8911l = -1;
                this.f8912m = ((AbstractList) bVar).modCount;
                break;
            default:
                c();
    ...
    public void c() {
        if (((AbstractList) ((c) this.f8913n)).modCount == this.f8912m) {
            return;
        }
        a3.b.i();
    }
