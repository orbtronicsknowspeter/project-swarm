...
public final class c extends p9.a implements c.b {
    ...
    public final String a() {
        ...
        String strValueOf = String.valueOf(dVar.f9336c.f10710a.size() + arrayList.size() + size + (dVar.f9337d != null ? 1 : 0));
        d dVar2 = this.O;
        if (dVar2 == null) {
            l.i("viewModel");
            throw null;
        }
        String strO0 = u.o0(dVar2.f.e().f5560b, "${partners}", strValueOf, true);
    ...
    public final void e(c.i iVar) {
        ...
        if (activity != null && (dVar instanceof e) && activity.getSupportFragmentManager().findFragmentByTag("k") == null) {
            ...
            d dVar3 = this.O;
            if (dVar3 != null) {
                fragmentTransactionBeginTransaction.add(d0.b.f(str, strA, strB, str2, dVar3.f.e().f5567n, dVar.f5465a, iVar.f1163d, false, 1), "k").commit();
            } else {
                l.i("viewModel");
                throw null;
            }
    ...
    public final void f(c.i iVar) {
        ...
        if (dVar instanceof f) {
            ...
            strValueOf.getClass();
            q.f5066b.h("Purposes_" + i, strValueOf);
            return;
        }
        if (dVar instanceof h8.b) {
            ...
            q.f5066b.h("Special Features_" + i6, strValueOf2);
        }
    }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View viewInflate = layoutInflater.inflate(2131558516, viewGroup, false);
