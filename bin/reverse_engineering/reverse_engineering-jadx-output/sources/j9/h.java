...
public final class h {
    ...
    public final void a() throws w5.e, NoSuchAlgorithmException {
        ...
        try {
            ...
            aVarC.h("tcfeuv2", "CmpId", Integer.valueOf(mVar.f10744m));
            aVarC.h("tcfeuv2", "CmpVersion", Integer.valueOf(mVar.f10745n));
            aVarC.h("tcfeuv2", "ConsentScreen", Integer.valueOf(mVar.j));
            aVarC.h("tcfeuv2", "ConsentLanguage", mVar.f10743l);
            h8.c cVar2 = mVar.f10737a;
            Integer num = cVar2 == null ? null : cVar2.f5460b;
            aVarC.h("tcfeuv2", "VendorListVersion", Integer.valueOf(num == null ? mVar.f10746o : num.intValue()));
            aVarC.h("tcfeuv2", "PolicyVersion", Integer.valueOf(mVar.d()));
            aVarC.h("tcfeuv2", "IsServiceSpecific", Boolean.valueOf(mVar.f10741e));
            aVarC.h("tcfeuv2", "UseNonStandardStacks", Boolean.valueOf(mVar.f));
            aVarC.h("tcfeuv2", "SpecialFeatureOptins", t1.e(12, mVar.f10748q));
            aVarC.h("tcfeuv2", "PurposeConsents", t1.e(24, mVar.f10749r));
            aVarC.h("tcfeuv2", "PurposeLegitimateInterests", t1.e(24, mVar.f10750s));
            aVarC.h("tcfeuv2", "PurposeOneTreatment", Boolean.valueOf(mVar.g));
            aVarC.h("tcfeuv2", "PublisherCountryCode", mVar.h);
            aVarC.h("tcfeuv2", "VendorConsents", q6.l.G0(mVar.f10756z.getAcceptedItems()));
            ...
            for (Map.Entry entry : mVar.G.f10720c.entrySet()) {
                ...
                u5.g gVarB = z3.b(str);
                arrayList.add(new o3.f(q6.l.G0(set), gVarB.f10716a, gVarB.f10717b.f10726a));
            }
            List list2 = r3.f.f8864a;
            aVarC.h("tcfeuv2", "PublisherRestrictions", arrayList);
            aVarC.h("tcfeuv2", "PublisherConsents", t1.e(24, mVar.v));
            aVarC.h("tcfeuv2", "PublisherLegitimateInterests", t1.e(24, mVar.f10753w));
            int i6 = mVar.f10747p;
            aVarC.h("tcfeuv2", "NumCustomPurposes", Integer.valueOf(i6));
            aVarC.h("tcfeuv2", "PublisherCustomConsents", t1.e(i6, mVar.f10754x));
            aVarC.h("tcfeuv2", "PublisherCustomLegitimateInterests", t1.e(i6, mVar.f10755y));
            ...
            if (zonedDateTime != null) {
                ...
                aVarC.h("tcfeuv2", "LastUpdated", mVar.f10740d);
            }
            m9.c.i = aVarC;
        ...
        String strC4 = d0.b.c(mVar.f10756z);
        String strC5 = d0.b.c(mVar.C);
        String strC6 = d0.b.c(mVar.f10749r);
        String strC7 = d0.b.c(mVar.f10750s);
        String strC8 = d0.b.c(mVar.f10748q);
        String string = mVar.G.f10720c.toString();
        String strC9 = d0.b.c(mVar.v);
        String strC10 = d0.b.c(mVar.f10753w);
        String strC11 = d0.b.c(mVar.f10754x);
        String strC12 = d0.b.c(mVar.f10755y);
