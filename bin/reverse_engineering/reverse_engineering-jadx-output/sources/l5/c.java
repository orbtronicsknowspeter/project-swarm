...
public final class c extends w3.a {
    ...
    public c(View view, v3.e eVar) {
        eVar.getClass();
        this.f7130a = view;
        View viewFindViewById = view.findViewById(2131364636);
        viewFindViewById.getClass();
        View viewFindViewById2 = view.findViewById(2131362450);
        viewFindViewById2.getClass();
        ImageView imageView = (ImageView) viewFindViewById2;
        this.f7131b = imageView;
        View viewFindViewById3 = view.findViewById(2131362449);
        viewFindViewById3.getClass();
        this.f7132c = (ImageView) viewFindViewById3;
