...
public final class e0 extends a {
    ...
    public final void k(c8.c cVar, int i, Map map, boolean z9) {
        ...
        map.getClass();
        Object objDecodeSerializableElement = cVar.decodeSerializableElement(getDescriptor(), i, this.f3635a, null);
        if (z9) {
    ...
    public final void serialize(c8.f fVar, Object obj) {
        ...
        while (itD.hasNext()) {
            ...
            int i6 = i + 1;
            dVarBeginCollection.encodeSerializableElement(getDescriptor(), i, this.f3635a, key);
            i += 2;
            dVarBeginCollection.encodeSerializableElement(getDescriptor(), i6, this.f3636b, value);
        }
