...
public final class t implements Collection, e7.a {
    ...
    public final boolean equals(Object obj) {
        if (obj instanceof t) {
            return this.f8459a.equals(((t) obj).f8459a);
        }
        return false;
    }
    ...
    public final boolean isEmpty() {
        return this.f8459a.length == 0;
    }

    @Override // java.util.Collection, java.lang.Iterable
    public final Iterator iterator() {
        return new kotlin.jvm.internal.b(this.f8459a, 3);
    }
    ...
    public final String toString() {
        return "ULongArray(storage=" + Arrays.toString(this.f8459a) + ')';
    }
