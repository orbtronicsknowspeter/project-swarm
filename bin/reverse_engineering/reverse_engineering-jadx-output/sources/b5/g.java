        ...
        switch (i) {
            case 0:
                ...
                if (i6 == 0) {
                    ...
                    this.f1023b = 1;
                    v7.e eVar = m0.f8288a;
                    Object objC = c0.C(new f(0, mVar, vVar, null), v7.d.f10884a, this);
                    if (objC == aVar) {
                    }
                } else if (i6 != 1) {
            ...
            case 1:
                ...
                if (i10 == 0) {
                    ...
                    Object objC2 = c0.C(new f(1, mVar, vVar, null), v7.d.f10884a, this);
                    if (objC2 == aVar) {
                    }
                } else if (i10 != 1) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("call to 'resume' before 'invoke' with coroutine");
            ...
            case 2:
                ...
                if (i11 == 0) {
                    ...
                    Object objC3 = c0.C(new k(vVar, mVar, (t6.c) null), v7.d.f10884a, this);
                    if (objC3 == aVar) {
                    }
                } else if (i11 != 1) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("call to 'resume' before 'invoke' with coroutine");
            ...
            default:
                ...
                if (i12 == 0) {
                    ...
                    Object objC4 = c0.C(new k(mVar, vVar, (t6.c) null), v7.d.f10884a, this);
                    if (objC4 == aVar) {
                    }
                } else if (i12 != 1) {
                    androidx.privacysandbox.ads.adservices.customaudience.a.i("call to 'resume' before 'invoke' with coroutine");
