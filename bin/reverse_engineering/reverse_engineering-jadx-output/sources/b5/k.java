    ...
    public final Object invokeSuspend(Object obj) {
        ...
        switch (i) {
            case 0:
                ...
                g2 g2VarP = vVar.p(jVar.f11224a, 10, 0);
                if (!g2VarP.b() && (str = g2VarP.f11203a) != null && str.length() != 0) {
                    ArrayList arrayListE = v.E(g2VarP);
                    try {
                        string = ((Context) mVar.f1061b).getString(2131952639);
                        string.getClass();
                    } catch (Exception e10) {
                        e10.printStackTrace();
                        string = "The latest";
            ...
            default:
                ...
                if (!g2VarT.b() && g2VarT.f11206d != null) {
                    ArrayList arrayListE2 = v.E(g2VarT);
                    try {
                        string2 = ((Context) mVar.f1061b).getString(2131952657);
                        string2.getClass();
                    } catch (Exception e11) {
                        e11.printStackTrace();
