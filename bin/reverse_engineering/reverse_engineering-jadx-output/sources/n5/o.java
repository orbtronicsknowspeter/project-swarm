...
public final class o {
    ...
    public final View f8102b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final HashMap f8103c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public final p f8104d;
    ...
    public final void a() {
        ...
        View viewInflate = LayoutInflater.from(context).inflate(2131558858, (ViewGroup) null, false);
        if (((RecyclerView) ViewBindings.findChildViewById(viewInflate, 2131363082)) == null) {
            com.google.gson.internal.a.i("Missing required view with ID: ".concat(viewInflate.getResources().getResourceName(2131363082)));
            return;
        }
        ...
        if (z9) {
            ...
            linearLayout.startAnimation(AnimationUtils.loadAnimation(context, 2130772027));
            linearLayout.setVisibility(0);
        } else {
            linearLayout.setVisibility(0);
        }
        View viewFindViewById = linearLayout.findViewById(2131363082);
        viewFindViewById.getClass();
        RecyclerView recyclerView = (RecyclerView) viewFindViewById;
        n nVar = new n(this.f8103c, new k(this, popupWindow));
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() { // from class: n5.l
            ...
            public final void onDismiss() {
                Context context2 = this.f8096a.f8101a;
                ...
                linearLayout2.startAnimation(AnimationUtils.loadAnimation(context2, 2130772000));
                linearLayout2.setVisibility(8);
            }
        });
    }
