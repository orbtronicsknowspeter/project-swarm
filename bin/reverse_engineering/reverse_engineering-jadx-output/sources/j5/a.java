...
public final class a {
    ...
    */
    ...
    public static x4.e h(Context context, String str) {
        ...
        context.getClass();
        synchronized (UptodownApp.f3298l0) {
            x4.e eVarG = null;
            if (str == null) {
                return null;
            }
            ...
            while (it2.hasNext()) {
                ...
                if (packageInfoE != null) {
                    ...
                    while (true) {
                        ...
                        it = it2;
                        i = 0;
                        if (l7.u.m0(eVar2.f11123l, applicationInfo.packageName, false)) {
                            eVar = eVar2;
                            break;
                        }
                        i6 = 0;
    ...
    public static void j(x4.e eVar, PackageInfo packageInfo, Context context) {
        ...
        if (z9) {
            ...
            String strReplaceAll = eVar.f11136z;
