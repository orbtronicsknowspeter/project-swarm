...
public class r extends a {
    ...
    public final c8.c beginStructure(b8.e eVar) {
        ...
        if (kVarC instanceof e8.t) {
            return new r(this.f4926c, (e8.t) kVarC, this.f4927d, eVar2);
        }
    ...
    public void endStructure(b8.e eVar) {
        ...
        for (String str : q().f4784a.keySet()) {
            if (!setZ.contains(str) && !kotlin.jvm.internal.l.a(str, this.f4927d)) {
    ...
    public String n(b8.e eVar, int i) {
        ...
        if (this.f4928e.f4773d && !q().f4784a.keySet().contains(strF)) {
            a3.d dVar = bVar.f4763c;
