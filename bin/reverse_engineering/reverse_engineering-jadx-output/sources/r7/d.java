...
public class d implements s7.i {
    ...
    */
    ...
    public final Object b(i iVar, t6.c cVar) {
        ...
        return objI == u6.a.f10762a ? objI : p6.x.f8463a;
    }
    ...
    public Object c(q7.s sVar, t6.c cVar) {
        switch (this.f8966m) {
            case 0:
                Object objInvoke = ((v6.i) this.f8967n).invoke(sVar, cVar);
                return objInvoke == u6.a.f10762a ? objInvoke : p6.x.f8463a;
            case 1:
                Object objCollect = ((h) this.f8967n).collect(new s7.o(sVar), cVar);
