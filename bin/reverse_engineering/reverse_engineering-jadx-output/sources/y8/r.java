...
public final class r extends d9.a {
    ...
    public final b9.s f11884a = new b9.s();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final n f11885b = new n();
    ...
    */
    ...
    @Override // d9.a
    public final void c() {
        if (this.f11885b.f11872b.length() == 0) {
            this.f11884a.f();
        }
    }
    ...
    public final void f(m mVar) {
        StringBuilder sb = this.f11885b.f11872b;
        if (sb.length() > 0) {
            mVar.f(sb.toString(), this.f11884a);
        }
    }
