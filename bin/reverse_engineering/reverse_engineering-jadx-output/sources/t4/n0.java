...
public final class n0 implements ViewBinding, k4.a, w4.o, t.b, w1.b, w1.a {
    ...
    public Method b(Class cls) {
        ...
        Class cls2;
        try {
            method = cls.getMethod((String) this.f10014b, (Class[]) this.f10015l);
        ...
        if (method == null || (cls2 = (Class) this.f10013a) == null || cls2.isAssignableFrom(method.getReturnType())) {
            return method;
        }
        return null;
    }
    ...
    public void e(r.p pVar, int i, boolean z9) {
        ...
        SQLiteDatabase sQLiteDatabaseB = ((y.h) ((y.d) this.f10014b)).b();
