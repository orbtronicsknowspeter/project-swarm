...
public final class a2 extends RecyclerView.OnScrollListener {
    ...
    public final void onScrollStateChanged(RecyclerView recyclerView, int i) {
        ...
        if (i == 0) {
            ...
            int i6 = m1Var.f4633k;
            if (iFindLastCompletelyVisibleItemPosition == linearLayoutManager.getItemCount() - 1 && iFindLastCompletelyVisibleItemPosition != m1Var.f4633k) {
                m1Var.f4633k = iFindLastCompletelyVisibleItemPosition;
                ArrayList arrayList = ((x4.g) m1Var.f4632e.get(i6)).Y;
                if (arrayList != null && !arrayList.isEmpty()) {
                    m1Var.notifyItemChanged(i6);
                }
                ArrayList arrayList2 = ((x4.g) m1Var.f4632e.get(iFindLastCompletelyVisibleItemPosition)).Y;
            ...
            if (iFindFirstCompletelyVisibleItemPosition == -1 || iFindFirstCompletelyVisibleItemPosition == m1Var.f4633k) {
                return;
            }
            m1Var.f4633k = iFindFirstCompletelyVisibleItemPosition;
            ArrayList arrayList3 = ((x4.g) m1Var.f4632e.get(i6)).Y;
            if (arrayList3 != null && !arrayList3.isEmpty()) {
                m1Var.notifyItemChanged(i6);
            }
            ArrayList arrayList4 = ((x4.g) m1Var.f4632e.get(iFindFirstCompletelyVisibleItemPosition)).Y;
