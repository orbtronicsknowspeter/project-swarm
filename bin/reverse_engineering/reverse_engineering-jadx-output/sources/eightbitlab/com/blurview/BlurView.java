...
public class BlurView extends FrameLayout {
    ...
    public final void a(AttributeSet attributeSet, int i) {
        TypedArray typedArrayObtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, e.f10300a, i, 0);
        this.f4793b = typedArrayObtainStyledAttributes.getColor(0, 0);
        typedArrayObtainStyledAttributes.recycle();
    }

    public final d b(ViewGroup viewGroup) {
        this.f4792a.destroy();
        d dVar = new d(this, viewGroup, this.f4793b, getBlurAlgorithm());
        this.f4792a = dVar;
        return dVar;
    }
