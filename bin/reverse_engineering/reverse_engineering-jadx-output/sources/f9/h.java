...
public final class h {
    ...
    public static b a(d dVar) {
        ...
        if (i10 == 0) {
            ...
            aVar3.getClass();
            boolValueOf = Boolean.valueOf(aVar3.f7262a.getBoolean(k0.k.b(i10), false));
        }
        ...
        if (i11 != 0) {
            ...
            aVar4.getClass();
            boolValueOf2 = Boolean.valueOf(aVar4.f7262a.getBoolean(k0.k.b(i11), false));
        }
        ...
        aVar5.getClass();
        return new b(strJ, strJ2, boolValueOf, bool, aVar5.f7262a.getBoolean(k0.k.b(i12), false));
    }
    ...
    */
    ...
    public final String f(String str) {
        ...
        if (zA) {
            List listD0 = q6.m.d0(mVar.D.getMap().values(), mVar.C.getMap().values(), mVar.f10750s.getMap().values());
            ...
            Collection<Boolean> collectionValues = mVar.f10749r.getMap().values();
    ...
    public final void g(int i, i iVar, d dVar) {
        ...
        sb.append('-');
        String string = q.f5065a.toString();
        string.getClass();
        sb.append(string);
