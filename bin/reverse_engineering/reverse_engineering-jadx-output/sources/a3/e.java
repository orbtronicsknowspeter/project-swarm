...
public final /* synthetic */ class e implements s1.d, CallbackToFutureAdapter.Resolver, OnActionClickedListener, s2.a, z.b, f, j1.d, j1.a {
    ...
    public Object apply(Object obj) {
        ...
        ArrayList arrayListE = hVar.e(sQLiteDatabase, jVar, aVar.f11575b);
        for (o.d dVar : o.d.values()) {
            if (dVar != jVar.f8833c) {
                int size = aVar.f11575b - arrayListE.size();
                if (size <= 0) {
                    break;
                }
        ...
        for (int i = 0; i < arrayListE.size(); i++) {
            sb.append(((y.b) arrayListE.get(i)).f11579a);
        ...
        while (listIterator.hasNext()) {
            ...
            if (map.containsKey(Long.valueOf(j6))) {
                r.h hVarC = bVar.f11581c.c();
                for (g gVar : (Set) map.get(Long.valueOf(j6))) {
                    hVarC.a(gVar.f11584a, gVar.f11585b);
                }
                listIterator.set(new y.b(j6, bVar.f11580b, hVarC.b()));
            }
        }
        return arrayListE;
    }
