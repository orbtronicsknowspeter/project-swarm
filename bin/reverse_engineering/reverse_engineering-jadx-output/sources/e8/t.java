...
public final class t extends k implements Map<String, k>, e7.a, j$.util.Map {
    ...
    public final boolean containsKey(Object obj) {
        ...
        return this.f4784a.containsKey((String) obj);
    }
    ...
    public final boolean containsValue(Object obj) {
        ...
        return this.f4784a.containsValue((k) obj);
    }

    @Override // java.util.Map
    public final Set<Map.Entry<String, k>> entrySet() {
        return this.f4784a.entrySet();
    }

    @Override // java.util.Map
    public final boolean equals(Object obj) {
        return kotlin.jvm.internal.l.a(this.f4784a, obj);
    }
    ...
    public final k get(Object obj) {
        ...
        return (k) this.f4784a.get((String) obj);
    }
    ...
    public final String toString() {
        return q6.l.x0(this.f4784a.entrySet(), ",", "{", "}", new androidx.room.f(25), 24);
    }

    @Override // java.util.Map
    public final Collection<k> values() {
        return this.f4784a.values();
    }
