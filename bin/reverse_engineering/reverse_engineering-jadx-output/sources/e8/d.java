...
public final class d extends k implements List<k>, e7.a, j$.util.List {
    ...
    public final boolean contains(Object obj) {
        ...
        return this.f4764a.contains((k) obj);
    }

    @Override // java.util.List, java.util.Collection
    public final boolean containsAll(Collection collection) {
        collection.getClass();
        return this.f4764a.containsAll(collection);
    }

    @Override // java.util.List, java.util.Collection
    public final boolean equals(Object obj) {
        return kotlin.jvm.internal.l.a(this.f4764a, obj);
    }
    ...
    public final int indexOf(Object obj) {
        ...
        return this.f4764a.indexOf((k) obj);
    }

    @Override // java.util.List, java.util.Collection
    public final boolean isEmpty() {
        return this.f4764a.isEmpty();
    }
    ...
    public final int lastIndexOf(Object obj) {
        ...
        return this.f4764a.lastIndexOf((k) obj);
    }

    @Override // java.util.List
    public final ListIterator<k> listIterator() {
        return this.f4764a.listIterator();
    }
    ...
    public final List<k> subList(int i, int i6) {
        return this.f4764a.subList(i, i6);
    }
    ...
    public final String toString() {
        return q6.l.x0(this.f4764a, ",", "[", "]", null, 56);
    }

    @Override // java.util.List
    public final ListIterator<k> listIterator(int i) {
        return this.f4764a.listIterator(i);
    }
