...
public final class t {
    ...
    public final int b(u uVar, String str) throws EOFException {
        ...
        char c12 = '#';
        if (i12 >= 2 || uVar == null || !uVar.f7792a.equals(this.f7787a)) {
            int i13 = iQ + i12;
            boolean z9 = false;
            boolean z10 = false;
            while (true) {
                ...
                if (bCharAt != 64) {
                    ...
                    if (z9) {
                        ...
                        if (z10) {
                            strA = a4.x.o(new StringBuilder(), this.f7788b, "%40", strA);
                        }
                        this.f7788b = strA;
                        if (iH != iG) {
                            int i14 = iH + 1;
                            i10 = iG;
                            this.f7789c = u.a(str, i14, i10, " \"':;<=>@[]^`{}|/\\?#", true, false, false, true);
                            z9 = true;
                        } else {
                            i10 = iG;
                        }
            ...
            int i17 = i16 + 1;
            if (i17 < iG) {
                this.f7790d = n8.c.b(u.h(str2, i15, i16, false));
                try {
            ...
            this.f7788b = uVar.f();
            this.f7789c = uVar.c();
            this.f7790d = uVar.f7795d;
            this.f7791e = uVar.f7796e;
            arrayList4.clear();
