...
public final class OrganizationActivity extends k0 {
    ...
    public final void b0(d0 d0Var) {
        ...
        e eVar = m0.f8288a;
        c0.s(lifecycleScope, n.f10348a, null, new a(rVarA, this, null, 18), 2);
    }
    ...
    public final void onCreate(Bundle bundle) {
        ...
        RelativeLayout relativeLayout = y0().f9686a;
        relativeLayout.getClass();
        setContentView(relativeLayout);
        Drawable drawable = ContextCompat.getDrawable(this, 2131230922);
        final t4.d0 d0VarY0 = y0();
        if (drawable != null) {
            d0VarY0.f9696t.setNavigationIcon(drawable);
            d0VarY0.f9696t.setNavigationContentDescription(getString(2131951735));
        }
        Toolbar toolbar = d0VarY0.f9696t;
        RecyclerView recyclerView = d0VarY0.f9694r;
        TextView textView = d0VarY0.f9699x;
        ...
        d0VarY0.f9695s.getViewTreeObserver().addOnScrollChangedListener(new ViewTreeObserver.OnScrollChangedListener() { // from class: c4.i6
            ...
            public final void onScrollChanged() {
                ...
                ScrollView scrollView = d0VarY0.f9695s;
                ...
                o7.c0.s(viewModelScope, v7.d.f10884a, null, new b6.a(n6VarZ0, organizationActivity, null, 20), 2);
            }
        });
        c0.s(LifecycleOwnerKt.getLifecycleScope(this), n.f10348a, null, new s(this, cVar, 10), 2);
        n6 n6VarZ0 = z0();
        n6VarZ0.getClass();
        a0 viewModelScope = ViewModelKt.getViewModelScope(n6VarZ0);
        e eVar = m0.f8288a;
        c0.s(viewModelScope, v7.d.f10884a, null, new a(n6VarZ0, this, cVar, 19), 2);
    }
