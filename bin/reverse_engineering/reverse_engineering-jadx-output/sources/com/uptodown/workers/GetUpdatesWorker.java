...
public final class GetUpdatesWorker extends CoroutineWorker {
    ...
    public static final void b(GetUpdatesWorker getUpdatesWorker, JSONObject jSONObject) {
        ...
        while (it.hasNext()) {
            Object next = it.next();
            next.getClass();
            if (u.m0(context.getPackageName(), ((q2) next).f11344b, true)) {
                z9 = true;
            }
        }
        ...
        while (it2.hasNext()) {
            ...
            while (true) {
                ...
                next3.getClass();
                if (u.m0(str, ((q2) next3).f11344b, true)) {
                    break;
                }
            }
        }
        ...
        if (z3.p(context, "is_status_code_526", false)) {
            if (o.a(context)) {
                ...
                String string = context.getString(2131952378);
                string.getClass();
                builder.setContentTitle(string);
                String string2 = context.getString(2131951945);
                string2.getClass();
        ...
        if (z9) {
            ...
            gVarL.c();
            r rVar = q2VarY != null ? q2VarY.f11352s : null;
            if (rVar == null || !rVar.c()) {
                UptodownApp.f3289c0.send(TypedValues.MotionType.TYPE_QUANTIZE_INTERPOLATOR, null);
                return;
            }
            ...
            try {
                ...
                cursorQuery = sQLiteDatabase.query("notifications", gVarL2.f6682s, "actions=?", new String[]{"update_uptodown"}, null, null, "id DESC");
                try {
            ...
            gVarL2.c();
            if ((s1Var != null ? s1Var.f11385b : null) == null || rVar.F.isEmpty() || ((j0) rVar.F.get(0)).f11240q == null) {
                return;
            }
            String str2 = ((j0) rVar.F.get(0)).f11240q;
            str2.getClass();
            File file = new File(str2);
            if (file.exists()) {
                String str3 = s1Var.f11385b;
                str3.getClass();
    ...
    public final void c(q2 q2Var) {
        ...
        arrayList2.getClass();
        ArrayList arrayListC = x4.p.c(this.f3482a, arrayList2);
