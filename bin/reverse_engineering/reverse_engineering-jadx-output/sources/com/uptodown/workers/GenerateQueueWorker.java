    ...
    public final ListenableWorker.Result doWork() {
        ...
        if (!d.p(context, "DownloadUpdatesWorker")) {
            ...
            while (true) {
                ...
                next.getClass();
                q2 q2Var = (q2) next;
                e eVarH = a.h(context2, q2Var.f11344b);
                if (eVarH != null) {
                    if (!u.m0(packageName, eVarH.f11123l, true) && str == null) {
                        if (!zF) {
                            Context context3 = this.f3478a;
                            if (eVarH.F > 0 && eVarH.v == 0 && eVarH.b(context3)) {
                                String str2 = eVarH.f11123l;
                            ...
                            if (!rVarA.F.isEmpty()) {
                                ...
                                if (arrayList3 == null || !arrayList3.isEmpty()) {
                                    ...
                                    while (i < size) {
                                        ...
                                        i++;
                                        j0 j0Var = (j0) obj;
                                        int i6 = (j0Var.f11241r < i6 && System.currentTimeMillis() > j0Var.f11242s) ? 4 : 4;
                                    }
                                }
                            }
                        }
            ...
            while (true) {
                if (i10 < size2) {
                    if (u.m0(packageName, ((e) arrayList.get(i10)).f11123l, true) && ((e) arrayList.get(i10)).f11127p == x4.d.f11087a) {
