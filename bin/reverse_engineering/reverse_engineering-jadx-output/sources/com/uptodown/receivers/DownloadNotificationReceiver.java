            ...
            switch (action.hashCode()) {
                case -1919974852:
                    if (action.equals("CANCEL_ALL") && (intExtra = intent.getIntExtra("notificationID", -1)) == 261 && context != null) {
                        ...
                        gVarL.c();
                        if (rVarB2 != null && (str = rVarB2.f11355b) != null && str.length() != 0) {
                            String str3 = rVarB2.f11355b;
                            str3.getClass();
                            r rVarB3 = b.b();
                            if (l.a(rVarB3 != null ? rVarB3.f11355b : null, str3)) {
                                b.f();
                            } else {
                                c.d();
                            }
                ...
                case 75902422:
                    ...
                    break;
                case 1980572282:
                    if (action.equals("CANCEL") && (intExtra2 = intent.getIntExtra("notificationID", -1)) == 261 && (rVarB = b.b()) != null && (str2 = rVarB.f11355b) != null && str2.length() != 0) {
                        String str4 = rVarB.f11355b;
                        str4.getClass();
                        r rVarB4 = b.b();
                        if (l.a(rVarB4 != null ? rVarB4.f11355b : null, str4)) {
                            b.f();
                        } else {
                            c.d();
                        }
