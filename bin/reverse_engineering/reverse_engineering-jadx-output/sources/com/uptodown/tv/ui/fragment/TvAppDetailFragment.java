...
public final class TvAppDetailFragment extends DetailsSupportFragment {
    ...
    public TvAppDetailFragment() {
        ...
        this.f3426x = activityResultLauncherRegisterForActivityResult;
    }
    ...
    public final boolean d() {
        ...
        AlertDialog alertDialog = this.f3419p;
        if (alertDialog != null) {
            alertDialog.dismiss();
        }
        ...
        if (z9) {
            ...
            if (!z10) {
                ...
                builder.setPositiveButton(2131952044, new p(this, 2));
                builder.setNegativeButton(R.string.cancel, new f5.b(4));
                builder.setCancelable(true);
                this.f3419p = builder.create();
                if (!requireActivity().isFinishing()) {
                    AlertDialog alertDialog2 = this.f3419p;
    ...
    public final void h() {
        ...
        while (it.hasNext()) {
            ...
            if (j0Var.f11240q != null) {
                ...
                if (file.exists() && j0Var.f11238o == file.length()) {
                }
            }
            parentFile = null;
        }
        ...
        this.f3422s = q2VarY;
        if (q2VarY == null || q2VarY.f11349p != 1) {
        ...
        try {
            ...
            if (activity != null && (packageManager = activity.getPackageManager()) != null) {
                q2 q2Var = this.f3422s;
                q2Var.getClass();
                applicationInfoB = i.b(packageManager, q2Var.f11344b, 128);
            }
    ...
    public final void j() {
        ...
        boolean zIsEmpty;
        SharedPreferences sharedPreferences;
        if (this.f3413a == null || getActivity() == null || k() || d()) {
            return;
        }
        g gVar = this.f3413a;
        if (gVar == null || !gVar.j()) {
            l("no_file_id");
            String string = getString(2131952263);
            string.getClass();
            g(string);
            return;
        }
    ...
    public final void l(String str) {
        ...
        if (this.f3413a != null) {
            ...
            if (gVar2.f11158a >= 0) {
                g gVar3 = this.f3413a;
                gVar3.getClass();
                bundleE.putString("appId", String.valueOf(gVar3.f11158a));
            }
            g gVar4 = this.f3413a;
            gVar4.getClass();
            if (gVar4.J >= 0) {
        ...
        try {
            if (getActivity() != null && this.f3413a != null) {
                ...
                if (gVar.f11177p != null) {
                    g gVar2 = this.f3413a;
                    gVar2.getClass();
                    String str = gVar2.f11177p;
                    str.getClass();
                    j = Long.parseLong(str);
                } else {
                    j = 0;
                }
                String string = getString(2131952712);
                Context contextRequireContext = requireContext();
                contextRequireContext.getClass();
                sparseArrayObjectAdapter.set(1, new Action(1L, string, i5.H(contextRequireContext, j)));
                String packageName = requireActivity().getPackageName();
