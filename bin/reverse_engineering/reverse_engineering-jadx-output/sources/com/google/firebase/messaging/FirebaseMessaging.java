...
public class FirebaseMessaging {
    ...
    public FirebaseMessaging(f fVar, b bVar, b bVar2, d dVar, b bVar3, c cVar) {
        ...
        fVar.a();
        final Context context2 = fVar.f7908a;
        ...
        scheduledThreadPoolExecutor.execute(new Runnable(this) { // from class: y2.k
            ...
            /* JADX INFO: renamed from: b, reason: collision with root package name */
            public final /* synthetic */ FirebaseMessaging f11741b;
            ...
            private final void a() {
                FirebaseMessaging firebaseMessaging = this.f11741b;
        ...
        t1.q(scheduledThreadPoolExecutor2, new Callable() { // from class: y2.w
            ...
            public final Object call() {
                ...
                synchronized (v.class) {
                    try {
                        WeakReference weakReference = v.f11767d;
                        ...
                        if (vVar2 == null) {
                            ...
                            vVar4.b();
                            v.f11767d = new WeakReference(vVar4);
                            vVar2 = vVar4;
                        }
                    } catch (Throwable th) {
                        throw th;
    ...
    public final String a() {
        ...
        h2 h2VarD = d();
        if (!i(h2VarD)) {
            return h2VarD.f11211a;
        }
        String strD = s.d(this.f3085a);
        j jVar = this.f3088d;
        synchronized (jVar) {
            pVarE = (p) ((ArrayMap) jVar.f11739b).get(strD);
            if (pVarE == null) {
                if (Log.isLoggable("FirebaseMessaging", 3)) {
                    Log.d("FirebaseMessaging", "Making new request for: " + strD);
                }
                v vVar = this.f3087c;
                pVarE = vVar.d(vVar.k(s.d((f) vVar.f5275b), "*", new Bundle())).j(this.g, new androidx.transition.a(this, strD, h2VarD, 7)).e((Executor) jVar.f11738a, new a3.e(jVar, strD));
                ((ArrayMap) jVar.f11739b).put(strD, pVarE);
    ...
    public final h2 d() {
        ...
        synchronized (gVarC) {
            h2VarD = h2.d(((SharedPreferences) gVarC.f5315b).getString(strD + "|T|" + strD2 + "|*", null));
        }
        return h2VarD;
    }
    ...
    public final void e() {
        p pVarW;
        int i;
        g0.b bVar = (g0.b) this.f3087c.f5277m;
        if (bVar.f5070c.a() >= 241100000) {
            n nVarA = n.a(bVar.f5069b);
            Bundle bundle = Bundle.EMPTY;
            synchronized (nVarA) {
                i = nVarA.f5101d;
                nVarA.f5101d = i + 1;
            }
            pVarW = nVarA.b(new g0.l(i, 5, bundle, 1)).d(h.f5081l, g0.d.f5075l);
        } else {
            pVarW = t1.w(new IOException("SERVICE_NOT_AVAILABLE"));
        }
    ...
    public final boolean i(h2 h2Var) {
        if (h2Var != null) {
            return System.currentTimeMillis() > h2Var.f11213c + 604800000 || !this.h.b().equals((String) h2Var.f11212b);
        }
        return true;
    }
}
