        ...
        switch (this.f2923n) {
            case 0:
                try {
                    ...
                    k1Var.getClass();
                    try {
                        k0VarAsInterface = j0.asInterface(t0.e.c(context, z9 ? t0.e.f9490c : t0.e.f9489b, ModuleDescriptor.MODULE_ID).b("com.google.android.gms.measurement.internal.AppMeasurementDynamiteService"));
                    } catch (t0.b e10) {
