        ...
        if (isDynamicColorAvailable()) {
            ...
            if (dynamicColorsOptions.getPrecondition().shouldApplyDynamicColors(activity, defaultThemeOverlay)) {
                if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
                    ...
                    ColorResourcesOverride resourcesLoaderColorResourcesOverride = ((30 > i || i > 33) && i < 34) ? null : ResourcesLoaderColorResourcesOverride.getInstance();
                    if (resourcesLoaderColorResourcesOverride == null || !resourcesLoaderColorResourcesOverride.applyIfPossible(activity, MaterialColorUtilitiesHelper.createColorResourcesIdsToColorValues(schemeContent))) {
                        return;
                    }
                } else {
        ...
        if (isDynamicColorAvailable()) {
            ...
            if (themeOverlay != 0) {
                if (dynamicColorsOptions.getContentBasedSeedColor() != null) {
                    ...
                    int i = Build.VERSION.SDK_INT;
                    ColorResourcesOverride resourcesLoaderColorResourcesOverride = ((30 > i || i > 33) && i < 34) ? null : ResourcesLoaderColorResourcesOverride.getInstance();
                    if (resourcesLoaderColorResourcesOverride != null) {
                        return resourcesLoaderColorResourcesOverride.wrapContextIfPossible(context, MaterialColorUtilitiesHelper.createColorResourcesIdsToColorValues(schemeContent));
                    }
                }
