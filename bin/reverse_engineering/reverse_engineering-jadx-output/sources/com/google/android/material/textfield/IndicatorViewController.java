...
final class IndicatorViewController {
    ...
    private void createCaptionAnimators(@NonNull List<Animator> list, boolean z9, @Nullable TextView textView, int i, int i6, int i10) {
        if (textView == null || !z9) {
            return;
        }
        if (i == i10 || i == i6) {
            ObjectAnimator objectAnimatorCreateCaptionOpacityAnimator = createCaptionOpacityAnimator(textView, i10 == i);
            if (i == i10 && i6 != 0) {
    ...
    private int getIndicatorPadding(boolean z9, @DimenRes int i, int i6) {
        return z9 ? this.context.getResources().getDimensionPixelSize(i) : i6;
    }
    ...
    private void setCaptionViewVisibilities(int i, int i6) {
    ...
    private void updateCaptionViewsVisibility(final int i, final int i6, boolean z9) {
        ...
        if (z9) {
            ...
            indicatorViewController.createCaptionAnimators(arrayList, this.helperTextEnabled, this.helperTextView, 2, i, i6);
            indicatorViewController.createCaptionAnimators(arrayList, indicatorViewController.errorEnabled, indicatorViewController.errorView, 1, i, i6);
            ...
            indicatorViewController = this;
            setCaptionViewVisibilities(i, i6);
        }
        indicatorViewController.textInputView.updateEditTextBackground();
        indicatorViewController.textInputView.updateLabelState(z9);
