...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public /* synthetic */ void lambda$new$0(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z9) {
    ...
    public void updateTime(int i, int i6, int i10) {
    ...
    public void setHandRotation(float f, boolean z9) {
        this.clockHandView.setHandRotation(f, z9);
    }
