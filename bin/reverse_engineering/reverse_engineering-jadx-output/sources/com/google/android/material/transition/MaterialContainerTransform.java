...
public final class MaterialContainerTransform extends Transition {
    ...
    public static final class TransitionDrawable extends Drawable {
        ...
        private void updateProgress(float f) {
            ...
            if (f > 1.0f || f < 0.0f) {
                ...
                float f14 = fArr2[0];
                float f15 = fArr2[1];
                f12 = x.f(f12, f14, f11, f12);
                f13 = x.f(f13, f15, f11, f13);
            }
            float f16 = f12;
            float f17 = f13;
            ...
            RectF rectF = this.currentStartBounds;
            float f18 = fitModeResultEvaluate.currentStartWidth;
            rectF.set(f16 - (f18 / 2.0f), f17, (f18 / 2.0f) + f16, fitModeResultEvaluate.currentStartHeight + f17);
            ...
            float f21 = (int) (fCalculateElevationDyMultiplier * f20);
            this.currentElevationDy = f21;
            this.shadowPaint.setShadowLayer(f20, (int) (fCalculateElevationDxMultiplier * f20), f21, SHADOW_COLOR);
    ...
    private boolean isEntering(@NonNull RectF rectF, @NonNull RectF rectF2) {
        ...
        androidx.core.view.contentcapture.a.f(this.transitionDirection, "Invalid transition direction: ");
        return false;
    }
