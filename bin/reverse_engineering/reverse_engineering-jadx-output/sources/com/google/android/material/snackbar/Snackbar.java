...
public class Snackbar extends BaseTransientBottomBar<Snackbar> {
    ...
    @NonNull
    public static Snackbar make(@NonNull View view, @StringRes int i, int i6) {
        return make(view, view.getResources().getText(i), i6);
    }
    ...
    private static Snackbar makeInternal(@Nullable Context context, @NonNull View view, @NonNull CharSequence charSequence, int i) {
        ...
        if (viewGroupFindSuitableParent == null) {
            a.p("No suitable parent found from the given view. Please provide a valid view.");
            return null;
        }
        if (context == null) {
    ...
    public int getDuration() {
        ...
        boolean z9 = this.hasAction;
        if (i >= 29) {
            return this.accessibilityManager.getRecommendedTimeoutMillis(duration, (z9 ? 4 : 0) | 3);
        }
        if (z9 && this.accessibilityManager.isTouchExplorationEnabled()) {
            return -2;
        }
        return duration;
    }
    ...
    public Snackbar setAction(@Nullable CharSequence charSequence, @Nullable View.OnClickListener onClickListener) {
        ...
        actionView.setOnClickListener(new e(20, this, onClickListener));
        return this;
    }
