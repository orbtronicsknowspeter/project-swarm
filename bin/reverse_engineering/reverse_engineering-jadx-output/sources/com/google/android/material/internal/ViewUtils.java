...
public class ViewUtils {
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i, int i6, @Nullable final OnApplyWindowInsetsListener onApplyWindowInsetsListener) {
        TypedArray typedArrayObtainStyledAttributes = view.getContext().obtainStyledAttributes(attributeSet, R.styleable.Insets, i, i6);
        final boolean z9 = typedArrayObtainStyledAttributes.getBoolean(R.styleable.Insets_paddingBottomSystemWindowInsets, false);
    ...
    public static void hideKeyboard(@NonNull View view, boolean z9) {
    ...
    public static void requestFocusAndShowKeyboard(@NonNull final View view, final boolean z9) {
        view.requestFocus();
    ...
    public static void showKeyboard(@NonNull View view, boolean z9) {
        WindowInsetsControllerCompat windowInsetsController;
        if (!z9 || (windowInsetsController = ViewCompat.getWindowInsetsController(view)) == null) {
    ...
    public static class RelativePadding {
        ...
        public RelativePadding(int i, int i6, int i10, int i11) {
            this.start = i;
            this.top = i6;
            this.end = i10;
            this.bottom = i11;
    ...
    public static void doOnApplyWindowInsets(@NonNull View view, @Nullable AttributeSet attributeSet, int i, int i6) {
        doOnApplyWindowInsets(view, attributeSet, i, i6, null);
    }
