...
public final class MaterialTimePicker extends DialogFragment implements TimePickerView.OnDoubleTapListener {
    ...
    private Pair<Integer, Integer> dataForMode(int i) {
        ...
        com.google.gson.internal.a.p(l.u(i, "no icon for mode: "));
        return null;
    }
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder setHour(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 23) int i) {
        ...
        @NonNull
        public Builder setMinute(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = 59) int i) {
            this.time.setMinute(i);
            return this;
        }
