...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    public void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new androidx.core.view.inputmethod.a(this, 15));
    }
    ...
    public void setShapeAppearanceModel(@NonNull ShapeAppearanceModel shapeAppearanceModel) {
        ShapeAppearanceModel shapeAppearanceModelWithTransformedCornerSizes = shapeAppearanceModel.withTransformedCornerSizes(new c2.a(14));
