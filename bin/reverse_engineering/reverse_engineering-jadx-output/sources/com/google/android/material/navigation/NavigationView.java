...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
    ...
    public NavigationView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        super(MaterialThemeOverlay.wrap(context, attributeSet, i, i11), attributeSet, i);
        ...
        this.backDrawerListener = new DrawerLayout.SimpleDrawerListener() { // from class: com.google.android.material.navigation.NavigationView.1
            ...
            public void onDrawerOpened(@NonNull View view) {
                ...
                if (view == navigationView) {
                    ...
                    view.post(new s(materialBackOrchestrator, 11));
                }
            }
        };
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, com.google.android.material.R.styleable.NavigationView, i, i11, new int[0]);
        ...
        if (background == null || colorStateListOrNull != null) {
            MaterialShapeDrawable materialShapeDrawable = new MaterialShapeDrawable(ShapeAppearanceModel.builder(context2, attributeSet, i, i11).build());
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(com.google.android.material.R.styleable.NavigationView_itemVerticalPadding)) {
            setItemVerticalPadding(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(com.google.android.material.R.styleable.NavigationView_itemVerticalPadding, i6));
        }
    ...
    private void maybeUpdateCornerSizeForDrawerLayout(@Px int i, @Px int i6) {
        if ((getParent() instanceof DrawerLayout) && (getLayoutParams() instanceof DrawerLayout.LayoutParams)) {
            if ((this.drawerLayoutCornerSize > 0 || this.drawerLayoutCornerSizeBackAnimationEnabled) && (getBackground() instanceof MaterialShapeDrawable)) {
                ...
                this.shapeableDelegate.onMaskChanged(this, new RectF(0.0f, 0.0f, i, i6));
    ...
    private Pair<DrawerLayout, DrawerLayout.LayoutParams> requireDrawerLayoutParent() {
        ...
        a.i("NavigationView back progress requires the direct parent view to be a DrawerLayout.");
        return null;
    }
    ...
    public void dispatchDraw(@NonNull Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new androidx.core.view.inputmethod.a(this, 16));
    }
    ...
    public void onSizeChanged(int i, int i6, int i10, int i11) {
        ...
        maybeUpdateCornerSizeForDrawerLayout(i, i6);
    }
    ...
    public void setCheckedItem(@NonNull MenuItem menuItem) {
        ...
        if (menuItemFindItem != null) {
            ...
            com.google.gson.internal.a.p("Called setCheckedItem(MenuItem) with an item that is not in the current menu.");
        }
    }
