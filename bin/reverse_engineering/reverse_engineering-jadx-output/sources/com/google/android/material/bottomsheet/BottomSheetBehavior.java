...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> implements MaterialBackHandler {
    ...
    private int addAccessibilityActionForState(View view, @StringRes int i, int i6) {
        return ViewCompat.addAccessibilityAction(view, view.getResources().getString(i), createAccessibilityViewCommandForState(i6));
    }
    ...
    private void clearAccessibilityAction(View view, int i) {
        ...
        int i6 = this.expandHalfwayActionIds.get(i, -1);
        if (i6 != -1) {
    ...
    public static <V extends View> BottomSheetBehavior<V> from(@NonNull V v) {
        ...
        a.p("The view is not associated with BottomSheetBehavior");
        return null;
    }
    ...
    private int getTopOffsetForState(int i) {
        ...
        a.p(l.u(i, "Invalid state to get top offset: "));
        return 0;
    }
    ...
    private boolean isTouchingDragHandle(@NonNull CoordinatorLayout coordinatorLayout, int i, int i6) {
        WeakReference<View> weakReference = this.dragHandleViewRef;
        View view = weakReference != null ? weakReference.get() : null;
        return view != null && coordinatorLayout.isPointInChildBounds(view, i, i6);
    }

    private boolean isTouchingScrollingChild(@NonNull CoordinatorLayout coordinatorLayout, int i, int i6) {
    ...
    private void updateDrawableForTargetState(int i, boolean z9) {
    ...
    public void dispatchOnSlide(int i) {
        ...
        for (int i6 = 0; i6 < this.callbacks.size(); i6++) {
            this.callbacks.get(i6).onSlide(v, fCalculateSlideOffsetWithTop);
        }
    }
    ...
    public boolean onInterceptTouchEvent(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, @NonNull MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            this.initialY = y9;
            if (this.state != 2 && isTouchingScrollingChild(coordinatorLayout, x3, y9)) {
                this.activePointerId = motionEvent.getPointerId(motionEvent.getActionIndex());
                if (!isTouchingDragHandle(coordinatorLayout, x3, this.initialY)) {
                    this.touchingScrollingChild = true;
                }
            }
            this.ignoreEvents = this.activePointerId == -1 && !coordinatorLayout.isPointInChildBounds(v, x3, this.initialY);
    ...
    public boolean onLayoutChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, int i) {
        ...
        for (int i13 = 0; i13 < this.callbacks.size(); i13++) {
            this.callbacks.get(i13).onLayout(v);
        }
        return true;
    }
    ...
    public boolean onMeasureChild(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, int i, int i6, int i10, int i11) {
        ...
        v.measure(getChildMeasureSpec(i, coordinatorLayout.getPaddingRight() + coordinatorLayout.getPaddingLeft() + marginLayoutParams.leftMargin + marginLayoutParams.rightMargin + i6, this.maxWidth, marginLayoutParams.width), getChildMeasureSpec(i10, coordinatorLayout.getPaddingBottom() + coordinatorLayout.getPaddingTop() + marginLayoutParams.topMargin + marginLayoutParams.bottomMargin + i11, this.maxHeight, marginLayoutParams.height));
        return true;
    }
    ...
    public boolean onNestedPreFling(@NonNull CoordinatorLayout coordinatorLayout, @NonNull V v, @NonNull View view, float f, float f10) {
        ...
        return isNestedScrollingCheckEnabled() && (weakReference = this.nestedScrollingChildRef) != null && view == weakReference.get() && (!(this.state == 3 || this.draggableOnNestedScrollLastDragIgnored) || super.onNestedPreFling(coordinatorLayout, v, view, f, f10));
    }
    ...
    */
    ...
    public void setExpandedOffset(int i) {
        if (i < 0) {
            a.p("offset must be greater than or equal to 0");
        } else {
    ...
    public void setHalfExpandedRatio(@FloatRange(from = 0.0d, fromInclusive = false, to = Contrast.RATIO_MIN, toInclusive = false) float f) {
        if (f <= 0.0f || f >= 1.0f) {
            a.p("ratio must be a float value between 0 and 1");
            return;
        }
    ...
    public final void setPeekHeight(int i, boolean z9) {
    ...
    public void setState(int i) {
        ...
        if (weakReference == null || weakReference.get() == null) {
            ...
            runAfterLayout(v, new Runnable() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.1
                @Override // java.lang.Runnable
                public void run() {
                    BottomSheetBehavior.this.startSettling(v, i6, false);
                }
            });
        }
    }
    ...
    public void setStateInternal(int i) {
        ...
        updateDrawableForTargetState(i, true);
        for (int i6 = 0; i6 < this.callbacks.size(); i6++) {
            this.callbacks.get(i6).onStateChanged(v, i);
        }
        updateAccessibilityActions();
    }
