...
public final class MaterialDynamicColors {
    ...
    public DynamicColor errorContainer() {
        int i = 13;
        return new DynamicColor("error_container", new d(7), new d(8), true, new g(this, i), null, new ContrastCurve(1.0d, 1.0d, 3.0d, 4.5d), new c(this, i));
    }
    ...
    public DynamicColor primary() {
        int i = 13;
        return new DynamicColor("primary", new d(12), new d(i), true, new g(this, i), null, new ContrastCurve(3.0d, 4.5d, 7.0d, 7.0d), new c(this, 15));
    }
    ...
    public MaterialDynamicColors(boolean z9) {
        this.isExtendedFidelity = z9;
    }
}
