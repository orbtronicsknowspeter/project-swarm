...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    public BaseTransientBottomBar(@NonNull Context context, @NonNull ViewGroup viewGroup, @NonNull View view, @NonNull com.google.android.material.snackbar.ContentViewCallback contentViewCallback) {
        ...
        if (viewGroup == null) {
            a.p("Transient bottom bar must have non-null parent");
            throw null;
        }
        if (view == null) {
            a.p("Transient bottom bar must have non-null content");
            throw null;
        }
        if (contentViewCallback == null) {
            a.p("Transient bottom bar must have non-null callback");
            throw null;
        }
    ...
    public void updateMargins() {
        ...
        boolean z9 = (marginLayoutParams.bottomMargin == i && marginLayoutParams.leftMargin == i6 && marginLayoutParams.rightMargin == i10 && marginLayoutParams.topMargin == i11) ? false : true;
        if (z9) {
        ...
        if ((z9 || this.appliedBottomMarginGestureInset != this.extraBottomMarginGestureInset) && Build.VERSION.SDK_INT >= 29 && shouldUpdateGestureInset()) {
    ...
    public B setAnchorView(@IdRes int i) {
        ...
        a.p(l.u(i, "Unable to find anchor view with id: "));
        return null;
    }
    ...
    public static abstract class BaseCallback<B> {
        ...
        public void onDismissed(B b7, int i) {
        }
    }
        ...
        public void onMeasure(int i, int i6) {
            ...
            if (this.maxWidth > 0) {
                ...
                if (measuredWidth > i10) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(i10, BasicMeasure.EXACTLY), i6);
                }
            }
        }
