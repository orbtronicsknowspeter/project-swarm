...
public final class DeterminateDrawable<S extends BaseProgressIndicatorSpec> extends DrawableWithAnimatedVisibilityChange {
    ...
    private void maybeInitializeAmplitudeAnimator() {
        ...
        this.amplitudeAnimator.addUpdateListener(new c(this, 2));
    }
    ...
    public boolean onLevelChange(int i) {
        float amplitudeFractionFromLevel = getAmplitudeFractionFromLevel(i);
        boolean z9 = this.skipAnimationOnLevelChange;
    ...
    @Override // com.google.android.material.progressindicator.DrawableWithAnimatedVisibilityChange, android.graphics.drawable.Drawable
    public /* bridge */ /* synthetic */ void setAlpha(@IntRange(from = FabTransformationScrimBehavior.COLLAPSE_DELAY, to = ScatterMapKt.Sentinel) int i) {
        super.setAlpha(i);
    }
    ...
    public void setEnforcedDrawing(boolean z9) {
        if (z9 && !this.phaseAnimator.isRunning()) {
