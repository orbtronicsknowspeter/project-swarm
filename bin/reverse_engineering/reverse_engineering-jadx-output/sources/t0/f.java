...
public abstract class f {
    ...
    public static final Object J(r rVar, r rVar2, p pVar) throws Throwable {
        ...
        if (uVar == aVar || (objR = rVar.R(uVar)) == c0.f8247e) {
            return aVar;
        }
    ...
    */
    ...
    public static n Q(com.google.android.gms.internal.measurement.d dVar, s sVar, ArrayList arrayList, boolean z9) {
        ...
        n nVarC = ((t) sVar.f11756l).c(sVar, (n) arrayList.get(0));
        ...
        if (arrayList.size() == 2) {
            nVarA = ((t) sVar.f11756l).c(sVar, (n) arrayList.get(1));
    ...
    public static void b(FragmentActivity fragmentActivity, d7.a aVar) {
        View viewInflate = LayoutInflater.from(fragmentActivity).inflate(2131558585, (ViewGroup) null);
        Button button = (Button) viewInflate.findViewById(2131361988);
        TextView textView = (TextView) viewInflate.findViewById(2131364126);
        ...
        if (jSONArrayOptJSONArray != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                if (!jSONObjectOptJSONObject.isNull("id")) {
                    jVar.f11224a = jSONObjectOptJSONObject.optInt("id");
                }
                if (!jSONObjectOptJSONObject.isNull("name")) {
                    jVar.f11225b = jSONObjectOptJSONObject.optString("name");
                }
