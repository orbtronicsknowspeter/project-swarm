...
public final class a0 implements j {
    ...
    public final long c(byte b7, long j, long j6) {
        ...
        while (jMax < j6) {
            ...
            long j11 = hVar.f10961b;
            if (j11 >= j10 || this.f10933a.p(hVar, 8192L) == -1) {
                break;
            }
    ...
    public final boolean d(long j, k kVar) {
        ...
        if (j >= 0 && iF >= 0 && kVar.f() >= iF) {
            for (int i = 0; i < iF; i++) {
                long j6 = ((long) i) + j;
                if (n(1 + j6) && this.f10934b.d(j6) == kVar.k(i)) {
                }
            }
            return true;
        }
    ...
    public final void skip(long j) {
        ...
        while (j > 0) {
            ...
            if (hVar.f10961b == 0 && this.f10933a.p(hVar, 8192L) == -1) {
                ...
                long jMin = Math.min(j, hVar.f10961b);
                hVar.skip(jMin);
                j -= jMin;
            }
        }
