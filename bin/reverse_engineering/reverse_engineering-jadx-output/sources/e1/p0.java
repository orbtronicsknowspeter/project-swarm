...
public final class p0 extends h0 {
    ...
    public final void k() {
        ...
        try {
            ...
            t1.m(w0Var);
            w0Var.f4346w.c(Integer.valueOf(iDelete), "Reset local analytics data. records");
    ...
    */
    public final boolean l() {
        /*
            ...
            r11.g()
            boolean r1 = r11.f4185m
            r2 = 0
            if (r1 == 0) goto Lc
            goto L97
        Lc:
            e1.t1 r1 = r11.f3875a
            android.content.Context r3 = r1.f4259a
        ...
        L1f:
            ...
            if (r6 != 0) goto L2c
            r11.f4185m = r7     // Catch: java.lang.Throwable -> L49 android.database.sqlite.SQLiteException -> L4b android.database.sqlite.SQLiteDatabaseLockedException -> L66 android.database.sqlite.SQLiteFullException -> L72
            goto L97
        L2c:
        ...
        L57:
            e1.w0 r9 = r1.f4264o     // Catch: java.lang.Throwable -> L49
            e1.t1.m(r9)     // Catch: java.lang.Throwable -> L49
            e1.u0 r9 = r9.f4339o     // Catch: java.lang.Throwable -> L49
            r9.c(r8, r0)     // Catch: java.lang.Throwable -> L49
            r11.f4185m = r7     // Catch: java.lang.Throwable -> L49
            if (r6 == 0) goto L82
            goto L6e
        L66:
