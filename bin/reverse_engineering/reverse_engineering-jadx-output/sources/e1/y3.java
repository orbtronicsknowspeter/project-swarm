...
public final class y3 extends p4 {
    ...
    public final Pair k(String str) {
        ...
        HashMap map = this.f4418m;
        x3 x3Var2 = (x3) map.get(str);
        if (x3Var2 != null && jElapsedRealtime < x3Var2.f4400c) {
            return new Pair(x3Var2.f4398a, Boolean.valueOf(x3Var2.f4399b));
        }
        long jN = gVar.n(str, f0.f3915b) + jElapsedRealtime;
        try {
            try {
                aVarA = c0.b.a(t1Var.f4259a);
            } catch (PackageManager.NameNotFoundException unused) {
                if (x3Var2 != null && jElapsedRealtime < x3Var2.f4400c + gVar.n(str, f0.f3917c)) {
                    return new Pair(x3Var2.f4398a, Boolean.valueOf(x3Var2.f4399b));
                }
                aVarA = null;
            }
