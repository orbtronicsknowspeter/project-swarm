...
public final class p extends RecyclerView.Adapter {
    ...
    public final w4.b f4651a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public final w4.n f4652b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public final w4.k f4653c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    public ArrayList f4654d;
    ...
    public final void a(Context context, File file) {
        ...
        while (true) {
            ...
            int i6 = i + 1;
            Object next = it.next();
            if ((next instanceof x4.e) && (str = (eVar = (x4.e) next).f11123l) != null && str.length() != 0) {
    ...
    public final void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int i) {
        ...
        if (viewHolder instanceof p1) {
            ...
            Object obj2 = this.f4654d.get(i);
            obj2.getClass();
            p1Var.a((v0) obj2, this.f4655e == i, false);
            return;
        }
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        viewGroup.getClass();
        if (i == 0) {
            return new m5.d(androidx.lifecycle.l.E(viewGroup, 2131558582, viewGroup, false), this.f4651a);
        }
        if (i == 1) {
            return new p1(androidx.lifecycle.l.E(viewGroup, 2131558855, viewGroup, false), this.f4652b);
        }
        if (i == 2) {
            View viewE = androidx.lifecycle.l.E(viewGroup, 2131558848, viewGroup, false);
            String string = viewE.getContext().getString(2131952636);
            string.getClass();
            return new m5.f0(viewE, string, null);
        }
        if (i == 3) {
            View viewE2 = androidx.lifecycle.l.E(viewGroup, 2131558848, viewGroup, false);
            String string2 = viewE2.getContext().getString(2131952234);
            string2.getClass();
        ...
        String string3 = viewE3.getContext().getString(2131951952);
        string3.getClass();
        return new m5.f0(viewE3, string3, this.f4653c);
    }
}
