...
public final class s extends RecyclerView.Adapter {
    ...
    public final int getItemCount() {
        ArrayList arrayList = this.f4680a.E0;
    ...
    */
    ...
    public final RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        if (i == 0) {
            View viewInflate = LayoutInflater.from(context).inflate(2131558567, viewGroup, false);
            viewInflate.getClass();
            return new m5.t(viewInflate, context);
        }
        if (i != 1) {
            View viewInflate2 = LayoutInflater.from(context).inflate(2131558676, viewGroup, false);
            viewInflate2.getClass();
            return new m5.b0(viewInflate2);
        }
        View viewInflate3 = LayoutInflater.from(context).inflate(2131558759, viewGroup, false);
        viewInflate3.getClass();
        return new m5.l0(viewInflate3, this.f4683d);
    }
}
