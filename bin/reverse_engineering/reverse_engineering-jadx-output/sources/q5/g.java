...
public final class g extends p9.a implements c.b {
        ...
        if (iC == 10) {
            ...
            if (r13 != 0) {
                ...
                while (true) {
                    ...
                    if (((j8.b) next2).f6720a.intValue() == dVar.f5465a) {
                        obj2 = next2;
                        break;
                    }
                }
        ...
        if (r14 != 0) {
            ...
            if (bVar2 != null && (r12 = bVar2.f) != 0) {
                ...
                while (true) {
                    ...
                    if (((j8.c) next3).f6726b.intValue() == dVar.f5465a) {
                        obj = next3;
                        break;
                    }
                }
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        View viewInflate = layoutInflater.inflate(2131558513, viewGroup, false);
    ...
    public final void onViewCreated(View view, Bundle bundle) {
        ...
        ArrayList arrayListA = iVar.a(j8.e.f6731a);
        ...
        if (arrayList != null) {
            ...
            while (i6 < size) {
                ...
                if (r10 != 0) {
                    for (j8.c cVar2 : r10) {
                        int iIntValue = cVar2.f6726b.intValue();
                        String str = cVar2.f6729e;
                        if (str == null) {
                            str = "";
                        }
                        arrayList2.add(new c.i(new h8.d(iIntValue, str), cVar2.f6728d, 0, 12, null, null, 116));
                    }
                }
            }
        }
        ...
        ArrayList arrayListA2 = iVar3.a(j8.e.f6733c);
        ...
        v7.e eVar = m0.f8288a;
        c0.s(viewModelScope, v7.d.f10884a, null, new p9.c(iVar4, cVar, i11), 2);
    }
