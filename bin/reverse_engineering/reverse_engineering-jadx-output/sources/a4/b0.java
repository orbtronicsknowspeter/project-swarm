...
public final class b0 extends n0 {
    ...
    public final m0 e(k0 k0Var, int i) throws z, a0 {
        ...
        if (iVar != null) {
            ...
            if (string.isEmpty()) {
                ((g5.f) sVar.f11757m).Q("Cache-Control");
            } else {
                sVar.w("Cache-Control", string);
            }
        }
        m8.a0 a0VarN = sVar.n();
        m8.x xVar = (m8.x) this.f73a.f4811b;
        m8.z zVar = new m8.z(xVar, a0VarN);
        xVar.f7818o.getClass();
        zVar.f7838l = m8.b.f7681d;
        synchronized (zVar) {
            if (zVar.f7840n) {
        ...
        zVar.f7837b.f8794b = u8.h.f10783a.i();
        zVar.f7838l.getClass();
        try {
            try {
                xVar.f7813a.e(zVar);
                m8.c0 c0VarA = zVar.a();
                xVar.f7813a.f(zVar);
                m8.e0 e0Var = c0VarA.f7698p;
                int i6 = c0VarA.f7694l;
                if (i6 < 200 || i6 >= 300) {
                    e0Var.close();
                    throw new a0(androidx.lifecycle.l.u(c0VarA.f7694l, "HTTP "));
                }
                int i10 = c0VarA.f7700r == null ? 3 : 2;
                if (i10 == 2 && e0Var.b() == 0) {
                    e0Var.close();
