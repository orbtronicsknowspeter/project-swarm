...
public final class k0 {
    ...
    public void a(int i) {
        ...
        if (i > 0) {
            ...
            while (true) {
                ...
                int i11 = ((s8.b[]) this.i)[length].f9385c;
                i -= i11;
                this.h -= i11;
                this.g--;
                i10++;
    ...
    public void f(w8.k kVar) throws EOFException {
        ...
        s8.y.f9480d.getClass();
        long j = 0;
        long j6 = 0;
        for (int i = 0; i < kVar.f(); i++) {
            j6 += (long) s8.y.f9479c[kVar.k(i) & 255];
        }
        ...
        for (int i10 = 0; i10 < kVar.f(); i10++) {
            ...
            int i11 = s8.y.f9478b[iK];
            byte b7 = s8.y.f9479c[iK];
            j = (j << b7) | ((long) i11);
            i6 += b7;
            while (i6 >= 8) {
                i6 -= 8;
        ...
        w8.k kVarG = hVar2.g(hVar2.f10961b);
        g(kVarG.f(), 127, 128);
        hVar.y(kVarG);
    }
