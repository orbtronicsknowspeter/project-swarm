        ...
        if (activity != null) {
            ...
            if (activity instanceof Updates) {
                if (string != null) {
                    ...
                    v7.e eVar = m0.f8288a;
                    c0.s(lifecycleScope, n.f10348a, null, new ya(updates, string, i, cVar, 0), 2);
                    return;
                }
                return;
            }
            if (activity instanceof MyApps) {
                if (string != null) {
                    ...
                    c0.s(lifecycleScope2, n.f10348a, null, new b.n(myApps, string, i, cVar, 19), 2);
                    return;
                }
                return;
            }
